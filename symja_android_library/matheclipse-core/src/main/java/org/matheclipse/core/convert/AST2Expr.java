...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"All", "AllowedHeads", "AllowShortContext",
      ...
      "NumericFunction", "OneIdentity", "Orange", "Orderless", "Overlaps", "Pi", "Pink",
      "PlotLegends", "PlotRange", "PlotStyle", "PrecisionGoal", "Primes", "Protected", "Purple",
      "Rationals", "ReadProtected", "Real", "Record", "RecordSeparators", "Red", "Reals", "Right",
      "SameTest", "ScalingFunctions", "Second", "SequenceHold", "SetSystemOptions", "SystemOptions",
      ...
      "TableHeadings", "TableSpacing", "TestID", "Today", "TooLarge", "Top", "Trig", "True",
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "SatisfiabilityInstances", "SatisfiableQ", "Scale", "Scaled", "Scan", "SchurDecomposition",
      "Sec", "Sech", "SeedRandom", "Select", "SelectFirst", "SemanticImport",
      ...
      "UpSet", "UpSetDelayed", "UpTo", "UpValues", "URLFetch", "ValueQ", "Values",
      "VandermondeMatrix", "Variables", "Variance", "VectorAngle", "VectorQ", "Verbatim",
