...
/**
 * Characteristic Set class acccording to the simple algorithm, where the leading coefficients are
 * <strong>not</strong> rereduced. Implements methods for Characteristic Sets and tests.
 *
...
public class CharacteristicSetSimple<C extends GcdRingElem<C>> implements CharacteristicSet<C> {
  ...
  /**
   * Characteristic set. According to the simple algorithm. The leading coefficients are
   * <strong>not</strong> rereduced.
   *
  ...
  public List<GenPolynomial<C>> characteristicSet(List<GenPolynomial<C>> A) {
    ...
    List<GenPolynomial<GenPolynomial<C>>> positiveDeg =
    ...
    OrderedPolynomialList<GenPolynomial<C>> opl =
        new OrderedPolynomialList<GenPolynomial<C>>(rfac, positiveDeg);
    List<GenPolynomial<GenPolynomial<C>>> pd =
        new ArrayList<GenPolynomial<GenPolynomial<C>>>(opl.list);
