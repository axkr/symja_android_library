...
/**
 * This interface defines a visitor for the entries of a vector. Visitors implementing this interface do not alter the entries of
 * the vector being visited.
 *
 * @param <T>
...
public interface FieldVectorPreservingVisitor {
	 ...
	 */
	void visit(int index, IExpr value);
