...
/**
 * Generate Relation Table for Weyl Algebras Adds the respective relations to the relation table of
 * the given solvable ring factory. Relations are of the form x<sub>j</sub> * x<sub>i</sub> =
 * x<sub>i</sub> x<sub>j</sub> + 1. Iterated form: R{x1,y1,...,xn,yn; yi*xi = xi yi + 1}.
 *
 * @author Heinz Kredel
 */
public class WeylRelationsIterated<C extends RingElem<C>> implements RelationGenerator<C> {
  ...
  /**
   * The constructor requires a ring factory. The relation table of this ring is setup to a Weyl
   * Algebra.
   *
   * @param r solvable polynomial ring factory, r must have even number of variables.
   */
  ...
  /**
   * Generates the relation table of this ring. Iterated form: R{x1,y1,...,xn,yn; yi*xi = xi yi +
   * 1}.
   */
   ...
   * 1}.
   *
   * @param ring solvable polynomial ring factory, ring must have even number of variables.
   */
