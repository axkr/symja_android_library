...
/**
 * Rational function coefficients factorization algorithms. This class implements factorization
 * methods for polynomials over rational functions, that is, with coefficients from class <code>
 * application.Quotient</code>.
 *
 * @author Heinz Kredel
 */
public class FactorQuotient<C extends GcdRingElem<C>> extends FactorAbstract<Quotient<C>> {
  ...
  public List<GenPolynomial<Quotient<C>>> factorsSquarefree(GenPolynomial<Quotient<C>> P) {
    ...
    List<GenPolynomial<Quotient<C>>> qfacts =
        PolyUfdUtil.<C>quotientFromIntegralCoefficients(pfac, irfacts);
