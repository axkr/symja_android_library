...
public class PolyUtilRoot {
  ...
  public static <C extends GcdRingElem<C> & Rational>
      GenPolynomial<RealAlgebraicNumber<C>> convertToAlgebraicCoefficients(
  ...
  /**
   * Convert to recursive RealAlgebraicNumber coefficients. Represent as polynomial with recursive
   * RealAlgebraicNumber<C> coefficients, C is e.g. ModInteger or BigRational.
   *
   ...
   */
  public static <C extends GcdRingElem<C> & Rational>
      GenPolynomial<RealAlgebraicNumber<C>> convertToRecAlgebraicCoefficients(
   ...
   *
   * @param pfac result polynomial factory.
   * @param A recursive polynomial with GenPolynomial&lt;BigInteger&gt; coefficients to be
   *     converted.
   * @return polynomial with RealAlgebraicNumber&lt;C&gt; coefficients.
   */
  public static <C extends GcdRingElem<C> & Rational>
      GenPolynomial<RealAlgebraicNumber<C>> convertRecursiveToAlgebraicCoefficients(
          GenPolynomialRing<RealAlgebraicNumber<C>> pfac, GenPolynomial<GenPolynomial<C>> A) {
    RealAlgebraicRing<C> afac = (RealAlgebraicRing<C>) pfac.coFac;
    return PolyUtil.<GenPolynomial<C>, RealAlgebraicNumber<C>>map(
        pfac, A, new PolyToReAlg<C>(afac));
  }

  /**
   * Convert to AlgebraicNumber coefficients. Represent as polynomial with AlgebraicNumber<C>
   * coefficients.
   *
   ...
   */
  public static <C extends GcdRingElem<C> & Rational>
      GenPolynomial<AlgebraicNumber<C>> algebraicFromRealCoefficients(
    ...
    return PolyUtil.<RealAlgebraicNumber<C>, AlgebraicNumber<C>>map(
        afac, A, new AlgFromRealCoeff<C>(cfac));
  }
   ...
   */
  public static <C extends GcdRingElem<C> & Rational>
      GenPolynomial<RealAlgebraicNumber<C>> realFromAlgebraicCoefficients(
    ...
    return PolyUtil.<AlgebraicNumber<C>, RealAlgebraicNumber<C>>map(
        rfac, A, new RealFromAlgCoeff<C>(cfac));
  }
   ...
   */
  public static <C extends GcdRingElem<C> & Rational>
      GenPolynomial<RealAlgebraicNumber<C>> convertToRealCoefficients(
          GenPolynomialRing<RealAlgebraicNumber<C>> pfac, GenPolynomial<C> A) {
    RealAlgebraicRing<C> afac = (RealAlgebraicRing<C>) pfac.coFac;
   ...
   */
  public static <C extends GcdRingElem<C> & Rational>
      GenPolynomial<ComplexAlgebraicNumber<C>> convertToComplexCoefficients(
   ...
   */
  public static <C extends GcdRingElem<C> & Rational>
      GenPolynomial<ComplexAlgebraicNumber<C>> convertToComplexCoefficientsFromComplex(
          GenPolynomialRing<ComplexAlgebraicNumber<C>> pfac, GenPolynomial<Complex<C>> A) {
    ComplexAlgebraicRing<C> afac = (ComplexAlgebraicRing<C>) pfac.coFac;
    return PolyUtil.<Complex<C>, ComplexAlgebraicNumber<C>>map(
        pfac, A, new CoeffToComplexFromComplex<C>(afac));
  }
   ...
   */
  public static <C extends GcdRingElem<C> & Rational> GenPolynomial<Complex<C>> complexFromAny(
      GenPolynomial<C> f) {
