...
ISetDelayed(Int(Gamma(pn_,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Gamma(pn_,Plus(Times(b_DEFAULT,x_),a_)),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(PolyGamma(pn_,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
    Condition(Times(PolyGamma(Plus(pn,Times(CN1,C1)),Plus(a,Times(b,x))),Power(b,CN1)),FreeQ(List(a,b,pn),x))),
ISetDelayed(Int(Times(PolyGamma(pn_,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(PolyGamma(C0,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(Gamma(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),pn_DEFAULT)),x_Symbol),
    Condition(Times(Power(Gamma(Plus(a,Times(b,x))),pn),Power(Times(b,pn),CN1)),FreeQ(List(a,b,pn),x))),
ISetDelayed(Int(Times(PolyGamma(C0,Plus(Times(b_DEFAULT,x_),c_DEFAULT)),Power(Factorial(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),pn_DEFAULT)),x_Symbol),
