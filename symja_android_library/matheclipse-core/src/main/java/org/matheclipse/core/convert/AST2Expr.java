...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "Adjugate", "AiryAi", "AiryAiPrime", "AiryBi", "AiryBiPrime", "AlgebraicIntegerQ",
      "AlgebraicNumber", "AllTrue", "Alphabet", "AlphabeticOrder", "Alternatives", "AmbientLight",
      "And", "AngerJ", "AnglePath", "AngleVector", "Annotation", "Annuity", "AnnuityDue", "Annulus",
      "AntihermitianMatrixQ", "AntisymmetricMatrixQ", "AnyTrue", "Apart", "AppellF1", "Append",
      "AppendTo", "Apply", "ApplySides", "ArcCos", "ArcCosh", "ArcCot", "ArcCoth", "ArcCsc",
      "ArcCsch", "ArcLength", "ArcSec", "ArcSech", "ArcSin", "ArcSinh", "ArcTan", "ArcTanh", "Area",
      "Arg", "ArgMax", "ArgMin", "ArithmeticGeometricMean", "Array", "ArrayDepth", "ArrayFlatten",
      ...
      "AsymptoticRSolveValue", "AtomQ", "Attributes", "Ball", "Band", "BarChart", "BarLegend",
      ...
      "DigitQ", "DigitSum", "Dimensions", "DiracDelta", "DirectedEdge", "DirectedInfinity",
      ...
      "Dynamic", "EasterSunday", "Echo", "EchoFunction", "EdgeCount", "EdgeForm", "EdgeList",
      "EdgeQ", "EdgeRules", "EdgeWeight", "EditDistance", "EffectiveInterest", "Eigensystem",
      ...
      "EmpiricalDistribution", "End", "EndPackage", "EndTestSection", "Entity", "EntityClass",
      "EntityList", "EntityProperty", "Entropy", "Equal", "EqualTo", "Equivalent", "Erf", "Erfc",
      ...
      "Flatten", "FlattenAt", "FlatTopWindow", "Floor", "Fold", "FoldList", "For", "ForAll",
      ...
      "Framed", "FRatioDistribution", "FrechetDistribution", "FreeQ", "FresnelC", "FresnelS",
      ...
      "GraphDisjointUnion", "GraphDistance", "Graphics", "GraphicsGrid", "Graphics3D",
      "Graphics3DJSON", "GraphicsColumn", "GraphicsComplex", "GraphicsGroup", "GraphicsRow",
      "GraphicsJSON", "GraphIntersection", "GraphPeriphery", "GraphPlot", "GraphPower", "GraphQ",
      "GraphRadius", "GraphUnion", "GrayLevel", "Greater", "GreaterEqual", "GreaterEqualThan",
      "GreaterThan", "GridGraph", "GroebnerBasis", "GroupBy", "Groupings", "Gudermannian",
      "GumbelDistribution", "HalfLine", "HalfNormalDistribution", "HamiltonianGraphQ",
      "HammingDistance", "HammingWindow", "HankelH1", "HankelH2", "HankelMatrix", "HannWindow",
      "HarmonicMean", "HarmonicNumber", "Hash", "Haversine", "Head", "HeavisideLambda",
      "HeavisidePi", "HeavisideTheta", "HermiteDecomposition", "HermiteH", "HermitianMatrixQ",
      "HessenbergDecomposition", "HessianMatrix", "Hexahedron", "HilbertMatrix", "Histogram",
      "HodgeDual", "Hold", "HoldForm", "HoldPattern", "Horner", "HornerForm", "Hue",
      ...
      "KaryTree", "KelvinBei", "KelvinBer", "Key", "KeyDrop", "KeyExistsQ", "Keys", "KeySelect",
      "KeySort", "KeyTake", "KeyValueMap", "KeyValuePattern", "KleinInvariantJ", "KnownUnitQ",
      ...
      "MapAll", "MapApply", "MapAt", "MapIndexed", "MapThread", "MarginalDistribution",
      ...
      "MonomialList", "Most", "Mouseover", "MovingAverage", "MovingMedian", "Multinomial",
      "MultinormalDistribution", "MultiplicativeOrder", "MultiplySides",
      "MultivariatePoissonDistribution", "MultivariateTDistribution", "NakagamiDistribution",
      "NameQ", "Names", "Nand", "NArgMax", "NArgMin", "ND", "NDSolve", "Nearest", "NearestTo",
      "Needs", "Negative", "NegativeDefiniteMatrixQ", "NegativeSemidefiniteMatrixQ", "Nest",
      ...
      "Normalize", "NormalMatrixQ", "Not", "Notebook", "NotElement", "NotListQ", "NProbability",
      "NProduct", "NRoots", "NSolve", "NSum", "NullSpace", "NumberDigit", "NumberFieldRootsOfUnity",
      "NumberLinePlot", "NumberQ", "Numerator", "NumericalOrder", "NumericalSort", "NumericArray",
      "NumericArrayQ", "NumericArrayType", "NumericQ", "NuttallWindow", "Octahedron", "OddQ", "Off",
      "Offset", "On", "Opacity", "OpenAppend", "OpenRead", "OpenWrite", "Operate",
      "OptimizeExpression", "Optional", "Options", "OptionsPattern", "OptionValue", "Or", "Order",
      "OrderedQ", "Ordering", "Orthogonalize", "OrthogonalMatrixQ", "Out", "Outer", "OutputForm",
      "OutputStream", "Overflow", "Overscript", "OverscriptBox", "OwnValues", "Package",
      "PadeApproximant", "PadLeft", "PadRight", "ParallelMap", "Parallelepiped", "Parallelogram",
      ...
      "Prefix", "PreIncrement", "Prepend", "PrependTo", "Prime", "PrimeNu", "PrimeOmega", "PrimePi",
      ...
      "Subfactorial", "Subresultants", "Subscript", "SubscriptBox", "Subset", "SubsetCases",
      ...
      "ToLowerCase", "Tooltip", "ToPolarCoordinates", "ToRadicals", "TortoiseShellBracket",
      ...
      "Transliterate", "Transpose", "TreeForm", "TreeGraph", "TreePlot", "Triangle",
      "TriangleCenter", "TrigExpand", "TrigFactor", "TrigReduce", "TrigSimplifyFu", "TrigToExp",
      "TrueQ", "TTest", "Tube", "TukeyWindow", "Tuples", "TwoWayRule", "UnaryMinusPlus",
