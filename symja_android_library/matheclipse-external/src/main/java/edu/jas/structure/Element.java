 ...
 *
 * <p><b>Note:</b> extension of <code>Cloneable</code> removed in 2012-08-18, <code>clone()</code>
 * is renamed to <code>copy()</code>. See also the discussion in <a
 * href="http://www.artima.com/intv/bloch13.html">Bloch on Cloning</a>.
 *
...
public interface Element<C extends Element<C>> extends Comparable<C>, Serializable {
  ...
  /**
   * Compare this to b. I.e. this &lt; b iff this.compareTo(b) &lt; 0. <b>Note:</b> may not be
   * meaningful if structure has no order.
   *
   * @param b
