...
public class AlgebraicFunctions extends AbstractRubiTestCase {
	...
	public void test0114() {
		check("Integrate[(a + b*x)^n/x^3, x]", "-((b^2*(a + b*x)^(1 + n)*Hypergeometric2F1[3, 1 + n, 2 + n, 1 + (b*x)/a])/(a^3*(1 + n)))", //
				65);
	}
	...
	public void test0116() {
		check("Integrate[(b*x)^m*(2 + d*x)^n, x]", "(2^n*(b*x)^(1 + m)*Hypergeometric2F1[1 + m, -n, 2 + m, -(d*x)/2])/(b*(1 + m))", //
				64);
	}

	// {65}
	public void test0117() {
		check("Integrate[(b*x)^m*(c - b*c*x)^n, x]", "-(((c - b*c*x)^(1 + n)*Hypergeometric2F1[-m, 1 + n, 2 + n, 1 - b*x])/(b*c*(1 + n)))", //
				65);
	}
	...
	public void test0139() {
		check("Integrate[1/((a - I*a*x)^(7/4)*(a + I*a*x)^(1/4)), x]", "(((-2*I)/3)*(a + I*a*x)^(3/4))/(a^2*(a - I*a*x)^(3/4))", //
				37);
	}
	...
	public void test0144() {
		check("Integrate[(a*c - b*c*x)^n/(a + b*x), x]", "-((a*c - b*c*x)^(1 + n)*Hypergeometric2F1[1, 1 + n, 2 + n, (a - b*x)/(2*a)])/(2*a*b*c*(1 + n))", //
				68);
	}

	// {68}
	public void test0145() {
		check("Integrate[(a*c - b*c*x)^n/(a + b*x)^2, x]", "-((a*c - b*c*x)^(1 + n)*Hypergeometric2F1[2, 1 + n, 2 + n, (a - b*x)/(2*a)])/(4*a^2*b*c*(1 + n))", //
				68);
	}
	...
	public void test0181() {
		check("Integrate[1/((a + b*x)^(2/3)*(c + d*x)^(1/3)), x]", "-((Sqrt[3]*ArcTan[1/Sqrt[3] + (2*b^(1/3)*(c + d*x)^(1/3))/(Sqrt[3]*d^(1/3)*(a + b*x)^(1/3))])/(b^(2/3)*d^(1/3))) - Log[a + b*x]/(2*b^(2/3)*d^(1/3)) - (3*Log[-1 + (b^(1/3)*(c + d*x)^(1/3))/(d^(1/3)*(a + b*x)^(1/3))])/(2*b^(2/3)*d^(1/3))", //
				59);
	}
	...
	public void test0183() {
		check("Integrate[1/((a + b*x)^(1/3)*(c + d*x)^(2/3)), x]", "-((Sqrt[3]*ArcTan[1/Sqrt[3] + (2*d^(1/3)*(a + b*x)^(1/3))/(Sqrt[3]*b^(1/3)*(c + d*x)^(1/3))])/(b^(1/3)*d^(2/3))) - Log[c + d*x]/(2*b^(1/3)*d^(2/3)) - (3*Log[-1 + (d^(1/3)*(a + b*x)^(1/3))/(b^(1/3)*(c + d*x)^(1/3))])/(2*b^(1/3)*d^(2/3))", //
				59);
	}
	...
	public void test0196() {
		check("Integrate[(a + b*x)^m/(c + d*x), x]", "((a + b*x)^(1 + m)*Hypergeometric2F1[1, 1 + m, 2 + m, -((d*(a + b*x))/(b*c - a*d))])/((b*c - a*d)*(1 + m))", //
				68);
	}

	// {68}
	public void test0197() {
		check("Integrate[(a + b*x)^m/(c + d*x)^2, x]", "(b*(a + b*x)^(1 + m)*Hypergeometric2F1[2, 1 + m, 2 + m, -((d*(a + b*x))/(b*c - a*d))])/((b*c - a*d)^2*(1 + m))", //
				68);
	}

	// {68}
	public void test0198() {
		check("Integrate[(a + b*x)^m/(c + d*x)^3, x]", "(b^2*(a + b*x)^(1 + m)*Hypergeometric2F1[3, 1 + m, 2 + m, -((d*(a + b*x))/(b*c - a*d))])/((b*c - a*d)^3*(1 + m))", //
				68);
	}
	...
	public void test0200() {
		check("Integrate[(c + d*x)^n/(a + b*x), x]", "-(((c + d*x)^(1 + n)*Hypergeometric2F1[1, 1 + n, 2 + n, (b*(c + d*x))/(b*c - a*d)])/((b*c - a*d)*(1 + n)))", //
				68);
	}

	// {68}
	public void test0201() {
		check("Integrate[(c + d*x)^n/(a + b*x)^2, x]", "(d*(c + d*x)^(1 + n)*Hypergeometric2F1[2, 1 + n, 2 + n, (b*(c + d*x))/(b*c - a*d)])/((b*c - a*d)^2*(1 + n))", //
				68);
	}

	// {68}
	public void test0202() {
		check("Integrate[(c + d*x)^n/(a + b*x)^3, x]", "-((d^2*(c + d*x)^(1 + n)*Hypergeometric2F1[3, 1 + n, 2 + n, (b*(c + d*x))/(b*c - a*d)])/((b*c - a*d)^3*(1 + n)))", //
				68);
	}
	...
	public void test0208() {
		check("Integrate[(1 - x)^n*(1 + x)^(7/3), x]", "(3*2^(-1 + n)*(1 + x)^(10/3)*Hypergeometric2F1[10/3, -n, 13/3, (1 + x)/2])/5", //
				69);
	}

	// {69}
	public void test0209() {
		check("Integrate[(1 - x)^(7/3)*(1 + x)^n, x]", "(-3*2^(-1 + n)*(1 - x)^(10/3)*Hypergeometric2F1[10/3, -n, 13/3, (1 - x)/2])/5", //
				69);
	}

	// {69}
	public void test0210() {
		check("Integrate[(2 + 3*x)^m/(1 + 2*x)^m, x]", "(2^(-1 - m)*(1 + 2*x)^(1 - m)*Hypergeometric2F1[1 - m, -m, 2 - m, -3*(1 + 2*x)])/(1 - m)", //
				69);
	}
	...
	public void test0251() {
		check("Integrate[1/(Sqrt[x]*Sqrt[2 - b*x]*Sqrt[2 + b*x]), x]", "(Sqrt[2]*EllipticF[ArcSin[(Sqrt[b]*Sqrt[x])/Sqrt[2]], -1])/Sqrt[b]", //
				116);
	}
	...
	public void test0253() {
		check("Integrate[1/(Sqrt[e*x]*Sqrt[2 - b*x]*Sqrt[2 + b*x]), x]", "(Sqrt[2]*EllipticF[ArcSin[(Sqrt[b]*Sqrt[e*x])/(Sqrt[2]*Sqrt[e])], -1])/(Sqrt[b]*Sqrt[e])", //
				116);
	}

	// {115}
	public void test0254() {
		check("Integrate[1/(Sqrt[2 - 3*x]*Sqrt[x]*Sqrt[2 + 3*x]), x]", "Sqrt[2/3]*EllipticF[ArcSin[Sqrt[3/2]*Sqrt[x]], -1]", //
				115);
	}
	...
	public void test0256() {
		check("Integrate[1/(Sqrt[2 - 3*x]*Sqrt[e*x]*Sqrt[2 + 3*x]), x]", "(Sqrt[2/3]*EllipticF[ArcSin[(Sqrt[3/2]*Sqrt[e*x])/Sqrt[e]], -1])/Sqrt[e]", //
				116);
	}
	...
	public void test0258() {
		check("Integrate[1/(Sqrt[b*x]*Sqrt[1 - c*x]*Sqrt[1 + c*x]), x]", "(2*EllipticF[ArcSin[(Sqrt[c]*Sqrt[b*x])/Sqrt[b]], -1])/(Sqrt[b]*Sqrt[c])", //
				116);
	}

	// {116}
	public void test0259() {
		check("Integrate[1/(Sqrt[b*x]*Sqrt[1 - c*x]*Sqrt[1 + d*x]), x]", "(2*EllipticF[ArcSin[(Sqrt[c]*Sqrt[b*x])/Sqrt[b]], -(d/c)])/(Sqrt[b]*Sqrt[c])", //
				116);
	}
	...
	public void test0261() {
		check("Integrate[Sqrt[1 + c*x]/(Sqrt[b*x]*Sqrt[1 - c*x]), x]", "(2*EllipticE[ArcSin[(Sqrt[c]*Sqrt[b*x])/Sqrt[b]], -1])/(Sqrt[b]*Sqrt[c])", //
				110);
	}

	// {110}
	public void test0262() {
		check("Integrate[Sqrt[1 + c*x]/(Sqrt[b*x]*Sqrt[1 - d*x]), x]", "(2*EllipticE[ArcSin[(Sqrt[d]*Sqrt[b*x])/Sqrt[b]], -(c/d)])/(Sqrt[b]*Sqrt[d])", //
				110);
	}
	...
	public void test0265() {
		check("Integrate[1/((1 - x)^(1/3)*(2 - x)^(1/3)*x), x]", "-(Sqrt[3]*ArcTan[1/Sqrt[3] + (2^(1/3)*(2 - x)^(2/3))/(Sqrt[3]*(1 - x)^(1/3))])/(2*2^(1/3)) + (3*Log[-(1 - x)^(1/3) + (2 - x)^(2/3)/2^(2/3)])/(4*2^(1/3)) - Log[x]/(2*2^(1/3))", //
				123);
	}

	// {95}
	public void test0266() {
		check("Integrate[1/((1 - x)^(1/4)*(e*x)^(5/2)*(1 + x)^(1/4)), x]", "(-2*(1 - x)^(3/4)*(1 + x)^(3/4))/(3*e*(e*x)^(3/2))", //
				95);
	}
	...
	public void test0268() {
		check("Integrate[(a + b*x)^n/(c + d*x), x]", "((a + b*x)^(1 + n)*Hypergeometric2F1[1, 1 + n, 2 + n, -((d*(a + b*x))/(b*c - a*d))])/((b*c - a*d)*(1 + n))", //
				68);
	}

	// {68}
	public void test0269() {
		check("Integrate[(a + b*x)^n/(c + d*x)^2, x]", "(b*(a + b*x)^(1 + n)*Hypergeometric2F1[2, 1 + n, 2 + n, -((d*(a + b*x))/(b*c - a*d))])/((b*c - a*d)^2*(1 + n))", //
				68);
	}

	// {133}
	public void test0270() {
		check("Integrate[(b*x)^m*(Pi + d*x)^n*(E + f*x)^p, x]", "(E^p*Pi^n*(b*x)^(1 + m)*AppellF1[1 + m, -n, -p, 2 + m, -((d*x)/Pi), -((f*x)/E)])/(b*(1 + m))", //
				133);
	}

	// {133}
	public void test0271() {
		check("Integrate[(b*x)^(5/2)*(Pi + d*x)^n*(E + f*x)^p, x]", "(2*E^p*Pi^n*(b*x)^(7/2)*AppellF1[7/2, -n, -p, 9/2, -((d*x)/Pi), -((f*x)/E)])/(7*b)", //
				133);
	}

	// {131}
	public void test0272() {
		check("Integrate[(a + b*x)^n/(x^2*(c + d*x)^n), x]", "((b*c - a*d)*(a + b*x)^(1 + n)*(c + d*x)^(-1 - n)*Hypergeometric2F1[2, 1 + n, 2 + n, (c*(a + b*x))/(a*(c + d*x))])/(a^2*(1 + n))", //
				131);
	}
	...
	public void test0274() {
		check("Integrate[(1 - x)^n/(x^2*(1 + x)^n), x]", "(-2*(1 - x)^(1 + n)*(1 + x)^(-1 - n)*Hypergeometric2F1[2, 1 + n, 2 + n, (1 - x)/(1 + x)])/(1 + n)", //
				131);
	}

	// {132}
	public void test0275() {
		check("Integrate[((1 - x)^(-1/2 + p)*(1 + x)^(1/2 + p))/(c*x)^(2*(1 + p)), x]", "-((4^(1 + p)*(1 - x)^(1/2 + p)*(x/(1 + x))^(2*(1 + p))*(1 + x)^(3/2 + p)*Hypergeometric2F1[1/2 + p, 2*(1 + p), 3/2 + p, (1 - x)/(1 + x)])/((1 + 2*p)*(c*x)^(2*(1 + p))))", //
				132);
	}

	// {131}
	public void test0276() {
		check("Integrate[(1 + x/a)^(n/2)/(x^2*(1 - x/a)^(n/2)), x]", "(-4*(1 - x/a)^(1 - n/2)*(1 + x/a)^((-2 + n)/2)*Hypergeometric2F1[2, 1 - n/2, 2 - n/2, (a - x)/(a + x)])/(a*(2 - n))", //
				131);
	}
	...
	public void test0280() {
		check("Integrate[x^2*(1 - a*x)^(-1 - (n*(1 + n))/2)*(1 + a*x)^(-1 - ((-1 + n)*n)/2), x]", "((1 + a*x)^(((1 - n)*n)/2)*(1 - a*n*x))/(a^3*n*(1 - n^2)*(1 - a*x)^((n*(1 + n))/2))", //
				81);
	}
	...
	public void test0289() {
		check("Integrate[1/(Sqrt[a + b*x]*Sqrt[c + (b*(-1 + c)*x)/a]*Sqrt[e + (b*(-1 + e)*x)/a]), x]", "(2*Sqrt[a]*EllipticF[ArcSin[(Sqrt[1 - c]*Sqrt[a + b*x])/Sqrt[a]], (1 - e)/(1 - c)])/(b*Sqrt[1 - c])", //
				119);
	}

	// {113}
	public void test0290() {
		check("Integrate[Sqrt[e + (b*(-1 + e)*x)/a]/(Sqrt[a + b*x]*Sqrt[c + (b*(-1 + c)*x)/a]), x]", "(2*Sqrt[a]*EllipticE[ArcSin[(Sqrt[1 - c]*Sqrt[a + b*x])/Sqrt[a]], (1 - e)/(1 - c)])/(b*Sqrt[1 - c])", //
				113);
	}

	// {113}
	public void test0291() {
		check("Integrate[Sqrt[1 - 2*x]/(Sqrt[-3 - 5*x]*Sqrt[2 + 3*x]), x]", "(2*Sqrt[7/5]*EllipticE[ArcSin[Sqrt[5]*Sqrt[2 + 3*x]], 2/35])/3", //
				113);
	}

	// {113}
	public void test0292() {
		check("Integrate[Sqrt[3 + 5*x]/(Sqrt[1 - 2*x]*Sqrt[2 + 3*x]), x]", "-(Sqrt[11/3]*EllipticE[ArcSin[Sqrt[3/7]*Sqrt[1 - 2*x]], 35/33])", //
				113);
	}
	...
	public void test0298() {
		check("Integrate[1/(Sqrt[1 - x]*Sqrt[3 - x]*Sqrt[2 + x]), x]", "(2*EllipticF[ArcSin[Sqrt[2 + x]/Sqrt[3]], 3/5])/Sqrt[5]", //
				119);
	}
	...
	public void test0303() {
		check("Integrate[Sqrt[2 + 3*x]/(Sqrt[1 - 2*x]*Sqrt[3 + 5*x]), x]", "-(Sqrt[7/5]*EllipticE[ArcSin[Sqrt[5/11]*Sqrt[1 - 2*x]], 33/35])", //
				113);
	}

	// {119}
	public void test0304() {
		check("Integrate[1/(Sqrt[1 - 2*x]*Sqrt[2 + 3*x]*Sqrt[3 + 5*x]), x]", "(-2*EllipticF[ArcSin[Sqrt[3/7]*Sqrt[1 - 2*x]], 35/33])/Sqrt[33]", //
				119);
	}
	...
	public void test0308() {
		check("Integrate[1/((a + b*x)^(1/3)*(c + d*x)^(2/3)*(e + f*x)), x]", "-((Sqrt[3]*ArcTan[1/Sqrt[3] + (2*(d*e - c*f)^(1/3)*(a + b*x)^(1/3))/(Sqrt[3]*(b*e - a*f)^(1/3)*(c + d*x)^(1/3))])/((b*e - a*f)^(1/3)*(d*e - c*f)^(2/3))) + Log[e + f*x]/(2*(b*e - a*f)^(1/3)*(d*e - c*f)^(2/3)) - (3*Log[((d*e - c*f)^(1/3)*(a + b*x)^(1/3))/(b*e - a*f)^(1/3) - (c + d*x)^(1/3)])/(2*(b*e - a*f)^(1/3)*(d*e - c*f)^(2/3))", //
				91);
	}

	// {123}
	public void test0309() {
		check("Integrate[1/((a + b*x)*(c + d*x)^(1/3)*(b*c + a*d + 2*b*d*x)^(1/3)), x]", "-(Sqrt[3]*ArcTan[1/Sqrt[3] + (2*b^(2/3)*(c + d*x)^(2/3))/(Sqrt[3]*(b*c - a*d)^(1/3)*(b*c + a*d + 2*b*d*x)^(1/3))])/(2*b^(2/3)*(b*c - a*d)^(2/3)) - Log[a + b*x]/(2*b^(2/3)*(b*c - a*d)^(2/3)) + (3*Log[(b^(2/3)*(c + d*x)^(2/3))/(b*c - a*d)^(1/3) - (b*c + a*d + 2*b*d*x)^(1/3)])/(4*b^(2/3)*(b*c - a*d)^(2/3))", //
				123);
	}

	// {74}
	public void test0310() {
		check("Integrate[(a + b*x)/((c + d*x)^(1/3)*(b*c + a*d + 2*b*d*x)^(4/3)), x]", "(3*(c + d*x)^(2/3))/(2*d^2*(b*c + a*d + 2*b*d*x)^(1/3))", //
				74);
	}

	// {123}
	public void test0311() {
		check("Integrate[1/((d - 3*e*x)^(1/3)*(d + e*x)*(d + 3*e*x)^(1/3)), x]", "(Sqrt[3]*ArcTan[1/Sqrt[3] - (d - 3*e*x)^(2/3)/(Sqrt[3]*d^(1/3)*(d + 3*e*x)^(1/3))])/(4*d^(2/3)*e) + Log[d + e*x]/(4*d^(2/3)*e) - (3*Log[-(d - 3*e*x)^(2/3)/(2*d^(1/3)) - (d + 3*e*x)^(1/3)])/(8*d^(2/3)*e)", //
				123);
	}

	// {131}
	public void test0312() {
		check("Integrate[(a + b*x)^m/((c + d*x)^m*(e + f*x)^2), x]", "((b*c - a*d)*(a + b*x)^(1 + m)*(c + d*x)^(-1 - m)*Hypergeometric2F1[2, 1 + m, 2 + m, ((d*e - c*f)*(a + b*x))/((b*e - a*f)*(c + d*x))])/((b*e - a*f)^2*(1 + m))", //
				131);
	}

	// {131}
	public void test0313() {
		check("Integrate[((a + b*x)^m*(c + d*x)^(-1 - m))/(e + f*x), x]", "((a + b*x)^(1 + m)*(c + d*x)^(-1 - m)*Hypergeometric2F1[1, 1 + m, 2 + m, ((d*e - c*f)*(a + b*x))/((b*e - a*f)*(c + d*x))])/((b*e - a*f)*(1 + m))", //
				131);
	}
	...
	public void test0315() {
		check("Integrate[((a + b*x)^m*(c + d*x)^(1 - m))/(e + f*x)^3, x]", "((b*c - a*d)^2*(a + b*x)^(1 + m)*(c + d*x)^(-1 - m)*Hypergeometric2F1[3, 1 + m, 2 + m, ((d*e - c*f)*(a + b*x))/((b*e - a*f)*(c + d*x))])/((b*e - a*f)^3*(1 + m))", //
				131);
	}

	// {131}
	public void test0316() {
		check("Integrate[((a + b*x)^m*(c + d*x)^(2 - m))/(e + f*x)^4, x]", "((b*c - a*d)^3*(a + b*x)^(1 + m)*(c + d*x)^(-1 - m)*Hypergeometric2F1[4, 1 + m, 2 + m, ((d*e - c*f)*(a + b*x))/((b*e - a*f)*(c + d*x))])/((b*e - a*f)^4*(1 + m))", //
				131);
	}

	// {132}
	public void test0317() {
		check("Integrate[(a + b*x)^m*(c + d*x)^(-m - n)*(e + f*x)^(-2 + n), x]", "((a + b*x)^(1 + m)*(c + d*x)^(-m - n)*(((b*e - a*f)*(c + d*x))/((b*c - a*d)*(e + f*x)))^(m + n)*(e + f*x)^(-1 + n)*Hypergeometric2F1[1 + m, m + n, 2 + m, -(((d*e - c*f)*(a + b*x))/((b*c - a*d)*(e + f*x)))])/((b*e - a*f)*(1 + m))", //
				132);
	}

	// {95}
	public void test0318() {
		check("Integrate[(a + b*x)^m*(c + d*x)^n*((b*c*f + a*d*f + a*d*f*m + b*c*f*n)/(b*d*(2 + m + n)) + f*x)^(-3 - m - n), x]", "(b*d*(2 + m + n)*(a + b*x)^(1 + m)*(c + d*x)^(1 + n)*((f*(a*d*(1 + m) + b*c*(1 + n)))/(b*d*(2 + m + n)) + f*x)^(-2 - m - n))/((b*c - a*d)^2*f*(1 + m)*(1 + n))", //
				95);
	}

	// {95}
	public void test0319() {
		check("Integrate[(a + b*x)^m*(c + d*x)^(-1 - (d*(b*e - a*f)*(1 + m))/(b*(d*e - c*f)))*(e + f*x)^(-1 + ((b*c - a*d)*f*(1 + m))/(b*(d*e - c*f))), x]", "(b*(a + b*x)^(1 + m)*(e + f*x)^(((b*c - a*d)*f*(1 + m))/(b*(d*e - c*f))))/((b*c - a*d)*(b*e - a*f)*(1 + m)*(c + d*x)^((d*(b*e - a*f)*(1 + m))/(b*(d*e - c*f))))", //
				95);
	}

	// {132}
	public void test0320() {
		check("Integrate[(a + b*x)^m*(c + d*x)^n*(e + f*x)^(-2 - m - n), x]", "((a + b*x)^(1 + m)*(c + d*x)^n*(e + f*x)^(-1 - m - n)*Hypergeometric2F1[1 + m, -n, 2 + m, -(((d*e - c*f)*(a + b*x))/((b*c - a*d)*(e + f*x)))])/((b*e - a*f)*(1 + m)*(((b*e - a*f)*(c + d*x))/((b*c - a*d)*(e + f*x)))^n)", //
				132);
	}

	// {138}
	public void test0321() {
		check("Integrate[(3 + 4*x)^n/(Sqrt[1 - x]*Sqrt[1 + x]), x]", "-(Sqrt[2]*7^n*Sqrt[1 - x]*AppellF1[1/2, 1/2, -n, 3/2, (1 - x)/2, (4*(1 - x))/7])", //
				138);
	}

	// {138}
	public void test0322() {
		check("Integrate[(3 - 4*x)^n/(Sqrt[1 - x]*Sqrt[1 + x]), x]", "Sqrt[2]*7^n*Sqrt[1 + x]*AppellF1[1/2, -n, 1/2, 3/2, (4*(1 + x))/7, (1 + x)/2]", //
				138);
	}

	// {138}
	public void test0323() {
		check("Integrate[(-3 + 4*x)^n/(Sqrt[1 - x]*Sqrt[1 + x]), x]", "-(Sqrt[2]*Sqrt[1 - x]*AppellF1[1/2, 1/2, -n, 3/2, (1 - x)/2, 4*(1 - x)])", //
				138);
	}

	// {138}
	public void test0324() {
		check("Integrate[(-3 - 4*x)^n/(Sqrt[1 - x]*Sqrt[1 + x]), x]", "Sqrt[2]*Sqrt[1 + x]*AppellF1[1/2, -n, 1/2, 3/2, 4*(1 + x), (1 + x)/2]", //
				138);
	}

	// {68}
	public void test0325() {
		check("Integrate[(a + b*x)^m/(e + f*x)^2, x]", "(b*(a + b*x)^(1 + m)*Hypergeometric2F1[2, 1 + m, 2 + m, -((f*(a + b*x))/(b*e - a*f))])/((b*e - a*f)^2*(1 + m))", //
				68);
	}
	...
	public void test0352() {
		check("Integrate[(c*(a - d) - (b - c)*x^2)^(-1), x]", "ArcTanh[(Sqrt[b - c]*x)/(Sqrt[c]*Sqrt[a - d])]/(Sqrt[b - c]*Sqrt[c]*Sqrt[a - d])", //
				208);
	}

	// {364}
	public void test0353() {
		check("Integrate[x^m/(a + b*x^2), x]", "(x^(1 + m)*Hypergeometric2F1[1, (1 + m)/2, (3 + m)/2, -((b*x^2)/a)])/(a*(1 + m))", //
				364);
	}

	// {364}
	public void test0354() {
		check("Integrate[x^m/(a + b*x^2)^2, x]", "(x^(1 + m)*Hypergeometric2F1[2, (1 + m)/2, (3 + m)/2, -((b*x^2)/a)])/(a^2*(1 + m))", //
				364);
	}

	// {364}
	public void test0355() {
		check("Integrate[x^m/(a + b*x^2)^3, x]", "(x^(1 + m)*Hypergeometric2F1[3, (1 + m)/2, (3 + m)/2, -((b*x^2)/a)])/(a^3*(1 + m))", //
				364);
	}

	// {364}
	public void test0356() {
		check("Integrate[(c*x)^(1 + m)/(a + b*x^2), x]", "((c*x)^(2 + m)*Hypergeometric2F1[1, (2 + m)/2, (4 + m)/2, -((b*x^2)/a)])/(a*c*(2 + m))", //
				364);
	}

	// {364}
	public void test0357() {
		check("Integrate[(c*x)^m/(a + b*x^2), x]", "((c*x)^(1 + m)*Hypergeometric2F1[1, (1 + m)/2, (3 + m)/2, -((b*x^2)/a)])/(a*c*(1 + m))", //
				364);
	}

	// {364}
	public void test0358() {
		check("Integrate[(c*x)^(-1 + m)/(a + b*x^2), x]", "((c*x)^m*Hypergeometric2F1[1, m/2, (2 + m)/2, -((b*x^2)/a)])/(a*c*m)", //
				364);
	}

	// {364}
	public void test0359() {
		check("Integrate[(c*x)^(-2 + m)/(a + b*x^2), x]", "-(((c*x)^(-1 + m)*Hypergeometric2F1[1, (-1 + m)/2, (1 + m)/2, -((b*x^2)/a)])/(a*c*(1 - m)))", //
				364);
	}

	// {364}
	public void test0360() {
		check("Integrate[(c*x)^(-3 + m)/(a + b*x^2), x]", "-(((c*x)^(-2 + m)*Hypergeometric2F1[1, (-2 + m)/2, m/2, -((b*x^2)/a)])/(a*c*(2 - m)))", //
				364);
	}

	// {364}
	public void test0361() {
		check("Integrate[x^m/(1 + (a*x^2)/b)^2, x]", "(x^(1 + m)*Hypergeometric2F1[2, (1 + m)/2, (3 + m)/2, -((a*x^2)/b)])/(1 + m)", //
				364);
	}
	...
	public void test0425() {
		check("Integrate[1/((a - b*x^2)^(1/3)*(3*a + b*x^2)), x]", "ArcTan[(Sqrt[3]*Sqrt[a])/(Sqrt[b]*x)]/(2*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b]) + ArcTan[(Sqrt[3]*a^(1/6)*(a^(1/3) - 2^(1/3)*(a - b*x^2)^(1/3)))/(Sqrt[b]*x)]/(2*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b]) - ArcTanh[(Sqrt[b]*x)/Sqrt[a]]/(6*2^(2/3)*a^(5/6)*Sqrt[b]) + ArcTanh[(Sqrt[b]*x)/(a^(1/6)*(a^(1/3) + 2^(1/3)*(a - b*x^2)^(1/3)))]/(2*2^(2/3)*a^(5/6)*Sqrt[b])", //
				393);
	}

	// {393}
	public void test0426() {
		check("Integrate[1/((-3*a - b*x^2)*(-a + b*x^2)^(1/3)), x]", "-ArcTan[(Sqrt[3]*Sqrt[a])/(Sqrt[b]*x)]/(2*2^(2/3)*Sqrt[3]*(-a)^(1/3)*Sqrt[a]*Sqrt[b]) - ArcTan[(Sqrt[3]*Sqrt[a]*((-a)^(1/3) - 2^(1/3)*(-a + b*x^2)^(1/3)))/((-a)^(1/3)*Sqrt[b]*x)]/(2*2^(2/3)*Sqrt[3]*(-a)^(1/3)*Sqrt[a]*Sqrt[b]) + ArcTanh[(Sqrt[b]*x)/Sqrt[a]]/(6*2^(2/3)*(-a)^(1/3)*Sqrt[a]*Sqrt[b]) - ArcTanh[((-a)^(1/3)*Sqrt[b]*x)/(Sqrt[a]*((-a)^(1/3) + 2^(1/3)*(-a + b*x^2)^(1/3)))]/(2*2^(2/3)*(-a)^(1/3)*Sqrt[a]*Sqrt[b])", //
				393);
	}

	// {392}
	public void test0427() {
		check("Integrate[1/((3*a - b*x^2)*(a + b*x^2)^(1/3)), x]", "-ArcTan[(Sqrt[b]*x)/Sqrt[a]]/(6*2^(2/3)*a^(5/6)*Sqrt[b]) + ArcTan[(Sqrt[b]*x)/(a^(1/6)*(a^(1/3) + 2^(1/3)*(a + b*x^2)^(1/3)))]/(2*2^(2/3)*a^(5/6)*Sqrt[b]) - ArcTanh[(Sqrt[3]*Sqrt[a])/(Sqrt[b]*x)]/(2*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b]) - ArcTanh[(Sqrt[3]*a^(1/6)*(a^(1/3) - 2^(1/3)*(a + b*x^2)^(1/3)))/(Sqrt[b]*x)]/(2*2^(2/3)*Sqrt[3]*a^(5/6)*Sqrt[b])", //
				392);
	}

	// {392}
	public void test0428() {
		check("Integrate[1/((c - d*x^2)*(c + 3*d*x^2)^(1/3)), x]", "-ArcTan[(Sqrt[3]*Sqrt[d]*x)/Sqrt[c]]/(2*2^(2/3)*Sqrt[3]*c^(5/6)*Sqrt[d]) + (Sqrt[3]*ArcTan[(Sqrt[3]*Sqrt[d]*x)/(c^(1/6)*(c^(1/3) + 2^(1/3)*(c + 3*d*x^2)^(1/3)))])/(2*2^(2/3)*c^(5/6)*Sqrt[d]) - ArcTanh[Sqrt[c]/(Sqrt[d]*x)]/(2*2^(2/3)*c^(5/6)*Sqrt[d]) - ArcTanh[(c^(1/6)*(c^(1/3) - 2^(1/3)*(c + 3*d*x^2)^(1/3)))/(Sqrt[d]*x)]/(2*2^(2/3)*c^(5/6)*Sqrt[d])", //
				392);
	}
	...
	public void test0430() {
		check("Integrate[1/((c - 3*d*x^2)^(1/3)*(c + d*x^2)), x]", "ArcTan[Sqrt[c]/(Sqrt[d]*x)]/(2*2^(2/3)*c^(5/6)*Sqrt[d]) + ArcTan[(c^(1/6)*(c^(1/3) - 2^(1/3)*(c - 3*d*x^2)^(1/3)))/(Sqrt[d]*x)]/(2*2^(2/3)*c^(5/6)*Sqrt[d]) - ArcTanh[(Sqrt[3]*Sqrt[d]*x)/Sqrt[c]]/(2*2^(2/3)*Sqrt[3]*c^(5/6)*Sqrt[d]) + (Sqrt[3]*ArcTanh[(Sqrt[3]*Sqrt[d]*x)/(c^(1/6)*(c^(1/3) + 2^(1/3)*(c - 3*d*x^2)^(1/3)))])/(2*2^(2/3)*c^(5/6)*Sqrt[d])", //
				393);
	}

	// {393}
	public void test0431() {
		check("Integrate[1/((1 - x^2)^(1/3)*(3 + x^2)), x]", "ArcTan[Sqrt[3]/x]/(2*2^(2/3)*Sqrt[3]) + ArcTan[(Sqrt[3]*(1 - 2^(1/3)*(1 - x^2)^(1/3)))/x]/(2*2^(2/3)*Sqrt[3]) - ArcTanh[x]/(6*2^(2/3)) + ArcTanh[x/(1 + 2^(1/3)*(1 - x^2)^(1/3))]/(2*2^(2/3))", //
				393);
	}

	// {392}
	public void test0432() {
		check("Integrate[1/((3 - x^2)*(1 + x^2)^(1/3)), x]", "-ArcTan[x]/(6*2^(2/3)) + ArcTan[x/(1 + 2^(1/3)*(1 + x^2)^(1/3))]/(2*2^(2/3)) - ArcTanh[Sqrt[3]/x]/(2*2^(2/3)*Sqrt[3]) - ArcTanh[(Sqrt[3]*(1 - 2^(1/3)*(1 + x^2)^(1/3)))/x]/(2*2^(2/3)*Sqrt[3])", //
				392);
	}

	// {1008}
	public void test0433() {
		check("Integrate[(3 - x)/((1 - x^2)^(1/3)*(3 + x^2)), x]", "-((Sqrt[3]*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 + x)^(2/3))/(Sqrt[3]*(1 - x)^(1/3))])/2^(2/3)) - Log[3 + x^2]/(2*2^(2/3)) + (3*Log[2^(1/3)*(1 - x)^(1/3) + (1 + x)^(2/3)])/(2*2^(2/3))", //
				1008);
	}

	// {1008}
	public void test0434() {
		check("Integrate[(3 + x)/((1 - x^2)^(1/3)*(3 + x^2)), x]", "(Sqrt[3]*ArcTan[1/Sqrt[3] - (2^(2/3)*(1 - x)^(2/3))/(Sqrt[3]*(1 + x)^(1/3))])/2^(2/3) + Log[3 + x^2]/(2*2^(2/3)) - (3*Log[(1 - x)^(2/3) + 2^(1/3)*(1 + x)^(1/3)])/(2*2^(2/3))", //
				1008);
	}

	// {394}
	public void test0435() {
		check("Integrate[1/((a + b*x^2)^(1/3)*((9*a*d)/b + d*x^2)), x]", "(Sqrt[b]*ArcTan[(Sqrt[b]*x)/(3*Sqrt[a])])/(12*a^(5/6)*d) + (Sqrt[b]*ArcTan[(a^(1/3) - (a + b*x^2)^(1/3))^2/(3*a^(1/6)*Sqrt[b]*x)])/(12*a^(5/6)*d) - (Sqrt[b]*ArcTanh[(Sqrt[3]*a^(1/6)*(a^(1/3) - (a + b*x^2)^(1/3)))/(Sqrt[b]*x)])/(4*Sqrt[3]*a^(5/6)*d)", //
				394);
	}

	// {395}
	public void test0436() {
		check("Integrate[1/((a - b*x^2)^(1/3)*((-9*a*d)/b + d*x^2)), x]", "-(Sqrt[b]*ArcTan[(Sqrt[3]*a^(1/6)*(a^(1/3) - (a - b*x^2)^(1/3)))/(Sqrt[b]*x)])/(4*Sqrt[3]*a^(5/6)*d) - (Sqrt[b]*ArcTanh[(Sqrt[b]*x)/(3*Sqrt[a])])/(12*a^(5/6)*d) + (Sqrt[b]*ArcTanh[(a^(1/3) - (a - b*x^2)^(1/3))^2/(3*a^(1/6)*Sqrt[b]*x)])/(12*a^(5/6)*d)", //
				395);
	}
	...
	public void test0439() {
		check("Integrate[1/((2 + b*x^2)^(1/3)*((18*d)/b + d*x^2)), x]", "(Sqrt[b]*ArcTan[(Sqrt[b]*x)/(3*Sqrt[2])])/(12*2^(5/6)*d) + (Sqrt[b]*ArcTan[(2^(1/3) - (2 + b*x^2)^(1/3))^2/(3*2^(1/6)*Sqrt[b]*x)])/(12*2^(5/6)*d) - (Sqrt[b]*ArcTanh[(2^(1/6)*Sqrt[3]*(2^(1/3) - (2 + b*x^2)^(1/3)))/(Sqrt[b]*x)])/(4*2^(5/6)*Sqrt[3]*d)", //
				394);
	}

	// {395}
	public void test0440() {
		check("Integrate[1/((-2 + b*x^2)^(1/3)*((-18*d)/b + d*x^2)), x]", "(Sqrt[b]*ArcTan[(2^(1/6)*Sqrt[3]*(2^(1/3) + (-2 + b*x^2)^(1/3)))/(Sqrt[b]*x)])/(4*2^(5/6)*Sqrt[3]*d) + (Sqrt[b]*ArcTanh[(Sqrt[b]*x)/(3*Sqrt[2])])/(12*2^(5/6)*d) - (Sqrt[b]*ArcTanh[(2^(1/3) + (-2 + b*x^2)^(1/3))^2/(3*2^(1/6)*Sqrt[b]*x)])/(12*2^(5/6)*d)", //
				395);
	}

	// {394}
	public void test0441() {
		check("Integrate[1/((2 + 3*x^2)^(1/3)*(6*d + d*x^2)), x]", "ArcTan[x/Sqrt[6]]/(4*2^(5/6)*Sqrt[3]*d) + ArcTan[(2^(1/3) - (2 + 3*x^2)^(1/3))^2/(3*2^(1/6)*Sqrt[3]*x)]/(4*2^(5/6)*Sqrt[3]*d) - ArcTanh[(2^(1/6)*(2^(1/3) - (2 + 3*x^2)^(1/3)))/x]/(4*2^(5/6)*d)", //
				394);
	}

	// {395}
	public void test0442() {
		check("Integrate[1/((2 - 3*x^2)^(1/3)*(-6*d + d*x^2)), x]", "-ArcTan[(2^(1/6)*(2^(1/3) - (2 - 3*x^2)^(1/3)))/x]/(4*2^(5/6)*d) - ArcTanh[x/Sqrt[6]]/(4*2^(5/6)*Sqrt[3]*d) + ArcTanh[(2^(1/3) - (2 - 3*x^2)^(1/3))^2/(3*2^(1/6)*Sqrt[3]*x)]/(4*2^(5/6)*Sqrt[3]*d)", //
				395);
	}
	...
	public void test0445() {
		check("Integrate[1/((1 + x^2)^(1/3)*(9 + x^2)), x]", "ArcTan[x/3]/12 + ArcTan[(1 - (1 + x^2)^(1/3))^2/(3*x)]/12 - ArcTanh[(Sqrt[3]*(1 - (1 + x^2)^(1/3)))/x]/(4*Sqrt[3])", //
				394);
	}

	// {394}
	public void test0446() {
		check("Integrate[1/((1 + b*x^2)^(1/3)*(9 + b*x^2)), x]", "ArcTan[(Sqrt[b]*x)/3]/(12*Sqrt[b]) + ArcTan[(1 - (1 + b*x^2)^(1/3))^2/(3*Sqrt[b]*x)]/(12*Sqrt[b]) - ArcTanh[(Sqrt[3]*(1 - (1 + b*x^2)^(1/3)))/(Sqrt[b]*x)]/(4*Sqrt[3]*Sqrt[b])", //
				394);
	}

	// {395}
	public void test0447() {
		check("Integrate[1/((1 - x^2)^(1/3)*(9 - x^2)), x]", "ArcTan[(Sqrt[3]*(1 - (1 - x^2)^(1/3)))/x]/(4*Sqrt[3]) + ArcTanh[x/3]/12 - ArcTanh[(1 - (1 - x^2)^(1/3))^2/(3*x)]/12", //
				395);
	}

	// {411}
	public void test0448() {
		check("Integrate[Sqrt[c + d*x^2]/(a + b*x^2)^(3/2), x]", "(Sqrt[c + d*x^2]*EllipticE[ArcTan[(Sqrt[b]*x)/Sqrt[a]], 1 - (a*d)/(b*c)])/(Sqrt[a]*Sqrt[b]*Sqrt[a + b*x^2]*Sqrt[(a*(c + d*x^2))/(c*(a + b*x^2))])", //
				411);
	}
	...
	public void test0456() {
		check("Integrate[1/(Sqrt[a + b*x^2]*Sqrt[c + d*x^2]), x]", "(Sqrt[c]*Sqrt[a + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(a*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])", //
				418);
	}

	// {411}
	public void test0457() {
		check("Integrate[Sqrt[a + b*x^2]/(c + d*x^2)^(3/2), x]", "(Sqrt[a + b*x^2]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[c]*Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]*Sqrt[c + d*x^2])", //
				411);
	}
	...
	public void test0467() {
		check("Integrate[1/(Sqrt[1 + x^2]*Sqrt[2 + 5*x^2]), x]", "(Sqrt[2 + 5*x^2]*EllipticF[ArcTan[x], -3/2])/(Sqrt[2]*Sqrt[1 + x^2]*Sqrt[(2 + 5*x^2)/(1 + x^2)])", //
				418);
	}

	// {418}
	public void test0468() {
		check("Integrate[1/(Sqrt[1 + x^2]*Sqrt[2 + 4*x^2]), x]", "(Sqrt[1 + 2*x^2]*EllipticF[ArcTan[x], -1])/(Sqrt[2]*Sqrt[1 + x^2]*Sqrt[(1 + 2*x^2)/(1 + x^2)])", //
				418);
	}

	// {418}
	public void test0469() {
		check("Integrate[1/(Sqrt[1 + x^2]*Sqrt[2 + 3*x^2]), x]", "(Sqrt[2 + 3*x^2]*EllipticF[ArcTan[x], -1/2])/(Sqrt[2]*Sqrt[1 + x^2]*Sqrt[(2 + 3*x^2)/(1 + x^2)])", //
				418);
	}

	// {418}
	public void test0470() {
		check("Integrate[1/(Sqrt[1 + x^2]*Sqrt[2 + x^2]), x]", "(Sqrt[2 + x^2]*EllipticF[ArcTan[x], 1/2])/(Sqrt[2]*Sqrt[1 + x^2]*Sqrt[(2 + x^2)/(1 + x^2)])", //
				418);
	}
	...
	public void test0480() {
		check("Integrate[1/(Sqrt[2 + b*x^2]*Sqrt[3 + d*x^2]), x]", "(Sqrt[2 + b*x^2]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[3]], 1 - (3*b)/(2*d)])/(Sqrt[2]*Sqrt[d]*Sqrt[(2 + b*x^2)/(3 + d*x^2)]*Sqrt[3 + d*x^2])", //
				418);
	}

	// {418}
	public void test0481() {
		check("Integrate[1/(Sqrt[4 + x^2]*Sqrt[c + d*x^2]), x]", "(Sqrt[c + d*x^2]*EllipticF[ArcTan[x/2], 1 - (4*d)/c])/(c*Sqrt[4 + x^2]*Sqrt[(c + d*x^2)/(c*(4 + x^2))])", //
				418);
	}
	...
	public void test0484() {
		check("Integrate[Sqrt[1 + (2*c*x^2)/(b - Sqrt[b^2 - 4*a*c])]/Sqrt[1 - (2*c*x^2)/(b + Sqrt[b^2 - 4*a*c])], x]", "(Sqrt[b + Sqrt[b^2 - 4*a*c]]*EllipticE[ArcSin[(Sqrt[2]*Sqrt[c]*x)/Sqrt[b + Sqrt[b^2 - 4*a*c]]], -((b + Sqrt[b^2 - 4*a*c])/(b - Sqrt[b^2 - 4*a*c]))])/(Sqrt[2]*Sqrt[c])", //
				424);
	}
	...
	public void test0486() {
		check("Integrate[1/(Sqrt[3 - 3*Sqrt[3] + 2*Sqrt[3]*x^2]*Sqrt[3 + (-3 + Sqrt[3])*x^2]), x]", "-(Sqrt[3 + Sqrt[3]]*EllipticF[ArcCos[Sqrt[(3 - Sqrt[3])/3]*x], (1 + Sqrt[3])/2])/6", //
				420);
	}

	// {397}
	public void test0487() {
		check("Integrate[1/((2 + 3*x^2)^(1/4)*(4 + 3*x^2)), x]", "-ArcTan[(2*2^(3/4) + 2*2^(1/4)*Sqrt[2 + 3*x^2])/(2*Sqrt[3]*x*(2 + 3*x^2)^(1/4))]/(2*2^(3/4)*Sqrt[3]) - ArcTanh[(2*2^(3/4) - 2*2^(1/4)*Sqrt[2 + 3*x^2])/(2*Sqrt[3]*x*(2 + 3*x^2)^(1/4))]/(2*2^(3/4)*Sqrt[3])", //
				397);
	}

	// {397}
	public void test0488() {
		check("Integrate[1/((2 - 3*x^2)^(1/4)*(4 - 3*x^2)), x]", "ArcTan[(2 - Sqrt[2]*Sqrt[2 - 3*x^2])/(2^(1/4)*Sqrt[3]*x*(2 - 3*x^2)^(1/4))]/(2*2^(3/4)*Sqrt[3]) + ArcTanh[(2 + Sqrt[2]*Sqrt[2 - 3*x^2])/(2^(1/4)*Sqrt[3]*x*(2 - 3*x^2)^(1/4))]/(2*2^(3/4)*Sqrt[3])", //
				397);
	}

	// {397}
	public void test0489() {
		check("Integrate[1/((2 + b*x^2)^(1/4)*(4 + b*x^2)), x]", "-ArcTan[(2*2^(3/4) + 2*2^(1/4)*Sqrt[2 + b*x^2])/(2*Sqrt[b]*x*(2 + b*x^2)^(1/4))]/(2*2^(3/4)*Sqrt[b]) - ArcTanh[(2*2^(3/4) - 2*2^(1/4)*Sqrt[2 + b*x^2])/(2*Sqrt[b]*x*(2 + b*x^2)^(1/4))]/(2*2^(3/4)*Sqrt[b])", //
				397);
	}

	// {397}
	public void test0490() {
		check("Integrate[1/((2 - b*x^2)^(1/4)*(4 - b*x^2)), x]", "ArcTan[(2 - Sqrt[2]*Sqrt[2 - b*x^2])/(2^(1/4)*Sqrt[b]*x*(2 - b*x^2)^(1/4))]/(2*2^(3/4)*Sqrt[b]) + ArcTanh[(2 + Sqrt[2]*Sqrt[2 - b*x^2])/(2^(1/4)*Sqrt[b]*x*(2 - b*x^2)^(1/4))]/(2*2^(3/4)*Sqrt[b])", //
				397);
	}

	// {397}
	public void test0491() {
		check("Integrate[1/((a + 3*x^2)^(1/4)*(2*a + 3*x^2)), x]", "-ArcTan[(a^(3/4)*(1 + Sqrt[a + 3*x^2]/Sqrt[a]))/(Sqrt[3]*x*(a + 3*x^2)^(1/4))]/(2*Sqrt[3]*a^(3/4)) - ArcTanh[(a^(3/4)*(1 - Sqrt[a + 3*x^2]/Sqrt[a]))/(Sqrt[3]*x*(a + 3*x^2)^(1/4))]/(2*Sqrt[3]*a^(3/4))", //
				397);
	}
	...
	public void test0493() {
		check("Integrate[1/((a + b*x^2)^(1/4)*(2*a + b*x^2)), x]", "-ArcTan[(a^(3/4)*(1 + Sqrt[a + b*x^2]/Sqrt[a]))/(Sqrt[b]*x*(a + b*x^2)^(1/4))]/(2*a^(3/4)*Sqrt[b]) - ArcTanh[(a^(3/4)*(1 - Sqrt[a + b*x^2]/Sqrt[a]))/(Sqrt[b]*x*(a + b*x^2)^(1/4))]/(2*a^(3/4)*Sqrt[b])", //
				397);
	}
	...
	public void test0495() {
		check("Integrate[1/((-2 + 3*x^2)*(-1 + 3*x^2)^(1/4)), x]", "-ArcTan[(Sqrt[3/2]*x)/(-1 + 3*x^2)^(1/4)]/(2*Sqrt[6]) - ArcTanh[(Sqrt[3/2]*x)/(-1 + 3*x^2)^(1/4)]/(2*Sqrt[6])", //
				398);
	}
	...
	public void test0497() {
		check("Integrate[1/((-2 + b*x^2)*(-1 + b*x^2)^(1/4)), x]", "-ArcTan[(Sqrt[b]*x)/(Sqrt[2]*(-1 + b*x^2)^(1/4))]/(2*Sqrt[2]*Sqrt[b]) - ArcTanh[(Sqrt[b]*x)/(Sqrt[2]*(-1 + b*x^2)^(1/4))]/(2*Sqrt[2]*Sqrt[b])", //
				398);
	}
	...
	public void test0499() {
		check("Integrate[1/((-2*a + 3*x^2)*(-a + 3*x^2)^(1/4)), x]", "-ArcTan[(Sqrt[3/2]*x)/(a^(1/4)*(-a + 3*x^2)^(1/4))]/(2*Sqrt[6]*a^(3/4)) - ArcTanh[(Sqrt[3/2]*x)/(a^(1/4)*(-a + 3*x^2)^(1/4))]/(2*Sqrt[6]*a^(3/4))", //
				398);
	}
	...
	public void test0501() {
		check("Integrate[1/((-2*a + b*x^2)*(-a + b*x^2)^(1/4)), x]", "-ArcTan[(Sqrt[b]*x)/(Sqrt[2]*a^(1/4)*(-a + b*x^2)^(1/4))]/(2*Sqrt[2]*a^(3/4)*Sqrt[b]) - ArcTanh[(Sqrt[b]*x)/(Sqrt[2]*a^(1/4)*(-a + b*x^2)^(1/4))]/(2*Sqrt[2]*a^(3/4)*Sqrt[b])", //
				398);
	}
	...
	public void test0503() {
		check("Integrate[1/((2 - x^2)*(-1 + x^2)^(1/4)), x]", "ArcTan[x/(Sqrt[2]*(-1 + x^2)^(1/4))]/(2*Sqrt[2]) + ArcTanh[x/(Sqrt[2]*(-1 + x^2)^(1/4))]/(2*Sqrt[2])", //
				398);
	}

	// {381}
	public void test0504() {
		check("Integrate[(a + b*x^2)^(-1 - (b*c)/(2*b*c - 2*a*d))*(c + d*x^2)^(-1 + (a*d)/(2*b*c - 2*a*d)), x]", "(x*(c + d*x^2)^((a*d)/(2*b*c - 2*a*d)))/(a*c*(a + b*x^2)^((b*c)/(2*b*c - 2*a*d)))", //
				381);
	}
	...
	public void test0511() {
		check("Integrate[x/((2 - 3*x^2)^(1/4)*(4 - 3*x^2)), x]", "ArcTan[(Sqrt[2] - Sqrt[2 - 3*x^2])/(2^(3/4)*(2 - 3*x^2)^(1/4))]/(3*2^(3/4)) + ArcTanh[(Sqrt[2] + Sqrt[2 - 3*x^2])/(2^(3/4)*(2 - 3*x^2)^(1/4))]/(3*2^(3/4))", //
				439);
	}
	...
	public void test0514() {
		check("Integrate[x^2/((2 + 3*x^2)^(3/4)*(4 + 3*x^2)), x]", "-ArcTan[(2*2^(3/4) + 2*2^(1/4)*Sqrt[2 + 3*x^2])/(2*Sqrt[3]*x*(2 + 3*x^2)^(1/4))]/(3*2^(1/4)*Sqrt[3]) + ArcTanh[(2*2^(3/4) - 2*2^(1/4)*Sqrt[2 + 3*x^2])/(2*Sqrt[3]*x*(2 + 3*x^2)^(1/4))]/(3*2^(1/4)*Sqrt[3])", //
				441);
	}

	// {441}
	public void test0515() {
		check("Integrate[x^2/((2 - 3*x^2)^(3/4)*(4 - 3*x^2)), x]", "ArcTan[(2 - Sqrt[2]*Sqrt[2 - 3*x^2])/(2^(1/4)*Sqrt[3]*x*(2 - 3*x^2)^(1/4))]/(3*2^(1/4)*Sqrt[3]) - ArcTanh[(2 + Sqrt[2]*Sqrt[2 - 3*x^2])/(2^(1/4)*Sqrt[3]*x*(2 - 3*x^2)^(1/4))]/(3*2^(1/4)*Sqrt[3])", //
				441);
	}

	// {441}
	public void test0516() {
		check("Integrate[x^2/((2 + b*x^2)^(3/4)*(4 + b*x^2)), x]", "-(ArcTan[(2*2^(3/4) + 2*2^(1/4)*Sqrt[2 + b*x^2])/(2*Sqrt[b]*x*(2 + b*x^2)^(1/4))]/(2^(1/4)*b^(3/2))) + ArcTanh[(2*2^(3/4) - 2*2^(1/4)*Sqrt[2 + b*x^2])/(2*Sqrt[b]*x*(2 + b*x^2)^(1/4))]/(2^(1/4)*b^(3/2))", //
				441);
	}

	// {441}
	public void test0517() {
		check("Integrate[x^2/((2 - b*x^2)^(3/4)*(4 - b*x^2)), x]", "ArcTan[(2 - Sqrt[2]*Sqrt[2 - b*x^2])/(2^(1/4)*Sqrt[b]*x*(2 - b*x^2)^(1/4))]/(2^(1/4)*b^(3/2)) - ArcTanh[(2 + Sqrt[2]*Sqrt[2 - b*x^2])/(2^(1/4)*Sqrt[b]*x*(2 - b*x^2)^(1/4))]/(2^(1/4)*b^(3/2))", //
				441);
	}

	// {441}
	public void test0518() {
		check("Integrate[x^2/((a + 3*x^2)^(3/4)*(2*a + 3*x^2)), x]", "-ArcTan[(a^(3/4)*(1 + Sqrt[a + 3*x^2]/Sqrt[a]))/(Sqrt[3]*x*(a + 3*x^2)^(1/4))]/(3*Sqrt[3]*a^(1/4)) + ArcTanh[(a^(3/4)*(1 - Sqrt[a + 3*x^2]/Sqrt[a]))/(Sqrt[3]*x*(a + 3*x^2)^(1/4))]/(3*Sqrt[3]*a^(1/4))", //
				441);
	}
	...
	public void test0520() {
		check("Integrate[x^2/((a + b*x^2)^(3/4)*(2*a + b*x^2)), x]", "-(ArcTan[(a^(3/4)*(1 + Sqrt[a + b*x^2]/Sqrt[a]))/(Sqrt[b]*x*(a + b*x^2)^(1/4))]/(a^(1/4)*b^(3/2))) + ArcTanh[(a^(3/4)*(1 - Sqrt[a + b*x^2]/Sqrt[a]))/(Sqrt[b]*x*(a + b*x^2)^(1/4))]/(a^(1/4)*b^(3/2))", //
				441);
	}
	...
	public void test0523() {
		check("Integrate[x^2/((-2 + 3*x^2)*(-1 + 3*x^2)^(3/4)), x]", "ArcTan[(Sqrt[3/2]*x)/(-1 + 3*x^2)^(1/4)]/(3*Sqrt[6]) - ArcTanh[(Sqrt[3/2]*x)/(-1 + 3*x^2)^(1/4)]/(3*Sqrt[6])", //
				442);
	}
	...
	public void test0525() {
		check("Integrate[x^2/((-2 + b*x^2)*(-1 + b*x^2)^(3/4)), x]", "ArcTan[(Sqrt[b]*x)/(Sqrt[2]*(-1 + b*x^2)^(1/4))]/(Sqrt[2]*b^(3/2)) - ArcTanh[(Sqrt[b]*x)/(Sqrt[2]*(-1 + b*x^2)^(1/4))]/(Sqrt[2]*b^(3/2))", //
				442);
	}
	...
	public void test0527() {
		check("Integrate[x^2/((-2*a + 3*x^2)*(-a + 3*x^2)^(3/4)), x]", "ArcTan[(Sqrt[3/2]*x)/(a^(1/4)*(-a + 3*x^2)^(1/4))]/(3*Sqrt[6]*a^(1/4)) - ArcTanh[(Sqrt[3/2]*x)/(a^(1/4)*(-a + 3*x^2)^(1/4))]/(3*Sqrt[6]*a^(1/4))", //
				442);
	}
	...
	public void test0529() {
		check("Integrate[x^2/((-2*a + b*x^2)*(-a + b*x^2)^(3/4)), x]", "ArcTan[(Sqrt[b]*x)/(Sqrt[2]*a^(1/4)*(-a + b*x^2)^(1/4))]/(Sqrt[2]*a^(1/4)*b^(3/2)) - ArcTanh[(Sqrt[b]*x)/(Sqrt[2]*a^(1/4)*(-a + b*x^2)^(1/4))]/(Sqrt[2]*a^(1/4)*b^(3/2))", //
				442);
	}
	...
	public void test0532() {
		check("Integrate[Sqrt[e + f*x^2]/((a + b*x^2)*Sqrt[c + d*x^2]), x]", "(e^(3/2)*Sqrt[c + d*x^2]*EllipticPi[1 - (b*e)/(a*f), ArcTan[(Sqrt[f]*x)/Sqrt[e]], 1 - (d*e)/(c*f)])/(a*c*Sqrt[f]*Sqrt[(e*(c + d*x^2))/(c*(e + f*x^2))]*Sqrt[e + f*x^2])", //
				539);
	}

	// {539}
	public void test0533() {
		check("Integrate[Sqrt[c + d*x^2]/((a + b*x^2)*Sqrt[e + f*x^2]), x]", "(c^(3/2)*Sqrt[e + f*x^2]*EllipticPi[1 - (b*c)/(a*d), ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (c*f)/(d*e)])/(a*Sqrt[d]*e*Sqrt[c + d*x^2]*Sqrt[(c*(e + f*x^2))/(e*(c + d*x^2))])", //
				539);
	}

	// {539}
	public void test0534() {
		check("Integrate[Sqrt[2 + x^2]/(Sqrt[1 + x^2]*(a + b*x^2)), x]", "(2*Sqrt[1 + x^2]*EllipticPi[1 - (2*b)/a, ArcTan[x/Sqrt[2]], -1])/(a*Sqrt[(1 + x^2)/(2 + x^2)]*Sqrt[2 + x^2])", //
				539);
	}

	// {539}
	public void test0535() {
		check("Integrate[Sqrt[2 + d*x^2]/((a + b*x^2)*Sqrt[3 + f*x^2]), x]", "(2*Sqrt[3 + f*x^2]*EllipticPi[1 - (2*b)/(a*d), ArcTan[(Sqrt[d]*x)/Sqrt[2]], 1 - (2*f)/(3*d)])/(Sqrt[3]*a*Sqrt[d]*Sqrt[2 + d*x^2]*Sqrt[(3 + f*x^2)/(2 + d*x^2)])", //
				539);
	}

	// {537}
	public void test0536() {
		check("Integrate[1/((a + b*x^2)*Sqrt[2 + d*x^2]*Sqrt[3 + f*x^2]), x]", "EllipticPi[(2*b)/(a*d), ArcSin[(Sqrt[-d]*x)/Sqrt[2]], (2*f)/(3*d)]/(Sqrt[3]*a*Sqrt[-d])", //
				537);
	}
	...
	public void test0563() {
		check("Integrate[1/Sqrt[a + b*x^3], x]", "(2*Sqrt[2 + Sqrt[3]]*(a^(1/3) + b^(1/3)*x)*Sqrt[(a^(2/3) - a^(1/3)*b^(1/3)*x + b^(2/3)*x^2)/((1 + Sqrt[3])*a^(1/3) + b^(1/3)*x)^2]*EllipticF[ArcSin[((1 - Sqrt[3])*a^(1/3) + b^(1/3)*x)/((1 + Sqrt[3])*a^(1/3) + b^(1/3)*x)], -7 - 4*Sqrt[3]])/(3^(1/4)*b^(1/3)*Sqrt[(a^(1/3)*(a^(1/3) + b^(1/3)*x))/((1 + Sqrt[3])*a^(1/3) + b^(1/3)*x)^2]*Sqrt[a + b*x^3])", //
				218);
	}
	...
	public void test0566() {
		check("Integrate[1/Sqrt[1 + x^3], x]", "(2*Sqrt[2 + Sqrt[3]]*(1 + x)*Sqrt[(1 - x + x^2)/(1 + Sqrt[3] + x)^2]*EllipticF[ArcSin[(1 - Sqrt[3] + x)/(1 + Sqrt[3] + x)], -7 - 4*Sqrt[3]])/(3^(1/4)*Sqrt[(1 + x)/(1 + Sqrt[3] + x)^2]*Sqrt[1 + x^3])", //
				218);
	}
	...
	public void test0578() {
		check("Integrate[(a + b*x^3)^(-1/3), x]", "ArcTan[(1 + (2*b^(1/3)*x)/(a + b*x^3)^(1/3))/Sqrt[3]]/(Sqrt[3]*b^(1/3)) - Log[-(b^(1/3)*x) + (a + b*x^3)^(1/3)]/(2*b^(1/3))", //
				239);
	}
	...
	public void test0583() {
		check("Integrate[(2 + x^3)^(-1/3), x]", "ArcTan[(1 + (2*x)/(2 + x^3)^(1/3))/Sqrt[3]]/Sqrt[3] - Log[-x + (2 + x^3)^(1/3)]/2", //
				239);
	}
	...
	public void test0585() {
		check("Integrate[x^m/(a + b*x^3), x]", "(x^(1 + m)*Hypergeometric2F1[1, (1 + m)/3, (4 + m)/3, -((b*x^3)/a)])/(a*(1 + m))", //
				364);
	}

	// {364}
	public void test0586() {
		check("Integrate[x^m/(a + b*x^3)^2, x]", "(x^(1 + m)*Hypergeometric2F1[2, (1 + m)/3, (4 + m)/3, -((b*x^3)/a)])/(a^2*(1 + m))", //
				364);
	}

	// {364}
	public void test0587() {
		check("Integrate[x^m/(a + b*x^3)^3, x]", "(x^(1 + m)*Hypergeometric2F1[3, (1 + m)/3, (4 + m)/3, -((b*x^3)/a)])/(a^3*(1 + m))", //
				364);
	}
	...
	public void test0607() {
		check("Integrate[1/Sqrt[a + b*x^4], x]", "((Sqrt[a] + Sqrt[b]*x^2)*Sqrt[(a + b*x^4)/(Sqrt[a] + Sqrt[b]*x^2)^2]*EllipticF[2*ArcTan[(b^(1/4)*x)/a^(1/4)], 1/2])/(2*a^(1/4)*b^(1/4)*Sqrt[a + b*x^4])", //
				220);
	}
	...
	public void test0619() {
		check("Integrate[1/Sqrt[1 + x^4], x]", "((1 + x^2)*Sqrt[(1 + x^4)/(1 + x^2)^2]*EllipticF[2*ArcTan[x], 1/2])/(2*Sqrt[1 + x^4])", //
				220);
	}
	...
	public void test0625() {
		check("Integrate[1/Sqrt[-1 + x^4], x]", "(Sqrt[-1 + x^2]*Sqrt[1 + x^2]*EllipticF[ArcSin[(Sqrt[2]*x)/Sqrt[-1 + x^2]], 1/2])/(Sqrt[2]*Sqrt[-1 + x^4])", //
				222);
	}
	...
	public void test0661() {
		check("Integrate[1/Sqrt[2 + x^6], x]", "(x*(2^(1/3) + x^2)*Sqrt[(2^(2/3) - 2^(1/3)*x^2 + x^4)/(2^(1/3) + (1 + Sqrt[3])*x^2)^2]*EllipticF[ArcCos[(2^(1/3) + (1 - Sqrt[3])*x^2)/(2^(1/3) + (1 + Sqrt[3])*x^2)], (2 + Sqrt[3])/4])/(2*2^(1/3)*3^(1/4)*Sqrt[(x^2*(2^(1/3) + x^2))/(2^(1/3) + (1 + Sqrt[3])*x^2)^2]*Sqrt[2 + x^6])", //
				225);
	}
	...
	public void test0751() {
		check("Integrate[1/(x^2*(a + b*x^n)^2), x]", "-(Hypergeometric2F1[2, -n^(-1), -((1 - n)/n), -((b*x^n)/a)]/(a^2*x))", //
				364);
	}
	...
	public void test0755() {
		check("Integrate[1/(x^2*(a + b*x^n)^3), x]", "-(Hypergeometric2F1[3, -n^(-1), -((1 - n)/n), -((b*x^n)/a)]/(a^3*x))", //
				364);
	}
	...
	public void test0779() {
		check("Integrate[x^m/(a + b*x^n), x]", "(x^(1 + m)*Hypergeometric2F1[1, (1 + m)/n, (1 + m + n)/n, -((b*x^n)/a)])/(a*(1 + m))", //
				364);
	}

	// {364}
	public void test0780() {
		check("Integrate[x^m/(a + b*x^n)^2, x]", "(x^(1 + m)*Hypergeometric2F1[2, (1 + m)/n, (1 + m + n)/n, -((b*x^n)/a)])/(a^2*(1 + m))", //
				364);
	}

	// {364}
	public void test0781() {
		check("Integrate[x^m/(a + b*x^n)^3, x]", "(x^(1 + m)*Hypergeometric2F1[3, (1 + m)/n, (1 + m + n)/n, -((b*x^n)/a)])/(a^3*(1 + m))", //
				364);
	}
	...
	public void test0795() {
		check("Integrate[(c*x)^(4 + n)/(a + b*x^n), x]", "((c*x)^(5 + n)*Hypergeometric2F1[1, (5 + n)/n, 2 + 5/n, -((b*x^n)/a)])/(a*c*(5 + n))", //
				364);
	}

	// {364}
	public void test0796() {
		check("Integrate[(c*x)^(3 + n)/(a + b*x^n), x]", "((c*x)^(4 + n)*Hypergeometric2F1[1, (4 + n)/n, 2*(1 + 2/n), -((b*x^n)/a)])/(a*c*(4 + n))", //
				364);
	}

	// {364}
	public void test0797() {
		check("Integrate[(c*x)^(2 + n)/(a + b*x^n), x]", "((c*x)^(3 + n)*Hypergeometric2F1[1, (3 + n)/n, 2 + 3/n, -((b*x^n)/a)])/(a*c*(3 + n))", //
				364);
	}

	// {364}
	public void test0798() {
		check("Integrate[(c*x)^(1 + n)/(a + b*x^n), x]", "((c*x)^(2 + n)*Hypergeometric2F1[1, (2 + n)/n, 2*(1 + n^(-1)), -((b*x^n)/a)])/(a*c*(2 + n))", //
				364);
	}

	// {364}
	public void test0799() {
		check("Integrate[(c*x)^n/(a + b*x^n), x]", "((c*x)^(1 + n)*Hypergeometric2F1[1, 1 + n^(-1), 2 + n^(-1), -((b*x^n)/a)])/(a*c*(1 + n))", //
				364);
	}

	// {364}
	public void test0800() {
		check("Integrate[(c*x)^(-2 + n)/(a + b*x^n), x]", "-(((c*x)^(-1 + n)*Hypergeometric2F1[1, -((1 - n)/n), 2 - n^(-1), -((b*x^n)/a)])/(a*c*(1 - n)))", //
				364);
	}

	// {364}
	public void test0801() {
		check("Integrate[(c*x)^(-3 + n)/(a + b*x^n), x]", "-(((c*x)^(-2 + n)*Hypergeometric2F1[1, -((2 - n)/n), 2*(1 - n^(-1)), -((b*x^n)/a)])/(a*c*(2 - n)))", //
				364);
	}
	...
	public void test0816() {
		check("Integrate[(c + d*x)^3*(a + b*(c + d*x)^4), x]", "(a*(c + d*x)^4)/(4*d) + (b*(c + d*x)^8)/(8*d)", //
				372, 14);
	}
	...
	public void test0823() {
		check("Integrate[(a + b*x^3)^(-1 - (b*c)/(3*b*c - 3*a*d))*(c + d*x^3)^(-1 + (a*d)/(3*b*c - 3*a*d)), x]", "(x*(c + d*x^3)^((a*d)/(3*b*c - 3*a*d)))/(a*c*(a + b*x^3)^((b*c)/(3*b*c - 3*a*d)))", //
				381);
	}

	// {405}
	public void test0824() {
		check("Integrate[Sqrt[a - b*x^4]/(a*c + b*c*x^4), x]", "ArcTan[(b^(1/4)*x*(Sqrt[a] + Sqrt[b]*x^2))/(a^(1/4)*Sqrt[a - b*x^4])]/(2*a^(1/4)*b^(1/4)*c) + ArcTanh[(b^(1/4)*x*(Sqrt[a] - Sqrt[b]*x^2))/(a^(1/4)*Sqrt[a - b*x^4])]/(2*a^(1/4)*b^(1/4)*c)", //
				405);
	}

	// {380}
	public void test0825() {
		check("Integrate[(a + b*x^n)^p*(c + d*x^n)^(-1 - n^(-1) - p), x]", "(x*(a + b*x^n)^p*(c + d*x^n)^(-n^(-1) - p)*Hypergeometric2F1[n^(-1), -p, 1 + n^(-1), -(((b*c - a*d)*x^n)/(a*(c + d*x^n)))])/(c*((c*(a + b*x^n))/(a*(c + d*x^n)))^p)", //
				380);
	}
	...
	public void test0827() {
		check("Integrate[1/((a + b*x^n)*(c + d*x^n)^n^(-1)), x]", "(x*Hypergeometric2F1[1, n^(-1), 1 + n^(-1), -(((b*c - a*d)*x^n)/(a*(c + d*x^n)))])/(a*(c + d*x^n)^n^(-1))", //
				379);
	}

	// {379}
	public void test0828() {
		check("Integrate[(c + d*x^n)^(1 - n^(-1))/(a + b*x^n)^2, x]", "(c*x*Hypergeometric2F1[2, n^(-1), 1 + n^(-1), -(((b*c - a*d)*x^n)/(a*(c + d*x^n)))])/(a^2*(c + d*x^n)^n^(-1))", //
				379);
	}

	// {379}
	public void test0829() {
		check("Integrate[(c + d*x^n)^(2 - n^(-1))/(a + b*x^n)^3, x]", "(c^2*x*Hypergeometric2F1[3, n^(-1), 1 + n^(-1), -(((b*c - a*d)*x^n)/(a*(c + d*x^n)))])/(a^3*(c + d*x^n)^n^(-1))", //
				379);
	}

	// {381}
	public void test0830() {
		check("Integrate[(a + b*x^n)^((a*d*n - b*c*(1 + n))/((b*c - a*d)*n))*(c + d*x^n)^((a*d - b*c*n + a*d*n)/(b*c*n - a*d*n)), x]", "(x*(c + d*x^n)^((a*d)/((b*c - a*d)*n)))/(a*c*(a + b*x^n)^((b*c)/((b*c - a*d)*n)))", //
				381);
	}

	// {450}
	public void test0831() {
		check("Integrate[(c + d*x^2)/(x^((2*b^2*c + a^2*d)/(b^2*c + a^2*d))*Sqrt[-a + b*x]*Sqrt[a + b*x]), x]", "((c/a^2 + d/b^2)*Sqrt[-a + b*x]*Sqrt[a + b*x])/x^((b^2*c)/(b^2*c + a^2*d))", //
				450);
	}

	// {484}
	public void test0832() {
		check("Integrate[x/(Sqrt[c + d*x^3]*(4*c + d*x^3)), x]", "-ArcTan[(Sqrt[3]*c^(1/6)*(c^(1/3) + 2^(1/3)*d^(1/3)*x))/Sqrt[c + d*x^3]]/(3*2^(2/3)*Sqrt[3]*c^(5/6)*d^(2/3)) + ArcTan[Sqrt[c + d*x^3]/(Sqrt[3]*Sqrt[c])]/(3*2^(2/3)*Sqrt[3]*c^(5/6)*d^(2/3)) - ArcTanh[(c^(1/6)*(c^(1/3) - 2^(1/3)*d^(1/3)*x))/Sqrt[c + d*x^3]]/(3*2^(2/3)*c^(5/6)*d^(2/3)) + ArcTanh[Sqrt[c + d*x^3]/Sqrt[c]]/(9*2^(2/3)*c^(5/6)*d^(2/3))", //
				484);
	}

	// {484}
	public void test0833() {
		check("Integrate[x/(Sqrt[1 - x^3]*(4 - x^3)), x]", "-ArcTan[(Sqrt[3]*(1 - 2^(1/3)*x))/Sqrt[1 - x^3]]/(3*2^(2/3)*Sqrt[3]) + ArcTan[Sqrt[1 - x^3]/Sqrt[3]]/(3*2^(2/3)*Sqrt[3]) - ArcTanh[(1 + 2^(1/3)*x)/Sqrt[1 - x^3]]/(3*2^(2/3)) + ArcTanh[Sqrt[1 - x^3]]/(9*2^(2/3))", //
				484);
	}
	...
	public void test0850() {
		check("Integrate[(Sqrt[-1 + Sqrt[x]]*Sqrt[1 + Sqrt[x]])/x^(5/2), x]", "(2*(-1 + Sqrt[x])^(3/2)*(1 + Sqrt[x])^(3/2))/(3*x^(3/2))", //
				265);
	}

	// {265}
	public void test0851() {
		check("Integrate[1/(Sqrt[-1 + Sqrt[x]]*Sqrt[1 + Sqrt[x]]*x^(3/2)), x]", "(2*Sqrt[-1 + Sqrt[x]]*Sqrt[1 + Sqrt[x]])/Sqrt[x]", //
				265);
	}
	...
	public void test0864() {
		check("Integrate[(1 + Sqrt[3] - x)/Sqrt[-1 + x^3], x]", "(2*Sqrt[-1 + x^3])/(1 - Sqrt[3] - x) - (3^(1/4)*Sqrt[2 + Sqrt[3]]*(1 - x)*Sqrt[(1 + x + x^2)/(1 - Sqrt[3] - x)^2]*EllipticE[ArcSin[(1 + Sqrt[3] - x)/(1 - Sqrt[3] - x)], -7 + 4*Sqrt[3]])/(Sqrt[-((1 - x)/(1 - Sqrt[3] - x)^2)]*Sqrt[-1 + x^3])", //
				1879);
	}
	...
	public void test0868() {
		check("Integrate[(1 + Sqrt[3] - (b/a)^(1/3)*x)/Sqrt[-a + b*x^3], x]", "(2*(b/a)^(2/3)*Sqrt[-a + b*x^3])/(b*(1 - Sqrt[3] - (b/a)^(1/3)*x)) - (3^(1/4)*Sqrt[2 + Sqrt[3]]*(1 - (b/a)^(1/3)*x)*Sqrt[(1 + (b/a)^(1/3)*x + (b/a)^(2/3)*x^2)/(1 - Sqrt[3] - (b/a)^(1/3)*x)^2]*EllipticE[ArcSin[(1 + Sqrt[3] - (b/a)^(1/3)*x)/(1 - Sqrt[3] - (b/a)^(1/3)*x)], -7 + 4*Sqrt[3]])/((b/a)^(1/3)*Sqrt[-((1 - (b/a)^(1/3)*x)/(1 - Sqrt[3] - (b/a)^(1/3)*x)^2)]*Sqrt[-a + b*x^3])", //
				1879);
	}
	...
	public void test0881() {
		check("Integrate[(a*g + e*x + f*x^3 - b*g*x^4)/(a + b*x^4)^(3/2), x]", "-(a*f - 2*a*b*g*x - b*e*x^2)/(2*a*b*Sqrt[a + b*x^4])", //
				1856);
	}
	...
	public void test0884() {
		check("Integrate[(a*c + 2*(b*c + a*d)*x^2 + 3*b*d*x^4)/(Sqrt[a + b*x^2]*Sqrt[c + d*x^2]), x]", "x*Sqrt[a + b*x^2]*Sqrt[c + d*x^2]", //
				1590);
	}

	// {1898}
	public void test0885() {
		check("Integrate[(a + b*x^n)^((-1 - n)/n)*(c + d*x^n)^((-1 - n)/n)*(a*c - b*d*x^(2*n)), x]", "x/((a + b*x^n)^n^(-1)*(c + d*x^n)^n^(-1))", //
				1898);
	}

	// {1849}
	public void test0886() {
		check("Integrate[(h*x)^(-1 - n - n*p)*(a + b*x^n)^p*(c + d*x^n)^p*(a*c - b*d*x^(2*n)), x]", "-(((a + b*x^n)^(1 + p)*(c + d*x^n)^(1 + p))/(h*n*(1 + p)*(h*x)^(n*(1 + p))))", //
				1849);
	}

	// {1897}
	public void test0887() {
		check("Integrate[(a + b*x^n)^p*(c + d*x^n)^p*(e + ((b*c + a*d)*e*(1 + n + n*p)*x^n)/(a*c) + (b*d*e*(1 + 2*n + 2*n*p)*x^(2*n))/(a*c)), x]", "(e*x*(a + b*x^n)^(1 + p)*(c + d*x^n)^(1 + p))/(a*c)", //
				1897);
	}

	// {1848}
	public void test0888() {
		check("Integrate[(h*x)^m*(a + b*x^n)^p*(c + d*x^n)^p*(e + ((b*c + a*d)*e*(1 + m + n + n*p)*x^n)/(a*c*(1 + m)) + (b*d*e*(1 + m + 2*n + 2*n*p)*x^(2*n))/(a*c*(1 + m))), x]", "(e*(h*x)^(1 + m)*(a + b*x^n)^(1 + p)*(c + d*x^n)^(1 + p))/(a*c*h*(1 + m))", //
				1848);
	}
	...
	public void test0897() {
		check("Integrate[x^4/(a*x^2 + b*x^3)^2, x]", "-(1/(b*(a + b*x)))", //
				1584, 32);
	}
	...
	public void test0907() {
		check("Integrate[x^12*(a*x + b*x^26)^12, x]", "(a + b*x^25)^13/(325*b)", //
				1584, 261);
	}
	...
	public void test0911() {
		check("Integrate[x^12*(a*x^2 + b*x^39)^12, x]", "(a + b*x^37)^13/(481*b)", //
				1584, 261);
	}
	...
	public void test0919() {
		check("Integrate[x^n*(a*x^m + b*x^(1 + m + n + m*p))^p, x]", "(a*x^m + b*x^(1 + m + n + m*p))^(1 + p)/(b*(1 + p)*(1 + n + m*p)*x^(m*(1 + p)))", //
				2014);
	}
	...
	public void test0923() {
		check("Integrate[(b*x + c*x^2)^p, x]", "-(((-((c*x)/b))^(-1 - p)*(b*x + c*x^2)^(1 + p)*Hypergeometric2F1[-p, 1 + p, 2 + p, (b + c*x)/b])/(b*(1 + p)))", //
				624);
	}
	...
	public void test0936() {
		check("Integrate[(a + b*x + c*x^2)^p, x]", "-((2^(1 + p)*(-((b - Sqrt[b^2 - 4*a*c] + 2*c*x)/Sqrt[b^2 - 4*a*c]))^(-1 - p)*(a + b*x + c*x^2)^(1 + p)*Hypergeometric2F1[-p, 1 + p, 2 + p, (b + Sqrt[b^2 - 4*a*c] + 2*c*x)/(2*Sqrt[b^2 - 4*a*c])])/(Sqrt[b^2 - 4*a*c]*(1 + p)))", //
				624);
	}

	// {624}
	public void test0937() {
		check("Integrate[(3 + 4*x + x^2)^p, x]", "-((2^(1 + 2*p)*(-2 - 2*x)^(-1 - p)*(3 + 4*x + x^2)^(1 + p)*Hypergeometric2F1[-p, 1 + p, 2 + p, (3 + x)/2])/(1 + p))", //
				624);
	}
	...
	public void test0965() {
		check("Integrate[1/((d + e*x)*(d^2 + 3*e^2*x^2)^(1/3)), x]", "-(ArcTan[1/Sqrt[3] + (2^(2/3)*(d - e*x))/(Sqrt[3]*d^(1/3)*(d^2 + 3*e^2*x^2)^(1/3))]/(2^(2/3)*Sqrt[3]*d^(2/3)*e)) - Log[d + e*x]/(2*2^(2/3)*d^(2/3)*e) + Log[3*d*e^2 - 3*e^3*x - 3*2^(1/3)*d^(1/3)*e^2*(d^2 + 3*e^2*x^2)^(1/3)]/(2*2^(2/3)*d^(2/3)*e)", //
				751);
	}

	// {751}
	public void test0966() {
		check("Integrate[1/((2 + 3*x)*(4 + 27*x^2)^(1/3)), x]", "-ArcTan[1/Sqrt[3] + (2^(1/3)*(2 - 3*x))/(Sqrt[3]*(4 + 27*x^2)^(1/3))]/(6*2^(1/3)*Sqrt[3]) - Log[2 + 3*x]/(12*2^(1/3)) + Log[54 - 81*x - 27*2^(2/3)*(4 + 27*x^2)^(1/3)]/(12*2^(1/3))", //
				751);
	}

	// {751}
	public void test0967() {
		check("Integrate[1/((2 + (3*I)*x)*(4 - 27*x^2)^(1/3)), x]", "((I/6)*ArcTan[1/Sqrt[3] + (2^(1/3)*(2 - (3*I)*x))/(Sqrt[3]*(4 - 27*x^2)^(1/3))])/(2^(1/3)*Sqrt[3]) + ((I/12)*Log[2 + (3*I)*x])/2^(1/3) - ((I/12)*Log[-54 + (81*I)*x + 27*2^(2/3)*(4 - 27*x^2)^(1/3)])/2^(1/3)", //
				751);
	}

	// {751}
	public void test0968() {
		check("Integrate[1/((Sqrt[3] + x)*(1 + x^2)^(1/3)), x]", "-(ArcTan[1/Sqrt[3] + (2^(2/3)*(Sqrt[3] - x))/(3*(1 + x^2)^(1/3))]/(2^(2/3)*Sqrt[3])) - Log[Sqrt[3] + x]/(2*2^(2/3)) + Log[Sqrt[3] - x - 2^(1/3)*Sqrt[3]*(1 + x^2)^(1/3)]/(2*2^(2/3))", //
				751);
	}
	...
	public void test0970() {
		check("Integrate[1/((d + e*x)^(3/2)*(a + c*x^2)^(1/4)), x]", "(-2*(Sqrt[-a] - Sqrt[c]*x)*(-(((Sqrt[c]*d + Sqrt[-a]*e)*(Sqrt[-a] + Sqrt[c]*x))/((Sqrt[c]*d - Sqrt[-a]*e)*(Sqrt[-a] - Sqrt[c]*x))))^(1/4)*Hypergeometric2F1[-1/2, 1/4, 1/2, (2*Sqrt[-a]*Sqrt[c]*(d + e*x))/((Sqrt[c]*d - Sqrt[-a]*e)*(Sqrt[-a] - Sqrt[c]*x))])/((Sqrt[c]*d + Sqrt[-a]*e)*Sqrt[d + e*x]*(a + c*x^2)^(1/4))", //
				727);
	}

	// {727}
	public void test0971() {
		check("Integrate[(d + e*x)^(-2 - 2*p)*(a + c*x^2)^p, x]", "-(((Sqrt[-a] - Sqrt[c]*x)*(d + e*x)^(-1 - 2*p)*(a + c*x^2)^p*Hypergeometric2F1[-1 - 2*p, -p, -2*p, (2*Sqrt[-a]*Sqrt[c]*(d + e*x))/((Sqrt[c]*d - Sqrt[-a]*e)*(Sqrt[-a] - Sqrt[c]*x))])/((Sqrt[c]*d + Sqrt[-a]*e)*(1 + 2*p)*(-(((Sqrt[c]*d + Sqrt[-a]*e)*(Sqrt[-a] + Sqrt[c]*x))/((Sqrt[c]*d - Sqrt[-a]*e)*(Sqrt[-a] - Sqrt[c]*x))))^p))", //
				727);
	}
	...
	public void test0980() {
		check("Integrate[(c*d^2 - c*e^2*x^2)^(3/2)/(d + e*x)^(3/2), x]", "(-2*(c*d^2 - c*e^2*x^2)^(5/2))/(5*c*e*(d + e*x)^(5/2))", //
				649);
	}
	...
	public void test0996() {
		check("Integrate[(d + e*x)/(c*d^2 + 2*c*d*e*x + c*e^2*x^2)^(5/2), x]", "-1/(3*c*e*(c*d^2 + 2*c*d*e*x + c*e^2*x^2)^(3/2))", //
				629);
	}

	// {607}
	public void test0997() {
		check("Integrate[(c*d^2 + 2*c*d*e*x + c*e^2*x^2)^(-5/2), x]", "-1/(4*c*e*(d + e*x)*(c*d^2 + 2*c*d*e*x + c*e^2*x^2)^(3/2))", //
				607);
	}
	...
	public void test1011() {
		check("Integrate[Sqrt[a + b*x + c*x^2]/(b*d + 2*c*d*x)^4, x]", "(2*(a + b*x + c*x^2)^(3/2))/(3*(b^2 - 4*a*c)*d^4*(b + 2*c*x)^3)", //
				682);
	}
	...
	public void test1013() {
		check("Integrate[(a + b*x + c*x^2)^(3/2)/(b*d + 2*c*d*x)^6, x]", "(2*(a + b*x + c*x^2)^(5/2))/(5*(b^2 - 4*a*c)*d^6*(b + 2*c*x)^5)", //
				682);
	}
	...
	public void test1015() {
		check("Integrate[(a + b*x + c*x^2)^(5/2)/(b*d + 2*c*d*x)^8, x]", "(2*(a + b*x + c*x^2)^(7/2))/(7*(b^2 - 4*a*c)*d^8*(b + 2*c*x)^7)", //
				682);
	}
	...
	public void test1017() {
		check("Integrate[1/((b*d + 2*c*d*x)^2*Sqrt[a + b*x + c*x^2]), x]", "(2*Sqrt[a + b*x + c*x^2])/((b^2 - 4*a*c)*d^2*(b + 2*c*x))", //
				682);
	}
	...
	public void test1019() {
		check("Integrate[(b*d + 2*c*d*x)^2/(a + b*x + c*x^2)^(5/2), x]", "(-2*d^2*(b + 2*c*x)^3)/(3*(b^2 - 4*a*c)*(a + b*x + c*x^2)^(3/2))", //
				682);
	}
	...
	public void test1021() {
		check("Integrate[(a + b*x + c*x^2)^(4/3)/(b*d + 2*c*d*x)^(17/3), x]", "(3*(a + b*x + c*x^2)^(7/3))/(7*(b^2 - 4*a*c)*d*(b*d + 2*c*d*x)^(14/3))", //
				682);
	}
	...
	public void test1034() {
		check("Integrate[Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2]/(d + e*x)^3, x]", "(2*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2))/(3*(c*d^2 - a*e^2)*(d + e*x)^3)", //
				650);
	}

	// {650}
	public void test1035() {
		check("Integrate[(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2)/(d + e*x)^5, x]", "(2*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(5/2))/(5*(c*d^2 - a*e^2)*(d + e*x)^5)", //
				650);
	}

	// {650}
	public void test1036() {
		check("Integrate[(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(5/2)/(d + e*x)^7, x]", "(2*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(7/2))/(7*(c*d^2 - a*e^2)*(d + e*x)^7)", //
				650);
	}

	// {650}
	public void test1037() {
		check("Integrate[1/((d + e*x)*Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2]), x]", "(2*Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2])/((c*d^2 - a*e^2)*(d + e*x))", //
				650);
	}

	// {636}
	public void test1038() {
		check("Integrate[(d + e*x)/(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2), x]", "(-2*(d + e*x))/((c*d^2 - a*e^2)*Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2])", //
				636);
	}

	// {613}
	public void test1039() {
		check("Integrate[(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(-3/2), x]", "(-2*(c*d^2 + a*e^2 + 2*c*d*e*x))/((c*d^2 - a*e^2)^2*Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2])", //
				613);
	}

	// {650}
	public void test1040() {
		check("Integrate[(d + e*x)^3/(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(5/2), x]", "(-2*(d + e*x)^3)/(3*(c*d^2 - a*e^2)*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2))", //
				650);
	}

	// {648}
	public void test1041() {
		check("Integrate[Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2]/Sqrt[d + e*x], x]", "(2*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2))/(3*c*d*(d + e*x)^(3/2))", //
				648);
	}

	// {648}
	public void test1042() {
		check("Integrate[(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2)/(d + e*x)^(3/2), x]", "(2*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(5/2))/(5*c*d*(d + e*x)^(5/2))", //
				648);
	}

	// {648}
	public void test1043() {
		check("Integrate[(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(5/2)/(d + e*x)^(5/2), x]", "(2*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(7/2))/(7*c*d*(d + e*x)^(7/2))", //
				648);
	}

	// {648}
	public void test1044() {
		check("Integrate[Sqrt[d + e*x]/Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2], x]", "(2*Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2])/(c*d*Sqrt[d + e*x])", //
				648);
	}

	// {648}
	public void test1045() {
		check("Integrate[(d + e*x)^(3/2)/(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2), x]", "(-2*Sqrt[d + e*x])/(c*d*Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2])", //
				648);
	}

	// {648}
	public void test1046() {
		check("Integrate[(d + e*x)^(5/2)/(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(5/2), x]", "(-2*(d + e*x)^(3/2))/(3*c*d*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2))", //
				648);
	}

	// {624}
	public void test1047() {
		check("Integrate[(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^p, x]", "-(((-((e*(a*e + c*d*x))/(c*d^2 - a*e^2)))^(-1 - p)*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(1 + p)*Hypergeometric2F1[-p, 1 + p, 2 + p, (c*d*(d + e*x))/(c*d^2 - a*e^2)])/((c*d^2 - a*e^2)*(1 + p)))", //
				624);
	}

	// {650}
	public void test1048() {
		check("Integrate[(d + e*x)^(-2 - 2*p)*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^p, x]", "(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(1 + p)/((c*d^2 - a*e^2)*(1 + p)*(d + e*x)^(2*(1 + p)))", //
				650);
	}

	// {648}
	public void test1049() {
		check("Integrate[(d + e*x)^m/(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^m, x]", "((d + e*x)^(-1 + m)*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(1 - m))/(c*d*(1 - m))", //
				648);
	}

	// {648}
	public void test1050() {
		check("Integrate[(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^p/(d + e*x)^p, x]", "((d + e*x)^(-1 - p)*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(1 + p))/(c*d*(1 + p))", //
				648);
	}

	// {636}
	public void test1052() {
		check("Integrate[(d + e*x)/(a + b*x + c*x^2)^(3/2), x]", "(-2*(b*d - 2*a*e + (2*c*d - b*e)*x))/((b^2 - 4*a*c)*Sqrt[a + b*x + c*x^2])", //
				636);
	}
	...
	public void test1055() {
		check("Integrate[1/((d + e*x)*Sqrt[(-(c*d^2) + b*d*e)/e^2 + b*x + c*x^2]), x]", "(2*e*Sqrt[-((d*(c*d - b*e))/e^2) + b*x + c*x^2])/((2*c*d - b*e)*(d + e*x))", //
				650);
	}

	// {750}
	public void test1056() {
		check("Integrate[1/((d + e*x)*(c^2*d^2 - b*c*d*e + b^2*e^2 + 3*b*c*e^2*x + 3*c^2*e^2*x^2)^(1/3)), x]", "-(ArcTan[1/Sqrt[3] + (2*(c*d - b*e - c*e*x))/(Sqrt[3]*(2*c*d - b*e)^(1/3)*(c^2*d^2 - b*c*d*e + b^2*e^2 + 3*b*c*e^2*x + 3*c^2*e^2*x^2)^(1/3))]/(Sqrt[3]*e*(2*c*d - b*e)^(2/3))) - Log[d + e*x]/(2*e*(2*c*d - b*e)^(2/3)) + Log[3*c*e^2*(c*d - b*e) - 3*c^2*e^3*x - 3*c*e^2*(2*c*d - b*e)^(1/3)*(c^2*d^2 - b*c*d*e + b^2*e^2 + 3*b*c*e^2*x + 3*c^2*e^2*x^2)^(1/3)]/(2*e*(2*c*d - b*e)^(2/3))", //
				750);
	}

	// {750}
	public void test1057() {
		check("Integrate[1/((2 + 3*x)*(52 - 54*x + 27*x^2)^(1/3)), x]", "-ArcTan[1/Sqrt[3] + (2^(2/3)*(8 - 3*x))/(Sqrt[3]*5^(1/3)*(52 - 54*x + 27*x^2)^(1/3))]/(3*Sqrt[3]*10^(2/3)) - Log[2 + 3*x]/(6*10^(2/3)) + Log[216 - 81*x - 27*10^(1/3)*(52 - 54*x + 27*x^2)^(1/3)]/(6*10^(2/3))", //
				750);
	}

	// {752}
	public void test1058() {
		check("Integrate[1/((2 + 3*x)*(28 + 54*x + 27*x^2)^(1/3)), x]", "-ArcTan[1/Sqrt[3] + (2^(2/3)*(4 + 3*x))/(Sqrt[3]*(28 + 54*x + 27*x^2)^(1/3))]/(3*2^(2/3)*Sqrt[3]) - Log[2 + 3*x]/(6*2^(2/3)) + Log[-108 - 81*x + 27*2^(1/3)*(28 + 54*x + 27*x^2)^(1/3)]/(6*2^(2/3))", //
				752);
	}

	// {726}
	public void test1059() {
		check("Integrate[1/((d + e*x)^(3/2)*(a + b*x + c*x^2)^(1/4)), x]", "(2*(b - Sqrt[b^2 - 4*a*c] + 2*c*x)*(((2*c*d - (b - Sqrt[b^2 - 4*a*c])*e)*(b + Sqrt[b^2 - 4*a*c] + 2*c*x))/((2*c*d - (b + Sqrt[b^2 - 4*a*c])*e)*(b - Sqrt[b^2 - 4*a*c] + 2*c*x)))^(1/4)*Hypergeometric2F1[-1/2, 1/4, 1/2, (-4*c*Sqrt[b^2 - 4*a*c]*(d + e*x))/((2*c*d - (b + Sqrt[b^2 - 4*a*c])*e)*(b - Sqrt[b^2 - 4*a*c] + 2*c*x))])/((2*c*d - b*e + Sqrt[b^2 - 4*a*c]*e)*Sqrt[d + e*x]*(a + b*x + c*x^2)^(1/4))", //
				726);
	}
	...
	public void test1061() {
		check("Integrate[(d + e*x)^(-2 - 2*p)*(a + b*x + c*x^2)^p, x]", "((b - Sqrt[b^2 - 4*a*c] + 2*c*x)*(d + e*x)^(-1 - 2*p)*(a + b*x + c*x^2)^p*Hypergeometric2F1[-1 - 2*p, -p, -2*p, (-4*c*Sqrt[b^2 - 4*a*c]*(d + e*x))/((2*c*d - (b + Sqrt[b^2 - 4*a*c])*e)*(b - Sqrt[b^2 - 4*a*c] + 2*c*x))])/((2*c*d - (b - Sqrt[b^2 - 4*a*c])*e)*(1 + 2*p)*(((2*c*d - (b - Sqrt[b^2 - 4*a*c])*e)*(b + Sqrt[b^2 - 4*a*c] + 2*c*x))/((2*c*d - (b + Sqrt[b^2 - 4*a*c])*e)*(b - Sqrt[b^2 - 4*a*c] + 2*c*x)))^p)", //
				726);
	}
	...
	public void test1068() {
		check("Integrate[(A + B*x)/(a + b*x + c*x^2)^(3/2), x]", "(-2*(A*b - 2*a*B - (b*B - 2*A*c)*x))/((b^2 - 4*a*c)*Sqrt[a + b*x + c*x^2])", //
				636);
	}
	...
	public void test1071() {
		check("Integrate[(-(a*e) + c*d*x)*(d + e*x)^(-3 - 2*p)*(a + c*x^2)^p, x]", "(a + c*x^2)^(1 + p)/(2*(1 + p)*(d + e*x)^(2*(1 + p)))", //
				803);
	}
	...
	public void test1085() {
		check("Integrate[((a + b*x)*Sqrt[a^2 + 2*a*b*x + b^2*x^2])/(d + e*x)^4, x]", "(a^2 + 2*a*b*x + b^2*x^2)^(3/2)/(3*(b*d - a*e)*(d + e*x)^3)", //
				767);
	}
	...
	public void test1087() {
		check("Integrate[((a + b*x)*(a^2 + 2*a*b*x + b^2*x^2)^(3/2))/(d + e*x)^6, x]", "(a^2 + 2*a*b*x + b^2*x^2)^(5/2)/(5*(b*d - a*e)*(d + e*x)^5)", //
				767);
	}
	...
	public void test1089() {
		check("Integrate[((a + b*x)*(a^2 + 2*a*b*x + b^2*x^2)^(5/2))/(d + e*x)^8, x]", "(a^2 + 2*a*b*x + b^2*x^2)^(7/2)/(7*(b*d - a*e)*(d + e*x)^7)", //
				767);
	}
	...
	public void test1091() {
		check("Integrate[(a + b*x)/((d + e*x)^2*Sqrt[a^2 + 2*a*b*x + b^2*x^2]), x]", "Sqrt[a^2 + 2*a*b*x + b^2*x^2]/((b*d - a*e)*(d + e*x))", //
				767);
	}
	...
	public void test1093() {
		check("Integrate[((a + b*x)*(d + e*x)^2)/(a^2 + 2*a*b*x + b^2*x^2)^(5/2), x]", "-(d + e*x)^3/(3*(b*d - a*e)*(a^2 + 2*a*b*x + b^2*x^2)^(3/2))", //
				767);
	}
	...
	public void test1095() {
		check("Integrate[(a*c + b*c*x)*(d + e*x)^(-3 - 2*p)*(a^2 + 2*a*b*x + b^2*x^2)^p, x]", "(c*(a^2 + 2*a*b*x + b^2*x^2)^(1 + p))/(2*(b*d - a*e)*(1 + p)*(d + e*x)^(2*(1 + p)))", //
				767);
	}
	...
	public void test1097() {
		check("Integrate[(d + e*x)^m*(c*d*m - b*e*(1 + m + p) - c*e*(2 + m + 2*p)*x)*(c*d^2 - b*d*e - b*e^2*x - c*e^2*x^2)^p, x]", "((d + e*x)^m*(d*(c*d - b*e) - b*e^2*x - c*e^2*x^2)^(1 + p))/e", //
				786);
	}

	// {786}
	public void test1098() {
		check("Integrate[(d + e*x)^(-3 - 2*p)*(f + g*x)*(d*(e*f + d*g + d*g*p) + e*(e*f + 3*d*g + 2*d*g*p)*x + e^2*g*(2 + p)*x^2)^p, x]", "-(((d + e*x)^(-3 - 2*p)*(d*(e*f + d*g*(1 + p)) + e*(e*f + d*g*(3 + 2*p))*x + e^2*g*(2 + p)*x^2)^(1 + p))/(e^2*(2 + p)))", //
				786);
	}
	...
	public void test1116() {
		check("Integrate[Sqrt[d + e*x]/((f + g*x)^(3/2)*Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2]), x]", "(2*Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2])/((c*d*f - a*e*g)*Sqrt[d + e*x]*Sqrt[f + g*x])", //
				860);
	}

	// {860}
	public void test1117() {
		check("Integrate[(d + e*x)^(3/2)/(Sqrt[f + g*x]*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2)), x]", "(-2*Sqrt[d + e*x]*Sqrt[f + g*x])/((c*d*f - a*e*g)*Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2])", //
				860);
	}

	// {860}
	public void test1118() {
		check("Integrate[((d + e*x)^(5/2)*Sqrt[f + g*x])/(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(5/2), x]", "(-2*(d + e*x)^(3/2)*(f + g*x)^(3/2))/(3*(c*d*f - a*e*g)*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2))", //
				860);
	}

	// {860}
	public void test1119() {
		check("Integrate[Sqrt[a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2]/(Sqrt[d + e*x]*(f + g*x)^(5/2)), x]", "(2*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2))/(3*(c*d*f - a*e*g)*(d + e*x)^(3/2)*(f + g*x)^(3/2))", //
				860);
	}

	// {860}
	public void test1120() {
		check("Integrate[(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(3/2)/((d + e*x)^(3/2)*(f + g*x)^(7/2)), x]", "(2*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(5/2))/(5*(c*d*f - a*e*g)*(d + e*x)^(5/2)*(f + g*x)^(5/2))", //
				860);
	}

	// {860}
	public void test1121() {
		check("Integrate[(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(5/2)/((d + e*x)^(5/2)*(f + g*x)^(9/2)), x]", "(2*(a*d*e + (c*d^2 + a*e^2)*x + c*d*e*x^2)^(7/2))/(7*(c*d*f - a*e*g)*(d + e*x)^(7/2)*(f + g*x)^(7/2))", //
				860);
	}
	...
	public void test1135() {
		check("Integrate[1/Sqrt[-2 + 5*x^2 + 3*x^4], x]", "(Sqrt[2 + x^2]*Sqrt[-1 + 3*x^2]*EllipticF[ArcSin[(Sqrt[7/2]*x)/Sqrt[-1 + 3*x^2]], 6/7])/(Sqrt[7]*Sqrt[-2 + 5*x^2 + 3*x^4])", //
				1097);
	}

	// {1098}
	public void test1136() {
		check("Integrate[1/Sqrt[-2 + 4*x^2 + 3*x^4], x]", "(Sqrt[(2 - (2 - Sqrt[10])*x^2)/(2 - (2 + Sqrt[10])*x^2)]*Sqrt[-2 + (2 + Sqrt[10])*x^2]*EllipticF[ArcSin[(2^(3/4)*5^(1/4)*x)/Sqrt[-2 + (2 + Sqrt[10])*x^2]], (5 + Sqrt[10])/10])/(2*10^(1/4)*Sqrt[(2 - (2 + Sqrt[10])*x^2)^(-1)]*Sqrt[-2 + 4*x^2 + 3*x^4])", //
				1098);
	}

	// {1098}
	public void test1137() {
		check("Integrate[1/Sqrt[-2 + 3*x^2 + 3*x^4], x]", "(Sqrt[(4 - (3 - Sqrt[33])*x^2)/(4 - (3 + Sqrt[33])*x^2)]*Sqrt[-4 + (3 + Sqrt[33])*x^2]*EllipticF[ArcSin[(Sqrt[2]*33^(1/4)*x)/Sqrt[-4 + (3 + Sqrt[33])*x^2]], (11 + Sqrt[33])/22])/(2*Sqrt[2]*33^(1/4)*Sqrt[(4 - (3 + Sqrt[33])*x^2)^(-1)]*Sqrt[-2 + 3*x^2 + 3*x^4])", //
				1098);
	}

	// {1098}
	public void test1138() {
		check("Integrate[1/Sqrt[-2 + 2*x^2 + 3*x^4], x]", "(Sqrt[(2 - (1 - Sqrt[7])*x^2)/(2 - (1 + Sqrt[7])*x^2)]*Sqrt[-2 + (1 + Sqrt[7])*x^2]*EllipticF[ArcSin[(Sqrt[2]*7^(1/4)*x)/Sqrt[-2 + (1 + Sqrt[7])*x^2]], (7 + Sqrt[7])/14])/(2*7^(1/4)*Sqrt[(2 - (1 + Sqrt[7])*x^2)^(-1)]*Sqrt[-2 + 2*x^2 + 3*x^4])", //
				1098);
	}

	// {1097}
	public void test1139() {
		check("Integrate[1/Sqrt[-2 + x^2 + 3*x^4], x]", "(Sqrt[1 + x^2]*Sqrt[-2 + 3*x^2]*EllipticF[ArcSin[(Sqrt[5]*x)/Sqrt[-2 + 3*x^2]], 3/5])/(Sqrt[5]*Sqrt[-2 + x^2 + 3*x^4])", //
				1097);
	}

	// {223}
	public void test1140() {
		check("Integrate[1/Sqrt[-2 + 3*x^4], x]", "(Sqrt[-2 + Sqrt[6]*x^2]*Sqrt[(2 + Sqrt[6]*x^2)/(2 - Sqrt[6]*x^2)]*EllipticF[ArcSin[(2^(3/4)*3^(1/4)*x)/Sqrt[-2 + Sqrt[6]*x^2]], 1/2])/(2*6^(1/4)*Sqrt[(2 - Sqrt[6]*x^2)^(-1)]*Sqrt[-2 + 3*x^4])", //
				223);
	}

	// {1097}
	public void test1141() {
		check("Integrate[1/Sqrt[-2 - x^2 + 3*x^4], x]", "(Sqrt[-1 + x^2]*Sqrt[2 + 3*x^2]*EllipticF[ArcSin[(Sqrt[5/2]*x)/Sqrt[-1 + x^2]], 2/5])/(Sqrt[5]*Sqrt[-2 - x^2 + 3*x^4])", //
				1097);
	}

	// {1098}
	public void test1142() {
		check("Integrate[1/Sqrt[-2 - 2*x^2 + 3*x^4], x]", "(Sqrt[-2 - (1 - Sqrt[7])*x^2]*Sqrt[(2 + (1 + Sqrt[7])*x^2)/(2 + (1 - Sqrt[7])*x^2)]*EllipticF[ArcSin[(Sqrt[2]*7^(1/4)*x)/Sqrt[-2 - (1 - Sqrt[7])*x^2]], (7 - Sqrt[7])/14])/(2*7^(1/4)*Sqrt[(2 + (1 - Sqrt[7])*x^2)^(-1)]*Sqrt[-2 - 2*x^2 + 3*x^4])", //
				1098);
	}

	// {1098}
	public void test1143() {
		check("Integrate[1/Sqrt[-2 - 3*x^2 + 3*x^4], x]", "(Sqrt[-4 - (3 - Sqrt[33])*x^2]*Sqrt[(4 + (3 + Sqrt[33])*x^2)/(4 + (3 - Sqrt[33])*x^2)]*EllipticF[ArcSin[(Sqrt[2]*33^(1/4)*x)/Sqrt[-4 - (3 - Sqrt[33])*x^2]], (11 - Sqrt[33])/22])/(2*Sqrt[2]*33^(1/4)*Sqrt[(4 + (3 - Sqrt[33])*x^2)^(-1)]*Sqrt[-2 - 3*x^2 + 3*x^4])", //
				1098);
	}

	// {1098}
	public void test1144() {
		check("Integrate[1/Sqrt[-2 - 4*x^2 + 3*x^4], x]", "(Sqrt[-2 - (2 - Sqrt[10])*x^2]*Sqrt[(2 + (2 + Sqrt[10])*x^2)/(2 + (2 - Sqrt[10])*x^2)]*EllipticF[ArcSin[(2^(3/4)*5^(1/4)*x)/Sqrt[-2 - (2 - Sqrt[10])*x^2]], (5 - Sqrt[10])/10])/(2*10^(1/4)*Sqrt[(2 + (2 - Sqrt[10])*x^2)^(-1)]*Sqrt[-2 - 4*x^2 + 3*x^4])", //
				1098);
	}

	// {1097}
	public void test1145() {
		check("Integrate[1/Sqrt[-2 - 5*x^2 + 3*x^4], x]", "(Sqrt[-2 + x^2]*Sqrt[1 + 3*x^2]*EllipticF[ArcSin[(Sqrt[7]*x)/Sqrt[-2 + x^2]], 1/7])/(Sqrt[7]*Sqrt[-2 - 5*x^2 + 3*x^4])", //
				1097);
	}

	// {1098}
	public void test1146() {
		check("Integrate[1/Sqrt[-3 + 7*x^2 + 2*x^4], x]", "(Sqrt[(6 - (7 - Sqrt[73])*x^2)/(6 - (7 + Sqrt[73])*x^2)]*Sqrt[-6 + (7 + Sqrt[73])*x^2]*EllipticF[ArcSin[(Sqrt[2]*73^(1/4)*x)/Sqrt[-6 + (7 + Sqrt[73])*x^2]], (73 + 7*Sqrt[73])/146])/(2*Sqrt[3]*73^(1/4)*Sqrt[(6 - (7 + Sqrt[73])*x^2)^(-1)]*Sqrt[-3 + 7*x^2 + 2*x^4])", //
				1098);
	}

	// {1098}
	public void test1147() {
		check("Integrate[1/Sqrt[-3 + 6*x^2 + 2*x^4], x]", "(Sqrt[(3 - (3 - Sqrt[15])*x^2)/(3 - (3 + Sqrt[15])*x^2)]*Sqrt[-3 + (3 + Sqrt[15])*x^2]*EllipticF[ArcSin[(Sqrt[2]*15^(1/4)*x)/Sqrt[-3 + (3 + Sqrt[15])*x^2]], (5 + Sqrt[15])/10])/(Sqrt[2]*3^(3/4)*5^(1/4)*Sqrt[(3 - (3 + Sqrt[15])*x^2)^(-1)]*Sqrt[-3 + 6*x^2 + 2*x^4])", //
				1098);
	}

	// {1097}
	public void test1148() {
		check("Integrate[1/Sqrt[-3 + 5*x^2 + 2*x^4], x]", "(Sqrt[3 + x^2]*Sqrt[-1 + 2*x^2]*EllipticF[ArcSin[(Sqrt[7/3]*x)/Sqrt[-1 + 2*x^2]], 6/7])/(Sqrt[7]*Sqrt[-3 + 5*x^2 + 2*x^4])", //
				1097);
	}

	// {1098}
	public void test1149() {
		check("Integrate[1/Sqrt[-3 + 4*x^2 + 2*x^4], x]", "(Sqrt[(3 - (2 - Sqrt[10])*x^2)/(3 - (2 + Sqrt[10])*x^2)]*Sqrt[-3 + (2 + Sqrt[10])*x^2]*EllipticF[ArcSin[(2^(3/4)*5^(1/4)*x)/Sqrt[-3 + (2 + Sqrt[10])*x^2]], (5 + Sqrt[10])/10])/(2^(3/4)*Sqrt[3]*5^(1/4)*Sqrt[(3 - (2 + Sqrt[10])*x^2)^(-1)]*Sqrt[-3 + 4*x^2 + 2*x^4])", //
				1098);
	}

	// {1098}
	public void test1150() {
		check("Integrate[1/Sqrt[-3 + 3*x^2 + 2*x^4], x]", "(Sqrt[(6 - (3 - Sqrt[33])*x^2)/(6 - (3 + Sqrt[33])*x^2)]*Sqrt[-6 + (3 + Sqrt[33])*x^2]*EllipticF[ArcSin[(Sqrt[2]*33^(1/4)*x)/Sqrt[-6 + (3 + Sqrt[33])*x^2]], (11 + Sqrt[33])/22])/(2*3^(3/4)*11^(1/4)*Sqrt[(6 - (3 + Sqrt[33])*x^2)^(-1)]*Sqrt[-3 + 3*x^2 + 2*x^4])", //
				1098);
	}

	// {1098}
	public void test1151() {
		check("Integrate[1/Sqrt[-3 + 2*x^2 + 2*x^4], x]", "(Sqrt[(3 - (1 - Sqrt[7])*x^2)/(3 - (1 + Sqrt[7])*x^2)]*Sqrt[-3 + (1 + Sqrt[7])*x^2]*EllipticF[ArcSin[(Sqrt[2]*7^(1/4)*x)/Sqrt[-3 + (1 + Sqrt[7])*x^2]], (7 + Sqrt[7])/14])/(Sqrt[6]*7^(1/4)*Sqrt[(3 - (1 + Sqrt[7])*x^2)^(-1)]*Sqrt[-3 + 2*x^2 + 2*x^4])", //
				1098);
	}

	// {1097}
	public void test1152() {
		check("Integrate[1/Sqrt[-3 + x^2 + 2*x^4], x]", "(Sqrt[-1 + x^2]*Sqrt[3 + 2*x^2]*EllipticF[ArcSin[(Sqrt[5/3]*x)/Sqrt[-1 + x^2]], 3/5])/(Sqrt[5]*Sqrt[-3 + x^2 + 2*x^4])", //
				1097);
	}

	// {223}
	public void test1153() {
		check("Integrate[1/Sqrt[-3 + 2*x^4], x]", "(Sqrt[-3 + Sqrt[6]*x^2]*Sqrt[(3 + Sqrt[6]*x^2)/(3 - Sqrt[6]*x^2)]*EllipticF[ArcSin[(2^(3/4)*3^(1/4)*x)/Sqrt[-3 + Sqrt[6]*x^2]], 1/2])/(6^(3/4)*Sqrt[(3 - Sqrt[6]*x^2)^(-1)]*Sqrt[-3 + 2*x^4])", //
				223);
	}

	// {1097}
	public void test1154() {
		check("Integrate[1/Sqrt[-3 - x^2 + 2*x^4], x]", "(Sqrt[1 + x^2]*Sqrt[-3 + 2*x^2]*EllipticF[ArcSin[(Sqrt[5]*x)/Sqrt[-3 + 2*x^2]], 2/5])/(Sqrt[5]*Sqrt[-3 - x^2 + 2*x^4])", //
				1097);
	}

	// {1098}
	public void test1155() {
		check("Integrate[1/Sqrt[-3 - 2*x^2 + 2*x^4], x]", "(Sqrt[-3 - (1 - Sqrt[7])*x^2]*Sqrt[(3 + (1 + Sqrt[7])*x^2)/(3 + (1 - Sqrt[7])*x^2)]*EllipticF[ArcSin[(Sqrt[2]*7^(1/4)*x)/Sqrt[-3 - (1 - Sqrt[7])*x^2]], (7 - Sqrt[7])/14])/(Sqrt[6]*7^(1/4)*Sqrt[(3 + (1 - Sqrt[7])*x^2)^(-1)]*Sqrt[-3 - 2*x^2 + 2*x^4])", //
				1098);
	}

	// {1098}
	public void test1156() {
		check("Integrate[1/Sqrt[-3 - 3*x^2 + 2*x^4], x]", "(Sqrt[-6 - (3 - Sqrt[33])*x^2]*Sqrt[(6 + (3 + Sqrt[33])*x^2)/(6 + (3 - Sqrt[33])*x^2)]*EllipticF[ArcSin[(Sqrt[2]*33^(1/4)*x)/Sqrt[-6 - (3 - Sqrt[33])*x^2]], (11 - Sqrt[33])/22])/(2*3^(3/4)*11^(1/4)*Sqrt[(6 + (3 - Sqrt[33])*x^2)^(-1)]*Sqrt[-3 - 3*x^2 + 2*x^4])", //
				1098);
	}

	// {1098}
	public void test1157() {
		check("Integrate[1/Sqrt[-3 - 4*x^2 + 2*x^4], x]", "(Sqrt[-3 - (2 - Sqrt[10])*x^2]*Sqrt[(3 + (2 + Sqrt[10])*x^2)/(3 + (2 - Sqrt[10])*x^2)]*EllipticF[ArcSin[(2^(3/4)*5^(1/4)*x)/Sqrt[-3 - (2 - Sqrt[10])*x^2]], (5 - Sqrt[10])/10])/(2^(3/4)*Sqrt[3]*5^(1/4)*Sqrt[(3 + (2 - Sqrt[10])*x^2)^(-1)]*Sqrt[-3 - 4*x^2 + 2*x^4])", //
				1098);
	}

	// {1097}
	public void test1158() {
		check("Integrate[1/Sqrt[-3 - 5*x^2 + 2*x^4], x]", "(Sqrt[-3 + x^2]*Sqrt[1 + 2*x^2]*EllipticF[ArcSin[(Sqrt[7]*x)/Sqrt[-3 + x^2]], 1/7])/(Sqrt[7]*Sqrt[-3 - 5*x^2 + 2*x^4])", //
				1097);
	}

	// {1100}
	public void test1159() {
		check("Integrate[1/Sqrt[2 + 5*x^2 + 3*x^4], x]", "((1 + x^2)*Sqrt[(2 + 3*x^2)/(1 + x^2)]*EllipticF[ArcTan[x], -1/2])/(Sqrt[2]*Sqrt[2 + 5*x^2 + 3*x^4])", //
				1100);
	}

	// {1103}
	public void test1160() {
		check("Integrate[1/Sqrt[2 + 4*x^2 + 3*x^4], x]", "((2 + Sqrt[6]*x^2)*Sqrt[(2 + 4*x^2 + 3*x^4)/(2 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(3/2)^(1/4)*x], 1/2 - 1/Sqrt[6]])/(2*6^(1/4)*Sqrt[2 + 4*x^2 + 3*x^4])", //
				1103);
	}

	// {1103}
	public void test1161() {
		check("Integrate[1/Sqrt[2 + 3*x^2 + 3*x^4], x]", "((2 + Sqrt[6]*x^2)*Sqrt[(2 + 3*x^2 + 3*x^4)/(2 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(3/2)^(1/4)*x], (4 - Sqrt[6])/8])/(2*6^(1/4)*Sqrt[2 + 3*x^2 + 3*x^4])", //
				1103);
	}

	// {1103}
	public void test1162() {
		check("Integrate[1/Sqrt[2 + 2*x^2 + 3*x^4], x]", "((2 + Sqrt[6]*x^2)*Sqrt[(2 + 2*x^2 + 3*x^4)/(2 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(3/2)^(1/4)*x], (6 - Sqrt[6])/12])/(2*6^(1/4)*Sqrt[2 + 2*x^2 + 3*x^4])", //
				1103);
	}

	// {1103}
	public void test1163() {
		check("Integrate[1/Sqrt[2 + x^2 + 3*x^4], x]", "((2 + Sqrt[6]*x^2)*Sqrt[(2 + x^2 + 3*x^4)/(2 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(3/2)^(1/4)*x], (12 - Sqrt[6])/24])/(2*6^(1/4)*Sqrt[2 + x^2 + 3*x^4])", //
				1103);
	}

	// {220}
	public void test1164() {
		check("Integrate[1/Sqrt[2 + 3*x^4], x]", "((2 + Sqrt[6]*x^2)*Sqrt[(2 + 3*x^4)/(2 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(3/2)^(1/4)*x], 1/2])/(2*6^(1/4)*Sqrt[2 + 3*x^4])", //
				220);
	}
	...
	public void test1169() {
		check("Integrate[1/Sqrt[2 - 5*x^2 + 3*x^4], x]", "((2 + Sqrt[6]*x^2)*Sqrt[(2 - 5*x^2 + 3*x^4)/(2 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(3/2)^(1/4)*x], (12 + 5*Sqrt[6])/24])/(2*6^(1/4)*Sqrt[2 - 5*x^2 + 3*x^4])", //
				1096);
	}

	// {1096}
	public void test1170() {
		check("Integrate[1/Sqrt[2 - 6*x^2 + 3*x^4], x]", "((2 + Sqrt[6]*x^2)*Sqrt[(2 - 6*x^2 + 3*x^4)/(2 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(3/2)^(1/4)*x], (2 + Sqrt[6])/4])/(2*6^(1/4)*Sqrt[2 - 6*x^2 + 3*x^4])", //
				1096);
	}

	// {1099}
	public void test1171() {
		check("Integrate[1/Sqrt[3 + 9*x^2 + 2*x^4], x]", "(Sqrt[(6 + (9 - Sqrt[57])*x^2)/(6 + (9 + Sqrt[57])*x^2)]*(6 + (9 + Sqrt[57])*x^2)*EllipticF[ArcTan[Sqrt[(9 + Sqrt[57])/6]*x], (-19 + 3*Sqrt[57])/4])/(Sqrt[6*(9 + Sqrt[57])]*Sqrt[3 + 9*x^2 + 2*x^4])", //
				1099);
	}

	// {1099}
	public void test1172() {
		check("Integrate[1/Sqrt[3 + 8*x^2 + 2*x^4], x]", "(Sqrt[(3 + (4 - Sqrt[10])*x^2)/(3 + (4 + Sqrt[10])*x^2)]*(3 + (4 + Sqrt[10])*x^2)*EllipticF[ArcTan[Sqrt[(4 + Sqrt[10])/3]*x], (-2*(5 - 2*Sqrt[10]))/3])/(Sqrt[3*(4 + Sqrt[10])]*Sqrt[3 + 8*x^2 + 2*x^4])", //
				1099);
	}

	// {1099}
	public void test1173() {
		check("Integrate[1/Sqrt[3 + 7*x^2 + 2*x^4], x]", "(Sqrt[(3 + x^2)/(1 + 2*x^2)]*(1 + 2*x^2)*EllipticF[ArcTan[Sqrt[2]*x], 5/6])/(Sqrt[6]*Sqrt[3 + 7*x^2 + 2*x^4])", //
				1099);
	}

	// {1099}
	public void test1174() {
		check("Integrate[1/Sqrt[3 + 6*x^2 + 2*x^4], x]", "(Sqrt[(3 + (3 - Sqrt[3])*x^2)/(3 + (3 + Sqrt[3])*x^2)]*(3 + (3 + Sqrt[3])*x^2)*EllipticF[ArcTan[Sqrt[(3 + Sqrt[3])/3]*x], -1 + Sqrt[3]])/(Sqrt[3*(3 + Sqrt[3])]*Sqrt[3 + 6*x^2 + 2*x^4])", //
				1099);
	}

	// {1099}
	public void test1175() {
		check("Integrate[1/Sqrt[3 + 5*x^2 + 2*x^4], x]", "((1 + x^2)*Sqrt[(3 + 2*x^2)/(1 + x^2)]*EllipticF[ArcTan[x], 1/3])/(Sqrt[3]*Sqrt[3 + 5*x^2 + 2*x^4])", //
				1099);
	}

	// {1103}
	public void test1176() {
		check("Integrate[1/Sqrt[3 + 4*x^2 + 2*x^4], x]", "((3 + Sqrt[6]*x^2)*Sqrt[(3 + 4*x^2 + 2*x^4)/(3 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(2/3)^(1/4)*x], 1/2 - 1/Sqrt[6]])/(2*6^(1/4)*Sqrt[3 + 4*x^2 + 2*x^4])", //
				1103);
	}

	// {1103}
	public void test1177() {
		check("Integrate[1/Sqrt[3 + 3*x^2 + 2*x^4], x]", "((3 + Sqrt[6]*x^2)*Sqrt[(3 + 3*x^2 + 2*x^4)/(3 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(2/3)^(1/4)*x], (4 - Sqrt[6])/8])/(2*6^(1/4)*Sqrt[3 + 3*x^2 + 2*x^4])", //
				1103);
	}

	// {1103}
	public void test1178() {
		check("Integrate[1/Sqrt[3 + 2*x^2 + 2*x^4], x]", "((3 + Sqrt[6]*x^2)*Sqrt[(3 + 2*x^2 + 2*x^4)/(3 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(2/3)^(1/4)*x], (6 - Sqrt[6])/12])/(2*6^(1/4)*Sqrt[3 + 2*x^2 + 2*x^4])", //
				1103);
	}

	// {1103}
	public void test1179() {
		check("Integrate[1/Sqrt[3 + x^2 + 2*x^4], x]", "((3 + Sqrt[6]*x^2)*Sqrt[(3 + x^2 + 2*x^4)/(3 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(2/3)^(1/4)*x], (12 - Sqrt[6])/24])/(2*6^(1/4)*Sqrt[3 + x^2 + 2*x^4])", //
				1103);
	}

	// {220}
	public void test1180() {
		check("Integrate[1/Sqrt[3 + 2*x^4], x]", "((3 + Sqrt[6]*x^2)*Sqrt[(3 + 2*x^4)/(3 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(2/3)^(1/4)*x], 1/2])/(2*6^(1/4)*Sqrt[3 + 2*x^4])", //
				220);
	}
	...
	public void test1185() {
		check("Integrate[1/Sqrt[3 - 5*x^2 + 2*x^4], x]", "((3 + Sqrt[6]*x^2)*Sqrt[(3 - 5*x^2 + 2*x^4)/(3 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(2/3)^(1/4)*x], (12 + 5*Sqrt[6])/24])/(2*6^(1/4)*Sqrt[3 - 5*x^2 + 2*x^4])", //
				1096);
	}

	// {1096}
	public void test1186() {
		check("Integrate[1/Sqrt[3 - 6*x^2 + 2*x^4], x]", "((3 + Sqrt[6]*x^2)*Sqrt[(3 - 6*x^2 + 2*x^4)/(3 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(2/3)^(1/4)*x], (2 + Sqrt[6])/4])/(2*6^(1/4)*Sqrt[3 - 6*x^2 + 2*x^4])", //
				1096);
	}

	// {1096}
	public void test1187() {
		check("Integrate[1/Sqrt[3 - 7*x^2 + 2*x^4], x]", "((3 + Sqrt[6]*x^2)*Sqrt[(3 - 7*x^2 + 2*x^4)/(3 + Sqrt[6]*x^2)^2]*EllipticF[2*ArcTan[(2/3)^(1/4)*x], (12 + 7*Sqrt[6])/24])/(2*6^(1/4)*Sqrt[3 - 7*x^2 + 2*x^4])", //
				1096);
	}
	...
	public void test1206() {
		check("Integrate[1/Sqrt[2 + 5*x^2 + 5*x^4], x]", "((2 + Sqrt[10]*x^2)*Sqrt[(2 + 5*x^2 + 5*x^4)/(2 + Sqrt[10]*x^2)^2]*EllipticF[2*ArcTan[(5/2)^(1/4)*x], (4 - Sqrt[10])/8])/(2*10^(1/4)*Sqrt[2 + 5*x^2 + 5*x^4])", //
				1103);
	}

	// {1103}
	public void test1207() {
		check("Integrate[1/Sqrt[2 + 5*x^2 + 4*x^4], x]", "((1 + Sqrt[2]*x^2)*Sqrt[(2 + 5*x^2 + 4*x^4)/(1 + Sqrt[2]*x^2)^2]*EllipticF[2*ArcTan[2^(1/4)*x], (8 - 5*Sqrt[2])/16])/(2*2^(3/4)*Sqrt[2 + 5*x^2 + 4*x^4])", //
				1103);
	}
	...
	public void test1209() {
		check("Integrate[1/Sqrt[2 + 5*x^2 + 2*x^4], x]", "(Sqrt[(2 + x^2)/(1 + 2*x^2)]*(1 + 2*x^2)*EllipticF[ArcTan[Sqrt[2]*x], 3/4])/(2*Sqrt[2 + 5*x^2 + 2*x^4])", //
				1099);
	}

	// {1099}
	public void test1210() {
		check("Integrate[1/Sqrt[2 + 5*x^2 + x^4], x]", "(Sqrt[(4 + (5 - Sqrt[17])*x^2)/(4 + (5 + Sqrt[17])*x^2)]*(4 + (5 + Sqrt[17])*x^2)*EllipticF[ArcTan[(Sqrt[5 + Sqrt[17]]*x)/2], (-17 + 5*Sqrt[17])/4])/(2*Sqrt[5 + Sqrt[17]]*Sqrt[2 + 5*x^2 + x^4])", //
				1099);
	}

	// {1584, 261}
	public void test1212() {
		check("Integrate[x^5/(b*x^2 + c*x^4)^2, x]", "-1/(2*c*(b + c*x^2))", //
				1584, 261);
	}

	// {1584, 261}
	public void test1213() {
		check("Integrate[x^7/(b*x^2 + c*x^4)^3, x]", "-1/(4*c*(b + c*x^2)^2)", //
				1584, 261);
	}
	...
	public void test1223() {
		check("Integrate[Sqrt[a^2 + 2*a*b*x^2 + b^2*x^4]/x^7, x]", "-((a + b*x^2)*Sqrt[a^2 + 2*a*b*x^2 + b^2*x^4])/(4*a*x^6) + (a^2 + 2*a*b*x^2 + b^2*x^4)^(3/2)/(12*a^2*x^6)", //
				1110);
	}

	// {1110}
	public void test1224() {
		check("Integrate[(a^2 + 2*a*b*x^2 + b^2*x^4)^(3/2)/x^11, x]", "-((a + b*x^2)*(a^2 + 2*a*b*x^2 + b^2*x^4)^(3/2))/(8*a*x^10) + (a^2 + 2*a*b*x^2 + b^2*x^4)^(5/2)/(40*a^2*x^10)", //
				1110);
	}

	// {1110}
	public void test1225() {
		check("Integrate[(a^2 + 2*a*b*x^2 + b^2*x^4)^(5/2)/x^15, x]", "-((a + b*x^2)*(a^2 + 2*a*b*x^2 + b^2*x^4)^(5/2))/(12*a*x^14) + (a^2 + 2*a*b*x^2 + b^2*x^4)^(7/2)/(84*a^2*x^14)", //
				1110);
	}

	// {1109}
	public void test1226() {
		check("Integrate[x^5/(a^2 + 2*a*b*x^2 + b^2*x^4)^(5/2), x]", "x^6/(24*a^2*(a^2 + 2*a*b*x^2 + b^2*x^4)^(3/2)) + x^6/(8*a*(a + b*x^2)*(a^2 + 2*a*b*x^2 + b^2*x^4)^(3/2))", //
				1109);
	}

	// {1103}
	public void test1228() {
		check("Integrate[1/Sqrt[a + b*x^2 + c*x^4], x]", "((Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + b*x^2 + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticF[2*ArcTan[(c^(1/4)*x)/a^(1/4)], (2 - b/(Sqrt[a]*Sqrt[c]))/4])/(2*a^(1/4)*c^(1/4)*Sqrt[a + b*x^2 + c*x^4])", //
				1103);
	}

	// {1196}
	public void test1229() {
		check("Integrate[(1 - b*x^2)/Sqrt[1 + b^2*x^4], x]", "-((x*Sqrt[1 + b^2*x^4])/(1 + b*x^2)) + ((1 + b*x^2)*Sqrt[(1 + b^2*x^4)/(1 + b*x^2)^2]*EllipticE[2*ArcTan[Sqrt[b]*x], 1/2])/(Sqrt[b]*Sqrt[1 + b^2*x^4])", //
				1196);
	}
	...
	public void test1232() {
		check("Integrate[1/((a + b*x^2)*Sqrt[4 - d*x^4]), x]", "EllipticPi[(-2*b)/(a*Sqrt[d]), ArcSin[(d^(1/4)*x)/Sqrt[2]], -1]/(Sqrt[2]*a*d^(1/4))", //
				1218);
	}
	...
	public void test1234() {
		check("Integrate[Sqrt[1 + x^2 + x^4]/(1 + x^2)^2, x]", "((1 + x^2)*Sqrt[(1 + x^2 + x^4)/(1 + x^2)^2]*EllipticE[2*ArcTan[x], 1/4])/(2*Sqrt[1 + x^2 + x^4])", //
				1225);
	}

	// {1099}
	public void test1235() {
		check("Integrate[1/Sqrt[2 + 3*x^2 + x^4], x]", "((1 + x^2)*Sqrt[(2 + x^2)/(1 + x^2)]*EllipticF[ArcTan[x], 1/2])/(Sqrt[2]*Sqrt[2 + 3*x^2 + x^4])", //
				1099);
	}

	// {1103}
	public void test1236() {
		check("Integrate[1/Sqrt[4 + 3*x^2 + x^4], x]", "((2 + x^2)*Sqrt[(4 + 3*x^2 + x^4)/(2 + x^2)^2]*EllipticF[2*ArcTan[x/Sqrt[2]], 1/8])/(2*Sqrt[2]*Sqrt[4 + 3*x^2 + x^4])", //
				1103);
	}
	...
	public void test1246() {
		check("Integrate[x^(-1 - n*(1 + 2*p))*(b*x^n + c*x^(2*n))^p, x]", "-((b*x^n + c*x^(2*n))^(1 + p)/(b*n*(1 + p)*x^(2*n*(1 + p))))", //
				2014);
	}
	...
	public void test1254() {
		check("Integrate[x*(b + 2*c*x^2)*(b*x^2 + c*x^4)^13, x]", "(x^28*(b + c*x^2)^14)/28", //
				1584, 446, 74);
	}

	// {1584, 446, 74}
	public void test1255() {
		check("Integrate[x^2*(b + 2*c*x^3)*(b*x^3 + c*x^6)^13, x]", "(x^42*(b + c*x^3)^14)/42", //
				1584, 446, 74);
	}
	...
	public void test1269() {
		check("Integrate[(x*(b + 2*c*x^2))/(b*x^2 + c*x^4), x]", "Log[x] + Log[b + c*x^2]/2", //
				1584, 446, 72);
	}

	// {1584, 446, 72}
	public void test1270() {
		check("Integrate[(x^2*(b + 2*c*x^3))/(b*x^3 + c*x^6), x]", "Log[x] + Log[b + c*x^3]/3", //
				1584, 446, 72);
	}
	...
	public void test1272() {
		check("Integrate[(x*(b + 2*c*x^2))/(b*x^2 + c*x^4)^8, x]", "-1/(14*x^14*(b + c*x^2)^7)", //
				1584, 446, 74);
	}

	// {1584, 446, 74}
	public void test1273() {
		check("Integrate[(x^2*(b + 2*c*x^3))/(b*x^3 + c*x^6)^8, x]", "-1/(21*x^21*(b + c*x^3)^7)", //
				1584, 446, 74);
	}
	...
	public void test1283() {
		check("Integrate[(a + b*x^n + c*x^(2*n))^p*(a + b*(1 + n + n*p)*x^n + c*(1 + 2*n*(1 + p))*x^(2*n)), x]", "x*(a + b*x^n + c*x^(2*n))^(1 + p)", //
				1775);
	}

	// {1816}
	public void test1284() {
		check("Integrate[(x^(-1 + n/4)*(-(a*h) + c*f*x^(n/4) + c*g*x^((3*n)/4) + c*h*x^n))/(a + c*x^n)^(3/2), x]", "(-2*(a*g + 2*a*h*x^(n/4) - c*f*x^(n/2)))/(a*n*Sqrt[a + c*x^n])", //
				1816);
	}

	// {1753}
	public void test1285() {
		check("Integrate[(x^(-1 + n/2)*(-(a*h) + c*f*x^(n/2) + c*g*x^((3*n)/2) + c*h*x^(2*n)))/(a + b*x^n + c*x^(2*n))^(3/2), x]", "(-2*(c*(b*f - 2*a*g) + (b^2 - 4*a*c)*h*x^(n/2) + c*(2*c*f - b*g)*x^n))/((b^2 - 4*a*c)*n*Sqrt[a + b*x^n + c*x^(2*n)])", //
				1753);
	}

	// {1747}
	public void test1286() {
		check("Integrate[(g*x)^m*(a + b*x^n + c*x^(2*n))^p*(a*(1 + m) + b*(1 + m + n + n*p)*x^n + c*(1 + m + 2*n*(1 + p))*x^(2*n)), x]", "((g*x)^(1 + m)*(a + b*x^n + c*x^(2*n))^(1 + p))/g", //
				1747);
	}
	...
	public void test1291() {
		check("Integrate[x^((3*(-1 + n))/2)/(a*x^(-1 + n) + b*x^n + c*x^(1 + n))^(3/2), x]", "(-2*x^((-1 + n)/2)*(b + 2*c*x))/((b^2 - 4*a*c)*Sqrt[a*x^(-1 + n) + b*x^n + c*x^(1 + n)])", //
				1915);
	}
	...
	public void test1303() {
		check("Integrate[x^14*(b + 2*c*x^2)*(b*x + c*x^3)^13, x]", "(x^28*(b + c*x^2)^14)/28", //
				1584, 446, 74);
	}

	// {1584, 446, 74}
	public void test1304() {
		check("Integrate[x^28*(b + 2*c*x^3)*(b*x + c*x^4)^13, x]", "(x^42*(b + c*x^3)^14)/42", //
				1584, 446, 74);
	}
	...
	public void test1307() {
		check("Integrate[(b + 2*c*x^2)/(x^7*(b*x + c*x^3)^8), x]", "-1/(14*x^14*(b + c*x^2)^7)", //
				1584, 446, 74);
	}

	// {1584, 446, 74}
	public void test1308() {
		check("Integrate[(b + 2*c*x^3)/(x^14*(b*x + c*x^4)^8), x]", "-1/(21*x^21*(b + c*x^3)^7)", //
				1584, 446, 74);
	}
	...
	public void test1312() {
		check("Integrate[x^((-1 + n)*(1 + p))*(b + 2*c*x^n)*(b*x + c*x^(1 + n))^p, x]", "(b*x + c*x^(1 + n))^(1 + p)/(n*(1 + p)*x^((1 - n)*(1 + p)))", //
				2036);
	}
	...
	public void test1333() {
		check("Integrate[x^7*(c*x + d*x^2)^7*(2*c*x + 3*d*x^2), x]", "(x^16*(c + d*x)^8)/8", //
				1584, 845);
	}
	...
	public void test1336() {
		check("Integrate[x*(2*c + 3*d*x)*(c*x^2 + d*x^3)^7, x]", "(x^16*(c + d*x)^8)/8", //
				1584, 74);
	}
	...
	public void test1345() {
		check("Integrate[x^m*(a + b*x + c*x^2 + d*x^3)^p*(a*(1 + m) + x*(b*(2 + m + p) + x*(c*(3 + m + 2*p) + d*(4 + m + 3*p)*x))), x]", "x^(1 + m)*(a + b*x + c*x^2 + d*x^3)^(1 + p)", //
				1590);
	}

	// {1588}
	public void test1346() {
		check("Integrate[x^2*(a + b*x + c*x^2 + d*x^3)^p*(3*a + b*(4 + p)*x + c*(5 + 2*p)*x^2 + d*(6 + 3*p)*x^3), x]", "x^3*(a + b*x + c*x^2 + d*x^3)^(1 + p)", //
				1588);
	}

	// {1588}
	public void test1347() {
		check("Integrate[x*(a + b*x + c*x^2 + d*x^3)^p*(2*a + b*(3 + p)*x + c*(4 + 2*p)*x^2 + d*(5 + 3*p)*x^3), x]", "x^2*(a + b*x + c*x^2 + d*x^3)^(1 + p)", //
				1588);
	}

	// {1588}
	public void test1348() {
		check("Integrate[(a + b*x + c*x^2 + d*x^3)^p*(a + b*(2 + p)*x + c*(3 + 2*p)*x^2 + d*(4 + 3*p)*x^3), x]", "x*(a + b*x + c*x^2 + d*x^3)^(1 + p)", //
				1588);
	}

	// {1585, 1588}
	public void test1349() {
		check("Integrate[((a + b*x + c*x^2 + d*x^3)^p*(b*(1 + p)*x + c*(2 + 2*p)*x^2 + d*(3 + 3*p)*x^3))/x, x]", "(a + b*x + c*x^2 + d*x^3)^(1 + p)", //
				1585, 1588);
	}

	// {1590}
	public void test1350() {
		check("Integrate[((a + b*x + c*x^2 + d*x^3)^p*(-a + b*p*x + c*(1 + 2*p)*x^2 + d*(2 + 3*p)*x^3))/x^2, x]", "(a + b*x + c*x^2 + d*x^3)^(1 + p)/x", //
				1590);
	}

	// {1590}
	public void test1351() {
		check("Integrate[((a + b*x + c*x^2 + d*x^3)^p*(-2*a + b*(-1 + p)*x + 2*c*p*x^2 + d*(1 + 3*p)*x^3))/x^3, x]", "(a + b*x + c*x^2 + d*x^3)^(1 + p)/x^2", //
				1590);
	}

	// {1590}
	public void test1352() {
		check("Integrate[((a + b*x + c*x^2 + d*x^3)^p*(-3*a + b*(-2 + p)*x + c*(-1 + 2*p)*x^2 + 3*d*p*x^3))/x^4, x]", "(a + b*x + c*x^2 + d*x^3)^(1 + p)/x^3", //
				1590);
	}
	...
	public void test1365() {
		check("Integrate[(2*x + x^2)/(1 + x)^2, x]", "x + (1 + x)^(-1)", //
				683);
	}
	...
	public void test1367() {
		check("Integrate[1/((c + d*x)*(-c^3 + d^3*x^3)^(1/3)), x]", "(Sqrt[3]*ArcTan[(1 - (2^(1/3)*(c - d*x))/(-c^3 + d^3*x^3)^(1/3))/Sqrt[3]])/(2*2^(1/3)*c*d) + Log[(c - d*x)*(c + d*x)^2]/(4*2^(1/3)*c*d) - (3*Log[d*(c - d*x) + 2^(2/3)*d*(-c^3 + d^3*x^3)^(1/3)])/(4*2^(1/3)*c*d)", //
				2148);
	}

	// {2151}
	public void test1368() {
		check("Integrate[(c - d*x)/((c + d*x)*(2*c^3 + d^3*x^3)^(1/3)), x]", "-((Sqrt[3]*ArcTan[(1 + (2*(2*c + d*x))/(2*c^3 + d^3*x^3)^(1/3))/Sqrt[3]])/d) - Log[c + d*x]/d + (3*Log[d*(2*c + d*x) - d*(2*c^3 + d^3*x^3)^(1/3)])/(2*d)", //
				2151);
	}

	// {220}
	public void test1369() {
		check("Integrate[1/Sqrt[a + c*x^4], x]", "((Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticF[2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(2*a^(1/4)*c^(1/4)*Sqrt[a + c*x^4])", //
				220);
	}
	...
	public void test1373() {
		check("Integrate[Sqrt[a + b*Sqrt[a^2/b^2 + c*x^2]], x]", "(2*b^2*c*x^3)/(3*(a + b*Sqrt[a^2/b^2 + c*x^2])^(3/2)) + (2*a*x)/Sqrt[a + b*Sqrt[a^2/b^2 + c*x^2]]", //
				2129);
	}
	...
	public void test1379() {
		check("Integrate[x*(a + b*x + c*x^2)^m*(d + e*x + f*x^2 + g*x^3)^n*(2*a*d + (3*b*d + 3*a*e + b*d*m + a*e*n)*x + (4*c*d + 4*b*e + 4*a*f + 2*c*d*m + b*e*m + b*e*n + 2*a*f*n)*x^2 + (5*c*e + 5*b*f + 5*a*g + 2*c*e*m + b*f*m + c*e*n + 2*b*f*n + 3*a*g*n)*x^3 + (6*c*f + 6*b*g + 2*c*f*m + b*g*m + 2*c*f*n + 3*b*g*n)*x^4 + c*g*(7 + 2*m + 3*n)*x^5), x]", "x^2*(a + b*x + c*x^2)^(1 + m)*(d + e*x + f*x^2 + g*x^3)^(1 + n)", //
				1590);
	}

	// {1590}
	public void test1380() {
		check("Integrate[(a + b*x + c*x^2)^m*(d + e*x + f*x^2 + g*x^3)^n*(a*d + (2*b*d + 2*a*e + b*d*m + a*e*n)*x + (3*c*d + 3*b*e + 3*a*f + 2*c*d*m + b*e*m + b*e*n + 2*a*f*n)*x^2 + (4*c*e + 4*b*f + 4*a*g + 2*c*e*m + b*f*m + c*e*n + 2*b*f*n + 3*a*g*n)*x^3 + (5*c*f + 5*b*g + 2*c*f*m + b*g*m + 2*c*f*n + 3*b*g*n)*x^4 + c*g*(6 + 2*m + 3*n)*x^5), x]", "x*(a + b*x + c*x^2)^(1 + m)*(d + e*x + f*x^2 + g*x^3)^(1 + n)", //
				1590);
	}

	// {1590}
	public void test1381() {
		check("Integrate[(a + b*x + c*x^2)^m*(d + e*x + f*x^2 + g*x^3)^n*(b*d + a*e + b*d*m + a*e*n + (2*c*d + 2*b*e + 2*a*f + 2*c*d*m + b*e*m + b*e*n + 2*a*f*n)*x + (3*c*e + 3*b*f + 3*a*g + 2*c*e*m + b*f*m + c*e*n + 2*b*f*n + 3*a*g*n)*x^2 + (4*c*f + 4*b*g + 2*c*f*m + b*g*m + 2*c*f*n + 3*b*g*n)*x^3 + c*g*(5 + 2*m + 3*n)*x^4), x]", "(a + b*x + c*x^2)^(1 + m)*(d + e*x + f*x^2 + g*x^3)^(1 + n)", //
				1590);
	}
	...
	public void test1402() {
		check("Integrate[(e*f - e*f*x^2)/((a*d + b*d*x + a*d*x^2)*Sqrt[a + b*x + c*x^2 + b*x^3 + a*x^4]), x]", "(e*f*ArcTan[(a*b + (4*a^2 + b^2 - 2*a*c)*x + a*b*x^2)/(2*a*Sqrt[2*a - c]*Sqrt[a + b*x + c*x^2 + b*x^3 + a*x^4])])/(a*Sqrt[2*a - c]*d)", //
				2084);
	}

	// {2085}
	public void test1403() {
		check("Integrate[(e*f - e*f*x^2)/((-(a*d) + b*d*x - a*d*x^2)*Sqrt[-a + b*x + c*x^2 + b*x^3 - a*x^4]), x]", "(e*f*ArcTanh[(a*b - (4*a^2 + b^2 + 2*a*c)*x + a*b*x^2)/(2*a*Sqrt[2*a + c]*Sqrt[-a + b*x + c*x^2 + b*x^3 - a*x^4])])/(a*Sqrt[2*a + c]*d)", //
				2085);
	}
}
