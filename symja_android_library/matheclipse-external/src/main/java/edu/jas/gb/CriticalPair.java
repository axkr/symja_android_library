...
/**
 * Serializable subclass to hold critical pairs of polynomials. Used also to manage reduction status
 * of the pair.
 *
...
public class CriticalPair<C extends RingElem<C>> extends AbstractPair<C> {
   ...
   * Is reduced to zero.
   *
   * @return true if the S-polynomial of this CriticalPair was reduced to ZERO, else false.
   */
   ...
   * Is reduced to one.
   *
   * @return true if the S-polynomial of this CriticalPair was reduced to ONE, else false.
   */
