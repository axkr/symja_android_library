 ...
 * bases with executable channels. Using pairlist class, distributed tasks do reduction, one
...
public class GroebnerBaseDistributedEC<C extends RingElem<C>> extends GroebnerBaseAbstract<C> {
  ...
  /** Pool of threads to use. <b>Note:</b> No ComputerThreads for one node tests */
   ...
   * @param port server port to use.
   */
  public GroebnerBaseDistributedEC(
      String mfile, int threads, ExecutorService pool, PairList<C> pl, int port) {
