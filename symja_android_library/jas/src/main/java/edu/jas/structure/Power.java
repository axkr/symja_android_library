/*
 * $Id: Power.java 4056 2012-07-26 17:44:13Z kredel $
 */
...
public class Power<C extends RingElem<C>> {
	...
	public static edu.jas.arith.BigInteger positivePower(edu.jas.arith.BigInteger a, long n) {
		if (n <= 0) {
		...
		if (a.equals(edu.jas.arith.BigInteger.valueOf(2)) && n < Integer.MAX_VALUE) {
			return edu.jas.arith.BigInteger.ONE.shiftLeft((int) n);
		}
		java.math.BigInteger b = a.getVal();
		long i = n - 1;
		...
		return new edu.jas.arith.BigInteger(p);
	}
	 ...
	 *            element.
	 * @param n
	 *            java.math.BigInteger exponent > 0.
	 * @return a^n.
	 */
