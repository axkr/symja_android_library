...
SetDelayed(Int(Times($p(u,true),Power(Plus(a_,Times($p(b,true),Power(v_,C2))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(Plus(a_,Times($p(b,true),Power(v_,C2))),m_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times($p(u,true),Power(f_,Plus(a_,v_))),Power(g_,Plus(b_,w_))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(f_,Plus(a_,v_))),$p(x,SymbolHead)),
...
SetDelayed(Int(u_,$p(x,SymbolHead)),
    Module(List(Set($s("lst"),FunctionOfSquareRootOfQuadratic(u,x))),Condition(Dist(C2,Subst(Int(Part($s("lst"),C1),x),x,Part($s("lst"),C2))),Not(FalseQ($s("lst")))))),
SetDelayed(Int(Times(u_,Power(Plus(C1,Times(CN1,Power(Plus($p(a,true),Times($p(b,true),x_)),C2))),$p(n,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(Plus(C1,Power(Plus($p(a,true),Times($p(b,true),x_)),C2)),$p(n,true))),$p(x,SymbolHead)),
