...
ISetDelayed(4218,MinimumMonomialExponent(u_,x_Symbol),
...
ISetDelayed(4219,MonomialExponent(Times(a_DEFAULT,Power(x_,n_DEFAULT)),x_Symbol),
    Condition(n,FreeQ(List(a,n),x))),
ISetDelayed(4220,LinearMatchQ(u_,x_Symbol),
...
ISetDelayed(4221,PowerOfLinearMatchQ(u_,x_Symbol),
...
ISetDelayed(4222,QuadraticMatchQ(u_,x_Symbol),
...
ISetDelayed(4223,CubicMatchQ(u_,x_Symbol),
...
ISetDelayed(4224,BinomialMatchQ(u_,x_Symbol),
...
ISetDelayed(4225,GeneralizedBinomialMatchQ(u_,x_Symbol),
...
ISetDelayed(4226,TrinomialMatchQ(u_,x_Symbol),
...
ISetDelayed(4227,GeneralizedTrinomialMatchQ(u_,x_Symbol),
...
ISetDelayed(4228,QuotientOfLinearsMatchQ(u_,x_Symbol),
...
ISetDelayed(4234,NormalizePseudoBinomial(u_,x_Symbol),
...
ISetDelayed(4235,PseudoBinomialParts(u_,x_Symbol),
...
ISetDelayed(4236,PerfectPowerTest(u_,x_Symbol),
...
ISetDelayed(4237,RationalFunctionQ(u_,x_Symbol),
...
ISetDelayed(4241,RationalFunctionExpand(Times(u_,Power(v_,n_)),x_Symbol),
...
ISetDelayed(4242,RationalFunctionExpand(u_,x_Symbol),
...
ISetDelayed(4243,PolyGCD(u_,v_,x_Symbol),
    NonfreeFactors(PolynomialGCD(u,v),x)),
ISetDelayed(4244,AlgebraicFunctionQ(u_,x_Symbol,$p("flag", null,False)),
...
ISetDelayed(4245,QuotientOfLinearsQ(u_,x_Symbol),
...
ISetDelayed(4246,QuotientOfLinearsP(Times(a_,u_),x_),
    Condition(QuotientOfLinearsP(u,x),FreeQ(a,x))),
ISetDelayed(4247,QuotientOfLinearsP(Plus(a_,u_),x_),
    Condition(QuotientOfLinearsP(u,x),FreeQ(a,x))),
ISetDelayed(4248,QuotientOfLinearsP(Power(u_,-1),x_),
    QuotientOfLinearsP(u,x)),
ISetDelayed(4249,QuotientOfLinearsP(u_,x_),
    Condition(True,LinearQ(u,x))),
ISetDelayed(4250,QuotientOfLinearsP(Times(u_,Power(v_,-1)),x_),
    Condition(True,And(LinearQ(u,x),LinearQ(v,x)))),
ISetDelayed(4251,QuotientOfLinearsP(u_,x_),
    Or(SameQ(u,x),FreeQ(u,x))),
ISetDelayed(4252,QuotientOfLinearsParts(Times(a_,u_),x_),
    Condition(Apply(Function(List(Times(a,Slot1),Times(a,Slot2),Slot(C3),Slot(C4))),QuotientOfLinearsParts(u,x)),FreeQ(a,x))),
ISetDelayed(4253,QuotientOfLinearsParts(Plus(a_,u_),x_),
...
ISetDelayed(4258,SubstForFractionalPowerOfQuotientOfLinears(u_,x_Symbol),
...
ISetDelayed(4259,SubstForFractionalPowerQ(u_,v_,x_Symbol),
...
ISetDelayed(4260,SubstForFractionalPowerAuxQ(u_,v_,x_),
...
ISetDelayed(4261,FractionalPowerOfQuotientOfLinears(u_,n_,v_,x_),
...
ISetDelayed(4262,SubstForInverseFunctionOfQuotientOfLinears(u_,x_Symbol),
...
ISetDelayed(4263,InverseFunctionOfQuotientOfLinears(u_,x_Symbol),
...
ISetDelayed(4264,SubstForFractionalPower(u_,v_,n_,w_,x_Symbol),
...
ISetDelayed(4265,SubstForInverseFunction(u_,v_,x_Symbol),
...
ISetDelayed(4266,SubstForInverseFunction(u_,v_,w_,x_Symbol),
...
ISetDelayed(4267,AbsurdNumberQ(u_),
    RationalQ(u)),
ISetDelayed(4268,AbsurdNumberQ(Power(u_,v_)),
    And(RationalQ(u),Greater(u,C0),FractionQ(v))),
ISetDelayed(4269,AbsurdNumberQ(Times(u_,v_)),
    And(AbsurdNumberQ(u),AbsurdNumberQ(v))),
ISetDelayed(4270,AbsurdNumberFactors(u_),
    If(AbsurdNumberQ(u),u,If(ProductQ(u),Map($rubi("Integrate::AbsurdNumberFactors"),u),NumericFactor(u)))),
ISetDelayed(4271,NonabsurdNumberFactors(u_),
    If(AbsurdNumberQ(u),C1,If(ProductQ(u),Map($rubi("Integrate::NonabsurdNumberFactors"),u),NonnumericFactors(u)))),
ISetDelayed(4272,FactorAbsurdNumber(m_),
    If(RationalQ(m),FactorInteger(m),If(PowerQ(m),Map(Function(List(Part(Slot1,C1),Times(Part(Slot1,C2),Part(m,C2)))),FactorInteger(Part(m,C1))),CombineExponents(Sort(Flatten(Map($rubi("Integrate::FactorAbsurdNumber"),Apply($s("List"),m)),C1),Function(Less(Part(Slot1,C1),Part(Slot2,C1)))))))),
ISetDelayed(4273,CombineExponents($p("lst")),
...
ISetDelayed(4274,AbsurdNumberGCD($ps("seq")),
    With(List(Set($s("lst"),List($s("seq")))),If(Equal(Length($s("lst")),C1),First($s("lst")),AbsurdNumberGCDList(FactorAbsurdNumber(First($s("lst"))),FactorAbsurdNumber(Apply($rubi("Integrate::AbsurdNumberGCD"),Rest($s("lst")))))))),
ISetDelayed(4275,AbsurdNumberGCDList($p("lst1"),$p("lst2")),
...
ISetDelayed(4278,NormalizeIntegrandFactor(u_,x_Symbol),
...
ISetDelayed(4279,NormalizeIntegrandFactorBase(Times(u_,Power(x_,m_DEFAULT)),x_Symbol),
    Condition(NormalizeIntegrandFactorBase(Map(Function(Times(Power(x,m),Slot1)),u),x),And(FreeQ(m,x),SumQ(u)))),
ISetDelayed(4280,NormalizeIntegrandFactorBase(u_,x_Symbol),
...
ISetDelayed(4281,NormalizeTogether(u_),
    NormalizeLeadTermSigns(Together(u))),
ISetDelayed(4282,NormalizeLeadTermSigns(u_),
    With(List(Set($s("lst"),If(ProductQ(u),Map($rubi("Integrate::SignOfFactor"),u),SignOfFactor(u)))),If(Equal(Part($s("lst"),C1),C1),Part($s("lst"),C2),AbsorbMinusSign(Part($s("lst"),C2))))),
ISetDelayed(4283,AbsorbMinusSign(Times(u_DEFAULT,$p(v,Plus))),
    Times(u,CN1,v)),
ISetDelayed(4284,AbsorbMinusSign(Times(u_DEFAULT,Power($p(v,Plus),m_))),
    Condition(Times(u,Power(Negate(v),m)),OddQ(m))),
ISetDelayed(4285,AbsorbMinusSign(u_),
    Negate(u)),
ISetDelayed(4286,NormalizeSumFactors(u_),
    If(Or(AtomQ(u),StopFunctionQ(u)),u,If(ProductQ(u),$(Function(Times(Part(Slot1,C1),Part(Slot1,C2))),SignOfFactor(Map($rubi("Integrate::NormalizeSumFactors"),u))),Map($rubi("Integrate::NormalizeSumFactors"),u)))),
ISetDelayed(4287,SignOfFactor(u_),
    If(Or(And(RationalQ(u),Less(u,C0)),And(SumQ(u),Less(NumericFactor(First(u)),C0))),List(CN1,Negate(u)),If(And(IntegerPowerQ(u),SumQ(Part(u,C1)),Less(NumericFactor(First(Part(u,C1))),C0)),List(Power(CN1,Part(u,C2)),Power(Negate(Part(u,C1)),Part(u,C2))),If(ProductQ(u),Map($rubi("Integrate::SignOfFactor"),u),List(C1,u))))),
ISetDelayed(4288,NormalizePowerOfLinear(u_,x_Symbol),
...
ISetDelayed(4289,MergeMonomials(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),n_DEFAULT)),x_Symbol),
...
ISetDelayed(4290,MergeMonomials(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Times(c_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),n_DEFAULT)),p_)),x_Symbol),
...
ISetDelayed(4291,MergeMonomials(Times(a_DEFAULT,Power(u_,m_)),x_Symbol),
    Condition(Times(a,Power(u,Simplify(m))),FreeQ(List(a,m),x))),
ISetDelayed(4292,MergeMonomials(u_,x_Symbol),
    If(LinearQ(u,x),Cancel(u),u)),
ISetDelayed(4293,SimplifyIntegrand(u_,x_Symbol),
...
ISetDelayed(4294,SimplifyTerm(u_,x_Symbol),
...
ISetDelayed(4295,TogetherSimplify(u_),
...
ISetDelayed(4296,SmartSimplify(u_),
...
ISetDelayed(4297,SubstForExpn(u_,v_,w_),
    If(SameQ(u,v),w,If(AtomQ(u),u,Map(Function(SubstForExpn(Slot1,v,w)),u)))),
ISetDelayed(4298,Simp(u_,x_),
    TimeConstrained(NormalizeSumFactors(SimpHelp(u,x)),$s("§$timelimit"),u)),
ISetDelayed(4299,SimpHelp(Exp(Times(u_DEFAULT,Plus(w_,Times(v_DEFAULT,Log(a_))))),x_),
    Times(Power(a,Times(u,v)),SimpHelp(Exp(Times(u,w)),x))),
ISetDelayed(4300,SimpHelp(u_,x_),
...
ISetDelayed(4301,NormalizeTrig($p("func"),Plus(Times(m_DEFAULT,Plus(Times(Pi,n_DEFAULT),r_DEFAULT)),s_DEFAULT),b_,x_),
...
ISetDelayed(4302,NormalizeHyperbolic($p("func"),Plus(s_DEFAULT,Times(m_DEFAULT,Plus(r_DEFAULT,Times(Pi,n_DEFAULT,Complex(C0,$p("nz")))))),b_,x_),
...
ISetDelayed(4303,FractionalPowerOfSquareQ(u_),
...
ISetDelayed(4304,FractionalPowerSubexpressionQ(u_,v_,w_),
...
ISetDelayed(4305,FixSimplify(Times(u_DEFAULT,Complex(C0,a_),Power(Plus(w_,Times(v_DEFAULT,Complex(C0,b_))),n_DEFAULT))),
    Condition(Times(Power(CN1,Times(C1D2,Plus(n,C1))),a,u,FixSimplify(Power(Plus(Times(b,v),Times(CN1,CI,w)),n))),OddQ(n))),
ISetDelayed(4306,FixSimplify(Times(Power(u_,m_DEFAULT),Power(v_,n_),w_DEFAULT)),
