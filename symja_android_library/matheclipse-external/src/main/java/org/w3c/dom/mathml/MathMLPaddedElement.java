...
/**
 * This interface extends the MathMLElement interface for the MathML spacing adjustment element
 * mpadded.
 */
public interface MathMLPaddedElement extends MathMLPresentationContainer {
  /**
   * A string representing the total width of the mpadded element, if specified. See also the
  ...
  /**
   * A string representing the lspace attribute - the additional space to the left - of the mpadded
  ...
  /**
   * A string representing the height above the baseline of the mpadded element, if specified. See
  ...
  /**
   * A string representing the depth beneath the baseline of the mpadded element, if specified. See
   * also the discussion of this attribute.
   *
