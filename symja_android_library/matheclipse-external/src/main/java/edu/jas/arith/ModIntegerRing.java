...
public final class ModIntegerRing implements ModularRingFactory<ModInteger>, Iterable<ModInteger> {
  ...
  /**
   * ModInteger chinese remainder algorithm. This is a factory method. Assert c.modul >= a.modul and
  ...
  /**
   * Modular integer list chinese remainder algorithm. m1 and m2 are positive integers, with
   ...
   */
  public static List<ModInteger> chineseRemainder(
      ModInteger m1, ModInteger m2, List<ModInteger> L1, List<ModInteger> L2) {
