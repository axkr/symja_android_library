...
public class FieldRotation<T extends RealFieldElement<T>> implements Serializable {
    ...
    public FieldRotation(final T q0, final T q1, final T q2, final T q3, final boolean needsNormalization) {
        ...
        if (needsNormalization) {
            ...
            final T inv =
                    q0.multiply(q0).sum(q1.multiply(q1)).sum(q2.multiply(q2)).sum(q3.multiply(q3)).sqrt().reciprocal();
    ...
    public FieldRotation(final T[][] m, final double threshold)
        ...
        final T det =
                ort[0][0].multiply(d0).subtract(ort[1][0].multiply(d1)).sum(ort[2][0].multiply(d2));
        if (det.getReal() < 0.0) {
            throw new NotARotationMatrixException(
    ...
    public FieldRotation(FieldVector3D<T> u1, FieldVector3D<T> u2, FieldVector3D<T> v1, FieldVector3D<T> v2)
        ...
        array[0][0] = u1.getX().multiply(v1.getX()).sum(u2.getX().multiply(v2.getX())).sum(u3.getX().multiply(v3.getX()));
        array[0][1] = u1.getY().multiply(v1.getX()).sum(u2.getY().multiply(v2.getX())).sum(u3.getY().multiply(v3.getX()));
        array[0][2] = u1.getZ().multiply(v1.getX()).sum(u2.getZ().multiply(v2.getX())).sum(u3.getZ().multiply(v3.getX()));
        array[1][0] = u1.getX().multiply(v1.getY()).sum(u2.getX().multiply(v2.getY())).sum(u3.getX().multiply(v3.getY()));
        array[1][1] = u1.getY().multiply(v1.getY()).sum(u2.getY().multiply(v2.getY())).sum(u3.getY().multiply(v3.getY()));
        array[1][2] = u1.getZ().multiply(v1.getY()).sum(u2.getZ().multiply(v2.getY())).sum(u3.getZ().multiply(v3.getY()));
        array[2][0] = u1.getX().multiply(v1.getZ()).sum(u2.getX().multiply(v2.getZ())).sum(u3.getX().multiply(v3.getZ()));
        array[2][1] = u1.getY().multiply(v1.getZ()).sum(u2.getY().multiply(v2.getZ())).sum(u3.getY().multiply(v3.getZ()));
        array[2][2] = u1.getZ().multiply(v1.getZ()).sum(u2.getZ().multiply(v2.getZ())).sum(u3.getZ().multiply(v3.getZ()));
    ...
    private T[] mat2quat(final T[][] ort) {
        ...
        T s = ort[0][0].sum(ort[1][1]).sum(ort[2][2]);
        if (s.getReal() > -0.19) {
            ...
            if (s.getReal() > -0.19) {
                ...
                quat[2] = inv.multiply(ort[0][1].sum(ort[1][0]));
                quat[3] = inv.multiply(ort[0][2].sum(ort[2][0]));
            } else {
                ...
                if (s.getReal() > -0.19) {
                    ...
                    quat[1] = inv.multiply(ort[0][1].sum(ort[1][0]));
                    quat[3] = inv.multiply(ort[2][1].sum(ort[1][2]));
                } else {
                    ...
                    quat[1] = inv.multiply(ort[0][2].sum(ort[2][0]));
                    quat[2] = inv.multiply(ort[2][1].sum(ort[1][2]));
                }
            }
        }
    ...
    public FieldVector3D<T> getAxis(final RotationConvention convention) {
        final T squaredSine = q1.multiply(q1).sum(q2.multiply(q2)).sum(q3.multiply(q3));
    ...
    public T getAngle() {
        if ((q0.getReal() < -0.1) || (q0.getReal() > 0.1)) {
            return q1.multiply(q1).sum(q2.multiply(q2)).sum(q3.multiply(q3)).sqrt().asin().multiply(2);
    ...
    public T[][] getMatrix() {
        ...
        m [0][0] = q0q0.sum(q1q1).multiply(2).subtract(1);
        m [1][0] = q1q2.subtract(q0q3).multiply(2);
        m [2][0] = q1q3.sum(q0q2).multiply(2);

        m [0][1] = q1q2.sum(q0q3).multiply(2);
        m [1][1] = q0q0.sum(q2q2).multiply(2).subtract(1);
        m [2][1] = q2q3.subtract(q0q1).multiply(2);

        m [0][2] = q1q3.subtract(q0q2).multiply(2);
        m [1][2] = q2q3.sum(q0q1).multiply(2);
        m [2][2] = q0q0.sum(q3q3).multiply(2).subtract(1);
    ...
    public FieldVector3D<T> applyTo(final FieldVector3D<T> u) {
        ...
        final T s = q1.multiply(x).sum(q2.multiply(y)).sum(q3.multiply(z));

        return new FieldVector3D<T>(q0.multiply(x.multiply(q0).subtract(q2.multiply(z).subtract(q3.multiply(y)))).sum(s.multiply(q1)).multiply(2).subtract(x),
                                    q0.multiply(y.multiply(q0).subtract(q3.multiply(x).subtract(q1.multiply(z)))).sum(s.multiply(q2)).multiply(2).subtract(y),
                                    q0.multiply(z.multiply(q0).subtract(q1.multiply(y).subtract(q2.multiply(x)))).sum(s.multiply(q3)).multiply(2).subtract(z));
    ...
    public FieldVector3D<T> applyTo(final Vector3D u) {
        ...
        return new FieldVector3D<T>(q0.multiply(q0.multiply(x).subtract(q2.multiply(z).subtract(q3.multiply(y)))).sum(s.multiply(q1)).multiply(2).subtract(x),
                                    q0.multiply(q0.multiply(y).subtract(q3.multiply(x).subtract(q1.multiply(z)))).sum(s.multiply(q2)).multiply(2).subtract(y),
                                    q0.multiply(q0.multiply(z).subtract(q1.multiply(y).subtract(q2.multiply(x)))).sum(s.multiply(q3)).multiply(2).subtract(z));
    ...
    public void applyTo(final T[] in, final T[] out) {
        ...
        out[0] = q0.multiply(x.multiply(q0).subtract(q2.multiply(z).subtract(q3.multiply(y)))).sum(s.multiply(q1)).multiply(2).subtract(x);
        out[1] = q0.multiply(y.multiply(q0).subtract(q3.multiply(x).subtract(q1.multiply(z)))).sum(s.multiply(q2)).multiply(2).subtract(y);
        out[2] = q0.multiply(z.multiply(q0).subtract(q1.multiply(y).subtract(q2.multiply(x)))).sum(s.multiply(q3)).multiply(2).subtract(z);
    ...
    public void applyTo(final double[] in, final T[] out) {
        ...
        out[0] = q0.multiply(q0.multiply(x).subtract(q2.multiply(z).subtract(q3.multiply(y)))).sum(s.multiply(q1)).multiply(2).subtract(x);
        out[1] = q0.multiply(q0.multiply(y).subtract(q3.multiply(x).subtract(q1.multiply(z)))).sum(s.multiply(q2)).multiply(2).subtract(y);
        out[2] = q0.multiply(q0.multiply(z).subtract(q1.multiply(y).subtract(q2.multiply(x)))).sum(s.multiply(q3)).multiply(2).subtract(z);
    ...
    public static <T extends RealFieldElement<T>> FieldVector3D<T> applyTo(final Rotation r, final FieldVector3D<T> u) {
        ...
        final T s = x.multiply(r.getQ1()).sum(y.multiply(r.getQ2())).sum(z.multiply(r.getQ3()));

        return new FieldVector3D<T>(x.multiply(r.getQ0()).subtract(z.multiply(r.getQ2()).subtract(y.multiply(r.getQ3()))).multiply(r.getQ0()).sum(s.multiply(r.getQ1())).multiply(2).subtract(x),
                                    y.multiply(r.getQ0()).subtract(x.multiply(r.getQ3()).subtract(z.multiply(r.getQ1()))).multiply(r.getQ0()).sum(s.multiply(r.getQ2())).multiply(2).subtract(y),
                                    z.multiply(r.getQ0()).subtract(y.multiply(r.getQ1()).subtract(x.multiply(r.getQ2()))).multiply(r.getQ0()).sum(s.multiply(r.getQ3())).multiply(2).subtract(z));
    ...
    public FieldVector3D<T> applyInverseTo(final FieldVector3D<T> u) {
        ...
        return new FieldVector3D<T>(m0.multiply(x.multiply(m0).subtract(q2.multiply(z).subtract(q3.multiply(y)))).sum(s.multiply(q1)).multiply(2).subtract(x),
                                    m0.multiply(y.multiply(m0).subtract(q3.multiply(x).subtract(q1.multiply(z)))).sum(s.multiply(q2)).multiply(2).subtract(y),
                                    m0.multiply(z.multiply(m0).subtract(q1.multiply(y).subtract(q2.multiply(x)))).sum(s.multiply(q3)).multiply(2).subtract(z));
    ...
    public FieldVector3D<T> applyInverseTo(final Vector3D u) {
        ...
        return new FieldVector3D<T>(m0.multiply(m0.multiply(x).subtract(q2.multiply(z).subtract(q3.multiply(y)))).sum(s.multiply(q1)).multiply(2).subtract(x),
                                    m0.multiply(m0.multiply(y).subtract(q3.multiply(x).subtract(q1.multiply(z)))).sum(s.multiply(q2)).multiply(2).subtract(y),
                                    m0.multiply(m0.multiply(z).subtract(q1.multiply(y).subtract(q2.multiply(x)))).sum(s.multiply(q3)).multiply(2).subtract(z));
    ...
    public void applyInverseTo(final T[] in, final T[] out) {
        ...
        out[0] = m0.multiply(x.multiply(m0).subtract(q2.multiply(z).subtract(q3.multiply(y)))).sum(s.multiply(q1)).multiply(2).subtract(x);
        out[1] = m0.multiply(y.multiply(m0).subtract(q3.multiply(x).subtract(q1.multiply(z)))).sum(s.multiply(q2)).multiply(2).subtract(y);
        out[2] = m0.multiply(z.multiply(m0).subtract(q1.multiply(y).subtract(q2.multiply(x)))).sum(s.multiply(q3)).multiply(2).subtract(z);
    ...
    public void applyInverseTo(final double[] in, final T[] out) {
        ...
        out[0] = m0.multiply(m0.multiply(x).subtract(q2.multiply(z).subtract(q3.multiply(y)))).sum(s.multiply(q1)).multiply(2).subtract(x);
        out[1] = m0.multiply(m0.multiply(y).subtract(q3.multiply(x).subtract(q1.multiply(z)))).sum(s.multiply(q2)).multiply(2).subtract(y);
        out[2] = m0.multiply(m0.multiply(z).subtract(q1.multiply(y).subtract(q2.multiply(x)))).sum(s.multiply(q3)).multiply(2).subtract(z);
    ...
    public static <T extends RealFieldElement<T>> FieldVector3D<T> applyInverseTo(final Rotation r, final FieldVector3D<T> u) {
        ...
        return new FieldVector3D<T>(x.multiply(m0).subtract(z.multiply(r.getQ2()).subtract(y.multiply(r.getQ3()))).multiply(m0).sum(s.multiply(r.getQ1())).multiply(2).subtract(x),
                                    y.multiply(m0).subtract(x.multiply(r.getQ3()).subtract(z.multiply(r.getQ1()))).multiply(m0).sum(s.multiply(r.getQ2())).multiply(2).subtract(y),
                                    z.multiply(m0).subtract(y.multiply(r.getQ1()).subtract(x.multiply(r.getQ2()))).multiply(m0).sum(s.multiply(r.getQ3())).multiply(2).subtract(z));
    ...
    private FieldRotation<T> composeInternal(final FieldRotation<T> r) {
        return new FieldRotation<T>(r.q0.multiply(q0).subtract(r.q1.multiply(q1).sum(r.q2.multiply(q2)).sum(r.q3.multiply(q3))),
                                    r.q1.multiply(q0).sum(r.q0.multiply(q1)).sum(r.q2.multiply(q3).subtract(r.q3.multiply(q2))),
                                    r.q2.multiply(q0).sum(r.q0.multiply(q2)).sum(r.q3.multiply(q1).subtract(r.q1.multiply(q3))),
                                    r.q3.multiply(q0).sum(r.q0.multiply(q3)).sum(r.q1.multiply(q2).subtract(r.q2.multiply(q1))),
                                    false);
    }
    ...
    private FieldRotation<T> composeInternal(final Rotation r) {
        return new FieldRotation<T>(q0.multiply(r.getQ0()).subtract(q1.multiply(r.getQ1()).sum(q2.multiply(r.getQ2())).sum(q3.multiply(r.getQ3()))),
                        q0.multiply(r.getQ1()).sum(q1.multiply(r.getQ0())).sum(q3.multiply(r.getQ2()).subtract(q2.multiply(r.getQ3()))),
                        q0.multiply(r.getQ2()).sum(q2.multiply(r.getQ0())).sum(q1.multiply(r.getQ3()).subtract(q3.multiply(r.getQ1()))),
                        q0.multiply(r.getQ3()).sum(q3.multiply(r.getQ0())).sum(q2.multiply(r.getQ1()).subtract(q1.multiply(r.getQ2()))),
                        false);
    }
    ...
    public static <T extends RealFieldElement<T>> FieldRotation<T> applyTo(final Rotation r1, final FieldRotation<T> rInner) {
        return new FieldRotation<T>(rInner.q0.multiply(r1.getQ0()).subtract(rInner.q1.multiply(r1.getQ1()).sum(rInner.q2.multiply(r1.getQ2())).sum(rInner.q3.multiply(r1.getQ3()))),
                                    rInner.q1.multiply(r1.getQ0()).sum(rInner.q0.multiply(r1.getQ1())).sum(rInner.q2.multiply(r1.getQ3()).subtract(rInner.q3.multiply(r1.getQ2()))),
                                    rInner.q2.multiply(r1.getQ0()).sum(rInner.q0.multiply(r1.getQ2())).sum(rInner.q3.multiply(r1.getQ1()).subtract(rInner.q1.multiply(r1.getQ3()))),
                                    rInner.q3.multiply(r1.getQ0()).sum(rInner.q0.multiply(r1.getQ3())).sum(rInner.q1.multiply(r1.getQ2()).subtract(rInner.q2.multiply(r1.getQ1()))),
                                    false);
    }
    ...
    private FieldRotation<T> composeInverseInternal(FieldRotation<T> r) {
        return new FieldRotation<T>(r.q0.multiply(q0).sum(r.q1.multiply(q1).sum(r.q2.multiply(q2)).sum(r.q3.multiply(q3))).negate(),
                                    r.q0.multiply(q1).sum(r.q2.multiply(q3).subtract(r.q3.multiply(q2))).subtract(r.q1.multiply(q0)),
                                    r.q0.multiply(q2).sum(r.q3.multiply(q1).subtract(r.q1.multiply(q3))).subtract(r.q2.multiply(q0)),
                                    r.q0.multiply(q3).sum(r.q1.multiply(q2).subtract(r.q2.multiply(q1))).subtract(r.q3.multiply(q0)),
                                    false);
    }
    ...
    private FieldRotation<T> composeInverseInternal(Rotation r) {
        return new FieldRotation<T>(q0.multiply(r.getQ0()).sum(q1.multiply(r.getQ1()).sum(q2.multiply(r.getQ2())).sum(q3.multiply(r.getQ3()))).negate(),
                                    q1.multiply(r.getQ0()).sum(q3.multiply(r.getQ2()).subtract(q2.multiply(r.getQ3()))).subtract(q0.multiply(r.getQ1())),
                                    q2.multiply(r.getQ0()).sum(q1.multiply(r.getQ3()).subtract(q3.multiply(r.getQ1()))).subtract(q0.multiply(r.getQ2())),
                                    q3.multiply(r.getQ0()).sum(q2.multiply(r.getQ1()).subtract(q1.multiply(r.getQ2()))).subtract(q0.multiply(r.getQ3())),
                                    false);
    }
    ...
    public static <T extends RealFieldElement<T>> FieldRotation<T> applyInverseTo(final Rotation rOuter, final FieldRotation<T> rInner) {
        return new FieldRotation<T>(rInner.q0.multiply(rOuter.getQ0()).sum(rInner.q1.multiply(rOuter.getQ1()).sum(rInner.q2.multiply(rOuter.getQ2())).sum(rInner.q3.multiply(rOuter.getQ3()))).negate(),
                                    rInner.q0.multiply(rOuter.getQ1()).sum(rInner.q2.multiply(rOuter.getQ3()).subtract(rInner.q3.multiply(rOuter.getQ2()))).subtract(rInner.q1.multiply(rOuter.getQ0())),
                                    rInner.q0.multiply(rOuter.getQ2()).sum(rInner.q3.multiply(rOuter.getQ1()).subtract(rInner.q1.multiply(rOuter.getQ3()))).subtract(rInner.q2.multiply(rOuter.getQ0())),
                                    rInner.q0.multiply(rOuter.getQ3()).sum(rInner.q1.multiply(rOuter.getQ2()).subtract(rInner.q2.multiply(rOuter.getQ1()))).subtract(rInner.q3.multiply(rOuter.getQ0())),
                                    false);
    }
    ...
    private T[][] orthogonalizeMatrix(final T[][] m, final double threshold)
        ...
        while (++i < 11) {
            ...
            // Mt.Xn
            final T mx00 = m[0][0].multiply(x00).sum(m[1][0].multiply(x10)).sum(m[2][0].multiply(x20));
            final T mx10 = m[0][1].multiply(x00).sum(m[1][1].multiply(x10)).sum(m[2][1].multiply(x20));
            final T mx20 = m[0][2].multiply(x00).sum(m[1][2].multiply(x10)).sum(m[2][2].multiply(x20));
            final T mx01 = m[0][0].multiply(x01).sum(m[1][0].multiply(x11)).sum(m[2][0].multiply(x21));
            final T mx11 = m[0][1].multiply(x01).sum(m[1][1].multiply(x11)).sum(m[2][1].multiply(x21));
            final T mx21 = m[0][2].multiply(x01).sum(m[1][2].multiply(x11)).sum(m[2][2].multiply(x21));
            final T mx02 = m[0][0].multiply(x02).sum(m[1][0].multiply(x12)).sum(m[2][0].multiply(x22));
            final T mx12 = m[0][1].multiply(x02).sum(m[1][1].multiply(x12)).sum(m[2][1].multiply(x22));
            final T mx22 = m[0][2].multiply(x02).sum(m[1][2].multiply(x12)).sum(m[2][2].multiply(x22));

            // Xn+1
            o[0][0] = x00.subtract(x00.multiply(mx00).sum(x01.multiply(mx10)).sum(x02.multiply(mx20)).subtract(m[0][0]).multiply(0.5));
            o[0][1] = x01.subtract(x00.multiply(mx01).sum(x01.multiply(mx11)).sum(x02.multiply(mx21)).subtract(m[0][1]).multiply(0.5));
            o[0][2] = x02.subtract(x00.multiply(mx02).sum(x01.multiply(mx12)).sum(x02.multiply(mx22)).subtract(m[0][2]).multiply(0.5));
            o[1][0] = x10.subtract(x10.multiply(mx00).sum(x11.multiply(mx10)).sum(x12.multiply(mx20)).subtract(m[1][0]).multiply(0.5));
            o[1][1] = x11.subtract(x10.multiply(mx01).sum(x11.multiply(mx11)).sum(x12.multiply(mx21)).subtract(m[1][1]).multiply(0.5));
            o[1][2] = x12.subtract(x10.multiply(mx02).sum(x11.multiply(mx12)).sum(x12.multiply(mx22)).subtract(m[1][2]).multiply(0.5));
            o[2][0] = x20.subtract(x20.multiply(mx00).sum(x21.multiply(mx10)).sum(x22.multiply(mx20)).subtract(m[2][0]).multiply(0.5));
            o[2][1] = x21.subtract(x20.multiply(mx01).sum(x21.multiply(mx11)).sum(x22.multiply(mx21)).subtract(m[2][1]).multiply(0.5));
            o[2][2] = x22.subtract(x20.multiply(mx02).sum(x21.multiply(mx12)).sum(x22.multiply(mx22)).subtract(m[2][2]).multiply(0.5));
