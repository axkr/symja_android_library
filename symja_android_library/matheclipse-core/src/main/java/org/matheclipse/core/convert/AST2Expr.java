...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$BoxForms", "$CommandLine", "$ContextAliases",
      ...
      "ButterflyGraph", "Button", "ButtonBar", "ByteArray", "ByteArrayQ", "ByteArrayToString",
      "ByteCount", "CachedValue", "CalendarConvert", "CalendarType", "Callout", "CalloutMarker",
      ...
      "GraphPower", "GraphQ", "GraphRadius", "GraphStyle", "GraphUnion", "GrayLevel", "Greater",
      ...
      "GridBox", "GridGraph", "GroebnerBasis", "GroupBy", "Groupings", "GroupOrbits",
      "Gudermannian", "GumbelDistribution", "HadamardMatrix", "HalfLine", "HalfNormalDistribution",
      "HalfPlane", "HalfSpace", "Haloing", "HamiltonianGraphQ", "HammingDistance", "HammingWindow",
      ...
      "HoldForm", "HoldPattern", "Horner", "HornerForm", "Hue", "HumpDownHump", "HumpEqual",
