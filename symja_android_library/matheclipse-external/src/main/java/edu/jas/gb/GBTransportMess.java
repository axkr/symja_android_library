...
/**
 * Distributed GB transport message. This class and its subclasses are used for transport of
 * polynomials and pairs and as markers in distributed GB algorithms.
 *
 * @author Heinz Kredel
 */
