...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AddTo", "AllTrue", "And",
			...
			"PrimitiveRootList", "Print", "Product", "ProductLog", "PseudoInverse", "Put", "QRDecomposition", "Quiet",
			"Quit", "Quotient", "RandomChoice", "RandomInteger", "RandomReal", "RandomSample", "Range", "Rational",
			...
			"StandardDeviation", "StieltjesGamma", "StirlingS1", "StirlingS2", "StringDrop", "StringJoin",
			"StringLength", "StringTake", "StruveH", "StruveL", "Subfactorial", "Subscript", "Subsuperscript",
			"Subsets", "SubtractFrom", "Sum", "Superscript", "SurfaceGraphics", "Switch", "SyntaxLength", "SymbolName",
			"SymbolQ", "SymmetricMatrixQ", "SyntaxQ", "Table", "Take", "Tally", "Tan", "Tanh", "TautologyQ", "Taylor",
			"TensorDimensions", "TensorRank", "TeXForm", "Thread", "Through", "Throw", "TimeConstrained", "Times",
