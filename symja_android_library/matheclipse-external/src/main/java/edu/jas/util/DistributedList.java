...
/**
 * Distributed version of a List. Implemented with a SortedMap / TreeMap to keep the sequence order
 * of elements.
 *
 * @author Heinz Kredel
 */
public class DistributedList /* implements List not jet */ {
  ...
  /**
   * Add object to the list and distribute to other lists. Blocks until the object is send and
   * received from the server (actually it blocks until some object is received).
   *
   * @param o
   */
