...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"Compile", "Complex", "ComplexExpand", "ComplexInfinity", "ComposeList", "Composition",
			"CompoundExpression", "Condition", "Conjugate", "ConjugateTranspose", "ConstantArray", "Continue",
			"ContinuedFraction", "CoprimeQ", "Correlation", "Cos", "Cosh", "CosineDistance", "CosIntegral",
			...
			"Implies", "Import", "Increment", "Inner", "Insert", "InexactNumberQ", "Information", "Interval",
			...
			"ListConvolve", "ListCorrelate", "ListQ", "Log", "Log2", "Log10", "LogGamma", "LogNormalDistribution",
