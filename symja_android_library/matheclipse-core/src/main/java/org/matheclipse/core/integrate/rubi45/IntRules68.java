...
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,$($s("§sec"),Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),CN1),x_Symbol),
...
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,$($s("§csc"),Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),CN1),x_Symbol),
