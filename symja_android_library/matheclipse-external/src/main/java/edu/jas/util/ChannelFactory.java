...
/**
 * ChannelFactory implements a symmetric and non blocking way of setting up sockets on the client
 * and server side. The constructor sets up a ServerSocket and accepts and stores any Socket
 * creation requests from clients. The created Sockets can the be retrieved from the store without
