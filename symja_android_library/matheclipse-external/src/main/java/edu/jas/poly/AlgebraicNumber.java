...
/**
 * Algebraic number class. Based on GenPolynomial with RingElem interface. Objects of this class are
 * immutable.
 *
 * @author Heinz Kredel
 */
public class AlgebraicNumber<C extends RingElem<C>> implements GcdRingElem<AlgebraicNumber<C>> {
  ...
  /**
   * The constructor creates a AlgebraicNumber object from AlgebraicNumberRing modul and a
   * GenPolynomial value.
   *
  ...
  public AlgebraicNumber<C> inverse() {
    try {
      ...
      throw new AlgebraicNotInvertibleException(
          e + ", val = " + val + ", modul = " + ring.modul + ", gcd = " + val.gcd(ring.modul), e);
    }
  }
