...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AddTo", "AllTrue", "And",
			...
			"ChessboardDistance", "ChineseRemainder", "Chop", "Clear", "ClearAll", "ClearAttributes", "Coefficient",
			...
			"Part", "Partition", "PartitionsP", "PartitionsQ","PerfectNumber", "PerfectNumberQ", "Pattern", "PatternTest", "PDF",
