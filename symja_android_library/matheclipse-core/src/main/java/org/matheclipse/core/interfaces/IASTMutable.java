...
public interface IASTMutable extends IAST {
     ...
     * @throws UnsupportedOperationException if replacing elements in this {@code IAST} is not supported.
     ...
     * @return <tt>this</tt>
     */
    IASTMutable setArgs(int start, int end, IntFunction<IExpr> function);
     ...
     * @return <tt>this</tt>
     */
    IASTMutable setArgs(int end, IntFunction<IExpr> function);
