...
public class AST2Expr {
	...
	public final static String[] SYMBOL_STRINGS = { "All", "Algebraics", "Automatic", "Axes", "AxesOrigin", "AxesStyle",
			...
			"SlotSequence", "Strict", "String", "Symbol", "Today", "TooLarge", "Top", "Trig", "True", "Unknown",
			"Variable", "ViewPoint", "White", "Whitespace", "Yellow" };
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AbsoluteCorrelation", "AbsoluteTime",
			...
			"ColorData", "Column", "Collect", "Commonest", "CompatibleUnitQ", "Complement", "Compile",
			"CompiledFunction", "Complex", "ComplexExpand", "ComplexPlot3D", "ComposeList", "ComposeSeries",
			...
			"ContainsOnly", "Context", "Continue", "ContinuedFraction", "ContourPlot", "Convergents", "ConvexHullMesh",
			"CoprimeQ", "Correlation", "Cos", "Cosh", "CosineDistance", "CosIntegral", "CoshIntegral", "Cot", "Coth",
			"Count", "CountDistinct", "Counts", "Covariance", "CreateDirectory", "Cross", "Csc", "Csch", "CubeRoot",
			"Curl", "Cyclotomic", "Dataset", "DateObject", "DateValue", "Decrement", "Default", "DefaultButton",
			...
			"DirectedInfinity", "Direction", "Directive", "DirichletWindow", "Discriminant", "DisjointQ", "Distribute",
			...
			"SokalSneathDissimilarity", "Solve", "Sort", "SortBy", "Sow", "Span", "SphericalBesselJ",
			...
			"Standardize", "StieltjesGamma", "StirlingS1", "StirlingS2", "StringCases", "StringContainsQ", "StringDrop",
			"StringExpression", "StringJoin", "StringLength", "StringMatchQ", "StringPart", "StringRiffle",
			"StringSplit", "StringTake", "StringQ", "StringReplace", "Structure", "StruveH", "StruveL",
			"StudentTDistribution", "Style", "Subdivide", "Subfactorial", "Summary", "Subscript", "Subsuperscript",
