...
IIntegrate(323,Integrate(Times(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),CN1D2),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),CN1D2)),x_Symbol),
    Condition(Simp(Dist(Times(Sqrt(Plus(C1,Times(d,Power(c,CN1),Sqr(x)))),Power(Plus(c,Times(d,Sqr(x))),CN1D2)),Integrate(Power(Times(Sqrt(Plus(a,Times(b,Sqr(x)))),Sqrt(Plus(C1,Times(d,Power(c,CN1),Sqr(x))))),CN1),x),x),x),And(FreeQ(List(a,b,c,d),x),Not(GtQ(c,C0))))),
IIntegrate(324,Integrate(Times(Sqrt(Plus(a_,Times(b_DEFAULT,Sqr(x_)))),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),CN1D2)),x_Symbol),
    Condition(Plus(Simp(Dist(a,Integrate(Power(Times(Sqrt(Plus(a,Times(b,Sqr(x)))),Sqrt(Plus(c,Times(d,Sqr(x))))),CN1),x),x),x),Simp(Dist(b,Integrate(Times(Sqr(x),Power(Times(Sqrt(Plus(a,Times(b,Sqr(x)))),Sqrt(Plus(c,Times(d,Sqr(x))))),CN1)),x),x),x)),And(FreeQ(List(a,b,c,d),x),PosQ(Times(d,Power(c,CN1))),PosQ(Times(b,Power(a,CN1)))))),
...
IIntegrate(326,Integrate(Times(Sqrt(Plus(a_,Times(b_DEFAULT,Sqr(x_)))),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),CN1D2)),x_Symbol),
    Condition(Subtract(Simp(Dist(Times(b,Power(d,CN1)),Integrate(Times(Sqrt(Plus(c,Times(d,Sqr(x)))),Power(Plus(a,Times(b,Sqr(x))),CN1D2)),x),x),x),Simp(Dist(Times(Subtract(Times(b,c),Times(a,d)),Power(d,CN1)),Integrate(Power(Times(Sqrt(Plus(a,Times(b,Sqr(x)))),Sqrt(Plus(c,Times(d,Sqr(x))))),CN1),x),x),x)),And(FreeQ(List(a,b,c,d),x),PosQ(Times(d,Power(c,CN1))),NegQ(Times(b,Power(a,CN1)))))),
...
IIntegrate(329,Integrate(Times(Sqrt(Plus(a_,Times(b_DEFAULT,Sqr(x_)))),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),CN1D2)),x_Symbol),
    Condition(Simp(Dist(Times(a,Sqrt(Subtract(C1,Times(Sqr(b),Power(x,C4),Power(a,CN2)))),Power(Times(Sqrt(Plus(a,Times(b,Sqr(x)))),Sqrt(Plus(c,Times(d,Sqr(x))))),CN1)),Integrate(Times(Sqrt(Plus(C1,Times(b,Sqr(x),Power(a,CN1)))),Power(Subtract(C1,Times(b,Sqr(x),Power(a,CN1))),CN1D2)),x),x),x),And(FreeQ(List(a,b,c,d),x),EqQ(Plus(Times(b,c),Times(a,d)),C0),Not(And(LtQ(Times(a,c),C0),GtQ(Times(a,b),C0)))))),
IIntegrate(330,Integrate(Times(Sqrt(Plus(a_,Times(b_DEFAULT,Sqr(x_)))),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),CN1D2)),x_Symbol),
    Condition(Simp(Dist(Times(Sqrt(Plus(a,Times(b,Sqr(x)))),Power(Plus(C1,Times(b,Power(a,CN1),Sqr(x))),CN1D2)),Integrate(Times(Sqrt(Plus(C1,Times(b,Power(a,CN1),Sqr(x)))),Power(Plus(c,Times(d,Sqr(x))),CN1D2)),x),x),x),And(FreeQ(List(a,b,c,d),x),NegQ(Times(d,Power(c,CN1))),GtQ(c,C0),Not(GtQ(a,C0))))),
IIntegrate(331,Integrate(Times(Sqrt(Plus(a_,Times(b_DEFAULT,Sqr(x_)))),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),CN1D2)),x_Symbol),
    Condition(Simp(Dist(Times(Sqrt(Plus(C1,Times(d,Power(c,CN1),Sqr(x)))),Power(Plus(c,Times(d,Sqr(x))),CN1D2)),Integrate(Times(Sqrt(Plus(a,Times(b,Sqr(x)))),Power(Plus(C1,Times(d,Power(c,CN1),Sqr(x))),CN1D2)),x),x),x),And(FreeQ(List(a,b,c,d),x),NegQ(Times(d,Power(c,CN1))),Not(GtQ(c,C0))))),
...
IIntegrate(338,Integrate(Times(Power(x_,m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),p_)),x_Symbol),
    Condition(Simp(Dist(C1D2,Subst(Integrate(Times(Power(x,Times(C1D2,Plus(m,CN1))),Power(Plus(a,Times(b,x)),p),Power(Plus(c,Times(d,x)),p)),x),x,Sqr(x)),x),x),And(FreeQ(List(a,b,c,d,p),x),EqQ(Plus(Times(b,c),Times(a,d)),C0),IntegerQ(Times(C1D2,Plus(m,CN1)))))),
IIntegrate(339,Integrate(Times(Power(Times(e_DEFAULT,x_),m_),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),p_)),x_Symbol),
    Condition(Subtract(Simp(Times(Power(Times(e,x),Plus(m,C1)),Power(Plus(a,Times(b,Sqr(x))),p),Power(Plus(c,Times(d,Sqr(x))),p),Power(Times(e,Plus(m,C1)),CN1)),x),Simp(Dist(Times(C4,b,d,p,Power(Times(Power(e,C4),Plus(m,C1)),CN1)),Integrate(Times(Power(Times(e,x),Plus(m,C4)),Power(Plus(a,Times(b,Sqr(x))),Plus(p,CN1)),Power(Plus(c,Times(d,Sqr(x))),Plus(p,CN1))),x),x),x)),And(FreeQ(List(a,b,c,d,e,m),x),EqQ(Plus(Times(b,c),Times(a,d)),C0),GtQ(p,C0),LtQ(m,CN1)))),
IIntegrate(340,Integrate(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),p_)),x_Symbol),
    Condition(Plus(Simp(Times(Power(Times(e,x),Plus(m,C1)),Power(Plus(a,Times(b,Sqr(x))),p),Power(Plus(c,Times(d,Sqr(x))),p),Power(Times(e,Plus(m,Times(C4,p),C1)),CN1)),x),Simp(Dist(Times(C4,a,c,p,Power(Plus(m,Times(C4,p),C1),CN1)),Integrate(Times(Power(Times(e,x),m),Power(Plus(a,Times(b,Sqr(x))),Plus(p,CN1)),Power(Plus(c,Times(d,Sqr(x))),Plus(p,CN1))),x),x),x)),And(FreeQ(List(a,b,c,d,e,m),x),EqQ(Plus(Times(b,c),Times(a,d)),C0),GtQ(p,C0),NeQ(Plus(m,Times(C4,p),C1),C0),IntegerQ(Times(C2,m)))))
  );
}
