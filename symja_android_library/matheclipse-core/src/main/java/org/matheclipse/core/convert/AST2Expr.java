...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"All", "AllowedHeads", "AllowShortContext",
      ...
      "DegreeReverseLexicographic", "DigitCharacter", "DisplayFunction", "DisrectedEdges",
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "ListPlot3D", "ListPointPlot3D", "ListQ", "Literal", "LoadJavaClass", "Log", "Log2", "Log10",
      "LogGamma", "LogNormalDistribution", "LogicalExpand", "LogisticSigmoid", "LogIntegral",
