...
public class JSXGraphParametricPlotExample {
	final static String WEB_PAGE = //
			"<html>\n" + //
					...
					"var board = JXG.JSXGraph.initBoard('jxgbox', {axis:true,boundingbox:[-1.25,1.25,1.25,-1.25]});\n"
					+ "board.suspendUpdate();\n" + //
					"`1`\n" + //
	...
	public static void main(String[] args) {
		try {
			...
			IExpr result = util.eval("ParametricPlot({Sin(t), Cos(t^2)}, {t, 0, 2*Pi})");
