...
SetDelayed(SimpAux(Power(Plus(Times($p("a",true),Cos(v_)),Times($p("b",true),Sin(v_))),n_)),
    Condition(SimpAux(Power(Plus(Times(Cos(v),Power(a,CN1)),Times(Sin(v),Power(b,CN1))),Times(CN1,n))),And(And(IntegerQ(n),Less(n,C0)),ZeroQ(Plus(Power(a,C2),Power(b,C2)))))),
...
SetDelayed(SimpAux(Power(Plus(Times($p("a",true),Cosh(v_)),Times($p("b",true),Sinh(v_))),n_)),
    Condition(SimpAux(Power(Plus(Times(Cosh(v),Power(a,CN1)),Times(CN1,Times(Sinh(v),Power(b,CN1)))),Times(CN1,n))),And(And(IntegerQ(n),Less(n,C0)),ZeroQ(Plus(Power(a,C2),Times(CN1,Power(b,C2))))))),
...
SetDelayed(ExpandIntegrandQ(m_,n_,p_),
    And(And(And(IntegerQ(p),Greater(p,C0)),NonzeroQ(Plus(Plus(m,Times(CN1,n)),C1))),If(ZeroQ(Plus(n,Times(CN1,C1))),Or(Or(Not(IntegerQ(m)),And(Less(m,C0),Not(LessEqual(LessEqual(Plus(Plus(m,p),C2),C0),Plus(Plus(m,Times(C2,p)),C2))))),LessEqual(p,Plus(m,C2))),Or(Or(Equal(p,C2),Not(IntegerQ(Times(Plus(m,C1),Power(n,CN1))))),And(Not(And(Less(C0,Times(Plus(m,C1),Power(n,CN1))),LessEqual(Times(Plus(m,C1),Power(n,CN1)),C3))),Not(LessEqual(Times(Plus(m,C1),Power(n,CN1)),Times(CN1,Plus(p,C1))))))))),
...
SetDelayed(ExpandExpression(Times($p("u",true),Power(Plus(Times($p("a",true),Power(x_,$p("p",true))),Times($p("b",true),Power(x_,$p("q",true)))),n_)),$p("x",$s("Symbol"))),
    Condition(ExpandExpression(Times(Times(u,Power(x,Times(n,p))),Power(Plus(a,Times(b,Power(x,Plus(q,Times(CN1,p))))),n)),x),And(And(FreeQ(List(a,b),x),IntegerQ(List(n,p,q))),GreaterEqual(Plus(q,Times(CN1,p)),C0)))),
SetDelayed(ExpandExpression(Times($p("u",true),Power(Plus(Plus($p("a",true),Times($p("d",true),Power(c_,m_))),Times($p("b",true),v_)),p_)),$p("x",$s("Symbol"))),
    Condition(Module(List($s("tmp")),ReplaceAll(ExpandExpression(Times(u,Power(Plus(Plus(a,Times(d,$s("tmp"))),Times(b,v)),p)),x),List(Rule($s("tmp"),Power(c,m))))),And(And(And(And(FreeQ(List(a,b,c,d),x),IntegerQ(p)),Less(p,C0)),FractionQ(m)),Not(FreeQ(v,x))))),
SetDelayed(ExpandExpression(Times($p("u",true),Power(Plus($p("a",true),Times(Times($p("b",true),Power(c_,m_)),v_)),p_)),$p("x",$s("Symbol"))),
    Condition(Module(List($s("tmp")),ReplaceAll(ExpandExpression(Times(u,Power(Plus(a,Times(Times(b,$s("tmp")),v)),p)),x),List(Rule($s("tmp"),Power(c,m))))),And(And(And(And(FreeQ(List(a,b,c),x),IntegerQ(p)),Less(p,C0)),FractionQ(m)),Not(FreeQ(v,x))))),
...
SetDelayed(ExpandExpression(Times(Power(x_,m_),Times(Plus(a_,Times($p("b",true),Power(x_,$p("n",true)))),Power(Plus(c_,Times($p("d",true),Power(x_,$p("n",true)))),CN1))),$p("x",$s("Symbol"))),
    Condition(Plus(Times(a,Times(Power(x,m),Power(c,CN1))),Dist(Times(Plus(Times(b,c),Times(CN1,Times(a,d))),Power(c,CN1)),ExpandExpression(Times(Power(x,Plus(m,n)),Power(Plus(c,Times(d,Power(x,n))),CN1)),x))),And(And(And(FreeQ(List(a,b,c,d),x),IntegerQ(List(m,n))),Greater(n,C0)),Less(m,C0)))),
SetDelayed(ExpandExpression(Times($p("u",true),Power(Plus(Plus(a_,Times($p("b",true),Power(x_,$p("k",true)))),Times($p("c",true),Power(x_,j_))),n_)),$p("x",$s("Symbol"))),
    Condition(ExpandExpression(Times(u,Times(Power(Plus(Times(b,C1D2),Times(c,Power(x,k))),Times(C2,n)),Power(Power(c,n),CN1))),x),And(And(And(And(FreeQ(List(a,b,c,j,k),x),IntegerQ(List(n,k,j))),Equal(j,Times(C2,k))),Less(n,C0)),ZeroQ(Plus(Power(b,C2),Times(CN1,Times(Times(C4,a),c))))))),
SetDelayed(ExpandExpression(Power(u_,n_),$p("x",$s("Symbol"))),
    Condition(Power(Plus(Plus(Coefficient(u,x,C0),Times(Coefficient(u,x,C1),x)),Times(Coefficient(u,x,C2),Power(x,C2))),n),And(And(And(And(RationalQ(n),Less(n,C0)),PolynomialQ(u,x)),Equal(Exponent(u,x),C2)),Not(MatchQ(u,Condition(Plus(Plus($p("a",true),Times($p("b",true),x)),Times($p("c",true),Power(x,C2))),FreeQ(List(a,b,c),x))))))),
SetDelayed(ExpandExpression(Times(u_,Power(Plus(a_,Times($p("b",true),Power(x_,C4))),CN1)),$p("x",$s("Symbol"))),
    Condition(Plus(Plus(Times(Plus(Coefficient(u,x,C0),Times(Coefficient(u,x,C2),Power(x,C2))),Power(Plus(a,Times(b,Power(x,C4))),CN1)),Times(Coefficient(u,x,C1),Times(x,Power(Plus(a,Times(b,Power(x,C4))),CN1)))),Times(Coefficient(u,x,C3),Times(Power(x,C3),Power(Plus(a,Times(b,Power(x,C4))),CN1)))),And(And(FreeQ(List(a,b),x),PolynomialQ(u,x)),Less(Exponent(u,x),C4)))),
SetDelayed(ExpandExpression(Times(Power(Plus($p("a",true),Times($p("b",true),x_)),$p("m",true)),Power(Plus(c_,Times($p("d",true),x_)),n_)),$p("x",$s("Symbol"))),
    Condition(Map(Function(RegularizeSubst(Slot1,x,Plus(a,Times(b,x)))),Apart(Times(Power(x,m),Power(Plus(Plus(c,Times(CN1,Times(a,Times(d,Power(b,CN1))))),Times(Times(d,Power(b,CN1)),x)),n)),x)),And(And(And(FreeQ(List(a,b,c,d),x),IntegerQ(List(m,n))),Greater(m,C0)),Less(n,C0)))),
SetDelayed(ExpandExpression(Times(Times(Power(x_,$p("m",true)),Power(Plus($p("a",true),Times($p("b",true),x_)),n_)),Power(Plus(c_,Times($p("d",true),x_)),n_)),$p("x",$s("Symbol"))),
    Condition(ExpandExpression(Times(Power(x,m),Power(Plus(Plus(Times(a,c),Times(Plus(Times(b,c),Times(a,d)),x)),Times(Times(b,d),Power(x,C2))),n)),x),And(And(FreeQ(List(a,b,c,d),x),IntegerQ(List(m,n))),Less(n,C0)))),
SetDelayed(ExpandExpression(Power(Sin(v_),n_),$p("x",$s("Symbol"))),
    Condition(Expand(TrigReduce(Power(Sin(v),n)),x),And(IntegerQ(n),Greater(n,C1)))),
SetDelayed(ExpandExpression(Power(Cos(v_),n_),$p("x",$s("Symbol"))),
    Condition(Expand(TrigReduce(Power(Cos(v),n)),x),And(IntegerQ(n),Greater(n,C1)))),
...
SetDelayed(ExpandExpression(Times(Power(Tan(v_),$p("n",true)),Power(Plus(Times($p("a",true),Power(Sin(v_),$p("n",true))),Times($p("b",true),Power(Cos(v_),$p("n",true)))),CN1)),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(Sec(v),n),Power(a,CN1)),Times(CN1,Times(b,Power(Times(a,Plus(Times(a,Power(Sin(v),n)),Times(b,Power(Cos(v),n)))),CN1)))),And(FreeQ(List(a,b),x),IntegerQ(n)))),
SetDelayed(ExpandExpression(Times(Power(Cot(v_),$p("n",true)),Power(Plus(Times($p("a",true),Power(Sin(v_),$p("n",true))),Times($p("b",true),Power(Cos(v_),$p("n",true)))),CN1)),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(Csc(v),n),Power(b,CN1)),Times(CN1,Times(a,Power(Times(b,Plus(Times(a,Power(Sin(v),n)),Times(b,Power(Cos(v),n)))),CN1)))),And(FreeQ(List(a,b),x),IntegerQ(n)))),
...
SetDelayed(ExpandExpression(Times(Power(Csc(v_),$p("n",true)),Power(Plus(a_,Times($p("b",true),Power(Tan(v_),$p("n",true)))),CN1)),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(Csc(v),n),Power(a,CN1)),Times(CN1,Times(b,Power(Times(a,Plus(Times(b,Power(Sin(v),n)),Times(a,Power(Cos(v),n)))),CN1)))),And(FreeQ(List(a,b),x),IntegerQ(n)))),
SetDelayed(ExpandExpression(Times(u_,Power(Plus(a_,Times($p("b",true),Tan(v_))),n_)),$p("x",$s("Symbol"))),
    Condition(ExpandExpression(Times(u,Power(Plus(Times(Power(Cos(v),C2),Power(a,CN1)),Times(Cos(v),Times(Sin(v),Power(b,CN1)))),Times(CN1,n))),x),And(And(And(FreeQ(List(a,b),x),IntegerQ(n)),Less(n,C0)),ZeroQ(Plus(Power(a,C2),Power(b,C2)))))),
SetDelayed(ExpandExpression(Times(u_,Power(Plus(a_,Times($p("b",true),Cot(v_))),n_)),$p("x",$s("Symbol"))),
    Condition(ExpandExpression(Times(u,Power(Plus(Times(Power(Sin(v),C2),Power(a,CN1)),Times(Cos(v),Times(Sin(v),Power(b,CN1)))),Times(CN1,n))),x),And(And(And(FreeQ(List(a,b),x),IntegerQ(n)),Less(n,C0)),ZeroQ(Plus(Power(a,C2),Power(b,C2)))))),
...
SetDelayed(ExpandExpression(Power(Sinh(v_),n_),$p("x",$s("Symbol"))),
    Condition(Module(List(z),Expand(NormalForm(Subst(TrigReduce(Power(Sinh(z),n)),z,v),x),x)),And(IntegerQ(n),Greater(n,C1)))),
SetDelayed(ExpandExpression(Times(Power(x_,$p("m",true)),Power(Sinh(v_),$p("n",true))),$p("x",$s("Symbol"))),
    Condition(Module(List(z),Expand(Times(Power(x,m),NormalForm(Subst(TrigReduce(Power(Sinh(z),n)),z,v),x)),x)),And(And(FreeQ(m,x),IntegerQ(n)),Greater(n,C0)))),
SetDelayed(ExpandExpression(Power(Cosh(v_),n_),$p("x",$s("Symbol"))),
    Condition(Module(List(z),Expand(NormalForm(Subst(TrigReduce(Power(Cosh(z),n)),z,v),x),x)),And(IntegerQ(n),Greater(n,C1)))),
SetDelayed(ExpandExpression(Times(Power(x_,$p("m",true)),Power(Cosh(v_),$p("n",true))),$p("x",$s("Symbol"))),
    Condition(Module(List(z),Expand(Times(Power(x,m),NormalForm(Subst(TrigReduce(Power(Cosh(z),n)),z,v),x)),x)),And(And(FreeQ(m,x),IntegerQ(n)),Greater(n,C0)))),
...
SetDelayed(ExpandExpression(Times(Power(Tanh(v_),$p("n",true)),Power(Plus(Times($p("a",true),Power(Sinh(v_),$p("n",true))),Times($p("b",true),Power(Cosh(v_),$p("n",true)))),CN1)),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(Sech(v),n),Power(a,CN1)),Times(CN1,Times(b,Power(Times(a,Plus(Times(a,Power(Sinh(v),n)),Times(b,Power(Cosh(v),n)))),CN1)))),And(FreeQ(List(a,b),x),IntegerQ(n)))),
SetDelayed(ExpandExpression(Times(Power(Coth(v_),$p("n",true)),Power(Plus(Times($p("a",true),Power(Sinh(v_),$p("n",true))),Times($p("b",true),Power(Cosh(v_),$p("n",true)))),CN1)),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(Csch(v),n),Power(b,CN1)),Times(CN1,Times(a,Power(Times(b,Plus(Times(a,Power(Sinh(v),n)),Times(b,Power(Cosh(v),n)))),CN1)))),And(FreeQ(List(a,b),x),IntegerQ(n)))),
...
SetDelayed(ExpandExpression(Times(Power(Csch(v_),$p("n",true)),Power(Plus(a_,Times($p("b",true),Power(Tanh(v_),$p("n",true)))),CN1)),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(Csch(v),n),Power(a,CN1)),Times(CN1,Times(b,Power(Times(a,Plus(Times(b,Power(Sinh(v),n)),Times(a,Power(Cosh(v),n)))),CN1)))),And(FreeQ(List(a,b),x),IntegerQ(n)))),
SetDelayed(ExpandExpression(Times(u_,Power(Plus(a_,Times($p("b",true),Tanh(v_))),n_)),$p("x",$s("Symbol"))),
    Condition(ExpandExpression(Times(u,Power(Plus(Times(Power(Cosh(v),C2),Power(a,CN1)),Times(CN1,Times(Cosh(v),Times(Sinh(v),Power(b,CN1))))),Times(CN1,n))),x),And(And(And(FreeQ(List(a,b),x),IntegerQ(n)),Less(n,C0)),ZeroQ(Plus(Power(a,C2),Times(CN1,Power(b,C2))))))),
SetDelayed(ExpandExpression(Times(u_,Power(Plus(a_,Times($p("b",true),Coth(v_))),n_)),$p("x",$s("Symbol"))),
    Condition(ExpandExpression(Times(u,Power(Plus(Times(Times(CN1,Power(Sinh(v),C2)),Power(a,CN1)),Times(Cosh(v),Times(Sinh(v),Power(b,CN1)))),Times(CN1,n))),x),And(And(And(FreeQ(List(a,b),x),IntegerQ(n)),Less(n,C0)),ZeroQ(Plus(Power(a,C2),Times(CN1,Power(b,C2))))))),
...
SetDelayed(ExpandExpression(u_,$p("x",$s("Symbol"))),
    If(Or(Or(Or(Or(Or(Or(SumQ(u),MatchQ(u,Condition(Times($p("c",true),Power(Plus(a_,Times($p("b",true),Power(x,$p("n",true)))),CN1)),And(FreeQ(List(a,b,c),x),IntegerQ(n))))),MatchQ(u,Condition(Times(Times($p("c",true),Power(x,$p("m",true))),Power(Plus(a_,Times($p("b",true),Power(x,$p("n",true)))),$p("p",true))),And(And(FreeQ(List(a,b,c),x),IntegerQ(List(m,n,p))),ZeroQ(Plus(Plus(m,Times(CN1,n)),C1)))))),MatchQ(u,Condition(Times(Times($p("c",true),Power(x,$p("m",true))),Power(Plus(v_,Times($p("b",true),Power(x,$p("n",true)))),$p("p",true))),And(And(And(And(FreeQ(List(b,c),x),Not(AlgebraicFunctionQ(v,x))),IntegerQ(List(m,n,p))),Less(p,C0)),And(Less(C0,n),LessEqual(n,m)))))),MatchQ(u,Condition(Times(Power(x,m_),Power($(f_,Plus($p("a",true),Times($p("b",true),x))),$p("n",true))),And(And(FreeQ(List(a,b,m,n),x),MemberQ(List($s("Tan"),$s("Cot"),$s("Tanh"),$s("Coth")),f)),Not(And(IntegerQ(m),Greater(m,C0))))))),MatchQ(u,Condition(Times($(f_,Plus(Plus($p("a",true),Times($p("b",true),x)),Times($p("c",true),Power(x,C2)))),Power(x,CN1)),And(FreeQ(List(a,b,c),x),MemberQ(List($s("Sin"),$s("Cos"),$s("Sinh"),$s("Cosh")),f))))),MatchQ(u,Condition(Power(Plus(a_,Times($p("b",true),Power($(f_,Plus($p("c",true),Times($p("d",true),x))),C2))),n_),And(And(FreeQ(List(a,b),x),MemberQ(List($s("Sin"),$s("Cos"),$s("Sinh"),$s("Cosh")),f)),IntegerQ(n))))),u,Module(List($s("tmp"),$s("lst")),CompoundExpression(Set($s("tmp"),FindKernel(u,x)),If(And(NotFalseQ($s("tmp")),FunctionOfKernelQ(u,$s("tmp"),x)),Subst(ExpandExpression(Subst(u,$s("tmp"),x),x),x,$s("tmp")),CompoundExpression(Set($s("tmp"),FunctionOfTrigQ(u,x,x)),If(And(And($s("tmp"),Or(ContainsQ(u,$s("Sin"),x),ContainsQ(u,$s("Csc"),x))),FunctionOfQ(Sin(x),u,x)),ExpandTrigExpression(u,Sin(x),x),If(And(And($s("tmp"),Or(ContainsQ(u,$s("Cos"),x),ContainsQ(u,$s("Sec"),x))),FunctionOfQ(Cos(x),u,x)),ExpandTrigExpression(u,Cos(x),x),If(And(And($s("tmp"),Or(ContainsQ(u,$s("Tan"),x),ContainsQ(u,$s("Cot"),x))),FunctionOfQ(Tan(x),u,x)),ExpandTrigExpression(u,Tan(x),x),CompoundExpression(Set($s("tmp"),FunctionOfHyperbolicQ(u,x,x)),If(And(And($s("tmp"),Or(ContainsQ(u,$s("Sinh"),x),ContainsQ(u,$s("Csch"),x))),FunctionOfQ(Sinh(x),u,x)),ExpandTrigExpression(u,Sinh(x),x),If(And(And($s("tmp"),Or(ContainsQ(u,$s("Cosh"),x),ContainsQ(u,$s("Sech"),x))),FunctionOfQ(Cosh(x),u,x)),ExpandTrigExpression(u,Cosh(x),x),If(And(And($s("tmp"),Or(ContainsQ(u,$s("Tanh"),x),ContainsQ(u,$s("Coth"),x))),FunctionOfQ(Tanh(x),u,x)),ExpandTrigExpression(u,Tanh(x),x),Module(List(v),If(And(AlgebraicFunctionQ(u,x),Not(RationalFunctionQ(u,x))),If(GoodExpansionQ(u,Set(v,ExpandExpressionAux(u,x)),x),RegularizeTerm(v,x),u),If(GoodExpansionQ(u,Set(v,Apart(u,x)),x),RegularizeTerm(v,x),If(GoodExpansionQ(u,Set(v,Apart(u)),x),RegularizeTerm(v,x),If(GoodExpansionQ(u,Set(v,ExpandExpressionAux(u,x)),x),RegularizeTerm(v,x),If(TrigHyperbolicFreeQ(u,x),CompoundExpression(Set(v,Apart(u,x)),RegularizeTerm(If(GoodExpansionQ(u,v,x),v,u),x)),CompoundExpression(CompoundExpression(Set($s("tmp"),TryTrigReduceQ(u)),If($s("tmp"),Set($s("lst"),SplitFreeFactors(TrigReduce(u),x)))),If(And($s("tmp"),GoodExpansionQ(u,Set(v,Apart(Part($s("lst"),C2),x)),x)),Map(Function(RegularizeTerm(Times(Part($s("lst"),C1),Slot1),x)),v),If(And($s("tmp"),GoodExpansionQ(u,Set(v,Apart(Part($s("lst"),C2))),x)),Map(Function(RegularizeTerm(Times(Part($s("lst"),C1),Slot1),x)),v),If(And($s("tmp"),GoodExpansionQ(u,Set(v,ExpandExpressionAux(Part($s("lst"),C2),x)),x)),Map(Function(RegularizeTerm(Times(Part($s("lst"),C1),Slot1),x)),v),CompoundExpression(Set(v,SmartTrigExpand(u,x)),If(SumQ(v),RegularizeTerm(v,x),CompoundExpression(Set(v,TrigExpand(u)),If(And(SumQ(v),SumQ(Set(v,Simplify(v)))),RegularizeTerm(v,x),CompoundExpression(Set(v,Apart(u,x)),RegularizeTerm(If(GoodExpansionQ(u,v,x),v,u),x))))))))))))))))))))))))))))),
SetDelayed(TryTrigReduceQ(u_),
    MatchQ(u,Condition(Times(v_,Power($(f_,w_),n_)),And(IntegerQ(n),MemberQ(List($s("Sin"),$s("Cos"),$s("Sinh"),$s("Cosh")),f))))),
...
SetDelayed(GoodExpansionQ(u_,v_,$p("x",$s("Symbol"))),
    If(SumQ(v),If(PolynomialQ(u,x),True,If(RationalFunctionQ(u,x),If(RationalFunctionQ(v,x),Module(List(Set($s("lst"),RationalFunctionExponents(u,x))),Catch(CompoundExpression(Scan(Function(If(SimplerRationalFunctionQ($s("lst"),RationalFunctionExponents(Slot1,x)),Throw(False))),v),True))),False),True)),False)),
...
SetDelayed(ExpandExpressionAux(Times(Plus(d_,Times($p("e",true),Power(x_,$p("k",true)))),Power(Plus(Plus(a_,Times($p("b",true),Power(x_,k_))),Times($p("c",true),Power(x_,j_))),n_)),$p("x",$s("Symbol"))),
    Condition(Plus(Times(d,Power(Plus(Plus(a,Times(b,Power(x,k))),Times(c,Power(x,j))),n)),Times(Times(e,Power(x,k)),Power(Plus(Plus(a,Times(b,Power(x,k))),Times(c,Power(x,j))),n))),And(And(And(And(FreeQ(List(a,b,c,d,e),x),IntegerQ(List(n,k,j))),EvenQ(k)),Equal(j,Times(C2,k))),Less(n,CN1)))),
...
SetDelayed(ExpandExpressionAux(Times(Power(u_,n_),$p("v",true)),$p("x",$s("Symbol"))),
    Condition(Module(List(Set(w,Expand(Power(u,n),x))),Condition(Map(Function(Times(Slot1,v)),w),SumQ(w))),And(And(And(SumQ(u),IntegerQ(n)),Greater(n,C0)),Not(FreeQ(u,x))))),
SetDelayed(RegularizeTerm(Times($p("c",true),Times(u_,Power(Plus(a_,Times($p("b",true),Power(x_,n_))),CN1))),$p("x",$s("Symbol"))),
    Condition(If(PolynomialQ(u,x),Module(List(k),Sum(RegularizeTerm(Times(Times(c,Coefficient(u,x,k)),Times(Power(x,k),Power(Plus(a,Times(b,Power(x,n))),CN1))),x),List(k,C0,Exponent(u,x)))),Map(Function(RegularizeTerm(Times(c,Times(Slot1,Power(Plus(a,Times(b,Power(x,n))),CN1))),x)),u)),And(And(And(And(FreeQ(List(a,b,c),x),IntegerQ(n)),Greater(n,C0)),SumQ(u)),Not(FreeQ(u,x))))),
...
SetDelayed(ContainsQ(u_,f_,x_),
    Greater(Count(u,Condition($(f,Times($p("n",true),x)),IntegerQ(n)),CInfinity),C0)),
