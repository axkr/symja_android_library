...
public class ExprPolynomial implements RingElem<ExprPolynomial>, Iterable<ExprMonomial> {
  ...
  /**
   * Constant coefficient. Returns the coefficient of the constant term (the term with all-zero
   * exponents), or zero if no such term exists.
   *
   * @return the constant coefficient of this polynomial, or zero if none.
   */
  public IExpr constantCoefficient() {
