...
public class BigRational extends Number implements Comparable<BigRational> {
  ...
  public BigRational negate() {
    return new BigRational(
        this.num.negate(),
        this.den); // It is not required to copy the denominator because BigIntegers are inmutable
  }
  ...
  /**
   * Converts this to a BigDecimal with decPrec digits precision. Because we can access numerator
   * and denominator directly, implementation in this class is more efficient than as
   * BigFloat.valueOf(BigRational).
   *
