      ...
      List(
          ...
          IIntegrate(3122,
              ...
              Condition(
                  Module(
                      list(
                          Set(f,
                              FreeFactors(Tan(Plus(Times(C1D2, Plus(d, Times(e, x))), CPiQuarter)),
                                  x))),
                      Dist(
                          Times(f, Power(e,
                              CN1)),
                          Subst(
                              Integrate(Power(Plus(a, Times(b, f, x)),
                                  CN1), x),
                              x, Times(Tan(Plus(Times(C1D2, Plus(d, Times(e, x))), CPiQuarter)),
                                  Power(f, CN1))),
                          x)),
          ...
          IIntegrate(3123,
              ...
              Condition(
                  Module(
                      list(Set(f,
                          FreeFactors(Cot(Plus(Times(C1D2, Plus(d, Times(e, x))), CPiQuarter)),
                              x))),
                      Negate(
                          Dist(
                              Times(f, Power(e,
                              ...
                              Subst(Integrate(Power(Plus(a, Times(b, f, x)), CN1), x), x,
                                  Times(Cot(Plus(Times(C1D2, Plus(d, Times(e, x))), CPiQuarter)),
                                      Power(f, CN1))),
                              x))),
                  And(FreeQ(List(a, b, c, d, e), x), EqQ(Subtract(a, c), C0),
                      NeQ(Subtract(a, b), C0)))),
          IIntegrate(3124,
              Integrate(
                  Power(
