...
/**
 * List of big primes. Provides an Iterator for generating prime numbers. Similar to ALDES/SAC2
 * SACPOL.PRIME list. See Knuth vol 2, page 390, for list of known primes. See also ALDES/SAC2
 * SACPOL.PRIME
 *
 * @author Heinz Kredel
 */
public final class PrimeList implements Iterable<java.math.BigInteger> {
  ...
  private static volatile List<java.math.BigInteger> SMALL_LIST = null;

  private static volatile List<java.math.BigInteger> LOW_LIST = null;

  private static volatile List<java.math.BigInteger> MEDIUM_LIST = null;

  private static volatile List<java.math.BigInteger> LARGE_LIST = null;

  private static volatile List<java.math.BigInteger> MERSENNE_LIST = null;
