...
public class ComplexUtils {
	...
	public static IComplexNum acos(final IComplexNum val) {
		...
		return ComplexNum.I.negate().multiply(log(z.add(ComplexNum.I.multiply(sqrt1z(z)))));
	}
	...
	public static IComplexNum asin(final IComplexNum val) {
		...
		return ComplexNum.I.negate().multiply(log(sqrt1z(z).add(ComplexNum.I.multiply(z))));
	}
	...
	public static IComplexNum atan(final IComplexNum val) {
		...
		return ComplexNum.I.multiply(log(temp.complexNumValue())).divide(ComplexNum.valueOf(2.0, 0.0))
				.complexNumValue();
	}
