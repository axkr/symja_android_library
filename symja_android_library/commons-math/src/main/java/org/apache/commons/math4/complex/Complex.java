...
public class Complex implements FieldElement<Complex>, Serializable  {
     ...
     */
    @Override
    public Complex sum(Complex addend) throws NullArgumentException {
    ...
    public Complex acos() {
        ...
        return this.sum(this.sqrt1z().multiply(I)).log().multiply(I.negate());
    }
    ...
    public Complex asin() {
        ...
        return sqrt1z().sum(this.multiply(I)).log().multiply(I.negate());
    }
    ...
    public Complex atan() {
        ...
        return this.sum(I).divide(I.subtract(this)).log()
