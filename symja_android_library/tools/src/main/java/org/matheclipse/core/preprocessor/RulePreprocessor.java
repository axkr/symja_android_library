...
public class RulePreprocessor {
  ...
  public static void appendSetDelayedToRule(
  ...
  public static void appendSetDelayedToMatcher(
      IAST ast, StringBuilder buffer, boolean evalRHS, boolean last) {
    IExpr leftHandSide = ast.arg1();
    IExpr rightHandSide = ast.arg2();
    if (leftHandSide.isAST()) {
  ...
  private static void convertToRule(
  ...
  private static void convertToMatcher(
      IExpr expr, String rulePostfix, final PrintWriter out, String symbolName, EvalEngine engine) {
    boolean last;
    StringBuilder buffer = new StringBuilder();
  ...
  public static void main(final String[] args) {
    ...
    sourceLocation = new File("..\\symja_android_library\\rule_sets\\");
    javaTargetLocation =
        new File(
            "..\\symja_android_library\\matheclipse-core\\src\\main\\java\\org\\matheclipse\\core\\reflection\\system\\rulesets");
