...
SetDelayed(SubstForFractionalPowerOfLinear(u_,x_Symbol),
...
SetDelayed(SubstForFractionalPowerOfQuotientOfLinears(u_,x_Symbol),
...
SetDelayed(SubstForFractionalPowerQ(u_,v_,x_Symbol),
...
SetDelayed(SubstForInverseFunctionOfLinear(u_,x_Symbol),
...
SetDelayed(InverseFunctionOfLinear(u_,x_Symbol),
...
SetDelayed(SubstForInverseFunctionOfQuotientOfLinears(u_,x_Symbol),
...
SetDelayed(InverseFunctionOfQuotientOfLinears(u_,x_Symbol),
...
SetDelayed(SubstForFractionalPower(u_,v_,n_,w_,x_Symbol),
...
SetDelayed(SubstForInverseFunction(u_,v_,x_Symbol),
...
SetDelayed(SubstForInverseFunction(u_,v_,w_,x_Symbol),
...
SetDelayed(SubstForInverseLinear(u_,x_Symbol),
...
SetDelayed(DerivativeDivides(u_,v_,x_Symbol),
...
SetDelayed(Rt(Times(Power(u_,w_),v_DEFAULT),$p(n,IntegerHead)),
...
SetDelayed(Rt(Times(Power(v_,m_),u_),$p(n,IntegerHead)),
...
SetDelayed(Rt(Times(Power(Plus(Times(Power(Sin(v_),C2),b_DEFAULT),a_),m_DEFAULT),u_DEFAULT),$p(n,IntegerHead)),
    Condition(Rt(Times(u,Power(Times(a,Power(Cos(v),C2)),m)),n),ZeroQ(Plus(a,b)))),
SetDelayed(Rt(Times(Power(Plus(Times(Power(Cos(v_),C2),b_DEFAULT),a_),m_DEFAULT),u_DEFAULT),$p(n,IntegerHead)),
    Condition(Rt(Times(u,Power(Times(a,Power(Sin(v),C2)),m)),n),ZeroQ(Plus(a,b)))),
SetDelayed(Rt(Times(Power(Plus(Times(Power(Sinh(v_),C2),b_DEFAULT),a_),m_DEFAULT),u_DEFAULT),$p(n,IntegerHead)),
    Condition(Rt(Times(u,Power(Times(a,Power(Cosh(v),C2)),m)),n),ZeroQ(Plus(a,Times(CN1,b))))),
SetDelayed(Rt(Times(Power(Plus(Times(Power(Cosh(v_),C2),b_DEFAULT),a_),m_DEFAULT),u_DEFAULT),$p(n,IntegerHead)),
