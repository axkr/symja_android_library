...
/**
 * Container for the logarithmic part of a rational function integral. num/den = sum( a_i ( der(d_i)
 * / d_i ) ) integrate(num/den) = sum( a_i log ( d_i ) )
 *
 * @author Heinz Kredel
...
public class LogIntegral<C extends GcdRingElem<C>> implements Serializable {
   ...
   * @param ad list of irreducible factors d_i of d with algebraic coefficients. n/d = sum( a_i (
   *     der(d_i) / d_i ) )
   */
  public LogIntegral(
      GenPolynomial<C> n,
