...
ISetDelayed(4396,ExpandToSum(u_,v_,x_Symbol),
...
ISetDelayed(4397,ExpandToSum(u_,x_Symbol),
...
ISetDelayed(4401,ExpandIntegrand(Power(u_,p_DEFAULT),x_Symbol),
    Condition(If(EqQ(p,C1),ExpandCleanup(u,x),ExpandCleanup(Expand(Power(u,p),x),x)),And(SumQ(u),IGtQ(p,C0)))),
ISetDelayed(4402,ExpandIntegrand(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_DEFAULT),x_Symbol),
    Condition(ExpandIntegrand(Times(Power(x,Times(n,p)),Power(Plus(b,Times(a,Power(x,Negate(n)))),p)),x),And(IntegerQ(p),ILtQ(n,C0)))),
ISetDelayed(4403,ExpandIntegrand(Times(Power(x_,m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(4404,ExpandIntegrand(Times($p("§px",true),Power(x_,m_),Power(Plus(Times(b_DEFAULT,Power(x_,n_DEFAULT)),Times(c_DEFAULT,Power(x_,$p("n1")))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(4405,ExpandIntegrand(Times($p("§px",true),Power(Plus(Times(b_DEFAULT,Power(x_,n_DEFAULT)),Times(c_DEFAULT,Power(x_,$p("n1")))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(4406,ExpandIntegrand(Times(Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(F_,u_))),p_DEFAULT),Power(Plus(c_DEFAULT,Times(d_DEFAULT,Power(F_,v_))),q_DEFAULT)),x_Symbol),
...
ISetDelayed(4407,ExpandIntegrand(Times(Power(F_,Times(e_DEFAULT,Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),n_DEFAULT))),Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Plus(g_DEFAULT,Times(h_DEFAULT,x_)),-1)),x_Symbol),
...
ISetDelayed(4408,ExpandIntegrand(Times(Power(F_,Times(b_DEFAULT,Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),n_DEFAULT))),Power(x_,m_DEFAULT),Power(Plus(e_,Times(f_DEFAULT,x_)),p_DEFAULT)),x_Symbol),
...
ISetDelayed(4409,ExpandIntegrand(Times(Power(F_,Plus(a_DEFAULT,Times(b_DEFAULT,Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),n_DEFAULT)))),Power(x_,m_DEFAULT),Power(Plus(e_,Times(f_DEFAULT,x_)),p_DEFAULT)),x_Symbol),
...
ISetDelayed(4410,ExpandIntegrand(Times(Power(Plus(a_,Times(b_DEFAULT,Power(F_,v_))),m_DEFAULT),Power(Plus(c_,Times(d_DEFAULT,Power(F_,v_))),n_),u_DEFAULT),x_Symbol),
...
ISetDelayed(4411,ExpandIntegrand(Times(Power(F_,Times(e_DEFAULT,Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),n_DEFAULT))),u_,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(4412,ExpandIntegrand(Times(u_,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT),Log(Times(c_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,Power(x_,n_DEFAULT))),p_DEFAULT)))),x_Symbol),
...
ISetDelayed(4413,ExpandIntegrand(Times(Power(F_,Times(e_DEFAULT,Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),n_DEFAULT))),u_),x_Symbol),
...
ISetDelayed(4414,ExpandIntegrand(Times(Power($(F_,u_),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,$(G_,u_))),n_DEFAULT)),x_Symbol),
...
ISetDelayed(4415,ExpandIntegrand(Times(u_,Power(Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(Times(d_DEFAULT,Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),p_DEFAULT)),q_DEFAULT))))),n_)),x_Symbol),
...
ISetDelayed(4416,ExpandIntegrand(Times(u_,Power(Plus(a_DEFAULT,Times(b_DEFAULT,$(F_,Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),n_)),x_Symbol),
...
ISetDelayed(4417,ExpandIntegrand(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,Power(x_,n_)),Times(b_DEFAULT,Sqrt(Plus(c_,Times(d_DEFAULT,Power(x_,j_)))))),-1)),x_Symbol),
...
ISetDelayed(4418,ExpandIntegrand(Times(Power(Plus(a_,Times(b_DEFAULT,x_)),m_),Power(Plus(c_,Times(d_DEFAULT,x_)),-1)),x_Symbol),
...
ISetDelayed(4419,ExpandIntegrand(Times(Plus(A_,Times(B_DEFAULT,x_)),Power(Plus(a_,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Plus(c_,Times(d_DEFAULT,x_)),-1)),x_Symbol),
...
ISetDelayed(4420,ExpandIntegrand(Times(u_,Power(Plus(a_,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Plus(c_,Times(d_DEFAULT,x_)),n_DEFAULT)),x_Symbol),
...
ISetDelayed(4421,ExpandIntegrand(Times(u_,Power(Plus(a_,Times(b_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(4422,ExpandIntegrand(Times(u_,Power(v_,n_),Power(Plus(a_,Times(b_DEFAULT,x_)),m_)),x_Symbol),
...
ISetDelayed(4423,ExpandIntegrand(Times(u_,Power(v_,n_),Power(Plus(a_,Times(b_DEFAULT,x_)),m_)),x_Symbol),
...
ISetDelayed(4424,ExpandIntegrand(Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1),x_Symbol),
...
ISetDelayed(4425,ExpandIntegrand(Times(Plus(c_,Times(d_DEFAULT,Power(u_,n_))),Power(Plus(a_,Times(b_DEFAULT,Power(u_,$p("n2")))),-1)),x_Symbol),
...
ISetDelayed(4426,ExpandIntegrand(Times(Plus(c_DEFAULT,Times(d_DEFAULT,u_)),Power(Plus(a_,Times(b_DEFAULT,u_)),m_)),x_Symbol),
...
ISetDelayed(4427,ExpandIntegrand(Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1),x_Symbol),
...
ISetDelayed(4428,ExpandIntegrand(Times(Plus(c_,Times(d_DEFAULT,Power(u_,m_DEFAULT))),Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1)),x_Symbol),
...
ISetDelayed(4429,ExpandIntegrand(Times(Plus(c_DEFAULT,Times(d_DEFAULT,Power(u_,m_DEFAULT)),Times(e_DEFAULT,Power(u_,p_))),Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1)),x_Symbol),
...
ISetDelayed(4430,ExpandIntegrand(Times(Plus(c_DEFAULT,Times(d_DEFAULT,Power(u_,m_DEFAULT)),Times(e_DEFAULT,Power(u_,p_)),Times(f_DEFAULT,Power(u_,q_))),Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1)),x_Symbol),
...
ISetDelayed(4431,ExpandIntegrand(Power(Plus(a_,Times(c_DEFAULT,Power(u_,n_))),p_),x_Symbol),
...
ISetDelayed(4432,ExpandIntegrand(Times(Power(u_,m_DEFAULT),Power(Plus(a_DEFAULT,Times(c_DEFAULT,Power(u_,n_))),p_)),x_Symbol),
...
ISetDelayed(4433,ExpandIntegrand(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
...
ISetDelayed(4434,ExpandIntegrand(Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(u_,n_DEFAULT)),Times(c_DEFAULT,Power(u_,$p("n2",true)))),p_),x_Symbol),
...
ISetDelayed(4435,ExpandIntegrand(Times(Power(u_,m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(u_,n_DEFAULT)),Times(c_DEFAULT,Power(u_,$p("n2",true)))),p_)),x_Symbol),
...
ISetDelayed(4436,ExpandIntegrand(Times(Plus(c_,Times(d_DEFAULT,Power(u_,n_DEFAULT))),Power(Plus(a_,Times(b_DEFAULT,Power(u_,$p("n2",true)))),-1)),x_Symbol),
...
ISetDelayed(4437,ExpandIntegrand(Times(Plus(d_DEFAULT,Times(e_DEFAULT,Plus(f_DEFAULT,Times(g_DEFAULT,Power(u_,n_DEFAULT))))),Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(u_,n_DEFAULT)),Times(c_DEFAULT,Power(u_,$p("n2",true)))),-1)),x_Symbol),
...
ISetDelayed(4438,ExpandIntegrand(Times(u_,Power(v_,-1)),x_Symbol),
    Condition(PolynomialDivide(u,v,x),And(PolynomialQ(u,x),PolynomialQ(v,x),GreaterEqual(Exponent(u,x),Exponent(v,x))))),
ISetDelayed(4439,ExpandIntegrand(Times(u_,Power(Times(a_DEFAULT,x_),p_)),x_Symbol),
    Condition(ExpandToSum(Power(Times(a,x),p),u,x),And(Not(IntegerQ(p)),PolynomialQ(u,x)))),
ISetDelayed(4440,ExpandIntegrand(Times(u_DEFAULT,Power(v_,p_)),x_Symbol),
    Condition(ExpandIntegrand(NormalizeIntegrand(Power(v,p),x),u,x),Not(IntegerQ(p)))),
ISetDelayed(4441,ExpandIntegrand(u_,x_Symbol),
    With(List(Set(v,ExpandExpression(u,x))),Condition(v,SumQ(v)))),
ISetDelayed(4442,ExpandIntegrand(Times(Power(u_,m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1)),x_Symbol),
    Condition(ExpandBinomial(a,b,m,n,u,x),And(FreeQ(List(a,b),x),IntegersQ(m,n),Less(C0,m,n)))),
ISetDelayed(4443,ExpandIntegrand(u_,x_Symbol),
    u),
ISetDelayed(4444,ExpandExpression(u_,x_Symbol),
...
ISetDelayed(4445,ExpandCleanup(Plus(u_,Times(v_,Power(Plus(a_,Times(b_DEFAULT,x_)),-1)),Times(w_,Power(Plus(c_,Times(d_DEFAULT,x_)),-1))),x_Symbol),
...
ISetDelayed(4446,ExpandCleanup(u_,x_Symbol),
...
ISetDelayed(4447,CollectReciprocals(Plus(u_,Times(e_,Power(Plus(a_,Times(b_DEFAULT,x_)),-1)),Times(f_,Power(Plus(c_,Times(d_DEFAULT,x_)),-1))),x_Symbol),
...
ISetDelayed(4448,CollectReciprocals(Plus(u_,Times(e_,Power(Plus(a_,Times(b_DEFAULT,x_)),-1)),Times(f_,Power(Plus(c_,Times(d_DEFAULT,x_)),-1))),x_Symbol),
...
ISetDelayed(4449,CollectReciprocals(u_,x_Symbol),
    u),
ISetDelayed(4450,ExpandBinomial(a_,b_,m_,n_,u_,x_Symbol),
...
ISetDelayed(4451,SmartApart(u_,x_Symbol),
...
ISetDelayed(4452,SmartApart(u_,v_,x_Symbol),
...
ISetDelayed(4453,MakeAssocList(u_,x_Symbol,Colon($p("alst",$s("List")),List())),
...
ISetDelayed(4454,GensymSubst(u_,x_Symbol,$p("alst",$s("List"))),
...
ISetDelayed(4455,KernelSubst(u_,x_Symbol,$p("alst",$s("List"))),
...
ISetDelayed(4461,ExpandLinearProduct(v_,u_,a_,b_,x_Symbol),
...
ISetDelayed(4462,ExpandTrigExpand(u_,F_,v_,m_,n_,x_Symbol),
...
ISetDelayed(4463,ExpandTrigReduce(u_,v_,x_Symbol),
    With(List(Set(w,ExpandTrigReduce(v,x))),If(SumQ(w),Map(Function(Times(u,Slot1)),w),Times(u,w)))),
ISetDelayed(4464,ExpandTrigReduce(Times(u_DEFAULT,Power($(F_,Plus(n_,v_DEFAULT)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(4465,ExpandTrigReduce(u_,x_Symbol),
    ExpandTrigReduceAux(u,x)),
ISetDelayed(4466,ExpandTrigReduceAux(u_,x_Symbol),
    With(List(Set(v,Expand(TrigReduce(u)))),If(SumQ(v),Map(Function(NormalizeTrigReduce(Slot1,x)),v),NormalizeTrigReduce(v,x)))),
ISetDelayed(4467,NormalizeTrigReduce(Times(a_DEFAULT,Power($(F_,u_),n_DEFAULT)),x_Symbol),
    Condition(Times(a,Power(F(ExpandToSum(u,x)),n)),And(FreeQ(List(FSymbol,a,n),x),PolynomialQ(u,x),Greater(Exponent(u,x),C0)))),
ISetDelayed(4468,NormalizeTrigReduce(u_,x_Symbol),
    u),
ISetDelayed(4469,ExpandTrigToExp(u_,x_Symbol),
    ExpandTrigToExp(C1,u,x)),
ISetDelayed(4470,ExpandTrigToExp(u_,v_,x_Symbol),
...
ISetDelayed(4475,FunctionOfLinear(u_,x_Symbol),
...
ISetDelayed(4476,FunctionOfLinear(u_,a_,b_,x_,$p("flag")),
...
ISetDelayed(4477,FunctionOfLinearSubst(u_,a_,b_,x_),
...
ISetDelayed(4478,DivideDegreesOfFactors(u_,n_),
...
ISetDelayed(4479,FunctionOfInverseLinear(u_,x_Symbol),
    FunctionOfInverseLinear(u,Null,x)),
ISetDelayed(4480,FunctionOfInverseLinear(u_,$p("lst"),x_),
...
ISetDelayed(4481,FunctionOfExponentialQ(u_,x_Symbol),
