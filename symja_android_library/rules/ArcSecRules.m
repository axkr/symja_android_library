{ 
 ...
 ArcSec(1)=0,
 ArcSec(-1)=Pi,
 ArcSec(Sqrt(6)-Sqrt(2))=1/12*Pi,
 ArcSec(Sqrt(2)-Sqrt(6))=11/12*Pi,
 ArcSec(Sqrt(2-2/Sqrt(5)))=1/10*Pi,
 ArcSec(-Sqrt(2-2/Sqrt(5)))=9/10*Pi,
 ArcSec(2/Sqrt(2+Sqrt(2)))=1/8*Pi,
 ArcSec(-2/Sqrt(2+Sqrt(2)))=7/8*Pi,
 ArcSec(2/Sqrt(3))=1/6*Pi,
 ArcSec(-2/Sqrt(3))=5/6*Pi,
 ArcSec(Sqrt(5)-1)=1/5*Pi,     
 ArcSec(1-Sqrt(5))=4/5*Pi,   
 ArcSec(Sqrt(2))=1/4*Pi, 
