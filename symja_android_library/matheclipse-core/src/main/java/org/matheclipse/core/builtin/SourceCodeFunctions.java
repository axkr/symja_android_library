...
public class SourceCodeFunctions {
	...
	public final static int[] LINE_NUMBER_OF_JAVA_CLASS = new int[] { //
			...
			53, 75, 2448, 726, 1674, 0, 141, 1387, 606, 63, 151, //
			140, 1752, 1556, 1835, 632, 2669, 2751, 0, 0, 0, 567, //
			...
			5356, 0, 5389, 0, 0, 1620, 4348, 4454, 0, 0, 236, //
			298, 0, 346, 383, 404, 439, 460, 506, 0, 544, 610, //
			688, 745, 795, 514, 1651, 1731, 5418, 0, 178, 5755, 4534, //
			0, 43, 1600, 0, 5049, 5004, 138, 594, 0, 4861, 0, //
			5578, 2496, 1843, 1877, 0, 0, 1227, 834, 1302, 0, 5874, //
			201, 0, 2131, 2205, 6233, 6418, 6464, 6074, 2883, 3026, 3826, //
			15, 661, 407, 539, 573, 428, 0, 857, 1933, 2031, 2700, //
			2527, 177, 107, 5163, 6131, 2682, 888, 928, 3683, 3633, 974, //
			990, 674, 3611, 3942, 0, 0, 6556, 3767, 2755, 2790, 0, //
			3860, 683, 0, 45, 51, 32, 0, 3941, 0, 1777, 0, //
			0, 0, 0, 4030, 2870, 5661, 6649, 2293, 360, 1548, 4032, //
			0, 4615, 0, 268, 4090, 2378, 2445, 2518, 0, 1059, 4081, //
			1335, 611, 4137, 0, 4296, 5882, 4201, 1385, 1199, 1264, 1326, //
			0, 5977, 954, 988, 1022, 1066, 0, 0, 2932, 3000, 0, //
			0, 0, 1434, 1496, 3054, 0, 0, 0, 4162, 0, 1888, //
			0, 1811 };
