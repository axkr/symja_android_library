...
public interface SumRules {
  public static Matcher init1() {
    ...
    matcher.caseOf(Sum(Power(c_, Plus(i_, a_DEFAULT)), list(i_Symbol, C1, oo)),
        Condition(Times(CN1, Power(Plus(CN1, c), CN1), Power(c, Plus(C1, a))),
            And(FreeQ(list(a, c), i), Or(Not(NumericQ(c)), And(Greater(c, CN1), Less(c, C1))))));
    ...
    matcher.caseOf(
        Sum(Times(Power(i_, k_), Power(c_, Times(a_DEFAULT, i_))), list(i_Symbol, C1, oo)),
        Condition(PolyLog(Negate(k), Power(c, a)),
            And(FreeQ(list(a, c, k), i), Or(Not(NumericQ(Power(c, a))),
                And(Greater(Power(c, a), CN1), Less(Power(c, a), C1))))));
    ...
    matcher.caseOf(
        Sum(Times(Power(-1, i_), Power(Factorial(Plus(Times(C2, i_), C1)), CN1),
            Power(x_, Plus(Times(C2, i_), C1))), list(i_Symbol, C0, oo)),
    ...
    matcher.caseOf(
        Sum(Times(Power(-1, i_), Power(Factorial(Times(C2, i_)), CN1), Power(x_, Times(C2, i_))),
            list(i_Symbol, C0, oo)),
        Condition(Cos(x), FreeQ(x, i)));
    // Sum((-1)^i_*x_^(2*i_+1)/(2*i_+1),{i_Symbol,0,Infinity}):=ArcTanh(x)/;FreeQ(x,i)&&(!NumericQ(x)||(x>-1&&x<1))
    matcher.caseOf(
        Sum(Times(Power(-1, i_), Power(Plus(Times(C2, i_), C1), CN1),
            Power(x_, Plus(Times(C2, i_), C1))), list(i_Symbol, C0, oo)),
        Condition(ArcTanh(x),
            And(FreeQ(x, i), Or(Not(NumericQ(x)), And(Greater(x, CN1), Less(x, C1))))));
    ...
    matcher.caseOf(
        Sum(Times(Power(i_, CN1), Power(-1, Plus(CN1, i_)), Power(Plus(CN1, x_), i_)),
            list(i_Symbol, C1, oo)),
        Condition(Log(x),
            And(FreeQ(x, i), Or(Not(NumericQ(x)), And(Greater(x, C0), LessEqual(x, C2))))));
    // Sum(1/((-1)^i_*(2*i_+1)),{i_Symbol,1,Infinity}):=1/4*(-4+Pi)
    matcher.caseOf(Sum(Times(Power(-1, Negate(i_)), Power(Plus(Times(C2, i_), C1), CN1)),
    ...
    matcher.caseOf(Sum(Times(Power(z_, k_), Power(Plus(k_, a_), s_)), list(k_, C0, oo)),
        Condition(HurwitzLerchPhi(z, Negate(s), a),
            And(FreeQ(list(a, s, z), k), Or(Not(NumericQ(z)), And(Greater(z, CN1), Less(z, C1))))));
    ...
    matcher.caseOf(Sum(Times(Sin(Times(a_DEFAULT, k_)), Power(k_, CN1)), list(k_Symbol, C1, oo)),
        Condition(Times(C1D2, Plus(Negate(a), Pi)),
            And(FreeQ(a, k), Greater(a, C0), Less(a, C2Pi))));
    ...
    matcher.caseOf(Sum(Times(Cos(Times(a_DEFAULT, k_)), Power(k_, CN1)), list(k_Symbol, C1, oo)),
        Condition(Negate(Log(Times(C2, Sin(Times(C1D2, a))))),
            And(FreeQ(a, k), Greater(a, C0), Less(a, C2Pi))));
    ...
    matcher.caseOf(Sum(Times(Sin(Times(a_DEFAULT, k_)), Power(k_, m_)), list(k_Symbol, C1, oo)),
        Condition(Im(PolyLog(Negate(m), Exp(Times(CI, a)))),
            And(FreeQ(list(a, m), k), Less(m, CN1), Greater(a, C0), Less(a, C2Pi))));
    ...
    matcher.caseOf(Sum(Times(Cos(Times(a_DEFAULT, k_)), Power(k_, m_)), list(k_Symbol, C1, oo)),
        Condition(Re(PolyLog(Negate(m), Exp(Times(CI, a)))),
            And(FreeQ(list(a, m), k), Less(m, CN1), Greater(a, C0), Less(a, C2Pi))));
    ...
    matcher.caseOf(Sum(Times(HarmonicNumber(k_), Power(k_, m_)), list(k_Symbol, C1, oo)),
        Condition(
            Plus(
                Times(CN1D2,
                    Sum(Times(Zeta(Plus(C1, j)), Zeta(Subtract(Negate(j), m))),
                        list(j, C1, Subtract(CN2, m)))),
                Times(Plus(C1, Times(CN1D2, m)), Zeta(Subtract(C1, m)))),
            And(FreeQ(m, k), IntegerQ(m), Less(m, CN1))));
    ...
    // Sum(HarmonicNumber(k_),{k_Symbol,1,n_Symbol}):=HyperHarmonicNumber(2,n)/;FreeQ(n,k)
    matcher.caseOf(Sum(HarmonicNumber(k_), list(k_Symbol, C1, n_Symbol)),
        Condition(HyperHarmonicNumber(C2, n), FreeQ(n, k)));
    // Sum(HarmonicNumber(k_,m_),{k_Symbol,1,n_Symbol}):=HyperHarmonicNumber(2,n,m)/;FreeQ({m,n},k)
    matcher.caseOf(Sum(HarmonicNumber(k_, m_), list(k_Symbol, C1, n_Symbol)),
        Condition(HyperHarmonicNumber(C2, n, m), FreeQ(list(m, n), k)));
    ...
    matcher.caseOf(Sum(Times(Power(z_, i_), Power(i_, Negate(n_))), list(i_Symbol, C1, oo)),
        Condition(PolyLog(n, z),
            And(FreeQ(list(z, n), i), Or(Not(NumericQ(z)), And(Greater(z, CN1), Less(z, C1))))));
    // Sum(Log(i_)/i_^2,{i_,1,Infinity}):=-1/6*Pi^2*(EulerGamma+Log(2)-12*Log(Glaisher)+Log(Pi))
    matcher.caseOf(Sum(Times(Log(i_), Power(i_, CN2)), list(i_, C1, oo)), Times(QQ(-1L, 6L),
        Sqr(Pi), Plus(EulerGamma, Log(C2), Times(ZZ(-12L), Log(Glaisher)), Log(Pi))));
    ...
    matcher.caseOf(Sum(Power(c_, Times(a_DEFAULT, i_)), list(i_Symbol, C0, n_)),
        Condition(
            Times(Power(Plus(CN1, Power(c, a)), CN1), Plus(CN1, Power(c, Plus(a, Times(a, n))))),
            And(FreeQ(list(a, c), i), SpecialsFreeQ(n))));
    ...
    matcher.caseOf(Sum(Power(c_, Plus(i_, m_DEFAULT)), list(i_Symbol, C0, n_)),
        Condition(Times(Power(Plus(CN1, c), CN1), Power(c, m), Plus(CN1, Power(c, Plus(C1, n)))),
            And(FreeQ(list(c, n, m), i), SpecialsFreeQ(n))));
    ...
    matcher.caseOf(Sum(Times(i_, Power(c_, i_)), list(i_Symbol, C0, oo)),
        Condition(Times(Power(Plus(CN1, c), CN2), c),
            And(FreeQ(c, i), Or(Not(NumericQ(c)), And(Greater(c, CN1), Less(c, C1))))));
    ...
    matcher.caseOf(Sum(Times(i_, Power(c_, i_)), list(i_Symbol, C0, n_)),
        Condition(
            ...
            And(FreeQ(list(c, n), i), Not(IntegerQ(n)), SpecialsFreeQ(n))));
    ...
    matcher
        .caseOf(
            Sum(Factorial(i_),
                list(i_Symbol, C0,
                    PatternTest(n_,
                        Function(And(Not(ExactNumberQ(Slot1)), SpecialsFreeQ(Slot1)))))),
            Condition(
                Plus(Negate(Subfactorial(CN1)),
                    Times(CN1, Power(-1, n), Gamma(Plus(C2, n)), Subfactorial(Subtract(CN2, n)))),
                FreeQ(n, i)));
    ...
    matcher.caseOf(Sum(Cos(Times(i_, c_DEFAULT)), list(i_Symbol, C0, n_)),
        Condition(
            Times(Csc(Times(C1D2, c)), Cos(Times(C1D2, c, n)), Sin(Times(C1D2, c, Plus(C1, n)))),
            And(FreeQ(list(c, n), i), SpecialsFreeQ(n))));
    ...
    matcher.caseOf(Sum(Sin(Times(i_, c_DEFAULT)), list(i_Symbol, C0, n_)),
        Condition(
            Times(Csc(Times(C1D2, c)), Sin(Times(C1D2, c, n)), Sin(Times(C1D2, c, Plus(C1, n)))),
            And(FreeQ(list(c, n), i), SpecialsFreeQ(n))));
    return matcher;
  }
}
