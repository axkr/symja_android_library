...
SetDelayed(QuotientOfLinearsQ(Plus(a_,u_),x_),
    Condition(QuotientOfLinearsQ(u,x),FreeQ(a,x))),
SetDelayed(QuotientOfLinearsQ(Power(u_,CN1),x_),
    QuotientOfLinearsQ(u,x)),
SetDelayed(QuotientOfLinearsQ(u_,x_),
    Condition(True,LinearQ(u,x))),
SetDelayed(QuotientOfLinearsQ(Times(Power(v_,CN1),u_),x_),
...
SetDelayed(QuotientOfLinearsParts(Power(u_,CN1),x_),
...
SetDelayed(QuotientOfLinearsParts(Times(Power(v_,CN1),u_),x_),
...
SetDelayed(NormalForm(Times(Plus(Times($p(d,true),x_),c_),$p(b,true),x_),$p(x,SymbolHead)),
    Condition(Plus(Times(Times(b,c),x),Times(Times(b,d),Power(x,C2))),FreeQ(List(b,c,d),x))),
SetDelayed(NormalForm(Plus(Times(Plus(Times(Power(x_,$p(n,true)),$p(d,true)),c_),Power(x_,$p(n,true)),$p(b,true)),a_),$p(x,SymbolHead)),
    Condition(Plus(Plus(a,Times(Times(b,c),Power(x,n))),Times(Times(b,d),Power(x,Times(C2,n)))),FreeQ(List(a,b,c,d,n),x))),
SetDelayed(NormalForm(Plus(Times(Power(Plus(Times(Power(x_,$p(n,true)),$p(b,true)),a_),C2),$p(d,true)),c_),$p(x,SymbolHead)),
...
SetDelayed(NormalForm(Plus(Times(Power(Plus(Times(Power(x_,$p(n,true)),$p(b,true)),a_),C2),$p(d,true)),Times(Power(x_,$p(n,true)),$p(e,true)),$p(c,true)),$p(x,SymbolHead)),
...
SetDelayed(NormalForm(Plus(Times(Plus(Times(Power(f_,Plus(Times($p(g,true),x_),$p(e,true))),$p(d,true)),c_),Power(f_,Plus(Times($p(g,true),x_),$p(e,true))),$p(b,true)),a_),$p(x,SymbolHead)),
...
SetDelayed(NormalForm(Times(Plus(Times(Power(x_,$p(n,true)),$p(b,true)),a_),Power(x_,$p(m,true)),$p(c,true)),$p(x,SymbolHead)),
    Condition(Times(c,Plus(b,Times(a,Power(x,m)))),And(FreeQ(List(a,b,c,m,n),x),ZeroQ(Plus(m,n))))),
SetDelayed(NormalForm($(f_,Times(Power(Plus(Times(Power(x_,$p(n,true)),$p(b,true)),a_),p_),Power(x_,$p(m,true)),$p(c,true))),$p(x,SymbolHead)),
...
SetDelayed(NormalForm(Power(Times(Plus(Times($p(b,true),x_),a_),Plus(Times($p(d,true),x_),c_),$p(e,true)),n_),$p(x,SymbolHead)),
...
SetDelayed(NormalForm(Times(Power(f_,v_),Power(g_,w_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(NormalForm(Times(Power(f_,Plus(Times(Power(x_,$p(n,true)),$p(b,true)),$p(a,true))),Power(g_,Plus(Times(Power(x_,$p(n,true)),$p(d,true)),$p(c,true))),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(NormalForm(Power(Plus(Times(Power(x_,$p(m,true)),$p(a,true)),Times(Power(x_,$p(n,true)),$p(b,true))),p_),$p(x,SymbolHead)),
...
SetDelayed(NormalForm(Plus(Times($p(a,true),v_),Times($p(b,true),v_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(NormalForm(Times(Plus(c_,d_),Power(Plus(a_,b_),integer(-2L)),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(SimplifyExpression(Times(Power(Plus(Times(Power(x_,n_),$p(b,true)),a_),$p(p,true)),Power(x_,m_)),$p(x,SymbolHead)),
...
SetDelayed(SimplifyExpression(Power(Plus(Times(Power(x_,m_),$p(b,true)),Times(Power(x_,n_),$p(c,true)),Times($p(a,true),x_)),CN1),$p(x,SymbolHead)),
...
SetDelayed(SimplifyExpression(Times(Plus(Times(Power(x_,C2),$p(b,true)),$p(a,true)),Power(Plus(Times(Power(x_,C2),$p(d,true)),Times(Power(Plus(Times(Power(x_,C2),$p(g,true)),f_),C1D2),$p(e,true)),c_),CN1)),$p(x,SymbolHead)),
...
SetDelayed(SimplifyExpression(Times(Power(Plus(Times(Power(x_,CN1),$p(a,true)),Times($p(c,true),x_),b_),CN1),Power(x_,CN1)),$p(x,SymbolHead)),
    Condition(Times(C1,Power(Plus(Plus(a,Times(b,x)),Times(c,Power(x,C2))),CN1)),FreeQ(List(a,b,c),x))),
SetDelayed(SimplifyExpression(Times(Power(Plus(Times(Power(x_,integer(-2L)),$p(a,true)),Times(Power(x_,CN1),$p(b,true)),c_),CN1),Power(x_,integer(-2L))),$p(x,SymbolHead)),
    Condition(Times(C1,Power(Plus(Plus(a,Times(b,x)),Times(c,Power(x,C2))),CN1)),FreeQ(List(a,b,c),x))),
SetDelayed(SimplifyExpression(Times(Power(Plus(Times(Power(x_,$p(m,true)),$p(a,true)),Times(Power(x_,$p(p,true)),$p(b,true)),Times(Power(x_,$p(q,true)),$p(c,true))),CN1),Power(x_,$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(TrigSimplifyAux(Times(Power(Plus(Times(Power(v_,$p(m,true)),$p(a,true)),Times(Power(v_,$p(n,true)),$p(b,true))),p_),$p(u,true))),
...
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Cos(z_),C2),$p(u,true)),Times(Power(Sin(z_),C2),$p(v,true)),$p(w,true))),
    Condition(Plus(u,w),SameQ(u,v))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Sec(z_),C2),$p(u,true)),Times(Power(Tan(z_),C2),$p(v,true)),$p(w,true))),
    Condition(Plus(u,w),SameQ(u,Times(CN1,v)))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Csc(z_),C2),$p(u,true)),Times(Power(Cot(z_),C2),$p(v,true)),$p(w,true))),
    Condition(Plus(u,w),SameQ(u,Times(CN1,v)))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Sin(z_),C2),$p(v,true)),u_,$p(w,true))),
    Condition(Plus(Times(u,Power(Cos(z),C2)),w),SameQ(u,Times(CN1,v)))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Cos(z_),C2),$p(v,true)),u_,$p(w,true))),
    Condition(Plus(Times(u,Power(Sin(z),C2)),w),SameQ(u,Times(CN1,v)))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Tan(z_),C2),$p(v,true)),u_,$p(w,true))),
    Condition(Plus(Times(u,Power(Sec(z),C2)),w),SameQ(u,v))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Cot(z_),C2),$p(v,true)),u_,$p(w,true))),
    Condition(Plus(Times(u,Power(Csc(z),C2)),w),SameQ(u,v))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Sec(z_),C2),$p(v,true)),u_,$p(w,true))),
    Condition(Plus(Times(v,Power(Tan(z),C2)),w),SameQ(u,Times(CN1,v)))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Csc(z_),C2),$p(v,true)),u_,$p(w,true))),
    Condition(Plus(Times(v,Power(Cot(z),C2)),w),SameQ(u,Times(CN1,v)))),
SetDelayed(TrigSimplifyAux(Times(Power(Plus(Times(Cos(v_),$p(b,true)),a_),CN1),Power(Sin(v_),C2),$p(u,true))),
    Condition(Times(u,Plus(Times(C1,Power(a,CN1)),Times(CN1,Times(Cos(v),Power(b,CN1))))),ZeroQ(Plus(Power(a,C2),Times(CN1,Power(b,C2)))))),
SetDelayed(TrigSimplifyAux(Times(Power(Cos(v_),C2),Power(Plus(Times(Sin(v_),$p(b,true)),a_),CN1),$p(u,true))),
    Condition(Times(u,Plus(Times(C1,Power(a,CN1)),Times(CN1,Times(Sin(v),Power(b,CN1))))),ZeroQ(Plus(Power(a,C2),Times(CN1,Power(b,C2)))))),
SetDelayed(TrigSimplifyAux(Times(Power(Plus(Times(Power(Tan(v_),$p(n,true)),$p(b,true)),a_),CN1),Power(Tan(v_),$p(n,true)),$p(u,true))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cot(v),n))),CN1)),And(And(IntIntegerQ(n),Greater(n,C0)),NonsumQ(a)))),
SetDelayed(TrigSimplifyAux(Times(Power(Cot(v_),$p(n,true)),Power(Plus(Times(Power(Cot(v_),$p(n,true)),$p(b,true)),a_),CN1),$p(u,true))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Tan(v),n))),CN1)),And(And(IntIntegerQ(n),Greater(n,C0)),NonsumQ(a)))),
SetDelayed(TrigSimplifyAux(Times(Power(Plus(Times(Power(Sec(v_),$p(n,true)),$p(b,true)),a_),CN1),Power(Sec(v_),$p(n,true)),$p(u,true))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cos(v),n))),CN1)),And(And(IntIntegerQ(n),Greater(n,C0)),NonsumQ(a)))),
SetDelayed(TrigSimplifyAux(Times(Power(Csc(v_),$p(n,true)),Power(Plus(Times(Power(Csc(v_),$p(n,true)),$p(b,true)),a_),CN1),$p(u,true))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Sin(v),n))),CN1)),And(And(IntIntegerQ(n),Greater(n,C0)),NonsumQ(a)))),
SetDelayed(TrigSimplifyAux(Power(Plus(Times(Csc(v_),$p(a,true)),Times(Cot(v_),$p(b,true))),n_)),
...
SetDelayed(TrigSimplifyAux(Times(Power(Plus(Times(Power(Cot(v_),$p(n,true)),$p(b,true)),$p(a,true)),$p(p,true)),Power(Sin(v_),$p(m,true)),$p(u,true))),
...
SetDelayed(TrigSimplifyAux(Times(Power(Cos(v_),$p(m,true)),Power(Plus(Times(Power(Tan(v_),$p(n,true)),$p(b,true)),$p(a,true)),$p(p,true)),$p(u,true))),
...
SetDelayed(TrigSimplifyAux(Times(Power(Plus(Times(Power(Tan(v_),C2),$p(b,true)),$p(a,true)),$p(p,true)),Power(Sec(v_),$p(m,true)),u_)),
...
SetDelayed(TrigSimplifyAux(Times(Power(Csc(v_),$p(m,true)),Power(Plus(Times(Power(Cot(v_),C2),$p(b,true)),$p(a,true)),$p(p,true)),u_)),
...
SetDelayed(TrigSimplifyAux(Times(Power(Cos(v_),$p(m,true)),Power(Plus(Times(Power(Tan(v_),$p(n,true)),$p(b,true)),Times(Power(Sec(v_),$p(n,true)),$p(c,true)),$p(a,true)),$p(p,true)),$p(u,true))),
...
SetDelayed(TrigSimplifyAux(Times(Power(Plus(Times(Power(Tan(v_),$p(n,true)),$p(b,true)),Times(Power(Sec(v_),$p(n,true)),$p(c,true)),$p(a,true)),$p(p,true)),Power(Sec(v_),$p(m,true)),$p(u,true))),
...
SetDelayed(TrigSimplifyAux(Times(Power(Plus(Times(Power(Cot(v_),$p(n,true)),$p(b,true)),Times(Power(Csc(v_),$p(n,true)),$p(c,true)),$p(a,true)),$p(p,true)),Power(Sin(v_),$p(m,true)),$p(u,true))),
...
SetDelayed(TrigSimplifyAux(Times(Power(Csc(v_),$p(m,true)),Power(Plus(Times(Power(Cot(v_),$p(n,true)),$p(b,true)),Times(Power(Csc(v_),$p(n,true)),$p(c,true)),$p(a,true)),$p(p,true)),$p(u,true))),
...
SetDelayed(TrigSimplifyAux(Times(Power(Plus(Times(Power(Sec(v_),$p(n,true)),$p(b,true)),a_),CN1),Power(Tan(v_),$p(n,true)),$p(u,true))),
