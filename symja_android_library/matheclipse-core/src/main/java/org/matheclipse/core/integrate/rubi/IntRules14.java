...
IIntegrate(281,Integrate(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_DEFAULT),Power(Plus(c_,Times(d_DEFAULT,Power(x_,n_))),q_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Power(Times(b,Power(d,CN1)),p),Integrate(Times(u,Power(Plus(c,Times(d,Power(x,n))),Plus(p,q))),x),x),x),And(FreeQ(List(a,b,c,d,n,p,q),x),EqQ(Subtract(Times(b,c),Times(a,d)),C0),IntegerQ(p),Not(And(IntegerQ(q),SimplerQ(Plus(a,Times(b,Power(x,n))),Plus(c,Times(d,Power(x,n))))))))),
IIntegrate(282,Integrate(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),Power(Plus(c_,Times(d_DEFAULT,Power(x_,n_))),q_)),x_Symbol),
    Condition(Simp(Dist(Power(Times(b,Power(d,CN1)),p),Integrate(Times(u,Power(Plus(c,Times(d,Power(x,n))),Plus(p,q))),x),x),x),And(FreeQ(List(a,b,c,d,n,p,q),x),EqQ(Subtract(Times(b,c),Times(a,d)),C0),GtQ(Times(b,Power(d,CN1)),C0),Not(SimplerQ(Plus(a,Times(b,Power(x,n))),Plus(c,Times(d,Power(x,n)))))))),
IIntegrate(283,Integrate(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),Power(Plus(c_,Times(d_DEFAULT,Power(x_,n_))),q_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Plus(a,Times(b,Power(x,n))),p),Power(Power(Plus(c,Times(d,Power(x,n))),p),CN1)),Integrate(Times(u,Power(Plus(c,Times(d,Power(x,n))),Plus(p,q))),x),x),x),And(FreeQ(List(a,b,c,d,n,p,q),x),EqQ(Subtract(Times(b,c),Times(a,d)),C0),Not(SimplerQ(Plus(a,Times(b,Power(x,n))),Plus(c,Times(d,Power(x,n)))))))),
...
IIntegrate(285,Integrate(Times(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),p_)),x_Symbol),
    Condition(Plus(Simp(Times(x,Power(Plus(a,Times(b,Sqr(x))),p),Power(Plus(c,Times(d,Sqr(x))),p),Power(Plus(Times(C4,p),C1),CN1)),x),Simp(Dist(Times(C4,a,c,p,Power(Plus(Times(C4,p),C1),CN1)),Integrate(Times(Power(Plus(a,Times(b,Sqr(x))),Plus(p,CN1)),Power(Plus(c,Times(d,Sqr(x))),Plus(p,CN1))),x),x),x)),And(FreeQ(List(a,b,c,d),x),EqQ(Plus(Times(b,c),Times(a,d)),C0),GtQ(p,C0)))),
IIntegrate(286,Integrate(Times(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),p_)),x_Symbol),
    Condition(Plus(Simp(Times(CN1,x,Power(Plus(a,Times(b,Sqr(x))),Plus(p,C1)),Power(Plus(c,Times(d,Sqr(x))),Plus(p,C1)),Power(Times(C4,a,c,Plus(p,C1)),CN1)),x),Simp(Dist(Times(Plus(Times(C4,p),C5),Power(Times(C4,a,c,Plus(p,C1)),CN1)),Integrate(Times(Power(Plus(a,Times(b,Sqr(x))),Plus(p,C1)),Power(Plus(c,Times(d,Sqr(x))),Plus(p,C1))),x),x),x)),And(FreeQ(List(a,b,c,d),x),EqQ(Plus(Times(b,c),Times(a,d)),C0),LtQ(p,CN1)))),
...
IIntegrate(288,Integrate(Times(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),p_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Plus(c,Times(d,Sqr(x))),FracPart(p)),Power(Times(Power(-1,IntPart(p)),Power(Subtract(Negate(c),Times(d,Sqr(x))),FracPart(p))),CN1)),Integrate(Power(Subtract(Times(CN1,a,c),Times(b,d,Power(x,C4))),p),x),x),x),And(FreeQ(List(a,b,c,d,p),x),EqQ(Plus(Times(b,c),Times(a,d)),C0),GtQ(a,C0),LtQ(c,C0)))),
IIntegrate(289,Integrate(Times(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),p_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Plus(a,Times(b,Sqr(x))),FracPart(p)),Power(Plus(c,Times(d,Sqr(x))),FracPart(p)),Power(Power(Plus(Times(a,c),Times(b,d,Power(x,C4))),FracPart(p)),CN1)),Integrate(Power(Plus(Times(a,c),Times(b,d,Power(x,C4))),p),x),x),x),And(FreeQ(List(a,b,c,d,p),x),EqQ(Plus(Times(b,c),Times(a,d)),C0),Not(IntegerQ(p))))),
...
IIntegrate(292,Integrate(Times(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),q_DEFAULT)),x_Symbol),
    Condition(Subtract(Simp(Times(CN1,x,Power(Plus(a,Times(b,Sqr(x))),Plus(p,C1)),Power(Plus(c,Times(d,Sqr(x))),q),Power(Times(C2,a,Plus(p,C1)),CN1)),x),Simp(Dist(Times(c,q,Power(Times(a,Plus(p,C1)),CN1)),Integrate(Times(Power(Plus(a,Times(b,Sqr(x))),Plus(p,C1)),Power(Plus(c,Times(d,Sqr(x))),Plus(q,CN1))),x),x),x)),And(FreeQ(List(a,b,c,d,p),x),NeQ(Subtract(Times(b,c),Times(a,d)),C0),EqQ(Plus(Times(C2,Plus(p,q,C1)),C1),C0),GtQ(q,C0),NeQ(p,CN1)))),
...
IIntegrate(296,Integrate(Times(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),Power(Plus(c_,Times(d_DEFAULT,Sqr(x_))),q_)),x_Symbol),
    Condition(Plus(Simp(Times(CN1,b,x,Power(Plus(a,Times(b,Sqr(x))),Plus(p,C1)),Power(Plus(c,Times(d,Sqr(x))),Plus(q,C1)),Power(Times(C2,a,Plus(p,C1),Subtract(Times(b,c),Times(a,d))),CN1)),x),Simp(Dist(Times(Plus(Times(b,c),Times(C2,Plus(p,C1),Subtract(Times(b,c),Times(a,d)))),Power(Times(C2,a,Plus(p,C1),Subtract(Times(b,c),Times(a,d))),CN1)),Integrate(Times(Power(Plus(a,Times(b,Sqr(x))),Plus(p,C1)),Power(Plus(c,Times(d,Sqr(x))),q)),x),x),x)),And(FreeQ(List(a,b,c,d,q),x),NeQ(Subtract(Times(b,c),Times(a,d)),C0),EqQ(Plus(Times(C2,Plus(p,q,C2)),C1),C0),Or(LtQ(p,CN1),Not(LtQ(q,CN1))),NeQ(p,CN1)))),
