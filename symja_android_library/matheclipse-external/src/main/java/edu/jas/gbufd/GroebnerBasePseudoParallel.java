...
/**
 * Groebner Base with pseudo reduction multi-threaded parallel algorithm. Implements coefficient
...
public class GroebnerBasePseudoParallel<C extends GcdRingElem<C>> extends GroebnerBaseAbstract<C> {
   ...
   *
   * @param threads number of threads to use.
   * @param rf coefficient ring factory. <b>Note:</b> red must be an instance of PseudoReductionPar.
   ...
   */
  public GroebnerBasePseudoParallel(
      int threads, RingFactory<C> rf, PseudoReduction<C> red, ExecutorService pool) {
