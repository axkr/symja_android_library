...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"FourierMatrix", "FractionalPart", "FrechetDistribution", "FreeQ", "FresnelC", "FresnelS", "FrobeniusSolve",
			"FromCharacterCode", "FromContinuedFraction", "FromPolarCoordinates", "FullForm", "FullSimplify",
			"Function", "Gamma", "GammaDistribution", "Gather", "GCD", "GegenbauerC", "GeometricDistribution",
			"GeometricMean", "Get", "Graphics", "Graphics3D", "Graphics3D", "Greater", "GreaterEqual", "GroebnerBasis",
			"GumbelDistribution", "Haversine", "HarmonicNumber", "Head", "HeavisideTheta", "HermiteH", "HilbertMatrix",
			...
			"LogGamma", "LogicalExpand", "LogisticSigmoid", "LogIntegral", "LowerCaseQ", "LowerTriangularize", "LucasL",
			"LUDecomposition", "MachineNumberQ", "ManhattanDistance", "MantissaExponent", "Map", "MapAt", "MapAll",
			"MapThread", "MatchingDissimilarity", "MatchQ", "MathMLForm", "MatrixForm", "MatrixMinimalPolynomial",
			"MatrixPower", "MatrixQ", "MatrixRank", "Max", "Mean", "Median", "MeijerG", "MemberQ", "MeshRange",
			...
			"Projection", "PseudoInverse", "Put", "QRDecomposition", "Quiet", "Quit", "Quotient", "RandomChoice",
			"RandomInteger", "RandomReal", "RandomSample", "Range", "Rational", "Rationalize", "Re", "RealNumberQ",
			"Reap", "Rectangle", "Reduce", "Refine", "Repeated", "RepeatedNull", "Replace", "ReplaceAll", "ReplaceList",
