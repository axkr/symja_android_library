...
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,$($s("§sec"),Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),n_),x_Symbol),
    Condition($(Defer($s("Int")),Power(Plus(a,Times(b,Sec(Plus(c,Times(d,x))))),n),x),And(And(FreeQ(List(a,b,c,d,n),x),NonzeroQ(Plus(Sqr(a),Negate(Sqr(b))))),Not(IntegerQ(Times(C2,n)))))),
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,$($s("§csc"),Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),n_),x_Symbol),
    Condition($(Defer($s("Int")),Power(Plus(a,Times(b,Csc(Plus(c,Times(d,x))))),n),x),And(And(FreeQ(List(a,b,c,d,n),x),NonzeroQ(Plus(Sqr(a),Negate(Sqr(b))))),Not(IntegerQ(Times(C2,n))))))
  );
}
