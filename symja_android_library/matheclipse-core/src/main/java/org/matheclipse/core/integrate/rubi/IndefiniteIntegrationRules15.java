...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Times(Power(x_,n_),$p(a,true)))),CN1),Power(ProductLog(Times(Power(x_,n_),$p(a,true))),p_),Power(x_,$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Times(Power(x_,n_),$p(a,true)))),CN1),Power(ProductLog(Times(Power(x_,n_),$p(a,true))),$p(p,true)),Power(x_,$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Plus(Times($p(b,true),x_),$p(a,true)))),CN1),Power(Times(CN1,ProductLog(Plus(Times($p(b,true),x_),$p(a,true)))),$p(p,true))),$p(x,SymbolHead)),
    Condition(Times(Gamma(Plus(p,C1),Times(CN1,ProductLog(Plus(a,Times(b,x))))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Power(Times(CN1,ProductLog(Plus(Times($p(b,true),x_),$p(a,true)))),p_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,CN1),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Plus(Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_)),Times($(Derivative(f_),x_),$(g_,x_))),Power($(g_,x_),integer(-2L))),$p(x,SymbolHead)),
    Condition(Times($(f,x),Power($(g,x),CN1)),FreeQ(List(f,g),x))),
SetDelayed(Int(Times(Plus(Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_)),Times($(Derivative(f_),x_),$(g_,x_))),Power($(f_,x_),CN1),Power($(g_,x_),CN1)),$p(x,SymbolHead)),
    Condition(Log(Times($(f,x),Power($(g,x),CN1))),FreeQ(List(f,g),x))),
SetDelayed(Int(Times(Plus(Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_)),Times($(Derivative(f_),x_),$(g_,x_))),Power(Plus(Power($(f_,x_),C2),Power($(g_,x_),C2)),CN1)),$p(x,SymbolHead)),
    Condition(ArcTan(Times($(f,x),Power($(g,x),CN1))),FreeQ(List(f,g),x))),
SetDelayed(Int(Times(Plus(Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_)),Times($(Derivative(f_),x_),$(g_,x_))),Power(Plus(Power($(f_,x_),C2),Times(CN1,Power($(g_,x_),C2))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power($p("u1"),n_),Power($p("u2"),n_),v_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(u_,$p(n,true)),Power(x_,$p(m,true)),v_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times($p(b,true),x_),$p(a,true)),$p(m,true)),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Sin(Times(Plus(Times($p(b,true),x_),$p(a,true)),$p(c,true))),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Cos(Times(Plus(Times($p(b,true),x_),$p(a,true)),$p(c,true))),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Sec(Times(Plus(Times($p(b,true),x_),$p(a,true)),$p(c,true))),n_),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Csc(Times(Plus(Times($p(b,true),x_),$p(a,true)),$p(c,true))),n_),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Csc(Plus(Times($p(b,true),x_),$p(a,true))),Sec(Plus(Times($p(b,true),x_),$p(a,true))),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Cos(Plus(Times($p(b,true),x_),$p(a,true))),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Sinh(Times(Plus(Times($p(b,true),x_),$p(a,true)),$p(c,true))),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Cosh(Times(Plus(Times($p(b,true),x_),$p(a,true)),$p(c,true))),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Sech(Times(Plus(Times($p(b,true),x_),$p(a,true)),$p(c,true))),n_),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Csch(Times(Plus(Times($p(b,true),x_),$p(a,true)),$p(c,true))),n_),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Csch(Plus(Times($p(b,true),x_),$p(a,true))),Sech(Plus(Times($p(b,true),x_),$p(a,true))),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Cosh(Plus(Times($p(b,true),x_),$p(a,true))),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(u_,Plus(CN1,Times(Power(x_,$p(m,true)),$p(a,true)))),Power(x_,$p(m,true)),v_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(f_,Plus(Times(Power(x_,$p(n,true)),$p(b,true)),$p(a,true))),Power(x_,$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power($(f_,Plus(Times(Power(x_,n_),$p(b,true)),$p(a,true))),$p(p,true)),Power(x_,$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(x_,n_),$p(b,true)),a_),m_),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times($p(b,true),x_),a_),$p(m,true)),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(Plus(Times($p(d,true),x_),c_),n_),$p(b,true)),a_),CN1),Power(x_,$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(Plus(Times($p(d,true),x_),c_),n_),$p(b,true)),a_),p_),Power(Plus(Times($p(f,true),x_),e_),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times($p(b,true),x_),$p(a,true)),$p(m,true)),Power($(f_,Plus(Times($p(d,true),x_),$p(c,true))),$p(p,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(x_,C2),$p(e,true)),Times($p(d,true),x_),$p(c,true)),n_),Power(Plus(Times($p(b,true),x_),$p(a,true)),m_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Power(x_,$p(p,true)),u_),n_),v_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Power(x_,$p(p,true)),u_),n_),Power(x_,$p(m,true)),v_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Log(u_),Power(Plus(Times($p(b,true),x_),a_),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Log(u_),Power(Plus(Times($p(b,true),x_),$p(a,true)),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Log(u_),v_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(x_,C2),$p(b,true)),a_),CN1),$p(u,true),x_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times($p(b,true),v_),Times($p(c,true),w_),a_),CN1),Power(v_,$p(m,true)),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Plus(Times($p(e,true),v_),$p(d,true)),Power(Plus(Times($p(b,true),v_),Times($p(c,true),w_),a_),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times($p(b,true),v_),Times($p(c,true),w_),a_),CN1),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Times(Power(t_,$p(q,true)),Power(v_,$p(m,true)),Power(w_,$p(n,true))),p_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(x_,n_),$p(b,true)),a_),CN1),Power(x_,$p(m,true)),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(x_,n_),$p(b,true)),a_),CN1),u_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(v_,n_),$p(b,true)),a_),CN1),Power(v_,m_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(v_,n_),$p(b,true)),a_),CN1),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(v_,n_),$p(b,true)),a_),m_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(Times($p(b,true),v_),Times($p(c,true),w_),a_),m_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Power(v_,m_),p_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Times(Power(v_,$p(m,true)),a_),p_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Times(Power(v_,$p(m,true)),Power(w_,$p(n,true)),$p(a,true)),p_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Times(Power(v_,$p(m,true)),Power(w_,$p(n,true))),p_),$p(u,true)),$p(x,SymbolHead)),
