...
public class AlgebraicNotInvertibleException extends NotInvertibleException {
   ...
   */
  public AlgebraicNotInvertibleException(
      String c, GenPolynomial f, GenPolynomial f1, GenPolynomial f2) {
    super(c);
    this.f = f;
    this.f1 = f1;
    this.f2 = f2;
   ...
   */
  public AlgebraicNotInvertibleException(
      String c, Throwable t, GenPolynomial f, GenPolynomial f1, GenPolynomial f2) {
    super(c, t);
    this.f = f;
    this.f1 = f1;
    this.f2 = f2;
   ...
   */
  public AlgebraicNotInvertibleException(
      Throwable t, GenPolynomial f, GenPolynomial f1, GenPolynomial f2) {
