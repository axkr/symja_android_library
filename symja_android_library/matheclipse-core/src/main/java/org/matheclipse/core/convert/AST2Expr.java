...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abs", "AbsArg", "AddTo", "AllTrue", "And", "AnyTrue",
			...
			"IntegerExponent", "IntegerLength", "IntegerPart", "IntegerPartitions", "IntegerQ", "Integrate", "Interpolation",
			...
			"LucasL", "LUDecomposition", "ManhattanDistance", "MantissaExponent", "Map", "MapAt", "MapAll", "MapThread",
			...
			"PrependTo", "Prime", "PrimeOmega", "PrimePowerQ", "PrimeQ", "PrimitiveRoots", "Print", "Product",
			"ProductLog", "PseudoInverse", "Put", "QRDecomposition", "Quiet", "Quit", "Quotient", "RandomInteger",
