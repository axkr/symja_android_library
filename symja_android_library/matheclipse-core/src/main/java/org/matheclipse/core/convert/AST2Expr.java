...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "Block", "Boole", "BooleanConvert", "BooleanFunction", "BooleanMaxterms", "BooleanMinimize",
      "BooleanMinterms", "BooleanQ", "BooleanTable", "BooleanVariables", "BoxWhiskerChart",
      "BrayCurtisDistance", "Break", "BrownianBridgeProcess", "BSplineCurve", "BSplineFunction",
      "Button", "ByteArray", "ByteArrayQ", "ByteArrayToString", "ByteCount", "CanberraDistance",
      "Cancel", "CancelButton", "CapForm", "CarlsonRC", "CarlsonRD", "CarlsonRF", "CarlsonRG",
      "CarlsonRJ", "CarmichaelLambda", "CartesianProduct", "Cases", "CatalanNumber", "Catch",
      "Catenate", "CauchyDistribution", "CDF", "Ceiling", "Cell", "CenterDot", "CentralMoment",
      ...
      "Complex", "ComplexExpand", "ComplexPlot", "ComplexPlot3D", "ComposeList", "ComposeSeries",
      "CompositeQ", "Composition", "CompoundExpression", "Compress", "Condition",
      "ConditionalExpression", "Cone", "Conjugate", "ConjugateTranspose",
      "ConnectedGraphComponents", "ConnectedGraphQ", "ConstantArray", "ContainsAll", "ContainsAny",
      "ContainsExactly", "ContainsNone", "ContainsOnly", "Context", "Contexts", "Continue",
      "ContinuedFraction", "ContourPlot", "ContourPlot3D", "Convergents", "ConvexHullMesh",
      ...
      "Coth", "Count", "CountDistinct", "Counts", "Covariance", "CreateDirectory", "CreateFile",
      "CreateUUID", "Cross", "Csc", "Csch", "Cube", "CubeRoot", "Cuboid", "Cumulant", "Curl",
      "CycleGraph", "Cycles", "Cyclotomic", "Cylinder", "Darker", "Dashing", "Dataset",
