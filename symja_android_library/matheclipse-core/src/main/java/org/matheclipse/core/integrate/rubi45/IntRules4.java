...
ISetDelayed(4296,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),-1),x_Symbol),
...
ISetDelayed(4297,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),-1),x_Symbol),
...
ISetDelayed(4298,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1),x_Symbol),
...
ISetDelayed(4299,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1),x_Symbol),
...
ISetDelayed(4300,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1),x_Symbol),
...
ISetDelayed(4301,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1),x_Symbol),
...
ISetDelayed(4302,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1),x_Symbol),
...
ISetDelayed(4303,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1),x_Symbol),
...
ISetDelayed(4304,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),-1),x_Symbol),
...
ISetDelayed(4305,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),-1),x_Symbol),
...
ISetDelayed(4306,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,4))),-1),x_Symbol),
...
ISetDelayed(4307,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,4))),-1),x_Symbol),
...
ISetDelayed(4308,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),-1),x_Symbol),
...
ISetDelayed(4309,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),-1),x_Symbol),
...
ISetDelayed(4310,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),CN1D2),x_Symbol),
    Condition(Simp(Times(ArcSinh(Times(Rt(b,C2),x,Power(a,CN1D2))),Power(Rt(b,C2),-1)),x),And(FreeQ(List(a,b),x),GtQ(a,C0),PosQ(b)))),
ISetDelayed(4311,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),CN1D2),x_Symbol),
...
ISetDelayed(4312,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),CN1D2),x_Symbol),
...
ISetDelayed(4313,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,3))),CN1D2),x_Symbol),
...
ISetDelayed(4314,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,3))),CN1D2),x_Symbol),
...
ISetDelayed(4315,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,4))),CN1D2),x_Symbol),
...
ISetDelayed(4316,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,4))),CN1D2),x_Symbol),
...
ISetDelayed(4317,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,4))),CN1D2),x_Symbol),
...
ISetDelayed(4318,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,4))),CN1D2),x_Symbol),
...
ISetDelayed(4319,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,4))),CN1D2),x_Symbol),
...
ISetDelayed(4320,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,6))),CN1D2),x_Symbol),
...
ISetDelayed(4321,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,8))),CN1D2),x_Symbol),
...
ISetDelayed(4322,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),CN1D4),x_Symbol),
...
ISetDelayed(4323,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),CN1D4),x_Symbol),
...
ISetDelayed(4324,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),CN1D4),x_Symbol),
...
ISetDelayed(4325,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),CN1D4),x_Symbol),
...
ISetDelayed(4326,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),QQ(-3L,4L)),x_Symbol),
...
ISetDelayed(4327,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),QQ(-3L,4L)),x_Symbol),
...
ISetDelayed(4328,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),QQ(-3L,4L)),x_Symbol),
...
ISetDelayed(4329,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),QQ(-3L,4L)),x_Symbol),
...
ISetDelayed(4330,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),CN1D3),x_Symbol),
...
ISetDelayed(4331,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),QQ(-2L,3L)),x_Symbol),
...
ISetDelayed(4332,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,4))),QQ(-3L,4L)),x_Symbol),
...
ISetDelayed(4333,Int(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),QQ(-1L,6L)),x_Symbol),
...
ISetDelayed(4334,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,3))),CN1D3),x_Symbol),
...
ISetDelayed(4335,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
...
ISetDelayed(4336,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
...
ISetDelayed(4337,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
...
ISetDelayed(4338,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
...
ISetDelayed(4339,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
    Condition(Int(ExpandIntegrand(Power(Plus(a,Times(b,Power(x,n))),p),x),x),And(FreeQ(List(a,b,n),x),IGtQ(p,C0)))),
ISetDelayed(4340,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
...
ISetDelayed(4341,Int(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
...
ISetDelayed(4342,Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(v_,n_))),p_),x_Symbol),
...
ISetDelayed(4343,Int(Times(Power(Plus($p("a1",true),Times($p("b1",true),Power(x_,n_))),p_DEFAULT),Power(Plus($p("a2",true),Times($p("b2",true),Power(x_,n_))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(4344,Int(Times(Power(Plus($p("a1"),Times($p("b1",true),Power(x_,n_DEFAULT))),p_DEFAULT),Power(Plus($p("a2"),Times($p("b2",true),Power(x_,n_DEFAULT))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(4345,Int(Times(Power(Plus($p("a1"),Times($p("b1",true),Power(x_,n_DEFAULT))),p_),Power(Plus($p("a2"),Times($p("b2",true),Power(x_,n_DEFAULT))),p_)),x_Symbol),
