...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "DiscreteUniformDistribution", "Discriminant", "DiskMatrix", "DisjointQ", "Disk", "Dispatch",
      "DisplayForm", "Distribute", "Distributed", "Div", "Divide", "DivideBy", "DivideSides",
      "Divisible", "Divisors", "DivisorSigma", "DivisorSum", "Do", "Dodecahedron", "Dot",
      "DownValues", "Drop", "DSolve", "DSolveValue", "Dt", "DuplicateFreeQ", "Dynamic",
      "EasterSunday", "Echo", "EchoFunction", "EdgeAdd", "EdgeCount", "EdgeContract", "EdgeDelete",
      "EdgeForm", "EdgeList", "EdgeQ", "EdgeRules", "EdgeWeight", "EditDistance",
