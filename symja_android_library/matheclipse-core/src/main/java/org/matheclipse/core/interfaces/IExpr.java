...
public interface IExpr extends Comparable<IExpr>, GcdRingElem<IExpr>, Serializable, FieldElement<IExpr> {
	...
	/**
	 * Returns the <b>number of arguments</b> in this {@code IAST}. The <b>number of arguments</b> equals <code>size() - 1</code> (i.e.
	 * the <b>number of elements</b> minus 1). If this is an atom return size <code>-1</code>.
	 * 
	...
	/**
	 * Get the first element of this <code>AST</code> list (i.e. get(1)). Return <code>F.NIL</code> if this object isn't an
	 * <code>AST</code>. Use this method if the AST gives <code>true</code> for the <code>isPower()</code> method.
	 * 
	 * @return the first argument of the function represented by this <code>AST</code> or <code>F.NIL</code> if this object isn't an
	 *         AST.
	 */
	default IExpr base() {
		return first();
	...
	/**
	 * Returns an <code>IExpr</code> whose value is <code>(this - 1)</code>. Calculates <code>F.eval(F.Subtract(this, C1))</code> in the
	...
	/**
	 * Calls <code>get(position).equals(expr)</code> if <code>this</code> is an <code>IAST</code>. Returns <code>false</code> otherwise.
	 * 
	 ...
	 * @return the evaluated Object or <code>F.NIL</code> if the evaluation is not possible (i.e. the evaluation doesn't change the
	 *         object).
	 */
	...
	/**
	 * Get the second element of this <code>AST</code> list (i.e. get(2)). Return <code>F.NIL</code> if this object isn't an
	 * <code>AST</code>. Use this method if the AST gives <code>true</code> for the <code>isPower()</code> method.
	 * 
	 * @return the second argument of the function represented by this <code>AST</code> or <code>F.NIL</code> if this object isn't an
	 *         AST.
	 */
	...
	/**
	 * Returns <code>true</code>, if <b>all of the elements</b> in the subexpressions or the expression itself, did not match the given
	 * pattern. Calls <code>isFree(pattern, true)</code>.
	 * 
	...
	/**
	 * Returns <code>true</code>, if <b>at least one of the elements</b> in the subexpressions or the expression itself, match the given
	 * pattern.
	 * 
	 * 
	 * @param pattern a pattern-matching expression
	 * @param heads   if set to <code>false</code>, only the arguments of an IAST should be tested and not the <code>Head[]</code>
	 *                element.
	 * @return
	 */
	 ...
	 * <code>#get(0)</code> ). Otherwise return the specific header, i.e. for
	...
	/**
	 * Get the head of an expression and if it is a built-in symbol return the ID of this symbol, otherwise return <code>-1</code>
	 * (ID.UNKNNOWN)
	 * 
	...
	/**
	 * If this expression unequals <code>F.NIL</code>, invoke the specified consumer with the <code>this</code> object, otherwise do
	 * nothing.
	 *
	...
	/**
	 * If a value is present, performs the given <code>consumer</code> with the value, otherwise performs the given empty-based action.
	 * 
	...
	/**
	 * Returns the multiplicative inverse of this object. It is the object such as <code>this.times(this.inverse()) == ONE </code>, with
	 * <code>ONE</code> being the multiplicative identity. Calculates <code>F.eval(F.Power(this, F.CN1))</code> in the common case and
	 * uses a specialized implmentation for derived number classes.
	 * 
	...
	/**
	 * Test if this expression and all subexpressions are already expanded i.e. all <code>Plus, Times, Power</code> (sub-)expressions
	 * are expanded.
	 * 
	 * @return
	 */
	 ...
	 * <code>0</code> and some optional <b>argument elements</b> at the index positions <code>1..n</code>. Therefore this expression is
	...
	/**
	 * Test if this expression is an AST list, which contains the given <b>header element</b> at index position <code>0</code> and some
	 * optional <b>argument elements</b> at the index positions <code>1..(size()-1)</code>. Therefore this expression is not an
	 ...
	 * optional <b>argument elements</b> at the index positions <code>1..(length-1)</code>. If this test gives <code>true</code> this
	 * expression is not an <b>atomic expression</b>.
	 * 
	 * @param header the header element at position 0, which should be tested
	 ...
	 * @param args   the arguments of this AST which should be tested, if they are equal, a <code>null</code> value argument skips the
	 *               equals check.
	 * @return
	 * @see #isAtom()
	 */
	 ...
	 * <code>1..(size()-1)</code>. If this test gives <code>true</code> this expression is not an <b>atomic expression</b>.
	 * </p>
	 * <p>
	 * Example: <code>isAST("Sin")</code> gives <code>true</code> for <code>Sin(Pi/2)</code>.
	 * </p>
	 * <p>
	 * <b>Note:</b> this is a performance critical method, only use it in special cases like for example UI handling etc.
	 * </p>
	 * 
	 ...
	 * <p>
	 * Test if this expression is an AST list, which contains a <b>header element</b> (i.e. the function name) at index position
	 * <code>0</code> and no <b>argument elements</b>. <br/>
	 ...
	 * <p>
	 * Test if this expression is an AST list, which contains a <b>header element</b> (i.e. the function name) at index position
	 * <code>0</code> and one <b>argument element</b> at the index position <code>1</code>.<br/>
	 * Therefore this expression is no <b>atomic expression</b>.
	 * </p>
	 * 
	 * @return
	 ...
	 * <p>
	 * Test if this expression is an AST list, which contains a <b>header element</b> (i.e. the function name) at index position
	 * <code>0</code> and two <b>argument elements</b> at the index positions <code>1, 2</code>.<br/>
	 * Therefore this expression is no <b>atomic expression</b>.
	 * </p>
	 * 
	 * @return
	 ...
	 * <p>
	 * Test if this expression is an AST list, which contains a <b>header element</b> (i.e. the function name) at index position
	 * <code>0</code> and three <b>argument elements</b> at the index positions <code>1, 2, 3</code>.<br/>
	 * Therefore this expression is no <b>atomic expression</b>.
	 * </p>
	 * 
	 * @return
	...
	/**
	 * Test if this expression is an AST list, which contains the given <b>header element</b> at index position <code>0</code> and
	 * optional <b>argument elements</b> at the index positions <code>1..n</code>. <code>n</code> must be greater equal than the given
	 * <code>length</code>.<br/>
	 * Therefore this expression is no <b>atomic expression</b>.
	 * 
	 * @param header the header element at position 0, which should be tested
	...
	/**
	 * Test if this expression is a symbol with attribute <code>Constant</code>. Therefore numbers return <code>false</code> for this
	 * method!
	 * 
	 * @return
	 * @see #isRealResult()
	...
	/**
	 * Test if this expression is a <code>IBuiltInSymbol</code> symbol and the evaluator implements <code>ICoreFunctionEvaluator</code>
	 * (see package <code>org.matheclipse.core.builtin.function</code>).
	 * 
	 * @return
	 */
	...
	/**
	 * <p>
	 * Test if this expression is a <code>Derivative[number][symbol][arg]</code> or <code>Derivative[number][symbol]</code> expression
	 * with one argument and return the corresponding <code>IAST</code> structures.
	 * <ul>
	 * <li>The expression at index <code>[0]</code> contains the <code>Derivative[number,...]</code> AST part.</li>
	 * <li>The expression at index <code>[1]</code> contains the <code>Derivative[...][symbol]</code> AST part.</li>
	...
	/**
	 * Test if this expression equals <code>E</code> (base of the natural logarithm; approximately equal to 2.71828...) in symbolic or
	 * numeric mode.
	 * 
	 * <br>
	...
	/**
	 * Test if this expression is an exact number. I.e. an instance of type <code>IRational</code> or <code>IComplex</code>.
	 * 
	 * @return
	 */
	 ...
	 * <code>Dot, Plus or Times</code>) with attribute <code>Flat</code> at index position <code>0</code> and some optional <b>argument
	 * elements</b> at the index positions <code>1..(size()-1)</code>. Examples for <code>Flat</code> functions are
	...
	/**
	 * Returns <code>true</code>, if <b>all of the elements</b> in the subexpressions or the expression itself, aren't ASTs with a head
	...
	/**
	 * Returns <code>true</code>, if <b>all of the elements</b> in the subexpressions or the expression itself, are no pattern objects.
	 * 
	...
	/**
	 * Compares this expression with the specified expression for order. Returns true if this expression is canonical greater than or
	...
	/**
	 * Compares this expression with the specified expression for order. Returns true if this expression is canonical greater than the
	...
	/**
	 * Test if this expression is the <code>HoldPattern</code> function <code>HoldPattern[&lt;expression&gt;]</code> or the deprecated
	 * <code>Literal[&lt;expression&gt;]</code> form.
	 * 
	 * @return
	 */
	...
	/**
	 * Test if this expression is an inexact number. I.e. an instance of type <code>INum</code> or <code>IComplexNum</code>.
	 * 
	 * @return
	 */
	...
	/**
	 * Test if this expression is a integer function (i.e. a number, a symbolic constant or an integer function where all arguments are
	 * also &quot;integer functions&quot;)
	 * 
	...
	/**
	 * Test if this expression is an interval expression with one <code>List[min, max]</code> argument <code>Interval[{min, max}]</code>
	 * 
	 * @return
	 */
	...
	/**
	 * Compares this expression with the specified expression for order. Returns true if this expression is canonical less than or equal
	 * to the specified expression (&lt;= relation).
	 * 
	 * @param expr an expression to compare with
	...
	/**
	 * Test if this expression is a machine-precision (Java double type) real or complex number. I.e. an instance of type
	 * <code>Num</code> or <code>ComplexNum</code>.
	 * 
	 * @return
	 */
	...
	/**
	 * Test if this expression is a matrix and return the dimensions as array [row-dimension, column-dimension]. This expression is only
	 * a matrix, if it is a <code>ASTRealMatrix</code> or a <code>List(...)</code> where all elements are lists with the header
	...
	/**
	 * Returns <code>true</code>, if <b>at least one of the elements</b> in the subexpressions, match the given pattern. By default
	 * <code>isMember()</code> only operates at level 1.
	 * 
	 * 
	 * @param pattern a pattern-matching expression
	 * 
	...
	/**
	 * Returns <code>true</code>, if <b>at least one of the elements</b> in the subexpressions, match the given pattern. If
	 * <code>visitor==null</code> the <code>isMember()</code> method only operates at level 1.
	 * 
	 * 
	 * @param pattern a pattern-matching expression
	 * @param heads   if set to <code>false</code>, only the arguments of an IAST should be tested and not the <code>Head[]</code>
	...
	/**
	 * Test if this object is a negative signed number. For an <code>IAST</code> object the method checks, if it is a numeric constant.
	 * If the <code>IAST</code> object evaluates to a negative numeric expression this method returns <code>true</code>.
	 * 
	...
	/**
	 * Check if the expression is a negative signed expression. This method is used in output forms of <code>Plus[...]</code>
	 * expressions.
	 * 
	...
	/**
	 * Test if this expression unequals <code>0</code> and is a numeric complex value or is assumed to be a negative or positive value.
	 * 
	 * @return
	 */
	...
	/**
	 * Test if this expression unequals <code>0</code> and is a numeric real value or is assumed to be a negative or positive value.
	 * 
	 * @return
	 */
	...
	/**
	 * Check if this expression equals an <code>IRational</code> value. The value of an <code>IInteger</code>, <code>IFraction</code> or
	 * the value of an <code>INum</code> object can be equal to <code>value</code>.
	 * 
	 * @param value
	 * @return
	 * @throws ArithmeticException
	...
	/**
	 * Test if this expression is a numeric number (i.e. an instance of type <code>INum</code> or type <code>IComplexNum</code>), an
	...
	/**
	 * Test if this expression is a numeric function (i.e. a number, a symbolic constant or a function (with attribute NumericFunction)
	 * where all arguments are also &quot;numeric functions&quot;)
	 * 
	...
	/**
	 * Test if this expression is an AST list, which contains a <b>header element</b> (i.e. a function symbol like for example
	 * <code>Plus or Times</code>) with attribute <code>OneIdentity</code> at index position <code>0</code> and exactly <b>one
	 * argument</b> at the index position <code>1</code>. Examples for <code>OneIdentity</code> functions are
	...
	/**
	 * Test if this expression is an AST list, which contains a <b>header element</b> (i.e. a function symbol like for example
	 * <code>Plus or Times</code>) with attribute <code>Orderless</code> at index position <code>0</code> and some optional <b>argument
	 * elements</b> at the index positions <code>1..n</code>. Examples for <code>Orderless</code> functions are
	 * <code>Plus[] or Times[]</code>. Therefore this expression is no <b>atomic expression</b>.
	 * 
	 * @return
	 * @see #isAtom()
	...
	/**
	 * Return <code>true</code>, if the expression is a pattern object with an associated default value (for example <code>0</code> is
	 * the default value for the addition expression <code>x_+y_.</code>)
	 * 
	 * @return
	 */
	...
	/**
	 * Test if this expression or a subexpression is a pattern object. Used in pattern-matching; checks flags in <code>IAST</code> with
	 * flag <code>IAST.CONTAINS_PATTERN_EXPR</code>.
	 * 
	 * @return
	 */
	...
	/**
	 * Return <code>true</code>, if the expression is a pattern object with an associated optional value (for example <code>value</code>
	 * is the default value for the expression <code>f[x_, y_:value]</code>)
	 * 
	 * @return
	 */
	...
	/**
	 * Test if this expression is a pattern sequence object <code>__</code> or null pattern sequence object <code>___</code>
	 * 
	...
	/**
	 * Test if this expression equals <code>Pi</code> (the ratio of a circle's circumference to its diameter, approx. 3.141592...) in
	...
	/**
	 * Test if this expression is the addition function <code>Plus[&lt;arg1&gt;, &lt;arg2&gt;, ...]</code> with at least 2 arguments.
	 * 
	 * @return
	 */
	 ...
	 * </p>
	 * <b>Note:</b> if the list contains no argument, this method returns <code>true</code> for a <code>Symbol</code> expression.
	 * 
	 ...
	 * </p>
	 * <b>Note:</b> if the variable is set to <code>null</code>, this method returns <code>true</code> for a <code>Symbol</code>
	 * expression.
	 * 
	...
	/**
	 * Test if this object is a positive signed number. For an <code>IAST</code> object the method checks, if it is a numeric constant.
	 * If the <code>IAST</code> object evaluates to a positive numeric expression this method returns <code>true</code>.
	 * 
	 * @return <code>true</code>, if <code>this > 0</code>; <code>false</code> in all other case.
	 */
	...
	/**
	 * <p>
	 * Test if this expression is the function <code>Power[&lt;arg1&gt;, -1]</code> (i.e. <code>1 / &lt;arg1&gt;</code>).
	 * </p>
	 * 
	...
	/**
	 * Return {@code true} if this expression unequals <code>F.NIL</code>, otherwise {@code false}. This method is similar to
	...
	/**
	 * Test if this expression is a rational function (i.e. a number, a symbolic constant or an rational function where all arguments
	 * are also &quot;rational functions&quot;)
	 * 
	...
	/**
	 * Test if this expression is a signed real number. I.e. an instance of type <code>IFraction</code> for exact number values or
	 * <code>INum</code> for approximated numbers.
	 * 
	 * @return
	 */
	...
	/**
	 * Test if this expression is a real matrix (i.e. an ASTRealMatrix) or a <code>List[List[...],...,List[...]]</code> matrix with
	 * elements of type <code>org.matheclipse.core.expression.Num</code>.
	 * 
	 * @return
	 */
	...
	/**
	 * Test if this expression is a number with no imaginary component. I.e. an instance of type <code>IRational</code> or
	 * <code>INum</code>.
	 * 
	 * @return
	...
	/**
	 * Test if this expression is a real vector (i.e. an ASTRealVector) or a <code>List[...]</code> with elements of type
	...
	/**
	 * Test if this expression equals the given expression. If the compared expressions are of the same numeric type, they are equal to
	 * a given EPSILON
	 * 
	 * @param expression
	 * @return
	 ...
	 * greater or equal <code>length</code>.
	 * 
	...
	/**
	 * Test if this expression is the function <code>Power[&lt;arg1&gt;, 1/2]</code> (i.e. <code>Sqrt[&lt;arg1&gt;]</code>).
	 * 
	 * @return
	 */
	...
	/**
	 * Test if this expression is the multiplication function <code>Times[&lt;arg1&gt;, &lt;arg2&gt;, ...]</code> with at least 2
	 * arguments.
	 * 
	 * @return
	 */
	 ...
	 * 
	 * @return <code>true</code> if the expression equals symbol <code>True</code> and <code>false</code> in all other cases
	 */
	...
	/**
	 * Returns <code>true</code>, if this symbol or ast expression is bound to a value (i.e. the evaluation returns an <i>assigned</i>
	 * value).
	 * 
	 * @return
	 */
	...
	/**
	 * Test if this expression is a vector and return the dimension of the vector. This expression is only a vector, if the expression
	 * is a <code>ASTRealVector</code> or a <code>List(...)</code> and no element is itself a <code>List(...)</code>.
	 * 
	...
	/**
	 * Get the last element of the <code>AST</code> list (i.e. get(size()-1). Return <code>F.NIL</code> if this object isn't an
	 * <code>AST</code>.
	 * 
	...
	/**
	 * Count the number of leaves of this expression; for integer numbers in exact integer, fractional and complex numbers count the
	 * digits of the integers. This function is used in <code>Simplify</code> as the default &quot;complexity function&quot;.
	 * 
	 * @return
	 */
	...
	/**
	 * Multiply <code>this * that</code>. If oneof the arguments is a <code>Plus</code> expression, distribute the other expression
	 * other <code>Plus</code>.
	 * 
	 * @param that
	 * @return
	 */
	...
	/**
	 * Returns an <code>IExpr</code> whose value is <code>(-1) * this</code>. Calculates <code>F.eval(F.Times(F.CN1, this))</code> in
	...
	/**
	 * The <code>ExprNull.NIL#optional()</code> method always returns <code>that</code>. All other objects which implement this method
	 * returns <code>that</code> if <code>that!=null</code> or <code>this</code> if <code>that==null</code>
	 * 
	 * @param that
	...
	/**
	 * Return <code>this</code> if <code>this</code> unequals <code>F.NIL</code> , otherwise invoke {@code other} and return the result
	 * of that invocation.
	 *
	 * @param other a {@code Supplier} whose result is returned if no value is present
	 * @return <code>this</code> if <code>this</code> unequals <code>F.NIL</code>, otherwise the result of {@code other.get()}
	 */
	...
	/**
	 * Return <code>this</code> if <code>this</code> unequals <code>F.NIL</code> , otherwise throw an exception to be created by the
	 * provided supplier.
	 *
	...
	/**
	 * Return <code>this</code> if <code>isList()==true</code>, otherwise create a new list <code>{this}</code> from this (i.e. return
	 ...
	 * which satisfy the predicate to the <code>1st element</code> of the resulting AST, or otherwise append it to the
	 * <code>2nd element</code> of the resulting AST.
	 * </p>
	 * <p>
	 * See: <a href= "https://people.eecs.berkeley.edu/~fateman/papers/partition.pdf">Fateman - Partitioning of Algebraic Subexpressions
	 * in Computer Algebra Systems</a>
	 * </p>
	 * 
	 ...
	 * @param initTrue  the result for the 1st result element, if the predicate doesn't give <code>true</code> for any of the arguments
	 *                  in this AST.
	 * @param initFalse the result for the 2nd result element, if the predicate doesn't give <code>false</code> for any of the arguments
	 *                  in this AST.
	...
	/**
	 * <p>
	 * Select all elements by applying the <code>predicate</code> to each argument in this <code>Plus(...)</code> expression and append
	 * the arguments which satisfy the predicate to the <code>1st element</code> of the resulting AST, or otherwise append it to the
	 * <code>2nd element</code> of the resulting AST.
	 * </p>
	 * <p>
	 * See: <a href= "https://people.eecs.berkeley.edu/~fateman/papers/partition.pdf">Fateman - Partitioning of Algebraic Subexpressions
	...
	/**
	 * <p>
	 * Select all elements by applying the <code>predicate</code> to each argument in this <code>Times(...)</code> expression and append
	 * the arguments which satisfy the predicate to the <code>1st element</code> of the resulting AST, or otherwise append it to the
	 * <code>2nd element</code> of the resulting AST.
	 * </p>
	 * <p>
	...
	/**
	 * Returns an <code>IExpr</code> whose value is <code>(this + that)</code>. Calculates <code>F.eval(F.Plus(this, that))</code> in
	 * the common case and uses a specialized implementation for derived number classes.
	 * 
	 * @param that
	 * @return
	...
	/**
	 * Returns an <code>IExpr</code> whose value is <code>(this ^ that)</code>. Calculates <code>F.eval(F.Power(this, that))</code> in
	 * the common case and uses a specialized implementation for derived number classes.
	 * 
	 * @param that
	...
	/**
	 * Returns an <code>IExpr</code> whose value is <code>(this ^ n)</code>. Calculates <code>F.eval(F.Power(this, that))</code> in the
	 * common case and uses a specialized implementation for derived number classes.
	 * 
	...
	/**
	 * Replace all (sub-) expressions with the given unary function, if the given predicate yields <code>true</code>. If no substitution
	 * matches, the method returns <code>this</code>.
	 * 
	 * @param predicate
	 * @param function  if the unary functions <code>apply()</code> method returns <code>F.NIL</code> the expression isn't substituted.
	...
	/**
	 * Replace all (sub-) expressions with the given unary function. If no substitution matches, the method returns <code>F.NIL</code>.
	 * 
	 * @param function if the unary functions <code>apply()</code> method returns <code>F.NIL</code> the expression isn't substituted.
	...
	/**
	 * Replace all (sub-) expressions with the given rule set. If no substitution matches, the method returns <code>F.NIL</code>.
	 * 
	 * @param astRules rules of the form <code>x-&gt;y</code> or <code>{a-&gt;b, c-&gt;d}</code>; the left-hand-side of the rule can
	...
	/**
	 * Replace all (sub-) expressions with the given <code>java.util.Map</code>n. If no substitution matches, the method returns
	 * <code>F.NIL</code>.
	 * 
	 * @param map if the maps <code>get()</code> method returns <code>F.NIL</code> the expression isn't substituted.
	 * @return <code>F.NIL</code> if no substitution of a (sub-)expression was possible.
	 */
	@Nullable
	 ...
	 * replaced on the left-hand-side. If no substitution matches, the method returns <code>F.NIL</code>.
	 * 
	...
	/**
	 * <p>
	 * Replace all occurrences of Slot[&lt;index&gt;] expressions with the expression at the appropriate <code>index</code> in the given
	 * <code>slotsList</code>.
	 * </p>
	 * <p>
	...
	/**
	 * Get the rest of the elements of this <code>AST</code> list. Return <code>F.NIL</code> if this object isn't an <code>AST</code>.
	 * 
	...
	/**
	 * Returns the <b>number of elements</b> in this {@code IAST}.The <b>number of elements</b> equals <code>argSize() + 1</code> (i.e.
	 * the <b>number of arguments</b> plus 1). If this is an atom return size <code>0</code>.
	 * 
	...
	/**
	 * Returns an <code>IExpr</code> whose value is <code>(this * that)</code>. Calculates <code>F.eval(F.Times(this, that))</code> in
	 * the common case and uses a specialized implementation for derived number classes.
	 * 
	...
	/**
	 * Converts this number to an <code>int</code> value; unlike {@link #intValue} this method returns <code>defaultValue</code> if the
	 * value of this integer isn't in the range <code>Integer.MIN_VALUE</code> to <code>Integer.MAX_VALUE</code> or the expression is
	 * not convertible to the int range.
	 * 
	...
	/**
	 * Return <code>0</code> if this is less than <code>0</code>. Return <code>1</code> if this is greater equal than <code>0</code>.
	 * Return <code>F.UnitStep(this)</code> for all other cases.
	 * 
	 * @return
	 */
	...
	/**
	 * Convert the variables (i.e. expressions of type <code>ISymbol</code> which aren't constants) in this expression into Slot[] s.
	 * 
