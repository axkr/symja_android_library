...
public class BoxesTest extends AbstractTestCase {
  ...
  public void testMakeBoxes001() {
    check(
        "MakeBoxes[Beta[a, b], StandardForm] // InputForm", //
