...
public class Examples {
  ...
  public static void example2() {
    ...
    //  ab+ac+db+dc   ->  (a+d)(b+c)
    GenPolynomial<BigInteger> tmp =
        (vars.get(0).multiply(vars.get(1)))
            .sum(vars.get(0).multiply(vars.get(2)))
            .sum(vars.get(3).multiply(vars.get(1)))
  ...
  public static void example9() {
    ...
    // PartialFraction<BigRational> Fa =
    // engine.baseAlgebraicPartialFractionIrreducibleAbsolute(N,D);
    // System.out.println("\nintegral_a " + Fa);
  ...
  public static void example10() {
    ...
    GenPolynomialRing<AlgebraicNumber<Quotient<AlgebraicNumber<BigRational>>>> apqfac =
        new GenPolynomialRing<AlgebraicNumber<Quotient<AlgebraicNumber<BigRational>>>>(
            axfac, 1, to, var_y);
    ...
    FactorAbstract<AlgebraicNumber<Quotient<AlgebraicNumber<BigRational>>>> engine =
        FactorFactory.getImplementation(axfac);
    System.out.println("engine = " + engine);

    SortedMap<GenPolynomial<AlgebraicNumber<Quotient<AlgebraicNumber<BigRational>>>>, Long> F =
        engine.factors(f);
