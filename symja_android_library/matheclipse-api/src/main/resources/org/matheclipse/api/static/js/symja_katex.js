/**
    ...
    One place for the KaTeX settings of the pods page.

    Kept in step with matheclipse-io/src/main/resources/public/media/js/symja_katex.js. The two
    web front ends are served from different modules and cannot share a file, but both render the
    output of the same TeXFormFactory and so need the same macros for the commands it emits that
    KaTeX does not know.
**/
