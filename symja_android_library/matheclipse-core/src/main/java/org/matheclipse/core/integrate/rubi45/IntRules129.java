...
ISetDelayed(Int(Times(Power(FresnelC(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT),Sin(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_))))),x_Symbol),
    Condition(Unintegrable(Times(Power(FresnelC(Plus(a,Times(b,x))),n),Sin(Plus(c,Times(d,Sqr(x))))),x),FreeQ(List(a,b,c,d,n),x))),
ISetDelayed(Int(Times(x_,FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(Int(Times(x_,Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_),FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Power(FresnelS(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT),Sin(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Cos(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(FresnelC(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(x_,Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(x_,FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_),FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Cos(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(FresnelS(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Power(FresnelC(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT),Sin(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_))))),x_Symbol),
...
ISetDelayed(Int(FresnelS(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
ISetDelayed(Int(FresnelC(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),FresnelS(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),FresnelC(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(d_DEFAULT,x_),m_),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(d_DEFAULT,x_),m_DEFAULT),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralE(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,-1),ExpIntegralEi(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1),ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Unintegrable(Times(ExpIntegralEi(Plus(a,Times(b,x))),Power(Plus(c,Times(d,x)),-1)),x),FreeQ(List(a,b,c,d),x))),
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Power(x_,m_DEFAULT),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Power(x_,m_),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,-1),ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
    Condition(Dist(Power(n,-1),Subst(ExpIntegralEi(Times(d,Plus(a,Times(b,x)))),x,Log(Times(c,Power(x,n)))),x),FreeQ(List(a,b,c,d,n),x))),
ISetDelayed(Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1),LogIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Unintegrable(Times(LogIntegral(Plus(a,Times(b,x))),Power(Plus(c,Times(d,x)),-1)),x),FreeQ(List(a,b,c,d),x))),
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),LogIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
