...
public class RealAlgebraicRing<C extends GcdRingElem<C> & Rational>
  ...
  /** Isolating interval for a real root. <b>Note: </b> interval may shrink eventually. */
  ...
  /**
   * The constructor creates a RealAlgebraicNumber factory object from a GenPolynomial objects
   * module.
   *
  ...
  /**
   * Get the interval for the real root. <b>Note:</b> interval may shrink later.
   *
  ...
  /**
   * Set a refined interval for the real root. <b>Note: </b> interval may shrink eventually.
   *
   * @param v interval.
   */
