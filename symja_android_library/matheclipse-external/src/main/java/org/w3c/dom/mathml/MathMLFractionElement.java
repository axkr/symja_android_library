...
/**
 * This interface extends the MathMLPresentationElement interface for the MathML fraction element
 * mfrac.
 */
public interface MathMLFractionElement extends MathMLPresentationElement {
   ...
   *
   * @param linethickness new value for linethickness.
   * @see #getLinethickness()
   */
  void setLinethickness(String linethickness);

  /**
   * One of the strings left, center and right. Represents the numalign attribute of the mfrac, if
   * specified.
   *
   ...
   *
   * @param numalign new value for numalign.
   * @see #getNumalign()
   */
  void setNumalign(String numalign);

  /**
   * One of the strings left, center and right. Represents the denomalign attribute of the mfrac, if
   * specified.
   *
   ...
   *
   * @param denomalign new value for denomalign.
   * @see #getDenomalign()
   */
  void setDenomalign(String denomalign);

  /**
   * One of the strings true and false. Represents the bevelled attribute of the mfrac, if
   * specified.
   *
   ...
   *
   * @param bevelled new value for bevelled.
   * @see #getBevelled()
   */
  void setBevelled(String bevelled);

  /**
   * The first child MathMLElement of the MathMLFractionElement; represents the numerator of the
   ...
   *
   * @param numerator new value for numerator.
   * @see #getNumerator()
   */
  void setNumerator(MathMLElement numerator);

  /**
   * The second child MathMLElement of the MathMLFractionElement; represents the denominator of the
   * represented fraction.
   *
   ...
   *
   * @param denominator new value for denominator.
   * @see #getDenominator()
   */
