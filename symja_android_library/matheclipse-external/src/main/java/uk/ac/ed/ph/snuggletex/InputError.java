 ...
 * it occurred.
 *
 * <p>See the {@link MessageFormatter} for methods formatting instances of this class in various
 * ways.
 *
 * @author David McKain
...
public final class InputError {
  ...
  /**
   * Any additional arguments about the error. These are passed to {@link MessageFormatter} when
   * formatting errors in a readable form.
   */
  ...
  /**
   * Returns the {@link FrozenSlice} indicating where the error occurred in the original {@link
   * SnuggleInput}.
   */
