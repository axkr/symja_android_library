...
public class SingleBlockHybridSieveU implements Sieve {
  ...
  public List<Integer> sieve() {
    ...
    for (int b = 0;
      ...
      sieveXBlock(
          pArray, logPArray, xPosArray, dPosArray, effectiveBlockSize, pMinIndex, r_s, p3Index);
      if (ANALYZE) sieveDuration += timer.capture();
    ...
    for (int b = 0;
      ...
      // pMinIndex + " ... " + r_s + " ... " + p3Index);
      sieveXBlock(
          pArray, logPArray, xNegArray, dNegArray, effectiveBlockSize, pMinIndex, r_s, p3Index);
      if (ANALYZE) sieveDuration += timer.capture();
  ...
  /**
   * Sieve a single block. This method is used to sieve inner and outer blocks, positive and
   * negative x.
   *
   * @param primesArray
   * @param logPArray
