  ...
  public static IAST RULES =
      List(
              ...
              Condition(
                  Dist(
                      ...
                      Subst(
                          Integrate(
                              Times(
                                  Power(Plus(a, Times(b, x)), n), Power(Cos(x),
                                      Plus(Times(C2, p), C1))),
                              x),
                          x, ArcSin(Times(c, x))),
                      x),
                  And(FreeQ(List(a, b, c, d, e, n), x), EqQ(Plus(Times(Sqr(c), d),
                      e), C0), IGtQ(Times(C2, p),
                          C0),
                  ...
                  Negate(
                      Dist(
                          ...
                          Subst(
                              ...
                              x, ArcCos(Times(c, x))),
                          x)),
                  And(FreeQ(List(a, b, c, d, e, n), x), EqQ(Plus(Times(Sqr(c),
                      d), e), C0), IGtQ(Times(C2,
                          p), C0),
                      Or(IntegerQ(p), GtQ(d, C0))))),
          IIntegrate(4663,
              Integrate(
                      ...
                      Subtract(Dist(Plus(a, Times(b, ArcSin(Times(c, x)))), u, x),
                          Dist(Times(b, c),
                              Integrate(SimplifyIntegrand(
                                  ...
                                  x),
                              x))),
                  And(FreeQ(List(a, b, c, d, e), x), NeQ(Plus(Times(Sqr(c), d), e), C0),
          ...
          IIntegrate(4667,
              ...
              Condition(
                  Integrate(
                      ExpandIntegrand(Power(Plus(a, Times(b, ArcSin(Times(c, x)))), n),
                          Power(Plus(d, Times(e, Sqr(x))), p), x),
                      x),
                  And(FreeQ(List(a, b, c, d, e, n), x), NeQ(Plus(Times(Sqr(c), d), e), C0),
                      IntegerQ(p), Or(GtQ(p, C0), IGtQ(n, C0))))),
          IIntegrate(4668,
              Integrate(
                  Times(
                      Power(
          ...
          IIntegrate(4672,
              ...
              Condition(
                  ...
                  And(FreeQ(List(a, b, c, d, e, f, g, n), x),
                      EqQ(Plus(Times(e, f), Times(d, g)), C0),
                      EqQ(Subtract(Times(Sqr(c), Sqr(d)), Sqr(e)), C0), HalfIntegerQ(p,
                          q),
                      GeQ(Subtract(p, q), C0), GtQ(d, C0), LtQ(Times(g, Power(e, CN1)), C0)))),
          IIntegrate(4673,
              Integrate(
                  Times(
                      Power(
              ...
              Condition(
                  Dist(
                      Times(
                          Power(Plus(d, Times(e, x)), q), Power(Plus(f, Times(g, x)), q), Power(
                              Power(Subtract(C1, Times(Sqr(c), Sqr(x))), q), CN1)),
                      Integrate(
                          Times(Power(Plus(d, Times(e, x)), Subtract(p, q)),
          ...
          IIntegrate(4675,
              ...
              Condition(
                  Negate(
                      Dist(Power(e, CN1),
                          Subst(Integrate(Times(Power(Plus(a, Times(b, x)), n), Tan(x)), x), x,
                              ArcSin(Times(c, x))),
                          x)),
          ...
          IIntegrate(4676,
              ...
              Condition(
                  Dist(Power(e, CN1),
                      Subst(
                          Integrate(Times(Power(Plus(a, Times(b, x)), n), Cot(x)),
                              x),
                          x, ArcCos(Times(c, x))),
                      x),
                      ...
                      Dist(
                          Times(b, n, Power(d, IntPart(p)),
                              ...
                              Power(
                                  ...
                                  CN1)),
                          Integrate(
                              Times(Power(Subtract(C1, Times(Sqr(c), Sqr(x))), Plus(p, C1D2)),
          ...
          IIntegrate(4678,
              Integrate(
                  Times(Power(Plus(a_DEFAULT,
                      Times(ArcCos(Times(c_DEFAULT, x_)), b_DEFAULT)), n_DEFAULT), x_, Power(
                  ...
                  Negate(
                      Dist(Power(d, CN1),
                          Subst(Integrate(Times(Power(Plus(a, Times(b, x)), n),
                              Power(Times(Cos(x), Sin(x)), CN1)), x), x, ArcCos(Times(c, x))),
                          x)),
                  And(FreeQ(List(a, b, c, d, e), x), EqQ(Plus(Times(Sqr(c), d), e), C0),
                      IGtQ(n, C0)))));
}
