 ...
 * 
 * The main reason why Montgomery multiplication is helpful for Pollard-Rho is that no conversions to/from Montgomery
 * form are required.
 * 
...
public class PollardRhoBrentMontgomery63 extends FactorAlgorithmBase {
	...
	public long findSingleFactor(long N) {
		...
		// Brent: "The probability of the algorithm failing because q_i=0 increases, so it is best not to choose m too
		// large"
		final int m = 100;
	 ...
	 * 
	 * EEA63 would not work with R=2^63 because R overflows positive longs. But the algorithm from
	 * http://coliru.stacked-crooked.com/a/f57f11426d06acd8 (which refers to "hackers delight") can deal with R=2^63.
	 */
	...
	/**
	 * Montgomery multiplication modulo N, using reducer R=2^63. Inputs and output are in Montgomery form and in the
	 * range [0, N).
	 * 
	 * @param a
	 * @param b
...
//		}
	...
	/**
	 * Test. Test numbers: 3225275494496681 (52 bits) = 56791489 * 56791529 322527333642009919 (59 bits) = 567914891 *
	 * 567914909 3225273260887418687 (62 bits) = 567914891 * 5679148957
	 * 
	 * @param args
	 *            ignored
	 */
