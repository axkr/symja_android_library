...
public class AST2Expr {
	...
	private final static String[] FUNCTION_STRINGS = { "ComplexInfinity", "DirectedInfinity", "False", "Flat", "HoldAll", "HoldFirst", "HoldRest",
			...
			"Riffle", "RootIntervals", "Roots", "RotateLeft", "RotateRight", "Round", "RowReduce", "Rule", "RuleDelayed", "SameQ",
			"Scan", "Sec", "Sech", "Select", "Set", "SetAttributes", "SetDelayed", "Show", "Sign", "SignCmp", "Simplify", "Sin",
