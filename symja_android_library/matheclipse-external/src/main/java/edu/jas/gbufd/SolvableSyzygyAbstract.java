...
public abstract class SolvableSyzygyAbstract<C extends GcdRingElem<C>>
   ...
   * @return leftSyz(F), a basis for the left module of syzygies for F.
   */
  public List<List<GenSolvablePolynomial<C>>> leftZeroRelations(
      int modv, List<GenSolvablePolynomial<C>> F) {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<List<GenSolvablePolynomial<C>>> rightZeroRelations(
      int modv, List<GenSolvablePolynomial<C>> F) {
   ...
   */
  public boolean isLeftZeroRelation(
      List<List<GenSolvablePolynomial<C>>> Z, List<GenSolvablePolynomial<C>> F) {
   ...
   */
  public boolean isRightZeroRelation(
      List<List<GenSolvablePolynomial<C>>> Z, List<GenSolvablePolynomial<C>> F) {
    List<GenPolynomial<C>> Fp = PolynomialList.<C>castToList(F);
    for (List<GenSolvablePolynomial<C>> row : Z) {
   ...
   */
  public List<List<GenSolvablePolynomial<C>>> leftZeroRelationsArbitrary(
   ...
   * @return syz(F), a basis for the module of right syzygies for F.
   */
  public List<List<GenSolvablePolynomial<C>>> rightZeroRelationsArbitrary(
      List<GenSolvablePolynomial<C>> F) {
  ...
  public ModuleList<C> rightZeroRelationsArbitrary(ModuleList<C> M) {
    ...
    logger.info("modv = " + modv);
    List<List<GenSolvablePolynomial<C>>> G =
        rightZeroRelationsArbitrary(modv, F.castToSolvableList());
    // if (G == null) {
    //    return N;
    // }
    List<List<GenSolvablePolynomial<C>>> Z = new ArrayList<List<GenSolvablePolynomial<C>>>();
   ...
   */
  public boolean isLeftOreCond(
      GenSolvablePolynomial<C> a, GenSolvablePolynomial<C> b, GenSolvablePolynomial<C>[] oc) {
   ...
   */
  public abstract GenSolvablePolynomial<C>[] leftSimplifier(
  ...
  public int compare(
    ...
    if (debug) {
      System.out.println(
          "oc[0] den =<>= oc[1] d: (" + oc[0] + ") (" + den + ") = (" + oc[1] + ") (" + d + ")");
    }
