  ...
  public void test002() {
    ...
    assertEquals(
        ...
        "## Im\n"
            ...
            + "### Github\n"
            + "\n"
            + "* [Implementation of Im](https://github.com/axkr/symja_android_library/blob/master/symja_android_library/matheclipse-core/src/main/java/org/matheclipse/core/builtin/Arithmetic.java#L2217) \n"
            + "");
  }
}
