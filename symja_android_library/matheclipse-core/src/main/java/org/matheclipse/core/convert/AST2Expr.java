...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"All", "AllowedHeads", "AllowShortContext",
      ...
      "DegreeReverseLexicographic", "DigitCharacter", "DirectedEdges", "DisplayFunction",
      "Disputed", "DistanceFunction", "DotDashed", "Dotted", "EdgeLabels", "EdgeShapeFunction",
      "EdgeStyle", "EliminationOrder", "EndOfFile", "EndOfLine", "EndOfString", "EulerGamma",
      "Expression", "Extension", "False", "Filling", "FillingStyle", "Flat", "Float", "Full",
      "GaussianIntegers", "General", "Glaisher", "GoldenAngle", "GoldenRatio", "Gray", "Green",
      ...
      "LabelingFunction", "LabelingSize", "Large", "Left", "LetterCharacter", "Lexicographic",
      "Lighting", "LightBlue", "LightBrown", "LightCyan", "LightGray", "LightGreen", "LightMagenta",
      "LightOrange", "LightPink", "LightPurple", "LightRed", "LightYellow", "Listable", "Locked",
      "LongForm", "Magenta", "Matrices", "MaxIterations", "MaxPoints", "Mesh", "Medium", "Method",
      ...
      "OneIdentity", "Orange", "Orderless", "Overlaps", "Pi", "Pink", "PlotLegends", "PlotRange",
      ...
      "SequenceHold", "SetSystemOptions", "Small", "SystemOptions", "Slot", "SlotAbsent",
      "SlotSequence", "StaticsVisible", "StartOfLine", "StartOfString", "Strict", "String",
      "Symbol", "TableAlignments", "TableDepth", "TableDirections", "TableHeadings", "TableSpacing",
      "TestID", "Ticks", "Tiny", "TicksStyle", "Today", "TooLarge", "Top", "Trig", "True",
      "Unknown", "UseTypeChecking", "Variable", "Vectors", "VertexLabels", "VertexShapeFunction",
      "VertexSize", "VertexStyle", "ViewPoint", "White", "Whitespace", "WhitespaceCharacter",
      "Word", "WordCharacter", "WordSeparators", "Yellow", "ZeroTest"};
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "Dimensions", "DiracDelta", "DirectionalLight", "DirichletEta", "DiscreteDelta",
      "DiscretePlot", "DiscreteUniformDistribution", "DirectedEdge", "DirectedInfinity",
      ...
      "DownValues", "Drop", "DuplicateFreeQ", "Dynamic", "DSolve", "Dt", "EasterSunday", "Echo",
      "EchoFunction", "EdgeCount", "EdgeForm", "EdgeList", "EdgeRules", "EdgeQ", "EdgeWeight",
      "EditDistance", "EffectiveInterest", "Eigenvalues", "EigenvectorCentrality", "Eigenvectors",
      "Element", "ElementData", "Eliminate", "Ellipsoid", "EllipticE", "EllipticF", "EllipticK",
      "EllipticPi", "EllipticTheta", "End", "EndPackage", "EndTestSection", "Entity", "Entropy",
      "Equal", "EqualTo", "Equivalent", "Erf", "Erfc", "Erfi", "ErlangDistribution",
      ...
      "ExponentialDistribution", "ExpIntegralE", "ExpIntegralEi", "Exponent", "Export",
      "ExportString", "ExpToTrig", "ExtendedGCD", "Extract", "Factor", "Factorial",
      ...
      "File", "FileFormat", "FileNameJoin", "FilePrint", "FileNameTake", "FileNames", "FilterRules",
      "FindClusters", "FindCycle", "FindEulerianCycle", "FindEdgeCover", "FindFit",
      ...
      "InterpolatingPolynomial", "InterquartileRange", "IntersectingQ", "Interrupt", "Intersection",
      ...
      "ListStreamPlot", "ListVectorPlot", "ListPlot3D", "ListPointPlot3D", "ListPolarPlot", "ListQ",
      "Literal", "LoadJavaClass", "Log", "Log2", "Log10", "LogGamma", "LogNormalDistribution",
      "LogPlot", "LogLinearPlot", "LogLogPlot", "LogicalExpand", "LogisticSigmoid", "LogIntegral",
      ...
      "NumberQ", "Numerator", "NumericalOrder", "NumericArray", "NumericArrayQ", "NumericArrayType",
      "NumericQ", "NuttallWindow", "Octahedron", "OddQ", "Off", "On", "Opacity", "OpenAppend",
      ...
      "SatisfiabilityCount", "SatisfiabilityInstances", "SatisfiableQ", "Scale", "Scaled",
      ...
      "ToRadicals", "ToString", "Total", "ToIntervalData", "ToLowerCase", "ToUnicode",
      "ToUpperCase", "Tr", "Trace", "TraceForm", "TraditionalForm", "TransformationFunction",
      "TranslationTransform", "Transliterate", "Transpose", "TreeForm", "Triangle", "TrigExpand",
      "TrigReduce", "TrigSimplifyFu", "TrigToExp", "TrueQ", "TTest", "TukeyWindow", "Tube",
      "Tuples", "TwoWayRule", "Undefined", "Underflow", "Underscript", "UnderscriptBox",
      "Underoverscript", "UnderoverscriptBox", "UndirectedEdge", "Unequal", "UnequalTo",
      ...
      "UpValues", "URLFetch", "ValueQ", "Values", "VandermondeMatrix", "Variables", "Variance",
      "VectorAngle", "VectorGreater", "VectorGreaterEqual", "VectorLess", "VectorLessEqual",
      "VectorPlot", "VectorQ", "Verbatim", "VertexEccentricity", "VertexList", "VerificationTest",
      "VertexQ", "Volume", "WeaklyConnectedGraphQ", "WeberE", "WeibullDistribution",
