...
/**
 * CFrac = Shanks' SQUFOF algorithm + carry along continuant recurrence + collect smooth relations +
 * LinAlg solver.<br>
 * <br>
 * The original CFrac was implemented by Morrison&Brillhart intending to factor the 7.th Fermat
 * number F7 with 39 digits (~130 bits). Now this number can be factored in about three seconds.
 *
 * <p>Stopping criterion for a single k: after complete period or at a maximum number of iterations.
 *
 * <p>Since 2017-09 Knuth-Schroeppel multipliers have been implemented, too.
 *
...
public class CFrac extends FactorAlgorithm {
  ...
  private static void testInput() {
    CFrac cfrac =
        new CFrac(
            true, 5, 1.5F, 0.152F, 0.253F, new TDiv_CF02(), 10, new MatrixSolver01_Gauss(), 5);
   ...
   * Standalone test.
   *
   * <p>Test numbers: F7 = 340282366920938463463374607431768211457
   *
   * @param args ignored
   */
