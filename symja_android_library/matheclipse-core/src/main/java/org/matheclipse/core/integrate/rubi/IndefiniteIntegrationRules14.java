...
SetDelayed(Int(CosIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(CosIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),C2),x_Symbol),
...
SetDelayed(Int(Times(CosIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(CosIntegral(Times(b_DEFAULT,x_)),C2),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(CosIntegral(Plus(Times(b_DEFAULT,x_),a_)),C2),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(CosIntegral(Plus(Times($p(d,true),x_),c_DEFAULT)),Sin(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(CosIntegral(Plus(Times($p(d,true),x_),c_DEFAULT)),Power(x_,m_DEFAULT),Sin(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(CosIntegral(Plus(Times($p(d,true),x_),c_DEFAULT)),Power(x_,m_),Sin(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(Cos(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CosIntegral(Plus(Times($p(d,true),x_),c_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(Cos(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CosIntegral(Plus(Times($p(d,true),x_),c_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(SinhIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(SinhIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),C2),x_Symbol),
...
SetDelayed(Int(Times(Power(x_,m_DEFAULT),SinhIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(Power(SinhIntegral(Times(b_DEFAULT,x_)),C2),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(SinhIntegral(Plus(Times(b_DEFAULT,x_),a_)),C2),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Sinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),SinhIntegral(Plus(Times($p(d,true),x_),c_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(Power(x_,m_DEFAULT),Sinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),SinhIntegral(Plus(Times($p(d,true),x_),c_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(Power(x_,m_),Sinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),SinhIntegral(Plus(Times($p(d,true),x_),c_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(Cosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),SinhIntegral(Plus(Times($p(d,true),x_),c_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(Cosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT),SinhIntegral(Plus(Times($p(d,true),x_),c_DEFAULT))),x_Symbol),
...
SetDelayed(Int(CoshIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(CoshIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),C2),x_Symbol),
...
SetDelayed(Int(Times(CoshIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(CoshIntegral(Times(b_DEFAULT,x_)),C2),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(CoshIntegral(Plus(Times(b_DEFAULT,x_),a_)),C2),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(CoshIntegral(Plus(Times($p(d,true),x_),c_DEFAULT)),Sinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(CoshIntegral(Plus(Times($p(d,true),x_),c_DEFAULT)),Power(x_,m_DEFAULT),Sinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(CoshIntegral(Plus(Times($p(d,true),x_),c_DEFAULT)),Power(x_,m_),Sinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(Cosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CoshIntegral(Plus(Times($p(d,true),x_),c_DEFAULT))),x_Symbol),
...
SetDelayed(Int(Times(Cosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CoshIntegral(Plus(Times($p(d,true),x_),c_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(LogIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(LogIntegral(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Gamma(n_,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Gamma(n_,Times(a_DEFAULT,x_)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Gamma(n_,Times(a_,x_)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Gamma(n_,Plus(Times(b_DEFAULT,x_),a_)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(LogGamma(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
    Condition(Times(PolyGamma(CN2,Plus(a,Times(b,x))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Times(LogGamma(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(PolyGamma(n_,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
    Condition(Times(PolyGamma(Plus(n,Times(CN1,C1)),Plus(a,Times(b,x))),Power(b,CN1)),FreeQ(List(a,b,n),x))),
SetDelayed(Int(Times(PolyGamma(n_,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(PolyGamma(C0,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(Gamma(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),n_DEFAULT)),x_Symbol),
    Condition(Times(Power(Gamma(Plus(a,Times(b,x))),n),Power(Times(b,n),CN1)),FreeQ(List(a,b,n),x))),
SetDelayed(Int(Times(PolyGamma(C0,Plus(Times(b_DEFAULT,x_),c_DEFAULT)),Power(Factorial(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),n_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Zeta(C2,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
    Condition(Int(PolyGamma(C1,Plus(a,Times(b,x))),x),FreeQ(List(a,b),x))),
SetDelayed(Int(Zeta(s_,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(x_,m_DEFAULT),Zeta(C2,Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
    Condition(Int(Times(Power(x,m),PolyGamma(C1,Plus(a,Times(b,x)))),x),And(FreeQ(List(a,b),x),RationalQ(m)))),
SetDelayed(Int(Times(Power(x_,m_DEFAULT),Zeta(s_,Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
...
SetDelayed(Int(PolyLog(n_,Times(Power(Times(Power(x_,p_DEFAULT),b_DEFAULT),q_DEFAULT),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(PolyLog(n_,Times(Power(Times(Power(x_,p_DEFAULT),b_DEFAULT),q_DEFAULT),a_DEFAULT)),Power(x_,CN1)),x_Symbol),
    Condition(Times(PolyLog(Plus(n,C1),Times(a,Power(Times(b,Power(x,p)),q))),Power(Times(p,q),CN1)),FreeQ(List(a,b,n,p,q),x))),
SetDelayed(Int(Times(PolyLog(n_,Times(Power(Times(Power(x_,p_DEFAULT),b_DEFAULT),q_DEFAULT),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(PolyLog(n_,u_),Power(Plus(Times(b_DEFAULT,x_),a_),CN1)),x_Symbol),
...
SetDelayed(Int(PolyLog(n_,Times(Power(Plus(Times(b_DEFAULT,x_),a_DEFAULT),p_DEFAULT),c_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(PolyLog(n_,Times(Power(Plus(Times(b_DEFAULT,x_),a_DEFAULT),p_DEFAULT),c_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(PolyLog(q_,Times(Power(x_,m_DEFAULT),b_DEFAULT)),Power(Log(Times(Power(x_,n_DEFAULT),a_DEFAULT)),p_DEFAULT),Power(x_,CN1)),x_Symbol),
...
SetDelayed(Int(Power(ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),p_DEFAULT),x_Symbol),
...
SetDelayed(Int(Power(ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),p_),x_Symbol),
...
SetDelayed(Int(Power(Plus(C1,ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),CN1),x_Symbol),
    Condition(Times(Plus(a,Times(b,x)),Power(Times(b,ProductLog(Plus(a,Times(b,x)))),CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),CN1),ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
    Condition(Plus(x,Times(CN1,Int(Power(Plus(C1,ProductLog(Plus(a,Times(b,x)))),CN1),x))),FreeQ(List(a,b),x))),
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),CN1),Power(ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CN1)),x_Symbol),
    Condition(Times(ExpIntegralEi(ProductLog(Plus(a,Times(b,x)))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),CN1),Power(ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CN1D2)),x_Symbol),
    Condition(Times(Sqrt(Pi),Erfi(Sqrt(ProductLog(Plus(a,Times(b,x))))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),CN1),Power(ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),p_)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),CN1),Power(ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),p_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(ProductLog(Times(a_DEFAULT,x_)),p_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(ProductLog(Plus(Times(b_DEFAULT,x_),a_)),p_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Times(a_DEFAULT,x_))),CN1),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Plus(Times(b_DEFAULT,x_),a_))),CN1),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Times(a_DEFAULT,x_))),CN1),Power(ProductLog(Times(a_DEFAULT,x_)),p_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Times(a_DEFAULT,x_))),CN1),Power(ProductLog(Times(a_DEFAULT,x_)),p_),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(ProductLog(Times(Power(x_,n_),a_DEFAULT)),p_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Times(Power(x_,n_),a_DEFAULT))),CN1),Power(ProductLog(Times(Power(x_,n_),a_DEFAULT)),p_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Times(Power(x_,n_),a_DEFAULT))),CN1),Power(ProductLog(Times(Power(x_,n_),a_DEFAULT)),p_)),x_Symbol),
...
SetDelayed(Int(Times(Power(ProductLog(Times(Power(x_,n_),a_DEFAULT)),p_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(Plus(C1,ProductLog(Times(Power(x_,n_),a_DEFAULT))),CN1),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Times(Power(x_,n_),a_DEFAULT))),CN1),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Times(Power(x_,n_),a_DEFAULT))),CN1),Power(ProductLog(Times(Power(x_,n_),a_DEFAULT)),p_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Times(Power(x_,n_),a_DEFAULT))),CN1),Power(ProductLog(Times(Power(x_,n_),a_DEFAULT)),p_),Power(x_,m_DEFAULT)),x_Symbol),
