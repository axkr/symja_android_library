...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abs", "AbsArg", "AddTo", "AllTrue", "And", "AnyTrue",
			...
			"CatalanNumber", "Catch", "Catenate", "CDF", "Ceiling", "CentralMoment", "CharacteristicPolynomial",
			"ChebyshevT", "ChebyshevU", "ChessboardDistance", "ChineseRemainder", "Chop", "Clear", "ClearAll",
			...
			"Csc", "Csch", "Curl", "Decrement", "Default", "Defer", "Definition", "Delete", "DeleteCases",
			"DeleteDuplicates", "Denominator", "Depth", "Derivative", "DesignMatrix", "Det", "DiagonalMatrix",
			"DiceDissimilarity", "DigitQ", "Dimensions", "DirectedInfinity", "Direction", "Discriminant", "Distribute",
			"Divergence", "DivideBy", "Divisible", "Divisors", "Do", "Dot", "Drop", "DSolve", "EasterSunday",
			...
			"EulerE", "EulerPhi", "EvenQ", "Except", "Exists", "Exp", "Expand", "ExpandAll", "ExpIntegralE",
			...
			"FindInstance", "FindRoot", "First", "Fit", "FixedPoint", "Floor", "Fold", "FoldList", "For", "ForAll",
			...
			"Max", "Mean", "Median", "MemberQ", "MeshRange", "MessageName", "Min", "Missing", "MissingQ", "Mod",
			...
			"PreDecrement", "PreIncrement", "Prepend", "PrependTo", "Prime", "PrimeQ", "PrimitiveRoots", "Print",
			"Product", "ProductLog", "PseudoInverse", "Put", "Quiet", "Quotient", "RandomInteger", "RandomReal",
