...
IIntegrate(1564,Integrate(Times(Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),CN1D2),Sqrt(Plus(a_,Times(b_DEFAULT,Sqr(x_)),Times(c_DEFAULT,Power(x_,C4))))),x_Symbol),
    Condition(Simp(Dist(Times(Sqrt(Plus(a,Times(b,Sqr(x)),Times(c,Power(x,C4)))),Sqrt(Times(Plus(d,Times(e,Sqr(x))),Power(d,CN1))),Power(Times(Sqrt(Plus(d,Times(e,Sqr(x)))),Sqrt(Times(Plus(a,Times(b,Sqr(x)),Times(c,Power(x,C4))),Power(a,CN1)))),CN1)),Integrate(Times(Sqrt(Plus(C1,Times(b,Power(a,CN1),Sqr(x)),Times(c,Power(a,CN1),Power(x,C4)))),Power(Plus(C1,Times(e,Power(d,CN1),Sqr(x))),CN1D2)),x),x),x),And(FreeQ(List(a,b,c,d,e),x),EqQ(Subtract(Times(c,d),Times(b,e)),C0),Not(And(GtQ(a,C0),GtQ(d,C0)))))),
...
IIntegrate(1572,Integrate(Times(Power(x_,m_DEFAULT),Power(Times(e_DEFAULT,Sqr(x_)),q_),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_)),Times(c_DEFAULT,Power(x_,C4))),p_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Power(Times(C2,Power(e,Times(C1D2,Plus(m,CN1)))),CN1),Subst(Integrate(Times(Power(Times(e,x),Plus(q,Times(C1D2,Plus(m,CN1)))),Power(Plus(a,Times(b,x),Times(c,Sqr(x))),p)),x),x,Sqr(x)),x),x),And(FreeQ(List(a,b,c,e,p,q),x),Not(IntegerQ(q)),IntegerQ(Times(C1D2,Plus(m,CN1)))))),
IIntegrate(1573,Integrate(Times(Power(x_,m_DEFAULT),Power(Times(e_DEFAULT,Sqr(x_)),q_),Power(Plus(a_,Times(c_DEFAULT,Power(x_,C4))),p_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Power(Times(C2,Power(e,Times(C1D2,Plus(m,CN1)))),CN1),Subst(Integrate(Times(Power(Times(e,x),Plus(q,Times(C1D2,Plus(m,CN1)))),Power(Plus(a,Times(c,Sqr(x))),p)),x),x,Sqr(x)),x),x),And(FreeQ(List(a,c,e,p,q),x),Not(IntegerQ(q)),IntegerQ(Times(C1D2,Plus(m,CN1)))))),
IIntegrate(1574,Integrate(Times(Power(Times(f_DEFAULT,x_),m_DEFAULT),Power(Times(e_DEFAULT,Sqr(x_)),q_),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_)),Times(c_DEFAULT,Power(x_,C4))),p_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Times(Power(e,IntPart(q)),Power(Times(e,Sqr(x)),FracPart(q)),Power(Times(Power(f,Times(C2,IntPart(q))),Power(Times(f,x),Times(C2,FracPart(q)))),CN1)),Integrate(Times(Power(Times(f,x),Plus(m,Times(C2,q))),Power(Plus(a,Times(b,Sqr(x)),Times(c,Power(x,C4))),p)),x),x),x),And(FreeQ(List(a,b,c,e,f,m,p,q),x),Not(IntegerQ(q))))),
IIntegrate(1575,Integrate(Times(Power(Times(f_DEFAULT,x_),m_DEFAULT),Power(Times(e_DEFAULT,Sqr(x_)),q_),Power(Plus(a_,Times(c_DEFAULT,Power(x_,C4))),p_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Times(Power(e,IntPart(q)),Power(Times(e,Sqr(x)),FracPart(q)),Power(Times(Power(f,Times(C2,IntPart(q))),Power(Times(f,x),Times(C2,FracPart(q)))),CN1)),Integrate(Times(Power(Times(f,x),Plus(m,Times(C2,q))),Power(Plus(a,Times(c,Power(x,C4))),p)),x),x),x),And(FreeQ(List(a,c,e,f,m,p,q),x),Not(IntegerQ(q))))),
IIntegrate(1576,Integrate(Times(x_,Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),q_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_)),Times(c_DEFAULT,Power(x_,C4))),p_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(C1D2,Subst(Integrate(Times(Power(Plus(d,Times(e,x)),q),Power(Plus(a,Times(b,x),Times(c,Sqr(x))),p)),x),x,Sqr(x)),x),x),FreeQ(List(a,b,c,d,e,p,q),x))),
IIntegrate(1577,Integrate(Times(x_,Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),q_DEFAULT),Power(Plus(a_,Times(c_DEFAULT,Power(x_,C4))),p_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(C1D2,Subst(Integrate(Times(Power(Plus(d,Times(e,x)),q),Power(Plus(a,Times(c,Sqr(x))),p)),x),x,Sqr(x)),x),x),FreeQ(List(a,c,d,e,p,q),x))),
IIntegrate(1578,Integrate(Times(Power(x_,m_DEFAULT),Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),q_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_)),Times(c_DEFAULT,Power(x_,C4))),p_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(C1D2,Subst(Integrate(Times(Power(x,Times(C1D2,Plus(m,CN1))),Power(Plus(d,Times(e,x)),q),Power(Plus(a,Times(b,x),Times(c,Sqr(x))),p)),x),x,Sqr(x)),x),x),And(FreeQ(List(a,b,c,d,e,p,q),x),IntegerQ(Times(C1D2,Plus(m,CN1)))))),
IIntegrate(1579,Integrate(Times(Power(x_,m_DEFAULT),Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),q_DEFAULT),Power(Plus(a_,Times(c_DEFAULT,Power(x_,C4))),p_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(C1D2,Subst(Integrate(Times(Power(x,Times(C1D2,Plus(m,CN1))),Power(Plus(d,Times(e,x)),q),Power(Plus(a,Times(c,Sqr(x))),p)),x),x,Sqr(x)),x),x),And(FreeQ(List(a,c,d,e,p,q),x),IntegerQ(Times(C1D2,Plus(m,C1)))))),
IIntegrate(1580,Integrate(Times(Power(x_,m_DEFAULT),Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),q_),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_)),Times(c_DEFAULT,Power(x_,C4))),p_DEFAULT)),x_Symbol),
    Condition(Plus(Simp(Times(Power(Negate(d),Plus(Times(C1D2,m),CN1)),Power(Plus(Times(c,Sqr(d)),Times(CN1,b,d,e),Times(a,Sqr(e))),p),x,Power(Plus(d,Times(e,Sqr(x))),Plus(q,C1)),Power(Times(C2,Power(e,Plus(Times(C2,p),Times(C1D2,m))),Plus(q,C1)),CN1)),x),Simp(Dist(Power(Times(C2,Power(e,Plus(Times(C2,p),Times(C1D2,m))),Plus(q,C1)),CN1),Integrate(Times(Power(Plus(d,Times(e,Sqr(x))),Plus(q,C1)),ExpandToSum(Together(Times(Power(Plus(d,Times(e,Sqr(x))),CN1),Subtract(Times(C2,Power(e,Plus(Times(C2,p),Times(C1D2,m))),Plus(q,C1),Power(x,m),Power(Plus(a,Times(b,Sqr(x)),Times(c,Power(x,C4))),p)),Times(Power(Negate(d),Plus(Times(C1D2,m),CN1)),Power(Plus(Times(c,Sqr(d)),Times(CN1,b,d,e),Times(a,Sqr(e))),p),Plus(d,Times(e,Plus(Times(C2,q),C3),Sqr(x))))))),x)),x),x),x)),And(FreeQ(List(a,b,c,d,e),x),NeQ(Subtract(Sqr(b),Times(C4,a,c)),C0),IGtQ(p,C0),ILtQ(q,CN1),IGtQ(Times(C1D2,m),C0))))
  );
}
