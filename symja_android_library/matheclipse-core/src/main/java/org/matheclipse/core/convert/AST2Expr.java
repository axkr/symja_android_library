...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$CommandLine", "$ContextAliases",
      "$GeoLocation", "$InstallationDirectory", "$MachineName", "$ParentLink", "$ProcessID",
      "$SystemID", "$TimeZone", "$UnitSystem", "$UserDocumentsDirectory", "$VersionNumber",
      "AASTriangle", "Abort", "AbortProtect", "Abs", "AbsArg", "AbsoluteDashing",
      "AbsoluteCorrelation", "AbsoluteFileName", "AbsoluteTime", "AbsoluteTiming", "AccountingForm",
      "Accumulate", "Accuracy", "ActionMenu", "Activate", "AcyclicGraphQ", "AddSides", "AddTo",
      "AddToClassPath", "AdjacencyGraph", "AdjacencyList", "AdjacencyMatrix", "Adjugate",
      "AffineTransform", "AggregateBy", "AiryAi", "AiryAiPrime", "AiryBi", "AiryBiPrime",
      "AlgebraicIntegerQ", "AlgebraicNumber", "AlgebraicNumberNorm", "AlgebraicNumberQ",
      "AlgebraicNumberTrace", "AlgebraicUnitQ", "Alignment", "AllowedDimensions", "AllPoints",
      "AllTrue", "Alpha", "Alphabet", "AlphabeticOrder", "AlphaChannel", "Alternatives",
      "AltitudeMethod", "AmbientLight", "And", "AngerJ", "AnglePath", "AngleVector", "Animate",
      ...
      "Antihermitian", "AntihermitianMatrixQ", "AntisymmetricMatrixQ", "AnyTrue", "Apart",
      "Appearance", "AppearanceElements", "AppellF1", "Append", "AppendTo", "Apply", "ApplySides",
      "ArcCos", "ArcCosh", "ArcCot", "ArcCoth", "ArcCsc", "ArcCsch", "ArcLength", "ArcSec",
      "ArcSech", "ArcSin", "ArcSinh", "ArcTan", "ArcTanh", "Area", "Arg", "ArgMax", "ArgMin",
      "ArithmeticGeometricMean", "Around", "AroundReplace", "Array", "ArrayDepth", "ArrayDot",
      "ArrayExpand", "ArrayFlatten", "ArrayMesh", "ArrayPad", "ArrayPlot", "ArrayQ", "ArrayReduce",
      "ArrayReshape", "ArrayRules", "ArraySimplify", "ArraySymbol", "Arrays", "Arrow", "Arrowheads",
      "ASATriangle", "AssociateTo", "Association", "AssociationMap", "AssociationQ",
      "AssociationThread", "Assuming", "Assumptions", "AstroAngularSeparation", "AstroBackground",
      ...
      "AsymptoticSolve", "AsymptoticDSolveValue", "AsymptoticIntegrate", "AsymptoticRSolveValue",
      "Atom", "AtomCount", "AtomDiagramCoordinates", "AtomList", "AtomQ", "Attributes",
      "AutoAction", "AutorunSequencing", "AxisObject", "Backslash", "Backsubstitution", "Ball",
      "Band", "BarChart", "BarChart3D", "BarLegend", "BarnesG", "BartlettWindow", "BaseDecode",
      ...
      "BinaryDeserialize", "BinaryDistance", "BinaryRead", "BinaryReadList", "BinarySerialize",
      ...
      "ColorDistance", "ColorNegate", "ColorQuantize", "ColorReplace", "ColorRules",
      "ColorSeparate", "ColorSetter", "ColorSlider", "Column", "ColumnAlignments", "Commonest",
      "CommonestFilter", "CommonUnits", "CompatibleUnitQ", "Compile", "CompiledFunction",
      "CompilePrint", "Complement", "CompleteGraph", "CompleteGraphQ", "CompleteKaryTree",
      "Complex", "ComplexArrayPlot", "ComplexContourPlot", "ComplexExpand", "ComplexListPlot",
      ...
      "ConnectedMoleculeComponents", "ConnectedMoleculeQ", "ConstantArray", "ConstantRegionQ",
      ...
      "ContourLabels", "ContourLines", "ContourPlot", "ContourPlot3D", "Control",
      ...
      "Coproduct", "CopyDirectory", "CopyFile", "CornerFilter", "CornerNeighbors", "Correlation",
      ...
      "CreateDirectory", "CreateFile", "CreateUUID", "Cross", "CrossingDetect", "CrossMatrix",
      "Csc", "Csch", "Cube", "CubeRoot", "Cubics", "Cuboid", "Cumulant",
      "CumulantGeneratingFunction", "Cup", "CupCap", "Curl", "CurrencyConvert", "CurveClosed",
      "CycleGraph", "Cycles", "Cyclotomic", "Cylinder", "Darker", "Dashing", "DataDistribution",
      "DataReversed", "Dataset", "DatasetDisplayFormat", "DatasetTheme", "DateBounds", "Dated",
      ...
      "DateWithinQ", "DawsonF", "DayCount", "DayHemisphere", "DaylightQ", "DayMatchQ", "DayName",
      "DayNightTerminator", "DayPlus", "DayRange", "DayRound", "DeBruijnSequence", "DecimalForm",
      "Decrement", "Decompose", "DedekindNumber", "Default", "DefaultButton", "DefaultDuration",
      "DefaultPrintPrecision", "DefaultValues", "Defer", "Definition", "Deinitialization", "Del",
      "DelaunayMesh", "Delete", "DeleteBorderComponents", "DeleteCases", "DeleteDirectory",
      ...
      "Empirical", "EmpiricalDistribution", "EmptyRegion", "Enabled", "End", "EndPackage",
      ...
      "Environment", "Equal", "EqualTilde", "EqualTo", "Equilibrium", "Equivalent", "Erf", "Erfc",
      "Erfi", "ErlangDistribution", "Erosion", "EuclideanDistance", "EulerE", "EulerianGraphQ",
      "EulerPhi", "Evaluate", "EvaluatePacket", "EvaluationMonitor", "Evaluator", "EvenQ",
      "ExactNumberQ", "Except", "ExcludedLines", "Exclusions", "ExclusionsStyle", "Exists", "Exit",
      ...
      "ExponentStep", "Export", "ExportByteArray", "ExportForm", "ExportString", "ExpressionGraph",
      "ExpToTrig", "ExtendedFullDefinition", "ExtendedGCD", "ExtentElementFunction",
      "ExtentMarkers", "Extract", "ExtractArchive", "FaceForm", "FaceGrids", "FaceGridsStyle",
      "Factor", "Factorial", "Factorial2", "FactorialMomentGeneratingFunction", "FactorList",
      ...
      "FileNameSetter", "FileNameSplit", "FileType", "FilledCurve", "FilledTorus",
      ...
      "For", "ForAll", "Format", "FormatValues", "FormBox", "FormulaData", "Fourier",
      "FourierCosTransform", "FourierDCT", "FourierDCTMatrix", "FourierDST", "FourierDSTMatrix",
      "FourierMatrix", "FourierSinTransform", "FractionalPart", "FractionBox", "Framed",
      ...
      "GammaRegularized", "GapPenalty", "Gather", "GatherBy", "GaussianFilter", "GaussianMatrix",
      ...
      "GreaterSlantEqual", "GreaterThan", "GreaterTilde", "GreenFunction", "Grid", "GridGraph",
      ...
      "HeaderDisplayFunction", "HeaderLines", "HeaderSize", "HeaderStyle", "HeavisideLambda",
      "HeavisidePi", "HeavisideTheta", "HermiteDecomposition", "HermiteH", "Hermitian",
      "HermitianMatrixQ", "HessenbergDecomposition", "HessianMatrix", "Hexahedron", "HiddenItems",
      "Highlighted", "HilbertMatrix", "Histogram", "HistogramDistribution", "HistogramList",
      "HistogramTransform", "HodgeDual", "Hold", "HoldForm", "HoldPattern", "Horner", "HornerForm",
      ...
      "HypergeometricU", "HyperHarmonicNumber", "HypoexponentialDistribution", "Iconize",
      "Icosahedron", "Identity", "IdentityMatrix", "If", "Im", "Image", "ImageAdd", "ImageAdjust",
      ...
      "ImageKeypoints", "ImageLines", "ImageMeasurements", "ImageMultiply", "ImagePad",
      ...
      "JacobiEpsilon", "JacobiMatrix", "JacobiNC", "JacobiND", "JacobiP", "JacobiSC", "JacobiSD",
      "JacobiSN", "JacobiSymbol", "JacobiZeta", "JavaClass", "JavaForm", "JavaNew", "JavaObject",
      "JavaObjectQ", "JavaShow", "Join", "JoinAcross", "JoinedCurve", "JoinForm",
      "JordanDecomposition", "JSForm", "JSFormData", "JulianDate", "KagiChart", "KaryTree",
      "KCoreComponents", "KelvinBei", "KelvinBer", "Key", "KeyDrop", "KeyDropFrom", "KeyExistsQ",
      "KeyFreeQ", "KeyComplement", "KeyIntersection", "KeyMap", "KeyMemberQ", "Keys", "KeySelect",
      ...
      "LinkLaunch", "LinkObject", "LinkRead", "LinkReadyQ", "Links", "LinkWrite", "LiouvilleLambda",
      "List", "ListAnimate", "ListContourPlot", "ListConvolve", "ListCorrelate",
      ...
      "Messages", "MetaInformation", "MidDate", "Min", "MinDate", "MinFilter", "MinimalPolynomial",
      "MinimalBy", "Minimize", "MinLimit", "MinMax", "Minor", "Minors", "MinStableDistribution",
      ...
      "NSum", "NullSpace", "NumberDigit", "NumberFieldClassNumber", "NumberFieldDiscriminant",
      ...
      "OverscriptBox", "OwnValues", "Package", "Paclet", "PacletDirectoryLoad",
      ...
      "ParallelMap", "Parallelepiped", "Parallelogram", "ParameterMixtureDistribution",
      ...
      "PearsonCorrelationTest", "PerfectNumber", "PerfectNumberQ", "Perimeter", "PeriodicTablePlot",
      ...
      "Perpendicular", "PetersenGraph", "Pick", "Piecewise", "PiecewiseExpand", "PieChart",
      "Placed", "Plain", "PlanarAngle", "PlanarFaceList", "PlanarGraph", "PlanarGraphQ", "Plot",
      "Plot3D", "PlotFit", "PlotFitElements", "PlotHighlighting", "PlotMarkers", "PlotTheme",
      "Plus", "PlusMinus", "Pochhammer", "Point", "PointFigureChart", "PointLegend", "PointLight",
      ...
      "ProbabilityScalePlot", "ProcessDirectory", "ProcessEnvironment", "ProcessInformation",
      "ProcessObject", "ProcessStatus", "Product", "ProductDistribution", "ProductLog",
      "ProgressIndicator", "Projection", "Proportion", "Proportional", "Protect", "ProteinData",
      "Pruning", "PseudoInverse", "Put", "PutAppend", "Pyramid", "QPochhammer", "QRDecomposition",
      ...
      "Quartiles", "Query", "Quiet", "Quit", "Quotient", "QuotientRemainder", "RadicalBox",
      "RadioButton", "RadioButtonBar", "Radius", "Ramp", "RamseyNumber", "Random", "RandomChoice",
      ...
      "RasterSize", "Rational", "Rationalize", "Ratios", "RawBackquote", "RawBoxes", "Re",
      "ReactionBalance", "ReactionBalancedQ", "Read", "ReadLine", "ReadList", "ReadString",
      "RealAbs", "RealDigits", "RealSign", "RealValuedNumberQ", "RealValuedNumericQ", "Reap",
      "Rectangle", "RectangleChart", "Reduce", "ReferenceAltitude", "Refine", "ReflectionTransform",
      ...
      "RemoveAlphaChannel", "RemoveBackground", "RemoveDiacritics", "RenameFile", "RenkoChart",
      ...
      "Residue", "Resolve", "ResourceData", "Rest", "Resultant", "Return", "ReturnExpressionPacket",
      ...
      "RiccatiSolve", "RiceDistribution", "RidgeFilter", "RiemannSiegelTheta", "Riffle",
      ...
      "SetAttributes", "SetDelayed", "SetDirectory", "Setter", "SetterBar", "Share", "Sharpen",
      ...
      "Standardized", "Star", "StarData", "StarGraph", "StartProcess", "StatusArea",
      ...
      "SystemDialogInput", "Table", "TableForm", "TableView", "TabView", "TagBox", "TagSet",
      ...
      "Thumbnail", "Thursday", "Tilde", "TildeEqual", "TildeFullEqual", "TildeTilde",
      "TimeConstrained", "TimeDirection", "TimelinePlot", "TimeObject", "TimeRemaining", "Times",
      "TimesBy", "TimeSystem", "TimeSystemConvert", "TimeValue", "TimeZone", "TimeZoneConvert",
      "TimeZoneOffset", "Timing", "ToBoxes", "ToCharacterCode", "ToDataset", "ToeplitzMatrix",
      "ToExpression", "Together", "Toggler", "TogglerBar", "ToIntervalData", "ToLowerCase",
      "Tooltip", "TopHatTransform", "ToPolarCoordinates", "TopologicalSort", "ToRadicals",
      ...
      "Transliterate", "Transpose", "TreeForm", "TreeGraph", "TreeGraphQ", "TreePlot", "Triangle",
      "TriangleCenter", "TriangleConstruct", "TriangleMeasurement", "TriangleWave",
      "TriangularDistribution", "TrigExpand", "TrigFactor", "Trigger", "TrigReduce",
      "TrigSimplifyFu", "TrigToExp", "TrueQ", "TruncatedDistribution", "TTest", "Tube", "Tuesday",
      ...
      "UnitStep", "UnitSystem", "UnitTriangle", "UnitVector", "UnityDimensions", "UnixTime",
      ...
      "URLDecode", "URLDownload", "URLEncode", "URLFetch", "URLRead", "ValenceErrorHandling",
      "ValueFunction", "ValueQ", "Values", "VandermondeMatrix", "Variables", "Variance",
      ...
      "Write", "WriteLine", "WriteString", "Wronskian", "Xnor", "Xor", "XYZColor", "Yesterday",
