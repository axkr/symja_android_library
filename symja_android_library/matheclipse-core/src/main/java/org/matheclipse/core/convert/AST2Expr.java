...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo", "AllTrue", "And",
			...
			"Gather", "GatherBy", "GaussianWindow", "GCD", "GegenbauerC", "GeometricDistribution", "GeometricMean",
			"Get", "Grad", "Graphics", "Graphics3D", "Greater", "GreaterEqual", "GroebnerBasis", "GumbelDistribution",
			"HammingWindow", "HannWindow", "Haversine", "HarmonicNumber", "Head", "HeavisideTheta", "HermiteH",
