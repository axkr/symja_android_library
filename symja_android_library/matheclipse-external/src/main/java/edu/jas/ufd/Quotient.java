...
/**
 * Quotient, that is a rational function, based on GenPolynomial with RingElem interface. Objects of
...
public class Quotient<C extends GcdRingElem<C>>
  ...
  /**
   * The constructor creates a Quotient object from a ring factory and a numerator polynomial. The
