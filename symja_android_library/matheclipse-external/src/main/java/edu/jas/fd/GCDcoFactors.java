...
/**
 * Container for the co-factors of left-right GCD computation. Invariant is left * coA * right =
 * polyA and left * coB * right = polyB.
 *
...
public class GCDcoFactors<C extends GcdRingElem<C>> implements Serializable {
   ...
   */
  public GCDcoFactors(
      GreatestCommonDivisorAbstract<C> g,
   ...
   *
   * @return true if x * (left * coA * right) = y * (polyA), for x, y with x * lc(left * coA *
   *     right) == y * lc(polyA) and x * (left * coB * right) == y * (polyB), for x, y with x *
   *     lc(left * coB * right) == y * lc(polyB).
   */
  public boolean isGCD() {
    ...
    // System.out.println("c1 = " + c1 + ", c2 = " + c2 + ", c1/l = " + c1.leftDivide(l) + ", c2/l =
    // " + c2.leftDivide(l));
    // System.out.println("c1 = " + c1 + ", c2 = " + c2 + ", l\\c1 = " + c1.rightDivide(l) + ",
    // l\\c2 = " + c2.rightDivide(l));
    ...
    // System.out.println("d1 = " + d1 + ", d2 = " + d2 + ", d1/l = " + d1.leftDivide(l) + ", d2/l =
    // " + d2.leftDivide(l));
    // System.out.println("d1 = " + d1 + ", d2 = " + d2 + ", l\\d1 = " + d1.rightDivide(l) + ",
    // l\\d2 = " + d2.rightDivide(l));
   ...
   * @return sign(this.polyA-facs.polyA) lexicographic &gt; sign(this.polyB-facs.polyB)
   *     lexicographic &gt; sign(this.coA-facs.coA) lexicographic &gt; sign(this.coB-facs.coB)
   *     lexicographic &gt; sign(this.left-facs.left) lexicographic &gt;
