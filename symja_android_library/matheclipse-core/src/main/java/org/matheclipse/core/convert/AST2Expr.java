...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$GeoLocation", "$TimeZone", "$UnitSystem",
      ...
      "ConnectedMoleculeQ", "ConstantArray", "ContainsAll", "ContainsAny", "ContainsExactly",
      "ContainsNone", "ContainsOnly", "ContentSize", "Context", "Contexts", "Continue",
      "ContinuedFraction", "ContinuousAction", "ContourLabels", "ContourLines", "ContourPlot",
      "ContourPlot3D", "Control", "ControllerLinking", "ControllerPath", "ControlPlacement",
      "ControlType", "Convergents", "ConvexHull", "ConvexHullMesh", "ConvexHullRegion",
      "ConvexRegionQ", "Convolve", "CoordinateBoundingBox", "CoordinateBounds", "CoplanarPoints",
      ...
      "DistributionParameterQ", "Dithering", "Div", "Divide", "DivideBy", "Divides", "DivideSides",
      "Divisible", "Divisors", "DivisorSigma", "DivisorSum", "DMSList", "DMSString", "Do",
      "Dodecahedron", "Dot", "DotEqual", "DoubleDownArrow", "DoubleLeftArrow",
      ...
      "Dynamic", "DynamicModule", "DynamicWrapper", "EasterSunday", "Echo", "EchoFunction",
      "EclipseType", "EdgeAdd", "EdgeCount", "EdgeContract", "EdgeDelete", "EdgeDetect", "EdgeForm",
      ...
      "EmpiricalDistribution", "EmptyRegion", "Enabled", "End", "EndPackage", "EndTestSection",
      "EngineeringForm", "Entity", "EntityClass", "EntityList", "EntityProperty", "Entropy",
      "EntropyFilter", "Equal", "EqualTilde", "EqualTo", "Equilibrium", "Equivalent", "Erf", "Erfc",
      "Erfi", "ErlangDistribution", "Erosion", "EuclideanDistance", "EulerE", "EulerianGraphQ",
      "EulerPhi", "Evaluate", "EvaluationMonitor", "Evaluator", "EvenQ", "ExactNumberQ", "Except",
      ...
      "FindAstroEvent", "FindDistributionParameters", "FindMaximumFlow", "FindMoleculeSubstructure",
      "FindSolarEclipse", "FindThreshold", "FiniteGroupCount", "FiniteAbelianGroupCount", "File",
      ...
      "FromUnixTime", "FullDefinition", "FullForm", "FullMoon", "FullSimplify", "Function",
      ...
      "GaussianMatrix", "GaussianWindow", "GCD", "GegenbauerC", "GeneratedQuantityMagnitudes",
      "GeneratingFunction", "GeoBackground", "GeoCenter", "GeodesyData", "GeoDistance",
      "GeoGraphics", "GeoGridLines", "GeometricDistribution", "GeometricMean",
      "GeometricTransformation", "GeoPosition", "GeoProjection", "GeoRange", "Get",
      ...
      "GreaterLess", "GreaterSlantEqual", "GreaterThan", "GreaterTilde", "Grid", "GridGraph",
      ...
      "ImageValue", "ImageValuePositions", "ImplicitD", "Implies", "Import", "ImportString", "In",
      "Inactivate", "Inactive", "IncidenceMatrix", "IncludeAromaticBonds", "IncludeHydrogens",
      "IncludeMetaInformation", "IncludeQuantities", "Increment", "IndependentPhysicalQuantity",
      "IndependentUnit", "IndependentUnitDimension", "Indexed", "IndexGraph", "Inequality",
      ...
      "Laplacian", "LaplacianFilter", "LaplacianGaussianFilter", "LaplacianPDETerm", "Last",
      "LCHColor", "LCM", "LeafCount", "LeapYearQ", "LeastSquares", "LeftArrow", "LeftArrowBar",
      ...
      "MergeDifferences", "MersennePrimeExponent", "MersennePrimeExponentQ", "MeshCellCount",
      ...
      "MeshRegion", "MeshRegionQ", "MeshShading", "MeshStyle", "Message", "MessageName", "Messages",
      ...
      "MinusPlus", "Missing", "MissingQ", "MissingValuePattern", "MixedMagnitude", "MixedUnit",
      ...
      "MoyalDistribution", "Multinomial", "MultinormalDistribution", "MultiplicativeOrder",
      "MultiplySides", "MultivariatePoissonDistribution", "MultivariateTDistribution",
      "NakagamiDistribution", "NameQ", "Names", "Nand", "NArgMax", "NArgMin", "NCache", "ND",
      ...
      "Normalize", "NormalMatrixQ", "NormalsFunction", "Not", "NotCongruent", "NotCupCap",
      ...
      "Overflow", "Overscript", "OverscriptBox", "OwnValues", "Package", "PaddedForm", "Padding",
      ...
      "ParametricPlot3D", "Parenthesis", "ParetoDistribution", "Part", "PartialD", "Partition",
      ...
      "ReplaceRepeated", "Resampling", "Rescale", "Residue", "Resolve", "Rest", "Resultant",
      ...
      "RiceDistribution", "RidgeFilter", "RiemannSiegelTheta", "Riffle", "RightArrow",
      ...
      "SystemDialogInput", "Table", "TableForm", "TableView", "TagSet", "TagSetDelayed", "TagUnset",
      "Take", "TakeLargest", "TakeLargestBy", "TakeList", "TakeSmallest", "TakeSmallestBy",
      "TakeWhile", "Tally", "Tan", "Tanh", "TargetUnits", "TautologyQ", "Taylor", "TemplateApply",
      ...
      "WignerSemicircleDistribution", "With", "WordBoundary", "WordCloud", "WordOrientation",
      "WordSelectionFunction", "WordSpacings", "Write", "WriteString", "Xnor", "Xor", "XYZColor",
