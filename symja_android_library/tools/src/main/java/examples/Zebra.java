...
public class Zebra {
  ...
  public static void main(String[] args) {
    ...
    IntVariable[] color = {red, green, ivory, yellow, blue};
    ...
    IntVariable[] nationality = {englishman, spaniard, ukrainian, norwegian, japanese};
    ...
    IntVariable[] drink = {coffee, tea, milk, orangeJuice, water};
    ...
    IntVariable[] smoke = {oldGold, kools, chesterfields, luckyStrike, parliaments};
    ...
    IntVariable[] pet = {dog, snails, fox, horse, zebra};
