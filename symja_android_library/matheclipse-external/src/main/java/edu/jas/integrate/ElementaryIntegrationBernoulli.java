...
/**
 * Methods related to the Bernoulli algorithm for elementary integration. The denominator is
 * factored into linear factors over iterated algebraic extensions over the rational numbers.
 *
 * @author Heinz Kredel
...
public class ElementaryIntegrationBernoulli<C extends GcdRingElem<C>>
  ...
  /**
   * Univariate GenPolynomial integration of the logarithmic part, Bernoulli linear factorization
   * algorithm.
   *
