...
/**
 * Real algebraic number factory class based on bi-variate real algebraic numbers. Objects of this
 * class are immutable with the exception of the isolating intervals. Bi-variate ideal
 * implementation is in version 3614 2011-04-28 09:20:34Z.
 *
 * @author Heinz Kredel
 */
public class RealAlgebraicRing<C extends GcdRingElem<C> & Rational>
  ...
  /**
   * Isolating intervals for the real algebraic roots of the real and imaginary part. <b>Note: </b>
   * intervals may shrink eventually.
   */
  ...
  /**
   * The constructor creates a RealAlgebraicNumber factory object from a IdealWithUniv, ResidueRing
   * and a root tuple.
   *
  ...
  public RealAlgebraicRing(IdealWithUniv<C> m, ResidueRing<C> a, RealRootTuple<C> r) {
    ...
    Interval<edu.jas.root.RealAlgebraicNumber<C>> r2r =
        new Interval<edu.jas.root.RealAlgebraicNumber<C>>(rleft, rright);
  ...
  /**
   * The constructor creates a RealAlgebraicNumber factory object from a IdealWithUniv and a root
   * tuple.
   *
   * @param m module IdealWithUniv&lt;C&gt;.
  ...
  /**
   * Set a refined rectangle for the complex root. <b>Note: </b> rectangle may shrink eventually.
   *
   * @param v rectangle.
   */
  ...
  public List<RealAlgebraicNumber<C>> generators() {
    List<edu.jas.root.RealAlgebraicNumber<edu.jas.root.RealAlgebraicNumber<C>>> agens =
        realRing.generators();
