...
ISetDelayed(4571,SimplifyAntiderivative(ArcTan(Plus(a_DEFAULT,Times(b_DEFAULT,Tan(u_)),Times(c_DEFAULT,Sqr(Tan(u_))))),x_Symbol),
...
ISetDelayed(4572,SimplifyAntiderivative(ArcTan(Plus(a_DEFAULT,Times(b_DEFAULT,Plus(d_DEFAULT,Times(e_DEFAULT,Tan(u_)))),Times(c_DEFAULT,Sqr(Plus(f_DEFAULT,Times(g_DEFAULT,Tan(u_))))))),x_Symbol),
...
ISetDelayed(4573,SimplifyAntiderivative(ArcTan(Plus(a_DEFAULT,Times(c_DEFAULT,Sqr(Tan(u_))))),x_Symbol),
...
ISetDelayed(4574,SimplifyAntiderivative(ArcTan(Plus(a_DEFAULT,Times(c_DEFAULT,Sqr(Plus(f_DEFAULT,Times(g_DEFAULT,Tan(u_))))))),x_Symbol),
...
ISetDelayed(4575,SimplifyAntiderivative(u_,x_Symbol),
...
ISetDelayed(4576,SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times(B_DEFAULT,Log(Cos(u_))),Times(A_DEFAULT,Log(Plus(a_,Times(b_DEFAULT,Power(Tan(u_),n_DEFAULT)))))),x_Symbol),
...
ISetDelayed(4577,SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times(A_DEFAULT,Log(Plus(a_,Times(b_DEFAULT,Power(Cot(u_),n_DEFAULT))))),Times(B_DEFAULT,Log(Sin(u_)))),x_Symbol),
...
ISetDelayed(4578,SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times(A_DEFAULT,Log(Plus(a_,Times(b_DEFAULT,Power(Tan(u_),n_DEFAULT))))),Times(B_DEFAULT,Log(Plus(c_,Times(d_DEFAULT,Power(Tan(u_),n_DEFAULT)))))),x_Symbol),
...
ISetDelayed(4579,SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times(A_DEFAULT,Log(Plus(a_,Times(b_DEFAULT,Power(Cot(u_),n_DEFAULT))))),Times(B_DEFAULT,Log(Plus(c_,Times(d_DEFAULT,Power(Cot(u_),n_DEFAULT)))))),x_Symbol),
...
ISetDelayed(4580,SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times(A_DEFAULT,Log(Plus(a_,Times(b_DEFAULT,Power(Tan(u_),n_DEFAULT))))),Times(B_DEFAULT,Log(Plus(c_,Times(d_DEFAULT,Power(Tan(u_),n_DEFAULT))))),Times(C_DEFAULT,Log(Plus(e_,Times(f_DEFAULT,Power(Tan(u_),n_DEFAULT)))))),x_Symbol),
...
ISetDelayed(4581,SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times(A_DEFAULT,Log(Plus(a_,Times(b_DEFAULT,Power(Cot(u_),n_DEFAULT))))),Times(B_DEFAULT,Log(Plus(c_,Times(d_DEFAULT,Power(Cot(u_),n_DEFAULT))))),Times(C_DEFAULT,Log(Plus(e_,Times(f_DEFAULT,Power(Cot(u_),n_DEFAULT)))))),x_Symbol),
...
ISetDelayed(4582,SimplifyAntiderivativeSum(u_,x_Symbol),
    u),
ISetDelayed(4583,RectifyTangent(u_,a_,b_,x_Symbol),
...
ISetDelayed(4584,RectifyTangent(u_,a_,b_,r_,x_Symbol),
...
ISetDelayed(4585,RectifyCotangent(u_,a_,b_,x_Symbol),
...
ISetDelayed(4586,RectifyCotangent(u_,a_,b_,r_,x_Symbol),
...
ISetDelayed(4587,SmartNumerator(Power(u_,n_)),
    Condition(SmartDenominator(Power(u,Negate(n))),And(RationalQ(n),Less(n,C0)))),
ISetDelayed(4588,SmartNumerator(Times(u_,v_)),
    Times(SmartNumerator(u),SmartNumerator(v))),
ISetDelayed(4589,SmartNumerator(u_),
    Numerator(u)),
ISetDelayed(4590,SmartDenominator(Power(u_,n_)),
    Condition(SmartNumerator(Power(u,Negate(n))),And(RationalQ(n),Less(n,C0)))),
ISetDelayed(4591,SmartDenominator(Times(u_,v_)),
    Times(SmartDenominator(u),SmartDenominator(v))),
ISetDelayed(4592,SmartDenominator(u_),
    Denominator(u)),
ISetDelayed(4593,SubstFor(w_,v_,u_,x_),
    SimplifyIntegrand(Times(w,SubstFor(v,u,x)),x)),
ISetDelayed(4594,SubstFor(v_,u_,x_),
...
ISetDelayed(4595,SubstForAux(u_,v_,x_),
...
ISetDelayed(4596,SubstForTrig(u_,$p("§sin"),$p("§cos"),v_,x_),
...
ISetDelayed(4597,SubstForHyperbolic(u_,$p("§sinh"),$p("§cosh"),v_,x_),
...
ISetDelayed(4598,SubstForFractionalPowerOfLinear(u_,x_Symbol),
...
ISetDelayed(4599,FractionalPowerOfLinear(u_,n_,v_,x_),
...
ISetDelayed(4600,InverseFunctionOfLinear(u_,x_Symbol),
...
ISetDelayed(4601,TryPureTanSubst(u_,x_Symbol),
...
ISetDelayed(4602,TryTanhSubst(u_,x_Symbol),
...
ISetDelayed(4603,TryPureTanhSubst(u_,x_Symbol),
...
ISetDelayed(4611,DeactivateTrig(u_,x_),
    UnifyInertTrigFunction(FixInertTrigFunction(DeactivateTrigAux(u,x),x),x)),
ISetDelayed(4612,DeactivateTrigAux(u_,x_),
...
ISetDelayed(4613,FixInertTrigFunction(Times(a_,u_),x_),
    Condition(Times(a,FixInertTrigFunction(u,x)),FreeQ(a,x))),
ISetDelayed(4614,FixInertTrigFunction(Times(u_DEFAULT,Power(Times(a_,Plus(b_,v_)),n_)),x_),
    Condition(FixInertTrigFunction(Times(u,Power(Plus(Times(a,b),Times(a,v)),n)),x),And(FreeQ(List(a,b,n),x),Not(FreeQ(v,x))))),
ISetDelayed(4615,FixInertTrigFunction(Times(Power($($s("§csc"),v_),m_DEFAULT),Power(Times(c_DEFAULT,$($s("§sin"),w_)),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sin"),v),Negate(m)),Power(Times(c,$($s("§sin"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4616,FixInertTrigFunction(Times(Power(Times(c_DEFAULT,$($s("§cos"),w_)),n_DEFAULT),Power($($s("§sec"),v_),m_DEFAULT)),x_),
    Condition(Times(Power($($s("§cos"),v),Negate(m)),Power(Times(c,$($s("§cos"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4617,FixInertTrigFunction(Times(Power($($s("§cot"),v_),m_DEFAULT),Power(Times(c_DEFAULT,$($s("§tan"),w_)),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§tan"),v),Negate(m)),Power(Times(c,$($s("§tan"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4618,FixInertTrigFunction(Times(Power(Times(c_DEFAULT,$($s("§cot"),w_)),n_DEFAULT),Power($($s("§tan"),v_),m_DEFAULT)),x_),
    Condition(Times(Power($($s("§cot"),v),Negate(m)),Power(Times(c,$($s("§cot"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4619,FixInertTrigFunction(Times(Power($($s("§cos"),v_),m_DEFAULT),Power(Times(c_DEFAULT,$($s("§sec"),w_)),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sec"),v),Negate(m)),Power(Times(c,$($s("§sec"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4620,FixInertTrigFunction(Times(Power(Times(c_DEFAULT,$($s("§csc"),w_)),n_DEFAULT),Power($($s("§sin"),v_),m_DEFAULT)),x_),
    Condition(Times(Power($($s("§csc"),v),Negate(m)),Power(Times(c,$($s("§csc"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4621,FixInertTrigFunction(Times(Power($($s("§sec"),v_),m_DEFAULT),Power(Times(c_DEFAULT,$($s("§sin"),w_)),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§cos"),v),Negate(m)),Power(Times(c,$($s("§sin"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4622,FixInertTrigFunction(Times(Power(Times(c_DEFAULT,$($s("§cos"),w_)),n_DEFAULT),Power($($s("§csc"),v_),m_DEFAULT)),x_),
    Condition(Times(Power($($s("§sin"),v),Negate(m)),Power(Times(c,$($s("§cos"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4623,FixInertTrigFunction(Times(Power($($s("§cos"),v_),m_DEFAULT),Power(Times(c_DEFAULT,$($s("§tan"),w_)),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sec"),v),Negate(m)),Power(Times(c,$($s("§tan"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4624,FixInertTrigFunction(Times(Power(Times(c_DEFAULT,$($s("§cot"),w_)),n_DEFAULT),Power($($s("§sin"),v_),m_DEFAULT)),x_),
    Condition(Times(Power($($s("§csc"),v),Negate(m)),Power(Times(c,$($s("§cot"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4625,FixInertTrigFunction(Times(Power(Times(c_DEFAULT,$($s("§sec"),w_)),n_DEFAULT),Power($($s("§sin"),v_),m_DEFAULT)),x_),
    Condition(Times(Power($($s("§csc"),v),Negate(m)),Power(Times(c,$($s("§sec"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4626,FixInertTrigFunction(Times(Power($($s("§cos"),v_),m_DEFAULT),Power(Times(c_DEFAULT,$($s("§csc"),w_)),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sec"),v),Negate(m)),Power(Times(c,$($s("§csc"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4627,FixInertTrigFunction(Times(Power($($s("§cot"),v_),m_DEFAULT),Power(Times(c_DEFAULT,$($s("§sin"),w_)),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§tan"),v),Negate(m)),Power(Times(c,$($s("§sin"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4628,FixInertTrigFunction(Times(Power(Times(c_DEFAULT,$($s("§cos"),w_)),n_DEFAULT),Power($($s("§tan"),v_),m_DEFAULT)),x_),
    Condition(Times(Power($($s("§cot"),v),Negate(m)),Power(Times(c,$($s("§cos"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4629,FixInertTrigFunction(Times(Power($($s("§csc"),v_),m_DEFAULT),Power(Times(c_DEFAULT,$($s("§tan"),w_)),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sin"),v),Negate(m)),Power(Times(c,$($s("§tan"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4630,FixInertTrigFunction(Times(Power(Times(c_DEFAULT,$($s("§cot"),w_)),n_DEFAULT),Power($($s("§sec"),v_),m_DEFAULT)),x_),
    Condition(Times(Power($($s("§cos"),v),Negate(m)),Power(Times(c,$($s("§cot"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4631,FixInertTrigFunction(Times(Power($($s("§cot"),v_),m_DEFAULT),Power(Times(c_DEFAULT,$($s("§sec"),w_)),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§tan"),v),Negate(m)),Power(Times(c,$($s("§sec"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4632,FixInertTrigFunction(Times(Power(Times(c_DEFAULT,$($s("§csc"),w_)),n_DEFAULT),Power($($s("§tan"),v_),m_DEFAULT)),x_),
    Condition(Times(Power($($s("§cot"),v),Negate(m)),Power(Times(c,$($s("§csc"),w)),n)),And(FreeQ(List(c,n),x),IntegerQ(m)))),
ISetDelayed(4633,FixInertTrigFunction(Times(Power($($s("§sec"),v_),m_DEFAULT),Power($($s("§sec"),w_),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§cos"),v),Negate(m)),Power($($s("§cos"),w),Negate(n))),IntegersQ(m,n))),
ISetDelayed(4634,FixInertTrigFunction(Times(Power($($s("§csc"),v_),m_DEFAULT),Power($($s("§csc"),w_),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sin"),v),Negate(m)),Power($($s("§sin"),w),Negate(n))),IntegersQ(m,n))),
ISetDelayed(4635,FixInertTrigFunction(Times(u_,Power(Plus(a_,Times(b_DEFAULT,$($s("§sin"),w_))),n_DEFAULT),Power($($s("§tan"),v_),m_DEFAULT)),x_),
...
ISetDelayed(4636,FixInertTrigFunction(Times(u_,Power($($s("§cot"),v_),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,$($s("§sin"),w_))),n_DEFAULT)),x_),
...
ISetDelayed(4637,FixInertTrigFunction(Times(u_,Power(Plus(a_,Times(b_DEFAULT,$($s("§cos"),w_))),n_DEFAULT),Power($($s("§tan"),v_),m_DEFAULT)),x_),
...
ISetDelayed(4638,FixInertTrigFunction(Times(u_,Power(Plus(a_,Times(b_DEFAULT,$($s("§cos"),w_))),n_DEFAULT),Power($($s("§cot"),v_),m_DEFAULT)),x_),
...
ISetDelayed(4639,FixInertTrigFunction(Times(Power($($s("§cot"),v_),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(Times(c_DEFAULT,$($s("§sin"),w_)),p_DEFAULT))),n_DEFAULT)),x_),
...
ISetDelayed(4640,FixInertTrigFunction(Times(Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(Times(c_DEFAULT,$($s("§cos"),w_)),p_DEFAULT))),n_DEFAULT),Power($($s("§tan"),v_),m_DEFAULT)),x_),
...
ISetDelayed(4641,FixInertTrigFunction(Times(u_DEFAULT,w_,Power(Times(c_DEFAULT,Power($($s("§sin"),v_),n_DEFAULT)),p_DEFAULT)),x_),
...
ISetDelayed(4642,FixInertTrigFunction(Times(u_DEFAULT,w_,Power(Times(c_DEFAULT,Power($($s("§cos"),v_),n_DEFAULT)),p_DEFAULT)),x_),
...
ISetDelayed(4643,FixInertTrigFunction(Times(u_DEFAULT,w_,Power(Times(c_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT)),p_DEFAULT)),x_),
...
ISetDelayed(4644,FixInertTrigFunction(Times(u_DEFAULT,w_,Power(Times(c_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT)),p_DEFAULT)),x_),
...
ISetDelayed(4645,FixInertTrigFunction(Times(u_DEFAULT,w_,Power(Times(c_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT)),p_DEFAULT)),x_),
...
ISetDelayed(4646,FixInertTrigFunction(Times(u_DEFAULT,w_,Power(Times(c_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT)),p_DEFAULT)),x_),
