...
public class AST2Expr {
	...
	private final static String[] FUNCTION_STRINGS = { "ArcCosh", "ArcSinh", "ArcTanh", "DirectedInfinity", "False", "Flat",
			...
			"Coefficient", "CoefficientList", "Collect", "Complement", "Complex", "ComplexExpand", "ComplexInfinity", "ComposeList",
			...
			"Eigenvectors", "Equal", "Erf", "EuclidianDistance", "EulerE", "EulerGamma", "EulerPhi", "EvenQ", "Exp", "Expand", "ExpandAll",
