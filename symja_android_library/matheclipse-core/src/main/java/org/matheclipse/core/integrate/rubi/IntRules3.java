...
IIntegrate(63,Integrate(Times(Power(Times(b_DEFAULT,x_),CN1D2),Power(Plus(c_,Times(d_DEFAULT,x_)),CN1D2)),x_Symbol),
    Condition(Simp(Dist(Times(C2,Power(b,CN1)),Subst(Integrate(Power(Plus(c,Times(d,Sqr(x),Power(b,CN1))),CN1D2),x),x,Sqrt(Times(b,x))),x),x),And(FreeQ(list(b,c,d),x),GtQ(c,C0)))),
IIntegrate(64,Integrate(Times(Power(Plus(a_,Times(b_DEFAULT,x_)),CN1D2),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),CN1D2)),x_Symbol),
    Condition(Simp(Dist(Times(C2,Power(b,CN1)),Subst(Integrate(Power(Plus(c,Times(CN1,a,d,Power(b,CN1)),Times(d,Sqr(x),Power(b,CN1))),CN1D2),x),x,Sqrt(Plus(a,Times(b,x)))),x),x),And(FreeQ(List(a,b,c,d),x),GtQ(Subtract(c,Times(a,d,Power(b,CN1))),C0),Or(Not(GtQ(Subtract(a,Times(c,b,Power(d,CN1))),C0)),PosQ(b))))),
IIntegrate(65,Integrate(Times(Power(Times(b_DEFAULT,x_),CN1D2),Power(Plus(c_,Times(d_DEFAULT,x_)),CN1D2)),x_Symbol),
    Condition(Simp(Dist(C2,Subst(Integrate(Power(Subtract(b,Times(d,Sqr(x))),CN1),x),x,Times(Sqrt(Times(b,x)),Power(Plus(c,Times(d,x)),CN1D2))),x),x),And(FreeQ(list(b,c,d),x),Not(GtQ(c,C0))))),
IIntegrate(66,Integrate(Times(Power(Plus(a_,Times(b_DEFAULT,x_)),CN1D2),Power(Plus(c_,Times(d_DEFAULT,x_)),CN1D2)),x_Symbol),
    Condition(Simp(Dist(C2,Subst(Integrate(Power(Subtract(b,Times(d,Sqr(x))),CN1),x),x,Times(Sqrt(Plus(a,Times(b,x))),Power(Plus(c,Times(d,x)),CN1D2))),x),x),And(FreeQ(List(a,b,c,d),x),Not(GtQ(Subtract(c,Times(a,d,Power(b,CN1))),C0))))),
IIntegrate(67,Integrate(Times(Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),CN1),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),CN1D3)),x_Symbol),
    Condition(With(list(Set(q,Rt(Times(Subtract(Times(b,c),Times(a,d)),Power(b,CN1)),C3))),Plus(Simp(Times(CN1,Log(RemoveContent(Plus(a,Times(b,x)),x)),Power(Times(C2,b,q),CN1)),x),Simp(Dist(Times(C3,Power(Times(C2,b),CN1)),Subst(Integrate(Power(Plus(Sqr(q),Times(q,x),Sqr(x)),CN1),x),x,Power(Plus(c,Times(d,x)),C1D3)),x),x),Negate(Simp(Dist(Times(C3,Power(Times(C2,b,q),CN1)),Subst(Integrate(Power(Subtract(q,x),CN1),x),x,Power(Plus(c,Times(d,x)),C1D3)),x),x)))),And(FreeQ(List(a,b,c,d),x),PosQ(Times(Subtract(Times(b,c),Times(a,d)),Power(b,CN1)))))),
IIntegrate(68,Integrate(Times(Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),CN1),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),CN1D3)),x_Symbol),
    Condition(With(list(Set(q,Rt(Times(CN1,Subtract(Times(b,c),Times(a,d)),Power(b,CN1)),C3))),Plus(Simp(Times(Log(RemoveContent(Plus(a,Times(b,x)),x)),Power(Times(C2,b,q),CN1)),x),Simp(Dist(Times(C3,Power(Times(C2,b),CN1)),Subst(Integrate(Power(Plus(Sqr(q),Times(CN1,q,x),Sqr(x)),CN1),x),x,Power(Plus(c,Times(d,x)),C1D3)),x),x),Negate(Simp(Dist(Times(C3,Power(Times(C2,b,q),CN1)),Subst(Integrate(Power(Plus(q,x),CN1),x),x,Power(Plus(c,Times(d,x)),C1D3)),x),x)))),And(FreeQ(List(a,b,c,d),x),NegQ(Times(Subtract(Times(b,c),Times(a,d)),Power(b,CN1)))))),
IIntegrate(69,Integrate(Times(Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),CN1),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),QQ(-2L,3L))),x_Symbol),
    Condition(With(list(Set(q,Rt(Times(Subtract(Times(b,c),Times(a,d)),Power(b,CN1)),C3))),Plus(Simp(Times(CN1,Log(RemoveContent(Plus(a,Times(b,x)),x)),Power(Times(C2,b,Sqr(q)),CN1)),x),Negate(Simp(Dist(Times(C3,Power(Times(C2,b,q),CN1)),Subst(Integrate(Power(Plus(Sqr(q),Times(q,x),Sqr(x)),CN1),x),x,Power(Plus(c,Times(d,x)),C1D3)),x),x)),Negate(Simp(Dist(Times(C3,Power(Times(C2,b,Sqr(q)),CN1)),Subst(Integrate(Power(Subtract(q,x),CN1),x),x,Power(Plus(c,Times(d,x)),C1D3)),x),x)))),And(FreeQ(List(a,b,c,d),x),PosQ(Times(Subtract(Times(b,c),Times(a,d)),Power(b,CN1)))))),
IIntegrate(70,Integrate(Times(Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),CN1),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),QQ(-2L,3L))),x_Symbol),
    Condition(With(list(Set(q,Rt(Times(CN1,Subtract(Times(b,c),Times(a,d)),Power(b,CN1)),C3))),Plus(Simp(Times(CN1,Log(RemoveContent(Plus(a,Times(b,x)),x)),Power(Times(C2,b,Sqr(q)),CN1)),x),Simp(Dist(Times(C3,Power(Times(C2,b,q),CN1)),Subst(Integrate(Power(Plus(Sqr(q),Times(CN1,q,x),Sqr(x)),CN1),x),x,Power(Plus(c,Times(d,x)),C1D3)),x),x),Simp(Dist(Times(C3,Power(Times(C2,b,Sqr(q)),CN1)),Subst(Integrate(Power(Plus(q,x),CN1),x),x,Power(Plus(c,Times(d,x)),C1D3)),x),x))),And(FreeQ(List(a,b,c,d),x),NegQ(Times(Subtract(Times(b,c),Times(a,d)),Power(b,CN1)))))),
