...
IIntegrate(10432,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_),CoshIntegral(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),Sinh(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10433,Int(SinhIntegral(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(10434,Int(CoshIntegral(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(10435,Int(Times(Power(x_,-1),$(F_,Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),d_DEFAULT))),x_Symbol),
...
IIntegrate(10436,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),SinhIntegral(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
IIntegrate(10437,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),CoshIntegral(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
IIntegrate(10438,Int(Gamma(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10439,Int(Times(Power(x_,-1),Gamma(C0,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10440,Int(Times(Power(x_,-1),Gamma(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10441,Int(Times(Power(x_,-1),Gamma(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10442,Int(Times(Power(x_,-1),Gamma(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10443,Int(Times(Power(Times(d_DEFAULT,x_),m_DEFAULT),Gamma(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10444,Int(Times(Power(Plus(c_,Times(d_DEFAULT,x_)),m_DEFAULT),Gamma(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10445,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1),Gamma(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10446,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Gamma(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10447,Int(LogGamma(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Simp(Times(PolyGamma(CN2,Plus(a,Times(b,x))),Power(b,-1)),x),FreeQ(List(a,b),x))),
IIntegrate(10448,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),LogGamma(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10449,Int(PolyGamma(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Simp(Times(PolyGamma(Plus(n,Negate(C1)),Plus(a,Times(b,x))),Power(b,-1)),x),FreeQ(List(a,b,n),x))),
IIntegrate(10450,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),PolyGamma(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10451,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),PolyGamma(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10452,Int(Times(Power(Gamma(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT),PolyGamma(C0,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Simp(Times(Power(Gamma(Plus(a,Times(b,x))),n),Power(Times(b,n),-1)),x),FreeQ(List(a,b,n),x))),
IIntegrate(10453,Int(Times(Power(Factorial(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT),PolyGamma(C0,Plus(c_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Simp(Times(Power(Factorial(Plus(a,Times(b,x))),n),Power(Times(b,n),-1)),x),And(FreeQ(List(a,b,c,n),x),EqQ(c,Plus(a,C1))))),
IIntegrate(10454,Int(Gamma(p_,Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(10455,Int(Times(Power(x_,-1),Gamma(p_,Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
    Condition(Dist(Power(n,-1),Subst(Gamma(p,Times(d,Plus(a,Times(b,x)))),x,Log(Times(c,Power(x,n)))),x),FreeQ(List(a,b,c,d,n,p),x))),
IIntegrate(10456,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Gamma(p_,Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
IIntegrate(10457,Int(Gamma(p_,Times(f_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(Plus(d_,Times(e_DEFAULT,x_)),n_DEFAULT))))))),x_Symbol),
...
IIntegrate(10458,Int(Times(Power(Plus(g_,Times(h_DEFAULT,x_)),m_DEFAULT),Gamma(p_,Times(f_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(Plus(d_,Times(e_DEFAULT,x_)),n_DEFAULT)))))))),x_Symbol),
...
IIntegrate(10459,Int(Zeta(C2,Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Int(PolyGamma(C1,Plus(a,Times(b,x))),x),FreeQ(List(a,b),x))),
IIntegrate(10460,Int(Zeta(s_,Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10461,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Zeta(C2,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Int(Times(Power(Plus(c,Times(d,x)),m),PolyGamma(C1,Plus(a,Times(b,x)))),x),And(FreeQ(List(a,b,c,d),x),RationalQ(m)))),
IIntegrate(10462,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Zeta(s_,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10463,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Zeta(s_,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10464,Int(PolyLog(n_,Times(a_DEFAULT,Power(Times(b_DEFAULT,Power(x_,p_DEFAULT)),q_DEFAULT))),x_Symbol),
...
IIntegrate(10465,Int(PolyLog(n_,Times(a_DEFAULT,Power(Times(b_DEFAULT,Power(x_,p_DEFAULT)),q_DEFAULT))),x_Symbol),
...
IIntegrate(10466,Int(Times(Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),-1),PolyLog(n_,Times(c_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),p_DEFAULT)))),x_Symbol),
...
IIntegrate(10467,Int(Times(Power(x_,-1),PolyLog(n_,Times(a_DEFAULT,Power(Times(b_DEFAULT,Power(x_,p_DEFAULT)),q_DEFAULT)))),x_Symbol),
    Condition(Simp(Times(PolyLog(Plus(n,C1),Times(a,Power(Times(b,Power(x,p)),q))),Power(Times(p,q),-1)),x),FreeQ(List(a,b,n,p,q),x))),
IIntegrate(10468,Int(Times(Power(Times(d_DEFAULT,x_),m_DEFAULT),PolyLog(n_,Times(a_DEFAULT,Power(Times(b_DEFAULT,Power(x_,p_DEFAULT)),q_DEFAULT)))),x_Symbol),
...
IIntegrate(10469,Int(Times(Power(Times(d_DEFAULT,x_),m_DEFAULT),PolyLog(n_,Times(a_DEFAULT,Power(Times(b_DEFAULT,Power(x_,p_DEFAULT)),q_DEFAULT)))),x_Symbol),
...
IIntegrate(10470,Int(Times(Power(x_,-1),Power(Log(Times(c_DEFAULT,Power(x_,m_DEFAULT))),r_DEFAULT),PolyLog(n_,Times(a_DEFAULT,Power(Times(b_DEFAULT,Power(x_,p_DEFAULT)),q_DEFAULT)))),x_Symbol),
...
IIntegrate(10471,Int(PolyLog(n_,Times(c_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),p_DEFAULT))),x_Symbol),
...
IIntegrate(10472,Int(Times(Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),-1),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10473,Int(Times(Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),-1),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10474,Int(Times(Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),m_DEFAULT),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10475,Int(Times(Power(x_,m_DEFAULT),PolyLog(n_,Times(c_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),p_DEFAULT)))),x_Symbol),
...
IIntegrate(10476,Int(Times(Plus(g_DEFAULT,Times(h_DEFAULT,Log(Times(f_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT))))),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
