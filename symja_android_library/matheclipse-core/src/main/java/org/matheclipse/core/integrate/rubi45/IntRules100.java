...
ISetDelayed(Int(Times(Power(Plus(Times(Sinh(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),b_DEFAULT),a_),pn_),Power(Plus(Times(f_DEFAULT,x_),pe_DEFAULT),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Cosh(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),b_DEFAULT),a_),pn_),Power(Plus(Times(f_DEFAULT,x_),pe_DEFAULT),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Sinh(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),b_DEFAULT),a_),CN2),x_),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Cosh(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),b_DEFAULT),a_),CN2),x_),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Sinh(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),b_DEFAULT),a_),pn_),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Cosh(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),b_DEFAULT),a_),pn_),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Cosh(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),Sinh(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),b_DEFAULT),a_),pn_DEFAULT),Power(Plus(Times(f_DEFAULT,x_),pe_DEFAULT),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Sqr(Sinh(Plus(Times(x_,pd_DEFAULT),c_DEFAULT))),b_DEFAULT),a_),pn_),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Sqr(Cosh(Plus(Times(x_,pd_DEFAULT),c_DEFAULT))),b_DEFAULT),a_),pn_),Power(x_,m_DEFAULT)),x_Symbol),
