...
/**
 * Integrate a function using a 7-point adaptive Newton-Cotes quadrature rule. This algorithm is a
 * translation of the corresponding subroutine dqnc79 from the SLATEC library.
 */
public final class NewtonCotes extends Quadrature {
  ...
  private final QuadratureResult dqnc79(final DoubleUnaryOperator fun, final double a,
      final double b) {
    double ae, area, bank, blocal, c, ce, ee, ef, eps, q13, q7, q7l, sq2 = Constants.SQRT2, test,
        tol, vr, ans;
    int i, kml = 7, kmx = 5000, l, lmn, lmx, nbits, nib, nlmn = 2, nlmx, fev = 0, k = 0;
    final double[] aa = new double[100], f = new double[14], f1 = new double[100],
        f2 = new double[100], f3 = new double[100], f4 = new double[100], f5 = new double[100],
        f6 = new double[100], f7 = new double[100], hh = new double[100], q7r = new double[100],
        vl = new double[100];
