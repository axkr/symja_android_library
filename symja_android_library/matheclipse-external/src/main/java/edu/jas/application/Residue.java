...
/**
 * Residue ring element based on GenPolynomial with RingElem interface. Objects of this class are
 * (nearly) immutable.
 *
 * @author Heinz Kredel
 */
public class Residue<C extends GcdRingElem<C>> implements GcdRingElem<Residue<C>> {
  ...
  /**
   * The constructor creates a Residue object from a ring factory, a polynomial and an indicator if
   * a is a unit.
   *
   * @param r residue ring factory.
   * @param a polynomial.
