...
IIntegrate(2723,Integrate(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,Power(F_,v_)),Times(b_DEFAULT,Power(F_,w_))),n_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Plus(Times(a,Power(FSymbol,v)),Times(b,Power(FSymbol,w))),n),Power(Times(Power(FSymbol,Times(n,v)),Power(Plus(a,Times(b,Power(FSymbol,ExpandToSum(Subtract(w,v),x)))),n)),CN1)),Integrate(Times(u,Power(FSymbol,Times(n,v)),Power(Plus(a,Times(b,Power(FSymbol,ExpandToSum(Subtract(w,v),x)))),n)),x),x),x),And(FreeQ(List(FSymbol,a,b,n),x),Not(IntegerQ(n)),LinearQ(list(v,w),x)))),
IIntegrate(2724,Integrate(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,Power(F_,v_)),Times(b_DEFAULT,Power(G_,w_))),n_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Plus(Times(a,Power(FSymbol,v)),Times(b,Power(GSymbol,w))),n),Power(Times(Power(FSymbol,Times(n,v)),Power(Plus(a,Times(b,Exp(ExpandToSum(Subtract(Times(Log(GSymbol),w),Times(Log(FSymbol),v)),x)))),n)),CN1)),Integrate(Times(u,Power(FSymbol,Times(n,v)),Power(Plus(a,Times(b,Exp(ExpandToSum(Subtract(Times(Log(GSymbol),w),Times(Log(FSymbol),v)),x)))),n)),x),x),x),And(FreeQ(List(FSymbol,GSymbol,a,b,n),x),Not(IntegerQ(n)),LinearQ(list(v,w),x)))),
...
IIntegrate(2733,Integrate(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),x_Symbol),
    Condition(Subtract(Simp(Times(x,Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p)),x),Simp(Dist(Times(b,n,p),Integrate(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,CN1)),x),x),x)),And(FreeQ(List(a,b,c,n),x),GtQ(p,C0),IntegerQ(Times(C2,p))))),
IIntegrate(2734,Integrate(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_),x_Symbol),
    Condition(Subtract(Simp(Times(x,Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,C1)),Power(Times(b,n,Plus(p,C1)),CN1)),x),Simp(Dist(Power(Times(b,n,Plus(p,C1)),CN1),Integrate(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,C1)),x),x),x)),And(FreeQ(List(a,b,c,n),x),LtQ(p,CN1),IntegerQ(Times(C2,p))))),
...
IIntegrate(2736,Integrate(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_),x_Symbol),
    Condition(Simp(Dist(Power(Times(n,Power(c,Power(n,CN1))),CN1),Subst(Integrate(Times(Exp(Times(x,Power(n,CN1))),Power(Plus(a,Times(b,x)),p)),x),x,Log(Times(c,Power(x,n)))),x),x),And(FreeQ(List(a,b,c,p),x),IntegerQ(Power(n,CN1))))),
IIntegrate(2737,Integrate(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_),x_Symbol),
    Condition(Simp(Dist(Times(x,Power(Times(n,Power(Times(c,Power(x,n)),Power(n,CN1))),CN1)),Subst(Integrate(Times(Exp(Times(x,Power(n,CN1))),Power(Plus(a,Times(b,x)),p)),x),x,Log(Times(c,Power(x,n)))),x),x),FreeQ(List(a,b,c,n,p),x))),
...
IIntegrate(2739,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,CN1)),x_Symbol),
    Condition(Simp(Dist(Power(Times(b,n),CN1),Subst(Integrate(Power(x,p),x),x,Plus(a,Times(b,Log(Times(c,Power(x,n)))))),x),x),FreeQ(List(a,b,c,n,p),x))),
