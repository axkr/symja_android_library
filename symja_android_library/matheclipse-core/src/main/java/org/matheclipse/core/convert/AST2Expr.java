...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "KroneckerSymbol", "Kurtosis", "Labeled", "LaguerreL", "LambertW", "LaplaceTransform",
      "Laplacian", "LaplacianPDETerm", "Last", "LCM", "LeafCount", "LeastSquares", "LegendreP",
      "LegendreQ", "Length", "LengthWhile", "LerchPhi", "Less", "LessEqual", "LessEqualThan",
      "LessThan", "LetterCounts", "LetterNumber", "LetterQ", "Level", "LevelQ", "LeviCivitaTensor",
      "Lighter", "Limit", "Line", "LinearModelFit", "LinearOptimization", "LinearProgramming",
      ...
      "NDSolveValue", "Nearest", "NearestTo", "Needs", "Negative", "NegativeDefiniteMatrixQ",
      ...
      "NSolveValues", "NSum", "NullSpace", "NumberDigit", "NumberFieldRootsOfUnity",
      ...
      "QuantityQ", "QuantityUnit", "QuarticSolve", "Quartiles", "Query", "Quiet", "Quit",
      ...
      "RankDecomposition", "RankedMax", "RankedMin", "Rational", "Rationalize", "Ratios",
      "RawBackquote", "RawBoxes", "Re", "Read", "ReadLine", "ReadList", "ReadString", "RealAbs",
      ...
      "RegionNearest", "RegionNearestFunction", "RegionWithin", "RegularExpression",
      ...
      "SokalSneathDissimilarity", "Solve", "SolveAlways", "SolveValues", "Sort", "SortBy", "Sow",
      "Span", "SparseArray", "SparseArrayQ", "SpearmanRho", "SpecialsFreeQ", "Specularity",
