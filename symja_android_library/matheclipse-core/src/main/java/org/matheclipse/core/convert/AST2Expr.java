...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$BoxForms", "$CommandLine", "$ContextAliases",
      ...
      "AudioOverlay", "AudioTrim", "AutoAction", "AutoRemove", "AutorunSequencing", "AxisObject",
      ...
      "ColorDistance", "ColorNegate", "ColorQ", "ColorQuantize", "ColorReplace", "ColorRules",
      ...
      "DatasetTheme", "DataStructureQ", "DateBounds", "Dated", "DateDifference", "DatedUnit",
      ...
      "DateRange", "DateSelect", "DateString", "DateValue", "DateWithinQ", "DawsonF", "DayCount",
      ...
      "DeleteObject", "DeleteSmallComponents", "Delimiter", "Denominator", "DensityHistogram",
      "DensityPlot", "Deployed", "Depth", "Derivative", "DerivativeFilter", "DesignMatrix", "Det",
      ...
      "DirectionalLight", "Directive", "Directory", "DirectoryName", "DirectoryQ", "DirichletBeta",
      ...
      "DiskSegment", "Dispatch", "DisplayAllSteps", "DisplayForm", "DistanceTransform",
      "Distribute", "Distributed", "DistributionChart", "DistributionParameterQ", "Dithering",
      "Div", "Divide", "DivideBy", "Dividers", "Divides", "DivideSides", "Divisible", "Divisors",
      "DivisorSigma", "DivisorSum", "DMSList", "DMSString", "Do", "Dodecahedron", "Dot", "DotEqual",
      ...
      "DynamicLibraryExtension", "DynamicModule", "DynamicWrapper", "EasterSunday", "Echo",
      "EchoFunction", "EchoLabel", "EclipseType", "EdgeAdd", "EdgeChromaticNumber", "EdgeCount",
      "EdgeContract", "EdgeCoverQ", "EdgeDelete", "EdgeDetect", "EdgeForm", "EdgeLabelStyle",
      "EdgeList", "EdgeQ", "EdgeRules", "EdgeWeight", "EditDistance", "EffectiveInterest",
      "Eigensystem", "Eigenvalues", "EigenvectorCentrality", "Eigenvectors", "Element",
      "ElementData", "Eliminate", "Ellipsoid", "EllipticE", "EllipticExp", "EllipticF", "EllipticK",
      "EllipticLog", "EllipticPi", "EllipticTheta", "Empirical", "EmpiricalDistribution",
      "EmptyRegion", "Enabled", "End", "EndOfBuffer", "EndPackage", "EndTestSection",
      "EngineeringForm", "EnterExpressionPacket", "EnterTextPacket", "Entity", "EntityClass",
      "EntityList", "EntityProperty", "EntityValue", "Entropy", "EntropyFilter", "Environment",
      "Equal", "EqualTilde", "EqualTo", "Equilibrium", "Equivalent", "Erf", "Erfc", "Erfi",
      "ErlangDistribution", "Erosion", "EuclideanDistance", "EulerE", "EulerianGraphQ", "EulerPhi",
      ...
      "ExponentialPowerDistribution", "ExponentStep", "Export", "ExportByteArray", "ExportForm",
      "ExportString", "ExpressionGraph", "ExpToTrig", "ExtendedFullDefinition", "ExtendedGCD",
      "ExtentElementFunction", "ExtentMarkers", "Extract", "ExtractArchive", "ExtractPacletArchive",
      "FaceForm", "FaceGrids", "FaceGridsStyle", "Factor", "Factorial", "Factorial2",
      ...
      "Failure", "FailureQ", "Fibonacci", "FileBaseName", "FileByteCount", "FileDate",
      "FileExistsQ", "FileExtension", "FileNameDepth", "FileNameSetter", "FileNameSplit",
      "FileSize", "FileType", "FilledCurve", "FilledTorus", "FillingTransform", "Find",
      "FindAstroEvent", "FindClique", "FindDistributionParameters", "FindKClan", "FindKClique",
      "FindKClub", "FindKPlex", "FindMaximumFlow", "FindMoleculeSubstructure", "FindPlanarColoring",
      "FindPostmanTour", "FindSolarEclipse", "FindThreshold", "FiniteGroupCount",
      ...
      "FoldList", "FontSlant", "FontTracking", "FontWeight", "For", "ForAll", "Format",
      ...
      "FractionalPart", "FractionBox", "Framed", "FrameListVideo", "FrameRate",
      ...
      "IndependentUnit", "IndependentUnitDimension", "IndependentVertexSetQ", "Indexed",
      "IndexGraph", "Inequality", "InexactNumberQ", "InfiniteLine", "InfinitePlane", "Infix",
      "InflationAdjust", "Information", "Initialization", "Inner", "Inpaint", "Input", "InputField",
      "InputForm", "InputNamePacket", "InputStream", "InputString", "Insert", "InstallJava",
      "InstanceOf", "IntegerDigits", "IntegerExponent", "IntegerLength", "IntegerName",
      "IntegerPart", "IntegerPartitions", "IntegerQ", "Integrate", "Interleaving",
      "InterpolatingFunction", "InterpolatingPolynomial", "Interpolation", "Interpretation",
      ...
      "ReadByteArray", "ReadLine", "ReadList", "ReadString", "RealAbs", "RealDigits", "RealSign",
      ...
      "Resampling", "Rescale", "ResetDirectory", "Residue", "Resolve", "ResourceData", "Rest",
      ...
      "RidgeFilter", "RiemannSiegelTheta", "Riffle", "RightArrow", "RightArrowBar",
      ...
      "TranslationTransform", "Transliterate", "Transpose", "TreeForm", "TreeGraph", "TreeGraphQ",
      "TreePlot", "Triangle", "TriangleCenter", "TriangleConstruct", "TriangleMeasurement",
      "TriangleWave", "TriangularDistribution", "TrigExpand", "TrigFactor", "Trigger", "TrigReduce",
      ...
      "URL", "URLBuild", "URLDecode", "URLDownload", "URLEncode", "URLFetch", "URLParse", "URLRead",
      "ValenceErrorHandling", "ValueFunction", "ValueQ", "Values", "VandermondeMatrix", "Variables",
      ...
      "WhiteCornerBracket", "WhittakerM", "WhittakerW", "WienerFilter",
      "WignerSemicircleDistribution", "WindowSize", "With", "WordBoundary", "WordCloud",
      "WordOrientation", "WordSelectionFunction", "WordSpacings", "Write", "WriteLine",
      "WriteString", "Wronskian", "Xnor", "Xor", "XYZColor", "Yesterday", "YuleDissimilarity",
