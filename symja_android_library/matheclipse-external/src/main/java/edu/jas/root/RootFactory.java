...
public class RootFactory {
   ...
   */
  public static <C extends GcdRingElem<C> & Rational> boolean isRoot(
      GenPolynomial<C> f, RealAlgebraicNumber<C> r) {
   ...
   */
  public static <C extends GcdRingElem<C> & Rational> boolean isRoot(
      GenPolynomial<C> f, ComplexAlgebraicNumber<C> r) {
   ...
   * @return true, if f(r) == 0, else false;
   */
  public static <C extends GcdRingElem<C> & Rational> boolean isRootComplex(
      GenPolynomial<Complex<C>> f, ComplexAlgebraicNumber<C> r) {
    ComplexAlgebraicRing<C> cr = r.factory();
    GenPolynomialRing<ComplexAlgebraicNumber<C>> cfac =
        new GenPolynomialRing<ComplexAlgebraicNumber<C>>(cr, f.factory());
    GenPolynomial<ComplexAlgebraicNumber<C>> p;
   ...
   */
  public static <C extends GcdRingElem<C> & Rational> boolean isRealRoot(
      GenPolynomial<C> f, ComplexAlgebraicNumber<C> c, RealAlgebraicNumber<C> r) {
   ...
   */
  public static <C extends GcdRingElem<C> & Rational> boolean isRealRoot(
      GenPolynomial<C> f, Complex<BigDecimal> c, BigDecimal r, BigRational eps) {
    ...
    GenPolynomialRing<Complex<C>> cfac =
        new GenPolynomialRing<Complex<C>>(new ComplexRing<C>(f.ring.coFac), f.ring);
    GenPolynomial<Complex<C>> cf = PolyUtil.<C>complexFromAny(cfac, f);
    ComplexRing<BigDecimal> cd = new ComplexRing<BigDecimal>(e);
    GenPolynomialRing<Complex<BigDecimal>> rfac =
        new GenPolynomialRing<Complex<BigDecimal>>(cd, cf.ring);
  ...
  public static <C extends GcdRingElem<C> & Rational>
    ...
    SquarefreeAbstract<Complex<C>> engine =
        SquarefreeFactory.<Complex<C>>getImplementation(f.ring.coFac);
   ...
   */
  public static <C extends GcdRingElem<C> & Rational>
      List<ComplexAlgebraicNumber<C>> complexAlgebraicNumbersComplex(
   ...
   */
  public static <C extends GcdRingElem<C> & Rational> AlgebraicRoots<C> algebraicRoots(
      GenPolynomial<C> f) {
   ...
   * @return container of real and complex algebraic numbers which are roots of unity.
   */
  public static <C extends GcdRingElem<C> & Rational> AlgebraicRoots<C> rootsOfUnity(
      AlgebraicRoots<C> ar) {
   ...
   */
  public static <C extends GcdRingElem<C> & Rational> void rootRefine(
      AlgebraicRoots<C> a, BigRational eps) {
   ...
   */
  public static <C extends GcdRingElem<C> & Rational> DecimalRoots<C> decimalRoots(
   ...
   */
  public static <C extends GcdRingElem<C> & Rational> DecimalRoots<C> decimalRoots(
      AlgebraicRoots<C> ar, BigRational eps) {
