...
public class AST2Expr {
	...
	public final static String[] SYMBOL_STRINGS = { "$Aborted", "All", "Algebraics", "Automatic", "Booleans",
			"CharacterEncoding", "ComplexInfinity", "Catalan", "Complexes", "Constant", "Degree", "Disputed",
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AddTo", "AllTrue", "And",
			...
			"BesselJ", "BesselK", "BesselY", "Binomial", "BinomialDistribution", "Blank", "Block", "Boole", "BooleanQ",
			...
			"ChessboardDistance", "ChineseRemainder", "Chop", "Clear", "ClearAll", "Coefficient", "CoefficientList",
			"CoefficientRules", "Colon", "Collect", "Commonest", "Complement", "Compile", "Complex", "ComplexExpand",
			"ComplexInfinity", "ComposeList", "Composition", "CompoundExpression", "Condition", "Conjugate",
			...
			"DeleteDuplicates", "Denominator", "Depth", "Derivative", "DesignMatrix", "Det", "DiagonalMatrix",
			"DiceDissimilarity", "DigitQ", "Dimensions", "DiracDelta", "DiscreteDelta", "DirectedInfinity", "Direction",
			...
			"Erfc", "Erfi", "EuclideanDistance", "EulerE", "EulerPhi", "EvenQ", "ExactNumberQ", "Except", "Exists",
			"Exp", "Expand", "ExpandAll", "ExpIntegralE", "ExpIntegralEi", "Exponent", "Export", "ExtendedGCD",
			"Extract", "Factor", "Factorial", "Factorial2", "FactorInteger", "FactorSquareFree", "FactorSquareFreeList",
			"FactorTerms", "Flatten", "Fibonacci", "FindInstance", "FindRoot", "First", "Fit", "FixedPoint",
			"FixedPointList", "Floor", "Fold", "FoldList", "For", "ForAll", "FractionalPart", "FreeQ", "FresnelC",
			"FresnelS", "FrobeniusSolve", "FromCharacterCode", "FromContinuedFraction", "FromPolarCoordinates",
			"FullForm", "FullSimplify", "Function", "Gamma", "Gather", "GCD", "GeometricMean", "Get", "Graphics",
			"Graphics3D", "Graphics3D", "Greater", "GreaterEqual", "GroebnerBasis", "Haversine", "HarmonicNumber",
			"Head", "HeavisideTheta", "HermiteH", "HilbertMatrix", "Hold", "HoldForm", "Horner", "HornerForm",
			"HurwitzZeta", "HypergeometricDistribution", "HypergeometricPFQ", "Hypergeometric1F1", "Hypergeometric2F1",
			"Identity", "IdentityMatrix", "If", "Im", "Implies", "Import", "Increment", "Inner", "Insert",
			"InexactNumberQ", "Interval", "IntegerExponent", "IntegerLength", "IntegerPart", "IntegerPartitions",
			...
			"LegendreP", "Length", "Less", "LessEqual", "LetterQ", "Level", "LevelQ", "Limit", "Line", "LinearModelFit",
			"LinearProgramming", "LinearSolve", "LiouvilleLambda", "List", "ListQ", "Log", "Log2", "Log10", "LogGamma",
			...
			"MatrixQ", "MatrixRank", "Max", "Mean", "Median", "MemberQ", "MeshRange", "MessageName", "Min",
			"MinimalPolynomial", "Minus", "Missing", "MissingQ", "Mod", "Module", "MoebiusMu", "MonomialList", "Most",
			"Multinomial", "MultiplicativeOrder", "Names", "Nand", "NDSolve", "Nearest", "Negative", "Nest", "NestList",
			"NestWhile", "NestWhileList", "NextPrime", "NFourierTransform", "NIntegrate", "NMaximize", "NMinimize",
			...
			"NumberQ", "Numerator", "NumericQ", "OddQ", "Operate", "Optional", "Options", "Or", "Order", "OrderedQ",
			"Out", "Outer", "Package", "PadLeft", "PadRight", "ParametricPlot", "Part", "Partition", "PartitionsP",
			"PartitionsQ", "Pattern", "PatternTest", "PDF", "Permutations", "Piecewise", "Plot", "PlotRange", "Plot3D",
			"Plus", "Pochhammer", "PoissonDistribution", "PolyGamma", "Polygon", "PolyLog", "PolynomialExtendedGCD",
			...
			"PrimePowerQ", "PrimeQ", "PrimitiveRoots", "Print", "Product", "ProductLog", "PseudoInverse", "Put",
			"QRDecomposition", "Quiet", "Quit", "Quotient", "RandomInteger", "RandomReal", "RandomSample", "Range",
			"Rational", "Rationalize", "Re", "RealNumberQ", "Reap", "Reduce", "Refine", "Repeated", "RepeatedNull",
			"Replace", "ReplaceAll", "ReplaceList", "ReplacePart", "ReplaceRepeated", "Rest", "Resultant", "Return",
			"Reverse", "Riffle", "RogersTanimotoDissimilarity", "RootIntervals", "Root", "RootOf", "Roots",
			"RussellRaoDissimilarity", "Surd", "RotateLeft", "RotateRight", "Round", "RowReduce", "Rule", "RuleDelayed",
			"SameQ", "SatisfiableQ", "Scan", "Sec", "Sech", "Select", "Sequence", "Series", "SeriesData", "Set",
			...
			"StruveH", "StruveL", "Subfactorial", "Subscript", "Subsuperscript", "Subsets", "SubtractFrom", "Sum",
			"Superscript", "SurfaceGraphics", "Switch", "SyntaxLength", "SymbolName", "SymbolQ", "SyntaxQ", "Table",
	...
	private IExpr convertNode(ASTNode node, EvalEngine engine) throws ConversionException {
		...
		if (node instanceof Pattern3Node) {
			...
			return F.$ps((ISymbol) convertNode(sn, engine), convertNode(p3n.getConstraint(), engine), p3n.isDefault(),
					true);
		}
		if (node instanceof Pattern2Node) {
			final Pattern2Node p2n = (Pattern2Node) node;
			SymbolNode sn = p2n.getSymbol();
			return F.$ps((ISymbol) convertNode(sn, engine), convertNode(p2n.getConstraint(), engine), p2n.isDefault(),
					false);
		}
