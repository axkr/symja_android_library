...
public class FDUtil {
   ...
   * @return remainder with ore(ldcf(S)<sup>m'</sup>) P = quotient * S + remainder. m' &le;
   *     deg(P)-deg(S)
   ...
   * @param P GenSolvablePolynomial.
   * @param S nonzero GenSolvablePolynomial.
   * @return remainder with P ore(ldcf(S)<sup>m'</sup>) = S * quotient + remainder. m' &le;
   *     deg(P)-deg(S)
   * @see edu.jas.poly.GenPolynomial#remainder(edu.jas.poly.GenPolynomial).
   */
  @SuppressWarnings("unchecked")
   ...
   * @param P GenSolvablePolynomial.
   * @param S nonzero GenSolvablePolynomial.
   * @return quotient with ore(ldcf(S)<sup>m'</sup>) P = quotient * S + remainder. m' &le;
   *     deg(P)-deg(S)
  ...
  /**
   * GenSolvablePolynomial right sparse pseudo quotient for univariate polynomials or exact
   * division.
   *
   * @param <C> coefficient type.
   * @param P GenSolvablePolynomial.
   * @param S nonzero GenSolvablePolynomial.
   * @return quotient with P ore(ldcf(S)<sup>m'</sup>) = S * quotient + remainder. m' &le;
   *     deg(P)-deg(S)
   * @see edu.jas.poly.GenPolynomial#divide(edu.jas.poly.GenPolynomial).
   */
  ...
  /**
   * GenSolvablePolynomial sparse pseudo quotient and remainder for univariate polynomials or exact
   * division.
   *
   * @param <C> coefficient type.
   * @param P GenSolvablePolynomial.
   * @param S nonzero GenSolvablePolynomial.
   * @return [ quotient, remainder ] with ore(ldcf(S)<sup>m'</sup>) P = quotient * S + remainder. m'
   *     &le; deg(P)-deg(S)
   * @see edu.jas.poly.GenPolynomial#divide(edu.jas.poly.GenPolynomial).
   */
  @SuppressWarnings("unchecked")
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<C>[] leftBasePseudoQuotientRemainder(
          GenSolvablePolynomial<C> P, GenSolvablePolynomial<C> S) {
    if (S == null || S.isZERO()) {
   ...
   * @param P GenSolvablePolynomial.
   * @param S nonzero GenSolvablePolynomial.
   * @return [ quotient, remainder ] with P ore(ldcf(S)<sup>m'</sup>) = S * quotient + remainder. m'
   *     &le; deg(P)-deg(S)
   * @see edu.jas.poly.GenPolynomial#divide(edu.jas.poly.GenPolynomial).
   */
  @SuppressWarnings("unchecked")
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<C>[] rightBasePseudoQuotientRemainder(
          GenSolvablePolynomial<C> P, GenSolvablePolynomial<C> S) {
    if (S == null || S.isZERO()) {
      throw new ArithmeticException(P.toString() + " division by zero " + S);
    }
   ...
   * @see edu.jas.poly.GenPolynomial#remainder(edu.jas.poly.GenPolynomial). <b>Note:</b> not always
  ...
  public static <C extends GcdRingElem<C>> boolean isRecursivePseudoQuotientRemainder(
    ...
    GenSolvablePolynomial<GenPolynomial<C>> D =
        (GenSolvablePolynomial<GenPolynomial<C>>) Pa.subtract(Rb);
    if (D.isZERO()) {
      return true;
    }
    if (debug) {
   ...
   * @see
   *     edu.jas.poly.PolyUtil#recursiveSparsePseudoRemainder(edu.jas.poly.GenPolynomial,edu.jas.poly.GenPolynomial)
   *     .
   */
  @SuppressWarnings("unchecked")
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<GenPolynomial<C>> recursiveSparsePseudoRemainder(
   ...
   */
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<GenPolynomial<C>> recursivePseudoQuotient(
          GenSolvablePolynomial<GenPolynomial<C>> P, GenSolvablePolynomial<GenPolynomial<C>> S) {
  ...
  @SuppressWarnings("unchecked")
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<GenPolynomial<C>>[] recursivePseudoQuotientRemainder(
          GenSolvablePolynomial<GenPolynomial<C>> P, GenSolvablePolynomial<GenPolynomial<C>> S) {
    if (S == null || S.isZERO()) {
  ...
  /**
   * Is recursive GenSolvablePolynomial right pseudo quotient and remainder. For recursive
   * polynomials.
   *
   * @param <C> coefficient type.
   * @param P recursive GenSolvablePolynomial.
   ...
   */
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<GenPolynomial<C>> recursiveRightSparsePseudoRemainder(
          GenSolvablePolynomial<GenPolynomial<C>> P, GenSolvablePolynomial<GenPolynomial<C>> S) {
   ...
   */
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<GenPolynomial<C>> recursiveRightPseudoQuotient(
          GenSolvablePolynomial<GenPolynomial<C>> P, GenSolvablePolynomial<GenPolynomial<C>> S) {
   ...
   * polynomials. <b>Note:</b> uses right multiplication of P by ldcf(S), not always applicable.
   *
   * @param <C> coefficient type.
   * @param P recursive GenSolvablePolynomial.
   * @param S nonzero recursive GenSolvablePolynomial.
  ...
  @SuppressWarnings("unchecked")
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<GenPolynomial<C>>[] recursiveRightPseudoQuotientRemainder(
          GenSolvablePolynomial<GenPolynomial<C>> P, GenSolvablePolynomial<GenPolynomial<C>> S) {
    if (S == null || S.isZERO()) {
      throw new ArithmeticException(P + " division by zero " + S);
    }
  ...
  /**
   * GenSolvablePolynomial recursive quotient for recursive polynomials and exact division by
  ...
  @SuppressWarnings("unchecked")
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<GenPolynomial<C>> recursiveDivideRightEval(
  ...
  /**
   * GenSolvablePolynomial left recursive quotient for recursive polynomials and exact division by
   * coefficient ring element.
   *
   * @param <C> coefficient type.
   * @param P recursive GenSolvablePolynomial.
  ...
  public static <C extends GcdRingElem<C>> GenSolvablePolynomial<GenPolynomial<C>> recursiveDivide(
    ...
    GenSolvablePolynomialRing<GenPolynomial<C>> rfac =
        (GenSolvablePolynomialRing<GenPolynomial<C>>) P.ring;
    ...
    while (!p.isZERO()) {
      ...
      if (!c1.equals(r.leadingBaseCoefficient())) {
        System.out.println(
            "recRightDivide: lc(r) = " + r.leadingBaseCoefficient() + ", c1 = " + c1);
        System.out.println(
            "recRightDivide: lc(r) = " + c.multiply(s) + ", c = " + c + ", s = " + s);
  ...
  */
  ...
  /**
   * GenSolvablePolynomial recursive quotient for recursive polynomials and partial right exact
  ...
  @SuppressWarnings({"unchecked", "cast"})
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<GenPolynomial<C>> recursiveRightDivide(
          GenSolvablePolynomial<GenPolynomial<C>> P, GenSolvablePolynomial<C> s) {
    if (s == null || s.isZERO()) {
      throw new ArithmeticException("division by zero " + P + ", " + s);
    }
    ...
    while (!p.isZERO()) {
      ...
      if (!a.equals(r.leadingBaseCoefficient())) {
        System.out.println(
            "recRightDivide: a   = " + a + ", lc(r) = " + r.leadingBaseCoefficient());
  ...
  /**
   * GenSolvablePolynomial recursive quotient for recursive polynomials and partial left exact
   * division by coefficient ring element.
   *
   * @param <C> coefficient type.
   * @param P recursive GenSolvablePolynomial.
  ...
  @SuppressWarnings({"unchecked", "cast"})
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<GenPolynomial<C>> recursiveLeftDivide(
          GenSolvablePolynomial<GenPolynomial<C>> P, GenSolvablePolynomial<C> s) {
    if (s == null || s.isZERO()) {
      throw new ArithmeticException("division by zero " + P + ", " + s);
    }
   ...
   * polynomial with integral solvable polynomial coefficients by multiplication with the lcm(??) of
   * the numerators of the rational function coefficients.
   *
  ...
  @SuppressWarnings({"unchecked", "cast"})
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<GenPolynomial<C>> integralFromQuotientCoefficients(
   ...
   * Integral solvable polynomial from solvable rational function coefficients. Represent as
   * polynomial with integral solvable polynomial coefficients by multiplication with the lcm(??) of
   * the numerators of the solvable rational function coefficients.
   *
   * @param fac result polynomial factory.
   * @param L list of polynomials with solvable rational function coefficients to be converted.
   * @return list of polynomials with integral solvable polynomial coefficients.
   */
  @SuppressWarnings("unchecked")
  public static <C extends GcdRingElem<C>>
      List<GenSolvablePolynomial<GenPolynomial<C>>> integralFromQuotientCoefficients(
          GenSolvablePolynomialRing<GenPolynomial<C>> fac,
          Collection<GenSolvablePolynomial<SolvableQuotient<C>>> L) {
    if (L == null) {
      return null;
    }
    List<GenSolvablePolynomial<GenPolynomial<C>>> list =
        new ArrayList<GenSolvablePolynomial<GenPolynomial<C>>>(L.size());
   ...
   *
   * @param fac result polynomial factory.
   * @param A polynomial with integral solvable polynomial coefficients to be converted.
   * @return polynomial with type SolvableQuotient<C> coefficients.
   */
  @SuppressWarnings("unchecked")
  public static <C extends GcdRingElem<C>>
      GenSolvablePolynomial<SolvableQuotient<C>> quotientFromIntegralCoefficients(
   ...
   *
   * @param fac result polynomial factory.
   * @param L list of polynomials with integral solvable polynomial coefficients to be converted.
   * @return list of polynomials with type SolvableQuotient<C> coefficients.
   */
  public static <C extends GcdRingElem<C>>
      List<GenSolvablePolynomial<SolvableQuotient<C>>> quotientFromIntegralCoefficients(
          GenSolvablePolynomialRing<SolvableQuotient<C>> fac,
          Collection<GenSolvablePolynomial<GenPolynomial<C>>> L) {
    if (L == null) {
      return null;
    }
    List<GenSolvablePolynomial<SolvableQuotient<C>>> list =
        new ArrayList<GenSolvablePolynomial<SolvableQuotient<C>>>(L.size());
