...
SetDelayed(Int(Times(Power(x_,$p(m,true)),Times(Power(ProductLog(Times($p(a,true),Power(x_,n_))),p_),Power(Plus(C1,ProductLog(Times($p(a,true),Power(x_,n_)))),CN1))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),Times(Power(ProductLog(Times($p(a,true),Power(x_,n_))),$p(p,true)),Power(Plus(C1,ProductLog(Times($p(a,true),Power(x_,n_)))),CN1))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Times(CN1,ProductLog(Plus($p(a,true),Times($p(b,true),x_)))),$p(p,true)),Power(Plus(C1,ProductLog(Plus($p(a,true),Times($p(b,true),x_)))),CN1)),$p(x,SymbolHead)),
    Condition(Times(Gamma(Plus(p,C1),Times(CN1,ProductLog(Plus(a,Times(b,x))))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Power(Times(CN1,ProductLog(Plus($p(a,true),Times($p(b,true),x_)))),p_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(x_,CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int($(Derivative(f_),x_),$p(x,SymbolHead)),
    Condition($(f,x),FreeQ(f,x))),
SetDelayed(Int($($(Derivative(n_),f_),x_),$p(x,SymbolHead)),
    Condition($($(Derivative(Plus(n,Times(CN1,C1))),f),x),FreeQ(List(f,n),x))),
SetDelayed(Int(Times(Plus(Times($(Derivative(f_),x_),$(g_,x_)),Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_))),Power(Power($(g_,x_),C2),CN1)),$p(x,SymbolHead)),
    Condition(Times($(f,x),Power($(g,x),CN1)),FreeQ(List(f,g),x))),
SetDelayed(Int(Times(Plus(Times($(Derivative(f_),x_),$(g_,x_)),Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_))),Power(Times($(f_,x_),$(g_,x_)),CN1)),$p(x,SymbolHead)),
    Condition(Log(Times($(f,x),Power($(g,x),CN1))),FreeQ(List(f,g),x))),
SetDelayed(Int(Times(Plus(Times($(Derivative(f_),x_),$(g_,x_)),Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_))),Power(Plus(Power($(f_,x_),C2),Power($(g_,x_),C2)),CN1)),$p(x,SymbolHead)),
    Condition(ArcTan(Times($(f,x),Power($(g,x),CN1))),FreeQ(List(f,g),x))),
SetDelayed(Int(Times(Plus(Times($(Derivative(f_),x_),$(g_,x_)),Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_))),Power(Plus(Power($(f_,x_),C2),Times(CN1,Power($(g_,x_),C2))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(x_,$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,v_),$p(x,SymbolHead)),
    Module(List(Set(z,DerivativeDivides(v,u,x))),Condition(Dist(z,Subst(Int(x,x),x,v)),Not(FalseQ(z))))),
SetDelayed(Int(Times(Times(Power($p("u1"),n_),Power($p("u2"),n_)),v_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times(Power(x_,$p(m,true)),Power(u_,$p(n,true))),v_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(Plus($p(a,true),Times($p(b,true),x_)),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(LinearSinCosQ(Power(u_,$p(n,true)),$p(x,SymbolHead)),
...
SetDelayed(LinearSinhCoshQ(Power(u_,$p(n,true)),$p(x,SymbolHead)),
    And(And(And(IntIntegerQ(n),Greater(n,C0)),Or(SinhQ(u),CoshQ(u))),LinearQ(Part(u,C1),x))),
SetDelayed(Int(Times(u_,Sin(Times($p(c,true),Plus($p(a,true),Times($p(b,true),x_))))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Cos(Times($p(c,true),Plus($p(a,true),Times($p(b,true),x_))))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(Sec(Times($p(c,true),Plus($p(a,true),Times($p(b,true),x_)))),n_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(Csc(Times($p(c,true),Plus($p(a,true),Times($p(b,true),x_)))),n_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times(u_,Sec(Plus($p(a,true),Times($p(b,true),x_)))),Csc(Plus($p(a,true),Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Cos(Plus($p(a,true),Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Sinh(Times($p(c,true),Plus($p(a,true),Times($p(b,true),x_))))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Cosh(Times($p(c,true),Plus($p(a,true),Times($p(b,true),x_))))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(Sech(Times($p(c,true),Plus($p(a,true),Times($p(b,true),x_)))),n_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(Csch(Times($p(c,true),Plus($p(a,true),Times($p(b,true),x_)))),n_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times(u_,Sech(Plus($p(a,true),Times($p(b,true),x_)))),Csch(Plus($p(a,true),Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Cosh(Plus($p(a,true),Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times(Power(x_,$p(m,true)),Power(u_,Plus(CN1,Times($p(a,true),Power(x_,$p(m,true)))))),v_),$p(x,SymbolHead)),
...
SetDelayed(TryTanSubst(u_,$p(x,SymbolHead)),
...
SetDelayed(TryTanhSubst(u_,$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),Power(f_,Plus($p(a,true),Times($p(b,true),Power(x_,$p(n,true)))))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),Power($(f_,Plus($p(a,true),Times($p(b,true),Power(x_,n_)))),$p(p,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(Plus(a_,Times($p(b,true),Power(x_,n_))),m_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(Plus(a_,Times($p(b,true),x_)),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),Power(Plus(a_,Times($p(b,true),Power(Plus(c_,Times($p(d,true),x_)),n_))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(e_,Times($p(f,true),x_)),$p(m,true)),Power(Plus(a_,Times($p(b,true),Power(Plus(c_,Times($p(d,true),x_)),n_))),p_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus($p(a,true),Times($p(b,true),x_)),$p(m,true)),Power($(f_,Plus($p(c,true),Times($p(d,true),x_))),$p(p,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus($p(a,true),Times($p(b,true),x_)),m_),Power(Plus(Plus($p(c,true),Times($p(d,true),x_)),Times($p(e,true),Power(x_,C2))),n_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(u_,Power(x_,$p(p,true))),n_),v_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times(Power(x_,$p(m,true)),Power(Plus(u_,Power(x_,$p(p,true))),n_)),v_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Log(u_),Power(Plus(a_,Times($p(b,true),x_)),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus($p(a,true),Times($p(b,true),x_)),$p(m,true)),Log(u_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(v_,Log(u_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Times(x_,Power(Plus(a_,Times($p(b,true),Power(x_,C2))),CN1))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Times(Power(v_,$p(m,true)),Power(Plus(Plus(a_,Times($p(b,true),v_)),Times($p(c,true),w_)),CN1))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Plus($p(d,true),Times($p(e,true),v_)),Power(Plus(Plus(a_,Times($p(b,true),v_)),Times($p(c,true),w_)),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(Plus(Plus(a_,Times($p(b,true),v_)),Times($p(c,true),w_)),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(Times(Times(Power(v_,$p(m,true)),Power(w_,$p(n,true))),Power(t_,$p(q,true))),p_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Times(Power(x_,$p(m,true)),Power(Plus(a_,Times($p(b,true),Power(x_,n_))),CN1))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(Plus(a_,Times($p(b,true),Power(x_,n_))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Times(Power(v_,m_),Power(Plus(a_,Times($p(b,true),Power(v_,n_))),CN1))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(Plus(a_,Times($p(b,true),Power(v_,n_))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(Plus(a_,Times($p(b,true),Power(v_,n_))),m_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(Plus(Plus(a_,Times($p(b,true),v_)),Times($p(c,true),w_)),m_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(Power(v_,m_),p_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(Times(a_,Power(v_,$p(m,true))),p_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(Times(Times($p(a,true),Power(v_,$p(m,true))),Power(w_,$p(n,true))),p_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(Times(Power(v_,$p(m,true)),Power(w_,$p(n,true))),p_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times($p(u,true),Power(v_,m_)),Power(w_,n_)),$p(x,SymbolHead)),
