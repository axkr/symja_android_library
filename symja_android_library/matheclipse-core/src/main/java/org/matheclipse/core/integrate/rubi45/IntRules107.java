...
ISetDelayed(Int(Times(Power(Plus($p("A",true),Times($p("B",true),x_),Times($p("C",true),Sqr(x_))),p_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSin(Plus(c_,Times(d_DEFAULT,x_))))),n_DEFAULT)),x_Symbol),
    Condition(Times(Power(d,-1),Subst(Int(Times(Power(Plus(Times(CN1,$s("C"),Power(d,-2)),Times($s("C"),Power(d,-2),Sqr(x))),p),Power(Plus(a,Times(b,ArcSin(x))),n)),x),x,Plus(c,Times(d,x)))),And(And(FreeQ(List(a,b,c,d,$s("A"),$s("B"),$s("C"),n,p),x),ZeroQ(Plus(Times($s("B"),Plus(C1,Negate(Sqr(c)))),Times(C2,$s("A"),c,d)))),ZeroQ(Plus(Times(C2,c,$s("C")),Times(CN1,$s("B"),d)))))),
ISetDelayed(Int(Times(Power(Plus($p("A",true),Times($p("B",true),x_),Times($p("C",true),Sqr(x_))),p_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCos(Plus(c_,Times(d_DEFAULT,x_))))),n_DEFAULT)),x_Symbol),
    Condition(Times(Power(d,-1),Subst(Int(Times(Power(Plus(Times(CN1,$s("C"),Power(d,-2)),Times($s("C"),Power(d,-2),Sqr(x))),p),Power(Plus(a,Times(b,ArcCos(x))),n)),x),x,Plus(c,Times(d,x)))),And(And(FreeQ(List(a,b,c,d,$s("A"),$s("B"),$s("C"),n,p),x),ZeroQ(Plus(Times($s("B"),Plus(C1,Negate(Sqr(c)))),Times(C2,$s("A"),c,d)))),ZeroQ(Plus(Times(C2,c,$s("C")),Times(CN1,$s("B"),d)))))),
ISetDelayed(Int(Times(Power(Plus($p("A",true),Times($p("B",true),x_),Times($p("C",true),Sqr(x_))),p_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSin(Plus(c_,Times(d_DEFAULT,x_))))),n_DEFAULT),Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
    Condition(Times(Power(d,-1),Subst(Int(Times(Power(Plus(Times(Plus(Times(d,e),Times(CN1,c,f)),Power(d,-1)),Times(f,x,Power(d,-1))),m),Power(Plus(Times(CN1,$s("C"),Power(d,-2)),Times($s("C"),Power(d,-2),Sqr(x))),p),Power(Plus(a,Times(b,ArcSin(x))),n)),x),x,Plus(c,Times(d,x)))),And(And(FreeQ(List(a,b,c,d,e,f,$s("A"),$s("B"),$s("C"),m,n,p),x),ZeroQ(Plus(Times($s("B"),Plus(C1,Negate(Sqr(c)))),Times(C2,$s("A"),c,d)))),ZeroQ(Plus(Times(C2,c,$s("C")),Times(CN1,$s("B"),d)))))),
ISetDelayed(Int(Times(Power(Plus($p("A",true),Times($p("B",true),x_),Times($p("C",true),Sqr(x_))),p_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCos(Plus(c_,Times(d_DEFAULT,x_))))),n_DEFAULT),Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
    Condition(Times(Power(d,-1),Subst(Int(Times(Power(Plus(Times(Plus(Times(d,e),Times(CN1,c,f)),Power(d,-1)),Times(f,x,Power(d,-1))),m),Power(Plus(Times(CN1,$s("C"),Power(d,-2)),Times($s("C"),Power(d,-2),Sqr(x))),p),Power(Plus(a,Times(b,ArcCos(x))),n)),x),x,Plus(c,Times(d,x)))),And(And(FreeQ(List(a,b,c,d,e,f,$s("A"),$s("B"),$s("C"),m,n,p),x),ZeroQ(Plus(Times($s("B"),Plus(C1,Negate(Sqr(c)))),Times(C2,$s("A"),c,d)))),ZeroQ(Plus(Times(C2,c,$s("C")),Times(CN1,$s("B"),d))))))
  );
}
