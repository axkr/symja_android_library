...
public class SpecialFunctions extends AbstractRubiTestCase {
	...
	public void test0019() {
		check("Integrate[(E^(c + b^2*x^2)*Erf[b*x])/x, x]", "(2*b*E^c*x*HypergeometricPFQ[{1/2, 1}, {3/2, 3/2}, b^2*x^2])/Sqrt[Pi]", //
				6388);
	}

	// {6376}
	public void test0020() {
		check("Integrate[E^(c + b^2*x^2)*Erf[b*x], x]", "(b*E^c*x^2*HypergeometricPFQ[{1, 1}, {3/2, 2}, b^2*x^2])/Sqrt[Pi]", //
				6376);
	}
	...
	public void test0030() {
		check("Integrate[Erfi[b*x]/(E^(b^2*x^2)*x), x]", "(2*b*x*HypergeometricPFQ[{1/2, 1}, {3/2, 3/2}, -(b^2*x^2)])/Sqrt[Pi]", //
				6390);
	}

	// {6378}
	public void test0031() {
		check("Integrate[Erfi[b*x]/E^(b^2*x^2), x]", "(b*x^2*HypergeometricPFQ[{1, 1}, {3/2, 2}, -(b^2*x^2)])/Sqrt[Pi]", //
				6378);
	}
	...
	public void test0038() {
		check("Integrate[Cos[(b^2*Pi*x^2)/2]*FresnelS[b*x], x]", "(FresnelC[b*x]*FresnelS[b*x])/(2*b) - (I/8)*b*x^2*HypergeometricPFQ[{1, 1}, {3/2, 2}, (-I/2)*b^2*Pi*x^2] + (I/8)*b*x^2*HypergeometricPFQ[{1, 1}, {3/2, 2}, (I/2)*b^2*Pi*x^2]", //
				6446);
	}
	...
	public void test0044() {
		check("Integrate[FresnelC[b*x]*Sin[(b^2*Pi*x^2)/2], x]", "(FresnelC[b*x]*FresnelS[b*x])/(2*b) + (I/8)*b*x^2*HypergeometricPFQ[{1, 1}, {3/2, 2}, (-I/2)*b^2*Pi*x^2] - (I/8)*b*x^2*HypergeometricPFQ[{1, 1}, {3/2, 2}, (I/2)*b^2*Pi*x^2]", //
				6447);
	}
	...
	public void test0048() {
		check("Integrate[ExpIntegralE[1, b*x]/x, x]", "b*x*HypergeometricPFQ[{1, 1, 1}, {2, 2, 2}, -(b*x)] - EulerGamma*Log[x] - Log[b*x]^2/2", //
				6475);
	}
	...
	public void test0067() {
		check("Integrate[x^3*ExpIntegralE[-1, b*x], x]", "-(x^4*ExpIntegralE[-3, b*x])/2 + (x^4*ExpIntegralE[-1, b*x])/2", //
				6478);
	}
	...
	public void test0073() {
		check("Integrate[x^4*ExpIntegralE[-2, b*x], x]", "-(x^5*ExpIntegralE[-4, b*x])/2 + (x^5*ExpIntegralE[-2, b*x])/2", //
				6478);
	}
	...
	public void test0080() {
		check("Integrate[x^5*ExpIntegralE[-3, b*x], x]", "-(x^6*ExpIntegralE[-5, b*x])/2 + (x^6*ExpIntegralE[-3, b*x])/2", //
				6478);
	}
	...
	public void test0089() {
		check("Integrate[(d*x)^(3/2)*ExpIntegralE[-3/2, b*x], x]", "(-4*(d*x)^(5/2)*HypergeometricPFQ[{5/2, 5/2}, {7/2, 7/2}, -(b*x)])/(25*d) + (3*Sqrt[Pi]*(d*x)^(3/2)*Log[x])/(4*b*(b*x)^(3/2))", //
				6477);
	}

	// {6477}
	public void test0090() {
		check("Integrate[Sqrt[d*x]*ExpIntegralE[-1/2, b*x], x]", "(-4*(d*x)^(3/2)*HypergeometricPFQ[{3/2, 3/2}, {5/2, 5/2}, -(b*x)])/(9*d) + (Sqrt[Pi]*Sqrt[d*x]*Log[x])/(2*b*Sqrt[b*x])", //
				6477);
	}

	// {6477}
	public void test0091() {
		check("Integrate[ExpIntegralE[1/2, b*x]/Sqrt[d*x], x]", "(-4*Sqrt[d*x]*HypergeometricPFQ[{1/2, 1/2}, {3/2, 3/2}, -(b*x)])/d + (Sqrt[Pi]*Sqrt[b*x]*Log[x])/(b*Sqrt[d*x])", //
				6477);
	}

	// {6477}
	public void test0092() {
		check("Integrate[ExpIntegralE[3/2, b*x]/(d*x)^(3/2), x]", "(-4*HypergeometricPFQ[{-1/2, -1/2}, {1/2, 1/2}, -(b*x)])/(d*Sqrt[d*x]) - (2*Sqrt[Pi]*(b*x)^(3/2)*Log[x])/(b*(d*x)^(3/2))", //
				6477);
	}

	// {6477}
	public void test0093() {
		check("Integrate[ExpIntegralE[5/2, b*x]/(d*x)^(5/2), x]", "(-4*HypergeometricPFQ[{-3/2, -3/2}, {-1/2, -1/2}, -(b*x)])/(9*d*(d*x)^(3/2)) + (4*Sqrt[Pi]*(b*x)^(5/2)*Log[x])/(3*b*(d*x)^(5/2))", //
				6477);
	}

	// {6478}
	public void test0094() {
		check("Integrate[x^m*ExpIntegralE[n, x], x]", "-((x^(1 + m)*ExpIntegralE[-m, x])/(m + n)) + (x^(1 + m)*ExpIntegralE[n, x])/(m + n)", //
				6478);
	}

	// {6478}
	public void test0095() {
		check("Integrate[x^m*ExpIntegralE[n, b*x], x]", "-((x^(1 + m)*ExpIntegralE[-m, b*x])/(m + n)) + (x^(1 + m)*ExpIntegralE[n, b*x])/(m + n)", //
				6478);
	}

	// {6478}
	public void test0096() {
		check("Integrate[(d*x)^m*ExpIntegralE[n, x], x]", "-(((d*x)^(1 + m)*ExpIntegralE[-m, x])/(d*(m + n))) + ((d*x)^(1 + m)*ExpIntegralE[n, x])/(d*(m + n))", //
				6478);
	}

	// {6478}
	public void test0097() {
		check("Integrate[(d*x)^m*ExpIntegralE[n, b*x], x]", "-(((d*x)^(1 + m)*ExpIntegralE[-m, b*x])/(d*(m + n))) + ((d*x)^(1 + m)*ExpIntegralE[n, b*x])/(d*(m + n))", //
				6478);
	}

	// {6477}
	public void test0098() {
		check("Integrate[ExpIntegralE[n, x]/x^n, x]", "-((x^(1 - n)*HypergeometricPFQ[{1 - n, 1 - n}, {2 - n, 2 - n}, -x])/(1 - n)^2) + Gamma[1 - n]*Log[x]", //
				6477);
	}

	// {6477}
	public void test0099() {
		check("Integrate[ExpIntegralE[n, b*x]/x^n, x]", "-((x^(1 - n)*HypergeometricPFQ[{1 - n, 1 - n}, {2 - n, 2 - n}, -(b*x)])/(1 - n)^2) + ((b*x)^n*Gamma[1 - n]*Log[x])/(b*x^n)", //
				6477);
	}

	// {6477}
	public void test0100() {
		check("Integrate[ExpIntegralE[n, x]/(d*x)^n, x]", "-(((d*x)^(1 - n)*HypergeometricPFQ[{1 - n, 1 - n}, {2 - n, 2 - n}, -x])/(d*(1 - n)^2)) + (x^n*Gamma[1 - n]*Log[x])/(d*x)^n", //
				6477);
	}

	// {6477}
	public void test0101() {
		check("Integrate[ExpIntegralE[n, b*x]/(d*x)^n, x]", "-(((d*x)^(1 - n)*HypergeometricPFQ[{1 - n, 1 - n}, {2 - n, 2 - n}, -(b*x)])/(d*(1 - n)^2)) + ((b*x)^n*Gamma[1 - n]*Log[x])/(b*(d*x)^n)", //
				6477);
	}

	// {6478}
	public void test0102() {
		check("Integrate[x^2*ExpIntegralE[n, b*x], x]", "-((x^3*ExpIntegralE[-2, b*x])/(2 + n)) + (x^3*ExpIntegralE[n, b*x])/(2 + n)", //
				6478);
	}

	// {6478}
	public void test0103() {
		check("Integrate[x*ExpIntegralE[n, b*x], x]", "-((x^2*ExpIntegralE[-1, b*x])/(1 + n)) + (x^2*ExpIntegralE[n, b*x])/(1 + n)", //
				6478);
	}
	...
	public void test0106() {
		check("Integrate[ExpIntegralE[n, b*x]/x^2, x]", "ExpIntegralE[2, b*x]/((2 - n)*x) - ExpIntegralE[n, b*x]/((2 - n)*x)", //
				6478);
	}

	// {6478}
	public void test0107() {
		check("Integrate[ExpIntegralE[n, b*x]/x^3, x]", "ExpIntegralE[3, b*x]/((3 - n)*x^2) - ExpIntegralE[n, b*x]/((3 - n)*x^2)", //
				6478);
	}
	...
	public void test0130() {
		check("Integrate[SinIntegral[b*x]/x, x]", "(b*x*HypergeometricPFQ[{1, 1, 1}, {2, 2, 2}, (-I)*b*x])/2 + (b*x*HypergeometricPFQ[{1, 1, 1}, {2, 2, 2}, I*b*x])/2", //
				6501);
	}
	...
	public void test0135() {
		check("Integrate[CosIntegral[b*x]/x, x]", "(-I/2)*b*x*HypergeometricPFQ[{1, 1, 1}, {2, 2, 2}, (-I)*b*x] + (I/2)*b*x*HypergeometricPFQ[{1, 1, 1}, {2, 2, 2}, I*b*x] + EulerGamma*Log[x] + Log[b*x]^2/2", //
				6502);
	}
	...
	public void test0140() {
		check("Integrate[SinhIntegral[b*x]/x, x]", "(b*x*HypergeometricPFQ[{1, 1, 1}, {2, 2, 2}, -(b*x)])/2 + (b*x*HypergeometricPFQ[{1, 1, 1}, {2, 2, 2}, b*x])/2", //
				6530);
	}
	...
	public void test0145() {
		check("Integrate[CoshIntegral[b*x]/x, x]", "-(b*x*HypergeometricPFQ[{1, 1, 1}, {2, 2, 2}, -(b*x)])/2 + (b*x*HypergeometricPFQ[{1, 1, 1}, {2, 2, 2}, b*x])/2 + EulerGamma*Log[x] + Log[b*x]^2/2", //
				6531);
	}
	...
	public void test0153() {
		check("Integrate[Gamma[0, a*x]/x, x]", "a*x*HypergeometricPFQ[{1, 1, 1}, {2, 2, 2}, -(a*x)] - EulerGamma*Log[x] - Log[a*x]^2/2", //
				6558);
	}
	...
	public void test0201() {
		check("Integrate[Gamma[1/2, a*x]/x, x]", "-4*Sqrt[a*x]*HypergeometricPFQ[{1/2, 1/2}, {3/2, 3/2}, -(a*x)] + Sqrt[Pi]*Log[x]", //
				6561);
	}
	...
	public void test0209() {
		check("Integrate[Gamma[3/2, a*x]/x, x]", "(-4*(a*x)^(3/2)*HypergeometricPFQ[{3/2, 3/2}, {5/2, 5/2}, -(a*x)])/9 + (Sqrt[Pi]*Log[x])/2", //
				6561);
	}
	...
	public void test0213() {
		check("Integrate[(d*x)^m*Gamma[3, b*x], x]", "((d*x)^(1 + m)*Gamma[3, b*x])/(d*(1 + m)) - ((d*x)^m*Gamma[4 + m, b*x])/(b*(1 + m)*(b*x)^m)", //
				6562);
	}

	// {6562}
	public void test0214() {
		check("Integrate[(d*x)^m*Gamma[2, b*x], x]", "((d*x)^(1 + m)*Gamma[2, b*x])/(d*(1 + m)) - ((d*x)^m*Gamma[3 + m, b*x])/(b*(1 + m)*(b*x)^m)", //
				6562);
	}
	...
	public void test0216() {
		check("Integrate[(d*x)^m*Gamma[0, b*x], x]", "((d*x)^(1 + m)*Gamma[0, b*x])/(d*(1 + m)) - ((d*x)^m*Gamma[1 + m, b*x])/(b*(1 + m)*(b*x)^m)", //
				6562);
	}

	// {6562}
	public void test0217() {
		check("Integrate[(d*x)^m*Gamma[-1, b*x], x]", "((d*x)^(1 + m)*Gamma[-1, b*x])/(d*(1 + m)) - ((d*x)^m*Gamma[m, b*x])/(b*(1 + m)*(b*x)^m)", //
				6562);
	}

	// {6562}
	public void test0218() {
		check("Integrate[(d*x)^m*Gamma[-2, b*x], x]", "((d*x)^(1 + m)*Gamma[-2, b*x])/(d*(1 + m)) - ((d*x)^m*Gamma[-1 + m, b*x])/(b*(1 + m)*(b*x)^m)", //
				6562);
	}
	...
	public void test0220() {
		check("Integrate[x^m*Gamma[n, b*x], x]", "(x^(1 + m)*Gamma[n, b*x])/(1 + m) - (x^m*Gamma[1 + m + n, b*x])/(b*(1 + m)*(b*x)^m)", //
				6562);
	}

	// {6562}
	public void test0221() {
		check("Integrate[(d*x)^m*Gamma[n, x], x]", "((d*x)^(1 + m)*Gamma[n, x])/(d*(1 + m)) - ((d*x)^m*Gamma[1 + m + n, x])/((1 + m)*x^m)", //
				6562);
	}

	// {6562}
	public void test0222() {
		check("Integrate[(d*x)^m*Gamma[n, b*x], x]", "((d*x)^(1 + m)*Gamma[n, b*x])/(d*(1 + m)) - ((d*x)^m*Gamma[1 + m + n, b*x])/(b*(1 + m)*(b*x)^m)", //
				6562);
	}
	...
	public void test0227() {
		check("Integrate[Gamma[n, a*x]/x, x]", "-(((a*x)^n*HypergeometricPFQ[{n, n}, {1 + n, 1 + n}, -(a*x)])/n^2) + Gamma[n]*Log[x]", //
				6561);
	}
	...
	public void test0231() {
		check("Integrate[x^100*Gamma[n, 2*x], x]", "(x^101*Gamma[n, 2*x])/101 - Gamma[101 + n, 2*x]/256065421246102339102334047485952", //
				6562);
	}
	...
	public void test0235() {
		check("Integrate[Gamma[n, 2*x]/x, x]", "-((2^n*x^n*HypergeometricPFQ[{n, n}, {1 + n, 1 + n}, -2*x])/n^2) + Gamma[n]*Log[x]", //
				6561);
	}
	...
	public void test0247() {
		check("Integrate[E^(-a - b*x)*(c + d*x)^m, x]", "-((E^(-a + (b*c)/d)*(c + d*x)^m*Gamma[1 + m, (b*(c + d*x))/d])/(b*((b*(c + d*x))/d)^m))", //
				2181);
	}
	...
	public void test0270() {
		check("Integrate[PolyLog[n, e*((a + b*x)/(c + d*x))^n]/((a + b*x)*(c + d*x)), x]", "PolyLog[1 + n, e*((a + b*x)/(c + d*x))^n]/((b*c - a*d)*n)", //
				6610);
	}

	// {6610}
	public void test0271() {
		check("Integrate[PolyLog[3, e*((a + b*x)/(c + d*x))^n]/((a + b*x)*(c + d*x)), x]", "PolyLog[4, e*((a + b*x)/(c + d*x))^n]/((b*c - a*d)*n)", //
				6610);
	}

	// {6610}
	public void test0272() {
		check("Integrate[PolyLog[2, e*((a + b*x)/(c + d*x))^n]/((a + b*x)*(c + d*x)), x]", "PolyLog[3, e*((a + b*x)/(c + d*x))^n]/((b*c - a*d)*n)", //
				6610);
	}

	// {2518}
	public void test0273() {
		check("Integrate[-(Log[1 - e*((a + b*x)/(c + d*x))^n]/((a + b*x)*(c + d*x))), x]", "PolyLog[2, e*((a + b*x)/(c + d*x))^n]/((b*c - a*d)*n)", //
				2518);
	}
	...
	public void test0302() {
		check("Integrate[x^m/(d + d*ProductLog[a*x]), x]", "(x^m*Gamma[1 + m, -((1 + m)*ProductLog[a*x])])/(a*d*E^(m*ProductLog[a*x])*(1 + m)*(-((1 + m)*ProductLog[a*x]))^m)", //
				6643);
	}
	...
	public void test0310() {
		check("Integrate[ProductLog[a/x^(1/4)]^4/(1 + ProductLog[a/x^(1/4)]), x]", "-4*a^4*ExpIntegralEi[-4*ProductLog[a/x^(1/4)]]", //
				6634);
	}

	// {6634}
	public void test0311() {
		check("Integrate[ProductLog[a/x^(1/3)]^3/(1 + ProductLog[a/x^(1/3)]), x]", "-3*a^3*ExpIntegralEi[-3*ProductLog[a/x^(1/3)]]", //
				6634);
	}

	// {6634}
	public void test0312() {
		check("Integrate[ProductLog[a/Sqrt[x]]^2/(1 + ProductLog[a/Sqrt[x]]), x]", "-2*a^2*ExpIntegralEi[-2*ProductLog[a/Sqrt[x]]]", //
				6634);
	}
	...
	public void test0315() {
		check("Integrate[1/(ProductLog[a*Sqrt[x]]^2*(1 + ProductLog[a*Sqrt[x]])), x]", "(2*ExpIntegralEi[2*ProductLog[a*Sqrt[x]]])/a^2", //
				6634);
	}

	// {6634}
	public void test0316() {
		check("Integrate[1/(ProductLog[a*x^(1/3)]^3*(1 + ProductLog[a*x^(1/3)])), x]", "(3*ExpIntegralEi[3*ProductLog[a*x^(1/3)]])/a^3", //
				6634);
	}

	// {6634}
	public void test0317() {
		check("Integrate[1/(ProductLog[a*x^(1/4)]^4*(1 + ProductLog[a*x^(1/4)])), x]", "(4*ExpIntegralEi[4*ProductLog[a*x^(1/4)]])/a^4", //
				6634);
	}
	...
	public void test0319() {
		check("Integrate[ProductLog[a*x^(1 - p)^(-1)]^p/(1 + ProductLog[a*x^(1 - p)^(-1)]), x]", "x*ProductLog[a*x^(1 - p)^(-1)]^(-1 + p)", //
				6633);
	}
}
