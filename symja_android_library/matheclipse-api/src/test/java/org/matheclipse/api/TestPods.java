  ...
  public void testTransliterate() {
    ...
    if (s.contains("Windows")) {
      assertEquals(
          ...
          + "      \"numsubpods\" : 1,\r\n"
          + "      \"subpods\" : [ {\r\n"
          + "        \"markdown\" : \"## Chop\\n\\n```\\nChop(numerical-expr)\\n```\\n\\n> replaces numerical values in the `numerical-expr` which are close to zero with symbolic value `0`.\\n\\n### Examples\\n\\n```\\n>> Chop(0.00000000001)\\n0\\n```\\n[Github master](https://github.com/axkr/symja_android_library/blob/master/symja_android_library/matheclipse-core/src/main/java/org/matheclipse/core/builtin/Arithmetic.java#L681)\\n\\n\"\r\n"
          + "      } ]\r\n"
          + "    } ]\r\n"
          + "  }\r\n"
          + "}"); //
