...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "OutputForm", "OutputStream", "OwnValues", "Package", "PadLeft", "PadRight", "ParametricPlot",
      "Parenthesis", "ParetoDistribution", "Part", "Partition", "PartitionsP", "PartitionsQ",
      "ParzenWindow", "PatternOrder", "PauliMatrix", "Pause", "PearsonChiSquareTest",
      ...
      "Pochhammer", "PolarPlot", "Point", "PointLight", "PoissonDistribution", "PolyGamma",
      "Polygon", "Polyhedron", "PolyLog", "PolynomialExtendedGCD", "PolynomialGCD", "PolynomialLCM",
