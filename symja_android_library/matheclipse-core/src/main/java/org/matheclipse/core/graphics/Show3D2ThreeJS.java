...
public class Show3D2ThreeJS {
   ...
   * </pre>
   *
   * <p>It's a bit messy because of all the HTML escaping. What we are interested in is the data
   * field. It's a JSON dict describing the 3D graphics in terms of graphics primitives. This JSON
   * can be used in <a href="http://threejs.org/">threejs.org</a> to construct a 3D div.
   *
   * @param ast
   * @param buf
   * @throws IOException
  ...
  private static void graphics3dToSVG(IAST ast, StringBuilder buf) {
    ...
    try {
      ...
      builder.append(
          "\"lighting\": [{\"color\": [0.3, 0.2, 0.4], \"type\": \"Ambient\"}, "
