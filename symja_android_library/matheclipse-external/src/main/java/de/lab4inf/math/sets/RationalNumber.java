 ...
 * arbitrary precision, allowing accurate computations.
 *
...
public class RationalNumber extends Number implements Rational {
      ...
      new RationalNumber(
          new BigInteger(
              "290059477841212181737978420557654767128189402403451"
                  + "5237231796026308354288358265194997650692411040761554492153"
                  + "8509045111980032"),
          new BigInteger(
              "923287993781660018891577792607872839441723954406"
                  + "09061374454200329478784181736733986393144506209415130324"
                  + "94837587807456247875"));
  ...
  /**
   * Construct a Rational form a real double value. Will use approximately 15 digits precision.
   *
   * @param real to use
   */
  ...
  /**
   * The epsilon precision used within calculations as sqrt.
   *
  ...
  /**
   * Special toString implementation using a fixed digets format.
   *
