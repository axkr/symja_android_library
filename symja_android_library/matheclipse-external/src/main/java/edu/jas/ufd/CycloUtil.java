...
public class CycloUtil {
   ...
   */
  public static GenPolynomial<BigInteger> cyclotomicPolynomial(
      GenPolynomialRing<BigInteger> ring, long n) {
   ...
   */
  public static List<GenPolynomial<BigInteger>> cyclotomicDecompose(
      GenPolynomialRing<BigInteger> ring, long n) {
    GenPolynomialRing<BigInteger> pfac = ring;
    if (pfac == null) {
      throw new IllegalArgumentException("ring must be non null");
