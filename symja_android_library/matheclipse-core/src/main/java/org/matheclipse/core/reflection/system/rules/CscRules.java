...
public interface CscRules {
  final public static IAST RULES = List(
    Set(Csc(C0),
      CComplexInfinity),
    Set(Csc(Times(C1D2,Pi)),
      C1),
    Set(Csc(Times(C1D3,Pi)),
      Times(QQ(2L,3L),Sqrt(C3))),
    Set(Csc(Times(C1D4,Pi)),
      Sqrt(C2)),
    Set(Csc(Times(QQ(1L,5L),Pi)),
      Times(QQ(1L,5L),Sqrt(Plus(ZZ(50L),Times(ZZ(10L),Sqrt(C5)))))),
    Set(Csc(Times(QQ(1L,6L),Pi)),
      C2),
    Set(Csc(Times(QQ(1L,8L),Pi)),
      Sqrt(Plus(C4,Times(C2,Sqrt(C2))))),
    Set(Csc(Times(QQ(1L,10L),Pi)),
      Plus(C1,Sqrt(C5))),
    Set(Csc(Times(QQ(1L,12L),Pi)),
      Plus(Sqrt(C2),Sqrt(ZZ(6L)))),
    Set(Csc(Times(QQ(3L,8L),Pi)),
      Sqrt(Plus(C4,Times(CN2,Sqrt(C2))))),
    Set(Csc(Times(QQ(3L,10L),Pi)),
      Plus(CN1,Sqrt(C5))),
    Set(Csc(Times(QQ(2L,5L),Pi)),
      Times(QQ(1L,5L),Sqrt(Plus(ZZ(50L),Times(ZZ(-10L),Sqrt(C5)))))),
    Set(Csc(Times(QQ(5L,12L),Pi)),
