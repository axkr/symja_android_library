package org.matheclipse.io.tablesaw;
...
import tech.tablesaw.io.arrow.ArrowReader;
import tech.tablesaw.io.arrow.ArrowWriter;
...
class ArrowWriterTest {
  ...
  void write3() {
    ArrowWriter writer = new ArrowWriter();
    Table table = Table.create("test", StringColumn.create("0"), BooleanColumn.create("1"),
        IntColumn.create("2"), LongColumn.create("3"), ShortColumn.create("4"),
        FloatColumn.create("5"), DoubleColumn.create("6"), DateTimeColumn.create("7"),
        DateColumn.create("8"), TimeColumn.create("9"), InstantColumn.create("10"));
