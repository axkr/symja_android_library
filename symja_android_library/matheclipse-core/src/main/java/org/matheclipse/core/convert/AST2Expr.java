...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AddTo", "AllTrue", "And",
			...
			"PadRight", "ParametricPlot", "Part", "Partition", "PartitionsP", "PartitionsQ", "Pattern", "PatternTest",
			"PDF", "Permutations", "Piecewise", "Plot", "PlotRange", "Plot3D", "Plus", "Pochhammer",
			...
			"PreIncrement", "Prepend", "PrependTo", "Prime", "PrimeOmega", "PrimePi", "PrimePowerQ", "PrimeQ",
			"PrimitiveRoots", "Print", "Product", "ProductLog", "PseudoInverse", "Put", "QRDecomposition", "Quiet",
			"Quit", "Quotient", "RandomInteger", "RandomReal", "RandomSample", "Range", "Rational", "Rationalize", "Re",
			"RealNumberQ", "Reap", "Reduce", "Refine", "Repeated", "RepeatedNull", "Replace", "ReplaceAll",
