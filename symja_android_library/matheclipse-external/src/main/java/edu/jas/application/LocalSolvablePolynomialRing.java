...
/**
 * LocalSolvablePolynomialRing generic recursive solvable polynomial factory implementing
 * RingFactory and extending GenSolvablePolynomialRing factory. Factory for n-variate ordered
 * solvable polynomials over solvable polynomial coefficients. The non-commutative multiplication
 * relations are maintained in a relation table and the non-commutative multiplication relations
 * between the coefficients and the main variables are maintained in a coefficient relation table.
 * Almost immutable object, except variable names and relation table contents.
 *
 * @param <C> coefficient type.
 * @author Heinz Kredel will be deprecated use QLRSolvablePolynomialRing
 */
public class LocalSolvablePolynomialRing<C extends GcdRingElem<C>>
   ...
   */
  public LocalSolvablePolynomialRing(
      RingFactory<SolvableLocal<C>> cf, int n, RelationTable<SolvableLocal<C>> rt) {
   ...
   */
  public LocalSolvablePolynomialRing(
      RingFactory<SolvableLocal<C>> cf, int n, TermOrder t, RelationTable<SolvableLocal<C>> rt) {
    this(cf, n, t, null, rt);
  }
   ...
   */
  public LocalSolvablePolynomialRing(
      RingFactory<SolvableLocal<C>> cf, int n, TermOrder t, String[] v) {
    this(cf, n, t, v, null);
  }
   ...
   */
  public LocalSolvablePolynomialRing(
      RingFactory<SolvableLocal<C>> cf,
      int n,
      TermOrder t,
      String[] v,
   ...
   */
  public LocalSolvablePolynomialRing(
      RingFactory<SolvableLocal<C>> cf, GenSolvablePolynomialRing o) {
   ...
   */
  public LocalSolvablePolynomialRing(
      RingFactory<SolvableLocal<C>> cf, LocalSolvablePolynomialRing o) {
  ...
  public LocalSolvablePolynomialRing<C> extend(int i, boolean top) {
    ...
    LocalSolvablePolynomialRing<C> spfac =
        new LocalSolvablePolynomialRing<C>(pfac.coFac, pfac.nvar, pfac.tord, pfac.getVars());
  ...
  /**
   * Rational function from integral polynomial coefficients. Represent as polynomial with type
   * SolvableLocal<C> coefficients.
   *
   ...
   */
  public LocalSolvablePolynomial<C> fromPolyCoefficients(
  ...
  /**
   * Integral function from rational polynomial coefficients. Represent as polynomial with type
   * GenSolvablePolynomial<C> coefficients.
   *
   * @param A polynomial with rational polynomial coefficients to be converted.
