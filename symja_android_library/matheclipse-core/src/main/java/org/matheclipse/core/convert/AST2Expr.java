...
public class AST2Expr {
	...
	public final static String[] SYMBOL_STRINGS = { "$Aborted", "All", "Algebraics", "Automatic", "Booleans", "CharacterEncoding",
			"ComplexInfinity", "Catalan", "Complexes", "Degree", "Disputed", "EulerGamma", "False", "Flat", "Glaisher",
			"GoldenRatio", "HoldAll", "HoldFirst", "HoldRest", "Indeterminate", "Infinity", "Integer", "Integers",
			"Khinchin", "Listable", "MaxIterations", "MaxPoints", "Method", "Modulus", "None", "Nonexistent",
	...
	public final static String[] FUNCTION_STRINGS = { "Abs", "AbsArg", "AddTo", "AllTrue", "And", "AnyTrue",
			...
			"BernoulliB", "BernoulliDistribution", "BesselI", "BesselJ", "BesselK", "BesselY", "Binomial",
			"BinomialDistribution", "Blank", "Block", "Boole", "BooleanConvert", "BooleanMinimize", "BooleanTable",
			"BooleanVariables", "Break", "Cancel", "CarmichaelLambda", "CartesianProduct", "Cases", "CatalanNumber",
			...
			"Eigenvectors", "Element", "ElementData", "Eliminate", "EllipticE", "EllipticF", "EllipticPi", "End",
			"EndPackage", "Equal", "Equivalent", "Erf", "Erfc", "Erfi", "EuclidianDistance", "EulerE", "EulerPhi",
			"EvenQ", "Except", "Exists", "Exp", "Expand", "ExpandAll", "ExpIntegralE", "ExpIntegralEi", "Exponent",
			"Export", "ExtendedGCD", "Extract", "Factor", "Factorial", "Factorial2", "FactorInteger",
			"FactorSquareFree", "FactorSquareFreeList", "FactorTerms", "Flatten", "Fibonacci", "FindInstance",
			"FindRoot", "First", "Fit", "FixedPoint", "Floor", "Fold", "FoldList", "For", "ForAll", "FractionalPart",
			"FreeQ", "FresnelC", "FresnelS", "FrobeniusSolve", "FromCharacterCode", "FromContinuedFraction",
			...
			"Identity", "IdentityMatrix", "If", "Im", "Implies", "Import", "Increment", "Inner", "Insert", "Interval",
			...
			"Min", "Missing", "MissingQ", "Mod", "Module", "MoebiusMu", "MonomialList", "Most", "Multinomial",
			"MultiplicativeOrder", "Names", "Nand", "NDSolve", "Nearest", "Negative", "Nest", "NestList", "NestWhile",
			...
			"Numerator", "NumericQ", "OddQ", "Operate", "Options", "Or", "Order", "OrderedQ", "Out", "Outer", "Package", "PadLeft",
			...
			"Prime", "PrimeQ", "PrimitiveRoots", "Print", "Product", "ProductLog", "PseudoInverse", "Put", "Quiet",
			...
			"SquareFreeQ", "StieltjesGamma", "StirlingS2", "StringDrop", "StringJoin", "StringLength", "StringTake", "Subfactorial",
