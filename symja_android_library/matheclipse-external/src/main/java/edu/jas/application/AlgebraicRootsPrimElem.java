...
/**
 * Container for the real and complex algebraic roots of a univariate polynomial together with
 * primitive element.
 *
 * @param <C> coefficient type.
 * @author Heinz Kredel
 */
public class AlgebraicRootsPrimElem<C extends GcdRingElem<C> & Rational> extends AlgebraicRoots<C>
   ...
   */
  public AlgebraicRootsPrimElem(
      AlgebraicRoots<C> ar, PrimitiveElement<C> pe, List<AlgebraicNumber<C>> ru) {
