...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"AccuracyGoal", "All", "AllowedHeads",
      ...
      "CharacterEncoding", "ColorFunction", "ComplexInfinity", "Catalan", "CoefficientDomain",
      "Complexes", "ComplexityFunction", "Constant", "Cyan", "Dashed", "DataRange", "DefaultValue",
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "RankedMax", "RankedMin", "Rational", "Rationalize", "RawBackquote", "RawBoxes", "Re", "Read",
