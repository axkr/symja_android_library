...
IIntegrate(10547,Int(Times(Power(FresnelC(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT),Sin(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_))))),x_Symbol),
    Condition(Unintegrable(Times(Power(FresnelC(Plus(a,Times(b,x))),n),Sin(Plus(c,Times(d,Sqr(x))))),x),FreeQ(List(a,b,c,d,n),x))),
IIntegrate(10548,Int(Times(x_,FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(10549,Int(Times(x_,Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10550,Int(Times(Power(x_,m_),FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(10551,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10552,Int(Times(Power(x_,m_),FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(10553,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10554,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Power(FresnelS(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT),Sin(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_))))),x_Symbol),
...
IIntegrate(10555,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Cos(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(FresnelC(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10556,Int(Times(x_,Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10557,Int(Times(x_,FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(10558,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10559,Int(Times(Power(x_,m_),FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(10560,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10561,Int(Times(Power(x_,m_),FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(10562,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Cos(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(FresnelS(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10563,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Power(FresnelC(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT),Sin(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_))))),x_Symbol),
...
IIntegrate(10564,Int(FresnelS(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(10565,Int(FresnelC(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(10566,Int(Times(Power(x_,-1),$(F_,Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),d_DEFAULT))),x_Symbol),
...
IIntegrate(10567,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),FresnelS(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
IIntegrate(10568,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),FresnelC(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
IIntegrate(10569,Int(ExpIntegralE(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Negate(Simp(Times(ExpIntegralE(Plus(n,C1),Plus(a,Times(b,x))),Power(b,-1)),x)),FreeQ(List(a,b,n),x))),
IIntegrate(10570,Int(Times(Power(x_,m_DEFAULT),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10571,Int(Times(Power(x_,-1),ExpIntegralE(C1,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10572,Int(Times(Power(x_,m_),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10573,Int(Times(Power(Times(d_DEFAULT,x_),m_),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10574,Int(Times(Power(Times(d_DEFAULT,x_),m_DEFAULT),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10575,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralE(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10576,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralE(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10577,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralE(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Unintegrable(Times(Power(Plus(c,Times(d,x)),m),ExpIntegralE(n,Plus(a,Times(b,x)))),x),FreeQ(List(a,b,c,d,m,n),x))),
IIntegrate(10578,Int(ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10579,Int(Times(Power(x_,-1),ExpIntegralEi(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10580,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1),ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Unintegrable(Times(ExpIntegralEi(Plus(a,Times(b,x))),Power(Plus(c,Times(d,x)),-1)),x),FreeQ(List(a,b,c,d),x))),
IIntegrate(10581,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10582,Int(Sqr(ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10583,Int(Times(Power(x_,m_DEFAULT),Sqr(ExpIntegralEi(Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10584,Int(Times(Power(x_,m_DEFAULT),Sqr(ExpIntegralEi(Plus(a_,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10585,Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10586,Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Power(x_,m_DEFAULT),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10587,Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Power(x_,m_),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10588,Int(ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(10589,Int(Times(Power(x_,-1),ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
    Condition(Dist(Power(n,-1),Subst(ExpIntegralEi(Times(d,Plus(a,Times(b,x)))),x,Log(Times(c,Power(x,n)))),x),FreeQ(List(a,b,c,d,n),x))),
IIntegrate(10590,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
IIntegrate(10591,Int(LogIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10592,Int(Times(Power(x_,-1),LogIntegral(Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Plus(Negate(Simp(Times(b,x),x)),Simp(Times(Log(Times(b,x)),LogIntegral(Times(b,x))),x)),FreeQ(b,x))),
IIntegrate(10593,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1),LogIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Unintegrable(Times(LogIntegral(Plus(a,Times(b,x))),Power(Plus(c,Times(d,x)),-1)),x),FreeQ(List(a,b,c,d),x))),
IIntegrate(10594,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),LogIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(10595,Int(SinIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10596,Int(CosIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
