...
public class DerivativeStructure implements RealFieldElement<DerivativeStructure>, Serializable {
     ...
     */
    @Override
    public DerivativeStructure sum(final DerivativeStructure a)
        throws DimensionMismatchException {
    ...
    public DerivativeStructure linearCombination(final DerivativeStructure[] a, final DerivativeStructure[] b)
        ...
        for (int i = 0; i < a.length; ++i) {
            simpleValue = simpleValue.sum(a[i].multiply(b[i]));
        }
    ...
    public DerivativeStructure linearCombination(final double[] a, final DerivativeStructure[] b)
        ...
        for (int i = 0; i < a.length; ++i) {
            simpleValue = simpleValue.sum(b[i].multiply(a[i]));
        }
    ...
    public DerivativeStructure linearCombination(final DerivativeStructure a1, final DerivativeStructure b1,
        ...
        // compute a simple value, with all partial derivatives
        final DerivativeStructure simpleValue = a1.multiply(b1).sum(a2.multiply(b2));
    ...
    public DerivativeStructure linearCombination(final double a1, final DerivativeStructure b1,
        ...
        // compute a simple value, with all partial derivatives
        final DerivativeStructure simpleValue = b1.multiply(a1).sum(b2.multiply(a2));
    ...
    public DerivativeStructure linearCombination(final DerivativeStructure a1, final DerivativeStructure b1,
        ...
        // compute a simple value, with all partial derivatives
        final DerivativeStructure simpleValue = a1.multiply(b1).sum(a2.multiply(b2)).sum(a3.multiply(b3));
    ...
    public DerivativeStructure linearCombination(final double a1, final DerivativeStructure b1,
        ...
        // compute a simple value, with all partial derivatives
        final DerivativeStructure simpleValue = b1.multiply(a1).sum(b2.multiply(a2)).sum(b3.multiply(a3));
    ...
    public DerivativeStructure linearCombination(final DerivativeStructure a1, final DerivativeStructure b1,
        ...
        // compute a simple value, with all partial derivatives
        final DerivativeStructure simpleValue = a1.multiply(b1).sum(a2.multiply(b2)).sum(a3.multiply(b3)).sum(a4.multiply(b4));
    ...
    public DerivativeStructure linearCombination(final double a1, final DerivativeStructure b1,
        ...
        // compute a simple value, with all partial derivatives
        final DerivativeStructure simpleValue = b1.multiply(a1).sum(b2.multiply(a2)).sum(b3.multiply(a3)).sum(b4.multiply(a4));
