...
IIntegrate(2024,Integrate(Times(Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power($p("§pq"),n_DEFAULT))),p_DEFAULT),$p("§qr")),x_Symbol),
    Condition(With(list(Set(q,Expon($s("§pq"),x)),Set(r,Expon($s("§qr"),x))),Condition(Simp(Dist(Times(Coeff($s("§qr"),x,r),Power(Times(q,Coeff($s("§pq"),x,q)),CN1)),Subst(Integrate(Power(Plus(a,Times(b,Power(x,n))),p),x),x,$s("§pq")),x),x),And(EqQ(r,Plus(q,CN1)),EqQ(Times(Coeff($s("§qr"),x,r),D($s("§pq"),x)),Times(q,Coeff($s("§pq"),x,q),$s("§qr")))))),And(FreeQ(List(a,b,n,p),x),PolyQ($s("§pq"),x),PolyQ($s("§qr"),x)))),
IIntegrate(2025,Integrate(Times(Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power($p("§pq"),n_DEFAULT)),Times(c_DEFAULT,Power($p("§pq"),$p("n2",true)))),p_DEFAULT),$p("§qr")),x_Symbol),
    Condition(Module(list(Set(q,Expon($s("§pq"),x)),Set(r,Expon($s("§qr"),x))),Condition(Simp(Dist(Times(Coeff($s("§qr"),x,r),Power(Times(q,Coeff($s("§pq"),x,q)),CN1)),Subst(Integrate(Power(Plus(a,Times(b,Power(x,n)),Times(c,Power(x,Times(C2,n)))),p),x),x,$s("§pq")),x),x),And(EqQ(r,Plus(q,CN1)),EqQ(Times(Coeff($s("§qr"),x,r),D($s("§pq"),x)),Times(q,Coeff($s("§pq"),x,q),$s("§qr")))))),And(FreeQ(List(a,b,c,n,p),x),EqQ($s("n2"),Times(C2,n)),PolyQ($s("§pq"),x),PolyQ($s("§qr"),x)))),
...
IIntegrate(2029,Integrate(Times($p("§fx",true),Power(Plus(Times(d_DEFAULT,Power(x_,q_DEFAULT)),Times(a_DEFAULT,Power(x_,r_DEFAULT)),Times(b_DEFAULT,Power(x_,s_DEFAULT)),Times(c_DEFAULT,Power(x_,t_DEFAULT))),p_DEFAULT)),x_Symbol),
    Condition(Integrate(Times(Power(x,Times(p,r)),Power(Plus(a,Times(b,Power(x,Subtract(s,r))),Times(c,Power(x,Subtract(t,r))),Times(d,Power(x,Subtract(q,r)))),p),$s("§fx")),x),And(FreeQ(List(a,b,c,d,r,s,t,q),x),IntegerQ(p),PosQ(Subtract(s,r)),PosQ(Subtract(t,r)),PosQ(Subtract(q,r)),Not(And(EqQ(p,C1),EqQ(u,C1)))))),
IIntegrate(2030,Integrate(Times($p("§fx",true),Power(v_,m_DEFAULT),Power(Times(b_,v_),n_)),x_Symbol),
    Condition(Simp(Dist(Power(Power(b,m),CN1),Integrate(Times(Power(Times(b,v),Plus(m,n)),$s("§fx")),x),x),x),And(FreeQ(list(b,n),x),IntegerQ(m)))),
IIntegrate(2031,Integrate(Times($p("§fx",true),Power(Times(a_DEFAULT,v_),m_),Power(Times(b_DEFAULT,v_),n_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(a,Plus(m,C1D2)),Power(b,Plus(n,CN1D2)),Sqrt(Times(b,v)),Power(Times(a,v),CN1D2)),Integrate(Times(Power(v,Plus(m,n)),$s("§fx")),x),x),x),And(FreeQ(list(a,b,m),x),Not(IntegerQ(m)),IGtQ(Plus(n,C1D2),C0),IntegerQ(Plus(m,n))))),
IIntegrate(2032,Integrate(Times($p("§fx",true),Power(Times(a_DEFAULT,v_),m_),Power(Times(b_DEFAULT,v_),n_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(a,Plus(m,CN1D2)),Power(b,Plus(n,C1D2)),Sqrt(Times(a,v)),Power(Times(b,v),CN1D2)),Integrate(Times(Power(v,Plus(m,n)),$s("§fx")),x),x),x),And(FreeQ(list(a,b,m),x),Not(IntegerQ(m)),ILtQ(Plus(n,CN1D2),C0),IntegerQ(Plus(m,n))))),
IIntegrate(2033,Integrate(Times($p("§fx",true),Power(Times(a_DEFAULT,v_),m_),Power(Times(b_DEFAULT,v_),n_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(a,Plus(m,n)),Power(Times(b,v),n),Power(Power(Times(a,v),n),CN1)),Integrate(Times(Power(v,Plus(m,n)),$s("§fx")),x),x),x),And(FreeQ(List(a,b,m,n),x),Not(IntegerQ(m)),Not(IntegerQ(n)),IntegerQ(Plus(m,n))))),
IIntegrate(2034,Integrate(Times($p("§fx",true),Power(Times(a_DEFAULT,v_),m_),Power(Times(b_DEFAULT,v_),n_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(b,IntPart(n)),Power(Times(b,v),FracPart(n)),Power(Times(Power(a,IntPart(n)),Power(Times(a,v),FracPart(n))),CN1)),Integrate(Times(Power(Times(a,v),Plus(m,n)),$s("§fx")),x),x),x),And(FreeQ(List(a,b,m,n),x),Not(IntegerQ(m)),Not(IntegerQ(n)),Not(IntegerQ(Plus(m,n)))))),
IIntegrate(2035,Integrate(Times($p("§fx"),Power(x_,m_)),x_Symbol),
    Condition(With(list(Set(k,Denominator(m))),Simp(Dist(k,Subst(Integrate(Times(Power(x,Plus(Times(k,Plus(m,C1)),CN1)),$($s("§substpower"),$s("§fx"),x,k)),x),x,Power(x,Power(k,CN1))),x),x)),And(FractionQ(m),AlgebraicFunctionQ($s("§fx"),x)))),
...
IIntegrate(2038,Integrate(Times(u_DEFAULT,Power(Plus(c_,Times(d_DEFAULT,Power(x_,n_DEFAULT))),q_DEFAULT),Power(Plus($p("a1"),Times($p("b1",true),Power(x_,$p("non2",true)))),p_),Power(Plus($p("a2"),Times($p("b2",true),Power(x_,$p("non2",true)))),p_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Plus($s("a1"),Times($s("b1"),Power(x,Times(C1D2,n)))),FracPart(p)),Power(Plus($s("a2"),Times($s("b2"),Power(x,Times(C1D2,n)))),FracPart(p)),Power(Power(Plus(Times($s("a1"),$s("a2")),Times($s("b1"),$s("b2"),Power(x,n))),FracPart(p)),CN1)),Integrate(Times(u,Power(Plus(Times($s("a1"),$s("a2")),Times($s("b1"),$s("b2"),Power(x,n))),p),Power(Plus(c,Times(d,Power(x,n))),q)),x),x),x),And(FreeQ(List($s("a1"),$s("b1"),$s("a2"),$s("b2"),c,d,n,p,q),x),EqQ($s("non2"),Times(C1D2,n)),EqQ(Plus(Times($s("a2"),$s("b1")),Times($s("a1"),$s("b2"))),C0),Not(And(EqQ(n,C2),IGtQ(q,C0)))))),
IIntegrate(2039,Integrate(Times(u_DEFAULT,Power(Plus(c_,Times(d_DEFAULT,Power(x_,n_DEFAULT)),Times(e_DEFAULT,Power(x_,$p("n2",true)))),q_DEFAULT),Power(Plus($p("a1"),Times($p("b1",true),Power(x_,$p("non2",true)))),p_DEFAULT),Power(Plus($p("a2"),Times($p("b2",true),Power(x_,$p("non2",true)))),p_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Plus($s("a1"),Times($s("b1"),Power(x,Times(C1D2,n)))),FracPart(p)),Power(Plus($s("a2"),Times($s("b2"),Power(x,Times(C1D2,n)))),FracPart(p)),Power(Power(Plus(Times($s("a1"),$s("a2")),Times($s("b1"),$s("b2"),Power(x,n))),FracPart(p)),CN1)),Integrate(Times(u,Power(Plus(Times($s("a1"),$s("a2")),Times($s("b1"),$s("b2"),Power(x,n))),p),Power(Plus(c,Times(d,Power(x,n)),Times(e,Power(x,Times(C2,n)))),q)),x),x),x),And(FreeQ(List($s("a1"),$s("b1"),$s("a2"),$s("b2"),c,d,e,n,p,q),x),EqQ($s("non2"),Times(C1D2,n)),EqQ($s("n2"),Times(C2,n)),EqQ(Plus(Times($s("a2"),$s("b1")),Times($s("a1"),$s("b2"))),C0)))),
