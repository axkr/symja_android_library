...
/**
 * QuotSolvablePolynomial generic recursive solvable polynomials implementing RingElem. n-variate
...
public class QuotSolvablePolynomial<C extends GcdRingElem<C>>
   ...
   * @param e exponent.
   */
  public QuotSolvablePolynomial(
      QuotSolvablePolynomialRing<C> r, SolvableQuotient<C> c, ExpVector e) {
    this(r);
    if (c != null && !c.isZERO()) {
      val.put(e, c);
    }
   ...
   */
  public QuotSolvablePolynomial(
      QuotSolvablePolynomialRing<C> r, GenSolvablePolynomial<SolvableQuotient<C>> S) {
    this(r, S.getMap());
  }
   ...
   */
  protected QuotSolvablePolynomial(
      QuotSolvablePolynomialRing<C> r, SortedMap<ExpVector, SolvableQuotient<C>> v) {
    this(r);
      ...
      for (Map.Entry<ExpVector, SolvableQuotient<C>> x : Bk) {
        ...
        if (ring.polCoeff.coeffTable.isEmpty() || b.isConstant() || e.isZERO()) { // symmetric
          ...
          if (b.den.isONE()) { // recursion base
            ...
            SolvableQuotient<C> qdeni =
                new SolvableQuotient<C>(b.ring, b.ring.ring.getONE(), b.den);
  ...
  /**
   * QuotSolvablePolynomial left and right multiplication. Product with two polynomials.
   *
   ...
   */
  // not @Override
  public QuotSolvablePolynomial<C> multiply(
      QuotSolvablePolynomial<C> S, QuotSolvablePolynomial<C> T) {
  ...
  /**
   * QuotSolvablePolynomial multiplication. Product with coefficient ring element.
   *
  ...
  /**
   * QuotSolvablePolynomial left and right multiplication. Product with coefficient ring element.
   *
  ...
  /**
   * QuotSolvablePolynomial left and right multiplication. Product with exponent vector.
   *
   * @param e exponent.
   * @param f exponent.
  ...
  /**
   * QuotSolvablePolynomial multiplication. Product with ring element and exponent vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  /**
   * QuotSolvablePolynomial left and right multiplication. Product with ring element and exponent
   * vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  @Override
  public QuotSolvablePolynomial<C> multiply(
      SolvableQuotient<C> b, ExpVector e, SolvableQuotient<C> c, ExpVector f) {
    if (b == null || b.isZERO()) {
      return ring.getZERO();
    }
    if (c == null || c.isZERO()) {
  ...
  /**
   * QuotSolvablePolynomial multiplication. Left product with ring element and exponent vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  /**
   * QuotSolvablePolynomial multiplication. Left product with coefficient ring element.
   *
   * @param b coefficient polynomial.
