...
public class ExprEvaluatorTest {
  ...
  public void testSmallValue() {
    ...
    assertEquals(exprEvaluator.eval("N( 1/(1602176620898*10^(-31)) ,100)").toString(),
        "6.241509125501484852088071665173164020252959820255548406024372975427711002340001391293975286331422182`100*10^18");
    assertEquals(exprEvaluator.eval("1/(N(0.0000000000000000001602176620898, 100))").toString(),
        "6.241509125501484852088071665173`31*10^18");
