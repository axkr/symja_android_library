...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AbsoluteCorrelation", "AbsoluteTime",
			...
			"Dot", "Drop", "DuplicateFreeQ", "Dynamic", "DSolve", "EasterSunday", "Echo", "EchoFunction", "EdgeCount",
			...
			"EndPackage", "Entity", "Equal", "Equivalent", "Erf", "Erfc", "Erfi", "ErlangDistribution",
			...
			"FactorTerms", "Flatten", "FlattenAt", "FlatTopWindow", "Fibonacci", "FindClusters", "FindEulerianCycle",
			"FindEdgeCover", "FindFit", "FindGraphCommunities", "FindIndependentEdgeSet", "FindIndependentVertexSet",
			...
			"Keys", "KeySort", "KleinInvariantJ", "KnownUnitQ", "KolmogorovSmirnovTest", "KOrderlessPartitions",
