...
/**
 * BigInteger class to make java.math.BigInteger available with RingElem respectively the
 * GcdRingElem interface. Objects of this class are immutable. The SAC2 static methods are also
 * provided.
 *
 * @author Heinz Kredel
...
public final class BigInteger
  ...
  /**
   * Integer inverse. R is a non-zero integer. S=1/R if defined else throws not invertible
   * exception.
   *
   ...
   * of A/B, and R is the remainder A-B*Q. Throws an exception, if B == 0.
   *
   * @param A BigInteger.
   * @param B BigInteger.
  ...
  /**
   * Returns the number of bits in the representation of this BigInteger, including a sign bit. For
   * positive BigIntegers, this is equivalent to {@code (ceil(log2(this+1))+1)}.)
   *
   * @return number of bits in the representation of this BigInteger, including a sign bit.
   */
   ...
   *
   * @param v value.
   * @return number of bits in the representation of a Long, including a sign bit.
   */
