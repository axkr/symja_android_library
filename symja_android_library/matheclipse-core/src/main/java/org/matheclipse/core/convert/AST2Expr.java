...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "And", "AngleVector", "AnyTrue", "AntihermitianMatrixQ", "AntiSymmetric",
      ...
      "File", "FileNameJoin", "FilePrint", "FileNameTake", "FileNames", "FilterRules",
      "FindClusters", "FindEulerianCycle", "FindEdgeCover", "FindFit", "FindGraphCommunities",
      "FindGraphIsomorphism", "FindIndependentEdgeSet", "FindIndependentVertexSet",
      "FindHamiltonianCycle", "FindInstance", "FindPermutation", "FindRoot", "FindShortestPath",
      ...
      "ImageCrop", "ImageResize", "ImageRotate", "ImageSize", "ImageType", "Implies", "Import",
      "ImportString", "In", "Increment", "Inequality", "InexactNumberQ", "Infix", "Information",
      ...
      "ListConvolve", "ListCorrelate", "ListLinePlot", "ListPlot", "ListPlot3D", "ListPointPlot3D",
      "ListQ", "Literal", "LoadJavaClass", "Log", "Log2", "Log10", "LogGamma",
      ...
      "PolarPlot", "Point", "PoissonDistribution", "PolyGamma", "Polygon", "Polyhedron", "PolyLog",
      ...
      "Positive", "PossibleZeroQ", "Postefix", "Power", "PowerExpand", "PowerMod", "Precision",
      "PreDecrement", "Prefix", "PreIncrement", "Prepend", "PrependTo", "Prime", "PrimeOmega",
      "PrimePi", "PrimePowerQ", "PrimeQ", "PrimitiveRoot", "PrimitiveRootList", "Print",
      ...
      "Quantile", "Quantity", "QuantityDistribution", "QuantityMagnitude", "QuantityQ", "Quartiles",
      "Quiet", "Quit", "Quotient", "QuotientRemainder", "Ramp", "RandomChoice", "RandomComplex",
      ...
      "SphericalHankelH1", "SphericalHankelH2", "SphericalHarmonicY", "Split", "SplitBy", "Sqrt",
      "SquaredEuclideanDistance", "SquareFreeQ", "SquareMatrixQ", "Stack", "StackBegin",
      "StandardDeviation", "StandardForm", "Standardize", "StarGraph", "StieltjesGamma",
      "StirlingS1", "StirlingS2", "StringCases", "StringCount", "StringContainsQ", "StringDrop",
      "StringExpression", "StringFormat", "StringFreeQ", "StringInsert", "StringJoin",
