...
ISetDelayed(Int(Times(Power(Plus(Times(Sqr(x_),c_DEFAULT),a_),p_),Power(Plus(Times(x_,pe_DEFAULT),pd_DEFAULT),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Sqr(w_),c_DEFAULT),Times(b_DEFAULT,v_),a_),p_DEFAULT),Power(Plus(Times(u_,pe_DEFAULT),pd_DEFAULT),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Sqr(w_),c_DEFAULT),a_),p_DEFAULT),Power(Plus(Times(u_,pe_DEFAULT),pd_DEFAULT),m_DEFAULT)),x_Symbol),
