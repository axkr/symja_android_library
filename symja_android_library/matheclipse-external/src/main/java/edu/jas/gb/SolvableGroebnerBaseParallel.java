...
/**
 * Solvable Groebner Base parallel algorithm. Implements a shared memory parallel version of
 * Groebner bases. Threads maintain pairlist.
 *
...
public class SolvableGroebnerBaseParallel<C extends RingElem<C>>
   ...
   */
  public SolvableGroebnerBaseParallel(
      int threads, ExecutorService pool, SolvableReduction<C> sred, PairList<C> pl) {
    super(sred, pl);
