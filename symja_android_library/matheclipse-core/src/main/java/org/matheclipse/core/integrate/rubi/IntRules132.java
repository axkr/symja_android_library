...
IIntegrate(6601,Int(Times(Power(x_,-1),Log(Plus(C1,Times(e_DEFAULT,x_))),PolyLog(C2,Times(c_DEFAULT,x_))),x_Symbol),
    Condition(Negate(Simp(Times(C1D2,Sqr(PolyLog(C2,Times(c,x)))),x)),And(FreeQ(List(c,e),x),EqQ(Plus(c,e),C0)))),
IIntegrate(6602,Int(Times(Power(x_,-1),Plus(g_,Times(h_DEFAULT,Log(Plus(C1,Times(e_DEFAULT,x_))))),PolyLog(C2,Times(c_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6603,Int(Times(Power(x_,m_DEFAULT),Plus(g_DEFAULT,Times(h_DEFAULT,Log(Times(f_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT))))),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(6604,Int(Times($p("§px"),Plus(g_DEFAULT,Times(h_DEFAULT,Log(Times(f_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT))))),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(6605,Int(Times($p("§px"),Power(x_,m_),Plus(g_DEFAULT,Times(h_DEFAULT,Log(Plus(C1,Times(e_DEFAULT,x_))))),PolyLog(C2,Times(c_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6606,Int(Times($p("§px"),Power(x_,m_DEFAULT),Plus(g_DEFAULT,Times(h_DEFAULT,Log(Times(f_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT))))),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(6607,Int(Times($p("§px",true),Power(x_,m_),Plus(g_DEFAULT,Times(h_DEFAULT,Log(Times(f_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT))))),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(6611,Int(Times(u_,Log(w_),PolyLog(n_,v_)),x_Symbol),
