...
public class ExamplesGeoTheorems {
  ...
  public static List<GenPolynomial<BigRational>> getExample() {
    ...
    GenPolynomial<BigRational> e9 =
        pring.parse("(a1*(b2*z2 - d2*z2) + a2*( - b1*z2 + d1*z2) + b1*d2*z2 - b2*d1*z2 - 1)");
    GenPolynomial<BigRational> e10 =
        pring.parse("(a1*(b2*z3 - e2*z3) + a2*( - b1*z3 + e1*z3) + b1*e2*z3 - b2*e1*z3 - 1)");
    GenPolynomial<BigRational> e11 =
        pring.parse("(h1*(i2*z1 - j2*z1) + h2*( - i1*z1 + j1*z1) + i1*j2*z1 - i2*j1*z1 - 1)");
  ...
  public static void example12() {
    ...
    GroebnerBaseAbstract<BigRational> ogb =
        new GBOptimized<BigRational>(sgb, true); // false no change for GB == 1
    List<GenPolynomial<BigRational>> gb;
    long t;
    t = System.currentTimeMillis();
    gb = ogb.GB(cp);
  ...
  public static void example16() {
    ...
    GroebnerBaseAbstract<BigRational> opgb =
        new GBOptimized<BigRational>(pgb, true); // false no change for GB == 1
  ...
  public static void example17() {
    ...
    GroebnerBaseAbstract<BigRational> ogb =
        new GBOptimized<BigRational>(ppgb, true); // false no change for GB == 1
    List<GenPolynomial<BigRational>> gb;
    long t;
    t = System.currentTimeMillis();
    gb = ogb.GB(cp);
