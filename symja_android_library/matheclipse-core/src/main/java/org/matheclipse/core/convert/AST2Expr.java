...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "AssociationQ", "AssociationThread", "Assuming", "Assumptions", "AsymptoticSolve",
      "AsymptoticDSolveValue", "AsymptoticRSolveValue", "AtomQ", "Attributes", "Ball", "BarChart",
      "BarLegend", "BarnesG", "BartlettWindow", "BaseDecode", "BaseEncode", "BaseForm", "Beep",
      ...
      "BlankNullSequence", "BlankSequence", "Block", "Boole", "BooleanConvert",
      "BooleanCountingFunction", "BooleanFunction", "BooleanMaxterms", "BooleanMinimize",
      "BooleanMinterms", "BooleanQ", "BooleanTable", "BooleanVariables", "BoxMatrix",
      ...
      "ClosenessCentrality", "CMYKColor", "Coefficient", "CoefficientArrays", "CoefficientList",
      "CoefficientRules", "Cofactor", "Collect", "CollinearPoints", "Colon", "ColorData",
      "ColorDataFunction", "Column", "Commonest", "CompatibleUnitQ", "Compile", "CompiledFunction",
      "CompilePrint", "Complement", "CompleteGraph", "CompleteKaryTree", "Complex", "ComplexExpand",
      ...
      "FactorSquareFreeList", "FactorTerms", "FactorTermsList", "Fibonacci", "FiniteGroupCount",
      ...
      "Ratios", "RawBackquote", "RawBoxes", "Re", "Read", "ReadLine", "ReadList", "ReadString",
      "RealAbs", "RealDigits", "RealSign", "RealValuedNumberQ", "RealValuedNumericQ", "Reap",
      "Rectangle", "Reduce", "Refine", "RegularExpression", "ReIm", "ReleaseHold", "Remove",
      ...
      "Solve", "Sort", "SortBy", "Sow", "Span", "SparseArray", "SparseArrayQ", "SpecialsFreeQ",
      "Specularity", "SpectrogramArray", "Sphere", "SphericalBesselJ", "SphericalBesselY",
      "SphericalHankelH1", "SphericalHankelH2", "SphericalHarmonicY", "SphericalPlot3D", "Splice",
      "Split", "SplitBy", "SpotLight", "Sqrt", "SqrtBox", "Square", "SquaredEuclideanDistance",
      ...
      "StarGraph", "StatusArea", "StieltjesGamma", "StirlingS1", "StirlingS2", "StreamPlot",
      ...
      "Write", "WriteString", "Xnor", "Xor", "YuleDissimilarity", "ZernikeR", "Zeta", "ZTransform"};
