 ...
 * 
 */
public class OpenIntToIExpr implements Serializable {
	...
	/**
	 * Build an empty map with default size and using <code>F.C0</code> for missing entries.
	 * 
	 */
	public OpenIntToIExpr() {
		this(DEFAULT_EXPECTED_SIZE, F.C0);
	}
	 ...
	 */
	public OpenIntToIExpr(final IExpr missingEntries) {
		this(DEFAULT_EXPECTED_SIZE, missingEntries);
	}

	/**
	 * Build an empty map with specified size and using <code>F.C0</code> for missing entries.
	 * 
	 * @param expectedSize
	 *            expected number of elements in the map
	 */
	public OpenIntToIExpr(final int expectedSize) {
		this(expectedSize, F.C0);
	}
	 ...
	 *            value to return when a missing entry is fetched
	 */
	public OpenIntToIExpr(final int expectedSize, final IExpr missingEntries) {
	 ...
	 *            map to copy
	 */
	public OpenIntToIExpr(final OpenIntToIExpr source) {
	 ...
	 * <p>
	 * The specialized iterators returned are fail-fast: they throw a <code>ConcurrentModificationException</code> when they detect
	...
	private IExpr[] buildArray(final int length) {
		return new IExpr[length]; // (IExpr[]) Array.newInstance(field.getRuntimeClass(), length);
	}
