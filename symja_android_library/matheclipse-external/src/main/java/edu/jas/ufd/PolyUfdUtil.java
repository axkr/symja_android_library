...
/**
 * Polynomial ufd utilities. For example conversion between different representations and Kronecker
 * substitution.
 *
 * @author Heinz Kredel
 */
public class PolyUfdUtil {
  ...
  /**
   * Integral polynomial from rational function coefficients. Represent as polynomial with integral
   * polynomial coefficients by multiplication with the lcm of the numerators of the rational
  ...
  public static <C extends GcdRingElem<C>>
      GenPolynomial<GenPolynomial<C>> integralFromQuotientCoefficients(
   ...
   */
  public static <C extends GcdRingElem<C>>
      List<GenPolynomial<GenPolynomial<C>>> integralFromQuotientCoefficients(
   ...
   */
  public static <C extends GcdRingElem<C>>
      GenPolynomial<Quotient<C>> quotientFromIntegralCoefficients(
   ...
   *
   * @param fac result polynomial factory.
   * @param L list of polynomials with integral polynomial coefficients to be converted.
   * @return list of polynomials with type Quotient<C> coefficients.
   */
  public static <C extends GcdRingElem<C>>
      List<GenPolynomial<Quotient<C>>> quotientFromIntegralCoefficients(
  ...
  /**
   * From BigInteger coefficients. Represent as polynomial with type GenPolynomial&lt;C&gt;
   ...
   *
   * @param fac result polynomial factory.
   * @param L polynomial list with GenPolynomial&lt;BigInteger&gt; coefficients to be converted.
   * @return polynomial list with polynomials with type GenPolynomial&lt;C&gt; coefficients.
   */
  public static <C extends RingElem<C>>
      List<GenPolynomial<GenPolynomial<C>>> fromIntegerCoefficients(
   ...
   *
   * @param fac result polynomial factory.
   * @param A polynomial with GenPolynomial&lt;BigRational&gt; coefficients to be converted.
   ...
   *
   * @param fac result polynomial factory.
   * @param L polynomial list with GenPolynomial&lt;BigRational&gt; coefficients to be converted.
  ...
  /**
   * Introduce lower variable. Represent as polynomial with type GenPolynomial&lt;C&gt;
   * coefficients.
   *
   ...
   */
  public static <C extends GcdRingElem<C>>
      GenPolynomial<GenPolynomial<C>> substituteFromAlgebraicCoefficients(
   ...
   */
  public static <C extends GcdRingElem<C>>
      GenPolynomial<AlgebraicNumber<C>> substituteConvertToAlgebraicCoefficients(
   ...
   */
  public static <C extends GcdRingElem<C>> GenPolynomial<C> norm(
  ...
  /**
   * Ensure that the field property is determined. Checks if modul is irreducible and modifies the
  ...
  /**
   * Construct an algebraic number field of degree d. Uses a random irreducible polynomial of degree
   * d as modulus of the algebraic number ring.
   *
   * @param cfac coefficient ring.
   * @param degree of random polynomial.
   ...
   */
  public static <C extends GcdRingElem<C>> GenPolynomial<C> substituteKronecker(
      GenPolynomial<C> A) {
    if (A == null) {
      return A;
    }
  ...
  /**
   * Kronecker back substitution. Substitute x**d**(i-1) to x_i to construct a multivariate
   * polynomial.
   *
   * @param A polynomial to be converted.
   * @param fac result polynomial factory.
  ...
  /**
   * Kronecker back substitution. Substitute x**d**(i-1) to x_i to construct multivariate
   * polynomials.
   *
   * @param A list of polynomials to be converted.
   * @param fac result polynomial factory.
