...
SetDelayed(SimpSum(u_,Times(Power(Sec(z_),C2),$p(v,true))),
    Condition(Times(v,Power(Tan(z),C2)),SameQ(u,Times(CN1,v)))),
SetDelayed(SimpSum(u_,Times(Power(Csc(z_),C2),$p(v,true))),
    Condition(Times(v,Power(Cot(z),C2)),SameQ(u,Times(CN1,v)))),
SetDelayed(SimpAux(Power(Plus(Times(Cos(v_),$p(a,true)),Times(Sin(v_),$p(b,true))),n_)),
...
SetDelayed(SimpSum(Times(Power(Cosh(z_),C2),$p(u,true)),Times(Power(Sinh(z_),C2),$p(v,true))),
    Condition(u,SameQ(u,Times(CN1,v)))),
SetDelayed(SimpSum(Times(Power(Sech(z_),C2),$p(u,true)),Times(Power(Tanh(z_),C2),$p(v,true))),
    Condition(u,SameQ(u,v))),
SetDelayed(SimpSum(Times(Power(Coth(z_),C2),$p(u,true)),Times(Power(Csch(z_),C2),$p(v,true))),
    Condition(u,SameQ(u,Times(CN1,v)))),
SetDelayed(SimpSum(u_,Times(Power(Sinh(z_),C2),$p(v,true))),
    Condition(Times(u,Power(Cosh(z),C2)),SameQ(u,v))),
SetDelayed(SimpSum(u_,Times(Power(Cosh(z_),C2),$p(v,true))),
    Condition(Times(v,Power(Sinh(z),C2)),SameQ(u,Times(CN1,v)))),
SetDelayed(SimpSum(u_,Times(Power(Tanh(z_),C2),$p(v,true))),
    Condition(Times(u,Power(Sech(z),C2)),SameQ(u,Times(CN1,v)))),
SetDelayed(SimpSum(u_,Times(Power(Coth(z_),C2),$p(v,true))),
    Condition(Times(v,Power(Csch(z),C2)),SameQ(u,Times(CN1,v)))),
SetDelayed(SimpSum(u_,Times(Power(Sech(z_),C2),$p(v,true))),
    Condition(Times(u,Power(Tanh(z),C2)),SameQ(u,Times(CN1,v)))),
SetDelayed(SimpSum(u_,Times(Power(Csch(z_),C2),$p(v,true))),
    Condition(Times(u,Power(Coth(z),C2)),SameQ(u,v))),
SetDelayed(SimpAux(Power(Plus(Times(Cosh(v_),$p(a,true)),Times(Sinh(v_),$p(b,true))),n_)),
...
SetDelayed(SimpSum(Times(Power($(f_,a_),$p(n,true)),$p(u,true)),Times(Power($(f_,a_),$p(n,true)),$p(v,true))),
...
SetDelayed(SimpSum(Times(Power($(f_,a_,b_),$p(n,true)),$p(u,true)),Times(Power($(f_,a_,b_),$p(n,true)),$p(v,true))),
...
SetDelayed(ExpnExpandAux(Plus(Times(Power(x_,CN1),$p(e,true)),Times(Power(Plus(Times($p(d,true),x_),c_),CN1),$p(f,true)),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(ExpnExpandAux(Plus(Times(Power(Plus(Times($p(b,true),x_),a_),CN1),$p(e,true)),Times(Power(Plus(Times($p(d,true),x_),c_),CN1),$p(f,true)),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(ExpnExpandAux(u_,$p(x,SymbolHead)),
    u),
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(x_,$p(p,true)),$p(a,true)),Times(Power(x_,$p(q,true)),$p(b,true))),n_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(c_,m_),$p(d,true)),Times($p(b,true),v_),$p(a,true)),p_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(c_,m_),$p(b,true),v_),$p(a,true)),p_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(x_,n_),$p(b,true)),a_),p_),Power(Plus(Times(Power(x_,$p(m,true)),$p(d,true)),$p(c,true)),$p(q,true))),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Plus(Times(Power(x_,$p(n,true)),$p(b,true)),a_),Power(Plus(Times(Power(x_,$p(n,true)),$p(d,true)),c_),CN1),Power(x_,m_)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(x_,$p(k,true)),$p(b,true)),Times(Power(x_,j_),$p(c,true)),a_),n_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(x_,C4),$p(b,true)),a_),CN1),u_),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times($p(b,true),x_),$p(a,true)),$p(m,true)),Power(Plus(Times($p(d,true),x_),c_),n_)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times($p(b,true),x_),$p(a,true)),n_),Power(Plus(Times($p(d,true),x_),c_),n_),Power(x_,$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(Cos(v_),C2),$p(d,true)),$p(c,true)),CN1),Power(Sin(v_),n_)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Cos(v_),n_),Power(Plus(Times(Power(Sin(v_),C2),$p(d,true)),$p(c,true)),CN1)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Plus(Times(Power(Sin(v_),C2),$p(b,true)),a_),Power(Plus(Times(Power(Cos(v_),C2),$p(d,true)),$p(c,true)),CN1)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Plus(Times(Power(Cos(v_),C2),$p(b,true)),a_),Power(Plus(Times(Power(Sin(v_),C2),$p(d,true)),$p(c,true)),CN1)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(Sin(v_),$p(n,true)),$p(a,true)),Times(Power(Cos(v_),$p(n,true)),$p(b,true))),CN1),Power(Tan(v_),$p(n,true))),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Cot(v_),$p(n,true)),Power(Plus(Times(Power(Sin(v_),$p(n,true)),$p(a,true)),Times(Power(Cos(v_),$p(n,true)),$p(b,true))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(Cot(v_),$p(n,true)),$p(b,true)),a_),CN1),Power(Sec(v_),$p(n,true))),$p(x,SymbolHead)),
    Condition(Plus(Times(Power(Sec(v),n),Power(a,CN1)),Times(CN1,Times(b,Power(Times(a,Plus(Times(a,Power(Sin(v),n)),Times(b,Power(Cos(v),n)))),CN1)))),And(FreeQ(List(a,b),x),IntIntegerQ(n)))),
SetDelayed(ExpandExpression(Times(Power(Csc(v_),$p(n,true)),Power(Plus(Times(Power(Tan(v_),$p(n,true)),$p(b,true)),a_),CN1)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Tan(v_),$p(b,true)),a_),n_),u_),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Cot(v_),$p(b,true)),a_),n_),u_),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Cos(u_),Sin(u_),v_),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Sinh(v_),$p(n,true)),Power(x_,$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Cosh(v_),$p(n,true)),Power(x_,$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(Cosh(v_),C2),$p(d,true)),$p(c,true)),CN1),Power(Sinh(v_),n_)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Cosh(v_),n_),Power(Plus(Times(Power(Sinh(v_),C2),$p(d,true)),$p(c,true)),CN1)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Plus(Times(Power(Sinh(v_),C2),$p(b,true)),a_),Power(Plus(Times(Power(Cosh(v_),C2),$p(d,true)),$p(c,true)),CN1)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Plus(Times(Power(Cosh(v_),C2),$p(b,true)),a_),Power(Plus(Times(Power(Sinh(v_),C2),$p(d,true)),$p(c,true)),CN1)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(Sinh(v_),$p(n,true)),$p(a,true)),Times(Power(Cosh(v_),$p(n,true)),$p(b,true))),CN1),Power(Tanh(v_),$p(n,true))),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Coth(v_),$p(n,true)),Power(Plus(Times(Power(Sinh(v_),$p(n,true)),$p(a,true)),Times(Power(Cosh(v_),$p(n,true)),$p(b,true))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Power(Coth(v_),$p(n,true)),$p(b,true)),a_),CN1),Power(Sech(v_),$p(n,true))),$p(x,SymbolHead)),
    Condition(Plus(Times(Power(Sech(v),n),Power(a,CN1)),Times(CN1,Times(b,Power(Times(a,Plus(Times(a,Power(Sinh(v),n)),Times(b,Power(Cosh(v),n)))),CN1)))),And(FreeQ(List(a,b),x),IntIntegerQ(n)))),
SetDelayed(ExpandExpression(Times(Power(Csch(v_),$p(n,true)),Power(Plus(Times(Power(Tanh(v_),$p(n,true)),$p(b,true)),a_),CN1)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Tanh(v_),$p(b,true)),a_),n_),u_),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(Plus(Times(Coth(v_),$p(b,true)),a_),n_),u_),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Cosh(u_),Sinh(u_),v_),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpression(Times(Power(v_,n_),$p(u,true)),$p(x,SymbolHead)),
...
SetDelayed(ExpandExpressionAux(Times(Plus(Times(Power(x_,$p(k,true)),$p(e,true)),d_),Power(Plus(Times(Power(x_,k_),$p(b,true)),Times(Power(x_,j_),$p(c,true)),a_),n_)),$p(x,SymbolHead)),
...
SetDelayed(RegularizeTerm(Times(Power(Plus(Times(Power(x_,n_),$p(b,true)),a_),CN1),$p(c,true),u_),$p(x,SymbolHead)),
