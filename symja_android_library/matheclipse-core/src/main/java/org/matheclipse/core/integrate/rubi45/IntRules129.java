...
ISetDelayed(10339,Int(Times(x_,FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(10340,Int(Times(x_,Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10341,Int(Times(Power(x_,m_),FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(10342,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10343,Int(Times(Power(x_,m_),FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(10344,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10345,Int(Times(x_,Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10346,Int(Times(x_,FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(10347,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10348,Int(Times(Power(x_,m_),FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(10349,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10350,Int(Times(Power(x_,m_),FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(10351,Int(FresnelS(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
ISetDelayed(10352,Int(FresnelC(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
ISetDelayed(10353,Int(Times(Power(x_,-1),$(F_,Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),d_DEFAULT))),x_Symbol),
...
ISetDelayed(10354,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),FresnelS(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(10355,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),FresnelC(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(10356,Int(ExpIntegralE(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Negate(Simp(Times(ExpIntegralE(Plus(n,C1),Plus(a,Times(b,x))),Power(b,-1)),x)),FreeQ(List(a,b,n),x))),
ISetDelayed(10357,Int(Times(Power(x_,m_DEFAULT),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10358,Int(Times(Power(x_,-1),ExpIntegralE(C1,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10359,Int(Times(Power(x_,m_),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10360,Int(Times(Power(Times(d_DEFAULT,x_),m_),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10361,Int(Times(Power(Times(d_DEFAULT,x_),m_DEFAULT),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10362,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralE(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(10363,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralE(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(10364,Int(ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10365,Int(Times(Power(x_,-1),ExpIntegralEi(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10366,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(10367,Int(Sqr(ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(10368,Int(Times(Power(x_,m_DEFAULT),Sqr(ExpIntegralEi(Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(10369,Int(Times(Power(x_,m_DEFAULT),Sqr(ExpIntegralEi(Plus(a_,Times(b_DEFAULT,x_))))),x_Symbol),
...
ISetDelayed(10370,Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(10371,Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Power(x_,m_DEFAULT),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(10372,Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Power(x_,m_),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(10373,Int(ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
ISetDelayed(10374,Int(Times(Power(x_,-1),ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
    Condition(Dist(Power(n,-1),Subst(ExpIntegralEi(Times(d,Plus(a,Times(b,x)))),x,Log(Times(c,Power(x,n)))),x),FreeQ(List(a,b,c,d,n),x))),
ISetDelayed(10375,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(10376,Int(LogIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10377,Int(Times(Power(x_,-1),LogIntegral(Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Plus(Negate(Simp(Times(b,x),x)),Simp(Times(Log(Times(b,x)),LogIntegral(Times(b,x))),x)),FreeQ(b,x))),
ISetDelayed(10378,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),LogIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(10379,Int(SinIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(10380,Int(CosIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
