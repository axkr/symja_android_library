...
public interface ISequence {
  ...
  /**
   * Get the generated sequence of indices for this ISequence. Especially useful for unit tests to
   * check the sequence implementation.
   *
  ...
  /**
   * Sets the list size of the current used list in the generics library. Sometimes this setting is
   * used by special sequence implementations.
   *
   * @param size
   */
