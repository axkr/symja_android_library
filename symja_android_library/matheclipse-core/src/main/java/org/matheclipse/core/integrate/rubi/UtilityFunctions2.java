...
SetDelayed(SmartTrigExpand(Times(Csc(u_),Cos(Times(n_,u_))),$p(x,SymbolHead)),
...
SetDelayed(SmartTrigExpand(Times(Csch(u_),Cosh(Times(n_,u_))),$p(x,SymbolHead)),
...
SetDelayed(SmartTrigExpand(Times(Power(Csch(u_),C2),Cosh(Times(n_,u_))),$p(x,SymbolHead)),
...
SetDelayed(SmartTrigExpand(Times(Power(Csch(u_),C3),Cosh(Times(n_,u_))),$p(x,SymbolHead)),
