...
/**
 * Modular coefficients factorization algorithms. This class implements factorization methods for
...
public class FactorModular<MOD extends GcdRingElem<MOD> & Modular> extends FactorAbsolute<MOD> {
   ...
   * @return [e_1 -&gt; p_1, ..., e_k -&gt; p_k] with P = prod_{i=1,...,k} p_i and p_i has only
   *     irreducible factors of degree e_i.
   */
