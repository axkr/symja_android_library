...
/**
 * ModInteger class with GcdRingElem interface. Objects of this class are immutable. The SAC2 static
...
public final class ModInteger implements GcdRingElem<ModInteger>, Modular {
  ...
  /**
   * Returns the number of bits in the representation of this ModInteger, including a sign bit. For
   * positive ModIntegers, this is equivalent to {@code val.bitLength()}.)
   *
   * @return number of bits in the representation of this ModInteger, including a sign bit.
   */
