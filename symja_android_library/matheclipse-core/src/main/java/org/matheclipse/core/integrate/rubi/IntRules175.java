...
IIntegrate(4378,Int(u_,x_Symbol),
    With(List(Set(v,FunctionOfTrig(u,x))),Condition(Simp(With(List(Set(d,FreeFactors(Sin(v),x))),Dist(Times(d,Power(Coefficient(v,x,C1),CN1)),Subst(Int(SubstFor(C1,Times(Sin(v),Power(d,CN1)),Times(u,Power(Cos(v),CN1)),x),x),x,Times(Sin(v),Power(d,CN1))),x)),x),And(Not(FalseQ(v)),FunctionOfQ(NonfreeFactors(Sin(v),x),Times(u,Power(Cos(v),CN1)),x))))),
IIntegrate(4379,Int(u_,x_Symbol),
    With(List(Set(v,FunctionOfTrig(u,x))),Condition(Simp(With(List(Set(d,FreeFactors(Cos(v),x))),Dist(Times(CN1,d,Power(Coefficient(v,x,C1),CN1)),Subst(Int(SubstFor(C1,Times(Cos(v),Power(d,CN1)),Times(u,Power(Sin(v),CN1)),x),x),x,Times(Cos(v),Power(d,CN1))),x)),x),And(Not(FalseQ(v)),FunctionOfQ(NonfreeFactors(Cos(v),x),Times(u,Power(Sin(v),CN1)),x))))),
IIntegrate(4380,Int(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(Sqr($($s("§cos"),Plus(d_DEFAULT,Times(e_DEFAULT,x_)))),b_DEFAULT),Times(c_DEFAULT,Sqr($($s("§sin"),Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),p_DEFAULT)),x_Symbol),
    Condition(Dist(Power(Plus(a,c),p),Int(ActivateTrig(u),x),x),And(FreeQ(List(a,b,c,d,e,p),x),EqQ(Subtract(b,c),C0)))),
...
IIntegrate(4382,Int(Times(Power(Plus(a_DEFAULT,Times(Sqr($($s("§cot"),Plus(d_DEFAULT,Times(e_DEFAULT,x_)))),b_DEFAULT),Times(Sqr($($s("§csc"),Plus(d_DEFAULT,Times(e_DEFAULT,x_)))),c_DEFAULT)),p_DEFAULT),u_DEFAULT),x_Symbol),
    Condition(Dist(Power(Plus(a,c),p),Int(ActivateTrig(u),x),x),And(FreeQ(List(a,b,c,d,e,p),x),EqQ(Plus(b,c),C0)))),
IIntegrate(4383,Int(Times(u_,Power(y_,CN1)),x_Symbol),
...
IIntegrate(4384,Int(Times(u_,Power(w_,CN1),Power(y_,CN1)),x_Symbol),
...
IIntegrate(4393,Int(Times(u_,Power(Plus(Times(a_,Power($(F_,Plus(c_DEFAULT,Times(d_DEFAULT,x_))),p_DEFAULT)),Times(b_DEFAULT,Power($(F_,Plus(c_DEFAULT,Times(d_DEFAULT,x_))),q_DEFAULT))),n_DEFAULT)),x_Symbol),
    Condition(Int(ActivateTrig(Times(u,Power(F(Plus(c,Times(d,x))),Times(n,p)),Power(Plus(a,Times(b,Power(F(Plus(c,Times(d,x))),Subtract(q,p)))),n))),x),And(FreeQ(List(a,b,c,d,p,q),x),InertTrigQ(FSymbol),IntegerQ(n),PosQ(Subtract(q,p))))),
IIntegrate(4394,Int(Times(u_,Power(Plus(Times(a_,Power($(F_,Plus(d_DEFAULT,Times(e_DEFAULT,x_))),p_DEFAULT)),Times(b_DEFAULT,Power($(F_,Plus(d_DEFAULT,Times(e_DEFAULT,x_))),q_DEFAULT)),Times(c_DEFAULT,Power($(F_,Plus(d_DEFAULT,Times(e_DEFAULT,x_))),r_DEFAULT))),n_DEFAULT)),x_Symbol),
    Condition(Int(ActivateTrig(Times(u,Power(F(Plus(d,Times(e,x))),Times(n,p)),Power(Plus(a,Times(b,Power(F(Plus(d,Times(e,x))),Subtract(q,p))),Times(c,Power(F(Plus(d,Times(e,x))),Subtract(r,p)))),n))),x),And(FreeQ(List(a,b,c,d,e,p,q,r),x),InertTrigQ(FSymbol),IntegerQ(n),PosQ(Subtract(q,p)),PosQ(Subtract(r,p))))),
IIntegrate(4395,Int(Times(u_,Power(Plus(a_,Times(b_DEFAULT,Power($(F_,Plus(d_DEFAULT,Times(e_DEFAULT,x_))),p_DEFAULT)),Times(c_DEFAULT,Power($(F_,Plus(d_DEFAULT,Times(e_DEFAULT,x_))),q_DEFAULT))),n_DEFAULT)),x_Symbol),
    Condition(Int(ActivateTrig(Times(u,Power(F(Plus(d,Times(e,x))),Times(n,p)),Power(Plus(b,Times(a,Power(Power(F(Plus(d,Times(e,x))),p),CN1)),Times(c,Power(F(Plus(d,Times(e,x))),Subtract(q,p)))),n))),x),And(FreeQ(List(a,b,c,d,e,p,q),x),InertTrigQ(FSymbol),IntegerQ(n),NegQ(p)))),
IIntegrate(4396,Int(Times(u_DEFAULT,Power(Plus(Times($($s("§cos"),Plus(c_DEFAULT,Times(d_DEFAULT,x_))),a_DEFAULT),Times(b_DEFAULT,$($s("§sin"),Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),n_DEFAULT)),x_Symbol),
    Condition(Int(Times(ActivateTrig(u),Power(Times(a,Power(Exp(Times(a,Plus(c,Times(d,x)),Power(b,CN1))),CN1)),n)),x),And(FreeQ(List(a,b,c,d,n),x),EqQ(Plus(Sqr(a),Sqr(b)),C0)))),
...
IIntegrate(4398,Int(Times(u_DEFAULT,Power(Times(a_,v_),p_)),x_Symbol),
    Condition(With(List(Set($s("uu"),ActivateTrig(u)),Set($s("vv"),ActivateTrig(v))),Dist(Times(Power(a,IntPart(p)),Power(Times(a,$s("vv")),FracPart(p)),Power(Power($s("vv"),FracPart(p)),CN1)),Int(Times($s("uu"),Power($s("vv"),p)),x),x)),And(FreeQ(List(a,p),x),Not(IntegerQ(p)),Not(InertTrigFreeQ(v))))),
IIntegrate(4399,Int(Times(u_DEFAULT,Power(Power(v_,m_),p_)),x_Symbol),
    Condition(With(List(Set($s("uu"),ActivateTrig(u)),Set($s("vv"),ActivateTrig(v))),Dist(Times(Power(Power($s("vv"),m),FracPart(p)),Power(Power($s("vv"),Times(m,FracPart(p))),CN1)),Int(Times($s("uu"),Power($s("vv"),Times(m,p))),x),x)),And(FreeQ(List(m,p),x),Not(IntegerQ(p)),Not(InertTrigFreeQ(v))))),
IIntegrate(4400,Int(Times(u_DEFAULT,Power(Times(Power(v_,m_DEFAULT),Power(w_,n_DEFAULT)),p_)),x_Symbol),
    Condition(With(List(Set($s("uu"),ActivateTrig(u)),Set($s("vv"),ActivateTrig(v)),Set($s("ww"),ActivateTrig(w))),Dist(Times(Power(Times(Power($s("vv"),m),Power($s("ww"),n)),FracPart(p)),Power(Times(Power($s("vv"),Times(m,FracPart(p))),Power($s("ww"),Times(n,FracPart(p)))),CN1)),Int(Times($s("uu"),Power($s("vv"),Times(m,p)),Power($s("ww"),Times(n,p))),x),x)),And(FreeQ(List(m,n,p),x),Not(IntegerQ(p)),Or(Not(InertTrigFreeQ(v)),Not(InertTrigFreeQ(w))))))
  );
}
