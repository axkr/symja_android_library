...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"AccuracyGoal", "All", "AllowedHeads",
      ...
      "Rationals", "ReadProtected", "Real", "Record", "RecordSeparators", "Red", "Reals", "Residue",
      "Right", "SameTest", "ScalingFunctions", "Second", "SequenceHold", "SetSystemOptions",
      "Small", "SystemOptions", "SlotAbsent", "StaticsVisible", "StartOfLine", "StartOfString",
      ...
      "WordSeparators", "WorkingPrecision", "Yellow", "ZeroTest"};
