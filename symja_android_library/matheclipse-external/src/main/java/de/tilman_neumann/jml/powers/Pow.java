...
public class Pow {
  ...
  public static BigDecimal pow(BigDecimal x, int n, Scale resultScale) {
    ...
    Precision resultPrecision =
        Precision.valueOf(Math.max(resultScale.digits() + resultMagnitude, 0));
  ...
  /**
   * Built-in Java implementation of the pow function for integer exponents between
   * -999999999...999999999. Only the <code>decPrec</code> leading digits of the output are correct!
   *
   * @param x
   * @param n
   * @return x^n
