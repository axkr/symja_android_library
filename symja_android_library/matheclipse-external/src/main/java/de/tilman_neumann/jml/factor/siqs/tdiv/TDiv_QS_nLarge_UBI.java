...
/**
 * A trial division engine where partials can have several large factors. Division is carried out
...
public class TDiv_QS_nLarge_UBI implements TDiv_QS {
  ...
  private boolean factor_recurrent(BigInteger Q_rest) {
    // Here we need a prime test, because factor algorithms may not return when called with a prime
    // argument.
