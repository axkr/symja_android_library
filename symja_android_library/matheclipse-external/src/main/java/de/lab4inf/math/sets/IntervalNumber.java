...
public class IntervalNumber extends Number implements Interval, Field<Interval> {
  ...
  /**
   * Indicate if the interval is a subset of [0,1], i.e. can be a logical value.
   *
   * @return logical flag.
   */
  @Override
  ...
  /**
   * Indicate if this interval is a subset of that interval, i.e. that.l <= l && r <= that.r
   *
  ...
  /**
   * Indicate if this is a none interval, i.e. an empty intersection of two intervals.
   *
   * @return null flag
   */
  @Override
  ...
  /**
   * Indicate if this is an empty interval, i.e. is either the null interval or has zero Borel
   * measure and is crisp singular real number.
   *
   * @return empty flag
   */
  @Override
  ...
  /**
   * Calculate the logical AND operation of this AND that, using product logic,
   *
