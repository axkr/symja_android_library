...
public class BigFraction extends Number implements FieldElement<BigFraction>, Comparable<BigFraction>, Serializable {
	...
	/**
	 * Create a {@link BigFraction} given the numerator and denominator as {@code BigInteger}. The {@link BigFraction} is reduced to
	 * lowest terms.
	 * 
	 * @param num
	 ...
	 * exactly, considering its internal bits representation. This works for all values except NaN and infinities and does not
	 * requires any loop or convergence threshold.
	 * </p>
	 * <p>
	 * Since this conversion is exact and since double numbers are sometimes approximated, the fraction created may seem strange in
	 * some cases. For example, calling <code>new BigFraction(1.0 / 3.0)</code> does <em>not</em> create the fraction 1/3, but the
	 * fraction 6004799503160661 / 18014398509481984 because the double number passed to the constructor is not exactly 1/3 (this
	 * number cannot be stored exactly in IEEE754).
	 * </p>
	 * 
	 ...
	 *            the double value to convert to a fraction.
	 * @param epsilon
	 *            maximum error allowed. The resulting fraction is within <code>epsilon</code> of <code>value</code>, in absolute
	 *            terms.
	 * @param maxIterations
	 ...
	 * <p>
	 * 
	 * NOTE: This constructor is called with EITHER - a valid epsilon value and the maxDenominator set to Integer.MAX_VALUE (that
	 * way the maxDenominator has no effect). OR - a valid maxDenominator value and the epsilon value set to zero (that way epsilon
	 * only has effect if there is an exact match before the maxDenominator value is reached).
	 * </p>
	 * <p>
	 * 
	 * It has been done this way so that the same code can be (re)used for both scenarios. However this could be confusing to users
	 * if it were part of the public API and this constructor should therefore remain PRIVATE.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Create a {@link BigFraction} given the numerator and denominator as simple <tt>int</tt>. The {@link BigFraction} is reduced
	 * to lowest terms.
	 * </p>
	 * 
	 * @param num
	...
	/**
	 * <p>
	 * Create a {@link BigFraction} given the numerator and denominator as simple <tt>long</tt>. The {@link BigFraction} is reduced
	 * to lowest terms.
	 * </p>
	 * 
	 * @param num
	...
	/**
	 * <p>
	 * Gets the fraction as a <code>BigDecimal</code> following the passed rounding mode. This calculates the fraction as the
	...
	/**
	 * <p>
	 * Gets the fraction as a <code>BigDecimal</code> following the passed scale and rounding mode. This calculates the fraction as
	 * the numerator divided by denominator.
	 * </p>
	 * 
	 * @param scale
	 *            scale of the <code>BigDecimal</code> quotient to be returned. see {@link BigDecimal} for more information.
	 * @param roundingMode
	 *            rounding mode to apply. see {@link BigDecimal} constants.
	 * @return the fraction as a <code>BigDecimal</code>.
	 * @see BigDecimal
	...
	/**
	 * <p>
	 * Divide the value of this fraction by the passed {@code BigInteger}, ie {@code this * 1 / bg}, returning the result in reduced
	 * form.
	 * </p>
	 * 
	 * @param bg
	...
	/**
	 * <p>
	 * Test for the equality of two fractions. If the lowest term numerator and denominators are the same for both fractions, the
	...
	/**
	 * <p>
	 * Gets the fraction percentage as a <tt>double</tt>. This calculates the fraction as the numerator divided by denominator
	 * multiplied by 100.
	 * </p>
	 * 
	 ...
	 * </p>
	 * 
	 * @return the reduced <code>BigFraction</code>. It doesn't change anything if the fraction can be reduced.
	 */
	...
	/**
	 * <p>
	 * Subtracts the value of an {@link BigInteger} from the value of this {@code BigFraction}, returning the result in reduced
	 * form.
	 * </p>
	 * 
	 * @param bg
