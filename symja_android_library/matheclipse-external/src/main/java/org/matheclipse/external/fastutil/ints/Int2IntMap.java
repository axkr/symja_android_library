 ...
 */
// Slim replacement for it.unimi.dsi.fastutil.ints.Int2IntMap, adapted from fastutil 8.5.19
...
/** A type-specific {@link Map} from primitive ints to primitive ints. */
public interface Int2IntMap extends Map<Integer, Integer> {

  /** A type-specific {@link Map.Entry}; provides primitive access to key and value. */
  ...
  /** Sets the value returned for keys that are not present. Defaults to 0. */
