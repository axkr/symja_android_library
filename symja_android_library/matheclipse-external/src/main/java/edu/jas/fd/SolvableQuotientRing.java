...
/**
 * SolvableQuotient ring factory based on GenPolynomial with RingElem interface. Objects of this
 * class are immutable.
 *
 * @author Heinz Kredel
 */
public class SolvableQuotientRing<C extends GcdRingElem<C>>
  ...
  /**
   * Parse SolvableQuotient from String. Syntax: "{ polynomial | polynomial }" or "{ polynomial }"
