...
public class Complex<C extends RingElem<C>>
  ...
  /**
   * The constructor creates a Complex object from a C object as real part, the imaginary part is
   * set to 0.
   *
   * @param r real part.
   */
  ...
  /**
   * The constructor creates a Complex object from a long element as real part, the imaginary part
   * is set to 0.
   *
   * @param r real part.
   */
   ...
   *
   * @return 0 if this is equal to b; 1 if re > b.re, or re == b.re and im > b.im; -1 if re < b.re,
   *     or re == b.re and im < b.im
   */
  @Override
   ...
   * Since complex numbers are unordered, we use lexicographical order of re and im.
   *
   * @return 0 if this is equal to 0; 1 if re > 0, or re == 0 and im > 0; -1 if re < 0, or re == 0
   *     and im < 0
  ...
  public Complex<C>[] egcd(Complex<C> S) {
    ...
    if (ring.isField()) {
      Complex<C> half =
          new Complex<C>(ring, ring.ring.fromInteger(1).divide(ring.ring.fromInteger(2)));
      ret[0] = ring.getONE();
