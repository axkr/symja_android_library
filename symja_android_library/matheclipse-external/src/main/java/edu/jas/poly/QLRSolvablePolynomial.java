...
/**
 * QLRSolvablePolynomial generic recursive solvable polynomials implementing RingElem. n-variate
 * ordered solvable polynomials over solvable quotient, local and local-residue coefficients.
 ...
 * @author Heinz Kredel
 */
public class QLRSolvablePolynomial<
      ...
      for (Map.Entry<ExpVector, C> x : Bk) {
        ...
        if (ring.polCoeff.isCommutative() || b.isConstant() || e.isZERO()) { // symmetric
          ...
          if (b.denominator().isONE()) { // recursion base
            ...
            RecSolvablePolynomial<D> rsp2 =
                new RecSolvablePolynomial<D>(ring.polCoeff, b.numerator());
            ...
            C qdeni =
                ring.qpfac.create(ring.qpfac.pairFactory().getONE(), b.denominator()); // 1/den
        ...
        if (debug) logger.info("coeff-den: Cps = " + Cps);
  ...
  /**
   * QLRSolvablePolynomial left and right multiplication. Product with two polynomials.
   *
   ...
   */
  // not @Override
  public QLRSolvablePolynomial<C, D> multiply(
      QLRSolvablePolynomial<C, D> S, QLRSolvablePolynomial<C, D> T) {
  ...
  /**
   * QLRSolvablePolynomial multiplication. Product with coefficient ring element.
   *
  ...
  /**
   * QLRSolvablePolynomial left and right multiplication. Product with coefficient ring element.
   *
  ...
  /**
   * QLRSolvablePolynomial left and right multiplication. Product with exponent vector.
   *
   * @param e exponent.
   * @param f exponent.
  ...
  /**
   * QLRSolvablePolynomial multiplication. Product with ring element and exponent vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  /**
   * QLRSolvablePolynomial left and right multiplication. Product with ring element and exponent
   * vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  /**
   * QLRSolvablePolynomial multiplication. Left product with ring element and exponent vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  /**
   * QLRSolvablePolynomial multiplication. Left product with coefficient ring element.
   *
   * @param b coefficient polynomial.
