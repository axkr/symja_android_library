...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AbsoluteCorrelation", "Accumulate",
			...
			"DialogReturn", "DiceDissimilarity", "Differences", "DigitQ", "Dimensions", "DiracDelta", "DirichletEta",
			...
			"Divisible", "Divisors", "DivisorSigma", "Do", "Dot", "Drop", "Dynamic", "DSolve", "EasterSunday",
			...
			"Permutations", "PieChart", "Piecewise", "PiecewiseExpand", "Plot", "PlotRange", "Plot3D", "Plus", "Pochhammer", "PolarPlot",
			...
			"QuotientRemainder", "Ramp", "RandomChoice", "RandomInteger", "RandomPrime", "RandomReal", "RandomSample",
			...
			"StringDrop", "StringExpression", "StringJoin", "StringLength", "StringRiffle", "StringTake", "StringQ",
