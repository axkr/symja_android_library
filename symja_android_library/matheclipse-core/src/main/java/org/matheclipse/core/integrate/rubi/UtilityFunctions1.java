...
SetDelayed(QuadraticQ(u_,$p("x",$s("Symbol"))),
    And(PolynomialQ(u,x),SameQ(Exponent(u,x),C2))),
...
SetDelayed(ImproperRationalFunctionQ(u_,v_,$p("x",$s("Symbol"))),
    And(And(And(PolynomialQ(u,x),PolynomialQ(v,x)),Not(And(MatchQ(u,Condition(Power(Plus($p("a",true),Times($p("b",true),x)),$p("n",true)),And(FreeQ(List(a,b),x),IntegerQ(n)))),MatchQ(v,Condition(Power(Plus($p("a",true),Times($p("b",true),x)),$p("n",true)),And(FreeQ(List(a,b),x),IntegerQ(n))))))),Or(And(QuadraticQ(v,x),GreaterEqual(Exponent(u,x),C2)),MatchQ(v,Condition(Plus(a_,Times($p("b",true),Power(x,$p("n",true)))),And(And(FreeQ(List(a,b),x),IntegerQ(n)),And(Less(C0,n),LessEqual(n,Exponent(u,x))))))))),
...
SetDelayed(SmartNumerator(u_),
    If(MemberQ(List($s("Cot"),$s("Sec"),$s("Csc"),$s("Coth"),$s("Sech"),$s("Csch")),Head(u)),C1,If(And(And(PowerQ(u),IntegerQ(Part(u,C2))),MemberQ(List($s("Cot"),$s("Sec"),$s("Csc"),$s("Coth"),$s("Sech"),$s("Csch")),Head(Part(u,C1)))),C1,If(And(And(PowerQ(u),RationalQ(Part(u,C2))),Less(Part(u,C2),C0)),C1,If(ProductQ(u),Map($s("Integrate::SmartNumerator"),u),u))))),
SetDelayed(SmartDenominator(u_),
    If(MemberQ(List($s("Cot"),$s("Sec"),$s("Csc"),$s("Coth"),$s("Sech"),$s("Csch")),Head(u)),Times(C1,Power(u,CN1)),If(And(And(PowerQ(u),IntegerQ(Part(u,C2))),MemberQ(List($s("Cot"),$s("Sec"),$s("Csc"),$s("Coth"),$s("Sech"),$s("Csch")),Head(Part(u,C1)))),Times(C1,Power(u,CN1)),If(And(And(PowerQ(u),RationalQ(Part(u,C2))),Less(Part(u,C2),C0)),Times(C1,Power(u,CN1)),If(ProductQ(u),Map($s("Integrate::SmartDenominator"),u),C1))))),
...
SetDelayed(RecognizedFormQ(u_,$p("x",$s("Symbol"))),
    Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(Or(FreeQ(u,x),MonomialQ(u,x)),MatchQ(u,Condition(Times(a_,v_),And(FreeQ(a,x),RecognizedFormQ(v,x))))),MatchQ(u,Condition(Power($(f_,Plus($p("a",true),Times($p("b",true),x))),$p("n",true)),And(FreeQ(List(a,b,f),x),IntegerQ(n))))),MatchQ(u,Condition(Power(Plus(a_,Times($p("b",true),Power(x,$p("n",true)))),$p("p",true)),And(And(FreeQ(List(a,b,n,p),x),IntegerQ(n)),Greater(n,C0))))),MatchQ(u,Condition(Times(Power(x,$p("m",true)),Power(Plus(a_,Times($p("b",true),Power(x,$p("n",true)))),$p("p",true))),And(And(FreeQ(List(a,b,m,n,p),x),IntegerQ(n)),Greater(n,C0))))),MatchQ(u,Condition(Times(Power(Plus($p("a",true),Times($p("b",true),x)),$p("m",true)),Power(Plus($p("c",true),Times($p("d",true),x)),$p("n",true))),FreeQ(List(a,b,c,d,m,n),x)))),MatchQ(u,Condition(Times(Times(Power(x,$p("p",true)),Power(Plus($p("a",true),Times($p("b",true),x)),$p("m",true))),Power(Plus($p("c",true),Times($p("d",true),x)),$p("n",true))),FreeQ(List(a,b,c,d,m,n,p),x)))),MatchQ(u,Condition(Times(Power(x,$p("m",true)),Power(Plus(Times($p("b",true),x),Times($p("c",true),Power(x,C2))),n_)),And(FreeQ(List(b,c,m,n),x),Not(IntegerQ(n)))))),MatchQ(u,Condition(Power(Plus(Plus($p("a",true),Times($p("b",true),x)),Times($p("c",true),Power(x,C2))),$p("n",true)),FreeQ(List(a,b,c,n),x)))),MatchQ(u,Condition(Times(Power(x,$p("m",true)),Power(Plus(Plus(a_,Times($p("b",true),x)),Times($p("c",true),Power(x,C2))),$p("n",true))),FreeQ(List(a,b,c,m,n),x)))),MatchQ(u,Condition(Times(Plus(d_,Times($p("e",true),x)),Power(Plus(Plus(a_,Times($p("b",true),x)),Times($p("c",true),Power(x,C2))),CN1)),FreeQ(List(a,b,c,d,e),x)))),MatchQ(u,Condition(Times(Power(x,$p("m",true)),Times(Plus(d_,Times($p("e",true),x)),Power(Plus(Plus(a_,Times($p("b",true),x)),Times($p("c",true),Power(x,C2))),CN1))),FreeQ(List(a,b,c,d,e),x)))),MatchQ(u,Condition(Times(v_,Plus(a_,Times($p("b",true),x))),And(FreeQ(List(a,b),x),FunctionOfQ(Plus(Times(a,x),Times(b,Times(Power(x,C2),C1D2))),v,x))))),MatchQ(u,Condition(Times(Plus(Times($p("a",true),Power(v_,$p("m",true))),Times($p("b",true),Power(v_,$p("n",true)))),Power(Plus(Times($p("c",true),Power(v_,$p("m",true))),Times($p("d",true),Power(v_,$p("n",true)))),CN1)),FreeQ(List(a,b,c,d,m,n),x))))),
...
SetDelayed(NormalForm($(f_,Times(Times($p("c",true),Power(x_,$p("m",true))),Power(Plus(a_,Times($p("b",true),Power(x_,$p("n",true)))),p_))),$p("x",$s("Symbol"))),
    Condition($(f,Times(c,Power(Plus(b,Times(a,Power(Power(x,n),CN1))),p))),And(And(FreeQ(List(a,b,c,f,m,n),x),IntegerQ(p)),ZeroQ(Plus(m,Times(n,p)))))),
...
SetDelayed(NormalForm(Times(Times($p("u",true),Power(f_,v_)),Power(g_,w_)),$p("x",$s("Symbol"))),
    Condition(Times(u,Power(E,Sum(Times(Plus(Times(Log(f),Coefficient(v,x,k)),Times(Log(g),Coefficient(w,x,k))),Power(x,k)),List(k,C0,C2)))),And(And(And(And(FreeQ(List(f,g),x),PolynomialQ(v,x)),LessEqual(LessEqual(C1,Exponent(v,x)),C2)),PolynomialQ(w,x)),LessEqual(LessEqual(C1,Exponent(w,x)),C2)))),
...
SetDelayed(QuadraticPolynomialQ(u_,$p("x",$s("Symbol"))),
    And(And(PolynomialQ(u,x),LessEqual(Exponent(u,x),C2)),Not(MatchQ(u,Condition(Times($p("a",true),Power(v_,C2)),FreeQ(a,x)))))),
...
SetDelayed(SimplifyExpression(Times(C1,Power(Plus(Plus(Times($p("a",true),x_),Times($p("b",true),Power(x_,m_))),Times($p("c",true),Power(x_,n_))),CN1)),$p("x",$s("Symbol"))),
    Condition(Times(C1,Power(Times(x,Plus(Plus(a,Times(b,Power(x,Plus(m,Times(CN1,C1))))),Times(c,Power(x,Plus(n,Times(CN1,C1)))))),CN1)),And(And(And(FreeQ(List(a,b,c),x),IntegerQ(List(m,n))),Greater(m,C2)),Equal(Plus(n,Times(CN1,C1)),Times(C2,Plus(m,Times(CN1,C1))))))),
...
SetDelayed(TrigSimplifyAux(Times($p("u",true),Power(Plus(Times($p("a",true),Power(v_,$p("m",true))),Times($p("b",true),Power(v_,$p("n",true)))),p_))),
    Condition(Times(Times(u,Power(v,Times(m,p))),Power(TrigSimplifyAux(Plus(a,Times(b,Power(v,Plus(n,Times(CN1,m)))))),p)),And(And(And(Or(TrigQ(v),HyperbolicQ(v)),IntegerQ(p)),RationalQ(List(m,n))),Less(m,n)))),
...
SetDelayed(TrigSimplifyAux(Times($p("u",true),Times(Power(Tan(v_),$p("n",true)),Power(Plus(a_,Times($p("b",true),Power(Tan(v_),$p("n",true)))),CN1)))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cot(v),n))),CN1)),And(And(IntegerQ(n),Greater(n,C0)),NonsumQ(a)))),
SetDelayed(TrigSimplifyAux(Times($p("u",true),Times(Power(Cot(v_),$p("n",true)),Power(Plus(a_,Times($p("b",true),Power(Cot(v_),$p("n",true)))),CN1)))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Tan(v),n))),CN1)),And(And(IntegerQ(n),Greater(n,C0)),NonsumQ(a)))),
SetDelayed(TrigSimplifyAux(Times($p("u",true),Times(Power(Sec(v_),$p("n",true)),Power(Plus(a_,Times($p("b",true),Power(Sec(v_),$p("n",true)))),CN1)))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cos(v),n))),CN1)),And(And(IntegerQ(n),Greater(n,C0)),NonsumQ(a)))),
SetDelayed(TrigSimplifyAux(Times($p("u",true),Times(Power(Csc(v_),$p("n",true)),Power(Plus(a_,Times($p("b",true),Power(Csc(v_),$p("n",true)))),CN1)))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Sin(v),n))),CN1)),And(And(IntegerQ(n),Greater(n,C0)),NonsumQ(a)))),
...
SetDelayed(TrigSimplifyAux(Times(Times($p("u",true),Power(Sin(v_),$p("m",true))),Power(Plus($p("a",true),Times($p("b",true),Power(Cot(v_),$p("n",true)))),$p("p",true)))),
    Condition(Times(Times(u,Power(Sin(v),Plus(m,Times(CN1,Times(n,p))))),Power(Plus(Times(b,Power(Cos(v),n)),Times(a,Power(Sin(v),n))),p)),IntegerQ(List(m,n,p)))),
SetDelayed(TrigSimplifyAux(Times(Times($p("u",true),Power(Cos(v_),$p("m",true))),Power(Plus($p("a",true),Times($p("b",true),Power(Tan(v_),$p("n",true)))),$p("p",true)))),
    Condition(Times(Times(u,Power(Cos(v),Plus(m,Times(CN1,Times(n,p))))),Power(Plus(Times(b,Power(Sin(v),n)),Times(a,Power(Cos(v),n))),p)),IntegerQ(List(m,n,p)))),
SetDelayed(TrigSimplifyAux(Times(Times(u_,Power(Sec(v_),$p("m",true))),Power(Plus($p("a",true),Times($p("b",true),Power(Tan(v_),C2))),$p("p",true)))),
    Condition(Times(u,Power(Plus(Times(b,Power(Sin(v),C2)),Times(a,Power(Cos(v),C2))),p)),And(IntegerQ(List(m,p)),Equal(Plus(m,Times(C2,p)),C0)))),
SetDelayed(TrigSimplifyAux(Times(Times(u_,Power(Csc(v_),$p("m",true))),Power(Plus($p("a",true),Times($p("b",true),Power(Cot(v_),C2))),$p("p",true)))),
    Condition(Times(u,Power(Plus(Times(b,Power(Cos(v),C2)),Times(a,Power(Sin(v),C2))),p)),And(IntegerQ(List(m,p)),Equal(Plus(m,Times(C2,p)),C0)))),
SetDelayed(TrigSimplifyAux(Times(Times($p("u",true),Power(Cos(v_),$p("m",true))),Power(Plus(Plus($p("a",true),Times($p("b",true),Power(Tan(v_),$p("n",true)))),Times($p("c",true),Power(Sec(v_),$p("n",true)))),$p("p",true)))),
    Condition(Times(Times(u,Power(Cos(v),Plus(m,Times(CN1,Times(n,p))))),Power(Plus(Plus(c,Times(b,Power(Sin(v),n))),Times(a,Power(Cos(v),n))),p)),IntegerQ(List(m,n,p)))),
SetDelayed(TrigSimplifyAux(Times(Times($p("u",true),Power(Sec(v_),$p("m",true))),Power(Plus(Plus($p("a",true),Times($p("b",true),Power(Tan(v_),$p("n",true)))),Times($p("c",true),Power(Sec(v_),$p("n",true)))),$p("p",true)))),
    Condition(Times(Times(u,Power(Sec(v),Plus(m,Times(n,p)))),Power(Plus(Plus(c,Times(b,Power(Sin(v),n))),Times(a,Power(Cos(v),n))),p)),IntegerQ(List(m,n,p))))
  );
}
