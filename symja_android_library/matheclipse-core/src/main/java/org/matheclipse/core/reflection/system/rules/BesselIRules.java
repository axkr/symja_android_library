...
public class BesselIRules {
  ...
  final public static IAST RULES = List(
    ...
    ISetDelayed(BesselI(Condition(x_,And(And(Greater(x,C0),Equal(FractionalPart(x),num(0.5))),Not(IntegerQ(x)))),Condition(z_,And(Not(PossibleZeroQ(z)),FreeQ(z,DirectedInfinity)))),
    ...
    ISetDelayed(BesselI(Condition(x_,And(Less(x,C0),Equal(FractionalPart(x),num(-0.5)),Not(IntegerQ(x)))),Condition(z_,And(Not(PossibleZeroQ(z)),FreeQ(z,DirectedInfinity)))),
