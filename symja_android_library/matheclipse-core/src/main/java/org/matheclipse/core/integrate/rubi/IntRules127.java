...
IIntegrate(6358,Int(Times(Power(x_,-1),Erf(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6359,Int(Times(Power(x_,-1),Erfc(Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Plus(Simp(Log(x),x),Negate(Int(Times(Erf(Times(b,x)),Power(x,-1)),x))),FreeQ(b,x))),
IIntegrate(6360,Int(Times(Power(x_,-1),Erfi(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6361,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6362,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6363,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Erfi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6364,Int(Times(Power(x_,m_DEFAULT),Sqr(Erf(Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6365,Int(Times(Power(x_,m_DEFAULT),Sqr(Erfc(Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6366,Int(Times(Power(x_,m_DEFAULT),Sqr(Erfi(Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6367,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Sqr(Erf(Plus(a_,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(6368,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Sqr(Erfc(Plus(a_,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(6369,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Sqr(Erfi(Plus(a_,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(6370,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Power(Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
    Condition(Unintegrable(Times(Power(Plus(c,Times(d,x)),m),Power(Erf(Plus(a,Times(b,x))),n)),x),FreeQ(List(a,b,c,d,m,n),x))),
IIntegrate(6371,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Power(Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
    Condition(Unintegrable(Times(Power(Plus(c,Times(d,x)),m),Power(Erfc(Plus(a,Times(b,x))),n)),x),FreeQ(List(a,b,c,d,m,n),x))),
IIntegrate(6372,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Power(Erfi(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
IIntegrate(6382,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),x_,Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6383,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),x_,Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6384,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),x_,Erfi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6385,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(x_,m_),Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6386,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(x_,m_),Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6387,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(x_,m_),Erfi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6388,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(x_,-1),Erf(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6389,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(x_,-1),Erfc(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6390,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(x_,-1),Erfi(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6391,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(x_,m_),Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6392,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(x_,m_),Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6393,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(x_,m_),Erfi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6394,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(Times(e_DEFAULT,x_),m_DEFAULT),Power(Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
IIntegrate(6395,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(Times(e_DEFAULT,x_),m_DEFAULT),Power(Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
IIntegrate(6396,Int(Times(Exp(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(Times(e_DEFAULT,x_),m_DEFAULT),Power(Erfi(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
IIntegrate(6397,Int(Erf(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(6398,Int(Erfc(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(6399,Int(Erfi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
