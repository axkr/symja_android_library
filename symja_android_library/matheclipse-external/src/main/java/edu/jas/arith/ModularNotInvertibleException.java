...
/**
 * Modular integer NotInvertibleException class. Runtime Exception to be thrown for not invertible
 * modular integers. Container for the non-trivial factors found by the inversion algorithm.
...
public class ModularNotInvertibleException extends NotInvertibleException {
   ...
   */
  public ModularNotInvertibleException(
      String c, Throwable t, GcdRingElem f, GcdRingElem f1, GcdRingElem f2) {
    super(c, t);
    this.f = f;
    this.f1 = f1;
    this.f2 = f2;
