...
IIntegrate(2703,Integrate(Times(Power(x_,m_DEFAULT),Power(Plus(Exp(x_),Power(x_,m_DEFAULT)),n_)),x_Symbol),
    Condition(Plus(Simp(Times(CN1,Power(Plus(Exp(x),Power(x,m)),Plus(n,C1)),Power(Plus(n,C1),CN1)),x),Integrate(Power(Plus(Exp(x),Power(x,m)),Plus(n,C1)),x),Simp(Dist(m,Integrate(Times(Power(x,Plus(m,CN1)),Power(Plus(Exp(x),Power(x,m)),n)),x),x),x)),And(RationalQ(m,n),GtQ(m,C0),LtQ(n,C0),NeQ(n,CN1)))),
...
IIntegrate(2705,Integrate(Power(F_,Times(Plus(a_DEFAULT,Times(Sqr(Log(Times(c_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT)))),b_DEFAULT)),f_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Times(Plus(d,Times(e,x)),Power(Times(e,n,Power(Times(c,Power(Plus(d,Times(e,x)),n)),Power(n,CN1))),CN1)),Subst(Integrate(Exp(Plus(Times(a,f,Log(FSymbol)),Times(x,Power(n,CN1)),Times(b,f,Log(FSymbol),Sqr(x)))),x),x,Log(Times(c,Power(Plus(d,Times(e,x)),n)))),x),x),FreeQ(List(FSymbol,a,b,c,d,e,f,n),x))),
IIntegrate(2706,Integrate(Times(Power(F_,Times(Plus(a_DEFAULT,Times(Sqr(Log(Times(c_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT)))),b_DEFAULT)),f_DEFAULT)),Power(Plus(g_DEFAULT,Times(h_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Plus(g,Times(h,x)),Plus(m,C1)),Power(Times(h,n,Power(Times(c,Power(Plus(d,Times(e,x)),n)),Times(Plus(m,C1),Power(n,CN1)))),CN1)),Subst(Integrate(Exp(Plus(Times(a,f,Log(FSymbol)),Times(Plus(m,C1),x,Power(n,CN1)),Times(b,f,Log(FSymbol),Sqr(x)))),x),x,Log(Times(c,Power(Plus(d,Times(e,x)),n)))),x),x),And(FreeQ(List(FSymbol,a,b,c,d,e,f,g,h,m,n),x),EqQ(Subtract(Times(e,g),Times(d,h)),C0)))),
IIntegrate(2707,Integrate(Times(Power(F_,Times(Plus(a_DEFAULT,Times(Sqr(Log(Times(c_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT)))),b_DEFAULT)),f_DEFAULT)),Power(Plus(g_DEFAULT,Times(h_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Power(Power(e,Plus(m,C1)),CN1),Subst(Integrate(ExpandIntegrand(Power(FSymbol,Times(f,Plus(a,Times(b,Sqr(Log(Times(c,Power(x,n)))))))),Power(Plus(Times(e,g),Times(CN1,d,h),Times(h,x)),m),x),x),x,Plus(d,Times(e,x))),x),x),And(FreeQ(List(FSymbol,a,b,c,d,e,f,g,h,n),x),IGtQ(m,C0)))),
...
IIntegrate(2709,Integrate(Power(F_,Times(Sqr(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT))),b_DEFAULT))),f_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Power(c,Times(C2,a,b,f,Log(FSymbol))),Integrate(Times(Power(Plus(d,Times(e,x)),Times(C2,a,b,f,n,Log(FSymbol))),Power(FSymbol,Plus(Times(Sqr(a),f),Times(Sqr(b),f,Sqr(Log(Times(c,Power(Plus(d,Times(e,x)),n)))))))),x),x),x),And(FreeQ(List(FSymbol,a,b,c,d,e,f,n),x),IntegerQ(Times(C2,a,b,f,Log(FSymbol)))))),
...
IIntegrate(2711,Integrate(Times(Power(F_,Times(Sqr(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT))),b_DEFAULT))),f_DEFAULT)),Power(Plus(g_DEFAULT,Times(h_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Times(Power(h,m),Power(c,Times(C2,a,b,f,Log(FSymbol))),Power(Power(e,m),CN1)),Integrate(Times(Power(Plus(d,Times(e,x)),Plus(m,Times(C2,a,b,f,n,Log(FSymbol)))),Power(FSymbol,Plus(Times(Sqr(a),f),Times(Sqr(b),f,Sqr(Log(Times(c,Power(Plus(d,Times(e,x)),n)))))))),x),x),x),And(FreeQ(List(FSymbol,a,b,c,d,e,f,g,h,m,n),x),EqQ(Subtract(Times(e,g),Times(d,h)),C0),IntegerQ(Times(C2,a,b,f,Log(FSymbol))),Or(IntegerQ(m),EqQ(h,e))))),
...
IIntegrate(2713,Integrate(Times(Power(F_,Times(Sqr(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT))),b_DEFAULT))),f_DEFAULT)),Power(Plus(g_DEFAULT,Times(h_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Power(Power(e,Plus(m,C1)),CN1),Subst(Integrate(ExpandIntegrand(Power(FSymbol,Times(f,Sqr(Plus(a,Times(b,Log(Times(c,Power(x,n)))))))),Power(Plus(Times(e,g),Times(CN1,d,h),Times(h,x)),m),x),x),x,Plus(d,Times(e,x))),x),x),And(FreeQ(List(FSymbol,a,b,c,d,e,f,g,h,n),x),IGtQ(m,C0)))),
...
IIntegrate(2715,Integrate(Log(Plus(a_,Times(b_DEFAULT,Power(Power(F_,Times(e_DEFAULT,Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),n_DEFAULT)))),x_Symbol),
    Condition(Simp(Dist(Power(Times(d,e,n,Log(FSymbol)),CN1),Subst(Integrate(Times(Log(Plus(a,Times(b,x))),Power(x,CN1)),x),x,Power(Power(FSymbol,Times(e,Plus(c,Times(d,x)))),n)),x),x),And(FreeQ(List(FSymbol,a,b,c,d,e,n),x),GtQ(a,C0)))),
IIntegrate(2716,Integrate(Log(Plus(a_,Times(b_DEFAULT,Power(Power(F_,Times(e_DEFAULT,Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),n_DEFAULT)))),x_Symbol),
    Condition(Subtract(Simp(Times(x,Log(Plus(a,Times(b,Power(Power(FSymbol,Times(e,Plus(c,Times(d,x)))),n))))),x),Simp(Dist(Times(b,d,e,n,Log(FSymbol)),Integrate(Times(x,Power(Power(FSymbol,Times(e,Plus(c,Times(d,x)))),n),Power(Plus(a,Times(b,Power(Power(FSymbol,Times(e,Plus(c,Times(d,x)))),n))),CN1)),x),x),x)),And(FreeQ(List(FSymbol,a,b,c,d,e,n),x),Not(GtQ(a,C0))))),
IIntegrate(2717,Integrate(Times(u_DEFAULT,Power(Times(a_DEFAULT,Power(F_,v_)),n_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Times(a,Power(FSymbol,v)),n),Power(Power(FSymbol,Times(n,v)),CN1)),Integrate(Times(u,Power(FSymbol,Times(n,v))),x),x),x),And(FreeQ(list(FSymbol,a,n),x),Not(IntegerQ(n))))),
...
IIntegrate(2720,Integrate(u_,x_Symbol),
    Condition(With(list(Set(v,FunctionOfExponential(u,x))),Simp(Dist(Times(v,Power(D(v,x),CN1)),Subst(Integrate(Times(FunctionOfExponentialFunction(u,x),Power(x,CN1)),x),x,v),x),x)),And(FunctionOfExponentialQ(u,x),Not(MatchQ(u,Condition(Times(w_,Power(Times(a_DEFAULT,Power(v_,n_)),m_)),And(FreeQ(list(a,m,n),x),IntegerQ(Times(m,n)))))),Not(MatchQ(u,Condition(Times(Exp(Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x)))),$(F_,v_)),And(FreeQ(list(a,b,c),x),InverseFunctionQ(F(x)))))))))
  );
}
