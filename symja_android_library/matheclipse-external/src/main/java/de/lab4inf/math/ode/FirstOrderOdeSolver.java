...
public interface FirstOrderOdeSolver extends OdeSolver {
  /**
   * Calculate y1 at point x1, given x0 and y0 with eps precision for the given first order
   ...
   */
  double solve(
      final double x0, final double y0, final double x1, final Function f, final double eps);
}
