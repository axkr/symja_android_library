...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "CenterDot", "CentralFeature", "CentralMoment", "CForm", "CharacteristicPolynomial",
      ...
      "Chop", "Circle", "CircleDot", "CirclePoints", "CircleTimes", "Clear", "ClearAll",
      ...
      "Collect", "CollinearPoints", "Colon", "ColorData", "ColorDataFunction", "Column",
      ...
      "KeySort", "KeyTake", "KeyValuePattern", "KleinInvariantJ", "KnownUnitQ",
