...
ISetDelayed(MonomialExponent(Times(a_DEFAULT,Power(x_,pn_DEFAULT)),x_Symbol),
...
ISetDelayed(GeneralizedBinomialTest(Plus(Times(a_DEFAULT,Power(x_,q_DEFAULT)),Times(b_DEFAULT,Power(x_,pn_DEFAULT))),x_Symbol),
...
ISetDelayed(GeneralizedTrinomialTest(Plus(Times(a_DEFAULT,Power(x_,q_DEFAULT)),Times(c_DEFAULT,Power(x_,r_DEFAULT)),Times(b_DEFAULT,Power(x_,pn_DEFAULT))),x_Symbol),
...
ISetDelayed(RationalFunctionExpand(Times(u_,Power(v_,pn_)),x_Symbol),
