...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
  ...
  interface Strategy extends Serializable {
     ...
     */
    <O> boolean put(O object, Funnel<? super O> funnel, int numHashFunctions, BloomFilterStrategies.BitArray bits);

    /**
     * Queries {@code numHashFunctions} bits of the given bit array, by hashing a user element;
     * returns {@code true} if and only if all selected bits are set.
     */
    <O> boolean mightContain(
            O object, Funnel<? super O> funnel, int numHashFunctions, BloomFilterStrategies.BitArray bits);
   ...
   */
  private BloomFilter(
      BloomFilterStrategies.BitArray bits, int numHashFunctions, Funnel<? super T> funnel, Strategy strategy) {
