...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "IntersectingQ", "Interrupt", "Intersection", "Interval", "IntervalData",
      ...
      "NumberQ", "Numerator", "NumericArray", "NumericArrayQ", "NumericArrayType", "NumericQ",
      ...
      "PDF", "Perimeter", "PermutationCycles", "PermutationCyclesQ", "PermutationList",
      "PermutationListQ", "PermutationReplace", "Permutations", "Permute", "PetersenGraph", "Pick",
      "PieChart", "Piecewise", "PiecewiseExpand", "PlanarGraph", "PlanarGraphQ", "Plot", "Plot3D",
      "Plus", "Pochhammer", "PolarPlot", "Point", "PointLight", "PointSize", "PoissonDistribution",
      ...
      "StringPart", "StringPosition", "StringRepeat", "StringRiffle", "StringSplit", "StringTake",
