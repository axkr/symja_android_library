...
/**
 * Interface a class that serves as a factory to construct new instances of type T.
 *
...
public interface Factory<T> {
  /**
   * Factory method to create a new instance of type T using this as prototype.
   *
