...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"AbsolutePointSize", "AbsoluteThickness",
      ...
      "AspectRatio", "Automatic", "Axis", "Axes", "AxesLabel", "AxesOrigin", "AxesStyle",
      "Background", "BarOrigin", "BarSpacing", "BaseStyle", "BetweennessCentrality", "Black",
      "Blue", "Booleans", "Bottom", "Boxed", "BoxRatios", "Brown", "Byte", "Center", "Character",
      "CharacterEncoding", "ChartLabels", "ChartLegends", "ChartStyle", "ColorFunction",
      "ColorFunctionScaling", "ColorSpace", "ComplexInfinity", "Catalan", "CoefficientDomain",
      "Complexes", "ComplexityFunction", "Constant", "Contours", "ContourShading", "ContourStyle",
      ...
      "FillingStyle", "Frame", "FrameStyle", "FrameTicks", "Flat", "Float", "FourierParameters",
      "Full", "GaussianIntegers", "General", "GenerateConditions", "Glaisher", "GoldenAngle",
      "GoldenRatio", "Gray", "Green", "GridLines", "GridLinesStyle", "Heads",
      ...
      "PlotLegends", "PlotPoints", "PlotRange", "PlotStyle", "PositiveIntegers",
      ...
      "RecordSeparators", "Red", "Reals", "Right", "SameTest", "ScalingFunctions", "Second",
      "SequenceHold", "SetSystemOptions", "Small", "SystemOptions", "SlotAbsent", "SplineClosed",
      "SplineDegree", "SplineKnots", "SplineWeights", "StaticsVisible", "StartOfLine",
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "AddSides", "AddTo", "AddToClassPath", "AdjacencyMatrix", "Adjugate", "AiryAi", "AiryAiPrime",
      "AiryBi", "AiryBiPrime", "AlgebraicNumber", "AllTrue", "Alphabet", "Alternatives",
      "AmbientLight", "And", "AngerJ", "AnglePath", "AngleVector", "Annotation", "Annuity",
      "AnnuityDue", "AntihermitianMatrixQ", "AntisymmetricMatrixQ", "AnyTrue", "Apart", "AppellF1",
      ...
      "ArrayReshape", "ArrayRules", "ArraySymbol", "Arrays", "Arrow", "Arrowheads", "ASATriangle",
      "AssociateTo", "Association", "AssociationMap", "AssociationQ", "AssociationThread",
      "Assuming", "Assumptions", "AtomQ", "Attributes", "Ball", "BarChart", "BarLegend", "BarnesG",
      ...
      "CollinearPoints", "Colon", "ColorData", "Column", "Commonest", "CompatibleUnitQ", "Compile",
      "CompiledFunction", "CompilePrint", "Complement", "CompleteGraph", "Complex", "ComplexExpand",
      ...
      "ConjugateTranspose", "ConnectedGraphQ", "ConstantArray", "ContainsAll", "ContainsAny",
      ...
      "DefaultButton", "Defer", "Definition", "Delete", "DeleteCases", "DeleteDuplicates",
      ...
      "DifferenceQuotient", "Differences", "DigitCount", "DigitQ", "Dimensions", "DiracDelta",
      ...
      "GeoPosition", "Get", "Glow", "GoldbachList", "GompertzMakehamDistribution", "Grad", "Graph",
      ...
      "JavaShow", "Join", "JoinForm", "JordanDecomposition", "JSForm", "JSFormData", "KelvinBei",
      "KelvinBer", "Key", "KeyDrop", "KeyExistsQ", "Keys", "KeySelect", "KeySort", "KeyTake",
      "KeyValuePattern", "KleinInvariantJ", "KnownUnitQ", "KolmogorovSmirnovTest",
      ...
      "Laplacian", "Last", "LCM", "LeafCount", "LeastSquares", "LegendreP", "LegendreQ", "Length",
      "LengthWhile", "LerchPhi", "Less", "LessEqual", "LessEqualThan", "LessThan", "LetterCounts",
      "LetterNumber", "LetterQ", "Level", "LevelQ", "LeviCivitaTensor", "Lighter", "Limit", "Line",
      ...
      "ReplacePart", "ReplaceRepeated", "Rescale", "Residue", "Rest", "Resultant", "Return",
      "Reverse", "ReverseElement", "ReverseEquilibrium", "ReverseSort", "ReverseUpEquilibrium",
      "RevolutionPlot3D", "RGBColor", "RiccatiSolve", "Riffle", "RightArrow", "RightArrowBar",
      ...
      "VertexCount", "VertexEccentricity", "VertexList", "VertexNormals", "VertexQ", "VerticalBar",
