...
ISetDelayed(9536,Int(Times(Sinh(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Tanh(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(9537,Int(Times(Cosh(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Coth(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(9538,Int(Times(Coth(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),Sinh(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Int(Plus(Negate(Power(Times(Exp(Plus(a,Times(b,x))),C2),-1)),Times(C1D2,Exp(Plus(a,Times(b,x)))),Power(Times(Exp(Plus(a,Times(b,x))),Plus(C1,Negate(Exp(Times(C2,Plus(c,Times(d,x))))))),-1),Times(CN1,Exp(Plus(a,Times(b,x))),Power(Plus(C1,Negate(Exp(Times(C2,Plus(c,Times(d,x)))))),-1))),x),And(FreeQ(List(a,b,c,d),x),NeQ(Plus(Sqr(b),Negate(Sqr(d))),C0)))),
ISetDelayed(9539,Int(Times(Cosh(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Tanh(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
    Condition(Int(Plus(Power(Times(Exp(Plus(a,Times(b,x))),C2),-1),Times(C1D2,Exp(Plus(a,Times(b,x)))),Negate(Power(Times(Exp(Plus(a,Times(b,x))),Plus(C1,Exp(Times(C2,Plus(c,Times(d,x)))))),-1)),Times(CN1,Exp(Plus(a,Times(b,x))),Power(Plus(C1,Exp(Times(C2,Plus(c,Times(d,x))))),-1))),x),And(FreeQ(List(a,b,c,d),x),NeQ(Plus(Sqr(b),Negate(Sqr(d))),C0)))),
ISetDelayed(9540,Int(Power(Sinh(Times(a_DEFAULT,Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1))),n_DEFAULT),x_Symbol),
...
ISetDelayed(9541,Int(Power(Cosh(Times(a_DEFAULT,Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1))),n_DEFAULT),x_Symbol),
...
ISetDelayed(9542,Int(Power(Sinh(Times(e_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_)),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1))),n_DEFAULT),x_Symbol),
...
ISetDelayed(9543,Int(Power(Cosh(Times(e_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_)),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1))),n_DEFAULT),x_Symbol),
...
ISetDelayed(9544,Int(Power(Sinh(u_),n_DEFAULT),x_Symbol),
...
ISetDelayed(9545,Int(Power(Cosh(u_),n_DEFAULT),x_Symbol),
...
ISetDelayed(9546,Int(Times(u_DEFAULT,Power(Sinh(v_),p_DEFAULT),Power(Sinh(w_),q_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(Sinh(v),Plus(p,q))),x),EqQ(w,v))),
ISetDelayed(9547,Int(Times(u_DEFAULT,Power(Cosh(v_),p_DEFAULT),Power(Cosh(w_),q_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(Cosh(v),Plus(p,q))),x),EqQ(w,v))),
ISetDelayed(9548,Int(Times(Power(Sinh(v_),p_DEFAULT),Power(Sinh(w_),q_DEFAULT)),x_Symbol),
...
ISetDelayed(9549,Int(Times(Power(Cosh(v_),p_DEFAULT),Power(Cosh(w_),q_DEFAULT)),x_Symbol),
...
ISetDelayed(9550,Int(Times(Power(x_,m_DEFAULT),Power(Sinh(v_),p_DEFAULT),Power(Sinh(w_),q_DEFAULT)),x_Symbol),
...
ISetDelayed(9551,Int(Times(Power(x_,m_DEFAULT),Power(Cosh(v_),p_DEFAULT),Power(Cosh(w_),q_DEFAULT)),x_Symbol),
...
ISetDelayed(9552,Int(Times(u_DEFAULT,Power(Cosh(w_),p_DEFAULT),Power(Sinh(v_),p_DEFAULT)),x_Symbol),
    Condition(Dist(Power(Power(C2,p),-1),Int(Times(u,Power(Sinh(Times(C2,v)),p)),x),x),And(EqQ(w,v),IntegerQ(p)))),
ISetDelayed(9553,Int(Times(Power(Cosh(w_),q_DEFAULT),Power(Sinh(v_),p_DEFAULT)),x_Symbol),
...
ISetDelayed(9554,Int(Times(Power(x_,m_DEFAULT),Power(Cosh(w_),q_DEFAULT),Power(Sinh(v_),p_DEFAULT)),x_Symbol),
...
ISetDelayed(9555,Int(Times(Sinh(v_),Power(Tanh(w_),n_DEFAULT)),x_Symbol),
...
ISetDelayed(9556,Int(Times(Cosh(v_),Power(Coth(w_),n_DEFAULT)),x_Symbol),
...
ISetDelayed(9557,Int(Times(Power(Coth(w_),n_DEFAULT),Sinh(v_)),x_Symbol),
...
ISetDelayed(9558,Int(Times(Cosh(v_),Power(Tanh(w_),n_DEFAULT)),x_Symbol),
...
ISetDelayed(9559,Int(Times(Power(Sech(w_),n_DEFAULT),Sinh(v_)),x_Symbol),
...
ISetDelayed(9560,Int(Times(Cosh(v_),Power(Csch(w_),n_DEFAULT)),x_Symbol),
...
ISetDelayed(9561,Int(Times(Power(Csch(w_),n_DEFAULT),Sinh(v_)),x_Symbol),
...
ISetDelayed(9562,Int(Times(Cosh(v_),Power(Sech(w_),n_DEFAULT)),x_Symbol),
...
ISetDelayed(9563,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Cosh(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),Sinh(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),n_DEFAULT)),x_Symbol),
...
ISetDelayed(9564,Int(Times(Power(x_,m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(Sinh(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))))),n_)),x_Symbol),
...
ISetDelayed(9565,Int(Times(Power(x_,m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(Cosh(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))))),n_)),x_Symbol),
...
ISetDelayed(9566,Int(Times(Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,Sqr(Cosh(Plus(d_DEFAULT,Times(e_DEFAULT,x_))))),Times(c_DEFAULT,Sqr(Sinh(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),-1)),x_Symbol),
...
ISetDelayed(9567,Int(Times(Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),m_DEFAULT),Sqr(Sech(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))),Power(Plus(b_,Times(c_DEFAULT,Sqr(Tanh(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),-1)),x_Symbol),
...
ISetDelayed(9568,Int(Times(Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),m_DEFAULT),Sqr(Sech(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))),Power(Plus(b_DEFAULT,Times(a_DEFAULT,Sqr(Sech(Plus(d_DEFAULT,Times(e_DEFAULT,x_))))),Times(c_DEFAULT,Sqr(Tanh(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),-1)),x_Symbol),
    Condition(Dist(C2,Int(Times(Power(Plus(f,Times(g,x)),m),Power(Plus(Times(C2,a),b,Negate(c),Times(Plus(b,c),Cosh(Plus(Times(C2,d),Times(C2,e,x))))),-1)),x),x),And(FreeQ(List(a,b,c,d,e,f,g),x),IGtQ(m,C0),NeQ(Plus(a,b),C0),NeQ(Plus(a,c),C0)))),
ISetDelayed(9569,Int(Times(Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),m_DEFAULT),Power(Plus(c_,Times(b_DEFAULT,Sqr(Coth(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),-1),Sqr(Csch(Plus(d_DEFAULT,Times(e_DEFAULT,x_))))),x_Symbol),
    Condition(Dist(C2,Int(Times(Power(Plus(f,Times(g,x)),m),Power(Plus(b,Negate(c),Times(Plus(b,c),Cosh(Plus(Times(C2,d),Times(C2,e,x))))),-1)),x),x),And(FreeQ(List(b,c,d,e,f,g),x),IGtQ(m,C0)))),
ISetDelayed(9570,Int(Times(Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),m_DEFAULT),Sqr(Csch(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))),Power(Plus(c_DEFAULT,Times(b_DEFAULT,Sqr(Coth(Plus(d_DEFAULT,Times(e_DEFAULT,x_))))),Times(a_DEFAULT,Sqr(Csch(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),-1)),x_Symbol),
    Condition(Dist(C2,Int(Times(Power(Plus(f,Times(g,x)),m),Power(Plus(Times(C2,a),b,Negate(c),Times(Plus(b,c),Cosh(Plus(Times(C2,d),Times(C2,e,x))))),-1)),x),x),And(FreeQ(List(a,b,c,d,e,f,g),x),IGtQ(m,C0),NeQ(Plus(a,b),C0),NeQ(Plus(a,c),C0)))),
ISetDelayed(9571,Int(Times(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),Plus(A_,Times(B_DEFAULT,Sinh(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),Power(Plus(a_,Times(b_DEFAULT,Sinh(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),-2)),x_Symbol),
...
ISetDelayed(9572,Int(Times(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),Plus(A_,Times(B_DEFAULT,Cosh(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),Power(Plus(a_,Times(b_DEFAULT,Cosh(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),-2)),x_Symbol),
...
ISetDelayed(9573,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Sinh(Plus(a_DEFAULT,Times(b_DEFAULT,Power(Plus(c_,Times(d_DEFAULT,x_)),n_)))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(9574,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Cosh(Plus(a_DEFAULT,Times(b_DEFAULT,Power(Plus(c_,Times(d_DEFAULT,x_)),n_)))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(9575,Int(Times(Power(Sech(v_),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Tanh(v_))),n_DEFAULT)),x_Symbol),
...
ISetDelayed(9576,Int(Times(Power(Plus(a_,Times(b_DEFAULT,Coth(v_))),n_DEFAULT),Power(Csch(v_),m_DEFAULT)),x_Symbol),
...
ISetDelayed(9577,Int(Times(u_DEFAULT,Power(Sinh(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),m_DEFAULT),Power(Sinh(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
ISetDelayed(9578,Int(Times(u_DEFAULT,Power(Cosh(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),m_DEFAULT),Power(Cosh(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
ISetDelayed(9579,Int(Times(Sech(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Sech(Plus(c_,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(9580,Int(Times(Csch(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Csch(Plus(c_,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(9581,Int(Times(Tanh(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Tanh(Plus(c_,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(9582,Int(Times(Coth(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Coth(Plus(c_,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(9583,Int(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,Cosh(v_)),Times(b_DEFAULT,Sinh(v_))),n_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(Times(a,Exp(Times(a,v,Power(b,-1)))),n)),x),And(FreeQ(List(a,b,n),x),EqQ(Plus(Sqr(a),Negate(Sqr(b))),C0)))),
ISetDelayed(9584,Int(Sinh(Times(d_DEFAULT,Sqr(Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(9585,Int(Cosh(Times(d_DEFAULT,Sqr(Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
