...
public abstract class AbstractAST implements IAST {
	 ...
	 * Returns a negative integer, zero, or a positive integer as this expression is
	...
	/** {@inheritDoc} */
	@Override
	public final IAST copyHead(final int intialCapacity) {
	...
	/**
	 * Select all elements by applying the <code>function</code> to each argument in
	 * this <code>AST</code> and append the result elements for which the
	 * <code>function</code> returns non-null elements to the
	 ...
	 *            <code>function#apply()</code> method returned <code>null</code>
	 * @param function
	 *            the function which filters each argument by returning a value
	 *            which unequals <code>F.NIL</code>
	...
	/**
	 * Casts an <code>IExpr</code> which is a list at position <code>index</code> to
	 * an <code>IAST</code>.
	 * 
	 * @param index
	 * @return
	...
	/**
	 * Check if the object at index 0 (i.e. the head of the list) is the same object
	 * as <code>head</code> and if the size of the list equals <code>length</code>.
	 * 
	 * @param head
	 *            object to compare with element at location <code>0</code>
	 * @param length
	...
	/**
	 * Check if the object at index 0 (i.e. the head of the list) is the same object
	 * as <code>head</code> and if the size of the list is between
	...
	/**
	 * Returns an iterator over the elements in this <code>IAST</code> starting with
	 * offset <b>1</b>.
	 * 
	...
	/**
	 * Additional <code>negative</code> method, which works like opposite to fulfill
