...
public class Combinatoric {
  ...
  /**
   * Integer binomial coefficient induction. n and k are integers with 0 less than or equal to k
   * less than or equal to n. A is the binomial coefficient n over k. B is the binomial coefficient
   * n over k+1.
   *
  ...
  /**
   * Integer binomial coefficient. n and k are integers with 0 less than or equal to k less than or
   * equal to n. A is the binomial coefficient n over k.
   *
   * @param n long.
   * @param k long.
   * @return the binomial coefficient n over k+1.
  ...
  /**
   * Integer binomial coefficient partial sum. n and k are integers, 0 le k le n. A is the sum on i,
   * from 0 to k, of the binomial coefficient n over i.
   *
   * @param n long.
   * @param k long.
