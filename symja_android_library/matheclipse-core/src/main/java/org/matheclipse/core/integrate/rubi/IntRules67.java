      ...
      List(
              ...
              Condition(
                  With(
                      ...
                      Dist(k,
                          ...
                          x)),
                  And(FreeQ(List(a, b, c, p), x), EqQ($s("n2"), Times(C2, n)), FractionQ(n)))),
          IIntegrate(1342,
              Integrate(
                  Power(
                      Plus(
                  ...
                  Negate(
                      Subst(
                          Integrate(
                              ...
                              x),
                          x, Power(x, CN1))),
                  And(FreeQ(List(a, b, c, p), x), EqQ($s("n2"), Times(C2, n)), ILtQ(n, C0)))),
          IIntegrate(1343,
              Integrate(
                  Power(
              ...
              Condition(
                  Dist(
                      ...
                      Integrate(Power(Plus(b, Times(C2, c, Power(x, n))), Times(C2, p)), x), x),
              ...
              Condition(
                  Integrate(
                      ExpandIntegrand(
                          ...
                          x),
                      x),
                  And(FreeQ(List(a, b, c, n), x), EqQ($s("n2"), Times(C2, n)), NeQ(Subtract(Sqr(b),
          ...
          IIntegrate(1345,
              ...
              Condition(
                  Plus(
                      Negate(
                          Simp(
                              Times(x, Plus(Sqr(b), Times(CN1, C2, a, c), Times(b, c, Power(x, n))),
                                  Power(
                      ...
                      Dist(Power(Times(a, n, Plus(p, C1), Subtract(Sqr(b), Times(C4, a, c))), CN1),
                          Integrate(
                              Times(
                                  Plus(Sqr(b), Times(CN1, C2, a, c),
                                      Times(n, Plus(p, C1), Subtract(Sqr(b), Times(C4, a, c))),
                                      Times(b, c, Plus(Times(n, Plus(Times(C2, p), C3)), C1),
                                          Power(x, n))),
                      ...
                      With(List(Set(r, Rt(Subtract(Times(C2, q), Times(b, Power(c, CN1))), C2))),
                          Plus(
                              Dist(Power(Times(C2, c, q, r), CN1),
                                  Integrate(
                                      Times(Subtract(r, Power(x, Times(C1D2, n))),
                              ...
                              Dist(Power(Times(C2, c, q, r), CN1),
                                  Integrate(
                                      Times(Plus(r, Power(x, Times(C1D2, n))),
              ...
              Condition(
                  Dist(
                              ...
                              Times(
                                  Power(Plus(C1,
                                      Times(C2, c, Power(x, n),
                                          Power(Plus(b, Rt(Subtract(Sqr(b), Times(C4, a, c)), C2)),
                                              CN1))),
                                      FracPart(p)),
                                  Power(
                                      Plus(C1,
                      ...
                      Integrate(
                          ...
                          x),
                      x),
                  And(FreeQ(List(a, b, c, n, p), x), EqQ($s("n2"), Times(C2,
          ...
          IIntegrate(1349,
              Integrate(
                  Power(
                      Plus(
                          a_, Times(c_DEFAULT, Power(u_, $p("n2", true))), Times(b_DEFAULT,
                              Power(u_, n_))),
                      p_),
                  x_Symbol),
              Condition(
                  Dist(
                      ...
                      Subst(
                          ...
                          x, u),
                      x),
                  And(FreeQ(List(a, b, c, n, p), x), EqQ($s("n2"), Times(C2, n)), LinearQ(u, x),
                      NeQ(u, x)))),
          IIntegrate(1350,
              Integrate(
                  Power(
                  ...
                  x_Symbol),
              Condition(Integrate(
                  Times(Power(Plus(b, Times(a, Power(x, n)), Times(c, Power(x, Times(C2, n)))), p),
                      Power(Power(x, Times(n, p)), CN1)),
                  x),
                  And(FreeQ(List(a, b, c, n), x), EqQ($s("mn"), Negate(n)), IntegerQ(p), PosQ(n)))),
          IIntegrate(1351,
              Integrate(
                  Power(
                      Plus(
              ...
              Condition(
                  Dist(
                      ...
                      x),
                  And(FreeQ(List(a, b, c, n, p), x), EqQ($s("mn"), Negate(n)), Not(IntegerQ(p)),
                      PosQ(n)))),
          IIntegrate(1352,
              Integrate(
              ...
              Condition(
                  Integrate(
                      Times(
                          ...
                          Power(
                              Plus(
                                  c, Times(b, Power(Power(x, n),
                                      CN1)),
                                  Times(a, Power(Power(x, Times(C2, n)), CN1))),
                              p)),
                      x),
                  And(FreeQ(List(a, b, c, m, n), x), EqQ($s("n2"), Times(C2, n)), ILtQ(p, C0),
                      NegQ(n)))),
          IIntegrate(1355,
              Integrate(
                  Times(
              ...
              Condition(
                  Dist(
                      ...
                      Integrate(
                          ...
                          x),
                      x),
                  And(FreeQ(List(a, b, c, d, m, n, p), x), EqQ($s("n2"),
          ...
          IIntegrate(1356,
              Integrate(
                  ...
                  x_Symbol),
              Condition(
                  Dist(Times(Power(a, IntPart(p)),
                      Power(Plus(a, Times(b, Power(x, n)), Times(c, Power(x, Times(C2, n)))),
                          FracPart(p)),
                      Power(Power(Plus(C1, Times(C2, c, Power(x, n), Power(b, CN1))),
                          Times(C2, FracPart(p))), CN1)),
                      Integrate(
                          Times(Power(Times(d, x), m),
                              Power(Plus(C1, Times(C2, c, Power(x, n), Power(b, CN1))),
                                  Times(C2, p))),
                          x),
                      x),
                  And(FreeQ(List(a, b, c, d, m, n, p), x), EqQ($s("n2"), Times(C2,
          ...
          IIntegrate(1358,
              ...
              Condition(
                  Dist(
                      Times(
                          Power(d, IntPart(m)), Power(Times(d,
                              x), FracPart(m)),
          ...
          IIntegrate(1360,
              Integrate(
                  ...
                  x_Symbol),
              Condition(
                  With(List(Set(k, Denominator(m))), Dist(Times(k, Power(d, CN1)), Subst(
                      Integrate(Times(Power(x, Subtract(Times(k, Plus(m, C1)), C1)),
                          Power(Plus(a, Times(b, Power(x, Times(k, n)), Power(Power(d, n), CN1)),
                              Times(c, Power(x, Times(C2, k, n)),
                                  Power(Power(d, Times(C2, n)), CN1))),
                              p)),
                          x),
                      x, Power(Times(d, x), Power(k, CN1))), x)),
                  And(FreeQ(List(a, b, c, d, p), x), EqQ($s("n2"), Times(C2, n)),
                      NeQ(Subtract(Sqr(b), Times(C4, a, c)), C0), IGtQ(n, C0), FractionQ(m),
                      IntegerQ(p)))));
}
