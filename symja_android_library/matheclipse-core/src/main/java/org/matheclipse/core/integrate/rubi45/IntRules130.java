...
ISetDelayed(Int(ExpIntegralE(pn_,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(ExpIntegralE(pn_,Plus(Times(b_DEFAULT,x_),a_)),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Sqr(ExpIntegralEi(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
...
ISetDelayed(Int(Times(Sqr(ExpIntegralEi(Times(b_DEFAULT,x_))),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Sqr(ExpIntegralEi(Plus(Times(b_DEFAULT,x_),a_))),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(ExpIntegralEi(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),Power(E,Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
...
ISetDelayed(Int(Times(ExpIntegralEi(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),Power(E,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(ExpIntegralEi(Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),Power(E,Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_)),x_Symbol),
