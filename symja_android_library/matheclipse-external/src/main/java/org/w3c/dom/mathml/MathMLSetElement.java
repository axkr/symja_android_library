...
/**
 * The set element is the container element that represents a set of elements. The elements of a set
 * can be defined either by explicitly listing the elements, or by using the bvar and condition
 * elements.
 */
public interface MathMLSetElement extends MathMLContentContainer {
  ...
  /**
   * The type attribute of the represented element. Predefined values are normal and multiset. See
   * and .
   *
