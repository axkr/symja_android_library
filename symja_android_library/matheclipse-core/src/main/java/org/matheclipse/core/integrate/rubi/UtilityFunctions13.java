...
class UtilityFunctions13 {
  public static IAST RULES =
      List(
          ...
          ISetDelayed(205, NormalizeTrig($p(
              "func"), Plus(Times(m_DEFAULT, Plus(Times(Pi, n_DEFAULT), r_DEFAULT)), s_DEFAULT), b_,
              x_),
              Condition(
                  If(And(Equal(Times(m, n), C1D4), NegQ(b)), Switch($s("func"), Sin,
                      Cos(Subtract(Subtract(Subtract(CPiQuarter, Times(m, r)), s), Times(b, x))),
                      Cos,
                      Sin(Subtract(Subtract(Subtract(CPiQuarter, Times(m, r)), s), Times(b, x))),
                      Tan,
                      Cot(Subtract(Subtract(Subtract(CPiQuarter, Times(m, r)), s), Times(b, x))),
                      Cot,
                      Tan(Subtract(Subtract(Subtract(CPiQuarter, Times(m, r)), s), Times(b, x))),
                      Sec,
                      Csc(Subtract(Subtract(Subtract(CPiQuarter, Times(m, r)), s), Times(b, x))),
                      Csc,
                      Sec(Subtract(Subtract(Subtract(CPiQuarter, Times(m, r)), s), Times(b, x)))),
                      If(Equal(Times(m, n), CN1D4), If(PosQ(b),
                          Switch($s("func"), Sin, Negate(
                              Cos(Plus(CPiQuarter, Times(m, r), s, Times(b, x)))), Cos,
                              Sin(Plus(CPiQuarter, Times(m, r), s, Times(b, x))), Tan, Negate(
                                  Cot(Plus(CPiQuarter, Times(m, r), s, Times(b, x)))),
                              Cot, Negate(Tan(Plus(CPiQuarter, Times(m, r), s, Times(b, x)))), Sec,
                              Csc(Plus(CPiQuarter, Times(m, r), s, Times(b, x))), Csc,
                              Negate(Sec(Plus(CPiQuarter, Times(m, r), s, Times(b, x))))),
                          Switch($s("func"), Sin,
                              Negate(Sin(Subtract(
                                  Subtract(Subtract(CPiQuarter, Times(m, r)), s), Times(b, x)))),
                              Cos,
                              Cos(Subtract(
                                  Subtract(Subtract(CPiQuarter, Times(m, r)), s), Times(b, x))),
                              Tan,
                              ...
                              Sec(Subtract(
                                  Subtract(Subtract(CPiQuarter, Times(m, r)), s), Times(b, x))),
                              Csc,
                              Negate(Csc(Subtract(Subtract(Subtract(CPiQuarter, Times(m, r)), s),
                                  Times(b, x)))))),
          ...
          ISetDelayed(209,
              FixSimplify(
                  Times(
                      Complex(C0, a_), u_DEFAULT,
                      Power(Plus(Times(Complex(C0, b_), v_DEFAULT), w_), n_DEFAULT))),
              Condition(
                  Times(
                      Power(CN1, Times(C1D2, Plus(n, C1))), a, u, FixSimplify(
                          Power(Subtract(Times(b, v), Times(CI, w)), n))),
                  OddQ(n))),
          ISetDelayed(
              ...
              Condition(
                  With(
                      ...
                      Condition(
                          FixSimplify(Times(w, Power(z, GCD(m, n)))), Or(AbsurdNumberQ(z),
                              SqrtNumberSumQ(z)))),
          ...
          ISetDelayed(213, FixSimplify(Times(Power(u_, m_DEFAULT), Power(v_, n_), w_DEFAULT)),
              Condition(
                  With(
                      list(Set(z,
                          Simplify(Times(Power(Negate(u), Times(m, Power(GCD(m, Negate(n)), CN1))),
                              Power(v, Times(n, Power(GCD(m, Negate(n)), CN1))))))),
                      Condition(
          ...
          ISetDelayed(214,
              FixSimplify(
                  Times(
                      Power(a_, m_), Power(Plus(u_, Times(Power(b_, n_), v_DEFAULT)),
                          p_DEFAULT),
                      w_DEFAULT)),
              Condition(
                  With(
                      list(Set(c, Simplify(Times(Power(a, Times(m, Power(p, CN1))), Power(b, n))))),
                      Condition(FixSimplify(Times(w,
          ...
          ISetDelayed(215,
              FixSimplify(
                  Times(Power(a_, m_DEFAULT),
                      Plus(Times(Power(a_,
                          n_), u_DEFAULT), Times(Power(b_, p_DEFAULT),
                              v_DEFAULT)),
                      w_DEFAULT)),
              Condition(
                  With(list(Set(z,
                      Times(w, Power(a, Plus(m, n)),
                          Plus(u, Times(Power(CN1, p), Power(a, Subtract(p, n)), v))))),
                      Condition(FixSimplify(z),
                          Not(MatchQ(z,
                              Condition(
