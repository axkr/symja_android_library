...
//			Set(Tan(Times(fraction(1L, 10L), Pi)),
//					Times(fraction(1L, 5L), Sqrt(Plus(integer(25L), Times(CN1, Times(integer(10L), Sqrt(C5))))))),
...
//			SetDelayed(
//					Tan(Times(Pi, $p(x, $s("NumberQ")))),
//					Condition(
//							If(Less(x, C1),
//									Times(CN1, Tan(Times(Plus(C1, Times(CN1, x)), Pi))),
//									If(Less(x, C2), Tan(Times(Plus(x, Times(CN1, C1)), Pi)),
//											Tan(Times(Plus(x, Times(CN1, Times(C2, Quotient(IntegerPart(x), C2)))), Pi)))),
//							Greater(x, C1D2))), SetDelayed(Tan(ArcTan($p(x))), x),
