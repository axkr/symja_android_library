...
ISetDelayed(4217,LinearPairQ(u_,v_,x_Symbol),
...
ISetDelayed(4218,MonomialQ(u_,x_Symbol),
...
ISetDelayed(4219,MinimumMonomialExponent(u_,x_Symbol),
...
ISetDelayed(4220,MonomialExponent(Times(a_DEFAULT,Power(x_,n_DEFAULT)),x_Symbol),
    Condition(n,FreeQ(List(a,n),x))),
ISetDelayed(4221,LinearMatchQ(u_,x_Symbol),
...
ISetDelayed(4222,PowerOfLinearMatchQ(u_,x_Symbol),
...
ISetDelayed(4223,QuadraticMatchQ(u_,x_Symbol),
...
ISetDelayed(4224,CubicMatchQ(u_,x_Symbol),
...
ISetDelayed(4225,BinomialMatchQ(u_,x_Symbol),
...
ISetDelayed(4226,GeneralizedBinomialMatchQ(u_,x_Symbol),
...
ISetDelayed(4227,TrinomialMatchQ(u_,x_Symbol),
...
ISetDelayed(4228,GeneralizedTrinomialMatchQ(u_,x_Symbol),
...
ISetDelayed(4229,QuotientOfLinearsMatchQ(u_,x_Symbol),
...
ISetDelayed(4235,NormalizePseudoBinomial(u_,x_Symbol),
...
ISetDelayed(4236,PseudoBinomialParts(u_,x_Symbol),
...
ISetDelayed(4237,PerfectPowerTest(u_,x_Symbol),
...
ISetDelayed(4238,RationalFunctionQ(u_,x_Symbol),
...
ISetDelayed(4242,RationalFunctionExpand(Times(u_,Power(v_,n_)),x_Symbol),
...
ISetDelayed(4243,RationalFunctionExpand(u_,x_Symbol),
...
ISetDelayed(4244,PolyGCD(u_,v_,x_Symbol),
    NonfreeFactors(PolynomialGCD(u,v),x)),
ISetDelayed(4245,AlgebraicFunctionQ(u_,x_Symbol,$p("flag", null,False)),
...
ISetDelayed(4246,QuotientOfLinearsQ(u_,x_Symbol),
...
ISetDelayed(4247,QuotientOfLinearsP(Times(a_,u_),x_),
    Condition(QuotientOfLinearsP(u,x),FreeQ(a,x))),
ISetDelayed(4248,QuotientOfLinearsP(Plus(a_,u_),x_),
    Condition(QuotientOfLinearsP(u,x),FreeQ(a,x))),
ISetDelayed(4249,QuotientOfLinearsP(Power(u_,-1),x_),
    QuotientOfLinearsP(u,x)),
ISetDelayed(4250,QuotientOfLinearsP(u_,x_),
    Condition(True,LinearQ(u,x))),
ISetDelayed(4251,QuotientOfLinearsP(Times(u_,Power(v_,-1)),x_),
    Condition(True,And(LinearQ(u,x),LinearQ(v,x)))),
ISetDelayed(4252,QuotientOfLinearsP(u_,x_),
    Or(SameQ(u,x),FreeQ(u,x))),
ISetDelayed(4253,QuotientOfLinearsParts(Times(a_,u_),x_),
    Condition(Apply(Function(List(Times(a,Slot1),Times(a,Slot2),Slot(C3),Slot(C4))),QuotientOfLinearsParts(u,x)),FreeQ(a,x))),
ISetDelayed(4254,QuotientOfLinearsParts(Plus(a_,u_),x_),
...
ISetDelayed(4259,SubstForFractionalPowerOfQuotientOfLinears(u_,x_Symbol),
...
ISetDelayed(4260,SubstForFractionalPowerQ(u_,v_,x_Symbol),
...
ISetDelayed(4261,SubstForFractionalPowerAuxQ(u_,v_,x_),
...
ISetDelayed(4262,FractionalPowerOfQuotientOfLinears(u_,n_,v_,x_),
...
ISetDelayed(4263,SubstForInverseFunctionOfQuotientOfLinears(u_,x_Symbol),
...
ISetDelayed(4264,InverseFunctionOfQuotientOfLinears(u_,x_Symbol),
...
ISetDelayed(4265,SubstForFractionalPower(u_,v_,n_,w_,x_Symbol),
...
ISetDelayed(4266,SubstForInverseFunction(u_,v_,x_Symbol),
...
ISetDelayed(4267,SubstForInverseFunction(u_,v_,w_,x_Symbol),
...
ISetDelayed(4274,CombineExponents($p("lst")),
...
ISetDelayed(4275,AbsurdNumberGCD($ps("seq")),
...
ISetDelayed(4276,AbsurdNumberGCDList($p("lst1"),$p("lst2")),
...
ISetDelayed(4279,NormalizeIntegrandFactor(u_,x_Symbol),
...
ISetDelayed(4280,NormalizeIntegrandFactorBase(Times(u_,Power(x_,m_DEFAULT)),x_Symbol),
    Condition(NormalizeIntegrandFactorBase(Map(Function(Times(Power(x,m),Slot1)),u),x),And(FreeQ(m,x),SumQ(u)))),
ISetDelayed(4281,NormalizeIntegrandFactorBase(u_,x_Symbol),
...
ISetDelayed(4282,NormalizeTogether(u_),
    NormalizeLeadTermSigns(Together(u))),
ISetDelayed(4283,NormalizeLeadTermSigns(u_),
...
ISetDelayed(4284,AbsorbMinusSign(Times(u_DEFAULT,$p(v,Plus))),
    Times(u,CN1,v)),
ISetDelayed(4285,AbsorbMinusSign(Times(u_DEFAULT,Power($p(v,Plus),m_))),
    Condition(Times(u,Power(Negate(v),m)),OddQ(m))),
ISetDelayed(4286,AbsorbMinusSign(u_),
    Negate(u)),
ISetDelayed(4287,NormalizeSumFactors(u_),
...
ISetDelayed(4288,SignOfFactor(u_),
...
ISetDelayed(4289,NormalizePowerOfLinear(u_,x_Symbol),
...
ISetDelayed(4290,MergeMonomials(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),n_DEFAULT)),x_Symbol),
...
ISetDelayed(4291,MergeMonomials(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Times(c_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),n_DEFAULT)),p_)),x_Symbol),
...
ISetDelayed(4292,MergeMonomials(Times(a_DEFAULT,Power(u_,m_)),x_Symbol),
    Condition(Times(a,Power(u,Simplify(m))),FreeQ(List(a,m),x))),
ISetDelayed(4293,MergeMonomials(u_,x_Symbol),
    If(LinearQ(u,x),Cancel(u),u)),
ISetDelayed(4294,SimplifyIntegrand(u_,x_Symbol),
...
ISetDelayed(4295,SimplifyTerm(u_,x_Symbol),
...
ISetDelayed(4296,TogetherSimplify(u_),
...
ISetDelayed(4297,SmartSimplify(u_),
...
ISetDelayed(4298,SubstForExpn(u_,v_,w_),
    If(SameQ(u,v),w,If(AtomQ(u),u,Map(Function(SubstForExpn(Slot1,v,w)),u)))),
ISetDelayed(4299,Simp(u_,x_),
    TimeConstrained(NormalizeSumFactors(SimpHelp(u,x)),$s("§$timelimit"),u)),
ISetDelayed(4300,SimpHelp(Exp(Times(u_DEFAULT,Plus(w_,Times(v_DEFAULT,Log(a_))))),x_),
    Times(Power(a,Times(u,v)),SimpHelp(Exp(Times(u,w)),x))),
ISetDelayed(4301,SimpHelp(u_,x_),
...
ISetDelayed(4302,NormalizeTrig($p("func"),Plus(Times(m_DEFAULT,Plus(Times(Pi,n_DEFAULT),r_DEFAULT)),s_DEFAULT),b_,x_),
...
ISetDelayed(4303,NormalizeHyperbolic($p("func"),Plus(s_DEFAULT,Times(m_DEFAULT,Plus(r_DEFAULT,Times(Pi,n_DEFAULT,Complex(C0,$p("nz")))))),b_,x_),
...
ISetDelayed(4304,FractionalPowerOfSquareQ(u_),
...
ISetDelayed(4305,FractionalPowerSubexpressionQ(u_,v_,w_),
