...
public final class MathUtils {
	...
	/**
	 * Returns the natural <code>log</code> of the <a href="http://mathworld.wolfram.com/BinomialCoefficient.html">
	 * Binomial Coefficient</a>, "<code>n choose k</code>", the number of <code>k</code>-element subsets that can be
	 * selected from an <code>n</code>-element set.
	 * <p>
	 * <Strong>Preconditions</strong>:
	 * <ul>
	 * <li><code>0 <= k <= n </code> (otherwise <code>IllegalArgumentException</code> is thrown)</li>
