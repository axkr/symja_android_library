...
public interface SeriesCoefficientRules {
  public static Matcher init1() {
    ...
    matcher.caseOf(SeriesCoefficient(Fibonacci(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(Times(CN1,
            Plus(Power(Subtract(Times(CNI, Pi), ArcCsch(C2)), n),
                Power(Subtract(Times(CI, Pi), ArcCsch(C2)), n), Times(CN2, Power(ArcCsch(C2), n))),
            Power(Times(C2, CSqrt5, Factorial(n)), CN1)), GreaterEqual(n, C1))), C0), FreeQ(n, x)));
    ...
    matcher.caseOf(
        ...
        Condition(Piecewise(list(list(HarmonicNumber(a), Equal(n, C0)), list(
            Times(Power(-1, Plus(C1, n)), Zeta(Plus(C1, n), Plus(C1, a))), GreaterEqual(n, C1))),
    ...
    matcher.caseOf(
        ...
        Condition(Piecewise(list(list(
            ...
            And(GreaterEqual(n, C0), GreaterEqual(m, n)))), C0), FreeQ(list(a, m, n), x)));
    // SeriesCoefficient(x_/(-1+a_^x_),{x_Symbol,0,n_?NotListQ}):=Piecewise({{BernoulliB(n)/(n!*Log(a)^(1-n)),n>=0}},0)/;FreeQ(a,x)&&FreeQ(n,x)
    matcher.caseOf(
        SeriesCoefficient(Times(Power(Plus(CN1, Power(a_, x_)), CN1), x_),
    ...
    matcher
        .caseOf(SeriesCoefficient(Cos(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
            Condition(Piecewise(list(list(
                Times(Power(CI, n), Plus(C1, Power(-1, n)), Power(Times(C2, Factorial(n)), CN1)),
    ...
    matcher.caseOf(SeriesCoefficient(Cos(x_), list(x_Symbol, CPiHalf, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(Times(CN1, CI, Power(CI, n), Plus(CN1, Power(-1, n)),
    ...
    matcher.caseOf(SeriesCoefficient(Sin(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(
            Times(CI, Power(CI, n), Plus(CN1, Power(-1, n)), Power(Times(C2, Factorial(n)), CN1)),
            GreaterEqual(n, C0))), C0), FreeQ(n, x)));
    // SeriesCoefficient(Sin(x_),{x_Symbol,Pi/2,n_?NotListQ}):=Piecewise({{(I^n*(1+(-1)^n))/(2*n!),n>=0}},0)/;FreeQ(n,x)
    matcher
        .caseOf(SeriesCoefficient(Sin(x_), list(x_Symbol, CPiHalf, PatternTest(n_, NotListQ))),
            Condition(Piecewise(list(list(
                Times(Power(CI, n), Plus(C1, Power(-1, n)), Power(Times(C2, Factorial(n)), CN1)),
                GreaterEqual(n, C0))), C0), FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(Sinc(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(
            Piecewise(list(list(Times(Power(CI, n), Plus(C1, Power(-1, n)),
                Power(Times(C2, Factorial(Plus(C1, n))), CN1)), GreaterEqual(n, C0))), C0),
            FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(Sinc(x_), list(x_Symbol, CPiHalf, PatternTest(n_, NotListQ))),
        Condition(
            Piecewise(list(list(Times(Power(Times(Pi, Factorial(n)), CN1),
                Plus(
                    Times(Power(CI, n),
                        HypergeometricPFQ(list(C1, Negate(n)), List(),
                            Times(CN1, CI, C2, Power(Pi, CN1)))),
                    Times(CN1, Power(CI, n),
                        HypergeometricPFQ(list(C1, Negate(n)), List(),
                            Times(CI, C2, Power(Pi, CN1)))))),
    ...
    matcher.caseOf(SeriesCoefficient(Tan(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(Times(Power(CI, Plus(C1, n)), Power(C2, n),
            Plus(CN1, Power(-1, n)), Plus(CN1, Power(C2, Plus(C1, n))), BernoulliB(Plus(C1, n)),
            Power(Factorial(Plus(C1, n)), CN1)), GreaterEqual(n, C1))), C0), FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(Tan(x_), list(x_Symbol, CPiHalf, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(CN1, Equal(n, CN1)),
            list(
                Times(Power(CI, Plus(C1, n)), Power(C2, n), Plus(CN1, Power(-1, n)),
    ...
    matcher.caseOf(SeriesCoefficient(Cot(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(C1, Equal(n, CN1)),
            list(
                Times(CN1, CI, Power(Times(C2, CI), n), Plus(CN1, Power(-1, n)),
                    BernoulliB(Plus(C1, n)), Power(Factorial(Plus(C1, n)), CN1)),
                GreaterEqual(n, C0))),
            C0), FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(Cot(x_), list(x_Symbol, CPiHalf, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(Times(CN1, CI, Power(Times(C2, CI), n),
            Plus(CN1, Power(-1, n)), Plus(CN1, Power(C2, Plus(C1, n))), BernoulliB(Plus(C1, n)),
            Power(Factorial(Plus(C1, n)), CN1)), GreaterEqual(n, C1))), C0), FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(Cosh(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(Piecewise(
            list(list(Power(Factorial(n), CN1), And(Equal(Mod(n, C2), C0), GreaterEqual(n, C0)))),
            C0), FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(Sinh(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(Piecewise(
            list(list(Power(Factorial(n), CN1), And(Equal(Mod(n, C2), C1), GreaterEqual(n, C0)))),
            C0), FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(Tanh(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(
            Times(Power(C2, Plus(C1, n)), Plus(CN1, Power(C2, Plus(C1, n))),
                BernoulliB(Plus(C1, n)), Power(Factorial(Plus(C1, n)), CN1)),
            And(Equal(Mod(n, C2), C1), GreaterEqual(n, C1)))), C0), FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(ArcCot(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(
            Piecewise(list(list(Times(Power(CI, Plus(C1, n)), Power(n, CN1)),
                And(Greater(n, C0), Equal(Mod(n, C2), C1))), list(CPiHalf, Equal(n, C0))), C0),
            FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(ArcTan(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(Piecewise(
            list(list(Times(CI, Subtract(Power(CNI, n), Power(CI, n)), Power(Times(C2, n), CN1)),
                Greater(n, C0))),
            C0), FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(ArcCosh(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(Times(CI, C1D2, Pi), Equal(n, C0)),
            list(
    ...
    matcher
        .caseOf(SeriesCoefficient(ArcCoth(x_), list(x_Symbol, C0, PatternTest(a_, NotListQ))),
            Condition(
                Piecewise(
                    list(list(
                        $(DifferenceRoot(Function(list(y, n),
                            list(
                                Equal(Plus(Times(CN1, n, $(y, n)),
                                    Times(Plus(C2, n), $(y, Plus(C2, n)))), C0),
                                Equal($(y, C0), Times(CI, C1D2, Pi)), Equal($(y, C1), C1)))),
                            a),
                        GreaterEqual(a, C0))),
                    C0),
                FreeQ(a, x)));
    ...
    matcher
        .caseOf(SeriesCoefficient(ArcTanh(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
            Condition(
                Piecewise(
                    list(list(Power(n, CN1), And(Equal(Mod(n, C2), C1), GreaterEqual(n, C0)))), C0),
                FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(Csc(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(C1, Equal(n, CN1)),
            list(
                Times(CN1, CI, C2, Power(CI, n), Plus(CN1, Power(C2, n)), BernoulliB(Plus(C1, n)),
                    Power(Factorial(Plus(C1, n)), CN1)),
                And(GreaterEqual(n, C0), Equal(Mod(n, C2), C1)))),
            C0), FreeQ(n, x)));
    ...
    matcher
        .caseOf(SeriesCoefficient(Sech(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
            Condition(Piecewise(
                list(list(Times(EulerE(n), Power(Factorial(n), CN1)), GreaterEqual(n, C0))), C0),
                FreeQ(n, x)));
        ...
        Condition(
            Piecewise(list(
                list(
                    ...
                    Greater(n, C0)),
                list(Times(C1D2, CI,
                    Subtract(Log(Times(Plus(CNI, a), Power(a, CN1))),
                        Log(Times(Plus(CI, a), Power(a, CN1))))),
                    Equal(n, C0))),
                C0),
            And(FreeQ(a, x), FreeQ(n, x))));
    ...
    matcher
        .caseOf(SeriesCoefficient(ArcTan(x_), list(x_Symbol, a_, PatternTest(n_, NotListQ))),
            Condition(
                Piecewise(list(list(
                    Times(CN1, CI,
                        Subtract(Power(Subtract(CNI, a), Negate(n)),
                            Power(Subtract(CI, a), Negate(n))),
                        Power(Times(C2, n), CN1)),
                    Greater(n, C0)), list(ArcTan(a), Equal(n, C0))), C0),
                And(FreeQ(a, x), FreeQ(n, x))));
    ...
    matcher.caseOf(SeriesCoefficient(ArcCoth(x_), list(x_Symbol, a_, PatternTest(n_, NotListQ))),
        Condition(
            Piecewise(list(
                list(
                    Times(Plus(Negate(Power(Subtract(CN1, a), Negate(n))),
                        Power(Subtract(C1, a), Negate(n))), Power(Times(C2, n), CN1)),
                    Greater(n, C0)),
                list(Times(C1D2,
                    Subtract(Log(Plus(C1, Power(a, CN1))),
                        Log(Times(Plus(CN1, a), Power(a, CN1))))),
                    Equal(n, C0))),
                C0),
            And(FreeQ(a, x), FreeQ(n, x))));
    ...
    matcher
        .caseOf(SeriesCoefficient(ArcTanh(x_), list(x_Symbol, a_, PatternTest(n_, NotListQ))),
            Condition(
                Piecewise(
                    list(
                        list(
    ...
    matcher.caseOf(SeriesCoefficient(ArcCsc(x_), list(x_Symbol, a_, C1)), Condition(
        Negate(Power(Times(Sqrt(Subtract(C1, Power(a, CN2))), Sqr(a)), CN1)), FreeQ(a, x)));
                ...
                If(SameQ(c, C1),
                    Piecewise(
                        list(
                            list(
                                Times(
                                    Power(-1, Plus(C1, n)), Power(Times(Power(Plus(a, b), n), n),
                                        CN1)),
                                GreaterEqual(n, C1)),
    ...
    matcher
        .caseOf(SeriesCoefficient(PolyGamma(C0, x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
            Condition(Piecewise(
                list(list(CN1, Equal(n, CN1)), list(Negate(EulerGamma), Equal(n, C0)),
                    list(Times(Power(-1, Plus(C1, n)), Zeta(Plus(C1, n))), GreaterEqual(n, C1))),
                C0), FreeQ(n, x)));
    ...
    matcher.caseOf(
        SeriesCoefficient(ChebyshevT(k_, x_), list(x_Symbol, p_, PatternTest(a_, NotListQ))),
        Condition(Piecewise(list(list(
            $(DifferenceRoot(Function(list(y, n),
                list(
                    Equal(Plus(Times(Plus(Negate(Sqr(k)), Sqr(n)), $(y, n)),
                        Times(Plus(C1, n), Plus(C1, Times(C2, n)), p, $(y, Plus(C1, n))),
                        Times(Plus(C1, n), Plus(C2, n), Plus(CN1, p), Plus(C1, p),
                            $(y, Plus(C2, n)))),
                        C0),
                    Equal($(y, C0), ChebyshevT(k, p)),
                    Equal($(y, C1), Times(k, ChebyshevT(Plus(CN1, k), p)))))),
                a),
            GreaterEqual(a, C0))), C0), And(FreeQ(k, x), FreeQ(a, x))));
    ...
    matcher
        .caseOf(
            SeriesCoefficient(ChebyshevU(k_, x_), list(x_Symbol, p_, PatternTest(a_, NotListQ))),
            Condition(Piecewise(list(list(
                $(DifferenceRoot(Function(list(y, n),
                    list(
                        Equal(Plus(Times(CN1, Plus(Negate(n), k), Plus(C2, n, k), $(y, n)),
                            Times(Plus(C1, n), Plus(C3, Times(C2, n)), p, $(y, Plus(C1, n))),
                            Times(Plus(C1, n), Plus(C2, n), Plus(CN1, p), Plus(C1, p),
                                $(y, Plus(C2, n)))),
                            C0),
                        Equal($(y, C0), ChebyshevU(k, p)),
                        Equal($(y, C1),
                            Times(Power(Plus(CN1, Sqr(p)), CN1),
                                Plus(Times(CN1, Plus(C1, k), ChebyshevU(Plus(CN1, k), p)),
                                    Times(k, p, ChebyshevU(k, p)))))))),
                    a),
                GreaterEqual(a, C0))), C0), And(FreeQ(k, x), FreeQ(a, x))));
    ...
    matcher.caseOf(SeriesCoefficient(EllipticE(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(
            Piecewise(list(list(Times(CN1, Gamma(Plus(CN1D2, n)), Gamma(Plus(C1D2, n)),
                Power(Times(C4, Sqr(Gamma(Plus(C1, n)))), CN1)), GreaterEqual(n, C0))), C0),
            FreeQ(n, x)));
    // SeriesCoefficient(EllipticK(x_),{x_Symbol,0,n_?NotListQ}):=Piecewise({{Gamma(1/2+n)^2/(2*Gamma(1+n)^2),n>=0}},0)/;FreeQ(n,x)
    matcher
        .caseOf(SeriesCoefficient(EllipticK(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
            Condition(
                Piecewise(list(list(Times(Sqr(Gamma(Plus(C1D2, n))),
                    Power(Times(C2, Sqr(Gamma(Plus(C1, n)))), CN1)), GreaterEqual(n, C0))), C0),
                FreeQ(n, x)));
    ...
    matcher
        .caseOf(SeriesCoefficient(LucasL(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
            Condition(
                Piecewise(
                    list(
                        list(
                            Times(
                                Plus(Power(Subtract(Times(CI, Pi), ArcCsch(C2)), n),
                                    Times(C2, Power(ArcCsch(C2), n)),
                                    Times(Power(-1, n),
                                        Power(Plus(Times(CI, Pi), ArcCsch(C2)), n))),
    ...
    matcher
        .caseOf(SeriesCoefficient(LucasL(m_, x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
            Condition(
                Piecewise(
                    list(list(
                        $(DifferenceRoot(Function(list(y, n),
                            list(
                                Equal(
                                    Plus(
                                        Times(CN1, Plus(CN1, Negate(n), m), Plus(C1, n, m),
                                            $(y, n)),
                                        Times(C4, Plus(C1, n), Plus(C2, n), $(y, Plus(C2, n)))),
                                    C0),
                                Equal($(y, C0), Times(C2, Sqr(Cos(Times(C1D2, m, Pi))))),
                                Equal($(y, C1), Times(m, Sqr(Sin(Times(C1D2, m, Pi)))))))),
                            n),
                        GreaterEqual(n, C0))),
                    C0),
                And(FreeQ(m, x), FreeQ(n, x))));
    ...
    matcher.caseOf(SeriesCoefficient(Zeta(x_), list(x_Symbol, C1, PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(C1, Equal(n, CN1)), list(
            Times(Power(-1, n), Power(Factorial(n), CN1), StieltjesGamma(n)), GreaterEqual(n, C0))),
            C0), FreeQ(n, x)));
    ...
    matcher.caseOf(SeriesCoefficient(Gamma(x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(
            Piecewise(list(list(C1, Equal(n, CN1)),
                list(Times(Power(Factorial(Plus(C1, n)), CN1),
                    $($(Derivative(Plus(C1, n)), Gamma), C1)), GreaterEqual(n, C0))),
                C0),
            FreeQ(n, x)));
    ...
    matcher.caseOf(
        SeriesCoefficient(Sec(x_), list(x_Symbol, Times(Pi, a_DEFAULT), PatternTest(n_, NotListQ))),
        Condition(
            Piecewise(list(list(Power(-1, Plus(a, C1D2)), Equal(n, CN1)), list(
                Times(CN1, CI, C2, Power(-1, Plus(a, C1D2)), Power(CI, n), Plus(CN1, Power(C2, n)),
                    BernoulliB(Plus(C1, n)), Power(Factorial(Plus(C1, n)), CN1)),
                And(GreaterEqual(n, C0), Equal(Mod(n, C2), C1)))), C0),
            And(FreeQ(n, x), IntegerQ(Plus(a, C1D2)))));
    ...
    matcher.caseOf(
        SeriesCoefficient(Cot(x_), list(x_Symbol, Times(Pi, a_DEFAULT), PatternTest(n_, NotListQ))),
        Condition(Piecewise(list(list(C1, Equal(n, CN1)),
            list(
                Times(CN1, CI, Power(Times(C2, CI), n), Plus(CN1, Power(-1, n)),
                    BernoulliB(Plus(C1, n)), Power(Factorial(Plus(C1, n)), CN1)),
                GreaterEqual(n, C0))),
            C0), And(FreeQ(n, x), IntegerQ(a))));
    ...
    matcher.caseOf(
        SeriesCoefficient(Csc(x_), list(x_Symbol, Times(Pi, a_DEFAULT), PatternTest(n_, NotListQ))),
        Condition(
            Piecewise(list(list(Power(-1, a), Equal(n, CN1)),
                list(
                    Times(CN1, CI, C2, Power(-1, a), Power(CI, n), Plus(CN1, Power(C2, n)),
                        BernoulliB(Plus(C1, n)), Power(Factorial(Plus(C1, n)), CN1)),
                    And(GreaterEqual(n, C0), Equal(Mod(n, C2), C1)))),
                C0),
            And(FreeQ(n, x), IntegerQ(a))));
    ...
    matcher.caseOf(
        SeriesCoefficient(BesselK(p_, x_), list(x_Symbol, C0, PatternTest(n_, NotListQ))),
        Condition(
            Piecewise(
                list(list(Times(Power(-1, Times(C1D2, Plus(n, Abs(p)))), Power(C2,
                    Subtract(CN1, n)), Factorial(Times(C1D2, Plus(CN2, Negate(n), Abs(p)))),
                    Power(Factorial(Times(C1D2, Plus(n, Abs(p)))), CN1)),
                    And(Equal(
                        Mod(Plus(n, Abs(p)), C2), C0), GreaterEqual(n, Negate(Abs(p))),
                        Less(n, Abs(p)))),
                    list(
                        Times(Power(-1, Abs(p)),
                            Power(Times(Power(C2, Plus(n, C1)),
                                Factorial(Times(C1D2, Subtract(n, Abs(p)))),
                                Factorial(Times(C1D2, Plus(n, Abs(p))))), CN1),
                            Plus(Times(CN2, EulerGamma), Times(C2, Log(C2)), Times(CN2, Log(x)),
                                HarmonicNumber(Times(C1D2, Subtract(n, Abs(p)))),
                                HarmonicNumber(Times(C1D2, Plus(n, Abs(p)))))),
                        And(Equal(Mod(Subtract(n, Abs(p)), C2), C0), GreaterEqual(n, Abs(p))))),
                C0),
            And(FreeQ(p, x), FreeQ(n, x), IntegerQ(p), GreaterEqual(p, C0))));
    ...
    matcher.caseOf(
        SeriesCoefficient(BesselJ(p_, x_), list(x_Symbol, oo, PatternTest(n_, NotListQ))),
        Condition(
            Piecewise(list(list(
                Times(Power(CI, Negate(p)),
                    Power(Times(Power(Times(CI, C1D2), n),
                        Factorial(Times(C1D2, Subtract(Negate(n), p))),
                        Gamma(Times(C1D2, Plus(Negate(n), p, C2)))), CN1)),
                And(Equal(Mod(Subtract(Negate(n), p), C2), C0), LessEqual(n, Negate(p))))), C0),
            And(FreeQ(p, x), FreeQ(n, x), IntegerQ(p), GreaterEqual(p, C0))));
    return matcher;
  }
}
