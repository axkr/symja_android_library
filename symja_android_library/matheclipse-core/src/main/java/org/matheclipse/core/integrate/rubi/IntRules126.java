...
IIntegrate(10217,Int(Times(Power(Times(f_DEFAULT,x_),m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10218,Int(Times(Power(Times(f_DEFAULT,x_),m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10219,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10220,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10221,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10222,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10223,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10224,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10225,Int(Times(u_,Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10226,Int(Times(u_,Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10227,Int(ArcSech(Plus(c_,Times(d_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10228,Int(ArcCsch(Plus(c_,Times(d_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10229,Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT),x_Symbol),
...
IIntegrate(10230,Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT),x_Symbol),
...
IIntegrate(10231,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10232,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10233,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10234,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10235,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10236,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10237,Int(Times(u_DEFAULT,Power(ArcSech(Times(c_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(x_,n_DEFAULT))),-1))),m_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(ArcCosh(Plus(Times(a,Power(c,-1)),Times(b,Power(x,n),Power(c,-1)))),m)),x),FreeQ(List(a,b,c,n,m),x))),
IIntegrate(10238,Int(Times(u_DEFAULT,Power(ArcCsch(Times(c_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(x_,n_DEFAULT))),-1))),m_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(ArcSinh(Plus(Times(a,Power(c,-1)),Times(b,Power(x,n),Power(c,-1)))),m)),x),FreeQ(List(a,b,c,n,m),x))),
IIntegrate(10239,Int(Exp(ArcSech(Times(a_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10240,Int(Exp(ArcSech(Times(a_DEFAULT,Power(x_,p_)))),x_Symbol),
...
IIntegrate(10241,Int(Exp(ArcCsch(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),x_Symbol),
...
IIntegrate(10242,Int(Exp(Times(n_DEFAULT,ArcSech(u_))),x_Symbol),
...
IIntegrate(10243,Int(Exp(Times(n_DEFAULT,ArcCsch(u_))),x_Symbol),
    Condition(Int(Power(Plus(Power(u,-1),Sqrt(Plus(C1,Power(u,-2)))),n),x),IntegerQ(n))),
IIntegrate(10244,Int(Times(Exp(ArcSech(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),Power(x_,-1)),x_Symbol),
...
IIntegrate(10245,Int(Times(Exp(ArcSech(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),Power(x_,m_DEFAULT)),x_Symbol),
...
IIntegrate(10246,Int(Times(Exp(ArcCsch(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),Power(x_,m_DEFAULT)),x_Symbol),
...
IIntegrate(10247,Int(Times(Exp(Times(n_DEFAULT,ArcSech(u_))),Power(x_,m_DEFAULT)),x_Symbol),
...
IIntegrate(10248,Int(Times(Exp(Times(n_DEFAULT,ArcCsch(u_))),Power(x_,m_DEFAULT)),x_Symbol),
    Condition(Int(Times(Power(x,m),Power(Plus(Power(u,-1),Sqrt(Plus(C1,Power(u,-2)))),n)),x),And(FreeQ(m,x),IntegerQ(n)))),
IIntegrate(10249,Int(Times(Exp(ArcSech(Times(c_DEFAULT,x_))),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
IIntegrate(10250,Int(Times(Exp(ArcCsch(Times(c_DEFAULT,x_))),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
IIntegrate(10251,Int(Times(Exp(ArcSech(Times(c_DEFAULT,x_))),Power(Times(d_DEFAULT,x_),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
IIntegrate(10252,Int(Times(Exp(ArcCsch(Times(c_DEFAULT,x_))),Power(Times(d_DEFAULT,x_),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
IIntegrate(10253,Int(ArcSech(u_),x_Symbol),
...
IIntegrate(10254,Int(ArcCsch(u_),x_Symbol),
...
IIntegrate(10255,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(u_)))),x_Symbol),
...
IIntegrate(10256,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(u_)))),x_Symbol),
...
IIntegrate(10257,Int(Times(v_,Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(u_)))),x_Symbol),
...
IIntegrate(10258,Int(Times(v_,Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(u_)))),x_Symbol),
...
IIntegrate(10259,Int(Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10260,Int(Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
