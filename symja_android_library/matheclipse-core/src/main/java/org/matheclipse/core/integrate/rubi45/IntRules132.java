...
ISetDelayed(Int(Times(Power(x_,-1),CoshIntegral(Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Plus(Times(CN1D2,b,x,HypergeometricPFQ(List(C1,C1,C1),List(C2,C2,C2),Times(CN1,b,x))),Times(C1D2,b,x,HypergeometricPFQ(List(C1,C1,C1),List(C2,C2,C2),Times(b,x))),Times(EulerGamma,Log(x)),Times(C1D2,Sqr(Log(Times(b,x))))),FreeQ(b,x))),
...
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),CoshIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),Cosh(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),CoshIntegral(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),Cosh(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),SinhIntegral(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),CoshIntegral(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),Sinh(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_),CoshIntegral(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),Sinh(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
