...
class IntRules241 {
  public static IAST RULES =
      List(
                          ...
                          Simp(
                              Times(
                                  Power(Times(c, Power(b,
                                      CN1)), QQ(3L,
                                          2L)),
                                  CSqrtPi, x, Plus(Cos(Times(a, Power(Times(C2, b), CN1))), Times(c,
                                      Sin(Times(a, Power(Times(C2, b), CN1))))),
                                  FresnelC(
                                      Times(Sqrt(Times(c, Power(Times(Pi, b), CN1))),
                                          Sqrt(Plus(a, Times(b, ArcSin(
                              ...
                              x)),
                      Simp(
                          Times(Power(Times(c, Power(b, CN1)), QQ(3L, 2L)), CSqrtPi, x,
                              Subtract(Cos(Times(a, Power(Times(C2, b), CN1))),
                                  Times(c, Sin(Times(a, Power(Times(C2, b), CN1))))),
                              FresnelS(Times(Sqrt(Times(c, Power(Times(Pi, b), CN1))), Sqrt(
          ...
          IIntegrate(4823,
              Integrate(Power(
                  Plus(a_DEFAULT, Times(ArcCos(Plus(C1, Times(d_DEFAULT, Sqr(x_)))), b_DEFAULT)),
                  QQ(-3L, 2L)), x_Symbol),
              Condition(Plus(
                  Simp(Times(Sqrt(Subtract(Times(CN2, d, Sqr(x)), Times(Sqr(d), Power(x, C4)))),
                      Power(Times(b, d, x,
                          Sqrt(Plus(a, Times(b, ArcCos(Plus(C1, Times(d, Sqr(x)))))))), CN1)),
                      x),
                  Negate(
                      Simp(
                          Times(C2, Power(Power(b, CN1), QQ(3L, 2L)), CSqrtPi,
                              Sin(Times(a, Power(Times(C2, b), CN1))),
                              ...
                              Power(Times(d, x), CN1)),
                          x)),
                  Simp(Times(C2, Power(Power(b, CN1), QQ(3L, 2L)), CSqrtPi,
                      Cos(Times(a, Power(Times(C2, b), CN1))),
                      Sin(Times(C1D2, ArcCos(Plus(C1, Times(d, Sqr(x)))))),
                      FresnelS(Times(Sqrt(Power(Times(Pi, b), CN1)),
                          Sqrt(Plus(a, Times(b, ArcCos(Plus(C1, Times(d, Sqr(x))))))))),
                                  ...
                                  FresnelC(
                                      Times(
                                          Sqrt(Power(Times(Pi, b),
                                              CN1)),
                                          Sqrt(Plus(a,
                                              Times(b, ArcCos(Plus(CN1, Times(d, Sqr(x))))))))),
                                  Power(Times(d, x), CN1)),
                              x)),
                      Negate(
                          Simp(Times(C2, Power(Power(b, CN1), QQ(3L, 2L)), CSqrtPi,
                              ...
                              Power(Times(d, x), CN1)), x))),
                  FreeQ(list(a, b, d), x))),
          IIntegrate(4825, Integrate(Power(
              Plus(a_DEFAULT, Times(ArcSin(Plus(c_, Times(d_DEFAULT, Sqr(x_)))), b_DEFAULT)), CN2),
              x_Symbol),
              Condition(
                  Plus(
                      Negate(
                              ...
                              Times(x,
                                  Plus(
                                      Cos(Times(a, Power(Times(C2, b), CN1))), Times(c,
                                          Sin(Times(a, Power(Times(C2, b), CN1))))),
                                  CosIntegral(Times(c, Power(Times(C2, b), CN1),
                                      Plus(a, Times(b, ArcSin(Plus(c, Times(d, Sqr(x)))))))),
                                  Power(
                                      Times(C4, Sqr(b),
                                          Subtract(
                      ...
                      Simp(
                          Times(x,
                              Subtract(
                                  Cos(Times(a, Power(Times(C2, b), CN1))), Times(c,
                                      Sin(Times(a, Power(Times(C2, b), CN1))))),
                              SinIntegral(Times(c, Power(Times(C2, b), CN1), Plus(a,
                                  Times(b, ArcSin(Plus(c, Times(d, Sqr(x)))))))),
                              Power(
                                  Times(C4, Sqr(b),
                                      Subtract(Cos(Times(C1D2, ArcSin(Plus(c, Times(d, Sqr(x)))))),
                                          Times(c, Sin(
                                              Times(C1D2, ArcSin(Plus(c, Times(d, Sqr(x))))))))),
                                  CN1)),
                          x)),
                  And(FreeQ(List(a, b, c, d), x), EqQ(Sqr(c), C1)))),
          IIntegrate(4826,
