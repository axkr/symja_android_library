...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abs", "AbsArg", "AddTo", "AllTrue", "And", "AngleVector",
			...
			"PrimeOmega", "PrimePowerQ", "PrimeQ", "PrimitiveRoots", "Print", "Product", "ProductLog", "PseudoInverse",
			"Put", "QRDecomposition", "Quiet", "Quit", "Quotient", "RandomInteger", "RandomReal", "RandomSample",
			"Range", "Rational", "Rationalize", "Re", "RealNumberQ", "Reap", "Reduce", "Refine", "Repeated",
