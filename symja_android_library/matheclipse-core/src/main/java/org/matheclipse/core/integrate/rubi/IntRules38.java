...
IIntegrate(765,Integrate(Power(Plus(a_,Times(b_DEFAULT,Power(x_,C4))),CN1D2),x_Symbol),
    Condition(Simp(Dist(Times(Sqrt(Plus(C1,Times(b,Power(x,C4),Power(a,CN1)))),Power(Plus(a,Times(b,Power(x,C4))),CN1D2)),Integrate(Power(Plus(C1,Times(b,Power(x,C4),Power(a,CN1))),CN1D2),x),x),x),And(FreeQ(list(a,b),x),NegQ(Times(b,Power(a,CN1))),Not(GtQ(a,C0))))),
...
IIntegrate(767,Integrate(Power(Plus(a_,Times(b_DEFAULT,Power(x_,C8))),CN1D2),x_Symbol),
    Condition(Plus(Simp(Dist(C1D2,Integrate(Times(Subtract(C1,Times(Rt(Times(b,Power(a,CN1)),C4),Sqr(x))),Power(Plus(a,Times(b,Power(x,C8))),CN1D2)),x),x),x),Simp(Dist(C1D2,Integrate(Times(Plus(C1,Times(Rt(Times(b,Power(a,CN1)),C4),Sqr(x))),Power(Plus(a,Times(b,Power(x,C8))),CN1D2)),x),x),x)),FreeQ(list(a,b),x))),
IIntegrate(768,Integrate(Power(Plus(a_,Times(b_DEFAULT,Power(x_,C4))),QQ(-3L,4L)),x_Symbol),
    Condition(Simp(Dist(Times(Power(x,C3),Power(Plus(C1,Times(a,Power(Times(b,Power(x,C4)),CN1))),QQ(3L,4L)),Power(Plus(a,Times(b,Power(x,C4))),QQ(-3L,4L))),Integrate(Power(Times(Power(x,C3),Power(Plus(C1,Times(a,Power(Times(b,Power(x,C4)),CN1))),QQ(3L,4L))),CN1),x),x),x),FreeQ(list(a,b),x))),
...
IIntegrate(770,Integrate(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
    Condition(Simp(Dist(Power(a,Plus(p,Power(n,CN1))),Subst(Integrate(Power(Power(Subtract(C1,Times(b,Power(x,n))),Plus(p,Power(n,CN1),C1)),CN1),x),x,Times(x,Power(Power(Plus(a,Times(b,Power(x,n))),Power(n,CN1)),CN1))),x),x),And(FreeQ(list(a,b),x),IGtQ(n,C0),LtQ(CN1,p,C0),NeQ(p,CN1D2),IntegerQ(Plus(p,Power(n,CN1)))))),
IIntegrate(771,Integrate(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
    Condition(Simp(Dist(Times(Power(Times(a,Power(Plus(a,Times(b,Power(x,n))),CN1)),Plus(p,Power(n,CN1))),Power(Plus(a,Times(b,Power(x,n))),Plus(p,Power(n,CN1)))),Subst(Integrate(Power(Power(Subtract(C1,Times(b,Power(x,n))),Plus(p,Power(n,CN1),C1)),CN1),x),x,Times(x,Power(Power(Plus(a,Times(b,Power(x,n))),Power(n,CN1)),CN1))),x),x),And(FreeQ(list(a,b),x),IGtQ(n,C0),LtQ(CN1,p,C0),NeQ(p,CN1D2),LtQ(Denominator(Plus(p,Power(n,CN1))),Denominator(p))))),
...
IIntegrate(774,Integrate(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
    Condition(With(list(Set(k,Denominator(n))),Simp(Dist(k,Subst(Integrate(Times(Power(x,Plus(k,CN1)),Power(Plus(a,Times(b,Power(x,Times(k,n)))),p)),x),x,Power(x,Power(k,CN1))),x),x)),And(FreeQ(list(a,b,p),x),FractionQ(n)))),
...
IIntegrate(776,Integrate(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
    Condition(Simp(Dist(Times(x,Power(Plus(a,Times(b,Power(x,n))),p),Power(Times(Power(x,n),Power(Plus(a,Times(b,Power(x,n))),CN1)),p),Power(n,CN1)),Subst(Integrate(Power(Times(Power(x,Plus(p,C1)),Subtract(C1,Times(b,x))),CN1),x),x,Times(Power(x,n),Power(Plus(a,Times(b,Power(x,n))),CN1))),x),x),And(FreeQ(List(a,b,n,p),x),EqQ(Plus(Power(n,CN1),p),C0)))),
IIntegrate(777,Integrate(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
    Condition(Plus(Simp(Times(CN1,x,Power(Plus(a,Times(b,Power(x,n))),Plus(p,C1)),Power(Times(a,n,Plus(p,C1)),CN1)),x),Simp(Dist(Times(Plus(Times(n,Plus(p,C1)),C1),Power(Times(a,n,Plus(p,C1)),CN1)),Integrate(Power(Plus(a,Times(b,Power(x,n))),Plus(p,C1)),x),x),x)),And(FreeQ(List(a,b,n,p),x),ILtQ(Simplify(Plus(Power(n,CN1),p,C1)),C0),NeQ(p,CN1)))),
...
IIntegrate(779,Integrate(Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_))),p_),x_Symbol),
    Condition(Simp(Dist(Times(Power(a,IntPart(p)),Power(Plus(a,Times(b,Power(x,n))),FracPart(p)),Power(Power(Plus(C1,Times(b,Power(x,n),Power(a,CN1))),FracPart(p)),CN1)),Integrate(Power(Plus(C1,Times(b,Power(x,n),Power(a,CN1))),p),x),x),x),And(FreeQ(List(a,b,n,p),x),Not(IGtQ(p,C0)),Not(IntegerQ(Power(n,CN1))),Not(ILtQ(Simplify(Plus(Power(n,CN1),p)),C0)),Not(Or(IntegerQ(p),GtQ(a,C0)))))),
