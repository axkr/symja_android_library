...
IIntegrate(2321,Int(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),q_DEFAULT)),x_Symbol),
    Condition(Plus(Simp(Times(x,Power(Plus(d,Times(e,Sqr(x))),q),Plus(a,Times(b,Log(Times(c,Power(x,n))))),Power(Plus(Times(C2,q),C1),CN1)),x),Negate(Dist(Times(b,n,Power(Plus(Times(C2,q),C1),CN1)),Int(Power(Plus(d,Times(e,Sqr(x))),q),x),x)),Dist(Times(C2,d,q,Power(Plus(Times(C2,q),C1),CN1)),Int(Times(Power(Plus(d,Times(e,Sqr(x))),Subtract(q,C1)),Plus(a,Times(b,Log(Times(c,Power(x,n)))))),x),x)),And(FreeQ(List(a,b,c,d,e,n),x),GtQ(q,C0)))),
IIntegrate(2322,Int(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),QQ(-3L,2L))),x_Symbol),
    Condition(Subtract(Simp(Times(x,Plus(a,Times(b,Log(Times(c,Power(x,n))))),Power(Times(d,Sqrt(Plus(d,Times(e,Sqr(x))))),CN1)),x),Dist(Times(b,n,Power(d,CN1)),Int(Power(Plus(d,Times(e,Sqr(x))),CN1D2),x),x)),FreeQ(List(a,b,c,d,e,n),x))),
IIntegrate(2323,Int(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),q_)),x_Symbol),
    Condition(Plus(Negate(Simp(Times(x,Power(Plus(d,Times(e,Sqr(x))),Plus(q,C1)),Plus(a,Times(b,Log(Times(c,Power(x,n))))),Power(Times(C2,d,Plus(q,C1)),CN1)),x)),Dist(Times(Plus(Times(C2,q),C3),Power(Times(C2,d,Plus(q,C1)),CN1)),Int(Times(Power(Plus(d,Times(e,Sqr(x))),Plus(q,C1)),Plus(a,Times(b,Log(Times(c,Power(x,n)))))),x),x),Dist(Times(b,n,Power(Times(C2,d,Plus(q,C1)),CN1)),Int(Power(Plus(d,Times(e,Sqr(x))),Plus(q,C1)),x),x)),And(FreeQ(List(a,b,c,d,e,n),x),LtQ(q,CN1)))),
IIntegrate(2324,Int(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),CN1)),x_Symbol),
    Condition(With(List(Set(u,IntHide(Power(Plus(d,Times(e,Sqr(x))),CN1),x))),Subtract(Simp(Times(u,Plus(a,Times(b,Log(Times(c,Power(x,n)))))),x),Dist(Times(b,n),Int(Times(u,Power(x,CN1)),x),x))),FreeQ(List(a,b,c,d,e,n),x))),
IIntegrate(2325,Int(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),Power(Plus(d_,Times(e_DEFAULT,Sqr(x_))),CN1D2)),x_Symbol),
    Condition(Subtract(Simp(Times(ArcSinh(Times(Rt(e,C2),x,Power(d,CN1D2))),Plus(a,Times(b,Log(Times(c,Power(x,n))))),Power(Rt(e,C2),CN1)),x),Dist(Times(b,n,Power(Rt(e,C2),CN1)),Int(Times(ArcSinh(Times(Rt(e,C2),x,Power(d,CN1D2))),Power(x,CN1)),x),x)),And(FreeQ(List(a,b,c,d,e,n),x),GtQ(d,C0),PosQ(e)))),
