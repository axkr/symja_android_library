...
/**
 * BigComplex class based on BigRational implementing the RingElem respectively the StarRingElem
 * interface. Objects of this class are immutable. The SAC2 static methods are also provided.
 *
 * @author Heinz Kredel
 */
public final class BigComplex
  ...
  /**
   * The constructor creates a BigComplex object from two BigRational objects real and imaginary
   * part.
   *
   * @param r real part.
  ...
  /**
   * The constructor creates a BigComplex object from a BigRational object as real part, the
  ...
  /**
   * The constructor creates a BigComplex object from a long element as real part, the imaginary
   * part is set to 0.
   *
   * @param r real part.
   */
  ...
  /**
   * Returns the number of bits in the representation of this BigComplex, including a sign bit. It
   * is equivalent to {@code re.bitLength() + im.bitLength()}.)
   *
   * @return number of bits in the representation of this BigComplex, including a sign bit.
   */
