...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "UniformDistribution", "Union", "UnionPlus", "Unique", "UnitaryMatrixQ", "UnitBox",
      ...
      "VertexOutDegree", "VertexList", "VertexNormals", "VertexQ", "VerticalBar",
      ...
      "WordBoundary", "WordCloud", "Write", "WriteString", "Xnor", "Xor", "YuleDissimilarity",
      "ZernikeR", "Zeta", "ZetaZero", "ZTransform"};
