...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "FindShortestTour", "FindSpanningTree",
      "FindVertexCover", "First", "FirstCase", "FirstPosition", "Fit", "FittedModel", "FiveNum",
      "FixedPoint", "FixedPointList", "Floor", "Fold", "FoldList", "For", "ForAll", "Fourier",
      "FourierMatrix", "FRatioDistribution", "FractionalPart", "FrechetDistribution", "FreeQ",
      ...
      "MultiplicativeOrder", "MultiplySides", "NakagamiDistribution", "Names", "Nand", "ND",
      "NDSolve", "Nearest", "NearestTo", "Needs", "Negative", "Nest", "NestList", "NestWhile",
