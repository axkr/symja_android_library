...
/**
 * Solvable polynomial Reduction abstract class. Implements common left, right S-Polynomial, left
 * normalform and left irreducible set.
 *
...
public abstract class SolvableReductionAbstract<C extends RingElem<C>>
  ...
  public ModuleList<C> leftNormalform(ModuleList<C> Pp, ModuleList<C> Ap, boolean top) {
    ...
    List<GenSolvablePolynomial<C>> red =
        leftNormalform(P.castToSolvableList(), A.castToSolvableList());
