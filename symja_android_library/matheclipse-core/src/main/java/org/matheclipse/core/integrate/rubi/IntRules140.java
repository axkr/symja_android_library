...
IIntegrate(2802,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,CN1),Power(Plus(d_,Times(e_DEFAULT,x_)),CN1)),x_Symbol),
    Condition(Subtract(Simp(Dist(Power(d,CN1),Integrate(Times(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),Power(x,CN1)),x),x),x),Simp(Dist(Times(e,Power(d,CN1)),Integrate(Times(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),Power(Plus(d,Times(e,x)),CN1)),x),x),x)),And(FreeQ(List(a,b,c,d,e,n),x),IGtQ(p,C0)))),
...
IIntegrate(2808,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Plus(d_DEFAULT,Times(Log(Times(f_DEFAULT,Power(x_,r_DEFAULT))),e_DEFAULT))),x_Symbol),
    Condition(With(list(Set(u,IntHide(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),x))),Subtract(Simp(Dist(Plus(d,Times(e,Log(Times(f,Power(x,r))))),u,x),x),Simp(Dist(Times(e,r),Integrate(SimplifyIntegrand(Times(u,Power(x,CN1)),x),x),x),x))),FreeQ(List(a,b,c,d,e,f,n,p,r),x))),
IIntegrate(2809,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(Plus(d_DEFAULT,Times(Log(Times(f_DEFAULT,Power(x_,r_DEFAULT))),e_DEFAULT)),q_DEFAULT)),x_Symbol),
    Condition(Plus(Simp(Times(x,Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),Power(Plus(d,Times(e,Log(Times(f,Power(x,r))))),q)),x),Negate(Simp(Dist(Times(b,n,p),Integrate(Times(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,CN1)),Power(Plus(d,Times(e,Log(Times(f,Power(x,r))))),q)),x),x),x)),Negate(Simp(Dist(Times(e,q,r),Integrate(Times(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),Power(Plus(d,Times(e,Log(Times(f,Power(x,r))))),Plus(q,CN1))),x),x),x))),And(FreeQ(List(a,b,c,d,e,f,n,r),x),IGtQ(p,C0),IGtQ(q,C0)))),
...
IIntegrate(2811,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(v_),b_DEFAULT)),p_DEFAULT),Power(Plus(c_DEFAULT,Times(Log(v_),d_DEFAULT)),q_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Power(Coeff(v,x,C1),CN1),Subst(Integrate(Times(Power(Plus(a,Times(b,Log(x))),p),Power(Plus(c,Times(d,Log(x))),q)),x),x,v),x),x),And(FreeQ(List(a,b,c,d,p,q),x),LinearQ(v,x),NeQ(Coeff(v,x,C0),C0)))),
IIntegrate(2812,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(Plus(d_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),e_DEFAULT)),q_DEFAULT),Power(x_,CN1)),x_Symbol),
    Condition(Simp(Dist(Power(n,CN1),Subst(Integrate(Times(Power(Plus(a,Times(b,x)),p),Power(Plus(d,Times(e,x)),q)),x),x,Log(Times(c,Power(x,n)))),x),x),FreeQ(List(a,b,c,d,e,n,p,q),x))),
IIntegrate(2813,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Plus(d_DEFAULT,Times(Log(Times(f_DEFAULT,Power(x_,r_DEFAULT))),e_DEFAULT)),Power(Times(g_DEFAULT,x_),m_DEFAULT)),x_Symbol),
    Condition(With(list(Set(u,IntHide(Times(Power(Times(g,x),m),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p)),x))),Subtract(Simp(Dist(Plus(d,Times(e,Log(Times(f,Power(x,r))))),u,x),x),Simp(Dist(Times(e,r),Integrate(SimplifyIntegrand(Times(u,Power(x,CN1)),x),x),x),x))),And(FreeQ(List(a,b,c,d,e,f,g,m,n,p,r),x),Not(And(EqQ(p,C1),EqQ(a,C0),NeQ(d,C0)))))),
IIntegrate(2814,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(Plus(d_DEFAULT,Times(Log(Times(f_DEFAULT,Power(x_,r_DEFAULT))),e_DEFAULT)),q_DEFAULT),Power(Times(g_DEFAULT,x_),m_DEFAULT)),x_Symbol),
    Condition(Plus(Simp(Times(Power(Times(g,x),Plus(m,C1)),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),Power(Plus(d,Times(e,Log(Times(f,Power(x,r))))),q),Power(Times(g,Plus(m,C1)),CN1)),x),Negate(Simp(Dist(Times(b,n,p,Power(Plus(m,C1),CN1)),Integrate(Times(Power(Times(g,x),m),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,CN1)),Power(Plus(d,Times(e,Log(Times(f,Power(x,r))))),q)),x),x),x)),Negate(Simp(Dist(Times(e,q,r,Power(Plus(m,C1),CN1)),Integrate(Times(Power(Times(g,x),m),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),Power(Plus(d,Times(e,Log(Times(f,Power(x,r))))),Plus(q,CN1))),x),x),x))),And(FreeQ(List(a,b,c,d,e,f,g,m,n,r),x),IGtQ(p,C0),IGtQ(q,C0),NeQ(m,CN1)))),
...
IIntegrate(2816,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(v_),b_DEFAULT)),p_DEFAULT),Power(Plus(c_DEFAULT,Times(Log(v_),d_DEFAULT)),q_DEFAULT),Power(u_,m_DEFAULT)),x_Symbol),
    Condition(With(List(Set(e,Coeff(u,x,C0)),Set(f,Coeff(u,x,C1)),Set(g,Coeff(v,x,C0)),Set(h,Coeff(v,x,C1))),Condition(Simp(Dist(Power(h,CN1),Subst(Integrate(Times(Power(Times(f,x,Power(h,CN1)),m),Power(Plus(a,Times(b,Log(x))),p),Power(Plus(c,Times(d,Log(x))),q)),x),x,v),x),x),And(EqQ(Subtract(Times(f,g),Times(e,h)),C0),NeQ(g,C0)))),And(FreeQ(List(a,b,c,d,m,p,q),x),LinearQ(list(u,v),x)))),
...
IIntegrate(2818,Integrate(Times(Log(Times(d_DEFAULT,Power(Plus(e_,Times(f_DEFAULT,Power(x_,m_DEFAULT))),r_DEFAULT))),Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT)),x_Symbol),
    Condition(With(list(Set(u,IntHide(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),x))),Subtract(Simp(Dist(Log(Times(d,Power(Plus(e,Times(f,Power(x,m))),r))),u,x),x),Simp(Dist(Times(f,m,r),Integrate(Dist(Times(Power(x,Plus(m,CN1)),Power(Plus(e,Times(f,Power(x,m))),CN1)),u,x),x),x),x))),And(FreeQ(List(a,b,c,d,e,f,r,m,n),x),IGtQ(p,C0),IntegerQ(m)))),
