...
public class AST2Expr {
	...
	public final static String[] SYMBOL_STRINGS = { "All", "Algebraics", "Automatic", "Axes", "AxesOrigin", "AxesStyle",
			...
			"Number", "NumberString", "NumericFunction", "OneIdentity", "Orderless", "Pi", "PrecisionGoal", "Primes", "Protected",
			"Rationals", "ReadProtected", "Real", "Reals", "SameTest", "Second", "SequenceHold", "Slot", "SlotSequence",
			"Strict", "String", "Symbol", "TooLarge", "Trig", "True", "Variable", "White", "Whitespace", "Unknown",
			"ViewPoint" };
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AbsoluteCorrelation", "Accumulate",
			...
			"StringDrop", "StringExpression", "StringJoin", "StringLength", "StringPart", "StringRiffle", "StringSplit",
			...
			"Symmetric", "SymmetricMatrixQ", "SyntaxQ", "SystemDialogInput", "Table", "TableForm", "TagSet",
