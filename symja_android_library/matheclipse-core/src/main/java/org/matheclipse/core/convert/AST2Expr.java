...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "AiryBi", "AiryBiPrime", "AlgebraicIntegerQ", "AlgebraicNumber", "AllPoints", "AllTrue",
      ...
      "ArraySymbol", "Arrays", "Arrow", "Arrowheads", "ASATriangle", "AssociateTo", "Association",
      ...
      "AsymptoticRSolveValue", "Atom", "AtomList", "AtomQ", "Attributes", "AxisObject", "Ball",
      "Band", "BarChart", "BarLegend", "BarnesG", "BartlettWindow", "BaseDecode", "BaseEncode",
      "BaseForm", "Beep", "Begin", "BeginPackage", "BeginTestSection", "BellB", "BellY",
      ...
      "BooleanMinterms", "BooleanQ", "BooleanTable", "BooleanVariables", "BoundaryMeshRegion",
      "BoundaryMeshRegionQ", "BoundedRegionQ", "BoundingRegion", "BoxMatrix", "BoxWhiskerChart",
      "BrayCurtisDistance", "Break", "BrownianBridgeProcess", "BSplineCurve", "BSplineFunction",
      "BSplineSurface", "Button", "ByteArray", "ByteArrayQ", "ByteArrayToString", "ByteCount",
      "CanberraDistance", "Cancel", "CancelButton", "CantorMesh", "CapForm", "CapsuleShape",
      "CarlsonRC", "CarlsonRD", "CarlsonRF", "CarlsonRG", "CarlsonRJ", "CarmichaelLambda",
      "CartesianProduct", "Cases", "CatalanNumber", "Catch", "Catenate", "CauchyDistribution",
      "CDF", "Ceiling", "Cell", "CellularAutomaton", "CenterDot", "CentralFeature", "CentralMoment",
      ...
      "ChiSquareDistribution", "CholeskyDecomposition", "Chop", "ChromaticNumber",
      "ChromaticPolynomial", "Circle", "CircleDot", "CirclePoints", "CircleTimes",
      "CircularArcThrough", "Clear", "ClearAll", "ClearAttributes", "ClebschGordan", "Clip",
      ...
      "ColorData", "ColorDataFunction", "Column", "Commonest", "CompatibleUnitQ", "Compile",
      "CompiledFunction", "CompilePrint", "Complement", "CompleteGraph", "CompleteGraphQ",
      "CompleteKaryTree", "Complex", "ComplexExpand", "ComplexPlot", "ComplexPlot3D",
      "ComplexRegionPlot", "ComposeList", "ComposeSeries", "CompositeQ", "Composition",
      ...
      "ConvexHull", "ConvexHullMesh", "ConvexHullRegion", "ConvexRegionQ", "Convolve",
      ...
      "CreateFile", "CreateUUID", "Cross", "CrossMatrix", "Csc", "Csch", "Cube", "CubeRoot",
      ...
      "Decrement", "Decompose", "DedekindNumber", "Default", "DefaultButton", "DefaultValues",
      "Defer", "Definition", "DelaunayMesh", "Delete", "DeleteCases", "DeleteDuplicates",
      ...
      "DiskSegment", "Dispatch", "DisplayForm", "Distribute", "Distributed", "Div", "Divide",
      ...
      "EllipticK", "EllipticLog", "EllipticPi", "EllipticTheta", "EmpiricalDistribution",
      "EmptyRegion", "End", "EndPackage", "EndTestSection", "Entity", "EntityClass", "EntityList",
      ...
      "ExportString", "ExpToTrig", "ExtendedGCD", "Extract", "FaceForm", "FaceGrids",
      "FaceGridsStyle", "Factor", "Factorial", "Factorial2", "FactorList", "FactorialMoment",
      "FactorialPower", "FactorInteger", "FactorSquareFree", "FactorSquareFreeList", "FactorTerms",
      "FactorTermsList", "Fibonacci", "FilledTorus", "FiniteGroupCount", "FiniteAbelianGroupCount",
      "File", "FileFormat", "FileHash", "FileNameDrop", "FileNameJoin", "FileNames", "FileNameTake",
      ...
      "HalfSpace", "HamiltonianGraphQ", "HammingDistance", "HammingWindow", "HankelH1", "HankelH2",
      ...
      "Inequality", "InexactNumberQ", "InfiniteLine", "InfinitePlane", "Infix", "Information",
      "Inner", "Input", "InputField", "InputForm", "InputStream", "InputString", "Insert",
      "InstallJava", "InstanceOf", "IntegerDigits", "IntegerExponent", "IntegerLength",
      ...
      "JavaObjectQ", "JavaShow", "Join", "JoinedCurve", "JoinForm", "JordanDecomposition", "JSForm",
      "JSFormData", "KaryTree", "KelvinBei", "KelvinBer", "Key", "KeyDrop", "KeyDropFrom",
      ...
      "MersennePrimeExponentQ", "MeshCellCount", "MeshCellHighlight", "MeshCellLabel",
      "MeshCellMarker", "MeshCells", "MeshCellShapeFunction", "MeshCellStyle", "MeshCoordinates",
      "MeshPrimitives", "MeshRange", "MeshRegion", "MeshRegionQ", "Message", "MessageName",
      "Messages", "Min", "MinFilter", "MinimalPolynomial", "MinimalBy", "Minimize", "MinMax",
      "Minor", "Minors", "Minus", "Missing", "MissingQ", "Mod", "ModularInverse", "Module",
      "MoebiusMu", "Molecule", "MoleculeQ", "MoleculeValue", "Moment", "MomentOfInertia",
      ...
      "NameQ", "Names", "Nand", "NArgMax", "NArgMin", "ND", "NDSolve", "NDSolveValue", "Nearest",
      "NearestTo", "Needs", "Negative", "NegativeDefiniteMatrixQ", "NegativeSemidefiniteMatrixQ",
      "NeighborhoodGraph", "Nest", "NestList", "NestWhile", "NestWhileList", "NExpectation",
      "NextPrime", "NFourierTransform", "NIntegrate", "NMaximize", "NMaxValue", "NMinimize",
      "NMinValue", "NonCommutativeMultiply", "NoneTrue", "NonNegative", "NonPositive", "Nor",
      "Norm", "Normal", "NormalDistribution", "Normalize", "NormalMatrixQ", "Not", "Notebook",
      "NotElement", "NotListQ", "NProbability", "NProduct", "NRoots", "NSolve", "NSolveValues",
      ...
      "PetersenGraph", "Pick", "Piecewise", "PiecewiseExpand", "PieChart", "PlanarAngle",
      "PlanarGraph", "PlanarGraphQ", "Plot", "Plot3D", "PlotTheme", "Plus", "PlusMinus",
      "Pochhammer", "Point", "PointLight", "PointSize", "PoissonDistribution", "PoissonProcess",
      "PolarPlot", "PolyGamma", "Polygon", "PolygonalNumber", "PolygonAngle", "PolygonCoordinates",
      ...
      "Precision", "PreDecrement", "Prefix", "PreIncrement", "Prepend", "PrependTo", "Prime",
      ...
      "Quartiles", "Query", "Quiet", "Quit", "Quotient", "QuotientRemainder", "RadicalBox", "Ramp",
      ...
      "RangeSpace", "RankDecomposition", "RankedMax", "RankedMin", "Raster3D", "Rational",
      ...
      "Reap", "Rectangle", "Reduce", "Refine", "ReflectionTransform", "Region", "RegionBoundary",
      "RegionBounds", "RegionCentroid", "RegionDimension", "RegionDistance",
      "RegionEmbeddingDimension", "RegionEqual", "RegionMeasure", "RegionMember", "RegionMoment",
      "RegionNearest", "RegionNearestFunction", "RegionQ", "RegionWithin", "RegularExpression",
      ...
      "SemanticImportString", "SeparateBoundaries", "Sequence", "SequenceCount", "SequenceCases",
      "SequencePosition", "SequenceReplace", "SequenceSplit", "Series", "SeriesCoefficient",
      "SeriesData", "Set", "SetAttributes", "SetDelayed", "Share", "ShearingTransform",
      "ShiftRegisterSequence", "Short", "ShortDownArrow", "Shortest", "ShortestCurveDistance",
      "ShortLeftArrow", "ShortRightArrow", "ShortUpArrow", "Show", "Sign", "Signature", "SignCmp",
      ...
      "SmithDecomposition", "SokalSneathDissimilarity", "Solve", "SolveAlways", "SolveValues",
      "Sort", "SortBy", "Sow", "Span", "SparseArray", "SparseArrayQ", "SpearmanRho",
      ...
      "SphericalPlot3D", "SphericalShell", "Splice", "Split", "SplitBy", "SpotLight", "Sqrt",
      ...
      "StatusArea", "StieltjesGamma", "StirlingS1", "StirlingS2", "StreamPlot", "StringCases",
      ...
      "TortoiseShellBracket", "Torus", "ToSphericalCoordinates", "ToString", "Total", "ToUnicode",
      "ToUpperCase", "Tr", "Trace", "TraceForm", "TraditionalForm", "TransformationFunction",
      "TransformedRegion", "TransitiveClosure", "TranslationTransform", "Transliterate",
      "Transpose", "TreeForm", "TreeGraph", "TreeGraphQ", "TreePlot", "Triangle", "TriangleCenter",
      "TriangleConstruct", "TriangleMeasurement", "TriangleWave", "TrigExpand", "TrigFactor",
