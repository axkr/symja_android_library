...
public interface SeriesCoefficientRules {
  ...
  public static final IAST RULES =
      List(
          ...
          ISetDelayed(
              SeriesCoefficient(HarmonicNumber(x_), List(x_Symbol, a_, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(HarmonicNumber(a), Equal(n, C0)),
                          List(
                              Times(Power(CN1, Plus(C1, n)), Zeta(Plus(C1, n), Plus(C1, a))),
                              GreaterEqual(n, C1))),
                      C0),
          ...
          ISetDelayed(
              SeriesCoefficient(BernoulliB(m_, x_), List(x_Symbol, a_, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(
                                  BernoulliB(Subtract(m, n), a),
                                  Power(Factorial(n), CN1),
          ...
          ISetDelayed(
              SeriesCoefficient(
                  Times(Power(Plus(CN1, Power(a_, x_)), CN1), x_),
                  List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(
                                  BernoulliB(n),
                                  Power(Factorial(n), CN1),
                                  Power(Log(a), Plus(CN1, n))),
                              GreaterEqual(n, C0))),
                      C0),
                  And(FreeQ(a, x), FreeQ(n, x)))),
          // SeriesCoefficient(Cos(x_),{x_Symbol,0,n_?NotListQ}):=Piecewise({{((1+(-1)^n)*I^n)/(2*n!),n>=0}},0)/;FreeQ(n,x)
          ISetDelayed(
              SeriesCoefficient(Cos(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(Cos(x_), List(x_Symbol, CPiHalf, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(Sin(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(Sin(x_), List(x_Symbol, CPiHalf, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(Tan(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(
                                  ...
                                  Power(CI, Plus(C1, n)),
                                  Power(C2, n),
                                  Plus(CN1, Power(C2, Plus(C1, n))),
                                  BernoulliB(Plus(C1, n)),
          ...
          ISetDelayed(
              SeriesCoefficient(Tan(x_), List(x_Symbol, CPiHalf, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
          ...
          ISetDelayed(
              SeriesCoefficient(Cot(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(C1, Equal(n, CN1)),
          ...
          ISetDelayed(
              SeriesCoefficient(Cot(x_), List(x_Symbol, CPiHalf, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(Cosh(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(Coth(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(C1, Equal(n, CN1)),
          ...
          ISetDelayed(
              SeriesCoefficient(Sinh(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(Tanh(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(ArcCos(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(CPiHalf, Equal(n, C0)),
                          List(
                              Times(
                                  CN1,
                                  Power(Times(n, Factorial(Times(C1D2, Plus(CN1, n)))), CN1),
          ...
          ISetDelayed(
              SeriesCoefficient(ArcCot(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(Power(CI, Plus(C1, n)), Power(n, CN1)),
                              And(Greater(n, C0), Equal(Mod(n, C2), C1))),
                          List(CPiHalf, Equal(n, C0))),
                      C0),
                  FreeQ(n, x))),
          ...
          ISetDelayed(
              SeriesCoefficient(ArcSin(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(ArcTan(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(Power(CI, Plus(CN1, n)), Power(n, CN1)),
                              And(Equal(Mod(n, C2), C1), GreaterEqual(n, C0)))),
                      C0),
                  FreeQ(n, x))),
          ...
          ISetDelayed(
              SeriesCoefficient(ArcCosh(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(Times(C1D2, CI, Pi), Equal(n, C0)),
                          List(
                              Times(
                                  CN1,
                                  CI,
          ...
          ISetDelayed(
              SeriesCoefficient(ArcSinh(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(ArcTanh(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(List(Power(n, CN1), And(Equal(Mod(n, C2), C1), GreaterEqual(n, C0)))),
                      C0),
                  FreeQ(n, x))),
          ...
          ISetDelayed(
              SeriesCoefficient(Csc(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(C1, Equal(n, CN1)),
          ...
          ISetDelayed(
              SeriesCoefficient(Sec(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(Power(CI, n), EulerE(n), Power(Factorial(n), CN1)),
                              And(Equal(Mod(n, C2), C0), GreaterEqual(n, C0)))),
                      C0),
                  FreeQ(n, x))),
          // SeriesCoefficient(Csch(x_),{x_Symbol,0,n_?NotListQ}):=Piecewise({{1,n==-1},{((-1)*2*(-1+2^n)*BernoulliB(1+n))/(1+n)!,n>=0&&Mod(n,2)==1}},0)/;FreeQ(n,x)
          ISetDelayed(
              SeriesCoefficient(Csch(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(C1, Equal(n, CN1)),
          ...
          ISetDelayed(
              SeriesCoefficient(Sech(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(List(Times(EulerE(n), Power(Factorial(n), CN1)), GreaterEqual(n, C0))),
                      C0),
                  FreeQ(n, x))),
          // SeriesCoefficient(Cos(x_),{x_Symbol,a_,n_?NotListQ}):=Piecewise({{Cos(a+1/2*n*Pi)/n!,n>=0}},0)/;FreeQ(a,x)&&FreeQ(n,x)
          ISetDelayed(
              SeriesCoefficient(Cos(x_), List(x_Symbol, a_, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(Cos(Plus(a, Times(C1D2, n, Pi))), Power(Factorial(n), CN1)),
                              GreaterEqual(n, C0))),
                      C0),
                  And(FreeQ(a, x), FreeQ(n, x)))),
          // SeriesCoefficient(Sin(x_),{x_Symbol,a_,n_?NotListQ}):=Piecewise({{Sin(a+1/2*n*Pi)/n!,n>=0}},0)/;FreeQ(a,x)&&FreeQ(n,x)
          ISetDelayed(
              SeriesCoefficient(Sin(x_), List(x_Symbol, a_, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(Power(Factorial(n), CN1), Sin(Plus(a, Times(C1D2, n, Pi)))),
                              GreaterEqual(n, C0))),
                      C0),
                  And(FreeQ(a, x), FreeQ(n, x)))),
          ...
          ISetDelayed(
              ...
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(Cosh(a), Power(Factorial(n), CN1)),
                              And(Equal(Mod(n, C2), C0), GreaterEqual(n, C0))),
                          List(
                              Times(Power(Factorial(n), CN1), Sinh(a)),
                              And(Equal(Mod(n, C2), C1), GreaterEqual(n, C0)))),
                      C0),
                  And(FreeQ(a, x), FreeQ(n, x)))),
          ...
          ISetDelayed(
              SeriesCoefficient(Sinh(x_), List(x_Symbol, a_, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                      ...
                      List(
                          ...
                          List(
                              Times(
                                  ...
                                  CI,
                                  Subtract(
                                      Log(Times(Power(a, CN1), Plus(CNI, a))),
          ...
          ISetDelayed(
              SeriesCoefficient(ArcTan(x_), List(x_Symbol, a_, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                          ...
                          List(
                              Times(
                                  ...
                                  CI,
                                  Subtract(
                                      Log(Plus(C1, Times(CNI, a))), Log(Plus(C1, Times(CI, a))))),
                              Equal(n, C0))),
                      C0),
                  And(FreeQ(a, x), FreeQ(n, x)))),
          ...
          ISetDelayed(
              SeriesCoefficient(ArcCoth(x_), List(x_Symbol, a_, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(
                                  Plus(
                                      Negate(Power(Subtract(CN1, a), Negate(n))),
                          ...
                          List(
                              Times(
                                  C1D2,
                                  Subtract(
                                      Log(Plus(C1, Power(a, CN1))),
                                      Log(Times(Power(a, CN1), Plus(CN1, a))))),
                              Equal(n, C0))),
                      C0),
                  And(FreeQ(a, x), FreeQ(n, x)))),
          ...
          ISetDelayed(
              SeriesCoefficient(ArcTanh(x_), List(x_Symbol, a_, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(
                  Log(Plus(b_DEFAULT, Times(c_DEFAULT, x_))),
                      ...
                      Piecewise(
                          List(
                              List(
                                  Times(
                                      CN1,
                                      Power(Times(CN1, c, Power(Plus(b, Times(a, c)), CN1)), n),
                                      Power(n, CN1)),
                                  Greater(n, C0)),
                              List(Log(Plus(b, Times(a, c))), Equal(n, C0))),
                          C0)),
                  FreeQ(List(a, b, c, n), x))),
          // SeriesCoefficient(ProductLog(x_),{x_Symbol,0,n_?NotListQ}):=Piecewise({{1/((-n)^(1-n)*n!),n>=1}},0)/;FreeQ(n,x)
          ISetDelayed(
              SeriesCoefficient(ProductLog(x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
          ...
          ISetDelayed(
              SeriesCoefficient(PolyLog(k_, x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(List(List(Power(n, Negate(k)), GreaterEqual(n, C1))), C0),
          ...
          ISetDelayed(
              SeriesCoefficient(ChebyshevT(k_, x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(
                                  ...
                                  Power(
                                      Times(
                                          Factorial(n),
                                          Gamma(Times(C1D2, Plus(C1, Negate(k), n))),
                                          Gamma(Times(C1D2, Plus(C1, k, n))),
                                          Pochhammer(C1D2, n)),
                                      CN1),
                                  Pochhammer(Negate(k), n),
                                  Pochhammer(k, n)),
                              GreaterEqual(n, C0))),
                      C0),
                  And(FreeQ(k, x), FreeQ(n, x)))),
          ...
          ISetDelayed(
              SeriesCoefficient(ChebyshevU(k_, x_), List(x_Symbol, C0, PatternTest(n_, NotListQ))),
              Condition(
                  Piecewise(
                      List(
                          List(
                              Times(
                                  Power(CN1D2, n),
                                  Sqrt(Pi),
                                  Gamma(Plus(QQ(3L, 2L), n)),
                                  Power(
                                      Times(
                                          Factorial(n),
                                          Gamma(Times(C1D2, Plus(C1, Negate(k), n))),
                                          Gamma(Times(C1D2, Plus(C3, k, n))),
                                          Pochhammer(QQ(3L, 2L), n)),
                                      CN1),
                                  Pochhammer(Negate(k), n),
                                  Pochhammer(Plus(C2, k), n)),
                              GreaterEqual(n, C0))),
                      C0),
                  And(FreeQ(k, x), FreeQ(n, x)))));
}
