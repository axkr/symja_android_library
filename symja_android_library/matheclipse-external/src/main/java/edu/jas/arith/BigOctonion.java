...
/**
 * BigOctonion class based on BigRational implementing the RingElem interface and with the familiar
 * MAS static method names. Objects of this class are immutable.
 *
 * @author Heinz Kredel
 */
public final class BigOctonion
  ...
  /**
   * The BigOctonion string constructor accepts the following formats: empty string, "quaternion",
   * or "quat o quat" with no blanks around o if used as polynoial coefficient.
   *
   * @param fac BigQuaternionRing.
   * @param s String.
   ...
   * Since quaternion numbers are unordered, we use lexicographical order of re, im, jm and km.
   *
   * @return 0 if this is equal to 0; 1 if or > 0, or or == 0 and oi > 0; -1 if or < 0, or or == 0
   *     and oi < 0.
  ...
  /**
   * BigOctonion random. Random rational numbers A, B, C and D are generated using random(n). Then R
   * is the quaternion number with real part A and imaginary parts B, C and D.
   *
  ...
  /**
   * BigOctonion random. Random rational numbers A, B, C and D are generated using RNRAND(n). Then R
   * is the quaternion number with real part A and imaginary parts B, C and D.
   *
   * @param n such that 0 &le; A, B, C, D &le; (2<sup>n</sup>-1).
  ...
  */
  ...
  /**
   * Returns the number of bits in the representation of this BigOctonion, including a sign bit. It
   * is equivalent to {@code or.bitLength() + oi.bitLength()}.)
   *
   * @return number of bits in the representation of this BigOctonion, including a sign bit.
   */
