...
ISetDelayed(FixInertTrigFunction(Times(Power(Plus(Times($($s("§sin"),v_),a_DEFAULT),Times($($s("§cos"),v_),b_DEFAULT)),pn_DEFAULT),Power($($s("§csc"),v_),m_DEFAULT),u_DEFAULT),x_),
...
ISetDelayed(FixInertTrigFunction(Times(Plus(Times($(g_,v_),pb_DEFAULT),Times(Sqr($(g_,v_)),pc_DEFAULT),pa_DEFAULT),Power($(f_,v_),m_DEFAULT)),x_),
...
ISetDelayed(FixInertTrigFunction(Times(Plus(Times(Sqr($(g_,v_)),pc_DEFAULT),pa_DEFAULT),Power($(f_,v_),m_DEFAULT)),x_),
...
ISetDelayed(FixInertTrigFunction(Times(Plus(Times($(g_,v_),pb_DEFAULT),Times(Sqr($(g_,v_)),pc_DEFAULT),pa_DEFAULT),Power(Plus(Times($(g_,v_),b_DEFAULT),a_DEFAULT),pn_DEFAULT),Power($(f_,v_),m_DEFAULT)),x_),
...
ISetDelayed(FixInertTrigFunction(Times(Plus(Times(Sqr($(g_,v_)),pc_DEFAULT),pa_DEFAULT),Power(Plus(Times($(g_,v_),b_DEFAULT),a_DEFAULT),pn_DEFAULT),Power($(f_,v_),m_DEFAULT)),x_),
...
ISetDelayed(EasyDQ(Times(Power(x_,m_DEFAULT),u_DEFAULT),x_Symbol),
...
ISetDelayed(RtAux(Times(Power(v_,m_DEFAULT),Power(w_,p_DEFAULT),u_DEFAULT),pn_),
...
ISetDelayed(RtAux(Times(CN1,Power(v_,m_DEFAULT),u_),pn_),
...
ISetDelayed(RtAux(Times(Power(u_,w_),v_DEFAULT),pn_),
...
ISetDelayed(IntTerm(Times(Power(v_,CN1),c_DEFAULT),x_Symbol),
    Condition(Simp(Times(c,Log(RemoveContent(v,x)),Power(Coefficient(v,x,C1),CN1)),x),And(FreeQ(c,x),LinearQ(v,x)))),
ISetDelayed(IntTerm(Times(Power(v_,m_DEFAULT),c_DEFAULT),x_Symbol),
...
ISetDelayed(FixRhsIntRule(Plus(Times(CN1,v_),u_),x_),
