...
class ParserTestCase {
  static Parser PARSE_UNRELAXED = new Parser();
  ...
  @Test
  void testParser0() {
    ASTNode obj = PARSE_UNRELAXED.parse("(#^3)&[x][y,z].{a,b,c}");
    assertEquals("Dot(Function(Power(Slot(1), 3))[x][y, z], List(a, b, c))", obj.toString());
  }

  @Test
  void testParser1() {
    ASTNode obj = PARSE_UNRELAXED.parse("Integrate[Sin[x]^2+3*x^4, x]");
    assertEquals("Integrate(Plus(Power(Sin(x), 2), Times(3, Power(x, 4))), x)", obj.toString());
  }

  @Test
  void testParser2() {
    ASTNode obj = PARSE_UNRELAXED.parse("a[][0][1]f[[x]]");
  ...
  @Test
  void testParser4() {
    ASTNode obj = PARSE_UNRELAXED.parse("$a=2");
  ...
  void testParser5() {
    if (!ParserConfig.EXPLICIT_TIMES_OPERATOR) {
      ASTNode obj = PARSE_UNRELAXED.parse("4.7942553860420304E-1");
      assertEquals("Plus(Times(4.7942553860420304, E), Times(-1, 1))", obj.toString());

      obj = PARSE_UNRELAXED.parse("4.7942553860420304 * E - 1");
      assertEquals("Plus(Times(4.7942553860420304, E), Times(-1, 1))", obj.toString());
    } else {
      ASTNode obj = PARSE_UNRELAXED.parse("4.7942553860420304E-1");
  ...
  @Test
  void testParser6() {
    ASTNode obj = PARSE_UNRELAXED.parse("a+%%%+%3*4!");
  ...
  @Test
  void testParser8() {
    ASTNode obj = PARSE_UNRELAXED.parse("-42424242424242424242");
    assertEquals("-42424242424242424242", obj.toString());
  }

  @Test
  void testParser9() {
    ASTNode obj = PARSE_UNRELAXED.parse("-42424242424242424242.125");
    assertEquals("-42424242424242424242.125", obj.toString());
  }

  @Test
  void testParser10() {
    ASTNode obj = PARSE_UNRELAXED.parse("-3/4");
  ...
  @Test
  void testParser12() {
    ASTNode obj = PARSE_UNRELAXED.parse("-(Pi/4)");
  ...
  @Test
  void testParser16() {
    ASTNode obj = PARSE_UNRELAXED.parse("f[[1,2]]");
    assertEquals("Part(f, 1, 2)", obj.toString());
    obj = PARSE_UNRELAXED.parse("f[[1]][[2]]");
    assertEquals("Part(Part(f, 1), 2)", obj.toString());
    obj = PARSE_UNRELAXED.parse("f[[1,2,f[x]]]");
  ...
  @Test
  void testParser17() {
    ASTNode obj = PARSE_UNRELAXED.parse("\\[Alpha]+\\[Alpha]*f[\\[CapitalSHacek]]");
    assertEquals("Plus(α, Times(α, f(Š)))", obj.toString());
  }

  @Test
  void testParser18() {
    ASTNode obj = PARSE_UNRELAXED.parse("(a+b)[x]");
    assertEquals("Plus(a, b)[x]", obj.toString());
  }

  @Test
  void testParser19() {
    ASTNode obj = PARSE_UNRELAXED.parse("B[[;; 2]]");
  ...
  @Test
  void testParser21a() {
    ASTNode obj = PARSE_UNRELAXED.parse("B[[ ;;1;;-1]]");
    assertEquals("Part(B, Span(1, 1, -1))", obj.toString());
  }

  @Test
  void testParser21b() {
    ASTNode obj = PARSE_UNRELAXED.parse("B[[3;;1;;-1]]");
    assertEquals("Part(B, Span(3, 1, -1))", obj.toString());
  }

  @Test
  void testParser21c() {
    ASTNode obj = PARSE_UNRELAXED.parse("B[[;;;;-1]]");
  ...
  @Test
  void testParser22() {
    ASTNode obj = PARSE_UNRELAXED.parse("a+b;");
    assertEquals("CompoundExpression(Plus(a, b), Null)", obj.toString());
  }

  @Test
  void testParser23() {
    ASTNode obj = PARSE_UNRELAXED.parse("f[x]*f''[x]");
    assertEquals("Times(f(x), Derivative(2)[f][x])", obj.toString());
  }

  @Test
  void testParser24() {
    ASTNode obj = PARSE_UNRELAXED.parse("x'[t] == 10*(y[t] - x[t])");
  ...
  @Test
  void testParser25() {
    ASTNode obj = PARSE_UNRELAXED.parse("Int[f_'[x_]*g_[x_] + f_[x_]*g_'[x_],x_Symbol]");
    assertEquals(
  ...
  @Test
  void testParser29() {
    ASTNode obj = PARSE_UNRELAXED.parse("FracPart[m_*u_,n_:1]");
    assertEquals("FracPart(Times(m_, u_), Optional(n_, 1))", obj.toString());
  }

  @Test
  void testParse30() {
    ASTNode obj = PARSE_UNRELAXED.parse("f[x,y,]");
    assertEquals("f(x, y, Null)", obj.toString());
  }

  @Test
  void testParser31() {
    ASTNode obj = PARSE_UNRELAXED.parse("#1.#123");
    assertEquals("Dot(Slot(1), Slot(123))", obj.toString());
  }

  @Test
  void testParser32() {
    ASTNode obj = PARSE_UNRELAXED.parse("(-1)^(a) (b)");
  ...
  @Test
  void testParse33() {
    ASTNode obj = PARSE_UNRELAXED.parse("f@ g@ h");
  ...
  void testParse39() {
    ASTNode obj =
        PARSE_UNRELAXED.parse("While[i\\[LessEqual]Length[asympt] && asympt[[i,2]]\\[Equal]0,i++]");
    assertEquals(
  ...
  @Test
  void testParse40() {
    ASTNode obj = PARSE_UNRELAXED.parse("ff/: Power[ff, i_Integer] = {i}");
  ...
  @Test
  void testParse42() {
    ASTNode obj = PARSE_UNRELAXED.parse("m_.k_+b_.");
    assertEquals("Plus(Times(m_., k_), b_.)", obj.toString());
  }

  @Test
  void testParse43() {
    ASTNode obj = PARSE_UNRELAXED.parse("MakeAssocList[u_,x_Symbol,alst_List:{}] ");
    assertEquals("MakeAssocList(u_, x_Symbol, Optional(alst_List, List()))", obj.toString());
  }

  @Test
  void testParser44() {
    ASTNode obj = PARSE_UNRELAXED.parse("-1<0<=a<4<5<b<10<11");
    assertEquals(
  ...
  @Test
  void testParser45() {
    ASTNode obj = PARSE_UNRELAXED.parse("\"array\"[x] ");
    assertEquals("array(x)", obj.toString());
  }

  @Test
  void testParser46() {
    ASTNode obj = PARSE_UNRELAXED.parse("{a,b,c}[x] ");
    assertEquals("List(a, b, c)[x]", obj.toString());
  }

  @Test
  void testParser47() {
    ASTNode obj = PARSE_UNRELAXED.parse("123456789012345678901234567890");
    assertEquals("123456789012345678901234567890", obj.toString());
  }

  @Test
  void testParser48a() {
    ASTNode obj = PARSE_UNRELAXED.parse("FullForm[Hold[;;; ]]");
    assertEquals("FullForm(Hold(CompoundExpression(Span(1, All), Null)))", obj.toString());
  }

  @Test
  void testParser48b() {
    ASTNode obj = PARSE_UNRELAXED.parse("FullForm[Hold[abc;;; ]]");
    assertEquals("FullForm(Hold(CompoundExpression(Span(abc, All), Null)))", obj.toString());
  }

  @Test
  void testParser48c() {
    ASTNode obj = PARSE_UNRELAXED.parse("FullForm[Hold[abc;;;d ]]");
  ...
  void testParser50() {
    ASTNode obj =
        PARSE_UNRELAXED.parse("FullForm[Hold[{a, b, c, d, e, f, g, h, i, j, k}[[3 ;; -3 ;; 2]]]]");
  ...
  @Test
  void testParser51() {
    ASTNode obj = PARSE_UNRELAXED.parse("FullForm[Hold[UT[n, ttt\\[Lambda]abc0]]]");
    assertEquals("FullForm(Hold(UT(n, tttλabc0)))", obj.toString());
  }

  @Test
  void testParser52() {
    ASTNode obj = PARSE_UNRELAXED.parse("FullForm[Hold[{1, 2, 3, 4, 5}[[;; ;; -1]]]]");
    assertEquals("FullForm(Hold(Part(List(1, 2, 3, 4, 5), Span(1, All, -1))))", obj.toString());
  }

  @Test
  void testParser53() {
    ASTNode obj = PARSE_UNRELAXED.parse("opts : OptionsPattern[]");
    assertEquals("Pattern(opts, OptionsPattern())", obj.toString());
  }

  @Test
  void testParser54() {
    ASTNode obj = PARSE_UNRELAXED.parse("f[x_, opts : OptionsPattern[]]");
  ...
  void testParser56() {
    ...
    ASTNode obj = PARSE_UNRELAXED.parse("x y : z");
  ...
  void testParser57() {
    // see https://github.com/halirutan/Wolfram-Language-IntelliJ-Plugin-Archive/issues/166
    ASTNode obj = PARSE_UNRELAXED.parse("x y_ : z");
    assertEquals("Times(x, Optional(y_, z))", obj.toString());
  }

  @Test
  void testParser58() {
    ASTNode obj = PARSE_UNRELAXED.parse("StringContainsQ[\"bcde\", \"c\" ~~ __ ~~ \"t\"]");
    assertEquals("StringContainsQ(bcde, StringExpression(c, __, t))", obj.toString());
  }

  @Test
  void testParser59() {
    ASTNode obj = PARSE_UNRELAXED.parse("f[t_] = Simplify[ r'[t] / Norm[ r'[t] ], t ∈ Reals];");
    assertEquals(
  ...
  @Test
  void testParser60() {
    ASTNode obj = PARSE_UNRELAXED.parse("x[ [ ] ]");
    assertEquals("Part(x)", obj.toString());
  }

  @Test
  void testParser61() {
    ASTNode obj = PARSE_UNRELAXED.parse("(a+i*b^2+k*c^3+d)");
    assertEquals("Plus(a, Times(i, Power(b, 2)), Times(k, Power(c, 3)), d)", obj.toString());
  }

  @Test
  void testParser62() {
    ASTNode obj = PARSE_UNRELAXED.parse("\\[Theta] = 4");
  ...
  @Test
  void testParser70() {
    ASTNode obj = PARSE_UNRELAXED.parse("Plot3D[Sin[x*y],{x,-1.5`,1.5`},{y,-1.5`,1.5`}]");
  ...
  @Test
  void testParser73() {
    ASTNode obj = PARSE_UNRELAXED.parse("y:r_^n_");
  ...
  @Test
  void testParser74() {
    ASTNode obj = PARSE_UNRELAXED.parse("Cases[e, y:(a_. x + b_.)^n_ /; FreeQ[{a,b}, x] ]");
  ...
  @Test
  void testParser75() {
    ASTNode obj = PARSE_UNRELAXED.parse("Cases[e, t:{__Integer} :> t^2]");
  ...
  @Test
  void testParser77() {
    ASTNode obj = PARSE_UNRELAXED.parse("a_+b:Power[c_,_Rational]");
    assertEquals("Plus(a_, Pattern(b, Power(c_, _Rational)))", obj.toString());
  }

  @Test
  void testParser78() {
    ASTNode obj = PARSE_UNRELAXED.parse("WordBoundary ~~ x:DigitCharacter.. ~~ WordBoundary");
    assertEquals(
  ...
  @Test
  void testParser80() {
    ASTNode obj = PARSE_UNRELAXED.parse(" 2 *(* a test *) 4");
    assertEquals("Times(2, 4)", obj.toString());
  }

  @Test
  void testParser81() {
    ASTNode obj = PARSE_UNRELAXED.parse("x|->(x^3)");
    assertEquals("Function(x, Power(x, 3))", obj.toString());
  }

  @Test
  void testParser82() {
    ASTNode obj = PARSE_UNRELAXED.parse("x \\[Function] (x^3)");
    assertEquals("Function(x, Power(x, 3))", obj.toString());
  }
