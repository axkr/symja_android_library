...
IIntegrate(2586,Integrate(Times(Power(x_,m_DEFAULT),Power(Plus(c_,Times(d_DEFAULT,Power(x_,n_)),Times(e_DEFAULT,Sqrt(Plus(a_,Times(b_DEFAULT,Power(x_,n_)))))),CN1)),x_Symbol),
    Condition(Simp(Dist(Power(n,CN1),Subst(Integrate(Times(Power(x,Plus(Times(Plus(m,C1),Power(n,CN1)),CN1)),Power(Plus(c,Times(d,x),Times(e,Sqrt(Plus(a,Times(b,x))))),CN1)),x),x,Power(x,n)),x),x),And(FreeQ(List(a,b,c,d,e,m,n),x),EqQ(Subtract(Times(b,c),Times(a,d)),C0),IntegerQ(Times(Plus(m,C1),Power(n,CN1)))))),
IIntegrate(2587,Integrate(Times(u_DEFAULT,Power(Plus(c_,Times(d_DEFAULT,Power(x_,n_)),Times(e_DEFAULT,Sqrt(Plus(a_,Times(b_DEFAULT,Power(x_,n_)))))),CN1)),x_Symbol),
    Condition(Subtract(Simp(Dist(c,Integrate(Times(u,Power(Plus(Sqr(c),Times(CN1,a,Sqr(e)),Times(c,d,Power(x,n))),CN1)),x),x),x),Simp(Dist(Times(a,e),Integrate(Times(u,Power(Times(Plus(Sqr(c),Times(CN1,a,Sqr(e)),Times(c,d,Power(x,n))),Sqrt(Plus(a,Times(b,Power(x,n))))),CN1)),x),x),x)),And(FreeQ(List(a,b,c,d,e,n),x),EqQ(Subtract(Times(b,c),Times(a,d)),C0)))),
IIntegrate(2588,Integrate(Power(u_,m_DEFAULT),x_Symbol),
    Condition(With(list(Set(c,Simplify(D(u,x)))),Simp(Dist(Power(c,CN1),Subst(Integrate(Power(x,m),x),x,u),x),x)),And(FreeQ(m,x),PiecewiseLinearQ(u,x),NeQ(Power(u,m),x)))),
IIntegrate(2589,Integrate(Times(Power(u_,CN1),v_),x_Symbol),
    Condition(With(list(Set(a,Simplify(D(u,x))),Set(b,Simplify(D(v,x)))),Condition(Subtract(Simp(Times(b,x,Power(a,CN1)),x),Simp(Dist(Times(Subtract(Times(b,u),Times(a,v)),Power(a,CN1)),Integrate(Power(u,CN1),x),x),x)),NeQ(Subtract(Times(b,u),Times(a,v)),C0))),PiecewiseLinearQ(u,v,x))),
IIntegrate(2590,Integrate(Times(Power(u_,CN1),Power(v_,n_)),x_Symbol),
    Condition(With(list(Set(a,Simplify(D(u,x))),Set(b,Simplify(D(v,x)))),Condition(Subtract(Simp(Times(Power(v,n),Power(Times(a,n),CN1)),x),Simp(Dist(Times(Subtract(Times(b,u),Times(a,v)),Power(a,CN1)),Integrate(Times(Power(v,Plus(n,CN1)),Power(u,CN1)),x),x),x)),NeQ(Subtract(Times(b,u),Times(a,v)),C0))),And(PiecewiseLinearQ(u,v,x),GtQ(n,C0),NeQ(n,C1)))),
IIntegrate(2591,Integrate(Times(Power(u_,CN1),Power(v_,CN1)),x_Symbol),
    Condition(With(list(Set(a,Simplify(D(u,x))),Set(b,Simplify(D(v,x)))),Condition(Subtract(Simp(Dist(Times(b,Power(Subtract(Times(b,u),Times(a,v)),CN1)),Integrate(Power(v,CN1),x),x),x),Simp(Dist(Times(a,Power(Subtract(Times(b,u),Times(a,v)),CN1)),Integrate(Power(u,CN1),x),x),x)),NeQ(Subtract(Times(b,u),Times(a,v)),C0))),PiecewiseLinearQ(u,v,x))),
...
IIntegrate(2594,Integrate(Times(Power(u_,CN1),Power(v_,n_)),x_Symbol),
    Condition(With(list(Set(a,Simplify(D(u,x))),Set(b,Simplify(D(v,x)))),Condition(Subtract(Simp(Times(Power(v,Plus(n,C1)),Power(Times(Plus(n,C1),Subtract(Times(b,u),Times(a,v))),CN1)),x),Simp(Dist(Times(a,Plus(n,C1),Power(Times(Plus(n,C1),Subtract(Times(b,u),Times(a,v))),CN1)),Integrate(Times(Power(v,Plus(n,C1)),Power(u,CN1)),x),x),x)),NeQ(Subtract(Times(b,u),Times(a,v)),C0))),And(PiecewiseLinearQ(u,v,x),LtQ(n,CN1)))),
...
IIntegrate(2599,Integrate(Times(Power(u_,m_),Power(v_,n_DEFAULT)),x_Symbol),
    Condition(With(list(Set(a,Simplify(D(u,x))),Set(b,Simplify(D(v,x)))),Condition(Subtract(Simp(Times(Power(u,Plus(m,C1)),Power(v,n),Power(Times(a,Plus(m,C1)),CN1)),x),Simp(Dist(Times(b,n,Power(Times(a,Plus(m,C1)),CN1)),Integrate(Times(Power(u,Plus(m,C1)),Power(v,Plus(n,CN1))),x),x),x)),NeQ(Subtract(Times(b,u),Times(a,v)),C0))),And(FreeQ(list(m,n),x),PiecewiseLinearQ(u,v,x),NeQ(m,CN1),Or(And(LtQ(m,CN1),GtQ(n,C0),Not(And(ILtQ(Plus(m,n),CN2),Or(FractionQ(m),GeQ(Plus(Times(C2,n),m,C1),C0))))),And(IGtQ(n,C0),IGtQ(m,C0),LeQ(n,m)),And(IGtQ(n,C0),Not(IntegerQ(m))),And(ILtQ(m,C0),Not(IntegerQ(n))))))),
IIntegrate(2600,Integrate(Times(Power(u_,m_),Power(v_,n_DEFAULT)),x_Symbol),
    Condition(With(list(Set(a,Simplify(D(u,x))),Set(b,Simplify(D(v,x)))),Condition(Subtract(Simp(Times(Power(u,Plus(m,C1)),Power(v,n),Power(Times(a,Plus(m,n,C1)),CN1)),x),Simp(Dist(Times(n,Subtract(Times(b,u),Times(a,v)),Power(Times(a,Plus(m,n,C1)),CN1)),Integrate(Times(Power(u,m),Power(v,Plus(n,CN1))),x),x),x)),NeQ(Subtract(Times(b,u),Times(a,v)),C0))),And(PiecewiseLinearQ(u,v,x),NeQ(Plus(m,n,C2),C0),GtQ(n,C0),NeQ(Plus(m,n,C1),C0),Not(And(IGtQ(m,C0),Or(Not(IntegerQ(n)),LtQ(C0,m,n)))),Not(ILtQ(Plus(m,n),CN2)))))
  );
}
