...
/**
 * M0 template for the per-method corpus suites.
 *
 * <p>
...
public class IntegrateCorpusScaffoldTest extends AbstractIntegrateCorpusTest {
  ...
  /**
   * Same corpus, forcing the single {@code "Rational"} stage via the {@code Method} option. Cases
   * the native rational integrator does not yet cover surface as UNRESOLVED (tolerated); a wrong
