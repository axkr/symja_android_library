...
ISetDelayed(Int(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,Power(x_,m_DEFAULT)),Times(b_DEFAULT,Sqrt(Times(c_DEFAULT,Power(x_,pn_))))),CN1)),x_Symbol),
...
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,Power(v_,pn_))),CN1),x_Symbol),
...
ISetDelayed(Int(Times(v_,Power(Plus(a_,Times(b_DEFAULT,Power(u_,pn_DEFAULT))),CN1)),x_Symbol),
...
ISetDelayed(Int(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(x_,m_DEFAULT))),p_DEFAULT),Power(Plus(c_DEFAULT,Times(pd_DEFAULT,Power(x_,pn_DEFAULT))),q_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(u_,Power(Plus(a_,Times(c_DEFAULT,Power(x_,j_DEFAULT)),Times(b_DEFAULT,Power(x_,pn_DEFAULT))),p_)),x_Symbol),
