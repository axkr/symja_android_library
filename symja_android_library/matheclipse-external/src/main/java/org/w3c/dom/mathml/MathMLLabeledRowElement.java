 ...
 * Note that the presence of a label causes the indexth child node to differ from the index-th cell!
 */
public interface MathMLLabeledRowElement extends MathMLTableRowElement {
  /**
   * A MathMLElement representing the label of this row. Note that retrieving this should have the
   * same effect as a call to Node::getfirstChild(), while setting it should have the same effect as
