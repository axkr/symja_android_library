...
ISetDelayed(Int(Times(Power(Plus(Times(Power(x_,q_DEFAULT),a_DEFAULT),Times(Power(x_,pn_DEFAULT),b_DEFAULT)),p_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power(x_,q_DEFAULT),a_DEFAULT),Times(Power(x_,pn_DEFAULT),b_DEFAULT)),p_),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power(x_,pn_),a_DEFAULT),Times(Power(x_,j_DEFAULT),b_DEFAULT)),CN1D2),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power(x_,q_DEFAULT),a_DEFAULT),Times(Power(x_,pn_DEFAULT),b_DEFAULT)),CN1D2),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power(v_,q_DEFAULT),a_DEFAULT),Times(Power(w_,pn_DEFAULT),b_DEFAULT)),p_),Power(u_,m_DEFAULT)),x_Symbol),
