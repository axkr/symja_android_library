...
public class SquarefreeFiniteFieldCharP<C extends GcdRingElem<C>> extends SquarefreeFieldCharP<C> {
  ...
  /**
   * Characteristics root of a coefficient. <b>Note:</b> not needed at the moment.
   *
   * @param p coefficient.
  ...
  /**
   * Characteristics root of a polynomial. <b>Note:</b> call only in recursion.
   *
   * @param P polynomial.
  ...
  /**
   * GenPolynomial char-th root univariate polynomial. Base coefficient type must be finite field,
