...
public class OpenIntToFieldHashMap implements Serializable {
     ...
     */
    public OpenIntToFieldHashMap(  final IExpr missingEntries) {
     ...
     */
    public OpenIntToFieldHashMap( final int expectedSize) {
     ...
     */
    public OpenIntToFieldHashMap(final OpenIntToFieldHashMap source) {
