...
public class RubiIssue77 extends AbstractRubiTestCase {
	...
	public void test0099() {
		check("Rubi`NonfreeFactors[(3*(a + c*x^2 + d*x^3)^(1 + n))/(3 + 3*n), x]", "(a + c*x^2 + d*x^3)^(1 + n)");
	}
	...
	public void test0211() {
		check("Rubi`Simp[(3*(a + c*x^2 + d*x^3)^(1 + n))/(3 + 3*n), x]", "(a + c*x^2 + d*x^3)^(1 + n)/(1 + n)");
	}
	...
	public void test0266() {
		check("FreeQ[1,x]&&Rubi`PolyQ[(2*c+3*d*x)*(a+c*x^2+d*x^3)^n,x]&&Rubi`PolyQ[x,x]&&Rubi`NeQ[1,-1]",
				"False");
	}

	public void test0268a() {
		check("Rubi`Coeff[x,x,1]*x^(1+(-1)*1+(-1)*3)*((1+(-1)*1+(-1)*3+1)*(2*c+3*d*x)*(a+c*x^2+d*x^3)+(1+1)*x*(a+c*x^2+d*x^3)*D[2*c+3*d*x,x]+(1+n)*x*(2*c+3*d*x)*D[a+c*x^2+d*x^3,x])", //
				"((1+n)*x*(2*c+3*d*x)*(2*c*x+3*d*x^2)+6*d*x*(a+c*x^2+d*x^3)-2*(2*c+3*d*x)*(a+c*x^\n" + "2+d*x^3))/x^3");

		check("Rubi`EqQ[3*d^2*(3+3*n)*x,((1+n)*x*(2*c+3*d*x)*(2*c*x+3*d*x^2)+6*d*x*(a+c*x^2+d*x^3)-2*(2*c+3*d*x)*(a+c*x^2+d*x^3))/x^3]", //
				"False");
	}
