...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abs", "AddTo", "And", "AlgebraicNumber", "Alternatives", "Apart",
			...
			"BesselI", "BesselJ", "BesselK", "BesselY", "Binomial", "BinomialDistribution", "Blank", "Block", "Boole",
			"BooleanConvert", "BooleanMinimize", "BooleanTable", "BooleanVariables", "Break", "Cancel",
			...
			"DesignMatrix", "Det", "DiagonalMatrix", "DiceDissimilarity", "DigitQ", "Dimensions", "DirectedInfinity",
