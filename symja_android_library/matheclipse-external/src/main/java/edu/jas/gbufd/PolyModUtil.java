...
public class PolyModUtil {
   ...
   * @return lcm(n,d)
   */
  public static <C extends GcdRingElem<C>> GenSolvablePolynomial<C> syzLcm(
   ...
   * @return gcd(n,d)
   */
  public static <C extends GcdRingElem<C>> GenSolvablePolynomial<C> syzGcd(
      GenSolvablePolynomialRing<C> r, GenSolvablePolynomial<C> n, GenSolvablePolynomial<C> d) {
   ...
   * @return lcm(n,d)
   */
  public static <C extends GcdRingElem<C>> GenPolynomial<C> syzLcm(
      GenPolynomialRing<C> r, GenPolynomial<C> n, GenPolynomial<C> d) {
   ...
   * @return gcd(n,d)
   */
  public static <C extends GcdRingElem<C>> GenPolynomial<C> syzGcd(
      GenPolynomialRing<C> r, GenPolynomial<C> n, GenPolynomial<C> d) {
    if (n.isZERO()) {
      return d;
    }
