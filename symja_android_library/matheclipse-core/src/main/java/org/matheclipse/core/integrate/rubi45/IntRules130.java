...
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,-1),ExpIntegralE(C1,Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Plus(Times(b,x,HypergeometricPFQ(List(C1,C1,C1),List(C2,C2,C2),Times(CN1,b,x))),Times(CN1,EulerGamma,Log(x)),Times(CN1,C1D2,Sqr(Log(Times(b,x))))),FreeQ(b,x))),
ISetDelayed(Int(Times(Power(x_,m_),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),ExpIntegralE(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(E,Plus(a_DEFAULT,Times(b_DEFAULT,x_))),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,-1),LogIntegral(Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Plus(Times(CN1,b,x),Times(Log(Times(b,x)),LogIntegral(Times(b,x)))),FreeQ(b,x))),
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),LogIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
