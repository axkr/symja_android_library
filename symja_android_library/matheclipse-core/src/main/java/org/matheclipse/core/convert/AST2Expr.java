...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$GeoLocation", "$TimeZone", "$UnitSystem",
      ...
      "AbsoluteTime", "AbsoluteTiming", "AccountingForm", "Accumulate", "Accuracy", "ActionMenu",
      ...
      "AiryAiPrime", "AiryBi", "AiryBiPrime", "AlgebraicIntegerQ", "AlgebraicNumber",
      "AlgebraicNumberNorm", "AlgebraicNumberQ", "AlgebraicNumberTrace", "AlgebraicUnitQ", "Alignment", "AllowedDimensions", "AllPoints", "AllTrue", "Alpha",
      "Alphabet", "AlphabeticOrder", "AlphaChannel", "Alternatives", "AltitudeMethod",
      "AmbientLight", "And", "AngerJ", "AnglePath", "AngleVector", "Animate", "AnimationDirection",
      ...
      "AntihermitianMatrixQ", "AntisymmetricMatrixQ", "AnyTrue", "Apart", "Appearance",
      "AppearanceElements", "AppellF1", "Append", "AppendTo", "Apply", "ApplySides", "ArcCos",
      ...
      "Closing", "CMYKColor", "Coefficient", "CoefficientArrays", "CoefficientList",
      "CoefficientRules", "Cofactor", "Collect", "CollinearPoints", "Colon", "ColorCombine",
      "ColorConvert", "ColorData", "ColorDataFunction", "ColorDistance", "ColorNegate",
      ...
      "ComplexContourPlot", "ComplexExpand", "ComplexListPlot", "ComplexPlot", "ComplexPlot3D",
      ...
      "CompoundExpression", "Compress", "Condition", "ConditionalExpression", "Conditioned", "Cone",
      ...
      "ContourPlot", "ContourPlot3D", "Control", "ControllerLinking", "ControllerPath",
      ...
      "CoordinateBounds", "CoplanarPoints", "CoprimeQ", "Coproduct", "CopyFile", "CornerFilter",
      ...
      "CrossingDetect", "CrossMatrix", "Csc", "Csch", "Cube", "CubeRoot", "Cubics", "Cuboid",
      "Cumulant", "CumulantGeneratingFunction", "Cup", "CupCap", "Curl", "CurrencyConvert",
      "CurveClosed", "CycleGraph", "Cycles", "Cyclotomic", "Cylinder", "Darker", "Dashing",
      "DataDistribution", "DataReversed", "Dataset", "DatasetDisplayFormat", "DatasetTheme",
      ...
      "DateString", "DateValue", "DateWithinQ", "DawsonF", "DayCount", "DayHemisphere", "DaylightQ",
      "DayMatchQ", "DayName", "DayNightTerminator", "DayPlus", "DayRange", "DayRound",
      "DeBruijnSequence", "DecimalForm", "Decrement", "Decompose", "DedekindNumber", "Default",
      "DefaultButton", "DefaultDuration", "DefaultPrintPrecision", "DefaultValues", "Defer",
      "Definition", "Deinitialization", "Del", "DelaunayMesh", "Delete", "DeleteBorderComponents",
      ...
      "DiscreteLimit", "DiscretePlot", "DiscretePlot3D", "DiscreteRatio", "DiscreteShift",
      ...
      "DynamicModule", "DynamicWrapper", "EasterSunday", "Echo", "EchoFunction", "EclipseType",
      ...
      "EndTestSection", "EngineeringForm", "Entity", "EntityClass", "EntityList", "EntityProperty",
      "EntityValue", "Entropy", "EntropyFilter", "Equal", "EqualTilde", "EqualTo", "Equilibrium",
      "Equivalent", "Erf", "Erfc", "Erfi", "ErlangDistribution", "Erosion", "EuclideanDistance",
      "EulerE", "EulerianGraphQ", "EulerPhi", "Evaluate", "EvaluationMonitor", "Evaluator", "EvenQ",
      ...
      "ExportForm", "ExportString", "ExpressionGraph", "ExpToTrig", "ExtendedGCD",
      ...
      "FactorSquareFreeList", "FactorTerms", "FactorTermsList", "Failure", "Fibonacci",
      "FileExistsQ", "FileNameSetter", "FilledCurve", "FilledTorus", "FillingTransform",
      ...
      "FoldList", "FontSlant", "FontTracking", "FontWeight", "For", "ForAll", "FormBox",
      ...
      "FractionBox", "Framed", "FRatioDistribution", "FrechetDistribution", "FreeQ", "FresnelC",
      ...
      "NSum", "NullSpace", "NumberDigit", "NumberFieldClassNumber", "NumberFieldDiscriminant", "NumberFieldFundamentalUnits", "NumberFieldIntegralBasis", "NumberFieldRegulator", "NumberFieldRootsOfUnity", "NumberFieldSignature", "NumberForm", "NumberFormat",
      ...
      "OutputForm", "OutputStream", "Overflow", "Overlay", "Overscript", "OverscriptBox",
      "OwnValues", "Package", "PaddedForm", "Padding", "PadeApproximant", "PadLeft", "PadRight",
      "PairedBarChart", "PairedHistogram", "PairedSmoothHistogram", "Pane", "Panel", "Paneled",
      "PaneSelector", "ParallelMap", "Parallelepiped", "Parallelogram",
      ...
      "ProbabilityScalePlot", "Product", "ProductDistribution", "ProductLog", "ProgressIndicator",
      "Projection", "Proportion", "Proportional", "Protect", "ProteinData", "Pruning",
      ...
      "RemoveAlphaChannel", "RemoveBackground", "RemoveDiacritics", "RenkoChart", "Repeated",
      ...
      "TakeSmallestBy", "TakeWhile", "Tally", "Tan", "Tanh", "TargetStructure", "TargetUnits",
      ...
      "Tetrahedron", "TeXForm", "Text", "TextCell", "TextElement", "TextString", "TextStructure",
      "Texture", "TextureCoordinateFunction", "TextureCoordinateScaling", "Therefore", "Thickness",
      "Thinning", "Thread", "ThreeJSymbol", "Through", "Throw", "Thumbnail", "Thursday", "Tilde",
      "TildeEqual", "TildeFullEqual", "TildeTilde", "TimeConstrained", "TimeDirection",
      ...
      "ToBoxes", "ToCharacterCode", "ToDataset", "ToeplitzMatrix", "ToExpression", "Together",
