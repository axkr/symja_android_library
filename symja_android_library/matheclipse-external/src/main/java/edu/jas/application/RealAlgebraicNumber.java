...
/**
 * Complex algebraic number class based on bi-variate real algebraic numbers. Objects of this class
 * are immutable. Bi-variate ideal implementation is in version 3614 2011-04-28 09:20:34Z.
 *
 * @author Heinz Kredel
 */
public class RealAlgebraicNumber<C extends GcdRingElem<C> & Rational>
   ...
   * @return this+c.
   */
  public RealAlgebraicNumber<C> sum(
  ...
  public RealAlgebraicNumber<C>[] egcd(RealAlgebraicNumber<C> S) {
    edu.jas.root.RealAlgebraicNumber<edu.jas.root.RealAlgebraicNumber<C>>[] aret =
        number.egcd(S.number);
