...
public class GraphicsTest extends ExprEvaluatorTestCase {
  ...
  public void testGraphicsJSON() {
    ...
    check("GraphicsJSON(Graphics({Red, Disk({1, 1}, 1, {0, Pi/4})}))", //
        "{\"elements\":[{\"type\":\"disk\",\"color\":[1.0,0.0,0.0],\"opacity\":1.0,\"radius1\":1.0,\"radius2\":1.0,\"angle1\":0.0,\"angle2\":0.7853981633974483,\"coords\":[[[1.0,1.0]]]}],\"extent\":{\"xmin\":0.0,\"xmax\":2.0,\"ymin\":0.0,\"ymax\":2.0},\"axes\":{\"hasaxes\":false}}");

    check(
        "GraphicsJSON(Graphics({Blue, Circle({2,0}), Yellow, Polygon( {{2, 0}, {4, 1}, {4, -1}})}))", //
        "{\"elements\":[{\"type\":\"circle\",\"color\":[0.0,0.0,1.0],\"opacity\":1.0,\"radius1\":1.0,\"radius2\":1.0,\"coords\":[[[2.0,0.0]]]},{\"type\":\"polygon\",\"color\":[1.0,1.0,0.0],\"opacity\":1.0,\"coords\":[[[2.0,0.0]],[[4.0,1.0]],[[4.0,-1.0]]]}],\"extent\":{\"xmin\":1.0,\"xmax\":4.0,\"ymin\":-1.0,\"ymax\":1.0},\"axes\":{\"hasaxes\":false}}");
