...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "Accumulate", "AddTo",
			...
			"Diagonal", "DiagonalMatrix", "DialogInput", "DiceDissimilarity", "Differences", "DigitQ", "Dimensions",
			...
			"TensorDimensions", "TensorProduct", "TensorRank", "TensorSymmetry", "TextString", "TeXForm", "Thread",
