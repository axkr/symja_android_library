...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abs", "AbsArg", "AddTo", "AllTrue", "And", "AnyTrue",
			...
			"Coth", "Count", "Covariance", "Cross", "Csc", "Csch", "Curl", "Decrement", "Default", "Defer",
			...
			"Sqrt", "SquaredEuclidianDistance", "SquareFreeQ", "StieltjesGamma", "StirlingS1", "StirlingS2",
			"StringDrop", "StringJoin", "StringLength", "StringTake", "StruveH", "StruveL", "Subfactorial", "Subscript",
			"Subsuperscript", "Subsets", "SubtractFrom", "Sum", "Superscript", "SurfaceGraphics", "Switch",
			"SyntaxLength", "SymbolQ", "SyntaxQ", "Table", "Take", "Tally", "Tan", "Tanh", "TautologyQ", "Taylor",
