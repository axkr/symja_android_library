...
public class ComplexAlgebraicRing<C extends GcdRingElem<C> & Rational>
  ...
  /** Isolating rectangle for a complex root. <b>Note: </b> interval may shrink eventually. */
  ...
  /**
   * The constructor creates a ComplexAlgebraicNumber factory object from a GenPolynomial objects
   * module.
   *
