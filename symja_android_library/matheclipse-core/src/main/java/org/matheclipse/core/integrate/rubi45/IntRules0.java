...
ISetDelayed(Int(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,v_),Times(b_DEFAULT,v_),w_DEFAULT),p_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(Plus(Times(Plus(a,b),v),w),p)),x),And(FreeQ(List(a,b),x),Not(FreeQ(v,x))))),
ISetDelayed(Int(Times(Power($p("§px"),p_),u_DEFAULT),x_Symbol),
...
ISetDelayed(Int(Times(u_DEFAULT,Power(Times(a_DEFAULT,Power(x_,n_)),m_)),x_Symbol),
...
ISetDelayed(Int(Times(u_DEFAULT,Power(Plus(c_,Times(d_DEFAULT,Power(x_,j_))),p_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_DEFAULT))),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,x_),Times(c_DEFAULT,Sqr(x_))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,Power(x_,n_)),Times(c_DEFAULT,Power(x_,$p("n2",true)))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Power(x_,-1),x_Symbol),
    Simp(Log(x),x)),
ISetDelayed(Int(Power(x_,m_DEFAULT),x_Symbol),
...
ISetDelayed(Int(Times(Plus(c_,Times(d_DEFAULT,x_)),Power(Plus(a_,Times(b_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Power(Times(Plus(a_,Times(b_DEFAULT,x_)),Plus(c_,Times(d_DEFAULT,x_))),-1),x_Symbol),
    Condition(Int(Power(Plus(Times(a,c),Times(b,d,Sqr(x))),-1),x),And(FreeQ(List(a,b,c,d),x),EqQ(Plus(Times(b,c),Times(a,d)),C0)))),
ISetDelayed(Int(Power(Times(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),Plus(c_DEFAULT,Times(d_DEFAULT,x_))),-1),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),n_)),x_Symbol),
...
ISetDelayed(Int(Power(Times(Power(Plus(a_,Times(b_DEFAULT,x_)),QQ(3L,2L)),Power(Plus(c_,Times(d_DEFAULT,x_)),QQ(3L,2L))),-1),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Plus(c_,Times(d_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Power(Times(Power(Plus(a_,Times(b_DEFAULT,x_)),QQ(9L,4L)),Power(Plus(c_,Times(d_DEFAULT,x_)),C1D4)),-1),x_Symbol),
...
ISetDelayed(Int(Power(Times(Power(Plus(a_,Times(b_DEFAULT,x_)),QQ(5L,4L)),Power(Plus(c_,Times(d_DEFAULT,x_)),C1D4)),-1),x_Symbol),
