...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"AbsolutePointSize", "AbsoluteThickness",
      "AccuracyGoal", "All", "AllowedHeads", "AllowShortContext", "Algebraics", "Antisymmetric",
      "AspectRatio", "Automatic", "Axis", "Axes", "AxesEdge", "AxesLabel", "AxesOrigin",
      "AxesStyle", "Background", "BarOrigin", "BarSpacing", "BaseStyle", "BetweennessCentrality",
      "Black", "Blue", "Booleans", "Bottom", "Boxed", "BoxRatios", "Brown", "Byte", "Center",
      "Character", "CharacterEncoding", "ChartLabels", "ChartLegends", "ChartStyle",
      "ColorFunction", "ColorFunctionScaling", "ColorSpace", "ComplexInfinity", "Catalan",
      ...
      "SequenceHold", "SetSystemOptions", "Small", "SystemOptions", "SlotAbsent", "SpanFromAbove",
      "SpanFromBoth", "SpanFromLeft", "SplineClosed", "SplineDegree", "SplineKnots",
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "Activate", "AddSides", "AddTo", "AddToClassPath", "AdjacencyGraph", "AdjacencyMatrix",
      "Adjugate", "AiryAi", "AiryAiPrime", "AiryBi", "AiryBiPrime", "AlgebraicNumber", "AllTrue",
      "Alphabet", "AlphabeticOrder", "Alternatives", "AmbientLight", "And", "AngerJ", "AnglePath",
      "AngleVector", "Annotation", "Annuity", "AnnuityDue", "AntihermitianMatrixQ",
      ...
      "ArrayPlot", "ArrayQ", "ArrayReduce", "ArrayReshape", "ArrayRules", "ArraySymbol", "Arrays",
      "Arrow", "Arrowheads", "ASATriangle", "AssociateTo", "Association", "AssociationMap",
      "AssociationQ", "AssociationThread", "Assuming", "Assumptions", "Asymptotic",
      "AsymptoticSolve", "AsymptoticDSolveValue", "AsymptoticIntegrate", "AsymptoticRSolveValue",
      "AtomQ", "Attributes", "Ball", "BarChart", "BarLegend", "BarnesG", "BartlettWindow",
      "BaseDecode", "BaseEncode", "BaseForm", "Beep", "Begin", "BeginPackage", "BeginTestSection",
      ...
      "BetaDistribution", "BetaRegularized", "Between", "BezierCurve", "BezierFunction",
      ...
      "Block", "Boole", "BooleanConvert", "BooleanCountingFunction", "BooleanFunction",
      "BooleanMaxterms", "BooleanMinimize", "BooleanMinterms", "BooleanQ", "BooleanTable",
      "BooleanVariables", "BoxMatrix", "BoxWhiskerChart", "BrayCurtisDistance", "Break",
      "BrownianBridgeProcess", "BSplineCurve", "BSplineFunction", "Button", "ByteArray",
      "ByteArrayQ", "ByteArrayToString", "ByteCount", "CanberraDistance", "Cancel", "CancelButton",
      "CapForm", "CarlsonRC", "CarlsonRD", "CarlsonRF", "CarlsonRG", "CarlsonRJ",
      "CarmichaelLambda", "CartesianProduct", "Cases", "CatalanNumber", "Catch", "Catenate",
      "CauchyDistribution", "CDF", "Ceiling", "Cell", "CellularAutomaton", "CenterDot",
      "CentralFeature", "CentralMoment", "CForm", "CharacteristicPolynomial", "CharacterRange",
      "Characters", "ChebyshevT", "ChebyshevU", "Check", "CheckAbort", "ChessboardDistance",
      ...
      "CompleteGraph", "CompleteKaryTree", "Complex", "ComplexExpand", "ComplexPlot",
      ...
      "CosIntegral", "Cot", "Coth", "Count", "CountDistinct", "Counts", "Covariance",
      "CreateDirectory", "CreateFile", "CreateUUID", "Cross", "Csc", "Csch", "Cube", "CubeRoot",
      "Cuboid", "Cumulant", "Curl", "CycleGraph", "Cycles", "Cyclotomic", "Cylinder", "Darker",
      "Dashing", "Dataset", "DateObject", "DateString", "DateValue", "DawsonF", "DeBruijnSequence",
      "Decrement", "DedekindNumber", "Default", "DefaultButton", "DefaultValues", "Defer",
      "Definition", "Delete", "DeleteCases", "DeleteDuplicates", "DeleteDuplicatesBy",
      "DeleteMissing", "Denominator", "DensityHistogram", "DensityPlot", "Depth", "Derivative",
      ...
      "DifferenceQuotient", "DifferenceRoot", "Differences", "DigitCount", "DigitQ", "Dimensions",
      "DiracDelta", "DirectedEdge", "DirectedInfinity", "Direction", "DirectionalLight",
      ...
      "Divisors", "DivisorSigma", "DivisorSum", "Do", "Dodecahedron", "Dot", "DownValues", "Drop",
      "DSolve", "DSolveValue", "Dt", "DuplicateFreeQ", "Dynamic", "EasterSunday", "Echo",
      "EchoFunction", "EdgeCount", "EdgeForm", "EdgeList", "EdgeQ", "EdgeRules", "EdgeWeight",
      "EditDistance", "EffectiveInterest", "Eigensystem", "Eigenvalues", "EigenvectorCentrality",
      "Eigenvectors", "Element", "ElementData", "Eliminate", "Ellipsoid", "EllipticE", "EllipticF",
      "EllipticK", "EllipticPi", "EllipticTheta", "EmpiricalDistribution", "End", "EndPackage",
      "EndTestSection", "Entity", "Entropy", "Equal", "EqualTo", "Equivalent", "Erf", "Erfc",
      "Erfi", "ErlangDistribution", "EuclideanDistance", "EulerE", "EulerianGraphQ", "EulerPhi",
      "Evaluate", "EvenQ", "ExactNumberQ", "Except", "Exists", "Exit", "Exp", "Expand", "ExpandAll",
      ...
      "FromSphericalCoordinates", "FullDefinition", "FullForm", "FullSimplify", "Function",
      ...
      "GammaDistribution", "GammaRegularized", "Gather", "GatherBy", "GaussianMatrix",
      ...
      "Glow", "GoldbachList", "GompertzMakehamDistribution", "Grad", "Graph", "Graph3D",
      "GraphCenter", "GraphComplement", "GraphData", "GraphDiameter", "GraphDifference",
      "GraphDisjointUnion", "Graphics", "GraphicsGrid", "Graphics3D", "Graphics3DJSON",
      "GraphicsColumn", "GraphicsComplex", "GraphicsGroup", "GraphicsRow", "GraphicsJSON",
      "GraphIntersection", "GraphPeriphery", "GraphPlot", "GraphPower", "GraphQ", "GraphRadius",
      "GraphUnion", "GrayLevel", "Greater", "GreaterEqual", "GreaterEqualThan", "GreaterThan",
      "GridGraph", "GroebnerBasis", "GroupBy", "Groupings", "Gudermannian", "GumbelDistribution",
      ...
      "Haversine", "Head", "HeavisideLambda", "HeavisidePi", "HeavisideTheta",
      "HermiteDecomposition", "HermiteH", "HermitianMatrixQ", "HessenbergDecomposition",
      "HessianMatrix", "Hexahedron", "HilbertMatrix", "Histogram", "HodgeDual", "Hold", "HoldForm",
      "HoldPattern", "Horner", "HornerForm", "Hue", "HurwitzLerchPhi", "HurwitzZeta",
      ...
      "HypergeometricPFQRegularized", "HypergeometricU", "Icosahedron", "Identity",
      "IdentityMatrix", "If", "Im", "Image", "ImageChannels", "ImageColorSpace", "ImageCrop",
      "ImageData", "ImageDimensions", "ImageQ", "ImageResize", "ImageRotate", "ImageScaled",
      "ImageSize", "ImageType", "ImplicitD", "Implies", "Import", "ImportString", "In",
      "Inactivate", "Inactive", "Increment", "Indexed", "IndexGraph", "Inequality",
      "InexactNumberQ", "Infix", "Information", "Inner", "Input", "InputField", "InputForm",
      "InputStream", "InputString", "Insert", "InstallJava", "InstanceOf", "IntegerDigits",
      "IntegerExponent", "IntegerLength", "IntegerName", "IntegerPart", "IntegerPartitions",
      "IntegerQ", "Integrate", "InterpolatingFunction", "InterpolatingPolynomial", "Interpolation",
      ...
      "InverseSeries", "InverseWeierstrassP", "InverseZTransform", "IrreduciblePolynomialQ",
      ...
      "JavaNew", "JavaObject", "JavaObjectQ", "JavaShow", "Join", "JoinForm", "JordanDecomposition",
      "JSForm", "JSFormData", "KaryTree", "KelvinBei", "KelvinBer", "Key", "KeyDrop", "KeyExistsQ",
      "Keys", "KeySelect", "KeySort", "KeyTake", "KeyValueMap", "KeyValuePattern",
      ...
      "LaguerreL", "LambertW", "LaplaceTransform", "Laplacian", "LaplacianPDETerm", "Last", "LCM",
      "LeafCount", "LeastSquares", "LegendreP", "LegendreQ", "Length", "LengthWhile", "LerchPhi",
      "Less", "LessEqual", "LessEqualThan", "LessThan", "LetterCounts", "LetterNumber", "LetterQ",
      "Level", "LevelQ", "LeviCivitaTensor", "Lighter", "Limit", "Line", "LinearModelFit",
      ...
      "ListVectorPlot", "Literal", "LLMFunction", "LoadJavaClass", "Log", "Log10", "Log2",
      "LogBarnesG", "LogGamma", "LogicalExpand", "LogIntegral", "LogisticSigmoid", "LogLinearPlot",
      "LogLogPlot", "LogNormalDistribution", "LogPlot", "Longest", "Lookup", "LowerCaseQ",
      ...
      "MapAll", "MapApply", "MapAt", "MapIndexed", "MapThread", "MatchingDissimilarity", "MatchQ",
      "MathMLForm", "MatrixExp", "MatrixForm", "MatrixFunction", "MatrixLog",
      "MatrixMinimalPolynomial", "MatrixPlot", "MatrixPower", "MatrixQ", "MatrixRank",
      "MatrixSymbol", "Max", "MaxFilter", "Maximize", "MaximalBy", "MaxMemoryUsed", "Mean",
      ...
      "Minus", "Missing", "MissingQ", "Mod", "ModularInverse", "Module", "MoebiusMu", "Moment",
      "MonomialList", "Most", "Mouseover", "MrvLimit", "Multinomial", "MultinormalDistribution",
      ...
      "NegativeSemidefiniteMatrixQ", "Nest", "NestList", "NestWhile", "NestWhileList",
      "NExpectation", "NextPrime", "NFourierTransform", "NIntegrate", "NMaximize", "NMaxValue",
      "NMinimize", "NMinValue", "NonCommutativeMultiply", "NoneTrue", "NonNegative", "NonPositive",
      "Nor", "Norm", "Normal", "NormalDistribution", "Normalize", "NormalMatrixQ", "Not",
      "Notebook", "NotElement", "NotListQ", "NProbability", "NProduct", "NRoots", "NSolve", "NSum",
      ...
      "PadLeft", "PadRight", "ParallelMap", "Parallelogram", "ParametricPlot", "ParametricPlot3D",
      ...
      "PerfectNumber", "PerfectNumberQ", "Perimeter", "PeriodogramArray", "PermutationCycles",
      "PermutationCyclesQ", "PermutationList", "PermutationListQ", "PermutationProduct",
      "PermutationReplace", "Permutations", "Permute", "PetersenGraph", "Pick", "Piecewise",
      "PiecewiseExpand", "PieChart", "PlanarGraph", "PlanarGraphQ", "Plot", "Plot3D", "Plus",
      ...
      "PolynomialRemainder", "Position", "Positive", "PositiveDefiniteMatrixQ",
      ...
      "PseudoInverse", "Put", "PutAppend", "Pyramid", "QRDecomposition", "QuadraticIrrationalQ",
      "Quantile", "Quantity", "QuantityDistribution", "QuantityMagnitude", "QuantityQ",
      "QuantityUnit", "QuarticSolve", "Quartiles", "Quiet", "Quit", "Quotient", "QuotientRemainder",
      ...
      "RandomSample", "RandomVariate", "Range", "RangeSpace", "RankedMax", "RankedMin", "Rational",
      ...
      "Reap", "Rectangle", "Reduce", "Refine", "RegularExpression", "ReIm", "ReleaseHold", "Remove",
      "RemoveDiacritics", "Repeated", "RepeatedNull", "RepeatedTiming", "Replace", "ReplaceAll",
      "ReplaceAt", "ReplaceList", "ReplacePart", "ReplaceRepeated", "Rescale", "Residue", "Resolve",
      ...
      "Sign", "Signature", "SignCmp", "Simplex", "Simplify", "Sin", "Sinc",
      "SingularValueDecomposition", "SingularValueList", "Sinh", "SinhIntegral", "SinIntegral",
      "SixJSymbol", "Skeleton", "Skewness", "Slot", "SlotNumber", "SlotSequence",
      "SlotSequenceNumber", "SmallCircle", "SmithDecomposition", "SokalSneathDissimilarity",
      "Solve", "SolveAlways", "Sort", "SortBy", "Sow", "Span", "SparseArray", "SparseArrayQ",
      "SpecialsFreeQ", "Specularity", "SpectrogramArray", "Sphere", "SphericalBesselJ",
      "SphericalBesselY", "SphericalHankelH1", "SphericalHankelH2", "SphericalHarmonicY",
      "SphericalPlot3D", "Splice", "Split", "SplitBy", "SpotLight", "Sqrt", "SqrtBox", "Square",
      ...
      "Star", "StarGraph", "StatusArea", "StieltjesGamma", "StirlingS1", "StirlingS2", "StreamPlot",
      ...
      "StudentTDistribution", "Style", "StyleForm", "Subdivide", "Subfactorial", "Subresultants",
      ...
      "SurfaceArea", "SurfaceGraphics", "SurvivalFunction", "Switch", "SymbolicDeltaProductArray",
      ...
      "SyntaxLength", "SyntaxQ", "SystemDialogInput", "Table", "TableForm", "TagSet",
      ...
      "Text", "TextCell", "TextElement", "TextString", "TextStructure", "Therefore", "Thickness",
      "Thread", "ThreeJSymbol", "Through", "Throw", "Tilde", "TildeEqual", "TildeFullEqual",
      "TildeTilde", "TimeConstrained", "TimeObject", "TimeRemaining", "Times", "TimesBy",
      "TimeValue", "Timing", "ToBoxes", "ToCharacterCode", "ToeplitzMatrix", "ToExpression",
      "Together", "ToIntervalData", "ToLowerCase", "Tooltip", "ToPolarCoordinates", "ToRadicals",
      ...
      "TranslationTransform", "Transliterate", "Transpose", "TreeForm", "TreeGraph", "TreePlot",
      "Triangle", "TrigExpand", "TrigFactor", "TrigReduce", "TrigSimplifyFu", "TrigToExp", "TrueQ",
      "TTest", "Tube", "TukeyWindow", "Tuples", "TwoWayRule", "UnaryMinusPlus", "UnaryPlus",
      ...
      "UnequalTo", "Unevaluated", "UniformDistribution", "Union", "UnionPlus", "Unique",
      "UnitaryMatrixQ", "UnitConvert", "Unitize", "UnitStep", "UnitTriangle", "UnitVector",
      "Unprotect", "UnsameQ", "Unset", "UpArrow", "UpArrowBar", "UpArrowDownArrow", "UpDownArrow",
      ...
      "VectorLessEqual", "VectorPlot", "VectorQ", "VectorSymbol", "Vee", "Verbatim",
      "VerificationTest", "VertexColors", "VertexCoordinates", "VertexCount", "VertexEccentricity",
      "VertexList", "VertexNormals", "VertexQ", "VerticalBar", "VerticalSeparator", "VerticalTilde",
      ...
      "WhiteCornerBracket", "WhittakerM", "WhittakerW", "With", "WordBoundary", "WordCloud",
      "Write", "WriteString", "Xnor", "Xor", "YuleDissimilarity", "ZernikeR", "Zeta", "ZetaZero",
      "ZTransform"};
