...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"AlignmentPoint", "BaselinePosition",
      ...
      "NonNegativeIntegers", "NonNegativeRationals", "NonNegativeReals", "Nothing", "Nonexistent",
      "NotApplicable", "NotAvailable", "Now", "Null", "Number", "NumberString", "NumericFunction",
      "OneIdentity", "Orange", "Orderless", "Overlaps", "PerformanceGoal", "Pi", "Pink",
      "PlotLabel", "PlotLabels", "PlotLegends", "PlotPoints", "PlotRange", "PlotRangePadding",
      "PlotStyle", "PositiveIntegers", "PositiveRationals", "PositiveReals", "PrecisionGoal",
      "Primes", "Prolog", "Protected", "Purple", "RationalFunctions", "Rationals", "ReadProtected",
      "Real", "Record", "RecordSeparators", "Red", "Reals", "Right", "RoundingRadius",
      "RuntimeAttributes", "SameTest", "ScalingFunctions", "Second", "SeriesTermGoal",
      "SequenceHold", "SetSystemOptions", "Small", "StereochemistryElements", "SystemOptions",
      "SlotAbsent", "SpanFromAbove", "SpanFromBoth", "SpanFromLeft", "SplineClosed", "SplineDegree",
      "SplineKnots", "SplineWeights", "StaticsVisible", "StartOfLine", "StartOfString", "Strict",
      "String", "Symbol", "TableAlignments", "TableDepth", "TableDirections", "TableHeadings",
      "TableSpacing", "TargetFunctions", "TestID", "Thick", "Thin", "Ticks", "Tiny", "TicksStyle",
      "Today", "Tolerance", "TooLarge", "Top", "Transparent", "Trig", "True", "Unknown",
      ...
      "WordCharacter", "WordSeparators", "WorkingPrecision", "Yellow", "ZeroSymmetric", "ZeroTest"};

  // START_FUNCTION_SYMBOLS

  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      "AbsoluteDashing", "AbsoluteCorrelation", "AbsoluteTime", "AbsoluteTiming", "Accumulate",
      "Activate", "AcyclicGraphQ", "AddSides", "AddTo", "AddToClassPath", "AdjacencyGraph",
      "AdjacencyList", "AdjacencyMatrix", "Adjugate", "AiryAi", "AiryAiPrime", "AiryBi",
      "AiryBiPrime", "AlgebraicIntegerQ", "AlgebraicNumber", "AllTrue", "Alphabet",
      "AlphabeticOrder", "Alternatives", "AmbientLight", "And", "AngerJ", "AnglePath",
      "AngleVector", "Annotation", "Annuity", "AnnuityDue", "Annulus", "AntihermitianMatrixQ",
      "AntisymmetricMatrixQ", "AnyTrue", "Apart", "AppellF1", "Append", "AppendTo", "Apply",
      "ApplySides", "ArcCos", "ArcCosh", "ArcCot", "ArcCoth", "ArcCsc", "ArcCsch", "ArcLength",
      "ArcSec", "ArcSech", "ArcSin", "ArcSinh", "ArcTan", "ArcTanh", "Area", "Arg", "ArgMax",
      "ArgMin", "ArithmeticGeometricMean", "Array", "ArrayDepth", "ArrayDot", "ArrayFlatten",
      "ArrayPad", "ArrayPlot", "ArrayQ", "ArrayReduce", "ArrayReshape", "ArrayRules", "ArraySymbol",
      "Arrays", "Arrow", "Arrowheads", "ASATriangle", "AssociateTo", "Association",
      "AssociationMap", "AssociationQ", "AssociationThread", "Assuming", "Assumptions",
      "Asymptotic", "AsymptoticSolve", "AsymptoticDSolveValue", "AsymptoticIntegrate",
      "AsymptoticRSolveValue", "Atom", "AtomList", "AtomQ", "Attributes", "Ball", "Band",
      "BarChart", "BarLegend", "BarnesG", "BartlettWindow", "BaseDecode", "BaseEncode", "BaseForm",
      "Beep", "Begin", "BeginPackage", "BeginTestSection", "BellB", "BellY", "BernoulliB",
      ...
      "BetaRegularized", "Between", "BezierCurve", "BezierFunction", "BinaryDeserialize",
      ...
      "BitClear", "BitFlip", "BitGet", "BitLength", "BitNot", "BitOr", "BitSet", "BitXor",
      "BlackmanHarrisWindow", "BlackmanNuttallWindow", "BlackmanWindow", "Blank",
      "BlankNullSequence", "BlankSequence", "Block", "Bond", "BondList", "Boole", "BooleanConvert",
      "BooleanCountingFunction", "BooleanFunction", "BooleanMaxterms", "BooleanMinimize",
      "BooleanMinterms", "BooleanQ", "BooleanTable", "BooleanVariables", "BoundingRegion",
      "BoxMatrix", "BoxWhiskerChart", "BrayCurtisDistance", "Break", "BrownianBridgeProcess",
      "BSplineCurve", "BSplineFunction", "Button", "ByteArray", "ByteArrayQ", "ByteArrayToString",
      "ByteCount", "CanberraDistance", "Cancel", "CancelButton", "CapForm", "CarlsonRC",
      "CarlsonRD", "CarlsonRF", "CarlsonRG", "CarlsonRJ", "CarmichaelLambda", "CartesianProduct",
      "Cases", "CatalanNumber", "Catch", "Catenate", "CauchyDistribution", "CDF", "Ceiling", "Cell",
      "CellularAutomaton", "CenterDot", "CentralFeature", "CentralMoment", "CForm",
      ...
      "ClebschGordan", "Clip", "Close", "ClosenessCentrality", "CMYKColor", "Coefficient",
      "CoefficientArrays", "CoefficientList", "CoefficientRules", "Cofactor", "Collect",
      "CollinearPoints", "Colon", "ColorData", "ColorDataFunction", "Column", "Commonest",
      "CompatibleUnitQ", "Compile", "CompiledFunction", "CompilePrint", "Complement",
      "CompleteGraph", "CompleteGraphQ", "CompleteKaryTree", "Complex", "ComplexExpand",
      "ComplexPlot", "ComplexPlot3D", "ComposeList", "ComposeSeries", "CompositeQ", "Composition",
      "CompoundExpression", "Compress", "Condition", "ConditionalExpression", "Cone", "Conjugate",
      "ConjugateTranspose", "ConnectedGraphComponents", "ConnectedGraphQ", "ConstantArray",
      "ContainsAll", "ContainsAny", "ContainsExactly", "ContainsNone", "ContainsOnly", "Context",
      "Contexts", "Continue", "ContinuedFraction", "ContourPlot", "ContourPlot3D", "Convergents",
      ...
      "Darker", "Dashing", "Dataset", "DateObject", "DateString", "DateValue", "DawsonF",
      "DeBruijnSequence", "Decrement", "Decompose", "DedekindNumber", "Default", "DefaultButton",
      "DefaultValues", "Defer", "Definition", "Delete", "DeleteCases", "DeleteDuplicates",
      "DeleteDuplicatesBy", "DeleteMissing", "Denominator", "DensityHistogram", "DensityPlot",
      "Depth", "Derivative", "DesignMatrix", "Det", "Diagonal", "DiagonalMatrix", "DiagonalMatrixQ",
      "DialogInput", "DialogNotebook", "DialogReturn", "DiamondMatrix", "DiceDissimilarity",
      "DifferenceDelta", "DifferenceQuotient", "DifferenceRoot", "Differences", "DigitCount",
      "DigitQ", "DigitSum", "Dimensions", "DiracDelta", "DirectedEdge", "DirectedGraphQ",
      ...
      "Discriminant", "DiskMatrix", "DisjointQ", "Disk", "Dispatch", "DisplayForm", "Distribute",
      "Distributed", "Div", "Divide", "DivideBy", "DivideSides", "Divisible", "Divisors",
      "DivisorSigma", "DivisorSum", "Do", "Dodecahedron", "Dot", "DownValues", "Drop", "DSolve",
      "DSolveValue", "Dt", "DuplicateFreeQ", "Dynamic", "EasterSunday", "Echo", "EchoFunction",
      "EdgeAdd", "EdgeCount", "EdgeContract", "EdgeDelete", "EdgeForm", "EdgeList", "EdgeQ",
      ...
      "End", "EndPackage", "EndTestSection", "Entity", "EntityClass", "EntityList",
      "EntityProperty", "Entropy", "Equal", "EqualTo", "Equivalent", "Erf", "Erfc", "Erfi",
      "ErlangDistribution", "EuclideanDistance", "EulerE", "EulerianGraphQ", "EulerPhi", "Evaluate",
      "EvenQ", "ExactNumberQ", "Except", "Exists", "Exit", "Exp", "Expand", "ExpandAll",
      ...
      "ExportString", "ExpToTrig", "ExtendedGCD", "Extract", "FaceForm", "Factor", "Factorial",
      "Factorial2", "FactorList", "FactorialMoment", "FactorialPower", "FactorInteger",
      "FactorSquareFree", "FactorSquareFreeList", "FactorTerms", "FactorTermsList", "Fibonacci",
      ...
      "FindPermutation", "FindRoot", "FindSequenceFunction", "FindShortestCurve",
      "FindShortestPath", "FindShortestTour", "FindSpanningTree", "FindVertexColoring",
      "FindVertexCover", "First", "FirstCase", "FirstPosition", "Fit", "FittedModel", "FiveNum",
      "FixedPoint", "FixedPointList", "Flatten", "FlattenAt", "FlatTopWindow", "Floor", "Fold",
      "FoldList", "For", "ForAll", "FormBox", "Fourier", "FourierCosTransform", "FourierDCT",
      ...
      "FromRomanNumeral", "FromSphericalCoordinates", "FullDefinition", "FullForm", "FullSimplify",
      ...
      "GaussianWindow", "GCD", "GegenbauerC", "GeneratingFunction", "GeodesyData", "GeoDistance",
      ...
      "GraphDifference", "GraphDisjointUnion", "GraphDistance", "Graphics", "GraphicsGrid",
      ...
      "GreaterEqualThan", "GreaterThan", "GridGraph", "GroebnerBasis", "GroupBy", "Groupings",
      ...
      "HankelMatrix", "HannWindow", "HarmonicMean", "HarmonicNumber", "Hash", "Haversine", "Head",
      "HeavisideLambda", "HeavisidePi", "HeavisideTheta", "HermiteDecomposition", "HermiteH",
      "HermitianMatrixQ", "HessenbergDecomposition", "HessianMatrix", "Hexahedron", "HilbertMatrix",
      ...
      "In", "Inactivate", "Inactive", "IncidenceMatrix", "Increment", "Indexed", "IndexGraph",
      "Inequality", "InexactNumberQ", "InfiniteLine", "Infix", "Information", "Inner", "Input",
      "InputField", "InputForm", "InputStream", "InputString", "Insert", "InstallJava",
      "InstanceOf", "IntegerDigits", "IntegerExponent", "IntegerLength", "IntegerName",
      "IntegerPart", "IntegerPartitions", "IntegerQ", "Integrate", "InterpolatingFunction",
      "InterpolatingPolynomial", "Interpolation", "InterquartileRange", "Interrupt",
      ...
      "JavaObjectQ", "JavaShow", "Join", "JoinForm", "JordanDecomposition", "JSForm", "JSFormData",
      "KaryTree", "KelvinBei", "KelvinBer", "Key", "KeyDrop", "KeyDropFrom", "KeyExistsQ",
      "KeyFreeQ", "KeyMap", "KeyMemberQ", "Keys", "KeySelect", "KeySort", "KeySortBy", "KeyTake",
      "KeyUnion", "KeyValueMap", "KeyValuePattern", "KirchhoffMatrix", "KleinInvariantJ",
      ...
      "LambertW", "LaplaceTransform", "Laplacian", "LaplacianPDETerm", "Last", "LCM", "LeafCount",
      "LeastSquares", "LegendreP", "LegendreQ", "Length", "LengthWhile", "LerchPhi", "Less",
      "LessEqual", "LessEqualThan", "LessThan", "LetterCounts", "LetterNumber", "LetterQ", "Level",
      "LevelQ", "LeviCivitaTensor", "Lighter", "Limit", "Line", "LinearModelFit",
      "LinearOptimization", "LinearProgramming", "LinearRecurrence", "LinearSolve",
      "LinearSolveFunction", "LineGraph", "LiouvilleLambda", "List", "ListContourPlot",
      ...
      "Log", "Log10", "Log2", "LogBarnesG", "LogGamma", "LogicalExpand", "LogIntegral",
      "LogisticSigmoid", "LogLinearPlot", "LogLogPlot", "LogNormalDistribution", "LogPlot",
      "Longest", "Lookup", "LowerCaseQ", "LowerTriangularize", "LowerTriangularMatrixQ", "LucasL",
      "LUDecomposition", "MachineNumberQ", "MakeBoxes", "MangoldtLambda", "ManhattanDistance",
      "Manipulate", "MantissaExponent", "Map", "MapAll", "MapApply", "MapAt", "MapIndexed",
      ...
      "MatrixPlot", "MatrixPower", "MatrixQ", "MatrixRank", "MatrixSymbol", "Max", "MaxFilter",
      "Maximize", "MaximalBy", "MaxMemoryUsed", "Mean", "MeanClusteringCoefficient",
      "MeanDeviation", "MeanFilter", "Median", "MedianFilter", "MeijerG", "MeijerGReduce",
      "MemberQ", "MemoryAvailable", "MemoryInUse", "Merge", "MersennePrimeExponent",
      "MersennePrimeExponentQ", "MeshRange", "Message", "MessageName", "Messages", "Min",
      "MinFilter", "MinimalPolynomial", "MinimalBy", "Minimize", "MinMax", "Minor", "Minors",
      "Minus", "Missing", "MissingQ", "Mod", "ModularInverse", "Module", "MoebiusMu", "Molecule",
      "MoleculeQ", "MoleculeValue", "Moment", "MonomialList", "Most", "Mouseover", "MovingAverage",
      "MovingMedian", "Multinomial", "MultinormalDistribution", "MultiplicativeOrder",
      "MultiplySides", "MultivariatePoissonDistribution", "MultivariateTDistribution",
      "NakagamiDistribution", "NameQ", "Names", "Nand", "NArgMax", "NArgMin", "ND", "NDSolve",
      "Nearest", "NearestTo", "Needs", "Negative", "NegativeDefiniteMatrixQ",
      "NegativeSemidefiniteMatrixQ", "NeighborhoodGraph", "Nest", "NestList", "NestWhile",
      "NestWhileList", "NExpectation", "NextPrime", "NFourierTransform", "NIntegrate", "NMaximize",
      "NMaxValue", "NMinimize", "NMinValue", "NonCommutativeMultiply", "NoneTrue", "NonNegative",
      "NonPositive", "Nor", "Norm", "Normal", "NormalDistribution", "Normalize", "NormalMatrixQ",
      "Not", "Notebook", "NotElement", "NotListQ", "NProbability", "NProduct", "NRoots", "NSolve",
      "NSum", "NullSpace", "NumberDigit", "NumberFieldRootsOfUnity", "NumberLinePlot", "NumberQ",
      "Numerator", "NumericalOrder", "NumericalSort", "NumericArray", "NumericArrayQ",
      "NumericArrayType", "NumericQ", "NuttallWindow", "Octahedron", "OddQ", "Off", "Offset", "On",
      "Opacity", "OpenAppend", "OpenRead", "OpenWrite", "Operate", "OptimizeExpression", "Optional",
      "Options", "OptionsPattern", "OptionValue", "Or", "Order", "OrderedQ", "Ordering",
      "Orthogonalize", "OrthogonalMatrixQ", "Out", "Outer", "OutputForm", "OutputStream",
      "Overflow", "Overscript", "OverscriptBox", "OwnValues", "Package", "PadeApproximant",
      "PadLeft", "PadRight", "ParallelMap", "Parallelepiped", "Parallelogram", "ParametricPlot",
      ...
      "PetersenGraph", "Pick", "Piecewise", "PiecewiseExpand", "PieChart", "PlanarGraph",
      "PlanarGraphQ", "Plot", "Plot3D", "Plus", "PlusMinus", "Pochhammer", "Point", "PointLight",
      ...
      "PositionIndex", "Positive", "PositiveDefiniteMatrixQ", "PositiveSemidefiniteMatrixQ",
      ...
      "PreIncrement", "Prepend", "PrependTo", "Prime", "PrimeNu", "PrimeOmega", "PrimePi",
      ...
      "Probability", "Product", "ProductLog", "Projection", "Proportion", "Proportional", "Protect",
      "PseudoInverse", "Put", "PutAppend", "Pyramid", "QPochhammer", "QRDecomposition",
      "QuadraticIrrationalQ", "Quantile", "Quantity", "QuantityDistribution", "QuantityMagnitude",
      "QuantityQ", "QuantityUnit", "QuarticSolve", "Quartiles", "Quiet", "Quit", "Quotient",
      ...
      "RandomReal", "RandomSample", "RandomVariate", "Range", "RangeSpace", "RankDecomposition",
      ...
      "RealValuedNumberQ", "RealValuedNumericQ", "Reap", "Rectangle", "Reduce", "Refine", "Region",
      "RegionBounds", "RegionCentroid", "RegionDimension", "RegionDistance",
      "RegionEmbeddingDimension", "RegionMeasure", "RegionMember", "RegionNearest",
      "RegionNearestFunction", "RegionWithin", "RegularExpression", "RegularPolygon", "ReIm",
      ...
      "Rescale", "Residue", "Resolve", "Rest", "Resultant", "Return", "Reverse", "ReverseElement",
      "ReverseEquilibrium", "ReverseSort", "ReverseUpEquilibrium", "RevolutionPlot3D", "RGBColor",
      "RiccatiSolve", "RiemannSiegelTheta", "Riffle", "RightArrow", "RightArrowBar",
      ...
      "RootOf", "RootReduce", "Roots", "RootSum", "RotateLeft", "RotateRight", "RotationMatrix",
      "RotationTransform", "Round", "RoundImplies", "Row", "RowBox", "RowReduce", "RSolve",
      ...
      "SemanticImportString", "Sequence", "SequenceCount", "SequenceCases", "SequencePosition",
      "SequenceReplace", "SequenceSplit", "Series", "SeriesCoefficient", "SeriesData", "Set",
      "SetAttributes", "SetDelayed", "Share", "ShearingTransform", "ShiftRegisterSequence", "Short",
      "ShortDownArrow", "Shortest", "ShortestCurveDistance", "ShortLeftArrow", "ShortRightArrow",
      "ShortUpArrow", "Show", "Sign", "Signature", "SignCmp", "SignedRegionDistance", "Simplex",
      ...
      "SokalSneathDissimilarity", "Solve", "SolveAlways", "Sort", "SortBy", "Sow", "Span",
      ...
      "SphericalHankelH2", "SphericalHarmonicY", "SphericalPlot3D", "Splice", "Split", "SplitBy",
      ...
      "StandardDeviation", "StandardForm", "Standardize", "Star", "StarGraph", "StatusArea",
      "StieltjesGamma", "StirlingS1", "StirlingS2", "StreamPlot", "StringCases", "StringContainsQ",
      ...
      "Subfactorial", "Subgraph", "Subresultants", "Subscript", "SubscriptBox", "Subset",
      ...
      "Sum", "Summary", "SuperDagger", "Superscript", "SuperscriptBox", "Superset", "SupersetEqual",
      "Surd", "SurfaceArea", "SurfaceGraphics", "SurvivalFunction", "Switch",
      ...
      "ToLowerCase", "Tooltip", "ToPolarCoordinates", "TopologicalSort", "ToRadicals",
      ...
      "TransitiveClosure", "TranslationTransform", "Transliterate", "Transpose", "TreeForm",
      "TreeGraph", "TreeGraphQ", "TreePlot", "Triangle", "TriangleCenter", "TrigExpand",
      "TrigFactor", "TrigReduce", "TrigSimplifyFu", "TrigToExp", "TrueQ", "TTest", "Tube",
      "TukeyWindow", "Tuples", "TwoWayRule", "UnaryMinusPlus", "UnaryPlus", "UnaryPlusMinus",
      "Uncompress", "Undefined", "Underflow", "Underoverscript", "UnderoverscriptBox",
      ...
      "Unitize", "UnitStep", "UnitTriangle", "UnitVector", "Unprotect", "UnsameQ", "Unset",
      ...
      "UpSetDelayed", "UpTee", "UpTeeArrow", "UpTo", "UpValues", "URLDecode", "URLEncode",
      "URLFetch", "ValueQ", "Values", "VandermondeMatrix", "Variables", "Variance", "VectorAngle",
      "VectorGreater", "VectorGreaterEqual", "VectorLess", "VectorLessEqual", "VectorPlot",
      "VectorQ", "VectorSymbol", "Vee", "Verbatim", "VerificationTest", "VertexAdd", "VertexColors",
      "VertexContract", "VertexDelete", "VertexCoordinates", "VertexCount", "VertexDegree",
      "VertexEccentricity", "VertexInDegree", "VertexOutDegree", "VertexList", "VertexNormals",
      "VertexQ", "VerticalBar", "VerticalSeparator", "VerticalTilde", "Volume",
      ...
      "WhittakerM", "WhittakerW", "With", "WordBoundary", "WordCloud", "Write", "WriteString",
      "Xnor", "Xor", "YuleDissimilarity", "ZernikeR", "Zeta", "ZetaZero", "ZTransform"};
