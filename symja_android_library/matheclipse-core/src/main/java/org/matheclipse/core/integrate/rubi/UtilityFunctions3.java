...
ISetDelayed(4306,FixSimplify(Times(u_DEFAULT,Complex(C0,a_),Power(Plus(w_,Times(v_DEFAULT,Complex(C0,b_))),n_DEFAULT))),
...
ISetDelayed(4310,FixSimplify(Times(Power(u_,m_DEFAULT),Power(v_,n_),w_DEFAULT)),
...
ISetDelayed(4311,FixSimplify(Times(Power(a_,m_),Power(Plus(u_,Times(Power(b_,n_),v_DEFAULT)),p_DEFAULT),w_DEFAULT)),
...
ISetDelayed(4312,FixSimplify(Times(Power(a_,m_DEFAULT),Plus(Times(Power(a_,n_),u_DEFAULT),Times(Power(b_,p_DEFAULT),v_DEFAULT)),w_DEFAULT)),
...
ISetDelayed(4313,FixSimplify(Times(Power(Plus(a_,b_),m_DEFAULT),Power(Plus(c_,d_),n_),w_DEFAULT)),
...
ISetDelayed(4314,FixSimplify(Times(Power(Plus(Times(Power(a_,m_DEFAULT),u_DEFAULT),Times(Power(a_,n_DEFAULT),v_DEFAULT)),t_DEFAULT),w_DEFAULT)),
...
ISetDelayed(4315,FixSimplify(Times(w_DEFAULT,Power(Plus(Times(Power(a_,m_DEFAULT),u_DEFAULT),Times(Power(a_,n_DEFAULT),v_DEFAULT),Times(Power(a_,p_DEFAULT),z_DEFAULT)),t_DEFAULT))),
...
ISetDelayed(4316,FixSimplify(Times(w_DEFAULT,Power(Plus(Times(Power(a_,m_DEFAULT),u_DEFAULT),Times(Power(a_,n_DEFAULT),v_DEFAULT),Times(Power(a_,q_DEFAULT),y_DEFAULT),Times(Power(a_,p_DEFAULT),z_DEFAULT)),t_DEFAULT))),
...
ISetDelayed(4317,FixSimplify(Times(Plus(u_DEFAULT,Times(b_DEFAULT,Sqrt(v_)),Times(c_DEFAULT,Sqrt(v_)),Times(d_DEFAULT,Sqrt(v_)),Times(a_DEFAULT,Sqrt($p(v,Plus)))),w_DEFAULT)),
    FixSimplify(Times(w,Plus(u,Times(FixSimplify(Plus(a,b,c,d)),Sqrt(v)))))),
ISetDelayed(4318,FixSimplify(Times(Plus(u_DEFAULT,Times(b_DEFAULT,Sqrt(v_)),Times(c_DEFAULT,Sqrt(v_)),Times(a_DEFAULT,Sqrt($p(v,Plus)))),w_DEFAULT)),
    FixSimplify(Times(w,Plus(u,Times(FixSimplify(Plus(a,b,c)),Sqrt(v)))))),
ISetDelayed(4319,FixSimplify(Times(Plus(u_DEFAULT,Times(b_DEFAULT,Sqrt(v_)),Times(a_DEFAULT,Sqrt($p(v,Plus)))),w_DEFAULT)),
    FixSimplify(Times(w,Plus(u,Times(FixSimplify(Plus(a,b)),Sqrt(v)))))),
ISetDelayed(4320,FixSimplify(Times(u_DEFAULT,Power(v_,m_),Power(w_,n_))),
...
ISetDelayed(4321,FixSimplify(Times(u_DEFAULT,Power(v_,m_),Power(w_,n_DEFAULT))),
...
ISetDelayed(4323,FixSimplify(Times(u_DEFAULT,Power(Negate(Power(v_,p_DEFAULT)),m_),Power(w_,n_DEFAULT))),
...
ISetDelayed(4324,FixSimplify(Times(Power(Plus(a_,Negate(b_)),m_DEFAULT),Power(Plus(a_,b_),m_DEFAULT),u_DEFAULT)),
    Condition(Times(u,Power(Plus(Sqr(a),Negate(Sqr(b))),m)),And(IntegerQ(m),AtomQ(a),AtomQ(b)))),
ISetDelayed(4325,FixSimplify(Times(Power(Plus(Times(c_Symbol,Sqr(d_Symbol)),Times(CN1,e_Symbol,Plus(Times(b_Symbol,d_Symbol),Times(CN1,a_Symbol,e_Symbol)))),m_DEFAULT),u_DEFAULT)),
    Condition(Times(u,Power(Plus(Times(c,Sqr(d)),Times(CN1,b,d,e),Times(a,Sqr(e))),m)),And(RationalQ(m),OrderedQ(List(a,b,c,d,e))))),
ISetDelayed(4326,FixSimplify(Times(Power(Plus(Times(c_Symbol,Sqr(d_Symbol)),Times(e_Symbol,Plus(Times(CN1,b_Symbol,d_Symbol),Times(a_Symbol,e_Symbol)))),m_DEFAULT),u_DEFAULT)),
    Condition(Times(u,Power(Plus(Times(c,Sqr(d)),Times(CN1,b,d,e),Times(a,Sqr(e))),m)),And(RationalQ(m),OrderedQ(List(a,b,c,d,e))))),
ISetDelayed(4327,FixSimplify(Times(Power(Plus(Times(CN1,c_Symbol,Sqr(d_Symbol)),Times(e_Symbol,Plus(Times(b_Symbol,d_Symbol),Times(CN1,a_Symbol,e_Symbol)))),m_DEFAULT),u_DEFAULT)),
...
ISetDelayed(4328,FixSimplify(Times(Power(Plus(Times(CN1,c_Symbol,Sqr(d_Symbol)),Times(CN1,e_Symbol,Plus(Times(CN1,b_Symbol,d_Symbol),Times(a_Symbol,e_Symbol)))),m_DEFAULT),u_DEFAULT)),
...
ISetDelayed(4329,FixSimplify(u_),
    u),
ISetDelayed(4330,SimpFixFactor(Power(Plus(Times(a_DEFAULT,Complex(C0,c_)),Times(b_DEFAULT,Complex(C0,d_))),p_DEFAULT),x_),
    Condition(Times(Power(CI,p),SimpFixFactor(Power(Plus(Times(a,c),Times(b,d)),p),x)),IntegerQ(p))),
ISetDelayed(4331,SimpFixFactor(Power(Plus(Times(a_DEFAULT,Complex(C0,d_)),Times(b_DEFAULT,Complex(C0,e_)),Times(c_DEFAULT,Complex(C0,f_))),p_DEFAULT),x_),
    Condition(Times(Power(CI,p),SimpFixFactor(Power(Plus(Times(a,d),Times(b,e),Times(c,f)),p),x)),IntegerQ(p))),
ISetDelayed(4332,SimpFixFactor(Power(Plus(Times(a_DEFAULT,Power(c_,r_)),Times(b_DEFAULT,Power(x_,n_DEFAULT))),p_DEFAULT),x_),
...
ISetDelayed(4333,SimpFixFactor(Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(c_,r_),Power(x_,n_DEFAULT))),p_DEFAULT),x_),
...
ISetDelayed(4335,SimpFixFactor(Power(Plus(Times(a_DEFAULT,Power(c_,s_DEFAULT)),Times(b_DEFAULT,Power(c_,r_DEFAULT),Power(x_,n_DEFAULT))),p_DEFAULT),x_),
...
ISetDelayed(4336,SimpFixFactor(u_,x_),
    u),
ISetDelayed(4337,FactorNumericGcd(u_),
    If(And(PowerQ(u),RationalQ(Part(u,C2))),Power(FactorNumericGcd(Part(u,C1)),Part(u,C2)),If(ProductQ(u),Map($s("Integrate::FactorNumericGcd"),u),If(SumQ(u),With(List(Set(g,Apply($s("GCD"),Map($s("Integrate::NumericFactor"),Apply($s("List"),u))))),Times(g,Map(Function(Times(Slot1,Power(g,-1))),u))),u)))),
ISetDelayed(4338,MergeFactors(u_,v_),
...
ISetDelayed(4339,MergeFactor($p("bas"),$p("deg"),v_),
...
ISetDelayed(4340,MergeableFactorQ($p("bas"),$p("deg"),v_),
...
ISetDelayed(4341,TrigSimplifyQ(u_),
    UnsameQ(ActivateTrig(u),TrigSimplify(u))),
ISetDelayed(4342,TrigSimplify(u_),
    ActivateTrig(TrigSimplifyRecur(u))),
ISetDelayed(4343,TrigSimplifyRecur(u_),
    If(AtomQ(u),u,If(SameQ(Head(u),$s("If")),u,TrigSimplifyAux(Map($s("Integrate::TrigSimplifyRecur"),u))))),
ISetDelayed(4344,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,Power(v_,m_DEFAULT)),Times(b_DEFAULT,Power(v_,n_DEFAULT))),p_))),
...
ISetDelayed(4345,TrigSimplifyAux(Plus(v_DEFAULT,Times(a_DEFAULT,Sqr($($s("§cos"),u_))),Times(b_DEFAULT,Sqr($($s("§sin"),u_))))),
    Condition(Plus(a,v),SameQ(a,b))),
ISetDelayed(4346,TrigSimplifyAux(Plus(v_DEFAULT,Times(a_DEFAULT,Sqr($($s("§sec"),u_))),Times(b_DEFAULT,Sqr($($s("§tan"),u_))))),
    Condition(Plus(a,v),SameQ(a,Negate(b)))),
ISetDelayed(4347,TrigSimplifyAux(Plus(v_DEFAULT,Times(b_DEFAULT,Sqr($($s("§cot"),u_))),Times(a_DEFAULT,Sqr($($s("§csc"),u_))))),
    Condition(Plus(a,v),SameQ(a,Negate(b)))),
ISetDelayed(4348,TrigSimplifyAux(Power(Plus(v_DEFAULT,Times(a_DEFAULT,Sqr($($s("§cos"),u_))),Times(b_DEFAULT,Sqr($($s("§sin"),u_)))),n_)),
    Power(Plus(Times(Plus(b,Negate(a)),Sqr(Sin(u))),a,v),n)),
ISetDelayed(4349,TrigSimplifyAux(Plus(u_,w_DEFAULT,Times(v_DEFAULT,Sqr($($s("§sin"),z_))))),
    Condition(Plus(Times(u,Sqr(Cos(z))),w),SameQ(u,Negate(v)))),
ISetDelayed(4350,TrigSimplifyAux(Plus(u_,w_DEFAULT,Times(v_DEFAULT,Sqr($($s("§cos"),z_))))),
    Condition(Plus(Times(u,Sqr(Sin(z))),w),SameQ(u,Negate(v)))),
ISetDelayed(4351,TrigSimplifyAux(Plus(u_,w_DEFAULT,Times(v_DEFAULT,Sqr($($s("§tan"),z_))))),
    Condition(Plus(Times(u,Sqr(Sec(z))),w),SameQ(u,v))),
ISetDelayed(4352,TrigSimplifyAux(Plus(u_,w_DEFAULT,Times(v_DEFAULT,Sqr($($s("§cot"),z_))))),
    Condition(Plus(Times(u,Sqr(Csc(z))),w),SameQ(u,v))),
ISetDelayed(4353,TrigSimplifyAux(Plus(u_,w_DEFAULT,Times(v_DEFAULT,Sqr($($s("§sec"),z_))))),
    Condition(Plus(Times(v,Sqr(Tan(z))),w),SameQ(u,Negate(v)))),
ISetDelayed(4354,TrigSimplifyAux(Plus(u_,w_DEFAULT,Times(v_DEFAULT,Sqr($($s("§csc"),z_))))),
    Condition(Plus(Times(v,Sqr(Cot(z))),w),SameQ(u,Negate(v)))),
ISetDelayed(4355,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,$($s("§cos"),v_))),-1),Sqr($($s("§sin"),v_)))),
    Condition(Times(u,Plus(Power(a,-1),Times(CN1,Cos(v),Power(b,-1)))),EqQ(Plus(Sqr(a),Negate(Sqr(b))),C0))),
ISetDelayed(4356,TrigSimplifyAux(Times(u_DEFAULT,Sqr($($s("§cos"),v_)),Power(Plus(a_,Times(b_DEFAULT,$($s("§sin"),v_))),-1))),
    Condition(Times(u,Plus(Power(a,-1),Times(CN1,Sin(v),Power(b,-1)))),EqQ(Plus(Sqr(a),Negate(Sqr(b))),C0))),
ISetDelayed(4357,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT))),-1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cot(v),n))),-1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(4358,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT))),-1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Tan(v),n))),-1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(4359,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT))),-1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cos(v),n))),-1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(4360,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT))),-1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Sin(v),n))),-1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(4361,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT))),-1),Power($($s("§tan"),v_),n_DEFAULT))),
    Condition(Times(u,Power(Sin(v),n),Power(Plus(b,Times(a,Power(Cos(v),n))),-1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(4362,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT))),-1))),
    Condition(Times(u,Power(Cos(v),n),Power(Plus(b,Times(a,Power(Sin(v),n))),-1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(4363,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT)),Times(b_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT))),p_DEFAULT))),
    Condition(Times(u,Power(Sec(v),Times(n,p)),Power(Plus(a,Times(b,Power(Sin(v),n))),p)),IntegersQ(n,p))),
ISetDelayed(4364,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(Times(b_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT)),Times(a_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT))),p_DEFAULT))),
    Condition(Times(u,Power(Csc(v),Times(n,p)),Power(Plus(a,Times(b,Power(Cos(v),n))),p)),IntegersQ(n,p))),
ISetDelayed(4365,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(Times(b_DEFAULT,Power($($s("§sin"),v_),n_DEFAULT)),Times(a_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT))),p_DEFAULT))),
    Condition(Times(u,Power(Tan(v),Times(n,p)),Power(Plus(a,Times(b,Power(Cos(v),n))),p)),IntegersQ(n,p))),
ISetDelayed(4366,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(Times(b_DEFAULT,Power($($s("§cos"),v_),n_DEFAULT)),Times(a_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT))),p_DEFAULT))),
    Condition(Times(u,Power(Cot(v),Times(n,p)),Power(Plus(a,Times(b,Power(Sin(v),n))),p)),IntegersQ(n,p))),
ISetDelayed(4367,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§cos"),v_),m_DEFAULT),Power(Plus(a_DEFAULT,Times(c_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT)),Times(b_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT))),p_DEFAULT))),
...
ISetDelayed(4368,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§sec"),v_),m_DEFAULT),Power(Plus(a_DEFAULT,Times(c_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT)),Times(b_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT))),p_DEFAULT))),
...
ISetDelayed(4369,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT)),Times(c_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT))),p_DEFAULT),Power($($s("§sin"),v_),m_DEFAULT))),
...
ISetDelayed(4370,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§csc"),v_),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT)),Times(c_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT))),p_DEFAULT))),
...
ISetDelayed(4371,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,Power($($s("§csc"),v_),m_DEFAULT)),Times(b_DEFAULT,Power($($s("§sin"),v_),n_DEFAULT))),p_DEFAULT))),
...
ISetDelayed(4372,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(Times(b_DEFAULT,Power($($s("§cos"),v_),n_DEFAULT)),Times(a_DEFAULT,Power($($s("§sec"),v_),m_DEFAULT))),p_DEFAULT))),
...
ISetDelayed(4373,TrigSimplifyAux(u_),
    u),
ISetDelayed(4374,TrigSimplifyAux(Times(u_DEFAULT,Power(Times(c_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT),Power($($s("§tan"),w_),n_DEFAULT)),p_DEFAULT))),
    Condition(Times(u,Power(Power(Plus(Negate(c),Times(c,$($s("§sec"),w))),n),p)),And(IntegerQ(n),EqQ(w,Times(C2,v))))),
ISetDelayed(4375,ContentFactor($p("expn")),
    TimeConstrained(ContentFactorAux($s("expn")),$s("§$timelimit"),$s("expn"))),
ISetDelayed(4376,ContentFactorAux($p("expn")),
...
ISetDelayed(4385,MinimumDegree($p("deg1"),$p("deg2")),
...
ISetDelayed(4386,ConstantFactor(u_,x_Symbol),
...
ISetDelayed(4387,PositiveFactors(u_),
    If(EqQ(u,C0),C1,If(RationalQ(u),Abs(u),If(GtQ(u,C0),u,If(ProductQ(u),Map($s("Integrate::PositiveFactors"),u),C1))))),
ISetDelayed(4388,NonpositiveFactors(u_),
    If(EqQ(u,C0),u,If(RationalQ(u),Sign(u),If(GtQ(u,C0),C1,If(ProductQ(u),Map($s("Integrate::NonpositiveFactors"),u),u))))),
ISetDelayed(4389,PolynomialInQ(u_,v_,x_Symbol),
    PolynomialInAuxQ(u,NonfreeFactors(NonfreeTerms(v,x),x),x)),
ISetDelayed(4390,PolynomialInAuxQ(u_,v_,x_),
...
ISetDelayed(4391,ExponentIn(u_,v_,x_Symbol),
    ExponentInAux(u,NonfreeFactors(NonfreeTerms(v,x),x),x)),
ISetDelayed(4392,ExponentInAux(u_,v_,x_),
...
ISetDelayed(4393,PolynomialInSubst(u_,v_,x_Symbol),
...
ISetDelayed(4394,PolynomialInSubstAux(u_,v_,x_),
