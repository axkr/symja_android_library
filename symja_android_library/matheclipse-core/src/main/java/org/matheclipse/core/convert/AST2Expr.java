...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "AtomQ", "Attributes", "Ball", "Band", "BarChart", "BarLegend", "BarnesG", "BartlettWindow",
      ...
      "DeBruijnSequence", "Decrement", "DedekindNumber", "Default", "DefaultButton",
      ...
      "DigitQ", "Dimensions", "DiracDelta", "DirectedEdge", "DirectedInfinity", "Direction",
      ...
      "DiscreteShift", "DiscreteUniformDistribution", "Discriminant", "DiskMatrix", "DisjointQ",
      "Disk", "Dispatch", "DisplayForm", "Distribute", "Distributed", "Div", "Divide", "DivideBy",
      "DivideSides", "Divisible", "Divisors", "DivisorSigma", "DivisorSum", "Do", "Dodecahedron",
      "Dot", "DownValues", "Drop", "DSolve", "DSolveValue", "Dt", "DuplicateFreeQ", "Dynamic",
      "EasterSunday", "Echo", "EchoFunction", "EdgeCount", "EdgeForm", "EdgeList", "EdgeQ",
      ...
      "Export", "ExportString", "ExpToTrig", "ExtendedGCD", "Extract", "FaceForm", "Factor",
      "Factorial", "Factorial2", "FactorList", "FactorialMoment", "FactorialPower", "FactorInteger",
      ...
      "NArgMin", "ND", "NDSolve", "Nearest", "NearestTo", "Needs", "Negative",
      "NegativeDefiniteMatrixQ", "NegativeSemidefiniteMatrixQ", "Nest", "NestList", "NestWhile",
      ...
      "PerfectNumber", "PerfectNumberQ", "Perimeter", "PeriodogramArray", "Permanent",
      ...
      "Pick", "Piecewise", "PiecewiseExpand", "PieChart", "PlanarGraph", "PlanarGraphQ", "Plot",
      "Plot3D", "Plus", "PlusMinus", "Pochhammer", "Point", "PointLight", "PointSize",
      ...
      "Positive", "PositiveDefiniteMatrixQ", "PositiveSemidefiniteMatrixQ", "PossibleZeroQ",
      "Postfix", "Power", "PowerExpand", "PowerMod", "PowerRange", "PowersRepresentations",
      "PrecedenceForm", "Precision", "PreDecrement", "Prefix", "PreIncrement", "Prepend",
      "PrependTo", "Prime", "PrimeOmega", "PrimePi", "PrimePowerQ", "PrimeQ", "PrimeZetaP",
      ...
      "RangeSpace", "RankedMax", "RankedMin", "Rational", "Rationalize", "Ratios", "RawBackquote",
      "RawBoxes", "Re", "Read", "ReadLine", "ReadList", "ReadString", "RealAbs", "RealDigits",
      "RealSign", "RealValuedNumberQ", "RealValuedNumericQ", "Reap", "Rectangle", "Reduce",
      ...
      "ReplaceList", "ReplacePart", "ReplaceRepeated", "Rescale", "Residue", "Resolve", "Rest",
      ...
      "SpearmanRho", "SpecialsFreeQ", "Specularity", "SpectrogramArray", "Sphere",
      "SphericalBesselJ", "SphericalBesselY", "SphericalHankelH1", "SphericalHankelH2",
      "SphericalHarmonicY", "SphericalPlot3D", "Splice", "Split", "SplitBy", "SpotLight", "Sqrt",
      ...
      "Transliterate", "Transpose", "TreeForm", "TreeGraph", "TreePlot", "Triangle", "TrigExpand",
      ...
      "VectorQ", "VectorSymbol", "Vee", "Verbatim", "VerificationTest", "VertexColors",
      "VertexCoordinates", "VertexCount", "VertexEccentricity", "VertexList", "VertexNormals",
