...
public interface SinRules {
  final public static IAST RULES = List(
    ...
    ISet(Sin(Times(QQ(1L,8L),Pi)),
      Times(C1D2,Sqrt(Plus(C2,Times(CN1,CSqrt2))))),
    ISet(Sin(Times(QQ(1L,6L),Pi)),
      C1D2),
    ISet(Sin(Times(QQ(1L,5L),Pi)),
      Times(C1D2,Sqrt(C1D2),Sqrt(Plus(C5,Times(CN1,CSqrt5))))),
    ...
    ISet(Sin(Times(QQ(9L,8L),Pi)),
      Times(CN1D2,Sqrt(Plus(C2,Times(CN1,CSqrt2))))),
    ISet(Sin(Times(QQ(7L,6L),Pi)),
      CN1D2),
    ISet(Sin(Times(QQ(6L,5L),Pi)),
      Times(CN1D2,Sqrt(C1D2),Sqrt(Plus(C5,Times(CN1,CSqrt5))))),
