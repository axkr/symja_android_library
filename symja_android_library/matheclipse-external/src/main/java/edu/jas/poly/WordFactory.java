...
public final class WordFactory implements MonoidFactory<Word> {
  ...
  public abstract static class WordComparator implements Comparator<Word>, Serializable {
  ...
  public Word valueOf(ExpVector e) {
    ...
    if (m > n) {
      throw new IllegalArgumentException(
          "alphabet to short for exponent " + e + ", alpahbet = " + alphabet);
    }
    for (int i = 0; i < m; i++) {
  ...
  /**
   * Contract word to this word factory. <code>this.isSubFactory(w.mono)</code> must be true,
