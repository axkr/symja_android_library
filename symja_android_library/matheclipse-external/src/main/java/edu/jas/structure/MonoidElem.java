...
public interface MonoidElem<C extends MonoidElem<C>> extends Element<C> {
  ...
  public default C[] quotientRemainder(C S) {
   ...
   */
  public default C rightDivide(C a) {
    return divide(a);
  }
   ...
   */
  public default C leftDivide(C a) {
    return divide(a);
  }
   ...
   */
  public default C rightRemainder(C a) {
    return remainder(a);
  }
   ...
   */
  public default C leftRemainder(C a) {
    return remainder(a);
  }
   ...
   */
  @SuppressWarnings("unchecked")
  public default C[] twosidedDivide(C a) {
   ...
   */
  public default C twosidedRemainder(C a) {
    return remainder(a);
  }

  /**
   * Inverse of this. Some implementing classes will throw NotInvertibleException if the element is
   * not invertible.
   *
   ...
   * @return a**n, with a**0 = 1 and a**{-n} = {1/a}**n. Java 8 only
   */
  @SuppressWarnings("unchecked")
  public default C power(long n) {
