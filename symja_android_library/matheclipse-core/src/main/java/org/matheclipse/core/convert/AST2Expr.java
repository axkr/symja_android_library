...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$BoxForms", "$CommandLine", "$ContextAliases",
      ...
      "BinaryFormat", "BinaryRead", "BinaryReadList", "BinarySerialize", "BinaryWrite", "BinCounts",
      ...
      "BioSequenceInstances", "BioSequenceModify", "BioSequenceQ", "BioSequenceReverseComplement",
      ...
      "BlankNullSequence", "BlankSequence", "Blend", "Block", "Blur", "Bold", "Bond", "BondCount",
