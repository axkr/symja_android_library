...
public class Examples {
  ...
  /**
   * example5. comprehensive GB of List&lt;GenPolynomial&lt;GenPolynomial&lt;BigRational&gt;&gt;&gt;
  ...
  public static void example5() {
    ...
    RReductionSeq<Product<Residue<BigRational>>> res =
        new RReductionSeq<Product<Residue<BigRational>>>();
  ...
  public static void example6() {
    ...
    List<IdealWithRealAlgebraicRoots<BigRational>> Ir =
        PolyUtilApp.<BigRational>realAlgebraicRoots(I);
  ...
  public static void example7() {
    ...
    GenPolynomialRing<ModInteger> z2p =
        new GenPolynomialRing<ModInteger>(z2, vars.length, new TermOrder(TermOrder.INVLEX), vars);
    ...
    GenPolynomialRing<Residue<ModInteger>> ringp =
        new GenPolynomialRing<Residue<ModInteger>>(ring, mvars.length, mvars);

    List<GenPolynomial<Residue<ModInteger>>> polynomials =
        new ArrayList<GenPolynomial<Residue<ModInteger>>>();
  ...
  public static void example9() {
    String[] vars = {
      "d1", "d2", "d3", "p1a", "p1b", "p1c", "p2a", "p2b", "p2c", "p3a", "p3b", "p3c", "p4a", "p4b",
      "p4c", "A", "B", "C", "D"
    };

    BigRational br = new BigRational();
    GenPolynomialRing<BigRational> pring = new GenPolynomialRing<BigRational>(br, vars);
    // GenPolynomialRing<BigRational> pring = new GenPolynomialRing<BigRational>(br, vars.length,
    ...
    GenPolynomial<BigRational> e10 =
        pring.parse("(p4a-p1a)^2+(p4b-p1b)^2+(p4c-p1c)^2-d3^2"); // (10)
    cp.add(e10);
  ...
  /**
   * example10. abtract types: GB of List&lt;GenPolynomial&lt;AlgebraicNumber&lt;Quotient
  ...
  public static void example10() {
    ...
    pqafac =
        new GenPolynomialRing<Quotient<AlgebraicNumber<BigRational>>>(qafac, new String[] {"wx"});
    ...
    */
    ...
    // bb = new GroebnerBaseSeq<AlgebraicNumber<Quotient<AlgebraicNumber<BigRational>>>>();
    // //aqafac);
  ...
  public static void example12() {
    ...
    List<GenPolynomial<Quotient<BigRational>>> L =
        new ArrayList<GenPolynomial<Quotient<BigRational>>>();
    ...
    // builder
    bb =
        GBAlgorithmBuilder.polynomialRing(pfac).fractionFree().syzygyPairlist().parallel(3).build();
    System.out.println("isGB(L) = " + bb.isGB(L));
    t = System.currentTimeMillis();
    G = bb.GB(L);
    t = System.currentTimeMillis() - t;
