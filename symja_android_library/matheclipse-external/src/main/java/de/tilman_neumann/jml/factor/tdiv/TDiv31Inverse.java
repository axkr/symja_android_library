...
public class TDiv31Inverse extends FactorAlgorithm {
  ...
  private AutoExpandingPrimesArray SMALL_PRIMES =
      AutoExpandingPrimesArray.get(); // "static" would be slightly slower
  ...
  public BigInteger findSingleFactor(BigInteger N) {
    if (N.bitLength() > 31)
      throw new IllegalArgumentException(
          "TDiv31Inverse.findSingleFactor() does not work for N>31 bit, but N=" + N);
