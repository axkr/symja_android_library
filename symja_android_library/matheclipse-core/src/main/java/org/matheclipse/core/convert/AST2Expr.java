...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "Quotient", "QuotientRemainder", "Ramp", "RandomChoice", "RandomComplex", "RandomInteger",
      ...
      "Re", "Read", "ReadList", "ReadString", "RealAbs", "RealDigits", "RealSign", "RealNumberQ",
      "Reap", "Rectangle", "Reduce", "Refine", "RegularExpression", "ReleaseHold", "Remove",
