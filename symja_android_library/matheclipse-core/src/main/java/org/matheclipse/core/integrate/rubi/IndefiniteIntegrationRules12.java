...
SetDelayed(Int(ArcCot(u_),x_Symbol),
...
SetDelayed(Int(Times(ArcCot(u_),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(ArcCot(u_),v_),x_Symbol),
...
SetDelayed(Int(Times(ArcCot(Times(b_DEFAULT,x_)),Power(Plus(Times(Power(x_,n_DEFAULT),$p(d,true)),c_),CN1)),x_Symbol),
...
SetDelayed(Int(Times(ArcCot(Plus(Times(b_DEFAULT,x_),a_)),Power(Plus(Times(Power(x_,n_DEFAULT),$p(d,true)),c_),CN1)),x_Symbol),
...
SetDelayed(Int(ArcSec(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(ArcSec(Times(Power(x_,n_DEFAULT),a_DEFAULT)),Power(x_,CN1)),x_Symbol),
...
SetDelayed(Int(Times(ArcSec(Plus(Times(b_DEFAULT,x_),a_)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(ArcSec(Times(a_DEFAULT,x_)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(ArcSec(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcSec(Times(Power(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_DEFAULT),CN1),c_DEFAULT)),m_DEFAULT),u_DEFAULT),x_Symbol),
    Condition(Int(Times(u,Power(ArcCos(Plus(Times(a,Power(c,CN1)),Times(b,Power(x,n),Power(c,CN1)))),m)),x),FreeQ(List(a,b,c,n,m),x))),
SetDelayed(Int(ArcSec(u_),x_Symbol),
...
SetDelayed(Int(ArcCsc(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(ArcCsc(Times(Power(x_,n_DEFAULT),a_DEFAULT)),Power(x_,CN1)),x_Symbol),
...
SetDelayed(Int(Times(ArcCsc(Plus(Times(b_DEFAULT,x_),a_)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(ArcCsc(Times(a_DEFAULT,x_)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(ArcCsc(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCsc(Times(Power(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_DEFAULT),CN1),c_DEFAULT)),m_DEFAULT),u_DEFAULT),x_Symbol),
    Condition(Int(Times(u,Power(ArcSin(Plus(Times(a,Power(c,CN1)),Times(b,Power(x,n),Power(c,CN1)))),m)),x),FreeQ(List(a,b,c,n,m),x))),
SetDelayed(Int(ArcCsc(u_),x_Symbol),
...
SetDelayed(Int(ArcSinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(ArcSinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CN1),x_Symbol),
    Condition(Times(CoshIntegral(ArcSinh(Plus(a,Times(b,x)))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Power(ArcSinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CN2),x_Symbol),
...
SetDelayed(Int(Power(ArcSinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CN1D2),x_Symbol),
...
SetDelayed(Int(Power(ArcSinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),C1D2),x_Symbol),
...
SetDelayed(Int(Power(ArcSinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),n_),x_Symbol),
...
SetDelayed(Int(Times(ArcSinh(Times(Power(x_,n_DEFAULT),a_DEFAULT)),Power(x_,CN1)),x_Symbol),
...
SetDelayed(Int(Times(ArcSinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(Plus(Times(ArcSinh(Plus(Times($p(d,true),x_),c_DEFAULT)),b_DEFAULT),a_),CN1D2),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcSinh(x_),n_DEFAULT),Power(Plus(C1,Power(x_,C2)),m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcSinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),n_),Power(u_,CN1D2),x_),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcSinh(Times(Power(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_DEFAULT),CN1),c_DEFAULT)),m_DEFAULT),u_DEFAULT),x_Symbol),
    Condition(Int(Times(u,Power(ArcCsch(Plus(Times(a,Power(c,CN1)),Times(b,Power(x,n),Power(c,CN1)))),m)),x),FreeQ(List(a,b,c,n,m),x))),
SetDelayed(Int(ArcSinh(u_),x_Symbol),
...
SetDelayed(Int(Power(f_,Times(ArcSinh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),c_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(E,Times(ArcSinh(v_),n_DEFAULT)),x_Symbol),
    Condition(Int(Power(Plus(v,Sqrt(Plus(C1,Power(v,C2)))),n),x),And(IntIntegerQ(n),IntPolynomialQ(v,x)))),
SetDelayed(Int(Times(Power(E,Times(ArcSinh(v_),n_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(ArcCosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(ArcCosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CN1),x_Symbol),
    Condition(Times(SinhIntegral(ArcCosh(Plus(a,Times(b,x)))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Power(ArcCosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CN2),x_Symbol),
...
SetDelayed(Int(Power(ArcCosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),CN1D2),x_Symbol),
...
SetDelayed(Int(Power(ArcCosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),C1D2),x_Symbol),
...
SetDelayed(Int(Power(ArcCosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),n_),x_Symbol),
...
SetDelayed(Int(Times(ArcCosh(Times(Power(x_,n_DEFAULT),a_DEFAULT)),Power(x_,CN1)),x_Symbol),
...
SetDelayed(Int(Times(ArcCosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(Plus(Times(ArcCosh(Plus(Times($p(d,true),x_),c_DEFAULT)),b_DEFAULT),a_),CN1D2),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCosh(x_),n_DEFAULT),Power(Plus(CN1,x_),m_DEFAULT),Power(Plus(C1,x_),m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCosh(Times(Power(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_DEFAULT),CN1),c_DEFAULT)),m_DEFAULT),u_DEFAULT),x_Symbol),
    Condition(Int(Times(u,Power(ArcSech(Plus(Times(a,Power(c,CN1)),Times(b,Power(x,n),Power(c,CN1)))),m)),x),FreeQ(List(a,b,c,n,m),x))),
SetDelayed(Int(ArcCosh(u_),x_Symbol),
...
SetDelayed(Int(Power(f_,Times(ArcCosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),c_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Power(E,Times(ArcCosh(v_),n_DEFAULT)),x_Symbol),
    Condition(Int(Power(Plus(v,Times(Sqrt(Plus(CN1,v)),Sqrt(Plus(C1,v)))),n),x),And(IntIntegerQ(n),IntPolynomialQ(v,x)))),
SetDelayed(Int(Times(Power(E,Times(ArcCosh(v_),n_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(ArcTanh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(ArcTanh(Plus(Times(Power(x_,n_),b_DEFAULT),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(ArcTanh(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_DEFAULT)),Power(x_,CN1)),x_Symbol),
...
SetDelayed(Int(Times(ArcTanh(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcTanh(x_),n_DEFAULT),Power(Plus(C1,Times(CN1,Power(x_,C2))),m_)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcTanh(x_),n_DEFAULT),Power(Plus(CN1,Power(x_,C2)),m_)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCoth(x_),CN1),Power(ArcTanh(x_),CN1),Power(Plus(C1,Times(CN1,Power(x_,C2))),CN1)),x_Symbol),
    Times(Plus(Times(CN1,Log(ArcCoth(x))),Log(ArcTanh(x))),Power(Plus(ArcCoth(x),Times(CN1,ArcTanh(x))),CN1))),
SetDelayed(Int(Times(Power(ArcCoth(x_),n_DEFAULT),Power(ArcTanh(x_),p_DEFAULT),Power(Plus(C1,Times(CN1,Power(x_,C2))),CN1)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcTanh(Times(a_DEFAULT,x_)),n_),x_),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcTanh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),n_),x_),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcTanh(Times(Power(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_DEFAULT),CN1),c_DEFAULT)),m_DEFAULT),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(E,Times(ArcTanh(v_),n_DEFAULT)),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Power(E,Times(ArcTanh(v_),n_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(E,Times(ArcTanh(v_),n_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(E,Times(ArcTanh(v_),n_DEFAULT)),Power(Plus(C1,Times(CN1,Power(v_,C2))),m_DEFAULT),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(E,Times(ArcTanh(v_),n_DEFAULT)),Power(Plus(Times(Power(v_,C2),b_DEFAULT),a_),m_DEFAULT),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(E,Times(ArcTanh(v_),n_DEFAULT)),Power(Plus(C1,v_),m_DEFAULT),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(E,Times(ArcTanh(v_),n_DEFAULT)),Power(Plus(C1,Times(CN1,v_)),m_DEFAULT),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(E,Times(ArcTanh(v_),n_DEFAULT)),Power(Plus(Times(b_DEFAULT,v_),a_),m_DEFAULT),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(E,ArcTanh(v_)),Power(Plus(Times(Power(v_,CN2),b_DEFAULT),a_),m_DEFAULT),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(ArcTanh(u_),x_Symbol),
...
SetDelayed(Int(Times(ArcTanh(u_),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(ArcTanh(u_),v_),x_Symbol),
...
SetDelayed(Int(Times(ArcTanh(Times(b_DEFAULT,x_)),Power(Plus(Times(Power(x_,n_DEFAULT),$p(d,true)),c_),CN1)),x_Symbol),
...
SetDelayed(Int(Times(ArcTanh(Plus(Times(b_DEFAULT,x_),a_)),Power(Plus(Times(Power(x_,n_DEFAULT),$p(d,true)),c_),CN1)),x_Symbol),
...
SetDelayed(Int(ArcCoth(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(ArcCoth(Plus(Times(Power(x_,n_),b_DEFAULT),a_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(ArcCoth(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_DEFAULT)),Power(x_,CN1)),x_Symbol),
...
SetDelayed(Int(Times(ArcCoth(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCoth(x_),n_DEFAULT),Power(Plus(C1,Times(CN1,Power(x_,C2))),m_)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCoth(x_),n_DEFAULT),Power(Plus(CN1,Power(x_,C2)),m_)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCoth(x_),n_DEFAULT),Power(ArcTanh(x_),p_),Power(Plus(C1,Times(CN1,Power(x_,C2))),CN1)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCoth(x_),n_DEFAULT),Power(ArcTanh(x_),p_DEFAULT),Power(Plus(C1,Times(CN1,Power(x_,C2))),m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCoth(x_),n_DEFAULT),Power(ArcTanh(x_),p_DEFAULT),Power(Plus(CN1,Power(x_,C2)),m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCoth(Times(a_DEFAULT,x_)),n_),x_),x_Symbol),
...
SetDelayed(Int(Times(Power(ArcCoth(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),n_),x_),x_Symbol),
