...
/**
 * Monolithic sieve of Eratosthenes, working only for limits < Integer.MAX_VALUE = 2^31 - 1. Used
...
public class SimpleSieve {
  ...
  public void sieve(long limit0) {
    ...
    if (limit0 > Integer.MAX_VALUE)
      throw new IllegalArgumentException(
          "limit " + limit0 + " exceeds Integer.MAX_VALUE = " + Integer.MAX_VALUE);
