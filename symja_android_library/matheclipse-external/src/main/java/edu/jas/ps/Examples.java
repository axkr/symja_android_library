...
public class Examples {
  ...
  public static void example6() {
    ...
    integers =
        pfac.fixPoint(
            new UnivPowerSeriesMap<BigInteger>() {
  ...
  public static void example10() {
    ...
    UnivPowerSeries<BigInteger> integers = integersFrom(0);
    System.out.println("      integers = " + integers);
    UnivPowerSeries<BigInteger> ONE =
        new UnivPowerSeries<BigInteger>(
            pfac,
            new Coefficients<BigInteger>() {
    ...
    UnivPowerSeries<BigInteger> ZERO =
        new UnivPowerSeries<BigInteger>(
            pfac,
            new Coefficients<BigInteger>() {
  ...
  public static void example12() {
    ...
    UnivPowerSeries<BigComplex> exp =
        pfac.fixPoint(
            new UnivPowerSeriesMap<BigComplex>() {
    ...
    UnivPowerSeries<BigComplex> sin =
        pfac.fixPoint(
            new UnivPowerSeriesMap<BigComplex>() {
    ...
    UnivPowerSeries<BigComplex> cos =
        pfac.fixPoint(
            new UnivPowerSeriesMap<BigComplex>() {
  ...
  public static void example14() {
    ...
    GenPolynomialRing<UnivPowerSeries<BigRational>> fac =
        new GenPolynomialRing<UnivPowerSeries<BigRational>>(pfac, new String[] {"x"});
