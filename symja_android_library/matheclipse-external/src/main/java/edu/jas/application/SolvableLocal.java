...
public class SolvableLocal<C extends GcdRingElem<C>>
  ...
  /**
   * The constructor creates a SolvableLocal object from a ring factory and a numerator and
   ...
   */
  public SolvableLocal(
      SolvableLocalRing<C> r, GenSolvablePolynomial<C> n, GenSolvablePolynomial<C> d) {
    this(r, n, d, false);
  }
   ...
   */
  protected SolvableLocal(
      SolvableLocalRing<C> r,
