...
class IntRules69 {
  public static IAST RULES =
      List(
                  ...
                  With(
                      ...
                      Subtract(Dist(Times(C2, c, Power(q, CN1)),
                          Integrate(Times(Power(Times(d, x), m),
                              Power(Plus(b, Negate(q), Times(C2, c, Power(x, n))), CN1)), x),
                          x),
                          Dist(Times(C2, c, Power(q, CN1)),
                              Integrate(Times(Power(Times(d, x), m),
                                  Power(Plus(b, q, Times(C2, c, Power(x, n))), CN1)), x),
                              x))),
                      ...
                      Dist(Power(Times(a, n, Plus(p, C1), Subtract(Sqr(b), Times(C4, a, c))), CN1),
                          Integrate(Times(Power(Times(d, x), m),
                              Power(Plus(
                                  ...
                                  Plus(p, C1)),
                              Simp(
                                  Plus(Times(Sqr(b), Plus(Times(n, Plus(p, C1)), m, C1)),
                                      Times(CN1, C2, a, c, Plus(m, Times(C2, n, Plus(p, C1)), C1)),
                                      Times(b, c, Plus(Times(C2, n, p), Times(C3, n), m, C1),
                                          Power(x, n))),
                                  x)),
                              x),
                          x)),
                  ...
                  Integrate(Times(Power(Times(d, x), m),
                      Power(
                          Plus(C1,
                              Times(
                                  C2, c, Power(x, n),
                                  Power(Plus(b, Sqrt(Subtract(Sqr(b), Times(C4, a, c)))), CN1))),
                          p),
                      Power(
                          Plus(C1,
                              Times(C2, c, Power(x, n),
                          ...
                          p)),
                      x),
                  x), And(FreeQ(List(a, b, c, d, m, n, p), x), EqQ($s("n2"), Times(C2, n))))),
          IIntegrate(1386,
              Integrate(
                  Times(Power(x_, m_DEFAULT),
                      Power(
                  ...
                  Integrate(
                      Times(
                          ...
                          Power(Plus(b, Times(a, Power(x, n)), Times(c, Power(x, Times(C2, n)))),
                              p)),
                      x),
                  And(FreeQ(List(a, b, c, m, n), x), EqQ($s("mn"), Negate(n)), IntegerQ(p),
                      PosQ(n)))),
          IIntegrate(1387,
              Integrate(
                  Times(Power(x_, m_DEFAULT),
                      Power(Plus(
                          a_, Times(c_DEFAULT, Power(x_, n_DEFAULT)),
                          Times(b_DEFAULT, Power(x_, $p("mn")))), p_DEFAULT)),
                  x_Symbol),
              Condition(
                  Dist(
                      Times(
                          ...
                          Power(Power(
                              ...
                              FracPart(p)), CN1)),
                      Integrate(
                          Times(Power(x, Subtract(m, Times(n, p))), Power(
                              Plus(b, Times(a, Power(x, n)), Times(c, Power(x, Times(C2, n)))), p)),
                          x),
                      x),
                  And(FreeQ(List(a, b, c, m, n, p), x), EqQ($s("mn"), Negate(n)), Not(IntegerQ(p)),
                      PosQ(n)))),
          IIntegrate(1388,
              Integrate(
                  Times(Power(Times(d_, x_), m_DEFAULT),
                      Power(Plus(a_, Times(c_DEFAULT, Power(x_, n_DEFAULT)),
                          Times(b_DEFAULT, Power(x_, $p("mn")))), p_DEFAULT)),
                  x_Symbol),
              Condition(
                  Dist(
                      Times(
                          Power(d, IntPart(m)), Power(Times(d, x),
                              FracPart(m)),
                          Power(Power(x, FracPart(m)), CN1)),
                      Integrate(
                          Times(Power(x, m),
                          ...
                          x),
                      x),
                  And(FreeQ(List(a, b, c, d, m, n, p), x), EqQ($s("mn"), Negate(n))))),
          IIntegrate(1389,
              Integrate(
                  Times(
                      Power(
              ...
              Condition(
                  Dist(Power(Power(Coefficient(v, x, C1), Plus(m, C1)), CN1),
                      Subst(Integrate(
                          SimplifyIntegrand(
                              Times(Power(Subtract(x, Coefficient(v, x, C0)), m),
                                  Power(Plus(a, Times(b, Power(x, n)),
                                      Times(c, Power(x, Times(C2, n)))), p)),
                              x),
                          x), x, v),
                      x),
                  And(FreeQ(List(a, b, c, n, p), x), EqQ($s("n2"), Times(C2, n)), LinearQ(v, x),
                      IntegerQ(m), NeQ(v, x)))),
          IIntegrate(1390,
              Integrate(
          ...
          IIntegrate(1391,
              Integrate(
                  Times(Power(Plus(d_, Times(e_DEFAULT, Power(x_, n_DEFAULT))), q_DEFAULT),
                      Power(
              ...
              Condition(
                  Dist(
                      Times(
                          ...
                          Power(Power(Plus(d, Times(e, Power(x, n))), Times(C2, p)), CN1)),
                      Integrate(Power(Plus(d, Times(e, Power(x, n))), Plus(q, Times(C2, p))),
                          x),
                      x),
                  And(FreeQ(List(a, b, c, d, e, n, p, q), x), EqQ($s("n2"), Times(C2, n)),
                      EqQ(Subtract(Sqr(b), Times(C4, a, c)), C0), Not(IntegerQ(
                          p)),
          ...
          IIntegrate(1393,
              ...
              Condition(
                  Integrate(
                      Times(Power(x, Times(n, Plus(Times(C2, p), q))),
                          Power(Plus(e,
                              Times(d, Power(Power(x, n), CN1))), q),
                          Power(
                              Plus(
                                  c, Times(b, Power(Power(x, n), CN1)), Times(a,
          ...
          IIntegrate(1394,
              ...
              Condition(
                  Integrate(
                      Times(Power(x, Times(n, Plus(Times(C2, p), q))),
                          Power(Plus(e, Times(d, Power(Power(x, n), CN1))), q), Power(
                              Plus(c, Times(a, Power(Power(x, Times(C2, n)), CN1))), p)),
                      x),
                  And(FreeQ(List(a, c, d, e, n), x), EqQ($s("n2"), Times(C2, n)), IntegersQ(p, q),
                      NegQ(n)))),
          IIntegrate(1395,
              Integrate(
                  Times(
                      ...
                      Subst(
                          Integrate(
                              Times(Power(Plus(d, Times(e, Power(Power(x, n), CN1))), q),
                                  Power(
                                      Plus(a, Times(b, Power(Power(x, n), CN1)),
                                          Times(c, Power(Power(x, Times(C2, n)), CN1))),
                                      p),
                                  Power(x, CN2)),
                              x),
                          x, Power(x, CN1))),
                  ...
                  Negate(
                      Subst(
                          Integrate(
                              ...
                              x),
                          x, Power(x, CN1))),
                  And(FreeQ(List(a, c, d, e, p, q), x), EqQ($s("n2"), Times(C2, n)), ILtQ(n, C0)))),
          IIntegrate(1397,
              Integrate(
                  Times(
                      Power(
          ...
          IIntegrate(1398,
              ...
              Condition(
                  With(List(Set(g, Denominator(n))),
                      Dist(g,
                          Subst(Integrate(Times(Power(x, Subtract(g, C1)),
                              Power(Plus(d, Times(e, Power(x, Times(g, n)))), q), Power(
                                  Plus(a, Times(c, Power(x, Times(C2, g, n)))), p)),
                              x), x, Power(x, Power(g, CN1))),
                          x)),
          ...
          IIntegrate(1399,
              Integrate(
                  Times(
                      ...
                      Power(
                          Plus(
                              Times(b_DEFAULT, Power(x_, n_)), Times(c_DEFAULT,
                                  Power(x_, $p("n2")))),
                          p_)),
                  x_Symbol),
              Condition(
                      ...
                      Simp(
                          Times(
                              Subtract(Times(b,
                                  e), Times(d, c)),
                              Power(
                                  Plus(Times(b, Power(x, n)), Times(c,
                                      Power(x, Times(C2, n)))),
                                  Plus(p, C1)),
                              Power(
                                  Times(b, c, n, Plus(p, C1), Power(x, Times(C2, n, Plus(p, C1)))),
                                  CN1)),
                          x),
                      Dist(
                          Times(e, Power(c,
                          ...
                          Integrate(
                              Times(
                                  Power(
                                      Plus(Times(b, Power(x, n)), Times(c, Power(x, Times(C2, n)))),
                                      Plus(p, C1)),
                                  Power(Power(x, n), CN1)),
                              x),
                          x)),
                  And(FreeQ(List(b, c, d, e, n, p), x), EqQ($s("n2"), Times(C2, n)), Not(IntegerQ(
                      p)), EqQ(Plus(Times(n, Plus(Times(C2, p), C1)), C1),
                          C0)))),
          IIntegrate(1400,
              Integrate(
                  Times(
                  ...
                  x_Symbol),
              Condition(
                  Simp(Times(e, Power(x, Plus(Negate(n), C1)),
                      Power(Plus(Times(b, Power(x, n)), Times(c, Power(x, Times(C2, n)))),
                          Plus(p, C1)),
                      Power(Times(c, Plus(Times(n, Plus(Times(C2, p), C1)), C1)), CN1)), x),
                  And(FreeQ(List(b, c, d, e, n, p), x), EqQ($s("n2"), Times(C2, n)),
                      Not(IntegerQ(p)), NeQ(Plus(Times(n, Plus(Times(C2, p), C1)), C1), C0),
                      EqQ(Subtract(Times(b, e, Plus(Times(n, p), C1)),
                          Times(c, d, Plus(Times(n, Plus(Times(C2, p), C1)), C1))), C0)))));
}
