...
public interface ArcSechRules {
  final public static IAST RULES = List(
    ...
    ISet(ArcSech(CN1),
      Times(CI,Pi)),
    ISet(ArcSech(Times(C2,Power(C3,CN1D2))),
      Times(CC(0L,1L,1L,6L),Pi)),
    ISet(ArcSech(Times(CN2,Power(C3,CN1D2))),
      Times(CC(0L,1L,5L,6L),Pi)),
    ISet(ArcSech(Plus(CN1,Sqrt(C5))),
      Times(CC(0L,1L,1L,5L),Pi)),
    ISet(ArcSech(Plus(C1,Times(CN1,Sqrt(C5)))),
      Times(CC(0L,1L,4L,5L),Pi)),
    ISet(ArcSech(Sqrt(C2)),
      Times(CC(0L,1L,1L,4L),Pi)),
    ISet(ArcSech(Times(CN1,Sqrt(C2))),
      Times(CC(0L,1L,3L,4L),Pi)),
    ISet(ArcSech(C2),
      Times(CC(0L,1L,1L,3L),Pi)),
    ISet(ArcSech(CN2),
      Times(CC(0L,1L,2L,3L),Pi)),
    ISet(ArcSech(Plus(C1,Sqrt(C5))),
      Times(CC(0L,1L,2L,5L),Pi)),
    ISet(ArcSech(Plus(CN1,Times(CN1,Sqrt(C5)))),
      Times(CC(0L,1L,3L,5L),Pi)),
    ISet(ArcSech(CI),
      Plus(Log(Plus(C1,Sqrt(C2))),Times(CC(0L,1L,-1L,2L),Pi))),
    ISet(ArcSech(CNI),
      Plus(Log(Plus(C1,Sqrt(C2))),Times(CC(0L,1L,1L,2L),Pi))),
