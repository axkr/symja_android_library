...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"All", "AllowedHeads", "AllowShortContext",
      ...
      "LongForm", "Magenta", "Matrices", "MaxIterations", "MaxPoints", "Mesh", "Method", "Modulus",
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "BooleanTable", "BooleanVariables", "BoxWhiskerChart", "BrayCurtisDistance", "Break",
      ...
      "ComplexExpand", "ComplexPlot3D", "ComposeList", "ComposeSeries", "Composition",
      ...
      "ContourPlot", "Convergents", "ConvexHullMesh", "CoplanarPoints", "CoprimeQ", "Correlation",
      ...
      "Cross", "Csc", "Csch", "CubeRoot", "Cuboid", "Curl", "Cyclotomic", "CycleGraph", "Cycles",
      "Cylinder", "Dataset", "DateObject", "DateString", "DateValue", "Decrement", "Default",
      "DefaultButton", "Defer", "Definition", "Delete", "DeleteCases", "DeleteDuplicates",
      "DeleteDuplicatesBy", "Denominator", "DensityHistogram", "DensityPlot", "Depth", "Derivative",
      ...
      "FlattenAt", "FlatTopWindow", "Fibonacci", "File", "FileFormat", "FileNameJoin", "FilePrint",
