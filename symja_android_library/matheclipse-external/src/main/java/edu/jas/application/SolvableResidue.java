...
/**
 * SolvableResidue ring element based on GenSolvablePolynomial with GcdRingElem interface. Objects
...
public class SolvableResidue<C extends GcdRingElem<C>>
  ...
  /**
   * The constructor creates a SolvableResidue object from a ring factory, a polynomial and an
   * indicator if a is a unit.
   *
   * @param r solvable residue ring factory.
   * @param a solvable polynomial.
