...
SetDelayed(Int(Times(Power(Plus(C1,ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),CN1),Power(Times(CN1,ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),p_DEFAULT)),x_Symbol),
    Condition(Times(Gamma(Plus(p,C1),Times(CN1,ProductLog(Plus(a,Times(b,x))))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Power(Times(CN1,ProductLog(Plus(Times(b_DEFAULT,x_),a_DEFAULT))),p_),x_Symbol),
...
SetDelayed(Int($(Derivative(f_),x_),x_Symbol),
    Condition($(f,x),FreeQ(f,x))),
SetDelayed(Int($($(Derivative(n_),f_),x_),x_Symbol),
    Condition($($(Derivative(Plus(n,Times(CN1,C1))),f),x),FreeQ(List(f,n),x))),
SetDelayed(Int(Times(Plus(Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_)),Times($(Derivative(f_),x_),$(g_,x_))),Power($(g_,x_),CN2)),x_Symbol),
    Condition(Times($(f,x),Power($(g,x),CN1)),FreeQ(List(f,g),x))),
SetDelayed(Int(Times(Plus(Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_)),Times($(Derivative(f_),x_),$(g_,x_))),Power($(f_,x_),CN1),Power($(g_,x_),CN1)),x_Symbol),
    Condition(Log(Times($(f,x),Power($(g,x),CN1))),FreeQ(List(f,g),x))),
SetDelayed(Int(Times(Plus(Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_)),Times($(Derivative(f_),x_),$(g_,x_))),Power(Plus(Power($(f_,x_),C2),Power($(g_,x_),C2)),CN1)),x_Symbol),
    Condition(ArcTan(Times($(f,x),Power($(g,x),CN1))),FreeQ(List(f,g),x))),
SetDelayed(Int(Times(Plus(Times(CN1,$(Derivative(Times($(f_,x_),g_)),x_)),Times($(Derivative(f_),x_),$(g_,x_))),Power(Plus(Power($(f_,x_),C2),Times(CN1,Power($(g_,x_),C2))),CN1)),x_Symbol),
...
SetDelayed(Int(Times(u_,v_),x_Symbol),
    Module(List(Set(z,DerivativeDivides(v,u,x))),Condition(Dist(z,Subst(Int(x,x),x,v)),Not(FalseQ(z))))),
SetDelayed(Int(Times(Power($p("u1"),n_),Power($p("u2"),n_),v_),x_Symbol),
...
SetDelayed(Int(Times(Power(u_,n_DEFAULT),Power(x_,m_DEFAULT),v_),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(b_DEFAULT,x_),a_DEFAULT),m_DEFAULT),u_),x_Symbol),
...
SetDelayed(LinearSinCosQ(Power(u_,n_DEFAULT),x_Symbol),
...
SetDelayed(LinearSinhCoshQ(Power(u_,n_DEFAULT),x_Symbol),
    And(And(And(IntIntegerQ(n),Greater(n,C0)),Or(SinhQ(u),CoshQ(u))),LinearQ(Part(u,C1),x))),
SetDelayed(Int(Times(Sin(Times(Plus(Times(b_DEFAULT,x_),a_DEFAULT),c_DEFAULT)),u_),x_Symbol),
...
SetDelayed(Int(Times(Cos(Times(Plus(Times(b_DEFAULT,x_),a_DEFAULT),c_DEFAULT)),u_),x_Symbol),
...
SetDelayed(Int(Times(Power(Sec(Times(Plus(Times(b_DEFAULT,x_),a_DEFAULT),c_DEFAULT)),n_),u_),x_Symbol),
...
SetDelayed(Int(Times(Power(Csc(Times(Plus(Times(b_DEFAULT,x_),a_DEFAULT),c_DEFAULT)),n_),u_),x_Symbol),
...
SetDelayed(Int(Times(Csc(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Sec(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),u_),x_Symbol),
...
SetDelayed(Int(Times(Cos(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),u_),x_Symbol),
...
SetDelayed(Int(Times(Sinh(Times(Plus(Times(b_DEFAULT,x_),a_DEFAULT),c_DEFAULT)),u_),x_Symbol),
...
SetDelayed(Int(Times(Cosh(Times(Plus(Times(b_DEFAULT,x_),a_DEFAULT),c_DEFAULT)),u_),x_Symbol),
...
SetDelayed(Int(Times(Power(Sech(Times(Plus(Times(b_DEFAULT,x_),a_DEFAULT),c_DEFAULT)),n_),u_),x_Symbol),
...
SetDelayed(Int(Times(Power(Csch(Times(Plus(Times(b_DEFAULT,x_),a_DEFAULT),c_DEFAULT)),n_),u_),x_Symbol),
...
SetDelayed(Int(Times(Csch(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),Sech(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),u_),x_Symbol),
...
SetDelayed(Int(Times(Cosh(Plus(Times(b_DEFAULT,x_),a_DEFAULT)),u_),x_Symbol),
...
SetDelayed(Int(Times(Power(u_,Plus(CN1,Times(Power(x_,m_DEFAULT),a_DEFAULT))),Power(x_,m_DEFAULT),v_),x_Symbol),
...
SetDelayed(TryTanSubst(u_,x_Symbol),
...
SetDelayed(Int(Times(Power($(f_,Plus(Times(Power(x_,n_),b_DEFAULT),a_DEFAULT)),p_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(x_,n_),b_DEFAULT),a_),m_),u_),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(b_DEFAULT,x_),a_),m_DEFAULT),u_),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(Plus(Times($p(d,true),x_),c_),n_),b_DEFAULT),a_),CN1),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(Plus(Times($p(d,true),x_),c_),n_),b_DEFAULT),a_),p_),Power(Plus(Times(f_DEFAULT,x_),$p(e)),m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(b_DEFAULT,x_),a_DEFAULT),m_DEFAULT),Power($(f_,Plus(Times($p(d,true),x_),c_DEFAULT)),p_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(x_,C2),$p(e,true)),Times($p(d,true),x_),c_DEFAULT),n_),Power(Plus(Times(b_DEFAULT,x_),a_DEFAULT),m_)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Power(x_,p_DEFAULT),u_),n_),v_),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Power(x_,p_DEFAULT),u_),n_),Power(x_,m_DEFAULT),v_),x_Symbol),
...
SetDelayed(Int(Times(Log(u_),Power(x_,CN1)),x_Symbol),
...
SetDelayed(Int(Times(Log(u_),Power(Plus(Times(b_DEFAULT,x_),a_),CN1)),x_Symbol),
...
SetDelayed(Int(Times(Log(u_),Power(Plus(Times(b_DEFAULT,x_),a_DEFAULT),m_DEFAULT)),x_Symbol),
...
SetDelayed(Int(Times(Log(u_),v_),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(x_,C2),b_DEFAULT),a_),CN1),u_DEFAULT,x_),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(b_DEFAULT,v_),Times(c_DEFAULT,w_),a_),CN1),Power(v_,m_DEFAULT),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Plus(Times($p(e,true),v_),$p(d,true)),Power(Plus(Times(b_DEFAULT,v_),Times(c_DEFAULT,w_),a_),CN1)),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(b_DEFAULT,v_),Times(c_DEFAULT,w_),a_),CN1),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(Times(Power(t_,q_DEFAULT),Power(v_,m_DEFAULT),Power(w_,n_DEFAULT)),p_),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(x_,n_),b_DEFAULT),a_),CN1),Power(x_,m_DEFAULT),u_),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(x_,n_),b_DEFAULT),a_),CN1),u_),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(v_,n_),b_DEFAULT),a_),CN1),Power(v_,m_),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(v_,n_),b_DEFAULT),a_),CN1),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(Power(v_,n_),b_DEFAULT),a_),m_),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(Plus(Times(b_DEFAULT,v_),Times(c_DEFAULT,w_),a_),m_),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(Power(v_,m_),p_),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(Times(Power(v_,m_DEFAULT),a_),p_),u_DEFAULT),x_Symbol),
...
SetDelayed(Int(Times(Power(Times(Power(v_,m_DEFAULT),Power(w_,n_DEFAULT)),p_),u_DEFAULT),x_Symbol),
