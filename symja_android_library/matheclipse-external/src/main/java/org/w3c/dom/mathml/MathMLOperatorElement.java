...
public interface MathMLOperatorElement extends MathMLPresentationToken {
   ...
   *
   * @param fence new value for fence.
   * @see #getFence()
   */
   ...
   *
   * @param separator new value for separator.
   * @see #getSeparator()
   */
   ...
   *
   * @param lspace new value for lspace.
   * @see #getLspace()
   */
   ...
   *
   * @param rspace new value for rspace.
   * @see #getRspace()
   */
   ...
   *
   * @param stretchy new value for stretchy.
   * @see #getStretchy()
   */
   ...
   *
   * @param symmetric new value for symmetric.
   * @see #getSymmetric()
   */
   ...
   *
   * @param maxsize new value for maxsize.
   * @see #getMaxsize()
   */
   ...
   *
   * @param minsize new value for minsize.
   * @see #getMinsize()
   */
   ...
   *
   * @param largeop new value for largeop.
   * @see #getLargeop()
   */
   ...
   *
   * @param movablelimits new value for movablelimits.
