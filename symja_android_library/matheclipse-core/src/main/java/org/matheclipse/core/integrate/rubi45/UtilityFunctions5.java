...
ISetDelayed(SimplifyAntiderivative(ArcTan(Plus(a_DEFAULT,Times(b_DEFAULT,Plus($p(d,true),Times($p(e,true),Tan(u_)))),Times(c_DEFAULT,Sqr(Plus(f_DEFAULT,Times(g_DEFAULT,Tan(u_))))))),x_Symbol),
...
ISetDelayed(SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times($p("A",true),Log(Plus(a_,Times(b_DEFAULT,Power(Tan(u_),n_DEFAULT))))),Times($p("B",true),Log(Cos(u_)))),x_Symbol),
    Condition(Plus(SimplifyAntiderivativeSum(v,x),Times($s("A"),Log(RemoveContent(Plus(Times(a,Power(Cos(u),n)),Times(b,Power(Sin(u),n))),x)))),And(And(FreeQ(List(a,b,$s("A"),$s("B")),x),IntegerQ(n)),ZeroQ(Plus(Times(n,$s("A")),Times(CN1,$s("B"))))))),
ISetDelayed(SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times($p("A",true),Log(Plus(a_,Times(b_DEFAULT,Power(Cot(u_),n_DEFAULT))))),Times($p("B",true),Log(Sin(u_)))),x_Symbol),
    Condition(Plus(SimplifyAntiderivativeSum(v,x),Times($s("A"),Log(RemoveContent(Plus(Times(a,Power(Sin(u),n)),Times(b,Power(Cos(u),n))),x)))),And(And(FreeQ(List(a,b,$s("A"),$s("B")),x),IntegerQ(n)),ZeroQ(Plus(Times(n,$s("A")),Times(CN1,$s("B"))))))),
ISetDelayed(SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times($p("A",true),Log(Plus(a_,Times(b_DEFAULT,Power(Tan(u_),n_DEFAULT))))),Times($p("B",true),Log(Plus(c_,Times($p(d,true),Power(Tan(u_),n_DEFAULT)))))),x_Symbol),
    Condition(Plus(SimplifyAntiderivativeSum(v,x),Times($s("A"),Log(RemoveContent(Plus(Times(a,Power(Cos(u),n)),Times(b,Power(Sin(u),n))),x))),Times($s("B"),Log(RemoveContent(Plus(Times(c,Power(Cos(u),n)),Times(d,Power(Sin(u),n))),x)))),And(And(FreeQ(List(a,b,c,d,$s("A"),$s("B")),x),IntegerQ(n)),ZeroQ(Plus($s("A"),$s("B")))))),
ISetDelayed(SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times($p("A",true),Log(Plus(a_,Times(b_DEFAULT,Power(Cot(u_),n_DEFAULT))))),Times($p("B",true),Log(Plus(c_,Times($p(d,true),Power(Cot(u_),n_DEFAULT)))))),x_Symbol),
    Condition(Plus(SimplifyAntiderivativeSum(v,x),Times($s("A"),Log(RemoveContent(Plus(Times(b,Power(Cos(u),n)),Times(a,Power(Sin(u),n))),x))),Times($s("B"),Log(RemoveContent(Plus(Times(d,Power(Cos(u),n)),Times(c,Power(Sin(u),n))),x)))),And(And(FreeQ(List(a,b,c,d,$s("A"),$s("B")),x),IntegerQ(n)),ZeroQ(Plus($s("A"),$s("B")))))),
ISetDelayed(SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times($p("A",true),Log(Plus(a_,Times(b_DEFAULT,Power(Tan(u_),n_DEFAULT))))),Times($p("B",true),Log(Plus(c_,Times($p(d,true),Power(Tan(u_),n_DEFAULT))))),Times($p("C",true),Log(Plus($p(e),Times(f_DEFAULT,Power(Tan(u_),n_DEFAULT)))))),x_Symbol),
    Condition(Plus(SimplifyAntiderivativeSum(v,x),Times($s("A"),Log(RemoveContent(Plus(Times(a,Power(Cos(u),n)),Times(b,Power(Sin(u),n))),x))),Times($s("B"),Log(RemoveContent(Plus(Times(c,Power(Cos(u),n)),Times(d,Power(Sin(u),n))),x))),Times($s("C"),Log(RemoveContent(Plus(Times(e,Power(Cos(u),n)),Times(f,Power(Sin(u),n))),x)))),And(And(FreeQ(List(a,b,c,d,e,f,$s("A"),$s("B"),$s("C")),x),IntegerQ(n)),ZeroQ(Plus($s("A"),$s("B"),$s("C")))))),
ISetDelayed(SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times($p("A",true),Log(Plus(a_,Times(b_DEFAULT,Power(Cot(u_),n_DEFAULT))))),Times($p("B",true),Log(Plus(c_,Times($p(d,true),Power(Cot(u_),n_DEFAULT))))),Times($p("C",true),Log(Plus($p(e),Times(f_DEFAULT,Power(Cot(u_),n_DEFAULT)))))),x_Symbol),
    Condition(Plus(SimplifyAntiderivativeSum(v,x),Times($s("A"),Log(RemoveContent(Plus(Times(b,Power(Cos(u),n)),Times(a,Power(Sin(u),n))),x))),Times($s("B"),Log(RemoveContent(Plus(Times(d,Power(Cos(u),n)),Times(c,Power(Sin(u),n))),x))),Times($s("C"),Log(RemoveContent(Plus(Times(f,Power(Cos(u),n)),Times(e,Power(Sin(u),n))),x)))),And(And(FreeQ(List(a,b,c,d,e,f,$s("A"),$s("B"),$s("C")),x),IntegerQ(n)),ZeroQ(Plus($s("A"),$s("B"),$s("C")))))),
ISetDelayed(SimplifyAntiderivativeSum(u_,x_Symbol),
    u),
ISetDelayed(RectifyTangent(u_,a_,b_,x_Symbol),
    If(MatchQ(Together(a),Times($p(d,true),Complex(C0,c_))),Module(List(Set(c,Times(a,Power(CI,CN1))),e),If(NegativeQ(c),RectifyTangent(u,Times(CN1,a),Times(CN1,b),x),If(ZeroQ(Plus(c,Times(CN1,C1))),If(EvenQ(Denominator(NumericFactor(Together(u)))),Times(CI,b,C1D2,ArcTanh(Sin(Times(C2,u)))),Times(CI,b,C1D2,ArcTanh(Times(C2,Cos(u),Sin(u))))),CompoundExpression(CompoundExpression(Set(e,SmartDenominator(c)),Set(c,Times(c,e))),Plus(Times(CI,b,C1D2,Log(RemoveContent(Plus(Times(e,Cos(u)),Times(c,Sin(u))),x))),Times(CN1,CI,b,C1D2,Log(RemoveContent(Plus(Times(e,Cos(u)),Times(CN1,c,Sin(u))),x)))))))),If(NegativeQ(a),RectifyTangent(u,Times(CN1,a),Times(CN1,b),x),If(ZeroQ(Plus(a,Times(CN1,C1))),Times(b,SimplifyAntiderivative(u,x)),Module(List(c,$s("numr"),$s("denr")),If(EvenQ(Denominator(NumericFactor(Together(u)))),CompoundExpression(CompoundExpression(CompoundExpression(Set(c,Simplify(Times(Plus(C1,a),Power(Plus(C1,Times(CN1,a)),CN1)))),Set($s("numr"),SmartNumerator(c))),Set($s("denr"),SmartDenominator(c))),Plus(Times(b,SimplifyAntiderivative(u,x)),Times(CN1,b,ArcTan(NormalizeLeadTermSigns(Times($s("denr"),Sin(Times(C2,u)),Power(Plus($s("numr"),Times($s("denr"),Cos(Times(C2,u)))),CN1))))))),If(PositiveQ(Plus(a,Times(CN1,C1))),CompoundExpression(CompoundExpression(CompoundExpression(Set(c,Simplify(Power(Plus(a,Times(CN1,C1)),CN1))),Set($s("numr"),SmartNumerator(c))),Set($s("denr"),SmartDenominator(c))),Plus(Times(b,SimplifyAntiderivative(u,x)),Times(b,ArcTan(NormalizeLeadTermSigns(Times($s("denr"),Cos(u),Sin(u),Power(Plus($s("numr"),Times($s("denr"),Sqr(Sin(u)))),CN1))))))),CompoundExpression(CompoundExpression(CompoundExpression(Set(c,Simplify(Times(a,Power(Plus(C1,Times(CN1,a)),CN1)))),Set($s("numr"),SmartNumerator(c))),Set($s("denr"),SmartDenominator(c))),Plus(Times(b,SimplifyAntiderivative(u,x)),Times(CN1,b,ArcTan(NormalizeLeadTermSigns(Times($s("denr"),Cos(u),Sin(u),Power(Plus($s("numr"),Times($s("denr"),Sqr(Cos(u)))),CN1)))))))))))))),
ISetDelayed(RectifyTangent(u_,a_,b_,r_,x_Symbol),
    If(And(MatchQ(Together(a),Times($p(d,true),Complex(C0,c_))),MatchQ(Together(b),Times($p(d,true),Complex(C0,c_)))),Module(List(Set(c,Times(a,Power(CI,CN1))),Set(d,Times(b,Power(CI,CN1))),e),If(NegativeQ(d),RectifyTangent(u,Times(CN1,a),Times(CN1,b),Times(CN1,r),x),CompoundExpression(CompoundExpression(CompoundExpression(Set(e,SmartDenominator(Together(Plus(c,Times(d,x))))),Set(c,Times(c,e))),Set(d,Times(d,e))),If(EvenQ(Denominator(NumericFactor(Together(u)))),Plus(Times(CI,r,C1D4,Log(RemoveContent(Plus(Simplify(Plus(Sqr(Plus(c,e)),Sqr(d))),Times(Simplify(Plus(Sqr(Plus(c,e)),Times(CN1,Sqr(d)))),Cos(Times(C2,u))),Times(Simplify(Times(C2,Plus(c,e),d)),Sin(Times(C2,u)))),x))),Times(CN1,CI,r,C1D4,Log(RemoveContent(Plus(Simplify(Plus(Sqr(Plus(c,Times(CN1,e))),Sqr(d))),Times(Simplify(Plus(Sqr(Plus(c,Times(CN1,e))),Times(CN1,Sqr(d)))),Cos(Times(C2,u))),Times(Simplify(Times(C2,Plus(c,Times(CN1,e)),d)),Sin(Times(C2,u)))),x)))),Plus(Times(CI,r,C1D4,Log(RemoveContent(Plus(Simplify(Sqr(Plus(c,e))),Times(Simplify(Times(C2,Plus(c,e),d)),Cos(u),Sin(u)),Times(CN1,Simplify(Plus(Sqr(Plus(c,e)),Times(CN1,Sqr(d)))),Sqr(Sin(u)))),x))),Times(CN1,CI,r,C1D4,Log(RemoveContent(Plus(Simplify(Sqr(Plus(c,Times(CN1,e)))),Times(Simplify(Times(C2,Plus(c,Times(CN1,e)),d)),Cos(u),Sin(u)),Times(CN1,Simplify(Plus(Sqr(Plus(c,Times(CN1,e))),Times(CN1,Sqr(d)))),Sqr(Sin(u)))),x)))))))),If(NegativeQ(b),RectifyTangent(u,Times(CN1,a),Times(CN1,b),Times(CN1,r),x),If(EvenQ(Denominator(NumericFactor(Together(u)))),Plus(Times(r,SimplifyAntiderivative(u,x)),Times(r,ArcTan(Simplify(Times(Plus(Times(C2,a,b,Cos(Times(C2,u))),Times(CN1,Plus(C1,Sqr(a),Times(CN1,Sqr(b))),Sin(Times(C2,u)))),Power(Plus(Sqr(a),Sqr(Plus(C1,b)),Times(Plus(C1,Sqr(a),Times(CN1,Sqr(b))),Cos(Times(C2,u))),Times(C2,a,b,Sin(Times(C2,u)))),CN1)))))),Plus(Times(r,SimplifyAntiderivative(u,x)),Times(CN1,r,ArcTan(ActivateTrig(Simplify(Times(Plus(Times(a,b),Times(CN1,C2,a,b,Sqr($($s("§cos"),u))),Times(Plus(C1,Sqr(a),Times(CN1,Sqr(b))),$($s("§cos"),u),$($s("§sin"),u))),Power(Plus(Times(b,Plus(C1,b)),Times(Plus(C1,Sqr(a),Times(CN1,Sqr(b))),Sqr($($s("§cos"),u))),Times(C2,a,b,$($s("§cos"),u),$($s("§sin"),u))),CN1))))))))))),
...
ISetDelayed(SmartDenominator(Power(u_,n_)),
    Condition(SmartNumerator(Power(u,Times(CN1,n))),And(RationalQ(n),Less(n,C0)))),
...
ISetDelayed(TryPureTanSubst(u_,x_Symbol),
    Not(MatchQ(u,Condition($($p("F"),Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,$($p("G"),v_))))),And(And(And(FreeQ(List(a,b,c),x),MemberQ(List($s("ArcTan"),$s("ArcCot"),$s("ArcTanh"),$s("ArcCoth")),$s("F"))),MemberQ(List($s("Tan"),$s("Cot"),$s("Tanh"),$s("Coth")),$s("G"))),LinearQ(v,x)))))),
ISetDelayed(TryTanhSubst(u_,x_Symbol),
    And(And(And(And(And(And(FalseQ(FunctionOfLinear(u,x)),Not(MatchQ(u,Condition(Times(r_DEFAULT,Power(Plus(s_,t_),n_DEFAULT)),And(IntegerQ(n),Greater(n,C0)))))),Not(MatchQ(u,Log(v_)))),Not(MatchQ(u,Condition(Power(Plus(a_,Times(b_DEFAULT,Power($(f_,x),n_))),CN1),And(And(SinhCoshQ(f),IntegerQ(n)),Greater(n,C2)))))),Not(MatchQ(u,Condition(Times($(f_,Times(m_DEFAULT,x)),$(g_,Times(n_DEFAULT,x))),And(And(IntegersQ(m,n),SinhCoshQ(f)),SinhCoshQ(g)))))),Not(MatchQ(u,Condition(Times(r_DEFAULT,Power(Times(a_DEFAULT,Power(s_,m_)),p_)),And(FreeQ(List(a,m,p),x),Not(And(SameQ(m,C2),Or(SameQ(s,Sech(x)),SameQ(s,Csch(x)))))))))),SameQ(u,ExpandIntegrand(u,x)))),
