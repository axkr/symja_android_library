...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"All", "AllowedHeads", "AllowShortContext",
      ...
      "AxesStyle", "Background", "BarOrigin", "BetweennessCentrality", "Black", "Blue", "Booleans",
      "Bottom", "Boxed", "BoxRatios", "Brown", "Byte", "Center", "Character", "CharacterEncoding",
      "ColorFunction", "ComplexInfinity", "Catalan", "Complexes", "ComplexityFunction", "Constant",
      "Cyan", "Dashed", "DataRange", "DefaultValue", "Degree", "DegreeLexicographic",
      ...
      "EulerGamma", "Expression", "Extension", "False", "Filling", "FillingStyle", "Flat", "Float",
      "Full", "GaussianIntegers", "General", "GenerateConditions", "Glaisher", "GoldenAngle",
      "GoldenRatio", "Gray", "Green", "Heads", "HexidecimalCharacter", "HoldAll", "HoldComplete",
      "HoldAllComplete", "HoldFirst", "HoldRest", "IgnoreCase", "Indeterminate", "Inherited",
      "Infinity", "InsertionFunction", "Integer", "Integers", "InterpolationOrder", "Joined",
      "KeyAbsent", "Khinchin", "LabelingFunction", "LabelingSize", "Large", "Left",
      ...
      "MaxIterations", "MaxPoints", "Mesh", "Medium", "Method", "Modulus", "MonomialOrder",
      ...
      "Pink", "PlotLegends", "PlotRange", "PlotStyle", "PositiveIntegers", "PositiveRationals",
      "PositiveReals", "PrecisionGoal", "Primes", "Protected", "Purple", "Rationals",
      "ReadProtected", "Real", "Record", "RecordSeparators", "Red", "Reals", "Right", "SameTest",
      "ScalingFunctions", "Second", "SequenceHold", "SetSystemOptions", "Small", "SystemOptions",
      "Slot", "SlotAbsent", "SlotSequence", "StaticsVisible", "StartOfLine", "StartOfString",
      "Strict", "String", "Symbol", "TableAlignments", "TableDepth", "TableDirections",
      "TableHeadings", "TableSpacing", "TargetFunctions", "TestID", "Ticks", "Tiny", "TicksStyle",
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "ArcLength", "ArcSec", "ArcSech", "ArithmeticGeometricMean", "ArcSin", "ArcSinh", "ArcTan",
      "ArcTanh", "Arg", "ArgMax", "ArgMin", "Array", "ArrayDepth", "ArrayFlatten", "ArrayPad",
      "ArrayPlot", "ArrayReshape", "Arrays", "ArrayQ", "ArrayRules", "Arrow", "Arrowheads",
      "ASATriangle", "AssociateTo", "Association", "AssociationQ", "AssociationMap",
      ...
      "BesselY", "BesselYZero", "Beta", "BetaDistribution", "BetaRegularized", "BezierFunction",
      "BinaryDistance", "BinarySerialize", "BinaryDeserialize", "BinaryRead", "BinaryWrite",
      "BinCounts", "Binomial", "BinomialDistribution", "BinomialProcess", "BioSequence",
      "BioSequenceQ", "BioSequenceTranscribe", "BioSequenceTranslate", "BitLength",
      "BlackmanHarrisWindow", "BlackmanNuttallWindow", "BlackmanWindow", "Blank", "BlankSequence",
      "BlankNullSequence", "Block", "Boole", "BooleanQ", "BooleanConvert", "BooleanFunction",
      "BooleanMaxterms", "BooleanMinimize", "BooleanMinterms", "BooleanTable", "BooleanVariables",
      "BoxWhiskerChart", "BrayCurtisDistance", "Break", "BrownianBridgeProcess", "BSplineFunction",
      "Button", "ByteArray", "ByteArrayToString", "ByteArrayQ", "ByteCount", "CanberraDistance",
      "Cancel", "CancelButton", "CarmichaelLambda", "CarlsonRC", "CarlsonRD", "CarlsonRF",
      "CarlsonRG", "CarlsonRJ", "CartesianProduct", "Cases", "CatalanNumber", "Catch", "Catenate",
      ...
      "DiscreteDelta", "DiscretePlot", "DiscreteUniformDistribution", "DirectedEdge",
      ...
      "Dot", "DownValues", "Drop", "DuplicateFreeQ", "Dynamic", "DSolve", "Dt", "EasterSunday",
      "Echo", "EchoFunction", "EdgeCount", "EdgeForm", "EdgeList", "EdgeRules", "EdgeQ",
      ...
      "EllipticE", "EllipticF", "EllipticK", "EllipticPi", "EllipticTheta", "End", "EndPackage",
      ...
      "Expectation", "ExponentialDistribution", "ExpIntegralE", "ExpIntegralEi", "Exponent",
      "Export", "ExportString", "ExpToTrig", "ExtendedGCD", "Extract", "Factor", "Factorial",
      "FactorialPower", "Factorial2", "FactorInteger", "FactorSquareFree", "FactorSquareFreeList",
      "FactorTerms", "FactorTermsList", "Flatten", "FlattenAt", "FlatTopWindow", "Fibonacci",
      "File", "FileFormat", "FileHash", "FileNameJoin", "FilePrint", "FileNameTake", "FileNames",
      "FilterRules", "FindClusters", "FindCycle", "FindEulerianCycle", "FindEdgeCover", "FindFit",
      "FindGraphCommunities", "FindGraphIsomorphism", "FindIndependentEdgeSet",
      "FindIndependentVertexSet", "FindHamiltonianCycle", "FindInstance", "FindLinearRecurrence",
      ...
      "Fold", "FoldList", "For", "ForAll", "FormBox", "Fourier", "FourierMatrix", "FourierDCT",
      "FourierDCTMatrix", "FourierDST", "FourierDSTMatrix", "FRatioDistribution", "FractionBox",
      ...
      "FromLetterNumber", "FromPolarCoordinates", "FromSphericalCoordinates", "FullForm",
      ...
      "Hypergeometric2F1Regularized", "HypergeometricPFQRegularized", "Icosahedron", "Identity",
      "IdentityMatrix", "If", "Im", "Image", "ImageData", "ImageChannels", "ImageColorSpace",
      "ImageDimensions", "ImageQ", "ImageCrop", "ImageResize", "ImageRotate", "ImageScaled",
      "ImageSize", "ImageType", "ImplicitD", "Implies", "Import", "ImportString", "In", "Increment",
      "IndexGraph", "Inequality", "InexactNumberQ", "Infix", "Information", "Inner", "Input",
      ...
      "IntegerPart", "IntegerPartitions", "IntegerQ", "Integrate", "Interpolation",
      "InterpolatingFunction", "InterpolatingPolynomial", "InterquartileRange", "IntersectingQ",
      "Interrupt", "Intersection", "Interval", "IntervalComplement", "IntervalData",
      "IntervalIntersection", "IntervalMemberQ", "IntervalUnion", "Inverse", "InverseFourier",
      "InverseGudermannian", "InverseBetaRegularized", "InverseCDF", "InverseErf", "InverseErfc",
      "InverseFunction", "InverseGammaRegularized", "InverseHaversine", "InverseJacobiCD",
      ...
      "JaccardDissimilarity", "JacobiAmplitude", "JacobiMatrix", "JacobiSymbol", "JacobiCD",
      "JacobiCN", "JacobiDC", "JacobiEpsilon", "JacobiDN", "JacobiNC", "JacobiND", "JacobiP",
      ...
      "LambertW", "LeafCount", "LerchPhi", "LaguerreL", "LaplaceTransform", "LeastSquares",
      "LegendreP", "LegendreQ", "Length", "LengthWhile", "Less", "LessEqual", "LessEqualThan",
      ...
      "ListLogLogPlot", "ListLogPlot", "ListLogLinearPlot", "ListPlot", "ListStreamPlot",
      "ListVectorPlot", "ListPlot3D", "ListPointPlot3D", "ListPolarPlot", "ListQ", "Literal",
      "LoadJavaClass", "Log", "Log2", "Log10", "LogGamma", "LogNormalDistribution", "LogPlot",
      "LogLinearPlot", "LogLogPlot", "LogicalExpand", "LogisticSigmoid", "LogIntegral", "Longest",
      ...
      "Normal", "Normalize", "Norm", "NormalDistribution", "NormalMatrixQ", "Not", "NotElement",
      "NotListQ", "NRoots", "NSolve", "NullSpace", "NumberFieldRootsOfUnity", "NumberLinePlot",
      "NumberQ", "Numerator", "NumericalOrder", "NumericalSort", "NumericArray", "NumericArrayQ",
      ...
      "PatternTest", "PDF", "Perimeter", "PermutationCycles", "PermutationCyclesQ",
      "PermutationList", "PermutationListQ", "PermutationReplace", "Permutations", "Permute",
      "PetersenGraph", "Pick", "PieChart", "Piecewise", "PiecewiseExpand", "PlanarGraph",
      "PlanarGraphQ", "Plot", "Plot3D", "Plus", "PlusMinus", "Pochhammer", "PolarPlot", "Point",
      "PointLight", "PointSize", "PoissonDistribution", "PoissonProcess", "PolyGamma", "Polygon",
      ...
      "PolynomialRemainder", "Position", "Positive", "PossibleZeroQ", "Postfix", "Power",
      "PowerExpand", "PowerMod", "PrecedenceForm", "Precision", "PreDecrement", "Prefix",
      ...
      "Ramp", "RandomChoice", "RandomComplex", "RandomInteger", "RandomGraph", "RandomPermutation",
      ...
      "RealAbs", "RealDigits", "RealSign", "RealValuedNumericQ", "RealValuedNumberQ", "Reap",
      ...
      "ReplaceList", "ReplacePart", "ReplaceRepeated", "Rescale", "Rest", "Resultant", "Return",
      "Reverse", "RGBColor", "RiccatiSolve", "Riffle", "RightComposition",
      ...
      "RussellRaoDissimilarity", "SASTriangle", "SameObjectQ", "SameQ", "SatisfiabilityCount",
      "SatisfiabilityInstances", "SatisfiableQ", "SawtoothWave", "Scale", "Scaled",
      "ScalingTransform", "Scan", "SchurDecomposition", "Sec", "Sech", "SeedRandom", "Select",
      ...
      "SetAttributes", "SetDelayed", "Share", "ShearingTransform", "Short", "Shortest", "Show",
      ...
      "StarGraph", "StieltjesGamma", "StirlingS1", "StirlingS2", "StreamPlot", "StringCases",
      "StringCount", "StringContainsQ", "StringDrop", "StringExpression", "StringFormat",
      "StringFreeQ", "StringInsert", "StringJoin", "StringLength", "StringMatchQ", "StringPart",
      "StringPosition", "StringRepeat", "StringRiffle", "StringSplit", "StringTake",
      "StringTemplate", "StringToByteArray", "StringToStream", "StringTrim", "StringQ",
      "StringReplace", "StringReverse", "Structure", "StruveH", "StruveL", "StudentTDistribution",
      "Style", "StyleForm", "Subdivide", "Subfactorial", "Summary", "Subscript", "SubscriptBox",
      ...
      "ToRadicals", "ToSphericalCoordinates", "ToString", "Total", "ToIntervalData", "ToLowerCase",
      ...
      "VectorLessEqual", "VectorPlot", "VectorQ", "Verbatim", "VertexEccentricity", "VertexList",
      "VerificationTest", "VertexQ", "Volume", "WeaklyConnectedGraphQ", "WeberE",
