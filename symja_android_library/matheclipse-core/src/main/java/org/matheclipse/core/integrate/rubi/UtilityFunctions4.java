...
ISetDelayed(311,ExpandIntegrand(Times(Power(F_,Times(e_DEFAULT,Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),n_DEFAULT))),Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Plus(g_DEFAULT,Times(h_DEFAULT,x_)),-1)),x_Symbol),
...
ISetDelayed(321,ExpandIntegrand(Times(u_DEFAULT,Power(Plus(Times(a_DEFAULT,Power(x_,n_)),Times(b_DEFAULT,Sqrt(Plus(c_,Times(d_DEFAULT,Power(x_,j_)))))),-1)),x_Symbol),
...
ISetDelayed(322,ExpandIntegrand(Times(Power(Plus(a_,Times(b_DEFAULT,x_)),m_),Power(Plus(c_,Times(d_DEFAULT,x_)),-1)),x_Symbol),
...
ISetDelayed(323,ExpandIntegrand(Times(Plus(A_,Times(B_DEFAULT,x_)),Power(Plus(a_,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Plus(c_,Times(d_DEFAULT,x_)),-1)),x_Symbol),
...
ISetDelayed(328,ExpandIntegrand(Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1),x_Symbol),
...
ISetDelayed(329,ExpandIntegrand(Times(Plus(c_,Times(d_DEFAULT,Power(u_,n_))),Power(Plus(a_,Times(b_DEFAULT,Power(u_,$p("n2")))),-1)),x_Symbol),
...
ISetDelayed(331,ExpandIntegrand(Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1),x_Symbol),
...
ISetDelayed(332,ExpandIntegrand(Times(Plus(c_,Times(d_DEFAULT,Power(u_,m_DEFAULT))),Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1)),x_Symbol),
...
ISetDelayed(333,ExpandIntegrand(Times(Plus(c_DEFAULT,Times(d_DEFAULT,Power(u_,m_DEFAULT)),Times(e_DEFAULT,Power(u_,p_))),Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1)),x_Symbol),
...
ISetDelayed(334,ExpandIntegrand(Times(Plus(c_DEFAULT,Times(d_DEFAULT,Power(u_,m_DEFAULT)),Times(e_DEFAULT,Power(u_,p_)),Times(f_DEFAULT,Power(u_,q_))),Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1)),x_Symbol),
...
ISetDelayed(340,ExpandIntegrand(Times(Plus(c_,Times(d_DEFAULT,Power(u_,n_DEFAULT))),Power(Plus(a_,Times(b_DEFAULT,Power(u_,$p("n2",true)))),-1)),x_Symbol),
...
ISetDelayed(341,ExpandIntegrand(Times(Plus(d_DEFAULT,Times(e_DEFAULT,Plus(f_DEFAULT,Times(g_DEFAULT,Power(u_,n_DEFAULT))))),Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(u_,n_DEFAULT)),Times(c_DEFAULT,Power(u_,$p("n2",true)))),-1)),x_Symbol),
...
ISetDelayed(342,ExpandIntegrand(Times(u_,Power(v_,-1)),x_Symbol),
...
ISetDelayed(346,ExpandIntegrand(Times(Power(u_,m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power(u_,n_))),-1)),x_Symbol),
...
ISetDelayed(349,ExpandCleanup(Plus(u_,Times(v_,Power(Plus(a_,Times(b_DEFAULT,x_)),-1)),Times(w_,Power(Plus(c_,Times(d_DEFAULT,x_)),-1))),x_Symbol),
...
ISetDelayed(351,CollectReciprocals(Plus(u_,Times(e_,Power(Plus(a_,Times(b_DEFAULT,x_)),-1)),Times(f_,Power(Plus(c_,Times(d_DEFAULT,x_)),-1))),x_Symbol),
...
ISetDelayed(352,CollectReciprocals(Plus(u_,Times(e_,Power(Plus(a_,Times(b_DEFAULT,x_)),-1)),Times(f_,Power(Plus(c_,Times(d_DEFAULT,x_)),-1))),x_Symbol),
...
ISetDelayed(357,MakeAssocList(u_,x_Symbol,Colon($p("alst",$s("List")),List())),
...
ISetDelayed(358,GensymSubst(u_,x_Symbol,$p("alst",$s("List"))),
...
ISetDelayed(359,KernelSubst(u_,x_Symbol,$p("alst",$s("List"))),
...
ISetDelayed(376,Dist(u_,$(Defer($rubi("Integrate::Dist")),v_,w_,x_),x_),
    Dist(Times(u,v),w,x)),
