...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "ReverseUpEquilibrium", "RevolutionPlot3D", "RGBColor", "RiccatiSolve", "Riffle",
      ...
      "SetAttributes", "SetDelayed", "Share", "ShearingTransform", "Short", "ShortDownArrow",
      "Shortest", "ShortLeftArrow", "ShortRightArrow", "ShortUpArrow", "Show", "Sign", "Signature",
      ...
      "SmithDecomposition", "SokalSneathDissimilarity", "Solve", "Sort", "SortBy", "Sow", "Span",
      "SparseArray", "SparseArrayQ", "SpecialsFreeQ", "Specularity", "SpectrogramArray", "Sphere",
