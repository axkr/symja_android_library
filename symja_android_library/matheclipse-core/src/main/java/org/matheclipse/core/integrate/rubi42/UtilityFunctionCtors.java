...
public class UtilityFunctionCtors {
	...
	public static IAST MakeAssocList(final IExpr a0, final IExpr a1) {
		// TODO fix this
		return MakeAssocList(a0, a1, F.List());
	}
	  ...
	  public static IAST FunctionOfPowerQ(final IExpr a0, final IExpr a1, final IExpr a2, final IExpr a3) {
	    return quaternary($s(INTEGRATE_PREFIX+"FunctionOfPowerQ"), a0, a1, a2, a3);
	  }
	  ...
	  public static IAST SubstForPower(final IExpr a0, final IExpr a1, final IExpr a2, final IExpr a3) {
	    return quaternary($s(INTEGRATE_PREFIX+"SubstForPower"), a0, a1, a2, a3);
	  }
