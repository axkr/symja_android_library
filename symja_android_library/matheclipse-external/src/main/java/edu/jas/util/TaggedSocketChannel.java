...
/**
 * TaggedSocketChannel provides a communication channel with message tags for Java objects using
 * TCP/IP sockets.
 *
 * @author Heinz Kredel
 */
public class TaggedSocketChannel extends Thread {
   ...
   */
  public Object receive(Integer tag)
  ...
  public String toString() {
    ...
    // return "socketChannel(" + sc + ", tags = " + queues.keySet() + ", values = " +
    // queues.values() + ")";
  }
