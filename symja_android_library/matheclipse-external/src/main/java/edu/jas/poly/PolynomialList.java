...
/**
 * List of polynomials. Mainly for storage and printing / toString and conversions to other
 * representations.
 *
 * @author Heinz Kredel
 */
public class PolynomialList<C extends RingElem<C>>
   ...
   * to cast (List&lt;GenSolvablePolynomial&lt;C&gt;&gt;) list.
   *
  ...
  /**
   * Get list of list as List of List of GenSolvablePolynomials. Required because no List casts
   * allowed. Equivalent to cast (List&lt;GenSolvablePolynomial&lt;C&gt;&gt;) list.
   *
   * @param list list of extensions of polynomials.
   * @return solvable polynomial list from this.
   */
  ...
  /**
   * Get list of extensions of polynomials as List of GenPolynomials. Required because no List casts
   * allowed. Equivalent to cast (List&lt;GenPolynomial&lt;C&gt;&gt;) list. Mainly used for lists of
  ...
  /**
   * Get list of list of extensions of polynomials as List of List of GenPolynomials. Required
   * because no List casts allowed. Equivalent to cast (List&lt;GenPolynomial&lt;C&gt;&gt;) list.
