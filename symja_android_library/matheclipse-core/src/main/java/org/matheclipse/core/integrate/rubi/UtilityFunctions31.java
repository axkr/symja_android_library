...
ISetDelayed(570,FixInertTrigFunction(Times(Power($($s("§cot"),v_),m_DEFAULT),Power(Plus(Times($($s("§sin"),v_),a_DEFAULT),Times($($s("§cos"),v_),b_DEFAULT)),n_DEFAULT),u_DEFAULT),x_),
...
ISetDelayed(571,FixInertTrigFunction(Times(Power($($s("§sec"),v_),m_DEFAULT),Power(Plus(Times($($s("§sin"),v_),a_DEFAULT),Times($($s("§cos"),v_),b_DEFAULT)),n_DEFAULT),u_DEFAULT),x_),
