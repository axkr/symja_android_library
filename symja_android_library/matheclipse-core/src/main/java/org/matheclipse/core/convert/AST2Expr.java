...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "ArrayFlatten", "ArrayPad", "ArrayPlot", "ArrayReshape", "Arrays", "ArrayQ", "ArrayRules",
      "Arrow", "Arrowheads", "ASATriangle", "AssociateTo", "Association", "AssociationQ",
      ...
      "Cross", "Csc", "Csch", "Cube", "CubeRoot", "Cuboid", "Curl", "Cyclotomic", "CycleGraph",
      "Cycles", "Cylinder", "Dataset", "DateObject", "Dashing", "DateString", "DateValue",
      ...
      "DiracDelta", "DirectionalLight", "DirichletBeta", "DirichletEta", "DiscreteDelta",
      ...
      "FileNameDrop", "FileNameJoin", "FilePrint", "FileNameTake", "FileNames", "FilterRules",
      "FindClusters", "FindCycle", "FindEulerianCycle", "FindEdgeCover", "FindFit", "FindFormula",
      ...
      "Floor", "Fold", "FoldList", "For", "ForAll", "FormBox", "Fourier", "FourierCosTransform",
      ...
      "KPartitions", "KroneckerDelta", "KroneckerProduct", "KroneckerSymbol", "Kurtosis", "Last",
      "LCM", "Labeled", "LambertW", "LeafCount", "LerchPhi", "LaguerreL", "LaplaceTransform",
      "Laplacian", "LeastSquares", "LegendreP", "LegendreQ", "Length", "LengthWhile", "Less",
      ...
      "ListLogLinearPlot", "ListPlot", "ListStepPlot", "ListStreamPlot", "ListVectorPlot",
      "ListPlot3D", "ListPointPlot3D", "ListPolarPlot", "ListQ", "Literal", "LLMFunction",
      ...
      "Manipulate", "MantissaExponent", "Map", "MapApply", "MapAt", "MapAll", "MapIndexed",
      "MapThread", "MatchingDissimilarity", "MatchQ", "MathMLForm", "MatrixD", "MatrixExp",
      "MatrixLog", "MatrixForm", "MatrixFunction", "MatrixMinimalPolynomial", "MatrixPlot",
      "MatrixPower", "MatrixQ", "MatrixRank", "Max", "MaxFilter", "Maximize", "MaxMemoryUsed",
      "Mean", "MeanFilter", "MeanDeviation", "Median", "MedianFilter", "MeijerG", "MemberQ",
      ...
      "NArgMax", "NArgMin", "ND", "NDSolve", "NExpectation", "Nearest", "NearestTo", "Needs",
      ...
      "RealSign", "RealValuedNumericQ", "RealValuedNumberQ", "Reap", "Rectangle", "Reduce",
      ...
      "Reverse", "ReverseSort", "RGBColor", "RiccatiSolve", "Riffle", "RightComposition",
