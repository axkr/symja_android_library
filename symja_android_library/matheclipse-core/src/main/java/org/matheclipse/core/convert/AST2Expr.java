...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "RealAbs", "RealDigits", "RealSign", "RealValuedNumberQ", "Reap", "Rectangle", "Reduce",
      ...
      "RGBColor", "RiccatiSolve", "Riffle", "RightComposition", "RogersTanimotoDissimilarity",
      "RomanNumeral", "RootIntervals", "Root", "RootOf", "RootReduce", "Roots", "RotateLeft",
      "RotateRight", "RotationMatrix", "RotationTransform", "Round", "Row", "RowBox", "RowReduce",
      "RSolve", "RSolveValue", "Rule", "RuleDelayed", "RussellRaoDissimilarity", "SASTriangle",
      "SameObjectQ", "SameQ", "SatisfiabilityCount", "SatisfiabilityInstances", "SatisfiableQ",
      "SawtoothWave", "Scale", "Scaled", "ScalingTransform", "Scan", "SchurDecomposition", "Sec",
