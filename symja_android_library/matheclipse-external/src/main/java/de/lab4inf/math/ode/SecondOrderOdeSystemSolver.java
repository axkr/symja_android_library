...
public interface SecondOrderOdeSystemSolver extends OdeSolver {
  /**
   * Calculate the vector y1 at point x1, given x0, vector y0 and the derivative vector dy0 with eps
   * precision for the given of second order differential equations.
   *
   * <pre>
