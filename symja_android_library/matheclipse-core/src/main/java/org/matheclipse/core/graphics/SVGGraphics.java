...
public class SVGGraphics {
  ...
  // "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"%.0f\" height=\"%.0f\" viewBox=\"0 0 %.0f
  // %.0f\">\n",
  ...
  // ContainerTag<?> ellipse = tag("ellipse").attr("cx", fmt(mapX(c[0]))).attr("cy",
  // fmt(mapY(c[1])))
  ...
  // drawPolygonPoints(state, parent, new double[] {0, 0}, new double[] {a, 0}, new double[] {x,
  // y});
  // }
  //
  ...
  // double y = x * tanA;
  // drawPolygonPoints(state, parent, new double[] {0, 0}, new double[] {c, 0}, new double[] {x,
  // y});
  // }
  //
  ...
  // "stroke:%s; stroke-width:%.2fpx; stroke-opacity:%.2f; stroke-dasharray:%s; stroke-linecap:%s;
  // stroke-linejoin:%s;",
  ...
  // // Alpha is handled via fill-opacity / stroke-opacity attributes using
  // state.opacity/edgeOpacity
