...
public class S {
    ...
    /** StringCases(str, {"p1", "p2",...}) - return a list of matches for `"p1", "p2",...` list of strings in the string `str`.*/
    ...
    /** StringMatchQ(str, RegularExpression(pattern-string)) - check if the regular expression `pattern-string` matches the string `str`.*/
