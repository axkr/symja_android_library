...
public class SphericalHarmonicYRules {
  ...
  final public static IAST RULES = List(IInit(SphericalHarmonicY, SIZES),
      ...
      ISetDelayed(SphericalHarmonicY(C0, C0, t_, p_), Power(Times(C2, CSqrtPi), CN1)),
