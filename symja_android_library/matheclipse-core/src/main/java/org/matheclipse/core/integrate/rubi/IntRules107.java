          ...
          IIntegrate(2156,
              ...
              Condition(
                  Subtract(
                      Dist(c,
                          Integrate(Times(u,
                              Power(Plus(Sqr(c), Times(CN1, a, Sqr(e)), Times(c, d, Power(x, n))),
                                  CN1)),
                              x),
                          x),
          ...
          IIntegrate(
              ...
              Condition(
                  With(
                      list(Set(c,
                          Simplify(D(u, x)))),
                      Dist(Power(c, CN1), Subst(Integrate(Power(x, m), x), x, u), x)),
                  And(FreeQ(m, x), PiecewiseLinearQ(u, x), NeQ(Power(u, m), x)))),
          IIntegrate(
