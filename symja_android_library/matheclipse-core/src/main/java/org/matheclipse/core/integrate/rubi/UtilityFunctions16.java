...
ISetDelayed(260,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT))),CN1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cot(v),n))),CN1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(261,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT))),CN1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Tan(v),n))),CN1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(262,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT))),CN1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cos(v),n))),CN1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(263,TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT))),CN1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Sin(v),n))),CN1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(264,TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT))),CN1),Power($($s("§tan"),v_),n_DEFAULT))),
