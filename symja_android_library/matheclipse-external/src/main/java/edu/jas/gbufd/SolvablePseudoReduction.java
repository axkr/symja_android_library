...
/**
 * Polynomial pseudo reduction interface. Defines additionally normalformFactor and
 * normalformRecursive.
 *
...
public interface SolvablePseudoReduction<C extends RingElem<C>> extends SolvableReduction<C> {
  ...
  public GenSolvablePolynomial<GenPolynomial<C>> leftNormalformRecursive(
      List<GenSolvablePolynomial<GenPolynomial<C>>> Pp, GenSolvablePolynomial<GenPolynomial<C>> Ap);
