...
ISetDelayed(368,ExpandTrigReduce(Times(Power($(F_,Plus(n_,v_DEFAULT)),m_DEFAULT),u_DEFAULT),x_Symbol),
...
ISetDelayed(371,NormalizeTrigReduce(Times(Power($(F_,u_),n_DEFAULT),a_DEFAULT),x_Symbol),
