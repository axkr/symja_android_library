...
/**
 * Groebner bases algorithms factory. Select appropriate Groebner bases engine based on the
 * coefficient types.
 *
 * <p><b>Usage:</b> To create objects that implement the <code>GroebnerBase</code> interface use the
 * <code>GBFactory</code>. It will select an appropriate implementation based on the types of
 * polynomial coefficients C. The method to obtain an implementation is <code>getImplementation()
 * </code>. <code>getImplementation()</code> returns an object of a class which implements the
 * <code>GroebnerBase</code> interface, more precisely an object of abstract class <code>
 * GroebnerBaseAbstract</code>.
 *
 * <pre>
...
public class GBFactory {
  ...
  /**
   * Algorithm indicators: igb = integerGB, egb = e-GB, dgb = d-GB, qgb = fraction coefficients GB,
   * ffgb = fraction free GB.
   */
   ...
   * @return GB algorithm implementation.
   */
  public static GroebnerBaseAbstract<ModLong> getImplementation(
   ...
   * @return GB algorithm implementation.
   */
  public static GroebnerBaseAbstract<ModInt> getImplementation(
      ModIntRing fac, PairList<ModInt> pl) {
   ...
   * @return GB algorithm implementation.
   */
  public static GroebnerBaseAbstract<ModInteger> getImplementation(
   ...
   * @return GB algorithm implementation.
   */
  public static GroebnerBaseAbstract<BigInteger> getImplementation(
   ...
   */
  public static GroebnerBaseAbstract<BigInteger> getImplementation(
      BigInteger fac, Algo a, PairList<BigInteger> pl) {
   ...
   * @return GB algorithm implementation.
   */
  public static GroebnerBaseAbstract<BigRational> getImplementation(
   ...
   */
  public static GroebnerBaseAbstract<BigRational> getImplementation(
      BigRational fac, Algo a, PairList<BigRational> pl) {
    ...
    switch (a) {
      ...
      case egb:
        if (fac.nvar > 1 || !fac.coFac.isField()) {
          throw new IllegalArgumentException(
              "coefficients not univariate or not over a field" + fac);
        }
  ...
  public static <C extends GcdRingElem<C>> // interface RingElem not sufficient
    ...
    if (ofac instanceof GenPolynomialRing) {
      ...
      GroebnerBaseAbstract<GenPolynomial<C>> bbr =
          new GroebnerBasePseudoRecSeq<C>(rofac, pli); // not pl
