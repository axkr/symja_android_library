...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$GeoLocation", "$TimeZone", "$UnitSystem",
      ...
      "AroundReplace", "Array", "ArrayDepth", "ArrayDot", "ArrayFlatten", "ArrayMesh", "ArrayPad",
      ...
      "AsymptoticRSolveValue", "Atom", "AtomCount", "AtomDiagramCoordinates", "AtomList", "AtomQ",
      "Attributes", "AutoAction", "AutorunSequencing", "AxisObject", "Backslash",
      ...
      "ChiSquareDistribution", "CholeskyDecomposition", "Chop",
      ...
      "DifferentialD", "DigitBlock", "DigitCount", "DigitQ", "DigitSum", "Dilation",
      ...
      "Div", "Divide", "DivideBy", "Divides", "DivideSides", "Divisible", "Divisors",
      ...
      "GeometricDistribution", "GeometricMean", "GeometricTransformation", "GeoPosition",
      "GeoProjection", "GeoRange", "Get", "GlobalClusteringCoefficient", "Glow", "GoldbachList",
      ...
      "GraphHighlightStyle", "Graphics", "GraphicsGrid", "Graphics3D", "Graphics3DJSON",
      ...
      "GraphUnion", "GrayLevel", "Greater", "GreaterEqual", "GreaterEqualLess", "GreaterEqualThan",
      "GreaterFullEqual", "GreaterGreater", "GreaterLess", "GreaterSlantEqual", "GreaterThan",
      "GreaterTilde", "Grid", "GridGraph", "GroebnerBasis", "GroupBy", "Groupings", "GroupOrbits",
      ...
      "IsomorphicGraphQ", "IsotopeData", "Italic", "Item", "ItemDisplayFunction", "ItemSize",
      "ItemStyle", "JaccardDissimilarity", "JacobiAmplitude", "JacobiCD", "JacobiCN", "JacobiDC",
      "JacobiDN", "JacobiEpsilon", "JacobiMatrix", "JacobiNC", "JacobiND", "JacobiP", "JacobiSC",
      "JacobiSD", "JacobiSN", "JacobiSymbol", "JacobiZeta", "JavaClass", "JavaForm", "JavaNew",
      "JavaObject", "JavaObjectQ", "JavaShow", "Join", "JoinAcross", "JoinedCurve", "JoinForm",
      ...
      "NormalsFunction", "Not", "NotCongruent", "NotCupCap", "NotDoubleVerticalBar", "Notebook",
      ...
      "NumberSigns", "Numerator", "NumericalOrder", "NumericalSort", "NumericArray",
      "NumericArrayQ", "NumericArrayType", "NumericQ", "NuttallWindow", "Octahedron", "OddQ", "Off",
      "Offset", "On", "Opacity", "OpenAppend", "Opener", "Opening", "OpenRead", "OpenWrite",
      "Operate", "OptimizeExpression", "Optional", "Options", "OptionsPattern", "OptionValue", "Or",
      "OrbitalElements", "Order", "OrderedQ", "Ordering", "Orthogonalize", "OrthogonalMatrixQ",
      ...
      "RegionNearestFunction", "RegionPlot", "RegionQ", "RegionSymmetricDifference", "RegionUnion",
      ...
      "Residue", "Resolve", "ResourceData", "Rest", "Resultant", "Return", "Reverse",
