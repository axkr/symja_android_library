...
/**
 * RecSolvableWordPolynomialRing generic recursive solvable polynomial factory implementing
 * RingFactory and extending GenSolvablePolynomialRing factory. Factory for n-variate ordered
 * solvable polynomials over non-commutative word polynomial coefficients. The non-commutative
...
public class RecSolvableWordPolynomialRing<C extends RingElem<C>>
  ...
  public RecSolvableWordPolynomialRing(
      RingFactory<GenWordPolynomial<C>> cf, int n, RelationTable<GenWordPolynomial<C>> rt) {
   ...
   */
  public RecSolvableWordPolynomialRing(
      RingFactory<GenWordPolynomial<C>> cf,
      int n,
      TermOrder t,
   ...
   */
  public RecSolvableWordPolynomialRing(
      RingFactory<GenWordPolynomial<C>> cf, int n, TermOrder t, String[] v) {
    this(cf, n, t, v, null);
  }
   ...
   */
  public RecSolvableWordPolynomialRing(
      RingFactory<GenWordPolynomial<C>> cf, TermOrder t, String[] v) {
   ...
   */
  public RecSolvableWordPolynomialRing(
      RingFactory<GenWordPolynomial<C>> cf, RecSolvableWordPolynomialRing o) {
  ...
  public RecSolvableWordPolynomialRing<C> extend(int i) {
    ...
    RecSolvableWordPolynomialRing<C> spfac =
        new RecSolvableWordPolynomialRing<C>(
            pfac.coFac, pfac.nvar, pfac.tord, pfac.vars, pfac.table);
  ...
  public RecSolvableWordPolynomialRing<C> contract(int i) {
    ...
    RecSolvableWordPolynomialRing<C> spfac =
        new RecSolvableWordPolynomialRing<C>(pfac.coFac, pfac.nvar, pfac.tord, pfac.vars);
  ...
  public GenSolvablePolynomialRing<GenWordPolynomial<C>> permutation(List<Integer> P) {
    ...
    GenSolvablePolynomialRing<GenWordPolynomial<C>> pfac =
        (GenSolvablePolynomialRing<GenWordPolynomial<C>>) super.permutation(P);
    return pfac;
  }
}
