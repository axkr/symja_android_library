...
ISetDelayed(Int(Times(Cos(Times(b_DEFAULT,Power(x_,n_))),Power(x_,-1)),x_Symbol),
...
ISetDelayed(Int(Times(Cos(Plus(a_,Times(b_DEFAULT,Power(x_,n_)))),Power(x_,-1)),x_Symbol),
