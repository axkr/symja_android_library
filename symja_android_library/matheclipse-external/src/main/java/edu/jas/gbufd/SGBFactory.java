...
/**
 * Solvable Groebner bases algorithms factory. Select appropriate Solvable Groebner bases engine
 * based on the coefficient types.
 *
 * <p><b>Usage:</b> To create objects that implement the <code>SolvableGroebnerBase</code> interface
 * use the <code>SGBFactory</code>. It will select an appropriate implementation based on the types
 * of polynomial coefficients C. The method to obtain an implementation is <code>getImplementation()
 * </code>. It returns an object of a class which implements the <code>SolvableGroebnerBase</code>
 * interface, more precisely an object of abstract class <code>SolvableGroebnerBaseAbstract</code>.
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>For example, if the coefficient type is BigInteger, the usage looks like
 *
 * <pre>
...
public class SGBFactory {
   ...
   * @return GB algorithm implementation.
   */
  public static SolvableGroebnerBaseAbstract<ModLong> getImplementation(
      ModLongRing fac, PairList<ModLong> pl) {
   ...
   * @return GB algorithm implementation.
   */
  public static SolvableGroebnerBaseAbstract<ModInteger> getImplementation(
      ModIntegerRing fac, PairList<ModInteger> pl) {
   ...
   * @return GB algorithm implementation.
   */
  public static SolvableGroebnerBaseAbstract<BigInteger> getImplementation(
      BigInteger fac, GBFactory.Algo a) {
   ...
   */
  public static SolvableGroebnerBaseAbstract<BigInteger> getImplementation(
      BigInteger fac, PairList<BigInteger> pl) {
   ...
   */
  public static SolvableGroebnerBaseAbstract<BigInteger> getImplementation(
      BigInteger fac, GBFactory.Algo a, PairList<BigInteger> pl) {
   ...
   * @return GB algorithm implementation.
   */
  public static SolvableGroebnerBaseAbstract<BigRational> getImplementation(
      BigRational fac, GBFactory.Algo a) {
   ...
   */
  public static SolvableGroebnerBaseAbstract<BigRational> getImplementation(
      BigRational fac, PairList<BigRational> pl) {
   ...
   */
  public static SolvableGroebnerBaseAbstract<BigRational> getImplementation(
      BigRational fac, GBFactory.Algo a, PairList<BigRational> pl) {
    ...
    switch (a) {
      ...
      case ffgb:
        throw new UnsupportedOperationException(
            "ffgb algorithm not available for BigRational " + a);
  ...
  public static <C extends GcdRingElem<C>>
    ...
    switch (a) {
      ...
      case egb:
        ...
        //    throw new IllegalArgumentException("coefficients not univariate or not over a field" +
        // fac);
        // }
  ...
  public static <C extends GcdRingElem<C>> // interface RingElem not sufficient
    ...
    if (ofac instanceof GenPolynomialRing) {
      ...
      SolvableGroebnerBaseAbstract<GenPolynomial<C>> bbr =
          new SolvableGroebnerBasePseudoRecSeq<C>(rofac, pli); // not pl
  ...
  public static <C extends GcdRingElem<C>> // interface RingElem not sufficient
    ...
    if (fac.isField()) {
      ...
      if (fac instanceof GenPolynomialRing) {
        ...
        return e1;
        // SolvableGroebnerBaseAbstract e2 = new SolvableGroebnerBasePseudoRecParallel<C>(th, pfac,
        // ppl);
        // return new SGBProxy<C>(e1, e2);
      }
      ...
      logger.warn("no parallel version available, returning sequential version");
      return e1;
      // SolvableGroebnerBaseAbstract<C> e2 = new SolvableGroebnerBasePseudoParallel<C>(th, fac,
      // pl);
      // return new SGBProxy<C>(e1, e2);
    }
  ...
  public static <C extends GcdRingElem<C>> // interface RingElem not sufficient
    ...
    SolvableGroebnerBaseAbstract<GenPolynomial<C>> e1 =
        new SolvableGroebnerBasePseudoRecSeq<C>(fac, ppl);
    logger.warn("no parallel version available, returning sequential version");
    return e1;
    // SolvableGroebnerBaseAbstract<GenPolynomial<C>> e2 = new
    // SolvableGroebnerBasePseudoRecParallel<C>(th, fac, ppl);
