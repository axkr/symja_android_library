...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abs", "AddTo", "And", "AlgebraicNumber", "Alternatives", "Apart",
			...
			"Level", "Limit", "Line", "LinearModelFit", "LinearProgramming", "LinearSolve", "List", "ListQ", "Log",
			"Log2", "Log10", "LogGamma", "LogicalExpand", "LogisticSigmoid", "LogIntegral", "LowerCaseQ",
			"LUDecomposition", "ManhattanDistance", "Map", "MapAt", "MapAll", "MapThread", "MatchQ", "MathMLForm",
			...
			"Not", "NRoots", "NSolve", "NullSpace", "NumberFieldRootsOfUnity", "NumberQ", "Numerator", "NumericQ",
			"OddQ", "Options", "Or", "Order", "OrderedQ", "Out", "Outer", "Package", "PadLeft", "PadRight",
			"ParametricPlot", "Part", "Partition", "Pattern", "PatternTest", "Permutations", "Piecewise", "Plot",
			"PlotRange", "Plot3D", "Plus", "Pochhammer", "PolyGamma", "Polygon", "PolyLog", "PolynomialExtendedGCD",
			...
			"RotateRight", "Round", "RowReduce", "Rule", "RuleDelayed", "SameQ", "SatisfiableQ", "Scan", "Sec", "Sech",
			...
			"Skewness", "Solve", "Sort", "Sow", "Span", "Sqrt", "SquaredEuclidianDistance", "SquareFreeQ", "StirlingS2",
