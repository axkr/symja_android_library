...
/**
 * RecSolvableWordPolynomial generic recursive solvable polynomials implementing RingElem. n-variate
 * ordered solvable polynomials over non-commutative word polynomial coefficients. Objects of this
 * class are intended to be immutable. The implementation is based on TreeMap respectively SortedMap
...
public class RecSolvableWordPolynomial<C extends RingElem<C>>
   ...
   * @param e exponent.
   */
  public RecSolvableWordPolynomial(
      RecSolvableWordPolynomialRing<C> r, GenWordPolynomial<C> c, ExpVector e) {
    this(r);
    if (c != null && !c.isZERO()) {
      val.put(e, c);
    }
   ...
   */
  public RecSolvableWordPolynomial(
      RecSolvableWordPolynomialRing<C> r, GenSolvablePolynomial<GenWordPolynomial<C>> S) {
    this(r, S.val);
  }
   ...
   */
  protected RecSolvableWordPolynomial(
      RecSolvableWordPolynomialRing<C> r, SortedMap<ExpVector, GenWordPolynomial<C>> v) {
    this(r);
  ...
  public RecSolvableWordPolynomial<C> multiply(RecSolvableWordPolynomial<C> Bp) {
    ...
    if (debug) logger.info("input A = " + this);
    for (Map.Entry<ExpVector, GenWordPolynomial<C>> y : A.entrySet()) {
      ...
      if (debug) logger.info("input B = " + Bp);
      for (Map.Entry<ExpVector, GenWordPolynomial<C>> x : Bk) {
        ...
        if (commuteCoeff || b.isConstant() || e.isZERO()) { // symmetric
          ...
          Cps.doAddTo(b, e);
          if (debug) logger.info("symmetric coeff, e*b: b = " + b + ", e = " + e);
        } else { // unsymmetric
          if (debug) logger.info("unsymmetric coeff, e*b: b = " + b + ", e = " + e);
          for (Map.Entry<Word, C> z : b.val.entrySet()) {
            ...
            Word g1 = g.reductum();
            // ExpVector g1;
            // System.out.println("c = " + c + ", g = " + g + ", g1 = " + g1 + ", g1 == 1: " +
            // g1.isONE());
            ExpVector e1 = e;
            ExpVector e2 = Z;
            if (!e.isZERO()) {
            ...
            if (debug) logger.info("coeff, crel = " + crel.p);
        ...
        if (commute || Cps.isConstant() || f.isZERO()) { // symmetric
          if (debug) logger.info("symmetric poly, P_eb*f: Cps = " + Cps + ", f = " + f);
          ExpVector g = e.sum(f);
          if (Cps.isConstant()) {
            Ds =
                ring.valueOf(
          ...
          if (debug) logger.info("unsymmetric poly, P_eb*f: Cps = " + Cps + ", f = " + f);
        ...
        if (debug) logger.info("recursion-: Ds = " + Ds);
        // Dp = (RecSolvableWordPolynomial<C>) Dp.sum(Ds);
        Dp.doAddTo(Ds);
        if (debug) logger.info("end B loop: Dp = " + Dp);
      } // end B loop
      if (debug) logger.info("end A loop: Dp = " + Dp);
    } // end A loop
    return Dp;
  }

  /**
   * RecSolvableWordPolynomial left and right multiplication. Product with two polynomials.
   *
   ...
   */
  // cannot @Override, @NoOverride
  public RecSolvableWordPolynomial<C> multiply(
      RecSolvableWordPolynomial<C> S, RecSolvableWordPolynomial<C> T) {
  ...
  /**
   * RecSolvableWordPolynomial left and right multiplication. Product with coefficient ring element.
   *
   * @param b coefficient polynomial.
   * @param c coefficient polynomial.
  ...
  public RecSolvableWordPolynomial<C> multiply(GenWordPolynomial<C> b, GenWordPolynomial<C> c) {
    ...
    RecSolvableWordPolynomial<C> Cb =
        ring.valueOf(b); // new RecSolvableWordPolynomial<C>(ring, b, ring.evzero);
    RecSolvableWordPolynomial<C> Cc =
        ring.valueOf(c); // new RecSolvableWordPolynomial<C>(ring, c, ring.evzero);
  ...
  /**
   * RecSolvableWordPolynomial left and right multiplication. Product with exponent vector.
   *
   * @param e exponent.
   * @param f exponent.
  ...
  /**
   * RecSolvableWordPolynomial multiplication. Product with ring element and exponent vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  public RecSolvableWordPolynomial<C> multiply(GenWordPolynomial<C> b, ExpVector e) {
    ...
    RecSolvableWordPolynomial<C> Cp =
        ring.valueOf(b, e); // new RecSolvableWordPolynomial<C>(ring, b, e);
    return multiply(Cp);
  }

  /**
   * RecSolvableWordPolynomial left and right multiplication. Product with ring element and exponent
   * vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  @Override
  public RecSolvableWordPolynomial<C> multiply(
      GenWordPolynomial<C> b, ExpVector e, GenWordPolynomial<C> c, ExpVector f) {
    if (b == null || b.isZERO()) {
      return ring.getZERO();
    }
    if (c == null || c.isZERO()) {
    ...
    RecSolvableWordPolynomial<C> Cp =
        ring.valueOf(b, e); // new RecSolvableWordPolynomial<C>(ring, b, e);
    RecSolvableWordPolynomial<C> Dp =
        ring.valueOf(c, f); // new RecSolvableWordPolynomial<C>(ring, c, f);
    return multiply(Cp, Dp);
  }

  /**
   * RecSolvableWordPolynomial multiplication. Left product with ring element and exponent vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  /**
   * RecSolvableWordPolynomial multiplication. Left product with exponent vector.
   *
   * @param e exponent.
  ...
  public RecSolvableWordPolynomial<C> multiplyLeft(ExpVector e) {
    ...
    // GenWordPolynomial<C> b = ring.getONECoefficient();
    RecSolvableWordPolynomial<C> Cp =
        ring.valueOf(e); // new RecSolvableWordPolynomial<C>(ring, b, e);
    return Cp.multiply(this);
  }

  /**
   * RecSolvableWordPolynomial multiplication. Left product with coefficient ring element.
   *
   * @param b coefficient polynomial.
  ...
  /**
   * RecSolvableWordPolynomial multiplication. Commutative product with exponent vector.
   *
