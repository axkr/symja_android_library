...
public class FuzzyParserFactory implements IParserFactory {
	...
	private static class ApplyOperator extends FuzzyInfixExprOperator {
		...
		@Override
		public IASTMutable createFunction(final IParserFactory factory, FuzzyParser parser, final IExpr lhs,
				final IExpr rhs) {
			if (fOperatorString.equals("@")) {
	...
	public final static FuzzyInfixExprOperator ALTERNATIVES_OPERATOR = new FuzzyInfixExprOperator("|", "Alternatives",
			160, FuzzyInfixExprOperator.NONE);

	public final static FuzzyInfixExprOperator OR_OPERATOR = new FuzzyInfixExprOperator("||", "Or", 213,
			FuzzyInfixExprOperator.NONE);

	public final static FuzzyInfixExprOperator AND_OPERATOR = new FuzzyInfixExprOperator("&&", "And", 215,
			FuzzyInfixExprOperator.NONE);

	public final static FuzzyPostfixExprOperator FUNCTION_OPERATOR = new FuzzyPostfixExprOperator("&", "Function", 90);
	...
	public final static FuzzyInfixExprOperator EQUAL_OPERATOR = //
			new FuzzyInfixExprOperator("==", "Equal", EQUAL_PRECEDENCE, FuzzyInfixExprOperator.NONE);

	public final static FuzzyInfixExprOperator NON_COMMUTATIVE_MULTIPLY_OPERATOR = //
			new FuzzyInfixExprOperator("**", "NonCommutativeMultiply", 510, FuzzyInfixExprOperator.NONE);

	public final static FuzzyInfixExprOperator POWER_OPERATOR = //
			new FuzzyInfixExprOperator("^", "Power", POWER_PRECEDENCE, FuzzyInfixExprOperator.RIGHT_ASSOCIATIVE);

	public final static FuzzyInfixExprOperator SET_OPERATOR = //
			new FuzzyInfixExprOperator("=", "Set", 40, FuzzyInfixExprOperator.RIGHT_ASSOCIATIVE);

	public final static FuzzyInfixExprOperator SET_DELAYED_OPERATOR = new FuzzyInfixExprOperator(":=", "SetDelayed", 40,
	...
	public final static FuzzyParserFactory RELAXED_STYLE_FACTORY = new FuzzyParserFactory();
	...
	private static class Initializer {
		...
		private static void init() {
			...
			OPERATORS = new Operator[] {
					...
					new FuzzyInfixExprOperator("//@", "MapAll", 620, FuzzyInfixExprOperator.RIGHT_ASSOCIATIVE), //
					new FuzzyInfixExprOperator("*=", "TimesBy", 100, FuzzyInfixExprOperator.RIGHT_ASSOCIATIVE), //
					...
					new FuzzyInfixExprOperator("//.", "ReplaceRepeated", 110, FuzzyInfixExprOperator.LEFT_ASSOCIATIVE), //
					new FuzzyInfixExprOperator("<", "Less", 290, FuzzyInfixExprOperator.NONE), //
					AND_OPERATOR, //
					new DivideExprOperator("/", "Divide", DIVIDE_PRECEDENCE, FuzzyInfixExprOperator.LEFT_ASSOCIATIVE), //
					...
					new FuzzyInfixExprOperator(":>", "RuleDelayed", 120, FuzzyInfixExprOperator.RIGHT_ASSOCIATIVE), //
					new FuzzyInfixExprOperator(">=", "GreaterEqual", 290, FuzzyInfixExprOperator.NONE), //
					new FuzzyInfixExprOperator("/;", "Condition", 130, FuzzyInfixExprOperator.LEFT_ASSOCIATIVE), //
					...
					new FuzzyInfixExprOperator("/=", "DivideBy", 100, FuzzyInfixExprOperator.RIGHT_ASSOCIATIVE), //
					OR_OPERATOR, //
					...
					new FuzzyInfixExprOperator("-=", "SubtractFrom", 100, FuzzyInfixExprOperator.RIGHT_ASSOCIATIVE), //
					...
					new FuzzyInfixExprOperator("^:=", "UpSetDelayed", 40, FuzzyInfixExprOperator.RIGHT_ASSOCIATIVE), //
					...
					new FuzzyInfixExprOperator("/.", "ReplaceAll", 110, FuzzyInfixExprOperator.LEFT_ASSOCIATIVE), //
					TAG_SET_OPERATOR, //
					...
					new FuzzyInfixExprOperator("\uF120", "TwoWayRule", 125, InfixOperator.RIGHT_ASSOCIATIVE), //
					new FuzzyInfixExprOperator("\uF3D5", "DirectedEdge", 120, InfixOperator.RIGHT_ASSOCIATIVE), //
					new FuzzyInfixExprOperator("\uF3D4", "UndirectedEdge", 120, InfixOperator.RIGHT_ASSOCIATIVE), //
