...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$GeoLocation", "$TimeZone", "$UnitSystem",
      ...
      "DSolve", "DSolveValue", "Dt", "DuplicateFreeQ", "Dynamic", "DynamicModule", "DynamicWrapper",
      "EasterSunday", "Echo", "EchoFunction", "EclipseType", "EdgeAdd", "EdgeCount", "EdgeContract",
      "EdgeDelete", "EdgeDetect", "EdgeForm", "EdgeLabelStyle", "EdgeList", "EdgeQ", "EdgeRules",
      ...
      "FillingTransform", "FindAstroEvent", "FindDistributionParameters", "FindMaximumFlow",
      "FindMoleculeSubstructure", "FindSolarEclipse", "FindThreshold", "FiniteGroupCount",
      ...
      "FontTracking", "FontWeight", "For", "ForAll", "FormBox", "FormulaData", "Fourier",
      ...
      "IncludeHydrogens", "IncludeMetaInformation", "IncludeQuantities", "Increment",
      ...
      "IntegerPartitions", "IntegerQ", "Integrate", "Interleaving", "InterpolatingFunction",
      ...
      "Italic", "Item", "ItemDisplayFunction", "ItemSize", "ItemStyle", "JaccardDissimilarity",
      ...
      "JavaShow", "Join", "JoinAcross", "JoinedCurve", "JoinForm", "JordanDecomposition", "JSForm",
      "JSFormData", "JulianDate", "KagiChart", "KaryTree", "KelvinBei", "KelvinBer", "Key",
      "KeyDrop", "KeyDropFrom", "KeyExistsQ", "KeyFreeQ", "KeyComplement", "KeyIntersection",
      "KeyMap", "KeyMemberQ", "Keys", "KeySelect", "KeySort", "KeySortBy", "KeyTake", "KeyUnion",
      ...
      "LowerTriangularMatrixQ", "LucasL", "LUDecomposition", "LunarEclipse", "LunationNumber",
      "LUVColor", "MachineNumberQ", "Magnification", "MakeBoxes", "MangoldtLambda",
      "ManhattanDistance", "Manipulate", "Manipulator", "MantissaExponent", "Map", "MapAll",
      "MapApply", "MapAt", "MapIndexed", "MapThread", "MarcumQ", "MarginalDistribution", "Masking",
      ...
      "Message", "MessageName", "Messages", "MetaInformation", "MidDate", "Min", "MinDate",
      "MinFilter", "MinimalPolynomial", "MinimalBy", "Minimize", "MinLimit", "MinMax", "Minor",
      ...
      "Mod", "ModularInverse", "Module", "MoebiusMu", "Molecule", "MoleculeAlign",
      ...
      "MomentGeneratingFunction", "MomentOfInertia", "Monday", "MonomialList", "MoonPhase",
      ...
      "Placed", "Plain", "PlanarAngle", "PlanarGraph", "PlanarGraphQ", "Plot", "Plot3D", "PlotFit",
      ...
      "Trigger", "TrigReduce", "TrigSimplifyFu", "TrigToExp", "TrueQ", "TTest", "Tube", "Tuesday",
      ...
      "URLDecode", "URLEncode", "URLFetch", "ValenceErrorHandling", "ValueQ", "Values",
      "VandermondeMatrix", "Variables", "Variance", "VectorAngle", "VectorAround",
      ...
      "VectorPlot", "VectorPoints", "VectorQ", "VectorScale", "VectorSizes", "VectorStyle",
      "VectorSymbol", "Vee", "Verbatim", "VerificationTest", "VerifySolutions", "VertexAdd",
      "VertexColors", "VertexContract", "VertexDelete", "VertexCoordinates", "VertexCount",
      ...
      "ViewVertical", "Volume", "VoronoiMesh", "WaringYuleDistribution", "WatershedComponents",
      ...
      "WeightedGraphQ", "WheelGraph", "Which", "While", "WhiteCornerBracket", "WhittakerM",
      "WhittakerW", "WienerFilter", "WignerSemicircleDistribution", "With", "WordBoundary",
      "WordCloud", "WordOrientation", "WordSelectionFunction", "WordSpacings", "Write",
      "WriteString", "Xnor", "Xor", "XYZColor", "Yesterday", "YuleDissimilarity", "ZernikeR",
