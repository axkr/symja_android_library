...
IIntegrate(2441,Integrate(Times($p("§pq"),Power(x_,m_DEFAULT),Power(Plus(Times(a_DEFAULT,Power(x_,j_DEFAULT)),Times(b_DEFAULT,Power(x_,n_))),p_)),x_Symbol),
    Condition(Simp(Dist(Power(n,CN1),Subst(Integrate(Times(Power(x,Plus(Simplify(Times(Plus(m,C1),Power(n,CN1))),CN1)),SubstFor(Power(x,n),$s("§pq"),x),Power(Plus(Times(a,Power(x,Simplify(Times(j,Power(n,CN1))))),Times(b,x)),p)),x),x,Power(x,n)),x),x),And(FreeQ(List(a,b,j,m,n,p),x),PolyQ($s("§pq"),Power(x,n)),Not(IntegerQ(p)),NeQ(n,j),IntegerQ(Simplify(Times(j,Power(n,CN1)))),IntegerQ(Simplify(Times(Plus(m,C1),Power(n,CN1))))))),
IIntegrate(2442,Integrate(Times($p("§pq"),Power(Times(c_,x_),m_DEFAULT),Power(Plus(Times(a_DEFAULT,Power(x_,j_DEFAULT)),Times(b_DEFAULT,Power(x_,n_))),p_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(c,Times(Sign(m),Quotient(m,Sign(m)))),Power(Times(c,x),Mod(m,Sign(m))),Power(Power(x,Mod(m,Sign(m))),CN1)),Integrate(Times(Power(x,m),$s("§pq"),Power(Plus(Times(a,Power(x,j)),Times(b,Power(x,n))),p)),x),x),x),And(FreeQ(List(a,b,c,j,n,p),x),PolyQ($s("§pq"),Power(x,n)),Not(IntegerQ(p)),NeQ(n,j),IntegerQ(Simplify(Times(j,Power(n,CN1)))),IntegerQ(Simplify(Times(Plus(m,C1),Power(n,CN1)))),RationalQ(m),GtQ(Sqr(m),C1)))),
IIntegrate(2443,Integrate(Times($p("§pq"),Power(Times(c_,x_),m_DEFAULT),Power(Plus(Times(a_DEFAULT,Power(x_,j_DEFAULT)),Times(b_DEFAULT,Power(x_,n_))),p_)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Times(c,x),m),Power(Power(x,m),CN1)),Integrate(Times(Power(x,m),$s("§pq"),Power(Plus(Times(a,Power(x,j)),Times(b,Power(x,n))),p)),x),x),x),And(FreeQ(List(a,b,c,j,m,n,p),x),PolyQ($s("§pq"),Power(x,n)),Not(IntegerQ(p)),NeQ(n,j),IntegerQ(Simplify(Times(j,Power(n,CN1)))),IntegerQ(Simplify(Times(Plus(m,C1),Power(n,CN1))))))),
IIntegrate(2444,Integrate(Times($p("§pq"),Power(x_,m_DEFAULT),Power(Plus(Times(a_DEFAULT,Power(x_,j_DEFAULT)),Times(b_DEFAULT,Power(x_,n_))),p_)),x_Symbol),
    Condition(With(list(Set(g,GCD(Plus(m,C1),n))),Condition(Simp(Dist(Power(g,CN1),Subst(Integrate(Times(Power(x,Plus(Times(Plus(m,C1),Power(g,CN1)),CN1)),ReplaceAll($s("§pq"),Rule(x,Power(x,Power(g,CN1)))),Power(Plus(Times(a,Power(x,Times(j,Power(g,CN1)))),Times(b,Power(x,Times(n,Power(g,CN1))))),p)),x),x,Power(x,g)),x),x),NeQ(g,C1))),And(FreeQ(list(a,b,p),x),PolyQ($s("§pq"),Power(x,n)),Not(IntegerQ(p)),IGtQ(j,C0),IGtQ(n,C0),IGtQ(Times(j,Power(n,CN1)),C0),IntegerQ(m)))),
...
IIntegrate(2458,Integrate(Power($p("§pn"),p_DEFAULT),x_Symbol),
    Condition(With(list(Set($s("S"),Times(Coeff($s("§pn"),x,Plus(Expon($s("§pn"),x),CN1)),Power(Times(Expon($s("§pn"),x),Coeff($s("§pn"),x,Expon($s("§pn"),x))),CN1)))),Condition(Subst(Integrate(Power(ExpandToSum(ReplaceAll($s("§pn"),Rule(x,Subtract(x,$s("S")))),x),p),x),x,Plus(x,$s("S"))),Or(BinomialQ(ReplaceAll($s("§pn"),Rule(x,Subtract(x,$s("S")))),x),And(IntegerQ(Times(C1D2,Expon($s("§pn"),x))),TrinomialQ(ReplaceAll($s("§pn"),Rule(x,Subtract(x,$s("S")))),x))))),And(FreeQ(p,x),PolyQ($s("§pn"),x),GtQ(Expon($s("§pn"),x),C2),NeQ(Coeff($s("§pn"),x,Plus(Expon($s("§pn"),x),CN1)),C0)))),
IIntegrate(2459,Integrate(Times(Power($p("§pn"),p_DEFAULT),$p("§qx")),x_Symbol),
    Condition(With(list(Set($s("S"),Times(Coeff($s("§pn"),x,Plus(Expon($s("§pn"),x),CN1)),Power(Times(Expon($s("§pn"),x),Coeff($s("§pn"),x,Expon($s("§pn"),x))),CN1)))),Condition(Subst(Integrate(Times(Power(ExpandToSum(ReplaceAll($s("§pn"),Rule(x,Subtract(x,$s("S")))),x),p),ExpandToSum(ReplaceAll($s("§qx"),Rule(x,Subtract(x,$s("S")))),x)),x),x,Plus(x,$s("S"))),Or(BinomialQ(ReplaceAll($s("§pn"),Rule(x,Subtract(x,$s("S")))),x),And(IntegerQ(Times(C1D2,Expon($s("§pn"),x))),TrinomialQ(ReplaceAll($s("§pn"),Rule(x,Subtract(x,$s("S")))),x))))),And(FreeQ(p,x),PolyQ($s("§pn"),x),GtQ(Expon($s("§pn"),x),C2),NeQ(Coeff($s("§pn"),x,Plus(Expon($s("§pn"),x),CN1)),C0),PolyQ($s("§qx"),x),Not(And(MonomialQ($s("§qx"),x),IGtQ(p,C0)))))),
