...
public interface TanRules {
  final public static IAST RULES = List(
    ...
    ISet(Tan(Times(QQ(1L,10L),Pi)),
      Sqrt(Plus(C1,Times(CN2,Power(C5,CN1D2))))),
    ...
    ISet(Tan(Times(QQ(3L,10L),Pi)),
      Sqrt(Plus(C1,Times(C2,Power(C5,CN1D2))))),
    ...
    ISet(Tan(Times(QQ(7L,12L),Pi)),
      Plus(CN2,Times(CN1,Sqrt(C3)))),
    ISet(Tan(Times(QQ(3L,5L),Pi)),
      Times(CN1,Sqrt(Plus(C5,Times(C2,Sqrt(C5)))))),
    ISet(Tan(Times(QQ(5L,8L),Pi)),
      Plus(CN1,Times(CN1,Sqrt(C2)))),
    ISet(Tan(Times(QQ(2L,3L),Pi)),
      Times(CN1,Sqrt(C3))),
    ISet(Tan(Times(QQ(7L,10L),Pi)),
      Times(CN1,Sqrt(Plus(C1,Times(C2,Power(C5,CN1D2)))))),
    ISet(Tan(Times(QQ(3L,4L),Pi)),
      CN1),
    ISet(Tan(Times(QQ(4L,5L),Pi)),
      Times(CN1,Sqrt(Plus(C5,Times(CN2,Sqrt(C5)))))),
    ISet(Tan(Times(QQ(5L,6L),Pi)),
      Times(CN1,Power(C3,CN1D2))),
    ISet(Tan(Times(QQ(7L,8L),Pi)),
      Plus(C1,Times(CN1,Sqrt(C2)))),
    ISet(Tan(Times(QQ(9L,10L),Pi)),
      Times(CN1,Sqrt(Plus(C1,Times(CN2,Power(C5,CN1D2)))))),
