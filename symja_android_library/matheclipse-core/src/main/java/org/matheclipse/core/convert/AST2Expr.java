...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"All", "AllowedHeads", "AllowShortContext",
      ...
      "Gray", "Green", "Heads", "HexidecimalCharacter", "HoldAll", "HoldComplete",
      ...
      "TableHeadings", "TableSpacing", "TestID", "Ticks", "Tiny", "TicksStyle", "Today", "TooLarge",
      "Top", "Trig", "True", "Unknown", "UseTypeChecking", "Variable", "Vectors", "VertexLabels",
