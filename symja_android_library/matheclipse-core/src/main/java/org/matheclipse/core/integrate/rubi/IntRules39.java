...
IIntegrate(1951,Int(Times(Power(x_,m_DEFAULT),Plus(A_,Times(B_DEFAULT,Power(x_,r_DEFAULT))),Power(Plus(Times(c_DEFAULT,Power(x_,j_DEFAULT)),Times(b_DEFAULT,Power(x_,n_DEFAULT)),Times(a_DEFAULT,Power(x_,q_DEFAULT))),p_DEFAULT)),x_Symbol),
...
IIntegrate(1952,Int(Times(Power(x_,m_DEFAULT),Plus(A_,Times(B_DEFAULT,Power(x_,r_DEFAULT))),Power(Plus(Times(c_DEFAULT,Power(x_,j_DEFAULT)),Times(a_DEFAULT,Power(x_,q_DEFAULT))),p_DEFAULT)),x_Symbol),
...
IIntegrate(1953,Int(Times(Plus(A_,Times(B_DEFAULT,Power(x_,j_DEFAULT))),Power(x_,m_DEFAULT),Power(Plus(Times(b_DEFAULT,Power(x_,n_DEFAULT)),Times(a_DEFAULT,Power(x_,q_DEFAULT)),Times(c_DEFAULT,Power(x_,r_DEFAULT))),CN1D2)),x_Symbol),
...
IIntegrate(1954,Int(Times(Power(x_,m_DEFAULT),Plus(A_,Times(B_DEFAULT,Power(x_,q_))),Power(Plus(Times(a_DEFAULT,Power(x_,j_DEFAULT)),Times(b_DEFAULT,Power(x_,k_DEFAULT)),Times(c_DEFAULT,Power(x_,n_DEFAULT))),p_)),x_Symbol),
...
IIntegrate(1955,Int(Times(Plus(A_,Times(B_DEFAULT,Power(u_,j_DEFAULT))),Power(u_,m_DEFAULT),Power(Plus(Times(b_DEFAULT,Power(u_,n_DEFAULT)),Times(a_DEFAULT,Power(u_,q_DEFAULT)),Times(c_DEFAULT,Power(u_,r_DEFAULT))),p_DEFAULT)),x_Symbol),
...
IIntegrate(1966,Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(Times(d_DEFAULT,Power(x_,-1)),n_)),Times(c_DEFAULT,Power(Times(d_DEFAULT,Power(x_,-1)),$p("n2",true)))),p_DEFAULT),x_Symbol),
...
IIntegrate(1967,Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power(Times(d_DEFAULT,Power(x_,-1)),n_)),Times(c_DEFAULT,Power(Times(d_DEFAULT,Power(x_,-1)),$p("n2",true)))),p_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
IIntegrate(1968,Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power(Times(d_DEFAULT,Power(x_,-1)),n_)),Times(c_DEFAULT,Power(Times(d_DEFAULT,Power(x_,-1)),$p("n2",true)))),p_DEFAULT),Power(Times(e_DEFAULT,x_),m_)),x_Symbol),
