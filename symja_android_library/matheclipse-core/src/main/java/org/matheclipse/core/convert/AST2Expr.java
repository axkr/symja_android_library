...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$GeoLocation", "$TimeZone", "$UnitSystem",
      ...
      "Convergents", "ConvexHull", "ConvexHullMesh", "ConvexHullRegion", "ConvexPolyhedronQ",
      ...
      "GeoRange", "Get", "GlobalClusteringCoefficient", "Glow", "GoldbachList",
      ...
      "GreaterTilde", "GreenFunction", "Grid", "GridGraph", "GroebnerBasis", "GroupBy", "Groupings",
      "GroupOrbits", "Gudermannian", "GumbelDistribution", "HadamardMatrix", "HalfLine",
      ...
      "HeaderStyle", "HeavisideLambda", "HeavisidePi", "HeavisideTheta", "HermiteDecomposition",
      "HermiteH", "Hermitian", "HermitianMatrixQ", "HessenbergDecomposition", "HessianMatrix",
      "Hexahedron", "HiddenItems", "Highlighted", "HilbertMatrix", "Histogram",
