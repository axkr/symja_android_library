...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$BoxForms", "$CommandLine", "$ContextAliases",
      ...
      "DefaultPrintPrecision", "DefaultValues", "Defer", "DefineOutputStreamMethod", "Definition",
      ...
      "DeleteMissing", "DeleteObject", "DeleteSmallComponents", "Delimiter", "Denominator",
      ...
      "VectorPoints", "VectorQ", "VectorScale", "VectorSizes", "VectorStyle", "VectorSymbol", "Vee",
      "Verbatim", "VerificationTest", "VerifySolutions", "VertexAdd", "VertexChromaticNumber",
      "VertexColors", "VertexContract", "VertexCoverQ", "VertexDelete", "VertexCoordinates",
      "VertexCount", "VertexDegree", "VertexEccentricity", "VertexInDegree", "VertexLabelStyle",
      "VertexOutDegree", "VertexList", "VertexNormals", "VertexQ", "VertexShape",
      "VertexTextureCoordinates", "VertexWeight", "VerticalBar", "VerticalSeparator",
      "VerticalSlider", "VerticalTilde", "ViewAngle", "ViewCenter", "ViewMatrix", "ViewProjection",
