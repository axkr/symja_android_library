...
public class SymjaMMA extends Kernel {
  ...
  // ,BeakerXJson beakerXJson
    ...
    super(id, evaluator, kernelSocketsFactory, new CustomMagicCommandsEmptyImpl(), commRepository,
        beakerXServer, magicCommandConfiguration
    // ,beakerXJson
    );
  }
  ...
  public static void main(final String[] args) {
    KernelRunner.run(() -> {
      ...
      SymjaMMAEvaluator evaluator = new SymjaMMAEvaluator(id, id, getEvaluatorParameters(),
          namespaceClient, magicCommandTypesFactory.patterns());
      return new SymjaMMA(id, evaluator, kernelSocketsFactory, beakerXCommRepository,
