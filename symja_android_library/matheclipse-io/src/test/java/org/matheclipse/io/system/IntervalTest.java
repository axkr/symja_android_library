...
public class IntervalTest {
	...
	//
	// SetInterval one = ic.numsToInterval(1, 1);
	// SetInterval denom = ic.numsToInterval(-2, 5);
	// SetInterval mi = ic.recip(denom); // d = s / y
	// System.out.println("1/(-2,5) = " + mi);
	//
	...
	// SetInterval z = ic.textToInterval("[1/3, 4.5]"); // create interval from
	// string
	//
