 ...
 *
 * <p>The binary gcd is much faster than the Euclidean, and also faster than the built-in BigInteger
 * gcd().
 *
...
public class Gcd31 {
  ...
  /**
   * Greatest common divisor of the given two arguments. Euclid's algorithm implementation with
   * division.
   *
   * @param m
   * @param n
