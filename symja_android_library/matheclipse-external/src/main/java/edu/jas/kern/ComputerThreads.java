 ...
 *
 * <p><b>Usage:</b> To obtain a reference to the thread pool use <code>ComputerThreads.getPool()
 * </code>. Once a pool has been created it must be shutdown with <code>ComputerThreads.terminate()
 * </code> to exit JAS.
 *
 * @author Heinz Kredel
 */
public class ComputerThreads {
  ...
  /**
   * Flag for thread usage. <b>Note:</b> Only introduced because Google app engine does not support
   * threads.
   *
