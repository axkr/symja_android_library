...
/**
 * Integer BigQuaternion class based on BigRational implementing the RingElem interface and with the
 * familiar MAS static method names. Objects of this class are immutable. The integer quaternion
 * methods are implemented after https://de.wikipedia.org/wiki/Hurwitzquaternion see also
...
// implements StarRingElem<BigQuaternion>, GcdRingElem<BigQuaternion>
{
  ...
  public BigQuaternionInteger(
      BigQuaternionRing fac, BigRational r, BigRational i, BigRational j, BigRational k) {
    super(fac, r, i, j, k);
  }
  ...
  /**
   * The BigQuaternion string constructor accepts the following formats: empty string, "rational",
   * or "rat i rat j rat k rat" with no blanks around i, j or k if used as polynoial coefficient.
   *
   * @param fac BigQuaternionRing.
   * @param s String.
  ...
  /**
   * Integral quotient and remainder by left division of this by S. This must be also an integral
   * (Hurwitz) quaternion number.
   *
  ...
  /**
   * Integral quotient and remainder by right division of this by S. This must be also an integral
   * (Hurwitz) quaternion number.
   *
   * @param b an integral (Hurwitz) quaternion number
