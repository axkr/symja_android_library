...
public class LaplaceTransformRules {
  ...
  final public static IAST RULES = List(IInit(LaplaceTransform, SIZES),
      ...
      ISetDelayed(LaplaceTransform(Sin(Times(a_DEFAULT, t_)), t_, s_),
          Condition(Times(a, Power(Plus(Sqr(s), Sqr(a)), CN1)),
              And(FreeQ(list(a, s), t), FreeQ(a, s)))),
      ...
      ISetDelayed(LaplaceTransform(Cos(Times(a_DEFAULT, t_)), t_, s_),
          Condition(Times(Power(Plus(Sqr(s), Sqr(a)), CN1), s),
              And(FreeQ(list(a, s), t), FreeQ(a, s)))),
      // LaplaceTransform(Sinh(a_.*t_),t_,s_):=a/(-a^2+s^2)/;FreeQ({a,s},t)
      ISetDelayed(LaplaceTransform(Sinh(Times(a_DEFAULT, t_)), t_, s_), Condition(Times(a, Power(
          Plus(Negate(Sqr(a)), Sqr(s)), CN1)), FreeQ(list(a, s), t))),
      // LaplaceTransform(Cosh(a_.*t_),t_,s_):=s/(-a^2+s^2)/;FreeQ({a,s},t)
      ISetDelayed(LaplaceTransform(Cosh(Times(a_DEFAULT, t_)), t_, s_), Condition(Times(s, Power(
          Plus(Negate(Sqr(a)), Sqr(s)), CN1)), FreeQ(list(a, s), t))),
      ...
      ISetDelayed(LaplaceTransform(Tanh(Times(a_DEFAULT, t_)), t_, s_),
          Condition(
              Times(Power(Times(C2, a, s), CN1),
                  Plus(Times(CN2, a), Times(CN1, s, PolyGamma(Times(Power(Times(C4, a), CN1), s))),
                      Times(s, PolyGamma(Times(C1D4, Plus(C2, Times(Power(a, CN1), s))))))),
              FreeQ(list(a, s), t))),
      ...
      ISetDelayed(LaplaceTransform(Times(DiracDelta(Plus(b_DEFAULT, t_)), a_DEFAULT), t_, s_),
          Condition(Times(a, Exp(Times(b, s)), HeavisideTheta(Negate(b))),
              FreeQ(list(a, b, s), t))),
      // LaplaceTransform(HeavisideTheta(b_.+c_.*t_)*a_.,t_,s_):=a*Which(Sign(c)==1,1/(E^(s*Max(0,-b/c))*s),Sign(c)==-1,0,True,0)/;FreeQ({a,b,c,s},t)
      ISetDelayed(
          LaplaceTransform(Times(HeavisideTheta(Plus(b_DEFAULT, Times(c_DEFAULT, t_))), a_DEFAULT),
              t_, s_),
          Condition(Times(a,
              Which(Equal(Sign(c), C1),
                  Power(Times(Exp(Times(s, Max(C0, Times(CN1, b, Power(c, CN1))))), s), CN1),
                  Equal(Sign(c), CN1), C0, True, C0)),
              FreeQ(List(a, b, c, s), t))),
      ...
      ISetDelayed(LaplaceTransform(UnitStep(Times(a_DEFAULT, t_)), t_, s_),
          Condition(Which(Equal(Sign(a), C1), Power(s, CN1), Equal(Sign(a), CN1), C0, True, C0),
              FreeQ(list(a, s), t))),
