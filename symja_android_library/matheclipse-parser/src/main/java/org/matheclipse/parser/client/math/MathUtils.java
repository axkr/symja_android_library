 ...
 * 
 * @version $Revision: 1.1 $ $Date: 2008-02-10 12:28:59 -0700 (Sun, 10 Feb
 *          2008) $
 */
public final class MathUtils {
	...
	public static int addAndCheck(int x, int y) {
		...
		if (s < Integer.MIN_VALUE || s > Integer.MAX_VALUE) {
			throw new MathException("overflow: add");
		}
		return (int) s;
	}
	 ...
	 * See Knuth 4.5.2 algorithm B. This algorithm is due to Josef Stein (1961).
	 * </p>
	 * 
	 * @param u
	 *          a non-zero number
	...
	public static int gcd(int u, int v) {
		...
		if (k == 31) {
			throw new MathException("overflow: gcd is 2^31");
		}
	 ...
	 * if x < 0. Returns <code>NaN</code> if <code>x</code> is
	 * <code>NaN</code>.
	 * 
	 * @param x
	 *          the value, a double
	...
	/**
	 * <p>
	 * Returns the <a href="http://mathworld.wolfram.com/Logarithm.html">logarithm</a>
	...
	public static int mulAndCheck(int x, int y) {
		...
		if (m < Integer.MIN_VALUE || m > Integer.MAX_VALUE) {
			throw new MathException("overflow: mul");
		}
		return (int) m;
	}
	 ...
	 *          base number
	 * @param direction
	 *          (the only important thing is whether direction is greater or
	 *          smaller than d)
	...
	/**
	 * Round the given value to the specified number of decimal places. The value
	...
	/**
	 * Round the given value to the specified number of decimal places. The value
	 * is rounding using the {@link BigDecimal#ROUND_HALF_UP} method.
	 * 
	 * @param x
	 *          the value to round.
	 * @param scale
	...
	// }
	/**
	 * Returns the <a href="http://mathworld.wolfram.com/Sign.html"> sign</a> for
	 * byte value <code>x</code>.
	 * <p>
	 * For a byte value x, this method returns (byte)(+1) if x > 0, (byte)(0) if x =
	 * 0, and (byte)(-1) if x < 0.
	 * </p>
	 * 
	 * @param x
	 ...
	 * and -1.0F if x < 0. Returns <code>NaN</code> if <code>x</code> is
	 * <code>NaN</code>.
	 * </p>
	 * 
	 * @param x
	...
	/**
	 * Returns the <a href="http://mathworld.wolfram.com/Sign.html"> sign</a> for
	 * int value <code>x</code>.
	 * <p>
	 * For an int value x, this method returns +1 if x > 0, 0 if x = 0, and -1 if
	 * x < 0.
	 * </p>
	 * 
	 * @param x
	...
	/**
	 * Returns the <a href="http://mathworld.wolfram.com/Sign.html"> sign</a> for
	 * long value <code>x</code>.
	 * <p>
	 * For a long value x, this method returns +1L if x > 0, 0L if x = 0, and -1L
	 * if x < 0.
	 * </p>
	 * 
	 * @param x
	...
	public static int subAndCheck(int x, int y) {
		long s = (long) x - (long) y;
		if (s < Integer.MIN_VALUE || s > Integer.MAX_VALUE) {
			throw new MathException("overflow: subtract");
		}
		return (int) s;
	}
