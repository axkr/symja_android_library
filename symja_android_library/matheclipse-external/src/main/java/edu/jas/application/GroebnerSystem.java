...
/**
 * Container for a Groebner system. It contains a list of colored systems and a list of parametric
 * polynomials representing the corresponding comprehensive Groebner base.
 *
...
public class GroebnerSystem<C extends GcdRingElem<C>> {
  ...
  public List<GenPolynomial<GenPolynomial<C>>> getCGB() {
    ...
    List<GenPolynomial<GenPolynomial<C>>> G = new ArrayList<GenPolynomial<GenPolynomial<C>>>(Gs);
