...
public interface MathMLApplyElement extends MathMLContentContainer {
  /**
   * The MathML element representing the function or operator that is applied to the list of
   * arguments.
   *
  ...
  /**
   * This attribute represents the lowlimit child element of this node (if any). This expresses, for
   * instance, the lower limit of integration if this is an apply element whose first child is a
   * int. See .
   *
  ...
  /**
   * This attribute represents the uplimit child element of this node (if any). This expresses, for
   * instance, the upper limit of integration if this is an apply element whose first child is a
   * int. See .
   *
   ...
   *
   * @param upLimit new value for upLimit.
   * @see #getUpLimit()
   */
