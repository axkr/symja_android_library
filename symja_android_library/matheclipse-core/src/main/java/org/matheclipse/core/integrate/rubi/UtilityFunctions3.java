...
ISetDelayed(FixSimplify(Times(Power(u_,m_DEFAULT),Power(v_,n_),w_DEFAULT)),
...
ISetDelayed(FixSimplify(Times(Power(a_,m_),Power(Plus(u_,Times(Power(b_,n_),v_DEFAULT)),p_DEFAULT),w_DEFAULT)),
...
ISetDelayed(FixSimplify(Times(Power(a_,m_DEFAULT),Plus(Times(Power(a_,n_),u_DEFAULT),Times(Power(b_,p_DEFAULT),v_DEFAULT)),w_DEFAULT)),
...
ISetDelayed(FixSimplify(Times(Power(Plus(a_,b_),m_DEFAULT),Power(Plus(c_,d_),n_),w_DEFAULT)),
...
ISetDelayed(FixSimplify(Times(Power(Plus(Times(Power(a_,m_DEFAULT),u_DEFAULT),Times(Power(a_,n_DEFAULT),v_DEFAULT)),t_DEFAULT),w_DEFAULT)),
...
ISetDelayed(FixSimplify(Times(w_DEFAULT,Power(Plus(Times(Power(a_,m_DEFAULT),u_DEFAULT),Times(Power(a_,n_DEFAULT),v_DEFAULT),Times(Power(a_,p_DEFAULT),z_DEFAULT)),t_DEFAULT))),
...
ISetDelayed(FixSimplify(Times(w_DEFAULT,Power(Plus(Times(Power(a_,m_DEFAULT),u_DEFAULT),Times(Power(a_,n_DEFAULT),v_DEFAULT),Times(Power(a_,q_DEFAULT),y_DEFAULT),Times(Power(a_,p_DEFAULT),z_DEFAULT)),t_DEFAULT))),
...
ISetDelayed(FixSimplify(Times(Plus(u_DEFAULT,Times(b_DEFAULT,Sqrt(v_)),Times(c_DEFAULT,Sqrt(v_)),Times(d_DEFAULT,Sqrt(v_)),Times(a_DEFAULT,Sqrt($p(v,Plus)))),w_DEFAULT)),
    FixSimplify(Times(w,Plus(u,Times(FixSimplify(Plus(a,b,c,d)),Sqrt(v)))))),
ISetDelayed(FixSimplify(Times(Plus(u_DEFAULT,Times(b_DEFAULT,Sqrt(v_)),Times(c_DEFAULT,Sqrt(v_)),Times(a_DEFAULT,Sqrt($p(v,Plus)))),w_DEFAULT)),
    FixSimplify(Times(w,Plus(u,Times(FixSimplify(Plus(a,b,c)),Sqrt(v)))))),
ISetDelayed(FixSimplify(Times(Plus(u_DEFAULT,Times(b_DEFAULT,Sqrt(v_)),Times(a_DEFAULT,Sqrt($p(v,Plus)))),w_DEFAULT)),
...
ISetDelayed(FixSimplify(Times(Power(Plus(a_,Negate(b_)),m_DEFAULT),Power(Plus(a_,b_),m_DEFAULT),u_DEFAULT)),
    Condition(Times(u,Power(Plus(Sqr(a),Negate(Sqr(b))),m)),And(IntegerQ(m),AtomQ(a),AtomQ(b)))),
ISetDelayed(FixSimplify(Times(Power(Plus(Times(c_Symbol,Sqr(d_Symbol)),Times(CN1,e_Symbol,Plus(Times(b_Symbol,d_Symbol),Times(CN1,a_Symbol,e_Symbol)))),m_DEFAULT),u_DEFAULT)),
    Condition(Times(u,Power(Plus(Times(c,Sqr(d)),Times(CN1,b,d,e),Times(a,Sqr(e))),m)),And(RationalQ(m),OrderedQ(List(a,b,c,d,e))))),
ISetDelayed(FixSimplify(Times(Power(Plus(Times(c_Symbol,Sqr(d_Symbol)),Times(e_Symbol,Plus(Times(CN1,b_Symbol,d_Symbol),Times(a_Symbol,e_Symbol)))),m_DEFAULT),u_DEFAULT)),
    Condition(Times(u,Power(Plus(Times(c,Sqr(d)),Times(CN1,b,d,e),Times(a,Sqr(e))),m)),And(RationalQ(m),OrderedQ(List(a,b,c,d,e))))),
ISetDelayed(FixSimplify(Times(Power(Plus(Times(CN1,c_Symbol,Sqr(d_Symbol)),Times(e_Symbol,Plus(Times(b_Symbol,d_Symbol),Times(CN1,a_Symbol,e_Symbol)))),m_DEFAULT),u_DEFAULT)),
...
ISetDelayed(FixSimplify(Times(Power(Plus(Times(CN1,c_Symbol,Sqr(d_Symbol)),Times(CN1,e_Symbol,Plus(Times(CN1,b_Symbol,d_Symbol),Times(a_Symbol,e_Symbol)))),m_DEFAULT),u_DEFAULT)),
...
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Sqr($($s("§cos"),v_)),Power(Plus(a_,Times(b_DEFAULT,$($s("§sin"),v_))),-1))),
    Condition(Times(u,Plus(Power(a,-1),Times(CN1,Sin(v),Power(b,-1)))),EqQ(Plus(Sqr(a),Negate(Sqr(b))),C0))),
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT))),-1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cot(v),n))),-1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT))),-1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Tan(v),n))),-1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT))),-1))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cos(v),n))),-1)),And(IGtQ(n,C0),NonsumQ(a)))),
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT))),-1))),
...
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT))),-1))),
...
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§cos"),v_),m_DEFAULT),Power(Plus(a_DEFAULT,Times(c_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT)),Times(b_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT))),p_DEFAULT))),
...
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§sec"),v_),m_DEFAULT),Power(Plus(a_DEFAULT,Times(c_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT)),Times(b_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT))),p_DEFAULT))),
...
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power($($s("§csc"),v_),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT)),Times(c_DEFAULT,Power($($s("§csc"),v_),n_DEFAULT))),p_DEFAULT))),
...
ISetDelayed(TrigSimplifyAux(u_),
    u),
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power(Times(c_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT),Power($($s("§tan"),w_),n_DEFAULT)),p_DEFAULT))),
