...
public final class ModLongRing implements ModularRingFactory<ModLong>, Iterable<ModLong> {
  ...
  /**
   * The constructor creates a ModLongRing object from a BigInteger converted to long as module
   * part.
   *
  ...
  /**
   * ModLong chinese remainder algorithm. This is a factory method. Assert c.modul >= a.modul and
   ...
   */
  public static List<ModLong> chineseRemainder(
      ModLong m1, ModLong m2, List<ModLong> L1, List<ModLong> L2) {
