      ...
      List(
              ...
              Condition(
                  Dist(Power(d, CN1),
                      Subst(Integrate(Times(
                          ...
                          Power(Plus(Times(CN1, CSymbol, Power(d, CN2)),
                              Times(CSymbol, Sqr(x), Power(d, CN2))), p),
                          Power(Plus(a, Times(b, ArcCos(x))), n)), x), x,
                          Plus(c, Times(d, x))),
                      x),
                  And(FreeQ(List(a, b, c, d, e, f, ASymbol, BSymbol, CSymbol, m, n, p), x),
                      EqQ(Plus(Times(BSymbol, Subtract(C1, Sqr(c))), Times(C2, ASymbol, c, d)), C0),
          ...
          IIntegrate(4811,
              ...
              Condition(
                  Plus(
                      Simp(Times(x,
                          Sqrt(Plus(a, Times(b, ArcSin(Plus(c, Times(d, Sqr(x)))))))), x),
                      Negate(
                          Simp(
                              Times(CSqrtPi, x,
                                  Plus(Cos(Times(a, Power(Times(C2, b), CN1))),
                  ...
                  Plus(
                      Simp(
                          Times(
                              ...
                              Power(Times(d, x), CN1)),
                          x),
                      Negate(Simp(Times(C2, CSqrtPi, Sin(Times(a, Power(Times(C2, b), CN1))),
                      ...
                      Simp(Times(C2, CSqrtPi, Cos(Times(a, Power(Times(C2, b), CN1))),
                          Sin(Times(C1D2, ArcCos(Plus(C1, Times(d, Sqr(x)))))),
              ...
              Condition(
                  Plus(
                      ...
                      Negate(
                          Simp(
                              Times(
                                  C2, CSqrtPi, Cos(Times(a, Power(Times(C2, b),
                                      CN1))),
                                  Cos(Times(C1D2,
                      ...
                      Negate(
                          Simp(
                              Times(C2, CSqrtPi, Sin(Times(a, Power(Times(C2, b), CN1))),
                              ...
                              Times(CSqrtPi, x,
                                  ...
                                  FresnelC(
                                      Times(C1,
                                          Sqrt(
                                              Plus(a, Times(b, ArcSin(Plus(c, Times(d, Sqr(x))))))),
                                          Power(Times(Sqrt(Times(b, c)), CSqrtPi), CN1))),
                                  Power(
                                      Times(Sqrt(Times(b, c)), Subtract(
                                          Cos(Times(C1D2, ArcSin(Plus(c, Times(d, Sqr(x)))))),
                                          Times(c,
                                              Sin(Times(C1D2,
                                                  ArcSin(Plus(c, Times(d, Sqr(x))))))))),
                          ...
                          Times(CSqrtPi, x,
                              Plus(
                                  Cos(Times(a, Power(Times(C2, b),
                                      CN1))),
                                  Times(c, Sin(Times(a, Power(Times(C2, b), CN1))))),
                              FresnelS(Times(Power(Times(Sqrt(Times(b, c)), CSqrtPi), CN1),
                                  Sqrt(Plus(a, Times(b, ArcSin(Plus(c, Times(d, Sqr(x))))))))),
                              Power(
                                  Times(Sqrt(Times(b, c)), Subtract(
                                      Cos(Times(C1D2, ArcSin(Plus(c, Times(d, Sqr(x)))))),
