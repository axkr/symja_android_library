...
public final class HashValueVisitor extends AbstractVisitorInt {

  public static final HashValueVisitor HASH_VALUE_VISITOR = new HashValueVisitor();

  public HashValueVisitor() {}

  /**
   * Calculate a hash value. Especially if the first argument of the given <code>ast</code> is
   * itself an <code>AST</code> object.
   *
