...
public class FindInstanceTest extends ExprEvaluatorTestCase {
  ...
  public void testDiophantine001() {
    if (ToggleFeature.SOLVE_DIOPHANTINE) {
      ...
      // https://rosettacode.org/wiki/Pell's_equation
      check("FindInstance(x^2-61*y^2 == 1, {x, y}, Integers, 2)", //
          "{{x->-1766319049,y->-226153980},{x->1766319049,y->226153980}}");
      check("FindInstance(x^2-109*y^2 == 1, {x, y}, Integers, 2)", //
          "{{x->-158070671986249,y->-15140424455100},{x->158070671986249,y->15140424455100}}");
      check("FindInstance(x^2-181*y^2 == 1, {x, y}, Integers, 2)", //
          "{{x->-2469645423824185801,y->-183567298683461940},{x->2469645423824185801,y->\n" //
              + "183567298683461940}}");
      check("FindInstance(x^2-277*y^2 == 1, {x, y}, Integers, 2)", //
          "{{x->-159150073798980475849,y->9562401173878027020},{x->159150073798980475849,y->-\n" //
              + "9562401173878027020}}");
    }
  }
