...
ISetDelayed(Int(Times(Power(Times(f_DEFAULT,x_),m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(f_DEFAULT,x_),m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_))))),x_Symbol),
...
ISetDelayed(Int(Times(u_,Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_))))),x_Symbol),
...
ISetDelayed(Int(Times(u_,Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_))))),x_Symbol),
...
ISetDelayed(Int(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
    Condition(Unintegrable(Times(u,Power(Plus(a,Times(b,ArcSech(Times(c,x)))),n)),x),FreeQ(List(a,b,c,n),x))),
ISetDelayed(Int(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
    Condition(Unintegrable(Times(u,Power(Plus(a,Times(b,ArcCsch(Times(c,x)))),n)),x),FreeQ(List(a,b,c,n),x))),
ISetDelayed(Int(ArcSech(Plus(c_,Times(d_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(ArcCsch(Plus(c_,Times(d_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT),x_Symbol),
...
ISetDelayed(Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT),x_Symbol),
...
ISetDelayed(Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_),x_Symbol),
    Condition(Unintegrable(Power(Plus(a,Times(b,ArcSech(Plus(c,Times(d,x))))),p),x),And(FreeQ(List(a,b,c,d,p),x),Not(IGtQ(p,C0))))),
ISetDelayed(Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_),x_Symbol),
    Condition(Unintegrable(Power(Plus(a,Times(b,ArcCsch(Plus(c,Times(d,x))))),p),x),And(FreeQ(List(a,b,c,d,p),x),Not(IGtQ(p,C0))))),
ISetDelayed(Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_)),x_Symbol),
...
ISetDelayed(Int(Exp(ArcSech(Times(a_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Exp(ArcSech(Times(a_DEFAULT,Power(x_,p_)))),x_Symbol),
...
ISetDelayed(Int(Exp(ArcCsch(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),x_Symbol),
...
ISetDelayed(Int(Exp(Times(n_DEFAULT,ArcSech(u_))),x_Symbol),
...
ISetDelayed(Int(Exp(Times(n_DEFAULT,ArcCsch(u_))),x_Symbol),
    Condition(Int(Power(Plus(Power(u,-1),Sqrt(Plus(C1,Power(u,-2)))),n),x),IntegerQ(n))),
ISetDelayed(Int(Times(Exp(ArcSech(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),Power(x_,-1)),x_Symbol),
...
ISetDelayed(Int(Times(Exp(ArcSech(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Exp(ArcCsch(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Exp(Times(n_DEFAULT,ArcSech(u_))),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Exp(Times(n_DEFAULT,ArcCsch(u_))),Power(x_,m_DEFAULT)),x_Symbol),
    Condition(Int(Times(Power(x,m),Power(Plus(Power(u,-1),Sqrt(Plus(C1,Power(u,-2)))),n)),x),And(FreeQ(m,x),IntegerQ(n)))),
ISetDelayed(Int(Times(Exp(ArcSech(Times(c_DEFAULT,x_))),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
ISetDelayed(Int(Times(Exp(ArcCsch(Times(c_DEFAULT,x_))),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
ISetDelayed(Int(Times(Exp(ArcSech(Times(c_DEFAULT,x_))),Power(Times(d_DEFAULT,x_),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
ISetDelayed(Int(Times(Exp(ArcCsch(Times(c_DEFAULT,x_))),Power(Times(d_DEFAULT,x_),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(u_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(u_)))),x_Symbol),
