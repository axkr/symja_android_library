 ...
 * <blockquote>
 *
 * <p>gives the partial derivative of <code>f</code> with respect to <code>x</code>.
 *
 * </blockquote>
 *
 * <pre>
 ...
 * <blockquote>
 *
 * <p>differentiates successively with respect to <code>x</code>, <code>y</code>, etc.
 *
 * </blockquote>
 *
 * <pre>
 ...
 * <blockquote>
 *
 * <p>gives the multiple derivative of order <code>n</code>.<br>
 *
 * </blockquote>
 *
 * <pre>
 ...
 * <blockquote>
 *
 * <p>gives the vector derivative of <code>f</code> with respect to <code>x1</code>, <code>x2</code>
 * , etc.
 *
 * </blockquote>
 *
 * <p><strong>Note</strong>: the upper case identifier <code>D</code> is different from the lower
 * case identifier <code>d</code>.
 *
 * <h3>Examples</h3>
 *
 * <p>First-order derivative of a polynomial:<br>
 *
 * <pre>
 * &gt;&gt; D(x^3 + x^2, x)
 * 2*x+3*x^2
 ...
 * </pre>
 *
 * <p>Trigonometric derivatives:<br>
 *
 * <pre>
 * &gt;&gt; D(Sin(Cos(x)), x)
 * -Cos(Cos(x))*Sin(x)
 ...
 * </pre>
 *
 * <p>Unknown variables are treated as constant:
 *
 * <pre>
 * &gt;&gt; D(y, x)
 * 0
 ...
 * </pre>
 *
 * <p>Derivatives of unknown functions are represented using 'Derivative':<br>
 *
 * <pre>
 * &gt;&gt; D(f(x), x)
 * f'(x)
 ...
 * </pre>
 *
 * <p>Compute the gradient vector of a function:<br>
 *
 * <pre>
 * &gt;&gt; D(x ^ 3 * Cos(y), {{x, y}})
...
public class D extends AbstractFunctionEvaluator implements DRules {
   ...
   * @return
   */
  private static IExpr getDerivativeArg1(
      IExpr x, final IExpr a1, final IExpr head, EvalEngine engine) {
    if (head.isSymbol()) {
  ...
  private static IAST addDerivative(
      final int pos, IAST deriveHead, final IExpr header, final IAST args) {
