...
//							throw new MathException("Invalid Level specification: " + levelExpr.toString());
	...
	public VisitorBooleanLevelSpecification(final Predicate<IExpr> predicate, final int fromLevel, final int toLevel) {
	 ...
	 * @param includeHeads
	 */
	public VisitorBooleanLevelSpecification(final Predicate<IExpr> function, final int fromLevel, final int toLevel,
