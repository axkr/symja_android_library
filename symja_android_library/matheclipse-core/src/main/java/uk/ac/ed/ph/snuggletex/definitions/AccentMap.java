...
/**
 * Map defines how unaccented alphabetic characters should map to corresponding Unicode characters when a particular
 * type of accent is applied (e.g. circumflex).
 *
 * @author David McKain
...
public final class AccentMap {
	...
	public AccentMap(char[] accentData, String mathUnsafeChars) {
		...
		char ascii, accented;
		int index;
		final int length = accentData.length-1;
