...
public class TDiv31 extends FactorAlgorithm {
  ...
  private static AutoExpandingPrimesArray SMALL_PRIMES =
      AutoExpandingPrimesArray.get().ensurePrimeCount(NUM_PRIMES_FOR_31_BIT_TDIV);
  ...
  public BigInteger findSingleFactor(BigInteger N) {
    if (N.bitLength() > 31)
      throw new IllegalArgumentException(
          "TDiv31.findSingleFactor() does not work for N>31 bit, but N=" + N);
