...
public class Residue<C extends RingElem<C>> implements RingElem<Residue<C>> {
  ...
  /**
   * The constructor creates a Residue object from a ring factory, a ring element and an indicator
   * if a is a unit.
   *
   * @param r ring factory.
   * @param a ring element.
  ...
  /**
   * Greatest common divisor. <b>Note: </b>Not implemented, throws UnsupportedOperationException.
   *
