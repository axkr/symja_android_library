...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "Head", "HeavisideLambda", "HeavisidePi", "HeavisideTheta", "HermiteH", "HermitianMatrixQ",
      ...
      "JavaNew", "JavaObject", "JavaObjectQ", "JavaShow", "Join", "JSForm", "JSFormData",
      ...
      "LogNormalDistribution", "LogPlot", "Longest", "Lookup", "LowerCaseQ", "LowerTriangularize",
      "LowerTriangularMatrixQ", "LucasL", "LUDecomposition", "MachineNumberQ", "MakeBoxes",
      "MangoldtLambda", "ManhattanDistance", "Manipulate", "MantissaExponent", "Map", "MapAll",
      "MapApply", "MapAt", "MapIndexed", "MapThread", "MatchingDissimilarity", "MatchQ",
      "MathMLForm", "MatrixD", "MatrixExp", "MatrixForm", "MatrixFunction", "MatrixLog",
      "MatrixMinimalPolynomial", "MatrixPlot", "MatrixPower", "MatrixQ", "MatrixRank", "Max",
      "MaxFilter", "Maximize", "MaxMemoryUsed", "Mean", "MeanDeviation", "MeanFilter", "Median",
      "MedianFilter", "MeijerG", "MemberQ", "MemoryAvailable", "MemoryInUse", "Merge",
      "MersennePrimeExponent", "MersennePrimeExponentQ", "MeshRange", "Message", "MessageName",
      "Messages", "Min", "MinFilter", "MinimalPolynomial", "Minimize", "MinMax", "Minor", "Minors",
      ...
      "Nearest", "NearestTo", "Needs", "Negative", "Nest", "NestList", "NestWhile", "NestWhileList",
      "NewLimit", "NExpectation", "NextPrime", "NFourierTransform", "NIntegrate", "NMaximize",
      ...
      "RankedMin", "Rational", "Rationalize", "RawBackquote", "RawBoxes", "Re", "Read", "ReadList",
      ...
      "ReplaceAt", "ReplaceList", "ReplacePart", "ReplaceRepeated", "Rescale", "Rest", "Resultant",
      "Return", "Reverse", "ReverseElement", "ReverseEquilibrium", "ReverseSort",
      "ReverseUpEquilibrium", "RGBColor", "RiccatiSolve", "Riffle", "RightArrow", "RightArrowBar",
      ...
      "TrigSimplifyFu", "TrigToExp", "TrueQ", "TTest", "Tube", "TukeyWindow", "Tuples",
      "TwoWayRule", "UnaryMinusPlus", "UnaryPlus", "UnaryPlusMinus", "Undefined", "Underflow",
      "Underoverscript", "UnderoverscriptBox", "Underscript", "UnderscriptBox", "UndirectedEdge",
      "Unequal", "UnequalTo", "Unevaluated", "UniformDistribution", "Union", "UnionPlus", "Unique",
      ...
      "VectorQ", "Vee", "Verbatim", "VerificationTest", "VertexEccentricity", "VertexList",
