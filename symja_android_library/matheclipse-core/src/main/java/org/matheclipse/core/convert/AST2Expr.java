...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AbsoluteCorrelation", "Accumulate",
			...
			"CountDistinct", "Counts", "Covariance", "CreateDirectory", "Cross", "Csc", "Csch", "CubeRoot", "Curl",
			"Cyclotomic", "Dataset", "Decrement", "Default", "DefaultButton", "Defer", "Definition", "Delete",
