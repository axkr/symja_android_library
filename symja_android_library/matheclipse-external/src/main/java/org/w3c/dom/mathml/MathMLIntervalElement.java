 ...
 * It contains either two child elements that evaluate to real numbers or one child element that is
 * a condition for defining membership in the interval.
 */
public interface MathMLIntervalElement extends MathMLContentElement {
   ...
   *
   * @param closure new value for closure.
   * @see #getClosure()
   */
  void setClosure(String closure);

  /**
   * A MathMLContentElement representing the real number defining the start of the interval. If end
   * has not already been set, it becomes the same as start until set otherwise.
   *
  ...
  /**
   * A MathMLContentElement representing the real number defining the end of the interval. If start
   * has not already been set, it becomes the same as end until set otherwise.
   *
