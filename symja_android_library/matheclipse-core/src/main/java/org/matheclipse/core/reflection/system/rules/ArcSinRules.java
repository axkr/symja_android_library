...
public interface ArcSinRules {
  final public static IAST RULES = List(
    ISet(ArcSin(C0),
      C0),
    ISet(ArcSin(Times(Plus(CN1,CSqrt3),Power(Times(C2,CSqrt2),CN1))),
      Times(QQ(1L,12L),Pi)),
    ...
    ISet(ArcSin(C1D2),
      Times(QQ(1L,6L),Pi)),
    ISet(ArcSin(Times(C1D2,Sqrt(Times(C1D2,Plus(C5,Times(CN1,CSqrt5)))))),
      Times(QQ(1L,5L),Pi)),
    ...
    ISet(ArcSin(Times(C1D2,Sqrt(Times(C1D2,Plus(C5,CSqrt5))))),
      Times(QQ(2L,5L),Pi)),
    ISet(ArcSin(Times(Plus(C1,CSqrt3),Power(Times(C2,CSqrt2),CN1))),
      Times(QQ(5L,12L),Pi)),
    ISet(ArcSin(C1),
      Times(C1D2,Pi)),
    ISet(ArcSin(CI),
