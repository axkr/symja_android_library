...
public class Trie<S, T> implements Map<S, T> {
	 ...
	 *            The TrieSequencer which handles the necessary sequence operations.
	 * @param defaultValue
	 *            The default value of the Trie is the value returned when {@link #get(Object)} or
	 *            {@link #get(Object, TrieMatch)} is called and no match was found.
	 */
	 ...
	 * @param queryOffset
	 *            The offset into that sequence where the node (subset sequence) should begin.
	 * @param queryLength
	 ...
	 * @return The value for the given sequence, or the default value of the Trie if no match was found. The default
	 *         value of a Trie is by default null.
	 */
	...
	/**
	 * Removes the sequence from the Trie and returns it's value. The sequence must be an exact match, otherwise nothing
	 * will be removed.
	 * 
	 * @param sequence
	...
	/**
	 * Starts at the root node and searches for a node with the exact given sequence, once found it removes it and
	 * returns the value. If a node is not found with the exact sequence then null is returned.
	 * 
	 * @param root
	...
	/**
	 * Returns a {@link Set} of {@link Entry}s that match the given sequence based on the default matching logic. If no
	 * matches were found then a Set with size 0 will be returned. The set returned can have Entries removed directly
	 * from it, given that the Entries are from this Trie.
	 * 
	 * @param sequence
	...
	/**
	 * Returns a {@link Set} of {@link Entry}s that match the given sequence based on the given matching logic. If no
	 * matches were found then a Set with size 0 will be returned. The set returned can have Entries removed directly
	 * from it, given that the Entries are from this Trie.
	 * 
	 * @param sequence
	...
	/**
	 * The same as {@link #entrySet()} except instead of a {@link Set} of {@link Entry}s, it's a {@link Set} of
	 * {@link TrieNode}s.
	 * 
	...
	/**
	 * Returns a {@link Set} of {@link TrieNode}s that match the given sequence based on the default matching logic. If
	 * no matches were found then a Set with size 0 will be returned. The set returned can have TrieNodes removed
	 * directly from it, given that the TrieNodes are from this Trie and they will be removed from this Trie.
	 * 
	 * @param sequence
	 *            The sequence to match on.
	...
	/**
	 * Returns a {@link Set} of {@link TrieNode}s that match the given sequence based on the given matching logic. If no
	 * matches were found then a Set with size 0 will be returned. The set returned can have TrieNodes removed directly
	 * from it, given that the TrieNodes are from this Trie.
	 * 
	 * @param sequence
	 *            The sequence to match on.
	 * @param match
	...
	/**
	 * Returns an {@link Iterable} of all {@link TrieNode}s in this Trie including naked (null-value) nodes.
	 * 
	...
	/**
	 * Returns an {@link Iterable} of all {@link TrieNode}s in this Trie that match the given sequence using the default
	 * matching logic including naked (null-value) nodes.
	 * 
	 * @param sequence
	 *            The sequence to match on.
	 * @return The reference to a new Iterable.
	...
	/**
	 * Returns an {@link Iterable} of all {@link TrieNode}s in this Trie that match the given sequence using the given
	 * matching logic including naked (null-value) nodes.
	 * 
	 * @param sequence
	 *            The sequence to match on.
	...
	/**
	 * Returns a {@link Set} of all keys (sequences) in this Trie that match the given sequence given the default
	 * matching logic. If no matches were found then a Set with size 0 will be returned. The Set returned can have
	 * keys/sequences removed directly from it and they will be removed from this Trie.
	 * 
	 * @param sequence
	 *            The sequence to match on.
	...
	/**
	 * Returns a {@link Set} of all keys (sequences) in this Trie that match the given sequence with the given matching
	 * logic. If no matches were found then a Set with size 0 will be returned. The Set returned can have keys/sequences
