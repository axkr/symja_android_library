...
ISetDelayed(Int($($s("§sin"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
    Condition(Times(CN1,Cos(Plus(a,Times(b,x))),Power(b,CN1)),FreeQ(List(a,b),x))),
ISetDelayed(Int($($s("§cos"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
    Condition(Times(Sin(Plus(a,Times(b,x))),Power(b,CN1)),FreeQ(List(a,b),x))),
ISetDelayed(Int(Power($($s("§sin"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),pn_),x_Symbol),
...
ISetDelayed(Int(Power($($s("§cos"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),pn_),x_Symbol),
...
ISetDelayed(Int(Power(Times($($s("§cos"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),c_DEFAULT),pn_),x_Symbol),
...
ISetDelayed(Int(Power(Times($($s("§cos"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),c_),pn_),x_Symbol),
