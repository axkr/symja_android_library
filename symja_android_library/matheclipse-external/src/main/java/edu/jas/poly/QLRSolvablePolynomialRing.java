...
/**
 * QLRSolvablePolynomialRing generic recursive solvable polynomial factory implementing RingFactory
 * and extending GenSolvablePolynomialRing factory. Factory for n-variate ordered solvable
 * polynomials over solvable quotient, local and local-residue coefficients. The non-commutative
 ...
 * @author Heinz Kredel
 */
public class QLRSolvablePolynomialRing<
        C extends GcdRingElem<C> & QuotPair<GenPolynomial<D>>, D extends GcdRingElem<D>>
  ...
  public QLRSolvablePolynomialRing(
      RingFactory<C> cf, int n, TermOrder t, String[] v, RelationTable<C> rt) {
    super(cf, n, t, v, rt);
  ...
  public QLRSolvablePolynomialRing<C, D> extend(int i, boolean top) {
    ...
    QLRSolvablePolynomialRing<C, D> spfac =
        new QLRSolvablePolynomialRing<C, D>(pfac.coFac, pfac.nvar, pfac.tord, pfac.getVars());
  ...
  public QLRSolvablePolynomialRing<C, D> extend(String[] vn, boolean top) {
    ...
    QLRSolvablePolynomialRing<C, D> spfac =
        new QLRSolvablePolynomialRing<C, D>(pfac.coFac, pfac.nvar, pfac.tord, pfac.vars);
    spfac.table.extend(this.table);
    spfac.polCoeff.coeffTable.extend(this.polCoeff.coeffTable);
    return spfac;
  }
  ...
  /**
   * Rational function from integral polynomial coefficients. Represent as polynomial with type C
   * coefficients.
   *
   * @param A polynomial with integral polynomial coefficients to be converted.
   * @return polynomial with type C coefficients.
   */
  public QLRSolvablePolynomial<C, D> fromPolyCoefficients(
      GenSolvablePolynomial<GenPolynomial<D>> A) {
  ...
  /**
   * Integral function from rational polynomial coefficients. Represent as polynomial with type
   * GenSolvablePolynomial coefficients.
   *
   * @param A polynomial with rational polynomial coefficients to be converted.
