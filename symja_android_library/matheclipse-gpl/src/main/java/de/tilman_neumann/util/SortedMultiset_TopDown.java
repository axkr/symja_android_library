 ...
 * @param <T> value class
 */
public class SortedMultiset_TopDown<T extends Comparable<T>> extends TreeMap<T, Integer> implements SortedMultiset<T> {
	 ...
	 * This sort order is particularly adequate for the parts of additive partitions.
	 */
	 ...
	 * Bigger elements are sorted in before smaller elements.
	 * @param values
	 */
	 ...
	 * A multiset is bigger than another one if it's biggest element is bigger
