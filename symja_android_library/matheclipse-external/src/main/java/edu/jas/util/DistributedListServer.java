 ...
 *
 * @author Heinz Kredel TODO: redistribute list for late comming clients, removal of elements.
 */
public class DistributedListServer extends Thread {
  ...
  public static final int DEFAULT_PORT = ChannelFactory.DEFAULT_PORT + 99;
...
/**
 * Class for holding the list index used as key in TreeMap. Implemented since Integer has no add()
 * method. Must implement Comparable so that TreeMap works with correct ordering.
 */
