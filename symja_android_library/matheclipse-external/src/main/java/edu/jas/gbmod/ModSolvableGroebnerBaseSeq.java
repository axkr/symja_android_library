...
/**
 * Module solvable Groebner Bases sequential class. Implements module solvable Groebner bases and GB
 * test.
 *
 ...
 */
@Deprecated
public class ModSolvableGroebnerBaseSeq<C extends GcdRingElem<C>>
    extends ModSolvableGroebnerBaseAbstract<C> {
