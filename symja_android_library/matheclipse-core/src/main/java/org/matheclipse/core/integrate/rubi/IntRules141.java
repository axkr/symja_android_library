...
IIntegrate(2821,Integrate(Times(Log(Times(d_DEFAULT,Plus(e_,Times(f_DEFAULT,Power(x_,m_DEFAULT))))),Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,CN1)),x_Symbol),
    Condition(Plus(Simp(Times(CN1,PolyLog(C2,Times(CN1,d,f,Power(x,m))),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),Power(m,CN1)),x),Simp(Dist(Times(b,n,p,Power(m,CN1)),Integrate(Times(PolyLog(C2,Times(CN1,d,f,Power(x,m))),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,CN1)),Power(x,CN1)),x),x),x)),And(FreeQ(List(a,b,c,d,e,f,m,n),x),IGtQ(p,C0),EqQ(Times(d,e),C1)))),
IIntegrate(2822,Integrate(Times(Log(Times(d_DEFAULT,Power(Plus(e_,Times(f_DEFAULT,Power(x_,m_DEFAULT))),r_DEFAULT))),Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,CN1)),x_Symbol),
    Condition(Subtract(Simp(Times(Log(Times(d,Power(Plus(e,Times(f,Power(x,m))),r))),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,C1)),Power(Times(b,n,Plus(p,C1)),CN1)),x),Simp(Dist(Times(f,m,r,Power(Times(b,n,Plus(p,C1)),CN1)),Integrate(Times(Power(x,Plus(m,CN1)),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,C1)),Power(Plus(e,Times(f,Power(x,m))),CN1)),x),x),x)),And(FreeQ(List(a,b,c,d,e,f,r,m,n),x),IGtQ(p,C0),NeQ(Times(d,e),C1)))),
IIntegrate(2823,Integrate(Times(Log(Times(d_DEFAULT,Power(Plus(e_,Times(f_DEFAULT,Power(x_,m_DEFAULT))),r_DEFAULT))),Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),Power(Times(g_DEFAULT,x_),q_DEFAULT)),x_Symbol),
    Condition(With(list(Set(u,IntHide(Times(Power(Times(g,x),q),Log(Times(d,Power(Plus(e,Times(f,Power(x,m))),r)))),x))),Subtract(Simp(Dist(Plus(a,Times(b,Log(Times(c,Power(x,n))))),u,x),x),Simp(Dist(Times(b,n),Integrate(Dist(Power(x,CN1),u,x),x),x),x))),And(FreeQ(List(a,b,c,d,e,f,g,r,m,n,q),x),Or(IntegerQ(Times(Plus(q,C1),Power(m,CN1))),And(RationalQ(m),RationalQ(q))),NeQ(q,CN1)))),
IIntegrate(2824,Integrate(Times(Log(Times(d_DEFAULT,Plus(e_,Times(f_DEFAULT,Power(x_,m_DEFAULT))))),Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(Times(g_DEFAULT,x_),q_DEFAULT)),x_Symbol),
    Condition(With(list(Set(u,IntHide(Times(Power(Times(g,x),q),Log(Times(d,Plus(e,Times(f,Power(x,m)))))),x))),Subtract(Simp(Dist(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),u,x),x),Simp(Dist(Times(b,n,p),Integrate(Dist(Times(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,CN1)),Power(x,CN1)),u,x),x),x),x))),And(FreeQ(List(a,b,c,d,e,f,g,m,n,q),x),IGtQ(p,C0),RationalQ(m),RationalQ(q),NeQ(q,CN1),Or(EqQ(p,C1),And(FractionQ(m),IntegerQ(Times(Plus(q,C1),Power(m,CN1)))),And(IGtQ(q,C0),IntegerQ(Times(Plus(q,C1),Power(m,CN1))),EqQ(Times(d,e),C1)))))),
IIntegrate(2825,Integrate(Times(Log(Times(d_DEFAULT,Power(Plus(e_,Times(f_DEFAULT,Power(x_,m_DEFAULT))),r_DEFAULT))),Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(Times(g_DEFAULT,x_),q_DEFAULT)),x_Symbol),
    Condition(With(list(Set(u,IntHide(Times(Power(Times(g,x),q),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p)),x))),Subtract(Simp(Dist(Log(Times(d,Power(Plus(e,Times(f,Power(x,m))),r))),u,x),x),Simp(Dist(Times(f,m,r),Integrate(Dist(Times(Power(x,Plus(m,CN1)),Power(Plus(e,Times(f,Power(x,m))),CN1)),u,x),x),x),x))),And(FreeQ(List(a,b,c,d,e,f,g,r,m,n,q),x),IGtQ(p,C0),RationalQ(m),RationalQ(q)))),
...
IIntegrate(2828,Integrate(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),PolyLog(k_,Times(e_DEFAULT,Power(x_,q_DEFAULT)))),x_Symbol),
    Condition(Plus(Simp(Times(CN1,b,n,x,PolyLog(k,Times(e,Power(x,q)))),x),Simp(Times(x,PolyLog(k,Times(e,Power(x,q))),Plus(a,Times(b,Log(Times(c,Power(x,n)))))),x),Negate(Simp(Dist(q,Integrate(Times(PolyLog(Plus(k,CN1),Times(e,Power(x,q))),Plus(a,Times(b,Log(Times(c,Power(x,n)))))),x),x),x)),Simp(Dist(Times(b,n,q),Integrate(PolyLog(Plus(k,CN1),Times(e,Power(x,q))),x),x),x)),And(FreeQ(List(a,b,c,e,n,q),x),IGtQ(k,C0)))),
...
IIntegrate(2830,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,CN1),PolyLog(k_,Times(e_DEFAULT,Power(x_,q_DEFAULT)))),x_Symbol),
    Condition(Subtract(Simp(Times(PolyLog(Plus(k,C1),Times(e,Power(x,q))),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),Power(q,CN1)),x),Simp(Dist(Times(b,n,p,Power(q,CN1)),Integrate(Times(PolyLog(Plus(k,C1),Times(e,Power(x,q))),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,CN1)),Power(x,CN1)),x),x),x)),And(FreeQ(List(a,b,c,e,k,n,q),x),GtQ(p,C0)))),
IIntegrate(2831,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(x_,CN1),PolyLog(k_,Times(e_DEFAULT,Power(x_,q_DEFAULT)))),x_Symbol),
    Condition(Subtract(Simp(Times(PolyLog(k,Times(e,Power(x,q))),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,C1)),Power(Times(b,n,Plus(p,C1)),CN1)),x),Simp(Dist(Times(q,Power(Times(b,n,Plus(p,C1)),CN1)),Integrate(Times(PolyLog(Plus(k,CN1),Times(e,Power(x,q))),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),Plus(p,C1)),Power(x,CN1)),x),x),x)),And(FreeQ(List(a,b,c,e,k,n,q),x),LtQ(p,CN1)))),
IIntegrate(2832,Integrate(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),Power(Times(d_DEFAULT,x_),m_DEFAULT),PolyLog(k_,Times(e_DEFAULT,Power(x_,q_DEFAULT)))),x_Symbol),
    Condition(Plus(Simp(Times(CN1,b,n,Power(Times(d,x),Plus(m,C1)),PolyLog(k,Times(e,Power(x,q))),Power(Times(d,Sqr(Plus(m,C1))),CN1)),x),Simp(Times(Power(Times(d,x),Plus(m,C1)),PolyLog(k,Times(e,Power(x,q))),Plus(a,Times(b,Log(Times(c,Power(x,n))))),Power(Times(d,Plus(m,C1)),CN1)),x),Negate(Simp(Dist(Times(q,Power(Plus(m,C1),CN1)),Integrate(Times(Power(Times(d,x),m),PolyLog(Plus(k,CN1),Times(e,Power(x,q))),Plus(a,Times(b,Log(Times(c,Power(x,n)))))),x),x),x)),Simp(Dist(Times(b,n,q,Power(Plus(m,C1),CN2)),Integrate(Times(Power(Times(d,x),m),PolyLog(Plus(k,CN1),Times(e,Power(x,q)))),x),x),x)),And(FreeQ(List(a,b,c,d,e,m,n,q),x),IGtQ(k,C0)))),
...
IIntegrate(2834,Integrate(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),$p("§px",true),Power($(F_,Times(d_DEFAULT,Plus(e_DEFAULT,Times(f_DEFAULT,x_)))),m_DEFAULT)),x_Symbol),
    Condition(With(list(Set(u,IntHide(Times($s("§px"),Power(F(Times(d,Plus(e,Times(f,x)))),m)),x))),Subtract(Simp(Dist(Plus(a,Times(b,Log(Times(c,Power(x,n))))),u,x),x),Simp(Dist(Times(b,n),Integrate(Dist(Power(x,CN1),u,x),x),x),x))),And(FreeQ(List(a,b,c,d,e,f,n),x),PolynomialQ($s("§px"),x),IGtQ(m,C0),MemberQ(List(ArcSin,ArcCos,ArcSinh,ArcCosh),FSymbol)))),
IIntegrate(2835,Integrate(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))),b_DEFAULT)),$p("§px",true),$(F_,Times(d_DEFAULT,Plus(e_DEFAULT,Times(f_DEFAULT,x_))))),x_Symbol),
    Condition(With(list(Set(u,IntHide(Times($s("§px"),F(Times(d,Plus(e,Times(f,x))))),x))),Subtract(Simp(Dist(Plus(a,Times(b,Log(Times(c,Power(x,n))))),u,x),x),Simp(Dist(Times(b,n),Integrate(Dist(Power(x,CN1),u,x),x),x),x))),And(FreeQ(List(a,b,c,d,e,f,n),x),PolynomialQ($s("§px"),x),MemberQ(List(ArcTan,ArcCot,ArcTanh,ArcCoth),FSymbol)))),
IIntegrate(2836,Integrate(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(Plus(d_,Times(e_DEFAULT,x_)),n_DEFAULT))),b_DEFAULT)),p_DEFAULT),x_Symbol),
    Condition(Simp(Dist(Power(e,CN1),Subst(Integrate(Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p),x),x,Plus(d,Times(e,x))),x),x),FreeQ(List(a,b,c,d,e,n,p),x))),
IIntegrate(2837,Integrate(Times(Power(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Power(Plus(d_,Times(e_DEFAULT,x_)),n_DEFAULT))),b_DEFAULT)),p_DEFAULT),Power(Plus(f_,Times(g_DEFAULT,x_)),q_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Power(e,CN1),Subst(Integrate(Times(Power(Times(f,x,Power(d,CN1)),q),Power(Plus(a,Times(b,Log(Times(c,Power(x,n))))),p)),x),x,Plus(d,Times(e,x))),x),x),And(FreeQ(List(a,b,c,d,e,f,g,n,p,q),x),EqQ(Subtract(Times(e,f),Times(d,g)),C0)))),
...
IIntegrate(2839,Integrate(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Plus(d_,Times(e_DEFAULT,x_)))),b_DEFAULT)),Power(x_,CN1)),x_Symbol),
    Condition(Plus(Simp(Times(Plus(a,Times(b,Log(Times(c,d)))),Log(x)),x),Simp(Dist(b,Integrate(Times(Log(Plus(C1,Times(e,x,Power(d,CN1)))),Power(x,CN1)),x),x),x)),And(FreeQ(List(a,b,c,d,e),x),GtQ(Times(c,d),C0)))),
IIntegrate(2840,Integrate(Times(Plus(a_DEFAULT,Times(Log(Times(c_DEFAULT,Plus(d_,Times(e_DEFAULT,x_)))),b_DEFAULT)),Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),CN1)),x_Symbol),
    Condition(Simp(Dist(Power(g,CN1),Subst(Integrate(Times(Plus(a,Times(b,Log(Plus(C1,Times(c,e,x,Power(g,CN1)))))),Power(x,CN1)),x),x,Plus(f,Times(g,x))),x),x),And(FreeQ(List(a,b,c,d,e,f,g),x),NeQ(Subtract(Times(e,f),Times(d,g)),C0),EqQ(Plus(g,Times(c,Subtract(Times(e,f),Times(d,g)))),C0))))
  );
}
