...
public final class ModLong implements GcdRingElem<ModLong>, Modular {
  ...
  public ModLong inverse() /*throws NotInvertibleException*/ {
    try {
      ...
      long f = ring.modul / g;
      throw new ModularNotInvertibleException(
          e, new BigInteger(ring.modul), new BigInteger(g), new BigInteger(f));
    }
  }
   ...
   *
   * @return number of bits in the representation of this ModLong, including a sign bit.
   */
