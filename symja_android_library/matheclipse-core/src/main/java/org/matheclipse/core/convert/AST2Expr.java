...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "Package", "PadLeft", "PadRight", "ParametricPlot", "Parenthesis", "ParetoDistribution",
      "Part", "Partition", "PartitionsP", "PartitionsQ", "ParzenWindow", "PatternOrder",
      ...
      "PoissonDistribution", "PolyGamma", "Polygon", "PolygonalNumber", "Polyhedron", "PolyLog",
      ...
      "WordBoundary", "Xor", "YuleDissimilarity", "ZeroSymmetric", "Zeta"};
