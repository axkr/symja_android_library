...
/**
 * RecSolvablePolynomial generic recursive solvable polynomials implementing RingElem. n-variate
...
public class RecSolvablePolynomial<C extends RingElem<C>>
   ...
   */
  public RecSolvablePolynomial(
      RecSolvablePolynomialRing<C> r, GenSolvablePolynomial<GenPolynomial<C>> S) {
    this(r, S.val);
  }
   ...
   */
  protected RecSolvablePolynomial(
      RecSolvablePolynomialRing<C> r, SortedMap<ExpVector, GenPolynomial<C>> v) {
    this(r);
  ...
  /**
   * RecSolvablePolynomial left and right multiplication. Product with two polynomials.
   *
  ...
  /**
   * RecSolvablePolynomial left and right multiplication. Product with coefficient ring element.
   *
   * @param b coefficient polynomial.
   * @param c coefficient polynomial.
  ...
  /**
   * RecSolvablePolynomial left and right multiplication. Product with exponent vector.
   *
   * @param e exponent.
   * @param f exponent.
  ...
  /**
   * RecSolvablePolynomial multiplication. Product with ring element and exponent vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  /**
   * RecSolvablePolynomial left and right multiplication. Product with ring element and exponent
   * vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
   ...
   */
  @Override
  public RecSolvablePolynomial<C> multiply(
      GenPolynomial<C> b, ExpVector e, GenPolynomial<C> c, ExpVector f) {
    if (b == null || b.isZERO()) {
      return ring.getZERO();
    }
    if (c == null || c.isZERO()) {
  ...
  /**
   * RecSolvablePolynomial multiplication. Left product with ring element and exponent vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  /**
   * RecSolvablePolynomial multiplication. Left product with coefficient ring element.
   *
   * @param b coefficient polynomial.
  ...
  /**
   * RecSolvablePolynomial multiplication. Commutative product with exponent vector.
   *
  ...
  /**
   * RecSolvablePolynomial multiplication. Commutative product with coefficient.
   *
   * @param b coefficient.
   ...
   *
   * @return R = sum( X<sup>i</sup> b<sub>i</sub> ), with this = sum(a<sub>i</sub> X<sup>i</sup> )
