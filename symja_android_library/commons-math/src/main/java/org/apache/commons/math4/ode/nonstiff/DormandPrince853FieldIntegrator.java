    ...
    protected T estimateError(final T[][] yDotK, final T[] y0, final T[] y1, final T h) {
        ...
        for (int j = 0; j < mainSetDimension; ++j) {
            final T errSum1 =      yDotK[ 0][j].multiply(e1_01).
                               sum(yDotK[ 5][j].multiply(e1_06)).
                               sum(yDotK[ 6][j].multiply(e1_07)).
                               sum(yDotK[ 7][j].multiply(e1_08)).
                               sum(yDotK[ 8][j].multiply(e1_09)).
                               sum(yDotK[ 9][j].multiply(e1_10)).
                               sum(yDotK[10][j].multiply(e1_11)).
                               sum(yDotK[11][j].multiply(e1_12));
            final T errSum2 =      yDotK[ 0][j].multiply(e2_01).
                               sum(yDotK[ 5][j].multiply(e2_06)).
                               sum(yDotK[ 6][j].multiply(e2_07)).
                               sum(yDotK[ 7][j].multiply(e2_08)).
                               sum(yDotK[ 8][j].multiply(e2_09)).
                               sum(yDotK[ 9][j].multiply(e2_10)).
                               sum(yDotK[10][j].multiply(e2_11)).
                               sum(yDotK[11][j].multiply(e2_12));
            ...
            error1        = error1.sum(ratio1.multiply(ratio1));
            final T ratio2  = errSum2.divide(tol);
            error2        = error2.sum(ratio2.multiply(ratio2));
        }

        T den = error1.sum(error2.multiply(0.01));
        if (den.getReal() <= 0.0) {
