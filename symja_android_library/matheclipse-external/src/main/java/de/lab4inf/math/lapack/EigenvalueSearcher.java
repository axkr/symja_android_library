...
public final class EigenvalueSearcher extends L4MObject {
  ...
  /**
   * Calculate the biggest eigenvalue of symmetric matrix \a a within the given accuracy using the
   * power method.
   *
   * @param a matrix
  ...
  /**
   * Calculate the biggest eigenvalue of symmetric matrix \a a with default accuracy of 1.E-6 using
   * the power method.
   *
   * @param a matrix
   * @return eigenvalue
  ...
  /**
   * Calculate the all real eigenvalues of a symmetric matrix a via its characteristic polynomial.
   *
   * @param a the matrix
