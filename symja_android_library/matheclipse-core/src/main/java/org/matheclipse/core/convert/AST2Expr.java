...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "Names", "Nand", "NArgMax", "NArgMin", "ND", "NDSolve", "NExpectation", "Nearest",
      "NearestTo", "Needs", "Negative", "Nest", "NestList", "NestWhile", "NestWhileList",
      "NewLimit", "NextPrime", "NFourierTransform", "NIntegrate", "NMaximize", "NMaxValue",
      "NMinimize", "NMinValue", "NonCommutativeMultiply", "NonNegative", "NonPositive", "NoneTrue",
      "Nor", "Normal", "Normalize", "Norm", "NormalDistribution", "NormalMatrixQ", "Not",
      "NotElement", "NotListQ", "NProbability", "NProduct", "NRoots", "NSolve", "NSum", "NullSpace",
      ...
      "SameQ", "SatisfiabilityCount", "SatisfiabilityInstances", "SatisfiableQ", "Save",
      "SawtoothWave", "Scale", "Scaled", "ScalingTransform", "Scan", "ScientificForm",
