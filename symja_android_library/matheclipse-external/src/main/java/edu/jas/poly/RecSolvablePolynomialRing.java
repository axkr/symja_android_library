...
/**
 * RecSolvablePolynomialRing generic recursive solvable polynomial factory implementing RingFactory
...
public class RecSolvablePolynomialRing<C extends RingElem<C>>
   ...
   */
  public RecSolvablePolynomialRing(
      RingFactory<GenPolynomial<C>> cf, int n, RelationTable<GenPolynomial<C>> rt) {
   ...
   */
  public RecSolvablePolynomialRing(
      RingFactory<GenPolynomial<C>> cf, int n, TermOrder t, RelationTable<GenPolynomial<C>> rt) {
    this(cf, n, t, null, rt);
  }
   ...
   */
  public RecSolvablePolynomialRing(
      RingFactory<GenPolynomial<C>> cf, int n, TermOrder t, String[] v) {
    this(cf, n, t, v, null);
  }
   ...
   */
  public RecSolvablePolynomialRing(
      RingFactory<GenPolynomial<C>> cf,
      int n,
      TermOrder t,
      String[] v,
  ...
  public static <C extends RingElem<C>> // must be static because of types
    ...
    GenSolvablePolynomialRing<C> fring =
    ...
    List<GenPolynomial<GenPolynomial<C>>> rl =
        (List<GenPolynomial<GenPolynomial<C>>>)
            (List) PolynomialList.castToList(rf.coeffTable.relationList());
  ...
  public GenSolvablePolynomialRing<GenPolynomial<C>> permutation(List<Integer> P) {
    ...
    GenSolvablePolynomialRing<GenPolynomial<C>> pfac =
        (GenSolvablePolynomialRing<GenPolynomial<C>>) super.permutation(P);
    return pfac;
  }
}
