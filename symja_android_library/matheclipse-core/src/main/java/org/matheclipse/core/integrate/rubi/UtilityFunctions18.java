...
ISetDelayed(316,ExpandIntegrand(Times(Log(Times(c_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,Power(x_,n_DEFAULT))),p_DEFAULT))),u_,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(318,ExpandIntegrand(Times(Power($(F_,u_),m_DEFAULT),Power(Plus(a_,Times($(G_,u_),b_DEFAULT)),n_DEFAULT)),x_Symbol),
