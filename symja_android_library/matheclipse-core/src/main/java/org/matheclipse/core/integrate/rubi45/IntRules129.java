...
ISetDelayed(Int(Times(Power(x_,-1),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,-1),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),FresnelS(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),FresnelC(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(x_,FresnelS(Times(b_DEFAULT,x_)),Sin(Times(c_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_),FresnelS(Times(b_DEFAULT,x_)),Sin(Times(c_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_),Cos(Times(c_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(x_,FresnelC(Times(b_DEFAULT,x_)),Sin(Times(c_DEFAULT,Sqr(x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_),Cos(Times(c_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,m_),FresnelC(Times(b_DEFAULT,x_)),Sin(Times(c_DEFAULT,Sqr(x_)))),x_Symbol),
