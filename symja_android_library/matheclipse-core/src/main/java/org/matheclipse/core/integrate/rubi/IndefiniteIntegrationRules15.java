...
SetDelayed(Int(Times(Power(x_,$p("m",true)),Times(Power(ProductLog(Times($p("a",true),Power(x_,n_))),p_),Power(Plus(C1,ProductLog(Times($p("a",true),Power(x_,n_)))),CN1))),$p("x",$s("Symbol"))),
    Condition(Times(Times(Power(a,Plus(p,Times(CN1,C1D2))),Sqrt(Times(Times(CN1,Pi),Power(Plus(p,Times(CN1,C1D2)),CN1)))),Times(Erfi(Sqrt(Times(Times(CN1,Plus(p,Times(CN1,C1D2))),ProductLog(Times(a,Power(x,n)))))),Power(n,CN1))),And(And(And(FreeQ(List(a,m,n),x),IntegerQ(Plus(p,Times(CN1,C1D2)))),Less(p,C0)),ZeroQ(Plus(Plus(m,Times(n,Plus(p,Times(CN1,C1D2)))),C1))))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),Times(Power(ProductLog(Times($p("a",true),Power(x_,n_))),$p("p",true)),Power(Plus(C1,ProductLog(Times($p("a",true),Power(x_,n_)))),CN1))),$p("x",$s("Symbol"))),
    Condition(Times(CN1,Subst(Int(Times(Power(ProductLog(Times(a,Power(x,Times(CN1,n)))),p),Power(Times(Power(x,Plus(m,C2)),Plus(C1,ProductLog(Times(a,Power(x,Times(CN1,n)))))),CN1)),x),x,Times(C1,Power(x,CN1)))),And(And(And(FreeQ(List(a,p),x),IntegerQ(List(m,n))),Less(n,C0)),NonzeroQ(Plus(m,C1))))),
...
SetDelayed(Int(u_,$p("x",$s("Symbol"))),
    Condition(Module(List(Set(v,TrigSimplify(u))),Condition(Int(v,x),UnsameQ(v,u))),Not(MatchQ(u,Condition(Times(Times($p("w",true),Power(Plus($p("a",true),Times($p("b",true),v_)),$p("m",true))),Power(Plus($p("c",true),Times($p("d",true),v_)),$p("n",true))),And(And(And(FreeQ(List(a,b,c,d),x),IntegerQ(List(m,n))),Less(m,C0)),Less(n,C0))))))),
...
SetDelayed(Int(Times(u_,v_),$p("x",$s("Symbol"))),
    Condition(Module(List(Set(w,Block(List(Set($s("ShowSteps"),False),Set($s("StepCounter"),Null)),Int(v,x)))),Condition(Subst(Int(Regularize(SubstFor(w,u,x),x),x),x,w),FunctionOfQ(w,u,x))),And(SumQ(v),PolynomialQ(v,x)))),
...
SetDelayed(LinearSinCosQ(Power(u_,$p("n",true)),$p("x",$s("Symbol"))),
    And(And(And(IntegerQ(n),Greater(n,C0)),Or(SinQ(u),CosQ(u))),LinearQ(Part(u,C1),x))),
SetDelayed(Int(u_,$p("x",$s("Symbol"))),
...
SetDelayed(LinearSinhCoshQ(Power(u_,$p("n",true)),$p("x",$s("Symbol"))),
    And(And(And(IntegerQ(n),Greater(n,C0)),Or(SinhQ(u),CoshQ(u))),LinearQ(Part(u,C1),x))),
...
SetDelayed(TryTanSubst(u_,$p("x",$s("Symbol"))),
    And(And(And(And(And(And(FalseQ(FunctionOfLinear(u,x)),Not(MatchQ(u,Condition(Times($p("r",true),Power(Plus(s_,t_),$p("n",true))),And(IntegerQ(n),Greater(n,C0)))))),Not(MatchQ(u,Condition(Log(Power($(f_,x),C2)),SinCosQ(f))))),Not(MatchQ(u,Condition(Times(C1,Power(Plus(a_,Times($p("b",true),Power($(f_,x),n_))),CN1)),And(And(SinCosQ(f),IntegerQ(n)),Greater(n,C2)))))),Not(MatchQ(u,Condition(Times($(f_,Times($p("m",true),x)),$(g_,Times($p("n",true),x))),And(And(IntegerQ(List(m,n)),SinCosQ(f)),SinCosQ(g)))))),Not(MatchQ(u,Condition(Times($p("r",true),Power(Times($p("a",true),Power(s_,m_)),p_)),And(FreeQ(List(a,m,p),x),Not(And(SameQ(m,C2),Or(SameQ(s,Sec(x)),SameQ(s,Csc(x)))))))))),SameQ(u,ExpnExpand(u,x)))),
SetDelayed(Int(u_,$p("x",$s("Symbol"))),
...
SetDelayed(TryTanhSubst(u_,$p("x",$s("Symbol"))),
    And(And(And(And(And(And(FalseQ(FunctionOfLinear(u,x)),Not(MatchQ(u,Condition(Times($p("r",true),Power(Plus(s_,t_),$p("n",true))),And(IntegerQ(n),Greater(n,C0)))))),Not(MatchQ(u,Condition(Log(Power($(f_,x),C2)),SinhCoshQ(f))))),Not(MatchQ(u,Condition(Times(C1,Power(Plus(a_,Times($p("b",true),Power($(f_,x),n_))),CN1)),And(And(SinhCoshQ(f),IntegerQ(n)),Greater(n,C2)))))),Not(MatchQ(u,Condition(Times($(f_,Times($p("m",true),x)),$(g_,Times($p("n",true),x))),And(And(IntegerQ(List(m,n)),SinhCoshQ(f)),SinhCoshQ(g)))))),Not(MatchQ(u,Condition(Times($p("r",true),Power(Times($p("a",true),Power(s_,m_)),p_)),And(FreeQ(List(a,m,p),x),Not(And(SameQ(m,C2),Or(SameQ(s,Sech(x)),SameQ(s,Csch(x)))))))))),SameQ(u,ExpnExpand(u,x)))),
SetDelayed(Int(u_,$p("x",$s("Symbol"))),
    Condition(Module(List(Set($s("lst"),FunctionOfExponentialOfLinear(u,x))),Condition(Dist(Times(C1,Power(Times(Part($s("lst"),C3),Log(Part($s("lst"),C4))),CN1)),Subst(Int(Regularize(Times(Part($s("lst"),C1),Power(x,CN1)),x),x),x,Power(Part($s("lst"),C4),Plus(Part($s("lst"),C2),Times(Part($s("lst"),C3),x))))),Not(FalseQ($s("lst"))))),And(And(And(Not(MatchQ(u,Condition(Power(v_,$p("n",true)),And(And(SumQ(v),IntegerQ(n)),Greater(n,C0))))),Not(MatchQ(u,Condition(Times(Power(v_,$p("n",true)),Power(f_,Plus($p("a",true),Times($p("b",true),x)))),And(And(And(FreeQ(List(a,b,f),x),SumQ(v)),IntegerQ(n)),Greater(n,C0)))))),Not(MatchQ(u,Condition(Times(C1,Power(Plus(Plus($p("a",true),Times($p("b",true),Power(f_,Plus($p("d",true),Times($p("e",true),x))))),Times($p("c",true),Power(f_,Plus($p("g",true),Times($p("h",true),x))))),CN1)),And(And(FreeQ(List(a,b,c,d,e,f,g,h),x),ZeroQ(Plus(g,Times(CN1,Times(C2,d))))),ZeroQ(Plus(h,Times(CN1,Times(C2,e))))))))),FalseQ(FunctionOfHyperbolic(u,x))))),
SetDelayed(Int(Times(Power(x_,$p("m",true)),Power(f_,Plus($p("a",true),Times($p("b",true),Power(x_,$p("n",true)))))),$p("x",$s("Symbol"))),
    Condition(Times(CN1,Subst(Int(Times(Power(f,Plus(a,Times(b,Power(x,Times(CN1,n))))),Power(Power(x,Plus(m,C2)),CN1)),x),x,Times(C1,Power(x,CN1)))),And(And(And(And(FreeQ(List(a,b,f),x),IntegerQ(List(m,n))),Less(n,C0)),Less(m,CN1)),Equal(GCD(Plus(m,C1),n),C1)))),
SetDelayed(Int(Times(Power(x_,$p("m",true)),Power($(f_,Plus($p("a",true),Times($p("b",true),Power(x_,n_)))),$p("p",true))),$p("x",$s("Symbol"))),
    Condition(Times(CN1,Subst(Int(Times(Power($(f,Plus(a,Times(b,Power(x,Times(CN1,n))))),p),Power(Power(x,Plus(m,C2)),CN1)),x),x,Times(C1,Power(x,CN1)))),And(And(And(And(FreeQ(List(a,b,f,p),x),IntegerQ(List(m,n))),Less(n,C0)),Less(m,CN1)),Equal(GCD(Plus(m,C1),n),C1)))),
SetDelayed(Int(Times(u_,Power(Plus(a_,Times($p("b",true),Power(x_,n_))),m_)),$p("x",$s("Symbol"))),
    Condition(Times(Times(Power(Plus(a,Times(b,Power(x,n))),m),Power(Times(Power(x,Times(m,n)),Power(Plus(b,Times(a,Power(Power(x,n),CN1))),m)),CN1)),Int(Times(Times(u,Power(x,Times(m,n))),Power(Plus(b,Times(a,Power(Power(x,n),CN1))),m)),x)),And(And(And(And(FreeQ(List(a,b),x),FractionQ(m)),IntegerQ(n)),Less(n,CN1)),SameQ(u,ExpnExpand(u,x))))),
SetDelayed(Int(u_,$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),Power(Plus(a_,Times($p("b",true),Power(Plus(c_,Times($p("d",true),x_)),n_))),CN1)),$p("x",$s("Symbol"))),
    Condition(Dist(Times(C1,Power(d,CN1)),Subst(Int(Times(Power(Plus(Times(Times(CN1,c),Power(d,CN1)),Times(x,Power(d,CN1))),m),Power(Plus(a,Times(b,Power(x,n))),CN1)),x),x,Plus(c,Times(d,x)))),And(And(FreeQ(List(a,b,c,d),x),IntegerQ(List(m,n))),Greater(n,C2)))),
SetDelayed(Int(Times(Power(Plus(e_,Times($p("f",true),x_)),$p("m",true)),Power(Plus(a_,Times($p("b",true),Power(Plus(c_,Times($p("d",true),x_)),n_))),p_)),$p("x",$s("Symbol"))),
    Condition(Dist(Times(Power(Times(f,Power(d,CN1)),m),Power(d,CN1)),Subst(Int(Times(Power(x,m),Power(Plus(a,Times(b,Power(x,n))),p)),x),x,Plus(c,Times(d,x)))),And(And(FreeQ(List(a,b,c,d,e,f),x),IntegerQ(List(m,n,p))),ZeroQ(Plus(Times(d,e),Times(CN1,Times(c,f))))))),
...
SetDelayed(Int(Times(Power(Plus(u_,Power(x_,$p("p",true))),n_),v_),$p("x",$s("Symbol"))),
    Condition(Module(List(Set(z,DerivativeDivides(u,v,x))),Condition(Plus(Times(z,Times(Power(Plus(u,Power(x,p)),Plus(n,C1)),Power(Plus(n,C1),CN1))),Times(CN1,Dist(Times(z,p),Int(Times(Power(x,Plus(p,Times(CN1,C1))),Power(Plus(u,Power(x,p)),n)),x)))),Not(FalseQ(z)))),And(And(And(IntegerQ(p),RationalQ(n)),NonzeroQ(Plus(n,C1))),Not(AlgebraicFunctionQ(v,x))))),
SetDelayed(Int(Times(Times(Power(x_,$p("m",true)),Power(Plus(u_,Power(x_,$p("p",true))),n_)),v_),$p("x",$s("Symbol"))),
    Condition(Module(List(Set(z,DerivativeDivides(u,v,x))),Condition(Plus(Plus(Times(Times(z,Power(x,m)),Times(Power(Plus(u,Power(x,p)),Plus(n,C1)),Power(Plus(n,C1),CN1))),Times(CN1,Dist(Times(z,p),Int(Times(Power(x,Plus(Plus(m,p),Times(CN1,C1))),Power(Plus(u,Power(x,p)),n)),x)))),Times(CN1,Dist(Times(z,Times(m,Power(Plus(n,C1),CN1))),Int(Times(Power(x,Plus(m,Times(CN1,C1))),Power(Plus(u,Power(x,p)),Plus(n,C1))),x)))),Not(FalseQ(z)))),And(And(IntegerQ(List(m,p)),RationalQ(n)),NonzeroQ(Plus(n,C1))))),
...
SetDelayed(Int(Times($p("u",true),Power(Plus(a_,Times($p("b",true),Power(v_,n_))),m_)),$p("x",$s("Symbol"))),
    Condition(Dist(Power(a,m),Int(Times(u,Product(Power(Plus(C1,Times(CN1,Times(Times(Power(CN1,Times(C4,Times(k,Power(n,CN1)))),Rt(Times(Times(CN1,b),Power(a,CN1)),Times(n,C1D2))),Power(v,C2)))),m),List(k,C1,Times(n,C1D2)))),x)),And(And(And(And(FreeQ(List(a,b),x),IntegerQ(m)),Less(m,CN1)),EvenQ(n)),Greater(n,C2)))),
SetDelayed(Int(Times($p("u",true),Power(Plus(a_,Times($p("b",true),Power(v_,n_))),m_)),$p("x",$s("Symbol"))),
    Condition(Dist(Power(a,m),Int(Times(u,Product(Power(Plus(C1,Times(Times(Power(CN1,Times(C2,Times(k,Power(n,CN1)))),Rt(Times(b,Power(a,CN1)),n)),v)),m),List(k,C1,n))),x)),And(And(And(And(FreeQ(List(a,b),x),IntegerQ(m)),Less(m,CN1)),OddQ(n)),Greater(n,C1)))),
SetDelayed(Int(Times($p("u",true),Power(Plus(Plus(a_,Times($p("b",true),v_)),Times($p("c",true),w_)),m_)),$p("x",$s("Symbol"))),
    Condition(Dist(Times(C1,Power(Power(Times(C4,c),m),CN1)),Int(Times(Times(u,Power(Plus(Plus(b,Times(CN1,Sqrt(Plus(Power(b,C2),Times(CN1,Times(Times(C4,a),c)))))),Times(Times(C2,c),v)),m)),Power(Plus(Plus(b,Sqrt(Plus(Power(b,C2),Times(CN1,Times(Times(C4,a),c))))),Times(Times(C2,c),v)),m)),x)),And(And(And(FreeQ(List(a,b,c),x),IntegerQ(m)),Less(m,C0)),ZeroQ(Plus(w,Times(CN1,Power(v,C2))))))),
SetDelayed(Int(u_,$p("x",$s("Symbol"))),
