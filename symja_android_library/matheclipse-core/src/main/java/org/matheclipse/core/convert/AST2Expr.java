...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"$TimeZone", "AASTriangle", "Abort", "Abs",
      ...
      "AiryAiPrime", "AiryBi", "AiryBiPrime", "AlgebraicIntegerQ", "AlgebraicNumber", "Alignment",
      "AllPoints", "AllTrue", "Alphabet", "AlphabeticOrder", "Alternatives", "AmbientLight", "And",
      "AngerJ", "AnglePath", "AngleVector", "Animate", "AnimationDirection", "AnimationRate",
      "AnimationRepetitions", "AnimationRunning", "Animator", "Annotation", "AnnotationRules",
      "Annuity", "AnnuityDue", "Annulus", "Antialiasing", "AntihermitianMatrixQ",
      ...
      "ArcTanh", "Area", "Arg", "ArgMax", "ArgMin", "ArithmeticGeometricMean", "Array",
      ...
      "AtomQ", "Attributes", "AutoAction", "AutorunSequencing", "AxisObject", "Ball", "Band",
      ...
      "BlankNullSequence", "BlankSequence", "Blend", "Block", "Bold", "Bond", "BondList",
      ...
      "BooleanVariables", "BorelTannerDistribution", "BoundaryMeshRegion", "BoundaryMeshRegionQ",
      ...
      "BSplineFunction", "BSplineSurface", "BubbleChart", "Button", "ByteArray", "ByteArrayQ",
      "ByteArrayToString", "ByteCount", "CalendarConvert", "CalendarType", "Callout",
      "CalloutMarker", "CanberraDistance", "Cancel", "CancelButton", "CandlestickChart",
      "CantorMesh", "CapForm", "CapsuleShape", "CarlsonRC", "CarlsonRD", "CarlsonRF", "CarlsonRG",
      ...
      "CheckAbort", "Checkbox", "ChessboardDistance", "ChineseRemainder", "ChiSquareDistribution",
      ...
      "ClipPlanes", "ClipPlanesStyle", "Close", "ClosenessCentrality", "CMYKColor", "Coefficient",
      "CoefficientArrays", "CoefficientList", "CoefficientRules", "Cofactor", "Collect",
      "CollinearPoints", "Colon", "ColorData", "ColorDataFunction", "ColorRules", "ColorSetter",
      "ColorSlider", "Column", "Commonest", "CommonUnits", "CompatibleUnitQ", "Compile",
      ...
      "ComplexVectorPlot", "ComposeList", "ComposeSeries", "CompositeQ", "Composition",
      ...
      "Counts", "CountsBy", "Covariance", "CreateDirectory", "CreateFile", "CreateUUID", "Cross",
      "CrossMatrix", "Csc", "Csch", "Cube", "CubeRoot", "Cuboid", "Cumulant",
      "CumulantGeneratingFunction", "Curl", "CurveClosed", "CycleGraph", "Cycles", "Cyclotomic",
      "Cylinder", "Darker", "Dashing", "DataDistribution", "Dataset", "DateBounds", "Dated",
      "DateDifference", "DateInterval", "DateList", "DateListLogPlot", "DateListPlot",
      "DateListStepPlot", "DateObject", "DateObjectQ", "DateOverlapsQ", "DatePlus", "DateRange",
      "DateSelect", "DateString", "DateValue", "DateWithinQ", "DawsonF", "DayCount", "DayMatchQ",
      "DayName", "DayPlus", "DayRange", "DayRound", "DeBruijnSequence", "Decrement", "Decompose",
      "DedekindNumber", "Default", "DefaultButton", "DefaultDuration", "DefaultValues", "Defer",
      "Definition", "Deinitialization", "DelaunayMesh", "Delete", "DeleteCases", "DeleteDuplicates",
      "DeleteDuplicatesBy", "DeleteMissing", "Delimiter", "Denominator", "DensityHistogram",
      "DensityPlot", "Deployed", "Depth", "Derivative", "DesignMatrix", "Det", "Diagonal",
      ...
      "DiskSegment", "Dispatch", "DisplayAllSteps", "DisplayForm", "Distribute", "Distributed",
      "DistributionChart", "DistributionParameterQ", "Div", "Divide", "DivideBy", "DivideSides",
      "Divisible", "Divisors", "DivisorSigma", "DivisorSum", "Do", "Dodecahedron", "Dot",
      "DownValues", "Drop", "DropShadowing", "DSolve", "DSolveValue", "Dt", "DuplicateFreeQ",
      "Dynamic", "EasterSunday", "Echo", "EchoFunction", "EdgeAdd", "EdgeCount", "EdgeContract",
      "EdgeDelete", "EdgeForm", "EdgeLabelStyle", "EdgeList", "EdgeQ", "EdgeRules", "EdgeWeight",
      ...
      "EndTestSection", "Entity", "EntityClass", "EntityList", "EntityProperty", "Entropy", "Equal",
      "EqualTo", "Equivalent", "Erf", "Erfc", "Erfi", "ErlangDistribution", "EuclideanDistance",
      "EulerE", "EulerianGraphQ", "EulerPhi", "Evaluate", "EvaluationMonitor", "Evaluator", "EvenQ",
      "ExactNumberQ", "Except", "Exclusions", "ExclusionsStyle", "Exists", "Exit", "Exp", "Expand",
      ...
      "ExponentialPowerDistribution", "Export", "ExportString", "ExpressionGraph", "ExpToTrig",
      "ExtendedGCD", "ExtentElementFunction", "ExtentMarkers", "Extract", "FaceForm", "FaceGrids",
      ...
      "GreaterEqual", "GreaterEqualThan", "GreaterThan", "Grid", "GridGraph", "GroebnerBasis",
      "GroupBy", "Groupings", "GroupOrbits", "Gudermannian", "GumbelDistribution", "HalfLine",
      ...
      "Information", "Initialization", "Inner", "Input", "InputField", "InputForm", "InputStream",
      ...
      "Italic", "Item", "JaccardDissimilarity", "JacobiAmplitude", "JacobiCD", "JacobiCN",
      ...
      "JavaNew", "JavaObject", "JavaObjectQ", "JavaShow", "Join", "JoinedCurve", "JoinForm",
      "JordanDecomposition", "JSForm", "JSFormData", "JulianDate", "KagiChart", "KaryTree",
      "KelvinBei", "KelvinBer", "Key", "KeyDrop", "KeyDropFrom", "KeyExistsQ", "KeyFreeQ",
      "KeyComplement", "KeyIntersection", "KeyMap", "KeyMemberQ", "Keys", "KeySelect", "KeySort",
      "KeySortBy", "KeyTake", "KeyUnion", "KeyValueMap", "KeyValuePattern", "KirchhoffMatrix",
      ...
      "LABColor", "Labeled", "LaguerreL", "LambertW", "LaplaceDistribution", "LaplaceTransform",
      "Laplacian", "LaplacianPDETerm", "Last", "LCHColor", "LCM", "LeafCount", "LeapYearQ",
      "LeastSquares", "LegendAppearance", "LegendFunction", "LegendLabel", "LegendLayout",
      "LegendMargins", "LegendMarkers", "LegendMarkerSize", "LegendreP", "LegendreQ", "Length",
      "LengthWhile", "LerchPhi", "Less", "LessEqual", "LessEqualThan", "LessThan", "LetterCounts",
      "LetterNumber", "LetterQ", "Level", "LevelQ", "LeviCivitaTensor", "Lighter", "LightingAngle",
      ...
      "LineIntegralConvolutionPlot", "LineLegend", "LiouvilleLambda", "List", "ListAnimate",
      ...
      "LocalizeVariables", "Locator", "LocatorAutoCreate", "LocatorPane", "Log", "Log10", "Log2",
      ...
      "LogNormalDistribution", "LogPlot", "LogSeriesDistribution", "Longest", "Lookup",
      "LowerCaseQ", "LowerTriangularize", "LowerTriangularMatrixQ", "LucasL", "LUDecomposition",
      "LUVColor", "MachineNumberQ", "MakeBoxes", "MangoldtLambda", "ManhattanDistance",
      ...
      "NArgMin", "NCache", "ND", "NDSolve", "NDSolveValue", "Nearest", "NearestTo", "Needs",
      "Negative", "NegativeDefiniteMatrixQ", "NegativeSemidefiniteMatrixQ", "NeighborhoodGraph",
      "Nest", "NestList", "NestWhile", "NestWhileList", "NetGraph", "NExpectation", "NextDate",
      "NextPrime", "NFourierTransform", "NIntegrate", "NMaximize", "NMaxValue", "NMinimize",
      "NMinValue", "NoncentralChiSquareDistribution", "NonCommutativeMultiply",
      "NondimensionalizationTransform", "NoneTrue", "NonNegative", "NonPositive", "Nor", "Norm",
      "Normal", "NormalDistribution", "Normalize", "NormalMatrixQ", "NormalsFunction", "Not",
      "Notebook", "NotElement", "NotListQ", "NProbability", "NProduct", "NRoots", "NSolve",
      ...
      "PetersenGraph", "Pick", "Piecewise", "PiecewiseExpand", "PieChart", "Placed", "Plain",
      "PlanarAngle", "PlanarGraph", "PlanarGraphQ", "Plot", "Plot3D", "PlotFit", "PlotFitElements",
      ...
      "PrependTo", "PreviousDate", "Prime", "PrimeNu", "PrimeOmega", "PrimePi", "PrimePowerQ",
      "PrimeQ", "PrimeZetaP", "PrimitivePolynomialQ", "PrimitiveRoot", "PrimitiveRootList",
      ...
      "Proportional", "Protect", "PseudoInverse", "Put", "PutAppend", "Pyramid", "QPochhammer",
      ...
      "Quotient", "QuotientRemainder", "RadicalBox", "RadioButton", "RadioButtonBar", "Ramp",
      ...
      "RangeSpace", "RankDecomposition", "RankedMax", "RankedMin", "Raster", "Raster3D", "Rational",
      ...
      "Reap", "Rectangle", "RectangleChart", "Reduce", "Refine", "ReflectionTransform",
      "RefreshRate", "Region", "RegionBoundary", "RegionBoundaryStyle", "RegionBounds",
      "RegionCentroid", "RegionDimension", "RegionDistance", "RegionEmbeddingDimension",
      "RegionEqual", "RegionFunction", "RegionMeasure", "RegionMember", "RegionMoment",
      "RegionNearest", "RegionNearestFunction", "RegionPlot", "RegionQ", "RegionWithin",
      "RegularExpression", "RegularPolygon", "ReIm", "ReleaseHold", "ReliefPlot", "Remove",
      "RemoveDiacritics", "RenkoChart", "Repeated", "RepeatedNull", "RepeatedTiming", "Replace",
      "ReplaceAll", "ReplaceAt", "ReplaceList", "ReplacePart", "ReplaceRepeated", "Rescale",
      "Residue", "Resolve", "Rest", "Resultant", "Return", "Reverse", "ReverseElement",
      "ReverseEquilibrium", "ReverseSort", "ReverseUpEquilibrium", "RevolutionAxis",
      "RevolutionPlot3D", "RGBColor", "RiccatiSolve", "RiceDistribution", "RiemannSiegelTheta",
      ...
      "ScientificForm", "Sec", "Sech", "SechDistribution", "SectorChart", "SectorOrigin",
      "SectorSpacing", "SeedRandom", "Select", "SelectFirst", "SemanticImport",
      ...
      "SeriesData", "Set", "SetAttributes", "SetDelayed", "Setter", "SetterBar", "Share",
      ...
      "ShrinkingDelay", "Sign", "Signature", "SignCmp", "SignedRegionDistance", "Simplex",
      ...
      "Skewness", "Slider", "Slider2D", "Slot", "SlotNumber", "SlotSequence", "SlotSequenceNumber",
      "SmallCircle", "SmithDecomposition", "SmoothDensityHistogram", "SmoothHistogram",
      ...
      "StackedDateListPlot", "StackedListPlot", "StadiumShape", "StandardDeviation", "StandardForm",
      "Standardize", "Star", "StarGraph", "StatusArea", "StieltjesGamma", "StirlingS1",
      ...
      "SucceedsTilde", "SuchThat", "SudokuSolve", "Sum", "Summary", "Sunday", "SuperDagger",
      ...
      "SynchronousUpdating", "SyntaxLength", "SyntaxQ", "SystemDialogInput", "Table", "TableForm",
      ...
      "TextureCoordinateFunction", "TextureCoordinateScaling", "Therefore", "Thickness", "Thread",
      "ThreeJSymbol", "Through", "Throw", "Thursday", "Tilde", "TildeEqual", "TildeFullEqual",
      "TildeTilde", "TimeConstrained", "TimelinePlot", "TimeObject", "TimeRemaining", "Times",
      "TimesBy", "TimeValue", "TimeZone", "TimeZoneOffset", "Timing", "ToBoxes", "ToCharacterCode",
      ...
      "TrackedSymbols", "TradingChart", "TraditionalForm", "TransformationFunction",
      ...
      "TrigSimplifyFu", "TrigToExp", "TrueQ", "TTest", "Tube", "Tuesday", "TukeyWindow", "Tuples",
      ...
      "UpTee", "UpTeeArrow", "UpTo", "UpValues", "URLDecode", "URLEncode", "URLFetch", "ValueQ",
      "Values", "VandermondeMatrix", "Variables", "Variance", "VectorAngle", "VectorAspectRatio",
      ...
      "Verbatim", "VerificationTest", "VertexAdd", "VertexColors", "VertexContract", "VertexDelete",
      ...
      "ViewRange", "ViewVector", "ViewVertical", "Volume", "VoronoiMesh", "WaringYuleDistribution",
