...
IIntegrate(1953,Int(Times(Power(x_,m_DEFAULT),Plus(A_,Times(B_DEFAULT,Power(x_,j_DEFAULT))),Power(Plus(Times(b_DEFAULT,Power(x_,n_DEFAULT)),Times(a_DEFAULT,Power(x_,q_DEFAULT)),Times(c_DEFAULT,Power(x_,r_DEFAULT))),CN1D2)),x_Symbol),
    Condition(Dist(Times(Power(x,Times(C1D2,q)),Sqrt(Plus(a,Times(b,Power(x,Plus(n,Negate(q)))),Times(c,Power(x,Times(C2,Plus(n,Negate(q))))))),Power(Plus(Times(a,Power(x,q)),Times(b,Power(x,n)),Times(c,Power(x,Plus(Times(C2,n),Negate(q))))),CN1D2)),Int(Times(Power(x,Plus(m,Times(CN1,C1D2,q))),Plus(ASymbol,Times(BSymbol,Power(x,Plus(n,Negate(q))))),Power(Plus(a,Times(b,Power(x,Plus(n,Negate(q)))),Times(c,Power(x,Times(C2,Plus(n,Negate(q)))))),CN1D2)),x),x),And(FreeQ(List(a,b,c,ASymbol,BSymbol,m,n,q),x),EqQ(j,Plus(n,Negate(q))),EqQ(r,Plus(Times(C2,n),Negate(q))),PosQ(Plus(n,Negate(q))),Or(EqQ(m,C1D2),EqQ(m,Negate(C1D2))),EqQ(n,C3),EqQ(q,C1))));
