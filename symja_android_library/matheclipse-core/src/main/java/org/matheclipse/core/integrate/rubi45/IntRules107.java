...
ISetDelayed(Int(Times(Power(Plus(h_DEFAULT,Times(i_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSin(Times(c_DEFAULT,x_)))),n_DEFAULT),Power(Times(Sqrt(Plus(d_,Times(e_DEFAULT,x_))),Sqrt(Plus(f_,Times(g_DEFAULT,x_)))),CN1)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(h_DEFAULT,Times(i_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCos(Times(c_DEFAULT,x_)))),n_DEFAULT),Power(Times(Sqrt(Plus(d_,Times(e_DEFAULT,x_))),Sqrt(Plus(f_,Times(g_DEFAULT,x_)))),CN1)),x_Symbol),
