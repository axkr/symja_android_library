...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "DirectedInfinity", "Abs", "AddTo", "And", "Apart", "AppellF1", "Append",
			...
			"Head", "HilbertMatrix", "Hold", "Horner", "HypergeometricPFQ", "Hypergeometric2F1", "Identity", "IdentityMatrix",
			"If", "Im", "Increment", "Inner", "Insert", "IntegerPart", "IntegerPartitions", "IntegerQ", "Integrate",
			...
			"ListQ", "Log", "LogGamma", "LogIntegral", "LowerCaseQ", "LUDecomposition", "ManhattanDistance", "Map", "MapAll",
			"MapThread", "MatchQ", "MatrixForm", "MatrixPower", "MatrixQ", "MatrixRank", "Max", "Mean", "Median", "MemberQ", "Min",
			"Mod", "Module", "MoebiusMu", "MonomialList", "Most", "Multinomial", "N", "Negative", "Nest", "NestList", "NestWhile",
			...
			"PreIncrement", "Prepend", "PrependTo", "PrimeQ", "PrimitiveRoots", "Print", "Product", "ProductLog", "Quiet",
			...
			"Roots", "RotateLeft", "RotateRight", "Round", "RowReduce", "Rule", "RuleDelayed", "SameQ", "Scan", "Sec", "Sech",
