...
IIntegrate(6452,Int(Times(x_,FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(6453,Int(Times(x_,Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6454,Int(Times(Power(x_,m_),FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(6455,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6456,Int(Times(Power(x_,m_),FresnelS(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(6457,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelC(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6458,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Power(FresnelS(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT),Sin(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_))))),x_Symbol),
...
IIntegrate(6459,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Cos(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(FresnelC(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
IIntegrate(6460,Int(Times(x_,Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6461,Int(Times(x_,FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(6462,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6463,Int(Times(Power(x_,m_),FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(6464,Int(Times(Power(x_,m_),Cos(Times(d_DEFAULT,Sqr(x_))),FresnelS(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6465,Int(Times(Power(x_,m_),FresnelC(Times(b_DEFAULT,x_)),Sin(Times(d_DEFAULT,Sqr(x_)))),x_Symbol),
...
IIntegrate(6466,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Cos(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_)))),Power(FresnelS(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT)),x_Symbol),
...
IIntegrate(6467,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Power(FresnelC(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),n_DEFAULT),Sin(Plus(c_DEFAULT,Times(d_DEFAULT,Sqr(x_))))),x_Symbol),
...
IIntegrate(6468,Int(FresnelS(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(6469,Int(FresnelC(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(6471,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),FresnelS(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
IIntegrate(6472,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),FresnelC(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
IIntegrate(6474,Int(Times(Power(x_,m_DEFAULT),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6475,Int(Times(Power(x_,-1),ExpIntegralE(C1,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6476,Int(Times(Power(x_,m_),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6477,Int(Times(Power(Times(d_DEFAULT,x_),m_),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6478,Int(Times(Power(Times(d_DEFAULT,x_),m_DEFAULT),ExpIntegralE(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6479,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralE(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6480,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralE(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6481,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralE(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6483,Int(Times(Power(x_,-1),ExpIntegralEi(Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(6484,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1),ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Unintegrable(Times(ExpIntegralEi(Plus(a,Times(b,x))),Power(Plus(c,Times(d,x)),-1)),x),FreeQ(List(a,b,c,d),x))),
IIntegrate(6485,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),ExpIntegralEi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6487,Int(Times(Power(x_,m_DEFAULT),Sqr(ExpIntegralEi(Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6488,Int(Times(Power(x_,m_DEFAULT),Sqr(ExpIntegralEi(Plus(a_,Times(b_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(6490,Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Power(x_,m_DEFAULT),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6491,Int(Times(Exp(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Power(x_,m_),ExpIntegralEi(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(6492,Int(ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
IIntegrate(6493,Int(Times(Power(x_,-1),ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
    Condition(Dist(Power(n,-1),Subst(ExpIntegralEi(Times(d,Plus(a,Times(b,x)))),x,Log(Times(c,Power(x,n)))),x),FreeQ(List(a,b,c,d,n),x))),
IIntegrate(6494,Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),ExpIntegralEi(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
IIntegrate(6496,Int(Times(Power(x_,-1),LogIntegral(Times(b_DEFAULT,x_))),x_Symbol),
    Condition(Plus(Negate(Simp(Times(b,x),x)),Simp(Times(Log(Times(b,x)),LogIntegral(Times(b,x))),x)),FreeQ(b,x))),
IIntegrate(6497,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1),LogIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Unintegrable(Times(LogIntegral(Plus(a,Times(b,x))),Power(Plus(c,Times(d,x)),-1)),x),FreeQ(List(a,b,c,d),x))),
IIntegrate(6498,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),LogIntegral(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
