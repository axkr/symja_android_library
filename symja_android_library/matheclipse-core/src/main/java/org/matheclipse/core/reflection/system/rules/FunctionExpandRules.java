...
public class FunctionExpandRules {
  final public static IAST RULES = List(
      ...
      Set(Cos(Times(QQ(1L, 60L), Pi)),
          Plus(
              Times(C1DSqrt2,
                  Plus(Times(QQ(1L, 8L), CSqrt3, Plus(CN1, CSqrt5)),
                      Times(C1D4, Sqrt(Times(C1D2, Plus(C5, CSqrt5)))))),
              Times(C1DSqrt2,
                  Plus(Times(QQ(1L, 8L), Subtract(C1, CSqrt5)),
                      Times(C1D4, Sqrt(Times(QQ(3L, 2L), Plus(C5, CSqrt5)))))))),
      ...
      SetDelayed(Cos(Times(ArcCot(z_), $p(n, Integer))),
          Condition(Times(n, Sum(
              Times(Power(-1, k), Factorial(Plus(CN1, Negate(k), n)),
                  Power(Times(Power(C2, Plus(C1, Times(C2, k), Negate(n))), Factorial(k),
                      Factorial(Plus(Times(CN2, k), n))), CN1),
                  Power(Times(Power(z, CN2), Plus(C1, Sqr(z))), Plus(k, Times(CN1D2, n)))),
              list(k, C0, Floor(Times(C1D2, n))))), Greater(n, C0))),
      ...
      SetDelayed(FactorialPower(x_, n_, CN1),
          Times(Power(x, n), Gamma(Subtract(C1, x)),
              Power(Times(Power(Negate(x), n), Gamma(Plus(C1, Negate(n), Negate(x)))), CN1))),
      ...
      SetDelayed(FactorialPower(x_, $p(n, Integer), h_),
          Condition(Product(Plus(Times(CN1, h, k), x), list(k, C0, Plus(CN1, n))),
              And(Greater(n, C0), UnsameQ(h, C0)))),
      // FactorialPower(x_,n_,h_):=(x^n*Gamma(1+x/h))/((x/h)^n*Gamma(1-n+x/h))/;h=!=0
      SetDelayed(FactorialPower(x_, n_, h_),
          Condition(Times(Power(x, n), Gamma(Plus(C1, Times(Power(h, CN1), x))),
              Power(Times(Power(Times(Power(h, CN1), x), n),
                  Gamma(Plus(C1, Negate(n), Times(Power(h, CN1), x)))), CN1)),
              UnsameQ(h, C0))),
      // (Gamma(a_.Integer+z_)*x_.)/Gamma(b_.Integer+z_):=If(b<a,x*Product(z+i,{i,b,-1+a}),x/Product(z+i,{i,a,-1+b}))
      SetDelayed(
          Times(Gamma(Plus($p(a, Integer, true), z_)),
              Power(Gamma(Plus($p(b, Integer, true), z_)), CN1), x_DEFAULT),
          If(Less(b, a), Times(x, Product(Plus(z, i), list(i, b, Plus(CN1, a)))),
              Times(x, Power(Product(Plus(z, i), list(i, a, Plus(CN1, b))), CN1)))),
      ...
      SetDelayed(HurwitzZeta($p(n, Integer), a_),
          Condition(
              Times(Power(-1, n), Power(Factorial(Plus(CN1, n)), CN1), PolyGamma(Plus(CN1, n), a)),
              Greater(n, C1))),
      ...
      SetDelayed(HypergeometricPFQ(List(), list(a_), z_),
          Times(Power(z, Plus(C1D2, Times(CN1D2, a))), BesselI(Plus(CN1, a), Times(C2, Sqrt(z))),
              Gamma(a))),
      // HypergeometricPFQ({a_},{b_},z_):=Hypergeometric1F1(a,b,z)
      SetDelayed(HypergeometricPFQ(list(a_), list(b_), z_), Hypergeometric1F1(a, b, z)),
      // HypergeometricPFQ({a_,b_},{c_},z_):=Hypergeometric2F1(a,b,c,z)
      SetDelayed(HypergeometricPFQ(list(a_, b_), list(c_), z_), Hypergeometric2F1(a, b, c, z)),
      ...
      SetDelayed(InverseGudermannian(z_), Log(Tan(Plus(CPiQuarter, Times(C1D2, z))))),
      ...
      Set(Log(Power(x_, a_)), Condition(Times(a, Log(x)), And(Greater(x, C0), Element(a, Reals)))),
      ...
      Set(PolyGamma(C1, C1D4), Plus(Times(C8, Catalan), Sqr(Pi))),
      // PolyGamma(1,3/4)=-8*Catalan+Pi^2
      Set(PolyGamma(C1, QQ(3L, 4L)), Plus(Times(CN8, Catalan), Sqr(Pi))),
      // PolyGamma(2,1)=-2*Zeta(3)
      Set(PolyGamma(C2, C1), Times(CN2, Zeta(C3))),
      // PolyGamma(2,1/2)=-14*Zeta(3)
      Set(PolyGamma(C2, C1D2), Times(ZZ(-14L), Zeta(C3))),
      // PolyGamma(2,1/4)=-2*Pi^3-56*Zeta(3)
      Set(PolyGamma(C2, C1D4), Plus(Times(CN2, Power(Pi, C3)), Times(ZZ(-56L), Zeta(C3)))),
      // PolyGamma(2,3/4)=2*Pi^3-56*Zeta(3)
      Set(PolyGamma(C2, QQ(3L, 4L)), Plus(Times(C2, Power(Pi, C3)), Times(ZZ(-56L), Zeta(C3)))),
      ...
      Set(PolyGamma(CN2, C1D2),
          Plus(Times(QQ(5L, 24L), Log(C2)), Times(QQ(3L, 2L), Log(Glaisher)),
              Times(C1D4, Log(Pi)))),
      // PolyGamma(-2,1/4)=Catalan/(4*Pi)+1/8*9*Log(Glaisher)+1/8*(Log(2)+Log(Pi))
      Set(PolyGamma(CN2, C1D4),
          Plus(Times(C1D4, Catalan, Power(Pi, CN1)), Times(QQ(9L, 8L), Log(Glaisher)),
              Times(QQ(1L, 8L), Plus(Log(C2), Log(Pi))))),
      // PolyGamma(-2,1)=1/2*(Log(2)+Log(Pi))
      Set(PolyGamma(CN2, C1), Times(C1D2, Plus(Log(C2), Log(Pi)))),
      // PolyGamma(-2,2)=-1+Log(2)+Log(Pi)
      Set(PolyGamma(CN2, C2), Plus(CN1, Log(C2), Log(Pi))),
      // PolyGamma(-3,1/2)=Log(Glaisher)/2+1/16*(Log(2)+Log(Pi))+(7*Zeta(3))/(32*Pi^2)
      Set(PolyGamma(CN3, C1D2),
          Plus(Times(C1D2, Log(Glaisher)), Times(QQ(1L, 16L), Plus(Log(C2), Log(Pi))),
              Times(QQ(7L, 32L), Power(Pi, CN2), Zeta(C3)))),
      // PolyGamma(-3,1)=Log(Glaisher)+1/4*(Log(2)+Log(Pi))
      Set(PolyGamma(CN3, C1), Plus(Log(Glaisher), Times(C1D4, Plus(Log(C2), Log(Pi))))),
      // PolyGamma(-3,2)=-3/4+Log(2)+2*Log(Glaisher)+Log(Pi)
      Set(PolyGamma(CN3, C2), Plus(QQ(-3L, 4L), Log(C2), Times(C2, Log(Glaisher)), Log(Pi))),
      // PolyGamma(n_Integer,1/2):=(-1)^(n+1)*n!*(-1+2^(n+1))*Zeta(n+1)/;n>0
      SetDelayed(PolyGamma($p(n, Integer), C1D2),
          Condition(Times(Power(-1, Plus(n, C1)), Factorial(n), Plus(CN1, Power(C2, Plus(n, C1))),
      ...
      Set(PolyLog(C2, Times(C1D2, Subtract(C1, CSqrt5))),
          Plus(Times(QQ(-1L, 10L), Sqr(Pi)), Sqr(ArcCsch(C2)),
              Times(C1D2, Subtract(Times(QQ(1L, 15L), Sqr(Pi)), Sqr(ArcCsch(C2)))))),
      ...
      Set(PolyLog(C2, CC(1L, 2L, -1L, 2L)),
          Plus(Times(CNI, Catalan), Times(QQ(1L, 48L), Sqr(Pi)),
              Times(CN1D2, Sqr(Plus(Times(CC(0L, 1L, 1L, 4L), Pi), Times(CN1D2, Log(C2))))))),
      ...
      SetDelayed(Power(Abs(x_), $p(y, Integer)),
          Condition(With(list(Set(a, Quotient(y, C2))), Power(Plus(Sqr(Im(x)), Sqr(Re(x))), a)),
              EvenQ(y))),
      // I^x_:=E^Distribute(1/2*I*Pi*x)
      SetDelayed(Power(CI, x_), Exp(Distribute(Times(C1D2, CI, Pi, x)))),
          ...
          Plus(
              Times(C1DSqrt2,
                  Plus(Times(QQ(1L, 8L), CSqrt3, Plus(CN1, CSqrt5)),
                      Times(C1D4, Sqrt(Times(C1D2, Plus(C5, CSqrt5)))))),
              Times(C1DSqrt2,
                  Plus(Times(QQ(1L, 8L), Plus(CN1, CSqrt5)),
                      Times(CN1D4, Sqrt(Times(QQ(3L, 2L), Plus(C5, CSqrt5)))))))),
      ...
      SetDelayed(Sin(Times(ArcTan(z_), $p(n, Integer))), Condition(Times(
          ...
          Sum(Times(Power(-1, k), Binomial(n, Plus(Times(C2, k), C1)),
      ...
      SetDelayed(SphericalHarmonicY(l_, C0, t_, p_),
          Times(Sqrt(Plus(C1, Times(C2, l))), Power(Times(C2, CSqrtPi), CN1),
              LegendreP(l, Cos(t)))),
      ...
      SetDelayed(SphericalHarmonicY(l_, C1, t_, p_),
          Times(CN1, Exp(Times(CI, p)), l, Plus(C1, l), Sqrt(Plus(C1, Times(C2, l))),
              Sqrt(Gamma(l)), Power(Times(C4, CSqrtPi, Sqrt(Gamma(Plus(C2, l)))), CN1),
              Hypergeometric2F1(Subtract(C1, l), Plus(C2, l), C2, Sqr(Sin(Times(C1D2, t)))),
              Sin(t))),
      ...
      SetDelayed(SphericalHarmonicY(l_, m_, t_, p_),
          Times(Exp(Times(CI, m, p)), Sqrt(Plus(C1, Times(C2, l))),
              Sqrt(Gamma(Plus(C1, l, Negate(m)))),
              Power(Times(Power(Subtract(C1, Cos(t)), m), C2, CSqrtPi, Gamma(Subtract(C1, m)),
                  Sqrt(Gamma(Plus(C1, l, m)))), CN1),
              Hypergeometric2F1(Negate(l), Plus(C1, l), Subtract(C1, m), Sqr(Sin(Times(C1D2, t)))),
              Power(Sin(t), m))),
      // WhittakerM(0,m_,z_):=4^m*Sqrt(z)*BesselI(m,z/2)*Gamma(1+m)
      SetDelayed(WhittakerM(C0, m_, z_),
          Times(Power(C4, m), Sqrt(z), BesselI(m, Times(C1D2, z)), Gamma(Plus(C1, m)))),
      ...
      SetDelayed(WhittakerW(C0, m_, z_),
          Times(Power(Pi, CN1D2), Sqrt(z), BesselK(m, Times(C1D2, z)))),
      // WhittakerW(k_,0,z_):=(Sqrt(z)*HypergeometricU(1/2-k,1,z))/E^(z/2)
      SetDelayed(WhittakerW(k_, C0, z_),
          Times(Power(Exp(Times(C1D2, z)), CN1), Sqrt(z),
              HypergeometricU(Subtract(C1D2, k), C1, z))),
      ...
      SetDelayed(Zeta($p(n, Integer), x_),
          Condition(Times(Power(Times(Power(-1, n), Factorial(Plus(CN1, n))), CN1),
      ...
      SetDelayed($($(Derivative(C1), Zeta), $p(m, Integer)),
          With(list(Set(n, Times(CN1D2, m))),
              Condition(
                  Times(C1D2, Power(-1, n), Power(Power(C2Pi, Times(C2, n)), CN1),
                      Factorial(Times(C2, n)), Zeta(Plus(Times(C2, n), C1))),
                  And(EvenQ(m), Less(m, CN1))))),
      // Zeta'(2):=1/6*Pi^2*(EulerGamma+Log(2)-12*Log(Glaisher)+Log(Pi))
      SetDelayed($($(Derivative(C1), Zeta), C2), Times(QQ(1L, 6L), Sqr(Pi),
          Plus(EulerGamma, Log(C2), Times(ZZ(-12L), Log(Glaisher)), Log(Pi)))));
}
