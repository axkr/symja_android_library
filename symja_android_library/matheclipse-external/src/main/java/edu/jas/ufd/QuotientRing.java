...
/**
 * Quotient ring factory based on GenPolynomial with RingElem interface. Objects of this class are
 * immutable.
 *
 * @author Heinz Kredel
 */
public class QuotientRing<C extends GcdRingElem<C>>
  ...
  /**
   * Parse Quotient from String. Syntax: "{ polynomial | polynomial }" or "{ polynomial }" or "
