...
public class MatrixSolver02_BlockLanczos extends MatrixSolver {
	...
	@Override
	protected void solve(List<Congruence> congruences, Map<Integer, Integer> factors_2_columnIndices)
		...
		// LOG.debug("constructed matrix with " + matrixBlength + " rows and " + factors_2_columnIndices.size() + "
		// columns");
