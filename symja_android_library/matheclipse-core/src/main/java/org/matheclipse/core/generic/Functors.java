...
public class Functors {
	...
	private static class EvalArgFunctor implements Function<IExpr, IExpr> {
		...
		/**
		 * Create a functor which evaluates the given <code>ast</code> as a function with the argument at the given
		 * <code>position</code> replaced in the <code>apply()</code> method.
		 * 
		 * @param ast
	...
	/**
	 * Return a function which clones the given AST and appends the argument to the cloned AST in the <code>apply()</code> method.
	 * The clone is then appended to the result collection.
	 * 
	 * @param ast
	...
	/**
	 * Return a function which clones the argument, if it is of type AST and sets the header to the given <code>expr</code>.
	 * <code>expr</code> is typically a symbol.
	 * 
	 * @param expr
	 * @return
	 */
	...
	/**
	 * Return a function which returns the given expression in the <code>apply()</code> method.
	 * 
	 * @param expr
	 * @return
	 */
	...
	/**
	 * Create a functor, which replaces all (sub-)expressions in <code>ast</code> which equals <code>lhs</code> with the argument of
	 * the functors <code>apply()</code> method.
	 * 
	 * @param ast
	 *            an AST which contains the <code>lhs</code> as a placeholder in it's subexpressions.
	 * @param lhs
	...
	/**
	 * Create a functor, which replaces the argument at the first position in the <code>ast</code> with the argument of the functors
	 * <code>apply()</code> method.
	 * 
	 * @param ast
	 *            an AST where the first argument is replaced with the argument of the functors <code>apply()</code> method.
	 * @return
	...
	/**
	 * Create a functor, which replaces the argument at the second position in the <code>ast</code> with the argument of the
	 * functors <code>apply()</code> method.
	 * 
	 * @param ast
	 *            an AST where the second argument is replaced with the argument of the functors <code>apply()</code> method.
	 * @return
	 * @deprecated use {@link #replaceArg(IAST, int)} instead
	 */
	...
	/**
	 * Create a functor, which replaces the argument at the given position in the <code>ast</code> with the argument of the functors
	 * <code>apply()</code> method.
	 * 
	 * @param ast
	 *            an AST where the element at the given <code>position</code> is replaced with the argument of the functors
	 *            <code>apply()</code> method.
	 * @param position
	 *            the position of the element, which should be replaced in the <code>ast</code>.
	 * @return
	 */
	...
	/**
	 * Create a functor from the given map, which calls the <code>rulesMap.get()</code> in the functors <code>apply</code>method.
	 * 
	 * @param rulesMap
	 * @return
	 */
	...
	/**
	 * Create a functor from the given rules. If <code>astRules</code> is a <code>List[]</code> object, the elements of the list are
	 * taken as the rules of the form <code>Rule[lhs, rhs]</code>, otherwise the <code>astRules</code> itself is taken as the
	 * <code>Rule[lhs, rhs]</code>.
	 * 
	 * @param astRules
	 * @return
	 * @throws WrongArgumentType
	...
	/**
	 * A predicate to determine if an expression is an instance of <code>IPattern</code> or <code>IPatternSequence</code>.
	 */
	private static Predicate<IExpr> PATTERNQ_PREDICATE = new Predicate<IExpr>() {
		@Override
		public boolean apply(IExpr input) {
			return input.isPattern() || input.isPatternSequence();
		}
	};
