...
public class ListLinePlotExample {
	private final static String WEB_PAGE = //
			"<html>\n" + //
					...
					"<body>\n" + //
					"\n" + //
					"<script src=\"https://cdn.jsdelivr.net/gh/paulmasson/math@1.2.3/build/math.js\"></script>" + //
					"\n" + //
	...
	public static void main(String[] args) {
		try {
			...
			// "Manipulate(ListLinePlot({1*a, 1*a, 2*a, 3*a, 5*a, 8*a}), {a,1,4,1})");
			IExpr result = util.eval(
