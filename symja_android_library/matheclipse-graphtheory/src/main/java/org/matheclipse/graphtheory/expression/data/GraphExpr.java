...
public class GraphExpr<T> extends DataExpr<Graph<IExpr, T>>
    implements Externalizable, IGraphExpr {
  ...
  public static GraphExpr<ExprWeightedEdge> createWeightedGraph(final IAST vertices,
    ...
    EdgeListType t = arg1.isListOfEdges();
    if (t != null) {
  ...
  public static IExpr unwrapEdge(IExpr expr) {
    return org.matheclipse.core.expression.EdgeUtil.unwrapEdge(expr);
  }
  ...
  /**
   * Create a JGraphT graph for the given {@link EdgeListType}, which may be directed, undirected
   * or mixed. A mixed graph has no counterpart in the JGraphT library and is represented by a directed
   ...
   */
  private static Graph<IExpr, ExprEdge> buildGraph(EdgeListType t, final IAST vertices,
      final IAST edges) {
    final boolean mixed = t == EdgeListType.MIXED;
    Graph<IExpr, ExprEdge> resultGraph;
    if (mixed) {
      resultGraph = new DirectedPseudograph<IExpr, ExprEdge>(ExprEdge.class);
    } else if (t == EdgeListType.DIRECTED) {
      resultGraph = new DefaultDirectedGraph<IExpr, ExprEdge>(ExprEdge.class);
    } else {
      resultGraph = new DefaultUndirectedGraph<IExpr, ExprEdge>(ExprEdge.class);
    }
  ...
  public static GraphExpr<ExprEdge> newInstance(final IAST vertices, final IAST edges) {
    EdgeListType t = edges.isListOfEdges();
    if (t != null) {
  ...
  /** {@inheritDoc} */
  @Override
  public void graphExport(java.io.Writer writer, org.matheclipse.core.io.Extension format)
      throws java.io.IOException {
    @SuppressWarnings("unchecked")
    Graph<IExpr, org.jgrapht.graph.DefaultEdge> graph =
        (Graph<IExpr, org.jgrapht.graph.DefaultEdge>) toData();
    try {
      switch (format) {
        case DOT:
          org.jgrapht.nio.dot.DOTExporter<IExpr, org.jgrapht.graph.DefaultEdge> dotExporter =
              new org.jgrapht.nio.dot.DOTExporter<>();
          dotExporter.setGraphAttributeProvider(() -> {
            java.util.Map<String, org.jgrapht.nio.Attribute> map =
                new java.util.LinkedHashMap<String, org.jgrapht.nio.Attribute>();
            map.put("overlap", org.jgrapht.nio.DefaultAttribute.createAttribute("false"));
            map.put("splines", org.jgrapht.nio.DefaultAttribute.createAttribute("true"));
            return map;
          });
          dotExporter.exportGraph(graph, writer);
          return;
        case GRAPHML:
          new org.jgrapht.nio.graphml.GraphMLExporter<IExpr, org.jgrapht.graph.DefaultEdge>()
              .exportGraph(graph, writer);
          return;
        default:
          // DEFAULT: an edge-list CSV
          new org.jgrapht.nio.csv.CSVExporter<IExpr, org.jgrapht.graph.DefaultEdge>(
              v -> String.valueOf(v), org.jgrapht.nio.csv.CSVFormat.EDGE_LIST, ';')
                  .exportGraph(graph, writer);
      }
    } catch (org.jgrapht.nio.ExportException e) {
