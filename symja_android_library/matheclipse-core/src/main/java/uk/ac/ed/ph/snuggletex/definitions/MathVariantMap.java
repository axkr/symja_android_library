...
/**
 * This map encapsulates how to apply certain types of Mathematical character variants to "safe and plain" Unicode
 * characters by mapping them to other characters.
 * 
 * @see MathVariantMaps
 *
 * @author David McKain
...
public final class MathVariantMap {
	...
	public MathVariantMap(final String mathVariantName, final char[] accentData) {
		...
		char ascii, accented;
		int index;
		int length = accentData.length - 1;
