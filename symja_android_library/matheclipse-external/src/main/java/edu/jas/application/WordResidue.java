...
/**
 * WordResidue ring element based on GenWordPolynomial with GcdRingElem interface. Objects of this
 * class are immutable.
 *
 * @author Heinz Kredel
 */
public class WordResidue<C extends GcdRingElem<C>>
  ...
  /**
   * The constructor creates a WordResidue object from a ring factory, a polynomial and an indicator
   * if a is a unit.
   *
   * @param r solvable residue ring factory.
   * @param a solvable polynomial.
