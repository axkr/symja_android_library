...
IIntegrate(10397,Int(Times(Power(Times(f_DEFAULT,x_),m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10398,Int(Times(Power(Times(f_DEFAULT,x_),m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10399,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10400,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10401,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10402,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10403,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10404,Int(Times(Power(x_,m_DEFAULT),Power(Plus(d_DEFAULT,Times(e_DEFAULT,Sqr(x_))),p_),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
...
IIntegrate(10405,Int(Times(u_,Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10406,Int(Times(u_,Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_))))),x_Symbol),
...
IIntegrate(10407,Int(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
    Condition(Unintegrable(Times(u,Power(Plus(a,Times(b,ArcSech(Times(c,x)))),n)),x),FreeQ(List(a,b,c,n),x))),
IIntegrate(10408,Int(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Times(c_DEFAULT,x_)))),n_DEFAULT)),x_Symbol),
    Condition(Unintegrable(Times(u,Power(Plus(a,Times(b,ArcCsch(Times(c,x)))),n)),x),FreeQ(List(a,b,c,n),x))),
IIntegrate(10409,Int(ArcSech(Plus(c_,Times(d_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10410,Int(ArcCsch(Plus(c_,Times(d_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10411,Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT),x_Symbol),
...
IIntegrate(10412,Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT),x_Symbol),
...
IIntegrate(10413,Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_),x_Symbol),
    Condition(Unintegrable(Power(Plus(a,Times(b,ArcSech(Plus(c,Times(d,x))))),p),x),And(FreeQ(List(a,b,c,d,p),x),Not(IGtQ(p,C0))))),
IIntegrate(10414,Int(Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_),x_Symbol),
    Condition(Unintegrable(Power(Plus(a,Times(b,ArcCsch(Plus(c,Times(d,x))))),p),x),And(FreeQ(List(a,b,c,d,p),x),Not(IGtQ(p,C0))))),
IIntegrate(10415,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10416,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10417,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10418,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10419,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10420,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_DEFAULT)),x_Symbol),
...
IIntegrate(10421,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(Plus(c_,Times(d_DEFAULT,x_))))),p_)),x_Symbol),
...
IIntegrate(10422,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(Plus(c_,Times(d_DEFAULT,x_))))),p_)),x_Symbol),
...
IIntegrate(10423,Int(Times(u_DEFAULT,Power(ArcSech(Times(c_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(x_,n_DEFAULT))),-1))),m_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(ArcCosh(Plus(Times(a,Power(c,-1)),Times(b,Power(x,n),Power(c,-1)))),m)),x),FreeQ(List(a,b,c,n,m),x))),
IIntegrate(10424,Int(Times(u_DEFAULT,Power(ArcCsch(Times(c_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,Power(x_,n_DEFAULT))),-1))),m_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(ArcSinh(Plus(Times(a,Power(c,-1)),Times(b,Power(x,n),Power(c,-1)))),m)),x),FreeQ(List(a,b,c,n,m),x))),
IIntegrate(10425,Int(Exp(ArcSech(Times(a_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10426,Int(Exp(ArcSech(Times(a_DEFAULT,Power(x_,p_)))),x_Symbol),
...
IIntegrate(10427,Int(Exp(ArcCsch(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),x_Symbol),
...
IIntegrate(10428,Int(Exp(Times(n_DEFAULT,ArcSech(u_))),x_Symbol),
...
IIntegrate(10429,Int(Exp(Times(n_DEFAULT,ArcCsch(u_))),x_Symbol),
    Condition(Int(Power(Plus(Power(u,-1),Sqrt(Plus(C1,Power(u,-2)))),n),x),IntegerQ(n))),
IIntegrate(10430,Int(Times(Exp(ArcSech(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),Power(x_,-1)),x_Symbol),
...
IIntegrate(10431,Int(Times(Exp(ArcSech(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),Power(x_,m_DEFAULT)),x_Symbol),
...
IIntegrate(10432,Int(Times(Exp(ArcCsch(Times(a_DEFAULT,Power(x_,p_DEFAULT)))),Power(x_,m_DEFAULT)),x_Symbol),
...
IIntegrate(10433,Int(Times(Exp(Times(n_DEFAULT,ArcSech(u_))),Power(x_,m_DEFAULT)),x_Symbol),
...
IIntegrate(10434,Int(Times(Exp(Times(n_DEFAULT,ArcCsch(u_))),Power(x_,m_DEFAULT)),x_Symbol),
    Condition(Int(Times(Power(x,m),Power(Plus(Power(u,-1),Sqrt(Plus(C1,Power(u,-2)))),n)),x),And(FreeQ(m,x),IntegerQ(n)))),
IIntegrate(10435,Int(Times(Exp(ArcSech(Times(c_DEFAULT,x_))),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
IIntegrate(10436,Int(Times(Exp(ArcCsch(Times(c_DEFAULT,x_))),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
IIntegrate(10437,Int(Times(Exp(ArcSech(Times(c_DEFAULT,x_))),Power(Times(d_DEFAULT,x_),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
IIntegrate(10438,Int(Times(Exp(ArcCsch(Times(c_DEFAULT,x_))),Power(Times(d_DEFAULT,x_),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),-1)),x_Symbol),
...
IIntegrate(10439,Int(ArcSech(u_),x_Symbol),
...
IIntegrate(10440,Int(ArcCsch(u_),x_Symbol),
...
IIntegrate(10441,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(u_)))),x_Symbol),
...
IIntegrate(10442,Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(u_)))),x_Symbol),
...
IIntegrate(10443,Int(Times(v_,Plus(a_DEFAULT,Times(b_DEFAULT,ArcSech(u_)))),x_Symbol),
...
IIntegrate(10444,Int(Times(v_,Plus(a_DEFAULT,Times(b_DEFAULT,ArcCsch(u_)))),x_Symbol),
...
IIntegrate(10445,Int(Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
...
IIntegrate(10446,Int(Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),x_Symbol),
