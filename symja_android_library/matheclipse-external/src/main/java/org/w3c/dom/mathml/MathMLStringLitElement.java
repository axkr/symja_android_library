...
/**
 * This interface extends the MathMLPresentationToken interface for the MathML string literal
 * element ms.
 */
public interface MathMLStringLitElement extends MathMLPresentationToken {
  /**
   * A string giving the opening delimiter for the string literal; represents the lquote attribute
   * for the ms element, if specified.
   *
   ...
   *
   * @param lquote new value for lquote.
   * @see #getLquote()
   */
  void setLquote(String lquote);

  /**
   * A string giving the closing delimiter for the string literal; represents the rquote attribute
   * for the ms element, if specified.
   *
   ...
   *
   * @param rquote new value for rquote.
   * @see #getRquote()
   */
