...
public interface SolvableReduction<C extends RingElem<C>> extends Serializable {
   ...
   */
  public GenSolvablePolynomial<C> leftSPolynomial(
      GenSolvablePolynomial<C> Ap, GenSolvablePolynomial<C> Bp);
   ...
   */
  public List<GenSolvablePolynomial<C>> leftNormalform(
      List<GenSolvablePolynomial<C>> Pp, List<GenSolvablePolynomial<C>> Ap);
   ...
   */
  public boolean isLeftReductionNF(
      List<GenSolvablePolynomial<C>> row,
      List<GenSolvablePolynomial<C>> Pp,
      GenSolvablePolynomial<C> Ap,
   ...
   */
  public GenSolvablePolynomial<C> rightSPolynomial(
      GenSolvablePolynomial<C> Ap, GenSolvablePolynomial<C> Bp);
  ...
  /**
   * Is top reducible. Condition is lt(B) | lt(A) for some B in F. Is left right symetric.
   *
   * @param A polynomial.
   ...
   */
  public GenSolvablePolynomial<C> normalform(
      List<GenSolvablePolynomial<C>> Pp, GenSolvablePolynomial<C> Ap);
}
