...
/**
 * QuotSolvablePolynomialRing generic recursive solvable polynomial factory implementing RingFactory
 * and extending GenSolvablePolynomialRing factory. Factory for n-variate ordered solvable
 * polynomials over solvable polynomial coefficients. The non-commutative multiplication relations
 * are maintained in a relation table and the non-commutative multiplication relations between the
 * coefficients and the main variables are maintained in a coefficient relation table. Almost
 * immutable object, except variable names and relation table contents. Will be deprecated use
 * <code>QLRSolvablePolynomialRing</code>
 *
...
public class QuotSolvablePolynomialRing<C extends GcdRingElem<C>>
  ...
  public QuotSolvablePolynomialRing(
      RingFactory<SolvableQuotient<C>> cf, int n, RelationTable<SolvableQuotient<C>> rt) {
   ...
   */
  public QuotSolvablePolynomialRing(
      RingFactory<SolvableQuotient<C>> cf,
      int n,
      TermOrder t,
   ...
   */
  public QuotSolvablePolynomialRing(
      RingFactory<SolvableQuotient<C>> cf, int n, TermOrder t, String[] v) {
    this(cf, n, t, v, null);
  }
   ...
   */
  public QuotSolvablePolynomialRing(
      RingFactory<SolvableQuotient<C>> cf, GenSolvablePolynomialRing o) {
   ...
   */
  public QuotSolvablePolynomialRing(
      RingFactory<SolvableQuotient<C>> cf, QuotSolvablePolynomialRing o) {
  ...
  public QuotSolvablePolynomialRing<C> extend(int i, boolean top) {
    ...
    QuotSolvablePolynomialRing<C> spfac =
        new QuotSolvablePolynomialRing<C>(pfac.coFac, pfac.nvar, pfac.tord, pfac.getVars());
   ...
   * SolvableQuotient<C> coefficients.
   *
