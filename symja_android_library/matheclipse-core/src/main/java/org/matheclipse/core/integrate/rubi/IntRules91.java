...
IIntegrate(8529,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sec(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),-1),Power($(F_,Plus(c_DEFAULT,Times(d_DEFAULT,x_))),n_DEFAULT),Power($(G_,Plus(c_DEFAULT,Times(d_DEFAULT,x_))),p_DEFAULT)),x_Symbol),
...
IIntegrate(8530,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Csc(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),-1),Power($(F_,Plus(c_DEFAULT,Times(d_DEFAULT,x_))),n_DEFAULT),Power($(G_,Plus(c_DEFAULT,Times(d_DEFAULT,x_))),p_DEFAULT)),x_Symbol),
...
IIntegrate(8531,Int(Times(Power(Sin(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),p_DEFAULT),Power(Sin(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),q_DEFAULT)),x_Symbol),
...
IIntegrate(8532,Int(Times(Power(Cos(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),p_DEFAULT),Power(Cos(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),q_DEFAULT)),x_Symbol),
...
IIntegrate(8533,Int(Times(Power(Cos(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),q_DEFAULT),Power(Sin(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),p_DEFAULT)),x_Symbol),
...
IIntegrate(8534,Int(Times(Power(Cos(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),p_DEFAULT),Power(Sin(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),q_DEFAULT)),x_Symbol),
...
IIntegrate(8535,Int(Times(Sin(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Tan(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(8536,Int(Times(Cos(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Cot(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(8537,Int(Times(Cot(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),Sin(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(8538,Int(Times(Cos(Plus(a_DEFAULT,Times(b_DEFAULT,x_))),Tan(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))),x_Symbol),
...
IIntegrate(8539,Int(Power(Sin(Times(a_DEFAULT,Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1))),n_DEFAULT),x_Symbol),
...
IIntegrate(8540,Int(Power(Cos(Times(a_DEFAULT,Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1))),n_DEFAULT),x_Symbol),
...
IIntegrate(8541,Int(Power(Sin(Times(e_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_)),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1))),n_DEFAULT),x_Symbol),
...
IIntegrate(8542,Int(Power(Cos(Times(e_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_)),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1))),n_DEFAULT),x_Symbol),
...
IIntegrate(8543,Int(Power(Sin(u_),n_DEFAULT),x_Symbol),
...
IIntegrate(8544,Int(Power(Cos(u_),n_DEFAULT),x_Symbol),
...
IIntegrate(8545,Int(Times(u_DEFAULT,Power(Sin(v_),p_DEFAULT),Power(Sin(w_),q_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(Sin(v),Plus(p,q))),x),EqQ(w,v))),
IIntegrate(8546,Int(Times(u_DEFAULT,Power(Cos(v_),p_DEFAULT),Power(Cos(w_),q_DEFAULT)),x_Symbol),
    Condition(Int(Times(u,Power(Cos(v),Plus(p,q))),x),EqQ(w,v))),
IIntegrate(8547,Int(Times(Power(Sin(v_),p_DEFAULT),Power(Sin(w_),q_DEFAULT)),x_Symbol),
...
IIntegrate(8548,Int(Times(Power(Cos(v_),p_DEFAULT),Power(Cos(w_),q_DEFAULT)),x_Symbol),
...
IIntegrate(8549,Int(Times(Power(x_,m_DEFAULT),Power(Sin(v_),p_DEFAULT),Power(Sin(w_),q_DEFAULT)),x_Symbol),
...
IIntegrate(8550,Int(Times(Power(x_,m_DEFAULT),Power(Cos(v_),p_DEFAULT),Power(Cos(w_),q_DEFAULT)),x_Symbol),
...
IIntegrate(8551,Int(Times(u_DEFAULT,Power(Cos(w_),p_DEFAULT),Power(Sin(v_),p_DEFAULT)),x_Symbol),
    Condition(Dist(Power(Power(C2,p),-1),Int(Times(u,Power(Sin(Times(C2,v)),p)),x),x),And(EqQ(w,v),IntegerQ(p)))),
IIntegrate(8552,Int(Times(Power(Cos(w_),q_DEFAULT),Power(Sin(v_),p_DEFAULT)),x_Symbol),
...
IIntegrate(8553,Int(Times(Power(x_,m_DEFAULT),Power(Cos(w_),q_DEFAULT),Power(Sin(v_),p_DEFAULT)),x_Symbol),
...
IIntegrate(8554,Int(Times(Sin(v_),Power(Tan(w_),n_DEFAULT)),x_Symbol),
...
IIntegrate(8555,Int(Times(Cos(v_),Power(Cot(w_),n_DEFAULT)),x_Symbol),
...
IIntegrate(8556,Int(Times(Power(Cot(w_),n_DEFAULT),Sin(v_)),x_Symbol),
...
IIntegrate(8557,Int(Times(Cos(v_),Power(Tan(w_),n_DEFAULT)),x_Symbol),
...
IIntegrate(8558,Int(Times(Power(Sec(w_),n_DEFAULT),Sin(v_)),x_Symbol),
...
IIntegrate(8559,Int(Times(Cos(v_),Power(Csc(w_),n_DEFAULT)),x_Symbol),
...
IIntegrate(8560,Int(Times(Power(Csc(w_),n_DEFAULT),Sin(v_)),x_Symbol),
...
IIntegrate(8561,Int(Times(Cos(v_),Power(Sec(w_),n_DEFAULT)),x_Symbol),
...
IIntegrate(8562,Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Cos(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),Sin(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),n_DEFAULT)),x_Symbol),
...
IIntegrate(8563,Int(Times(Power(x_,m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(Sin(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))))),n_)),x_Symbol),
...
IIntegrate(8564,Int(Times(Power(x_,m_DEFAULT),Power(Plus(a_,Times(b_DEFAULT,Sqr(Cos(Plus(c_DEFAULT,Times(d_DEFAULT,x_)))))),n_)),x_Symbol),
...
IIntegrate(8565,Int(Times(Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),m_DEFAULT),Power(Plus(a_DEFAULT,Times(b_DEFAULT,Sqr(Cos(Plus(d_DEFAULT,Times(e_DEFAULT,x_))))),Times(c_DEFAULT,Sqr(Sin(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),-1)),x_Symbol),
...
IIntegrate(8566,Int(Times(Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),m_DEFAULT),Sqr(Sec(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))),Power(Plus(b_,Times(c_DEFAULT,Sqr(Tan(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),-1)),x_Symbol),
...
IIntegrate(8567,Int(Times(Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),m_DEFAULT),Sqr(Sec(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))),Power(Plus(b_DEFAULT,Times(a_DEFAULT,Sqr(Sec(Plus(d_DEFAULT,Times(e_DEFAULT,x_))))),Times(c_DEFAULT,Sqr(Tan(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),-1)),x_Symbol),
    Condition(Dist(C2,Int(Times(Power(Plus(f,Times(g,x)),m),Power(Plus(Times(C2,a),b,c,Times(Plus(b,Negate(c)),Cos(Plus(Times(C2,d),Times(C2,e,x))))),-1)),x),x),And(FreeQ(List(a,b,c,d,e,f,g),x),IGtQ(m,C0),NeQ(Plus(a,b),C0),NeQ(Plus(a,c),C0)))),
IIntegrate(8568,Int(Times(Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),m_DEFAULT),Power(Plus(c_,Times(b_DEFAULT,Sqr(Cot(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),-1),Sqr(Csc(Plus(d_DEFAULT,Times(e_DEFAULT,x_))))),x_Symbol),
    Condition(Dist(C2,Int(Times(Power(Plus(f,Times(g,x)),m),Power(Plus(b,c,Times(Plus(b,Negate(c)),Cos(Plus(Times(C2,d),Times(C2,e,x))))),-1)),x),x),And(FreeQ(List(b,c,d,e,f,g),x),IGtQ(m,C0)))),
IIntegrate(8569,Int(Times(Power(Plus(f_DEFAULT,Times(g_DEFAULT,x_)),m_DEFAULT),Sqr(Csc(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))),Power(Plus(c_DEFAULT,Times(b_DEFAULT,Sqr(Cot(Plus(d_DEFAULT,Times(e_DEFAULT,x_))))),Times(a_DEFAULT,Sqr(Csc(Plus(d_DEFAULT,Times(e_DEFAULT,x_)))))),-1)),x_Symbol),
    Condition(Dist(C2,Int(Times(Power(Plus(f,Times(g,x)),m),Power(Plus(Times(C2,a),b,c,Times(Plus(b,Negate(c)),Cos(Plus(Times(C2,d),Times(C2,e,x))))),-1)),x),x),And(FreeQ(List(a,b,c,d,e,f,g),x),IGtQ(m,C0),NeQ(Plus(a,b),C0),NeQ(Plus(a,c),C0)))),
IIntegrate(8570,Int(Times(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),Plus(A_,Times(B_DEFAULT,Sin(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),Power(Plus(a_,Times(b_DEFAULT,Sin(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),-2)),x_Symbol),
...
IIntegrate(8571,Int(Times(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),Plus(A_,Times(B_DEFAULT,Cos(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),Power(Plus(a_,Times(b_DEFAULT,Cos(Plus(c_DEFAULT,Times(d_DEFAULT,x_))))),-2)),x_Symbol),
...
IIntegrate(8572,Int(Times(Sqr(x_),Power(Plus(Times(d_DEFAULT,x_,Cos(Times(a_DEFAULT,x_))),Times(c_DEFAULT,Sin(Times(a_DEFAULT,x_)))),-2)),x_Symbol),
...
IIntegrate(8573,Int(Times(Sqr(x_),Power(Plus(Times(c_DEFAULT,Cos(Times(a_DEFAULT,x_))),Times(d_DEFAULT,x_,Sin(Times(a_DEFAULT,x_)))),-2)),x_Symbol),
...
IIntegrate(8574,Int(Times(Sqr(Sin(Times(a_DEFAULT,x_))),Power(Plus(Times(d_DEFAULT,x_,Cos(Times(a_DEFAULT,x_))),Times(c_DEFAULT,Sin(Times(a_DEFAULT,x_)))),-2)),x_Symbol),
...
IIntegrate(8575,Int(Times(Sqr(Cos(Times(a_DEFAULT,x_))),Power(Plus(Times(c_DEFAULT,Cos(Times(a_DEFAULT,x_))),Times(d_DEFAULT,x_,Sin(Times(a_DEFAULT,x_)))),-2)),x_Symbol),
...
IIntegrate(8576,Int(Times(Power(Times(b_DEFAULT,x_),m_),Power(Sin(Times(a_DEFAULT,x_)),n_),Power(Plus(Times(d_DEFAULT,x_,Cos(Times(a_DEFAULT,x_))),Times(c_DEFAULT,Sin(Times(a_DEFAULT,x_)))),-2)),x_Symbol),
...
IIntegrate(8577,Int(Times(Power(Times(b_DEFAULT,x_),m_),Power(Cos(Times(a_DEFAULT,x_)),n_),Power(Plus(Times(c_DEFAULT,Cos(Times(a_DEFAULT,x_))),Times(d_DEFAULT,x_,Sin(Times(a_DEFAULT,x_)))),-2)),x_Symbol),
...
IIntegrate(8578,Int(Times(Power(Times(b_DEFAULT,x_),m_DEFAULT),Power(Csc(Times(a_DEFAULT,x_)),n_DEFAULT),Power(Plus(Times(d_DEFAULT,x_,Cos(Times(a_DEFAULT,x_))),Times(c_DEFAULT,Sin(Times(a_DEFAULT,x_)))),-2)),x_Symbol),
