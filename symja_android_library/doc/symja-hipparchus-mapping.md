...
| [FindMinimum](functions/FindMinimum.md) | `optim.nonlinear.vector.constrained.SQPOptimizerS2`<br> `optim.nonlinear.scalar.noderiv.BOBYQAOptimizer` <br> `optim.nonlinear.scalar.noderiv.CMAESOptimizer` <br> `optim.nonlinear.scalar.noderiv.NelderMeadSimplex` <br> `optim.nonlinear.scalar.noderiv.PowellOptimizer`|
