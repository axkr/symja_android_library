...
IIntegrate(201,Integrate(Times(Power(Plus(a_DEFAULT,Times(b_DEFAULT,u_)),m_DEFAULT),Power(Plus(c_DEFAULT,Times(d_DEFAULT,u_)),n_DEFAULT),Power(Plus(e_DEFAULT,Times(f_DEFAULT,u_)),p_DEFAULT),Power(Plus(g_DEFAULT,Times(h_DEFAULT,u_)),q_DEFAULT)),x_Symbol),
    Condition(Simp(Dist(Power(Coefficient(u,x,C1),CN1),Subst(Integrate(Times(Power(Plus(a,Times(b,x)),m),Power(Plus(c,Times(d,x)),n),Power(Plus(e,Times(f,x)),p),Power(Plus(g,Times(h,x)),q)),x),x,u),x),x),And(FreeQ(List(a,b,c,d,e,f,g,h,m,n,p,q),x),LinearQ(u,x),NeQ(u,x)))),
IIntegrate(202,Integrate(Power(Times(i_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),n_),Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),p_),Power(Plus(g_DEFAULT,Times(h_DEFAULT,x_)),q_)),r_),x_Symbol),
    Condition(Simp(Dist(Times(Power(Times(i,Power(Plus(a,Times(b,x)),m),Power(Plus(c,Times(d,x)),n),Power(Plus(e,Times(f,x)),p),Power(Plus(g,Times(h,x)),q)),r),Power(Times(Power(Plus(a,Times(b,x)),Times(m,r)),Power(Plus(c,Times(d,x)),Times(n,r)),Power(Plus(e,Times(f,x)),Times(p,r)),Power(Plus(g,Times(h,x)),Times(q,r))),CN1)),Integrate(Times(Power(Plus(a,Times(b,x)),Times(m,r)),Power(Plus(c,Times(d,x)),Times(n,r)),Power(Plus(e,Times(f,x)),Times(p,r)),Power(Plus(g,Times(h,x)),Times(q,r))),x),x),x),FreeQ(List(a,b,c,d,e,f,g,h,i,m,n,p,q,r),x))),
...
IIntegrate(207,Integrate(Power(Times(b_DEFAULT,Sqr(x_)),p_),x_Symbol),
    Condition(Simp(Dist(Times(Power(b,IntPart(p)),Power(Times(b,Sqr(x)),FracPart(p)),Power(Power(x,Times(C2,FracPart(p))),CN1)),Integrate(Power(x,Times(C2,p)),x),x),x),FreeQ(list(b,p),x))),
...
IIntegrate(209,Integrate(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),x_Symbol),
    Condition(Plus(Simp(Times(CN1,x,Power(Plus(a,Times(b,Sqr(x))),Plus(p,C1)),Power(Times(C2,a,Plus(p,C1)),CN1)),x),Simp(Dist(Times(Plus(Times(C2,p),C3),Power(Times(C2,a,Plus(p,C1)),CN1)),Integrate(Power(Plus(a,Times(b,Sqr(x))),Plus(p,C1)),x),x),x)),And(FreeQ(list(a,b),x),ILtQ(Plus(p,QQ(3L,2L)),C0)))),
...
IIntegrate(211,Integrate(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),x_Symbol),
    Condition(Plus(Simp(Times(x,Power(Plus(a,Times(b,Sqr(x))),p),Power(Plus(Times(C2,p),C1),CN1)),x),Simp(Dist(Times(C2,a,p,Power(Plus(Times(C2,p),C1),CN1)),Integrate(Power(Plus(a,Times(b,Sqr(x))),Plus(p,CN1)),x),x),x)),And(FreeQ(list(a,b),x),GtQ(p,C0),Or(IntegerQ(Times(C4,p)),IntegerQ(Times(C6,p)))))),
...
IIntegrate(213,Integrate(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),QQ(-5L,4L)),x_Symbol),
    Condition(Simp(Dist(Times(Power(Plus(C1,Times(b,Sqr(x),Power(a,CN1))),C1D4),Power(Times(a,Power(Plus(a,Times(b,Sqr(x))),C1D4)),CN1)),Integrate(Power(Plus(C1,Times(b,Sqr(x),Power(a,CN1))),QQ(-5L,4L)),x),x),x),And(FreeQ(list(a,b),x),PosQ(a),PosQ(Times(b,Power(a,CN1)))))),
IIntegrate(214,Integrate(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),QQ(-7L,6L)),x_Symbol),
    Condition(Simp(Dist(Power(Times(Power(Plus(a,Times(b,Sqr(x))),QQ(2L,3L)),Power(Times(a,Power(Plus(a,Times(b,Sqr(x))),CN1)),QQ(2L,3L))),CN1),Subst(Integrate(Power(Subtract(C1,Times(b,Sqr(x))),CN1D3),x),x,Times(x,Power(Plus(a,Times(b,Sqr(x))),CN1D2))),x),x),FreeQ(list(a,b),x))),
IIntegrate(215,Integrate(Power(Plus(a_,Times(b_DEFAULT,Sqr(x_))),p_),x_Symbol),
    Condition(Plus(Simp(Times(CN1,x,Power(Plus(a,Times(b,Sqr(x))),Plus(p,C1)),Power(Times(C2,a,Plus(p,C1)),CN1)),x),Simp(Dist(Times(Plus(Times(C2,p),C3),Power(Times(C2,a,Plus(p,C1)),CN1)),Integrate(Power(Plus(a,Times(b,Sqr(x))),Plus(p,C1)),x),x),x)),And(FreeQ(list(a,b),x),LtQ(p,CN1),Or(IntegerQ(Times(C4,p)),IntegerQ(Times(C6,p)))))),
