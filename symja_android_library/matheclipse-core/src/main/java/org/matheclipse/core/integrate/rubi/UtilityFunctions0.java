...
SetDelayed(MakeList($p(n,IntegerHead),u_),
...
SetDelayed(NotIntegrableQ(u_,$p(x,SymbolHead)),
...
SetDelayed(RationalQ(Plus(Times(Plus(n_,v_),m_),u_)),
...
SetDelayed(TrigHyperbolicFreeQ(u_,$p(x,SymbolHead)),
...
SetDelayed(InverseFunctionFreeQ(u_,$p(x,SymbolHead)),
...
SetDelayed(SplitMonomialTerms(u_,$p(x,SymbolHead)),
...
SetDelayed(LinearQ(u_,$p(x,SymbolHead)),
    And(IntPolynomialQ(u,x),SameQ(Exponent(u,x),C1))),
SetDelayed(QuadraticQ(u_,$p(x,SymbolHead)),
    And(IntPolynomialQ(u,x),SameQ(Exponent(u,x),C2))),
SetDelayed(MonomialQ(u_,$p(x,SymbolHead)),
    MatchQ(u,Condition(Power(x,$p(n,true)),FreeQ(n,x)))),
SetDelayed(BinomialQ(u_,$p(x,SymbolHead)),
