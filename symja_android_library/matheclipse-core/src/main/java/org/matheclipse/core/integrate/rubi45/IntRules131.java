...
ISetDelayed(Int(Times(Power(Plus(e_DEFAULT,Times(f_DEFAULT,x_)),m_),CoshIntegral(Plus(c_DEFAULT,Times(d_DEFAULT,x_))),Sinh(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(SinhIntegral(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
ISetDelayed(Int(CoshIntegral(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),SinhIntegral(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),CoshIntegral(Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,-1),Gamma(C0,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,-1),Gamma(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(d_DEFAULT,x_),m_DEFAULT),Gamma(n_,Times(b_DEFAULT,x_))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_,Times(d_DEFAULT,x_)),m_DEFAULT),Gamma(n_,Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),-1),Gamma(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Gamma(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),LogGamma(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),PolyGamma(n_,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Gamma(p_,Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(x_,-1),Gamma(p_,Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
    Condition(Dist(Power(n,-1),Subst(Gamma(p,Times(d,Plus(a,Times(b,x)))),x,Log(Times(c,Power(x,n)))),x),FreeQ(List(a,b,c,d,n,p),x))),
ISetDelayed(Int(Times(Power(Times(e_DEFAULT,x_),m_DEFAULT),Gamma(p_,Times(d_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(x_,n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(Int(Gamma(p_,Times(f_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(Plus(d_,Times(e_DEFAULT,x_)),n_DEFAULT))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(g_,Times(h_DEFAULT,x_)),m_DEFAULT),Gamma(p_,Times(f_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,Log(Times(c_DEFAULT,Power(Plus(d_,Times(e_DEFAULT,x_)),n_DEFAULT)))))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Zeta(C2,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Int(Times(Power(Plus(c,Times(d,x)),m),PolyGamma(C1,Plus(a,Times(b,x)))),x),And(FreeQ(List(a,b,c,d),x),RationalQ(m)))),
ISetDelayed(Int(Times(Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT),Zeta(s_,Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(d_DEFAULT,x_),m_DEFAULT),PolyLog(n_,Times(a_DEFAULT,Power(Times(b_DEFAULT,Power(x_,p_DEFAULT)),q_DEFAULT)))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),-1),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),m_DEFAULT),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
...
ISetDelayed(Int(Times(Plus(g_DEFAULT,Times(h_DEFAULT,Log(Times(f_DEFAULT,Power(Plus(d_DEFAULT,Times(e_DEFAULT,x_)),n_DEFAULT))))),PolyLog(C2,Times(c_DEFAULT,Plus(a_DEFAULT,Times(b_DEFAULT,x_))))),x_Symbol),
