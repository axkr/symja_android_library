...
/**
 * GenMatrixRing implements a generic matrix algebra factory with RingFactory. Matrices of n rows
 * and m columns over C.
 *
 * @author Heinz Kredel
 */
public class GenMatrixRing<C extends RingElem<C>> implements AlgebraFactory<GenMatrix<C>, C> {
  ...
  /**
   * Query if this ring is a field. May return false if it is to hard to determine if this ring is a
   * field.
   *
