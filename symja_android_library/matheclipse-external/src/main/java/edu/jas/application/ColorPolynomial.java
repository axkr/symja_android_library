...
/**
 * Colored Polynomials with green, red and white coefficients. Not implementing RingElem.
...
/* implements RingElem< ColorPolynomial<C> > */ {
  ...
  /**
   * ColorPolynomial summation. <b>Note:</b> green coefficients stay green, all others become white.
   *
  ...
  /**
   * ColorPolynomial subtraction. <b>Note:</b> green coefficients stay green, all others become
   * white.
   *
   * @param S ColorPolynomial.
   * @return this-S.
