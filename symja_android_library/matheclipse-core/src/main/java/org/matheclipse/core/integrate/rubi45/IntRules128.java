...
ISetDelayed(Int(Times(x_,Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Plus(Times(Power(E,Plus(c,Times(d,Sqr(x)))),Erf(Plus(a,Times(b,x))),Power(Times(C2,d),CN1)),Times(CN1,b,Power(Times(d,Sqrt(Pi)),CN1),Int(Power(E,Plus(Times(CN1,Sqr(a)),c,Times(CN1,C2,a,b,x),Times(CN1,Plus(Sqr(b),Times(CN1,d)),Sqr(x)))),x))),FreeQ(List(a,b,c,d),x))),
ISetDelayed(Int(Times(x_,Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Plus(Times(Power(E,Plus(c,Times(d,Sqr(x)))),Erfc(Plus(a,Times(b,x))),Power(Times(C2,d),CN1)),Times(b,Power(Times(d,Sqrt(Pi)),CN1),Int(Power(E,Plus(Times(CN1,Sqr(a)),c,Times(CN1,C2,a,b,x),Times(CN1,Plus(Sqr(b),Times(CN1,d)),Sqr(x)))),x))),FreeQ(List(a,b,c,d),x))),
ISetDelayed(Int(Times(x_,Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Erfi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Plus(Times(Power(E,Plus(c,Times(d,Sqr(x)))),Erfi(Plus(a,Times(b,x))),Power(Times(C2,d),CN1)),Times(CN1,b,Power(Times(d,Sqrt(Pi)),CN1),Int(Power(E,Plus(Sqr(a),c,Times(C2,a,b,x),Times(Plus(Sqr(b),d),Sqr(x)))),x))),FreeQ(List(a,b,c,d),x))),
ISetDelayed(Int(Times(Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Power(x_,m_),Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Plus(Times(Power(x,Plus(m,Times(CN1,C1))),Power(E,Plus(c,Times(d,Sqr(x)))),Erf(Plus(a,Times(b,x))),Power(Times(C2,d),CN1)),Times(CN1,b,Power(Times(d,Sqrt(Pi)),CN1),Int(Times(Power(x,Plus(m,Times(CN1,C1))),Power(E,Plus(Times(CN1,Sqr(a)),c,Times(CN1,C2,a,b,x),Times(CN1,Plus(Sqr(b),Times(CN1,d)),Sqr(x))))),x)),Times(CN1,Plus(m,Times(CN1,C1)),Power(Times(C2,d),CN1),Int(Times(Power(x,Plus(m,Times(CN1,C2))),Power(E,Plus(c,Times(d,Sqr(x)))),Erf(Plus(a,Times(b,x)))),x))),And(And(FreeQ(List(a,b,c,d),x),IntegerQ(m)),Greater(m,C1)))),
ISetDelayed(Int(Times(Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Power(x_,m_),Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Plus(Times(Power(x,Plus(m,Times(CN1,C1))),Power(E,Plus(c,Times(d,Sqr(x)))),Erfc(Plus(a,Times(b,x))),Power(Times(C2,d),CN1)),Times(b,Power(Times(d,Sqrt(Pi)),CN1),Int(Times(Power(x,Plus(m,Times(CN1,C1))),Power(E,Plus(Times(CN1,Sqr(a)),c,Times(CN1,C2,a,b,x),Times(CN1,Plus(Sqr(b),Times(CN1,d)),Sqr(x))))),x)),Times(CN1,Plus(m,Times(CN1,C1)),Power(Times(C2,d),CN1),Int(Times(Power(x,Plus(m,Times(CN1,C2))),Power(E,Plus(c,Times(d,Sqr(x)))),Erfc(Plus(a,Times(b,x)))),x))),And(And(FreeQ(List(a,b,c,d),x),IntegerQ(m)),Greater(m,C1)))),
ISetDelayed(Int(Times(Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Power(x_,m_),Erfi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Plus(Times(Power(x,Plus(m,Times(CN1,C1))),Power(E,Plus(c,Times(d,Sqr(x)))),Erfi(Plus(a,Times(b,x))),Power(Times(C2,d),CN1)),Times(CN1,b,Power(Times(d,Sqrt(Pi)),CN1),Int(Times(Power(x,Plus(m,Times(CN1,C1))),Power(E,Plus(Sqr(a),c,Times(C2,a,b,x),Times(Plus(Sqr(b),d),Sqr(x))))),x)),Times(CN1,Plus(m,Times(CN1,C1)),Power(Times(C2,d),CN1),Int(Times(Power(x,Plus(m,Times(CN1,C2))),Power(E,Plus(c,Times(d,Sqr(x)))),Erfi(Plus(a,Times(b,x)))),x))),And(And(FreeQ(List(a,b,c,d),x),IntegerQ(m)),Greater(m,C1)))),
ISetDelayed(Int(Times(Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Erf(Times(b_DEFAULT,x_)),Power(x_,CN1)),x_Symbol),
    Condition(Times(C2,b,Power(E,c),x,Power(Pi,CN1D2),HypergeometricPFQ(List(C1D2,C1),List(QQ(3L,2L),QQ(3L,2L)),Times(d,Sqr(x)))),And(FreeQ(b,x),ZeroQ(Plus(d,Times(CN1,Sqr(b))))))),
ISetDelayed(Int(Times(Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Erfc(Times(b_DEFAULT,x_)),Power(x_,CN1)),x_Symbol),
    Condition(Plus(Int(Times(Power(E,Plus(c,Times(d,Sqr(x)))),Power(x,CN1)),x),Times(CN1,Int(Times(Power(E,Plus(c,Times(d,Sqr(x)))),Erf(Times(b,x)),Power(x,CN1)),x))),And(FreeQ(b,x),ZeroQ(Plus(d,Times(CN1,Sqr(b))))))),
ISetDelayed(Int(Times(Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Erfi(Times(b_DEFAULT,x_)),Power(x_,CN1)),x_Symbol),
...
ISetDelayed(Int(Times(Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Power(x_,m_),Erf(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Plus(Times(Power(x,Plus(m,C1)),Power(E,Plus(c,Times(d,Sqr(x)))),Erf(Plus(a,Times(b,x))),Power(Plus(m,C1),CN1)),Times(CN1,C2,b,Power(Times(Plus(m,C1),Sqrt(Pi)),CN1),Int(Times(Power(x,Plus(m,C1)),Power(E,Plus(Times(CN1,Sqr(a)),c,Times(CN1,C2,a,b,x),Times(CN1,Plus(Sqr(b),Times(CN1,d)),Sqr(x))))),x)),Times(CN1,C2,d,Power(Plus(m,C1),CN1),Int(Times(Power(x,Plus(m,C2)),Power(E,Plus(c,Times(d,Sqr(x)))),Erf(Plus(a,Times(b,x)))),x))),And(And(FreeQ(List(a,b,c,d),x),IntegerQ(m)),Less(m,CN1)))),
ISetDelayed(Int(Times(Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Power(x_,m_),Erfc(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Plus(Times(Power(x,Plus(m,C1)),Power(E,Plus(c,Times(d,Sqr(x)))),Erfc(Plus(a,Times(b,x))),Power(Plus(m,C1),CN1)),Times(C2,b,Power(Times(Plus(m,C1),Sqrt(Pi)),CN1),Int(Times(Power(x,Plus(m,C1)),Power(E,Plus(Times(CN1,Sqr(a)),c,Times(CN1,C2,a,b,x),Times(CN1,Plus(Sqr(b),Times(CN1,d)),Sqr(x))))),x)),Times(CN1,C2,d,Power(Plus(m,C1),CN1),Int(Times(Power(x,Plus(m,C2)),Power(E,Plus(c,Times(d,Sqr(x)))),Erfc(Plus(a,Times(b,x)))),x))),And(And(FreeQ(List(a,b,c,d),x),IntegerQ(m)),Less(m,CN1)))),
ISetDelayed(Int(Times(Power(E,Plus(c_DEFAULT,Times($p(d,true),Sqr(x_)))),Power(x_,m_),Erfi(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition(Plus(Times(Power(x,Plus(m,C1)),Power(E,Plus(c,Times(d,Sqr(x)))),Erfi(Plus(a,Times(b,x))),Power(Plus(m,C1),CN1)),Times(CN1,C2,b,Power(Times(Plus(m,C1),Sqrt(Pi)),CN1),Int(Times(Power(x,Plus(m,C1)),Power(E,Plus(Sqr(a),c,Times(C2,a,b,x),Times(Plus(Sqr(b),d),Sqr(x))))),x)),Times(CN1,C2,d,Power(Plus(m,C1),CN1),Int(Times(Power(x,Plus(m,C2)),Power(E,Plus(c,Times(d,Sqr(x)))),Erfi(Plus(a,Times(b,x)))),x))),And(And(FreeQ(List(a,b,c,d),x),IntegerQ(m)),Less(m,CN1)))),
