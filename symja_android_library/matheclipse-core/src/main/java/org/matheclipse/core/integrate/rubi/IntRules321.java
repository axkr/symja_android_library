      ...
      List(
              ...
              Condition(
                  Plus(
                      Dist(Times(C1D4, Plus(C1, CI)),
                          Integrate(
                              Times(Erf(Times(C1D2, CSqrtPi, Plus(C1, CI), b, x)),
                                  Power(x, CN1)),
                              x),
                          x),
                      Dist(
                          Times(C1D4, Subtract(C1,
                              CI)),
                          Integrate(
                              Times(Erf(Times(C1D2, CSqrtPi, Subtract(C1, CI), b, x)),
                                  Power(x, CN1)),
                              x),
                          x)),
                  FreeQ(b, x))),
          IIntegrate(6425,
              ...
              Condition(Plus(
                  Dist(Times(C1D4, Subtract(C1, CI)),
                      Integrate(Times(Erf(Times(C1D2, CSqrtPi, Plus(C1, CI), b, x)), Power(x, CN1)),
                          x),
                      x),
                  Dist(Times(C1D4, Plus(C1, CI)),
                      Integrate(
                          Times(Erf(Times(C1D2, CSqrtPi, Subtract(C1, CI), b, x)), Power(x, CN1)),
                          x),
                      x)),
                  FreeQ(b, x))),
          IIntegrate(6426,
                      ...
                      Dist(Times(C1D4, Plus(C1, CI)),
                          Integrate(
                              Times(Exp(Plus(c, Times(d, Sqr(x)))),
                                  Erf(Times(C1D2, CSqrtPi, Plus(C1, CI), b, x))),
                              x),
                          x),
                      Dist(Times(C1D4, Subtract(C1, CI)),
                          Integrate(Times(Exp(Plus(c, Times(d, Sqr(x)))),
                              Erf(Times(C1D2, CSqrtPi, Subtract(C1, CI), b, x))), x),
                          x)),
                  And(FreeQ(list(b, c,
                      d), x), EqQ(Sqr(d),
          ...
          IIntegrate(6437,
              ...
              Condition(Plus(Dist(Times(C1D4, Subtract(C1, CI)),
                  Integrate(Times(Exp(Plus(c, Times(d, Sqr(x)))),
                      Erf(Times(C1D2, CSqrtPi, Plus(C1, CI), b, x))), x),
                  x),
                  Dist(Times(C1D4, Plus(C1, CI)),
                      Integrate(Times(Exp(Plus(c, Times(d, Sqr(x)))),
                          Erf(Times(C1D2, CSqrtPi, Subtract(C1, CI), b, x))), x),
