...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abs", "AddTo", "And", "Alternatives", "Apart", "AppellF1",
			...
			"FromCharacterCode", "FromContinuedFraction", "FullForm", "FullSimplify", "Function", "Gamma", "Gather",
			...
			"JacobiSymbol", "JavaForm", "Join", "KOrderlessPartitions", "KPartitions", "Last", "LCM", "LeafCount",
			"LaguerreL", "LaplaceTransform", "LegendreP", "Length", "Less", "LessEqual", "LetterQ", "Level", "Limit",
			"Line", "LinearProgramming", "LinearSolve", "List", "ListQ", "Log", "Log2", "Log10", "LogGamma",
			"LogicalExpand", "LogIntegral", "LowerCaseQ", "LUDecomposition", "ManhattanDistance", "Map", "MapAt",
			"MapAll", "MapThread", "MatchQ", "MathMLForm", "MatrixForm", "MatrixPower", "MatrixQ", "MatrixRank", "Max",
			"Mean", "Median", "MemberQ", "MeshRange", "MessageName", "Min", "Mod", "Module", "MoebiusMu",
			"MonomialList", "Most", "Multinomial", "Names", "Nand", "Negative", "Nest", "NestList", "NestWhile",
