 ...
 * BuiltinEnvironment}) supported by SnuggleTeX.
 *
 * <h2>Notes</h2>
 *
 * <ul>
...
public final class CorePackageDefinitions {
  ...
  static {
    ...
    try {
      corePackage.setErrorMessageBundle(
          ResourceBundle.getBundle(CORE_ERROR_MESSAGES_PROPERTIES_BASENAME));
    ...
    corePackage.addSimpleCommand(
        ...
        new ModeDelegatingHandler(
            new CharacterCommandHandler("{"), new InterpretableSimpleMathHandler()),
        null);
    corePackage.addSimpleCommand(
        "}",
        ALL_MODES,
    ...
    corePackage.addSimpleCommand(
        ",",
        ALL_MODES,
        new SpaceHandler("\u2009", "0.167em"),
        ALLOW_INLINE); /* Thin space, all modes */
    corePackage.addSimpleCommand(
        ":", MATH_MODE_ONLY, new SpaceHandler(null, "0.222em"), null); /* Medium space, math only */
    corePackage.addSimpleCommand(
        ";", MATH_MODE_ONLY, new SpaceHandler(null, "0.278em"), null); /* Thick space, math only */
    corePackage.addSimpleCommand(
        "!", MATH_MODE_ONLY, new SpaceHandler(null, "-0.167em"), null); /* Negative thin space */
    corePackage.addSimpleCommand(
        " ", ALL_MODES, new CharacterCommandHandler("\u00a0"), ALLOW_INLINE);
     ...
     */
    corePackage.addComplexCommandSameArgMode(
        "'", false, 1, TEXT_MODE_ONLY, new AccentHandler(AccentMaps.ACCENT), ALLOW_INLINE);
    corePackage.addComplexCommandSameArgMode(
        "`", false, 1, TEXT_MODE_ONLY, new AccentHandler(AccentMaps.GRAVE), ALLOW_INLINE);
    corePackage.addComplexCommandSameArgMode(
        "^", false, 1, TEXT_MODE_ONLY, new AccentHandler(AccentMaps.CIRCUMFLEX), ALLOW_INLINE);
    corePackage.addComplexCommandSameArgMode(
        "~", false, 1, TEXT_MODE_ONLY, new AccentHandler(AccentMaps.TILDE), ALLOW_INLINE);
    corePackage.addComplexCommandSameArgMode(
        "\"", false, 1, TEXT_MODE_ONLY, new AccentHandler(AccentMaps.UMLAUT), ALLOW_INLINE);

    /* Traditional LaTeX commands */
    CMD_PAR =
        corePackage.addSimpleCommand(
            "par", TEXT_MODE_ONLY, null, null); /* (This is substituted during fixing) */
    ...
    corePackage.addComplexCommandOneArg(
        "ensuremath", false, ALL_MODES, MATH, new EnsureMathHandler(), null);
     ...
     */
    corePackage.addComplexCommandOneArg(
        "literal", false, TEXT_MODE_ONLY, VERBATIM, new LiteralHandler(), null);
    ...
    CMD_PARAGRAPH =
        corePackage.addComplexCommandSameArgMode(
            "<paragraph>", false, 1, TEXT_MODE_ONLY, new ParagraphHandler(), START_NEW_XHTML_BLOCK);
    ...
    corePackage.addComplexCommandOneArg(
        ...
        PARA_MODE_ONLY,
        LR,
        new SimpleXHTMLContainerBuildingHandler("h2"),
        START_NEW_XHTML_BLOCK);
    corePackage.addComplexCommandOneArg(
        "section*",
        false,
    ...
    corePackage.addComplexCommandOneArg(
        ...
        PARA_MODE_ONLY,
        LR,
        new SimpleXHTMLContainerBuildingHandler("h3"),
        START_NEW_XHTML_BLOCK);
    corePackage.addComplexCommandOneArg(
        "subsection*",
        false,
    ...
    corePackage.addComplexCommandOneArg(
        ...
        PARA_MODE_ONLY,
        LR,
        new SimpleXHTMLContainerBuildingHandler("h4"),
        START_NEW_XHTML_BLOCK);
    corePackage.addComplexCommandOneArg(
        "subsubsection*",
        false,
    ...
    corePackage.addComplexCommandOneArg(
        ...
        ALL_MODES,
        LR,
        StyleDeclarationInterpretation.RM,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addComplexCommandOneArg(
        "textsf",
        false,
        ALL_MODES,
        LR,
        StyleDeclarationInterpretation.SF,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addComplexCommandOneArg(
        "textit",
        ...
        ALL_MODES,
        LR,
        StyleDeclarationInterpretation.IT,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addComplexCommandOneArg(
        "textsl",
        ...
        ALL_MODES,
        LR,
        StyleDeclarationInterpretation.SL,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addComplexCommandOneArg(
        "textsc",
        ...
        ALL_MODES,
        LR,
        StyleDeclarationInterpretation.SC,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addComplexCommandOneArg(
        "textbf",
        ...
        ALL_MODES,
        LR,
        StyleDeclarationInterpretation.BF,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addComplexCommandOneArg(
        "texttt",
        ...
        ALL_MODES,
        LR,
        StyleDeclarationInterpretation.TT,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addComplexCommandOneArg(
        "emph",
        ...
        ALL_MODES,
        LR,
        StyleDeclarationInterpretation.EM,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
     ...
     */
    corePackage.addSimpleCommand(
        "tiny", TEXT_MODE_ONLY, StyleDeclarationInterpretation.TINY, null, null);
    corePackage.addSimpleCommand(
        "scriptsize", TEXT_MODE_ONLY, StyleDeclarationInterpretation.SCRIPTSIZE, null, null);
    corePackage.addSimpleCommand(
    ...
    corePackage.addSimpleCommand(
        "Large", TEXT_MODE_ONLY, StyleDeclarationInterpretation.LARGE_2, null, null);
    corePackage.addSimpleCommand(
        "LARGE", TEXT_MODE_ONLY, StyleDeclarationInterpretation.LARGE_3, null, null);
    corePackage.addSimpleCommand(
        "huge", TEXT_MODE_ONLY, StyleDeclarationInterpretation.HUGE, null, null);
    corePackage.addSimpleCommand(
        "Huge", TEXT_MODE_ONLY, StyleDeclarationInterpretation.HUGE_2, null, null);

    /* Non-English symbols (non-math, simple) See Table 3.2, p.39 on LaTeX companion */
    corePackage.addSimpleCommand(
        "ae", TEXT_MODE_ONLY, new CharacterCommandHandler("\u00e6"), ALLOW_INLINE);
    corePackage.addSimpleCommand(
        "oe", TEXT_MODE_ONLY, new CharacterCommandHandler("\u0153"), ALLOW_INLINE);

    /* Special punctuation (non-math, simple) See p.39 on LC */
    corePackage.addSimpleCommand(
        "dag", TEXT_MODE_ONLY, new CharacterCommandHandler("\u2020"), ALLOW_INLINE);

    /* Ellipses (All modes) */
    corePackage.addSimpleCommand(
        "ldots",
        ALL_MODES,
        new MathIdentifierInterpretation("\u2026"),
        new TextSafeInterpretableMathIdentifierHandler(),
        ALLOW_INLINE);
    ...
    CMD_APPLY_FUNCTION =
        corePackage.addSimpleMathCommand(
            "af", new MathOperatorInterpretation(MathMLSymbol.APPLY_FUNCTION));
    CMD_INVISIBLE_TIMES =
        corePackage.addSimpleMathCommand(
            "itimes", new MathOperatorInterpretation(MathMLSymbol.INVISIBLE_TIMES));
    ...
    CMD_MROW =
        corePackage.addComplexCommandSameArgMode(
            "<mrow>", false, 1, MATH_MODE_ONLY, new MrowHandler(), null);
    CMD_MSUB_OR_MUNDER =
        corePackage.addComplexCommandSameArgMode(
            "<msubormunder>", false, 2, MATH_MODE_ONLY, mathLimitsBuilder, null);
    CMD_MSUP_OR_MOVER =
        corePackage.addComplexCommandSameArgMode(
            "<msupormover>", false, 2, MATH_MODE_ONLY, mathLimitsBuilder, null);
    CMD_MSUBSUP_OR_MUNDEROVER =
        corePackage.addComplexCommandSameArgMode(
            "<msubsupormunderover>", false, 3, MATH_MODE_ONLY, mathLimitsBuilder, null);

    /* A related idea to sub/super is \\stackrel */
    corePackage.addComplexCommand(
        "stackrel", false, 2, MATH_MODE_ONLY, null, new MathStackrelHandler(), null);
    ...
    corePackage.addComplexCommandSameArgMode(
        ...
        1,
        MATH_MODE_ONLY,
        new MathVariantMapHandler(MathVariantMaps.SCRIPT),
        null);
    corePackage.addComplexCommandSameArgMode(
        "mathsc",
        false,
    ...
    corePackage.addComplexCommandSameArgMode(
        ...
        1,
        MATH_MODE_ONLY,
        new MathVariantMapHandler(MathVariantMaps.DOUBLE_STRUCK),
        null);
    corePackage.addComplexCommandSameArgMode(
        "mathfrak",
        false,
        1,
        MATH_MODE_ONLY,
        new MathVariantMapHandler(MathVariantMaps.FRAKTUR),
        null);
    ...
    corePackage.addSimpleMathCommand(
        "epsilon", new MathIdentifierInterpretation(MathMLSymbol.EPSILON));
    corePackage.addSimpleMathCommand(
        "varepsilon", new MathIdentifierInterpretation(MathMLSymbol.VAREPSILON));
    ...
    corePackage.addSimpleMathCommand(
        "vartheta", new MathIdentifierInterpretation(MathMLSymbol.VARTHETA));
    ...
    corePackage.addSimpleMathCommand(
        "lambda", new MathIdentifierInterpretation(MathMLSymbol.LAMBDA));
    ...
    corePackage.addSimpleMathCommand(
        "Gamma", new MathIdentifierInterpretation(MathMLSymbol.UC_GAMMA));
    corePackage.addSimpleMathCommand(
        "Delta", new MathIdentifierInterpretation(MathMLSymbol.UC_DELTA));
    corePackage.addSimpleMathCommand(
        "Theta", new MathIdentifierInterpretation(MathMLSymbol.UC_THETA));
    corePackage.addSimpleMathCommand(
        "Lambda", new MathIdentifierInterpretation(MathMLSymbol.UC_LAMBDA));
    ...
    corePackage.addSimpleMathCommand(
        "Sigma", new MathIdentifierInterpretation(MathMLSymbol.UC_SIGMA));
    corePackage.addSimpleMathCommand(
        "Upsilon", new MathIdentifierInterpretation(MathMLSymbol.UC_UPSILON));
    ...
    corePackage.addSimpleMathCommand(
        "Omega", new MathIdentifierInterpretation(MathMLSymbol.UC_OMEGA));
    ...
    corePackage.addSimpleMathCommand(
        "sum", new MathOperatorInterpretation(MathMLSymbol.SUM), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "prod", new MathOperatorInterpretation(MathMLSymbol.PROD), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "coprod", new MathOperatorInterpretation(MathMLSymbol.COPROD), bigLimitOwner);
    corePackage.addSimpleMathCommand("int", new MathOperatorInterpretation(MathMLSymbol.INTEGRAL));
    corePackage.addSimpleMathCommand(
        "oint", new MathOperatorInterpretation(MathMLSymbol.OINT), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "bigcap", new MathOperatorInterpretation(MathMLSymbol.BIGCAP), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "bigcup", new MathOperatorInterpretation(MathMLSymbol.BIGCUP), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "bigsqcup", new MathOperatorInterpretation(MathMLSymbol.BIGSQCUP), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "bigvee", new MathOperatorInterpretation(MathMLSymbol.BIGVEE), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "bigwedge", new MathOperatorInterpretation(MathMLSymbol.BIGWEDGE), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "bigodot", new MathOperatorInterpretation(MathMLSymbol.BIGODOT), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "bigotimes", new MathOperatorInterpretation(MathMLSymbol.BIGOTIMES), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "bigoplus", new MathOperatorInterpretation(MathMLSymbol.BIGOPLUS), bigLimitOwner);
    corePackage.addSimpleMathCommand(
        "biguplus", new MathOperatorInterpretation(MathMLSymbol.BIGUPLUS), bigLimitOwner);
    ...
    corePackage.addSimpleMathCommand(
        "setminus", new MathOperatorInterpretation(MathMLSymbol.SETMINUS));
    corePackage.addSimpleMathCommand("wr", new MathOperatorInterpretation(MathMLSymbol.WR));
    corePackage.addSimpleMathCommand(
        "diamond", new MathOperatorInterpretation(MathMLSymbol.DIAMOND));
    corePackage.addSimpleMathCommand(
        "bigtriangleup", new MathOperatorInterpretation(MathMLSymbol.BIGTRIANGLEUP));
    corePackage.addSimpleMathCommand(
        "bigtriangledown", new MathOperatorInterpretation(MathMLSymbol.BIGTRIANGLEDOWN));
    corePackage.addSimpleMathCommand(
        "triangleleft", new MathOperatorInterpretation(MathMLSymbol.TRIANGLELEFT));
    corePackage.addSimpleMathCommand(
        "triangleright", new MathOperatorInterpretation(MathMLSymbol.TRIANGLERIGHT));
    ...
    corePackage.addSimpleMathCommand(
        "prec",
        new MathOperatorInterpretation(MathMLSymbol.PREC),
    ...
    corePackage.addSimpleMathCommand(
        "subset",
        new MathOperatorInterpretation(MathMLSymbol.SUBSET),
    ...
    corePackage.addSimpleMathCommand(
        "sqsubset", new MathOperatorInterpretation(MathMLSymbol.SQSUBSET));
    corePackage.addSimpleMathCommand(
        "sqsubseteq",
    ...
    corePackage.addSimpleMathCommand(
        "in",
        new MathOperatorInterpretation(MathMLSymbol.IN),
        new MathNegatableInterpretation(MathMLSymbol.NOT_IN));
    corePackage.addSimpleMathCommand(
        "vdash",
        new MathOperatorInterpretation(MathMLSymbol.VDASH),
        new MathNegatableInterpretation(MathMLSymbol.NOT_VDASH));
    corePackage.addSimpleMathCommand(
        "geq",
        new MathOperatorInterpretation(MathMLSymbol.GEQ),
    ...
    corePackage.addSimpleMathCommand(
        "succ",
        new MathOperatorInterpretation(MathMLSymbol.SUCC),
    ...
    corePackage.addSimpleMathCommand(
        "supset",
        new MathOperatorInterpretation(MathMLSymbol.SUPSET),
    ...
    corePackage.addSimpleMathCommand(
        "sqsupset", new MathOperatorInterpretation(MathMLSymbol.SQSUPSET));
    corePackage.addSimpleMathCommand(
        "sqsupseteq",
    ...
    corePackage.addSimpleMathCommand(
        "ni",
        new MathOperatorInterpretation(MathMLSymbol.NI),
    ...
    corePackage.addSimpleMathCommand(
        "equiv",
        new MathOperatorInterpretation(MathMLSymbol.EQUIV),
        new MathNegatableInterpretation(MathMLSymbol.NOT_EQUIV));
    corePackage.addSimpleMathCommand(
        "sim",
        new MathOperatorInterpretation(MathMLSymbol.SIM),
        new MathNegatableInterpretation(MathMLSymbol.NOT_SIM));
    corePackage.addSimpleMathCommand(
        "simeq",
        new MathOperatorInterpretation(MathMLSymbol.SIMEQ),
    ...
    corePackage.addSimpleMathCommand(
        "approx",
        new MathOperatorInterpretation(MathMLSymbol.APPROX),
        new MathNegatableInterpretation(MathMLSymbol.NOT_APPROX));
    corePackage.addSimpleMathCommand(
        "cong",
        new MathOperatorInterpretation(MathMLSymbol.CONG),
        new MathNegatableInterpretation(MathMLSymbol.NOT_CONG));
    corePackage.addSimpleMathCommand(
        "neq", new MathOperatorInterpretation(MathMLSymbol.NOT_EQUALS));
    ...
    corePackage.addSimpleMathCommand(
        "mid",
        new MathOperatorInterpretation(MathMLSymbol.MID),
        new MathNegatableInterpretation(MathMLSymbol.NOT_MID));
    corePackage.addSimpleMathCommand(
        "parallel", new MathOperatorInterpretation(MathMLSymbol.PARALLEL));
    ...
    /* Arrows */
    corePackage.addSimpleMathCommand(
        "leftarrow", new MathOperatorInterpretation(MathMLSymbol.LEFTARROW));
    corePackage.addSimpleMathCommand(
        "Leftarrow", new MathOperatorInterpretation(MathMLSymbol.UC_LEFTARROW));
    corePackage.addSimpleMathCommand("to", new MathOperatorInterpretation(MathMLSymbol.RIGHTARROW));
    corePackage.addSimpleMathCommand(
        "rightarrow", new MathOperatorInterpretation(MathMLSymbol.RIGHTARROW));
    corePackage.addSimpleMathCommand(
        "Rightarrow", new MathOperatorInterpretation(MathMLSymbol.UC_RIGHTARROW));
    corePackage.addSimpleMathCommand(
        "leftrightarrow", new MathOperatorInterpretation(MathMLSymbol.LEFTRIGHTARROW));
    corePackage.addSimpleMathCommand(
        "Leftrightarrow", new MathOperatorInterpretation(MathMLSymbol.UC_LEFTRIGHTARROW));
    corePackage.addSimpleMathCommand("mapsto", new MathOperatorInterpretation(MathMLSymbol.MAPSTO));
    corePackage.addSimpleMathCommand(
        "hookleftarrow", new MathOperatorInterpretation(MathMLSymbol.HOOKLEFTARROW));
    corePackage.addSimpleMathCommand(
        "leftharpoonup", new MathOperatorInterpretation(MathMLSymbol.LEFTHARPOONUP));
    corePackage.addSimpleMathCommand(
        "leftharpoondown", new MathOperatorInterpretation(MathMLSymbol.LEFTHARPOONDOWN));
    corePackage.addSimpleMathCommand(
        "rightleftharpoons", new MathOperatorInterpretation(MathMLSymbol.RIGHTLEFTHARPOONS));
    corePackage.addSimpleMathCommand(
        "longleftarrow",
        new MathOperatorInterpretation(
            MathMLSymbol.LEFTARROW)); /* NB: No appropriate Unicode symbols for long operators! */
    corePackage.addSimpleMathCommand(
        "Longleftarrow", new MathOperatorInterpretation(MathMLSymbol.UC_LEFTARROW));
    corePackage.addSimpleMathCommand(
        "longrightarrow", new MathOperatorInterpretation(MathMLSymbol.RIGHTARROW));
    corePackage.addSimpleMathCommand(
        "Longrightarrow", new MathOperatorInterpretation(MathMLSymbol.UC_RIGHTARROW));
    corePackage.addSimpleMathCommand(
        "longleftrightarrow", new MathOperatorInterpretation(MathMLSymbol.LEFTRIGHTARROW));
    corePackage.addSimpleMathCommand(
        "Longleftrightarrow", new MathOperatorInterpretation(MathMLSymbol.UC_LEFTRIGHTARROW));
    corePackage.addSimpleMathCommand(
        "longmapsto", new MathOperatorInterpretation(MathMLSymbol.MAPSTO));
    corePackage.addSimpleMathCommand(
        "hookrightarrow", new MathOperatorInterpretation(MathMLSymbol.HOOKRIGHTARROW));
    corePackage.addSimpleMathCommand(
        "rightharpoonup", new MathOperatorInterpretation(MathMLSymbol.RIGHTHARPOONOUP));
    corePackage.addSimpleMathCommand(
        "rightharpoondown", new MathOperatorInterpretation(MathMLSymbol.RIGHTHARPOONDOWN));
    corePackage.addSimpleMathCommand(
        "uparrow", new MathOperatorInterpretation(MathMLSymbol.UPARROW));
    corePackage.addSimpleMathCommand(
        "Uparrow", new MathOperatorInterpretation(MathMLSymbol.UC_UPARROW));
    corePackage.addSimpleMathCommand(
        "downarrow", new MathOperatorInterpretation(MathMLSymbol.DOWNARROW));
    corePackage.addSimpleMathCommand(
        "Downarrow", new MathOperatorInterpretation(MathMLSymbol.UC_DOWNARROW));
    corePackage.addSimpleMathCommand(
        "updownarrow", new MathOperatorInterpretation(MathMLSymbol.UPDOWNARROW));
    corePackage.addSimpleMathCommand(
        "Updownarrow", new MathOperatorInterpretation(MathMLSymbol.UC_UPDOWNARROW));
    corePackage.addSimpleMathCommand(
        "nearrow", new MathOperatorInterpretation(MathMLSymbol.NEARROW));
    corePackage.addSimpleMathCommand(
        "searrow", new MathOperatorInterpretation(MathMLSymbol.SEARROW));
    corePackage.addSimpleMathCommand(
        "swarrow", new MathOperatorInterpretation(MathMLSymbol.SWARROW));
    corePackage.addSimpleMathCommand(
        "nwarrow", new MathOperatorInterpretation(MathMLSymbol.NWARROW));
    ...
    corePackage.addSimpleMathCommand(
        "emptyset", new MathIdentifierInterpretation(MathMLSymbol.EMPTYSET));
    ...
    corePackage.addSimpleMathCommand(
        "natural", new MathIdentifierInterpretation(MathMLSymbol.NATURAL));
    corePackage.addSimpleMathCommand("sharp", new MathIdentifierInterpretation(MathMLSymbol.SHARP));
    corePackage.addSimpleMathCommand(
        "backslash", new MathOperatorInterpretation(MathMLSymbol.BACKSLASH));
    corePackage.addSimpleMathCommand(
        "partial", new MathOperatorInterpretation(MathMLSymbol.PARTIAL));
    corePackage.addSimpleMathCommand("infty", new MathIdentifierInterpretation(MathMLSymbol.INFTY));
    corePackage.addSimpleMathCommand(
        "triangle", new MathIdentifierInterpretation(MathMLSymbol.TRIANGLE));
    corePackage.addSimpleMathCommand(
        "clubsuit", new MathIdentifierInterpretation(MathMLSymbol.CLUBSUIT));
    corePackage.addSimpleMathCommand(
        "diamondsuit", new MathIdentifierInterpretation(MathMLSymbol.DIAMONDSUIT));
    corePackage.addSimpleMathCommand(
        "heartsuit", new MathIdentifierInterpretation(MathMLSymbol.HEARTSUIT));
    corePackage.addSimpleMathCommand(
        "spadesuit", new MathIdentifierInterpretation(MathMLSymbol.SPADESUIT));
    ...
    corePackage.addSimpleMathCommand(
        ...
        new MathBracketInterpretation(
            MathMLSymbol.VERT_BRACKET, BracketType.OPENER_OR_CLOSER, true));
    corePackage.addSimpleMathCommand(
        "Vert",
        new MathOperatorInterpretation(MathMLSymbol.DOUBLE_VERT_BRACKET),
        new MathBracketInterpretation(
            MathMLSymbol.DOUBLE_VERT_BRACKET, BracketType.OPENER_OR_CLOSER, true));
    ...
    CMD_NOT =
        corePackage.addCombinerCommand(
            "not", MATH_MODE_ONLY, notTargetMatcher, new MathNotHandler(), null);

    /* Complex math macros */
    corePackage.addComplexCommandSameArgMode(
        "sqrt", true, 1, MATH_MODE_ONLY, new MathRootHandler(), null);
    CMD_FRAC =
        corePackage.addComplexCommandSameArgMode(
            "frac", false, 2, MATH_MODE_ONLY, new MathComplexCommandHandler("mfrac"), null);
    CMD_OVER =
        corePackage.addSimpleCommand(
            "over",
            MATH_MODE_ONLY,
            null,
            null); /* TeX style fractions {... \over ...}, replaced during fixing *;
    ...
    corePackage.addComplexCommandSameArgMode(
        "hspace", false, 1, ALL_MODES, new HSpaceHandler(), null);
    corePackage.addComplexCommandSameArgMode(
        "hspace*", false, 1, ALL_MODES, new HSpaceHandler(), null);
    ...
    corePackage.addComplexCommandSameArgMode(
        ...
        1,
        MATH_MODE_ONLY,
        new AccentHandler(AccentMaps.CIRCUMFLEX, '\u0302', "mover"),
        null);
    corePackage.addComplexCommandSameArgMode(
        "bar", false, 1, MATH_MODE_ONLY, new AccentHandler(null, '\u0304', "mover"), null);
    corePackage.addComplexCommandSameArgMode(
        "vec", false, 1, MATH_MODE_ONLY, new AccentHandler(null, '\u2192', "mover"), null);
    corePackage.addComplexCommandSameArgMode(
        "dot", false, 1, MATH_MODE_ONLY, new AccentHandler(null, '\u0307', "mover"), null);
    corePackage.addComplexCommandSameArgMode(
        "ddot", false, 1, MATH_MODE_ONLY, new AccentHandler(null, '\u0308', "mover"), null);
    corePackage.addComplexCommandSameArgMode(
        "tilde", false, 1, MATH_MODE_ONLY, new AccentHandler(AccentMaps.TILDE, '~', "mover"), null);
    corePackage.addComplexCommandSameArgMode(
        "widehat",
        false,
        1,
    ...
    corePackage.addComplexCommandSameArgMode(
        ...
        1,
        MATH_MODE_ONLY,
        new AccentHandler(AccentMaps.TILDE, '\u02dc', "mover"),
        null);
    corePackage.addComplexCommandSameArgMode(
        "overline",
        false,
    ...
    corePackage.addComplexCommandSameArgMode(
        "overbrace", false, 1, MATH_MODE_ONLY, new AccentHandler(null, '\ufe37', "mover"), null);
    corePackage.addComplexCommandSameArgMode(
        "underbrace", false, 1, MATH_MODE_ONLY, new AccentHandler(null, '\ufe38', "munder"), null);
    corePackage.addComplexCommandSameArgMode(
        "overrightarrow",
        false,
        1,
        MATH_MODE_ONLY,
        new AccentHandler(null, '\u20d7', "mover"),
        null);
    corePackage.addComplexCommandSameArgMode(
        "overleftarrow",
        false,
        1,
        MATH_MODE_ONLY,
        new AccentHandler(null, '\u20d6', "mover"),
        null);
    ...
    corePackage.addComplexCommandSameArgMode(
        ...
        1,
        ALL_MODES,
        StyleDeclarationInterpretation.UNDERLINE,
        new ModeDelegatingHandler(
    ...
    CMD_NEWCOMMAND =
        corePackage.addComplexCommandSameArgMode(
            "newcommand", false, 1, ALL_MODES, doNothingHandler, IGNORE);
    CMD_RENEWCOMMAND =
        corePackage.addComplexCommandSameArgMode(
            "renewcommand", false, 1, ALL_MODES, doNothingHandler, IGNORE);
    CMD_NEWENVIRONMENT =
        corePackage.addComplexCommandSameArgMode(
            "newenvironment", false, 2, ALL_MODES, doNothingHandler, IGNORE);
    CMD_RENEWENVIRONMENT =
        corePackage.addComplexCommandSameArgMode(
            "renewenvironment", false, 2, ALL_MODES, doNothingHandler, IGNORE);
    ...
    corePackage.addComplexCommand(
        ...
        1,
        TEXT_MODE_ONLY,
        new LaTeXMode[] {LR, VERBATIM},
        new HrefHandler(),
        ALLOW_INLINE);
    corePackage.addComplexCommandOneArg(
        "anchor", false, TEXT_MODE_ONLY, VERBATIM, new AnchorHandler(), ALLOW_INLINE);
    corePackage.addComplexCommandOneArg(
        "anchor*", false, TEXT_MODE_ONLY, LR, new AnchorHandler(), ALLOW_INLINE);

    /* Special MathML helpers */
    corePackage.addComplexCommandOneArg(
        "units", false, MATH_MODE_ONLY, MATH, new UnitsHandler(), null);
    ...
    corePackage.addComplexCommand(
        ...
        3,
        ALL_MODES,
        new LaTeXMode[] {LR, LR, LR, null},
        new XMLBlockElementHandler(),
        START_NEW_XHTML_BLOCK);
    corePackage.addComplexCommand(
        "xmlInlineElement",
        true,
    ...
    corePackage.addComplexCommandOneArg(
        ...
        ALL_MODES,
        VERBATIM,
        new XMLNameOrIdHandler(XMLNameOrIdHandler.NAME),
        IGNORE);
    corePackage.addComplexCommandOneArg(
        "xmlName*", false, ALL_MODES, LR, new XMLNameOrIdHandler(XMLNameOrIdHandler.NAME), IGNORE);
    corePackage.addComplexCommandOneArg(
        "xmlId", false, ALL_MODES, VERBATIM, new XMLNameOrIdHandler(XMLNameOrIdHandler.ID), IGNORE);
    corePackage.addComplexCommandOneArg(
        "xmlId*", false, ALL_MODES, LR, new XMLNameOrIdHandler(XMLNameOrIdHandler.ID), IGNORE);
    corePackage.addComplexCommandSameArgMode(
        "xmlUnparse", false, 1, TEXT_MODE_ONLY, new XMLUnparseHandler(), ALLOW_INLINE);
    corePackage.addComplexCommandOneArg(
        "ux", false, ALL_MODES, LR, new InsertUnicodeHandler(), IGNORE);

    /* Special commands for managing simple "variables" */
    corePackage.addComplexCommandSameArgMode(
        "getvar", true, 1, ALL_MODES, new GetVarHandler(), IGNORE);
    corePackage.addComplexCommandSameArgMode(
        "setvar", true, 2, ALL_MODES, new SetVarHandler(), IGNORE);

    /* =================================== ENVIRONMENTS ================================= */

    ENV_MATH =
        corePackage.addEnvironment(
            "math", TEXT_MODE_ONLY, MATH, null, new MathEnvironmentHandler(), ALLOW_INLINE);
    ENV_DISPLAYMATH =
        corePackage.addEnvironment(
            "displaymath", TEXT_MODE_ONLY, MATH, null, new MathEnvironmentHandler(), ALLOW_INLINE);
    ENV_VERBATIM =
        corePackage.addEnvironment(
            "verbatim",
            PARA_MODE_ONLY,
    ...
    corePackage.addEnvironment(
        ...
        START_NEW_XHTML_BLOCK);
    corePackage.addEnvironment(
        "array", false, 1, MATH_MODE_ONLY, MATH, tabularInterpretation, new ArrayHandler(), null);
    corePackage.addEnvironment(
        "cases",
        MATH_MODE_ONLY,
        MATH,
        tabularInterpretation,
        new MatrixHandler(2, MathMLSymbol.OPEN_CURLY_BRACKET, ""),
        null);
    corePackage.addEnvironment(
        "eqnarray",
        PARA_MODE_ONLY,
    ...
    corePackage.addEnvironment(
        "matrix", MATH_MODE_ONLY, MATH, tabularInterpretation, new MatrixHandler(), null);
    corePackage.addEnvironment(
        "pmatrix",
        MATH_MODE_ONLY,
        MATH,
        tabularInterpretation,
        new MatrixHandler(MathMLSymbol.OPEN_BRACKET, MathMLSymbol.CLOSE_BRACKET),
        null);
    corePackage.addEnvironment(
        "bmatrix",
        MATH_MODE_ONLY,
    ...
    corePackage.addEnvironment(
        ...
        MATH,
        tabularInterpretation,
        new MatrixHandler(MathMLSymbol.OPEN_CURLY_BRACKET, MathMLSymbol.CLOSE_CURLY_BRACKET),
        null);
    corePackage.addEnvironment(
        "vmatrix",
        MATH_MODE_ONLY,
        MATH,
        tabularInterpretation,
        new MatrixHandler(MathMLSymbol.VERT_BRACKET, MathMLSymbol.VERT_BRACKET),
        null);
    corePackage.addEnvironment(
        "Vmatrix",
        MATH_MODE_ONLY,
    ...
    corePackage.addEnvironment(
        ...
        PARAGRAPH,
        null,
        new SimpleXHTMLContainerBuildingHandler("blockquote"),
        START_NEW_XHTML_BLOCK);
    ...
    corePackage.addEnvironment(
        ...
        PARAGRAPH,
        null,
        new SimpleXHTMLContainerBuildingHandler("div", "center"),
        START_NEW_XHTML_BLOCK);
    corePackage.addEnvironment(
        "flushleft",
        PARA_MODE_ONLY,
        PARAGRAPH,
        null,
        new SimpleXHTMLContainerBuildingHandler("div", "flushleft"),
        START_NEW_XHTML_BLOCK);
    corePackage.addEnvironment(
        "flushright",
        PARA_MODE_ONLY,
        PARAGRAPH,
        null,
        new SimpleXHTMLContainerBuildingHandler("div", "flushright"),
        START_NEW_XHTML_BLOCK);
    ...
    corePackage.addEnvironment(
        ...
        TEXT_MODE_ONLY,
        null,
        StyleDeclarationInterpretation.TINY,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addEnvironment(
        "scriptsize",
        TEXT_MODE_ONLY,
        null,
        StyleDeclarationInterpretation.SCRIPTSIZE,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addEnvironment(
        "footnotesize",
        TEXT_MODE_ONLY,
        null,
        StyleDeclarationInterpretation.FOOTNOTESIZE,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addEnvironment(
        "small",
        TEXT_MODE_ONLY,
        null,
        StyleDeclarationInterpretation.SMALL,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addEnvironment(
        "normalsize",
        TEXT_MODE_ONLY,
        null,
        StyleDeclarationInterpretation.NORMALSIZE,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addEnvironment(
        "large",
        TEXT_MODE_ONLY,
        null,
        StyleDeclarationInterpretation.LARGE,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addEnvironment(
        "Large",
        TEXT_MODE_ONLY,
        null,
        StyleDeclarationInterpretation.LARGE_2,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addEnvironment(
        "LARGE",
        TEXT_MODE_ONLY,
        null,
        StyleDeclarationInterpretation.LARGE_3,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addEnvironment(
        "huge",
        TEXT_MODE_ONLY,
        null,
        StyleDeclarationInterpretation.HUGE,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    corePackage.addEnvironment(
        "Huge",
        TEXT_MODE_ONLY,
        null,
        StyleDeclarationInterpretation.HUGE_2,
        styleInterpretationNodeBuilder,
        ALLOW_INLINE);
    ...
    ENV_BRACKETED =
        corePackage.addEnvironment(
            "<mfenced>", false, 2, MATH_MODE_ONLY, MATH, null, new MathFenceHandler(), null);
    ...
    corePackage.addEnvironment(
        ...
        ALLOW_INLINE);
    corePackage.addEnvironment(
        "xmlUnparse", false, 0, TEXT_MODE_ONLY, null, null, new XMLUnparseHandler(), ALLOW_INLINE);
  }
}
