...
/**
 * This interface extends the MathMLPresentationContainer interface for the MathML enlivening
 * expression element maction.
 */
public interface MathMLActionElement extends MathMLPresentationContainer {
  /**
   * A string specifying the action. Possible values include toggle, statusline, tooltip, and
   * highlight, and menu.
   *
   ...
   *
   * @param actiontype new value for actiontype.
   * @see #getActiontype()
   */
   ...
   *
   * @param selection new value for selection.
   * @see #getSelection()
   */
