          ...
          Integrate(
              Times(
                  ...
                  Power(Plus(A_DEFAULT, Times(B_DEFAULT, x_), Times(C_DEFAULT, Sqr(x_))),
                      p_DEFAULT)),
              x_Symbol),
          Condition(Dist(Power(d, CN1), Subst(Integrate(Times(
              Power(Plus(Times(Subtract(Times(d, e), Times(c, f)), Power(d, CN1)),
                  Times(f, x, Power(d, CN1))), m),
              Power(Plus(Times(CN1, CSymbol, Power(d, CN2)), Times(CSymbol, Sqr(x), Power(d, CN2))),
                  p),
              Power(Plus(a, Times(b, ArcCosh(x))), n)), x), x, Plus(c,
                  Times(d, x))),
              x),
              And(FreeQ(List(a, b, c, d, e, f, ASymbol, BSymbol, CSymbol, m, n, p), x),
                  EqQ(Plus(Times(BSymbol, Subtract(C1,
                      ...
                      Simp(
                          Times(
                              Sqrt(Plus(Times(C2, c, d, Sqr(
                                  x)), Times(Sqr(d), Power(x, C4)))),
                              Power(
                                  Times(b, d, x, Sqrt(Plus(
                                      a, Times(b, ArcSinh(Plus(c, Times(d, Sqr(x)))))))),
                                  CN1)),
                          x)),
                  Negate(Simp(Times(
                      Power(Times(CN1, c, Power(b, CN1)), QQ(3L,
                          2L)),
                      CSqrtPi, x,
                      Subtract(
                          Cosh(Times(a,
                          ...
                          Times(c, Sinh(Times(a, Power(Times(C2, b), CN1))))),
                      FresnelC(
                          Times(Sqrt(Times(CN1, c, Power(Times(Pi, b), CN1))),
                      ...
                      x)),
                  Simp(
                      Times(Power(Times(CN1, c, Power(b, CN1)), QQ(3L, 2L)), CSqrtPi, x,
                          Plus(
