...
/**
 * ResidueSolvablePolynomialRing generic solvable polynomial with residue coefficients factory
 * implementing RingFactory and extending GenSolvablePolynomialRing factory. Factory for n-variate
 * ordered solvable polynomials over solvable residue coefficients. The non-commutative
...
public class ResidueSolvablePolynomialRing<C extends GcdRingElem<C>>
   ...
   */
  public ResidueSolvablePolynomialRing(
      RingFactory<SolvableResidue<C>> cf, int n, RelationTable<SolvableResidue<C>> rt) {
   ...
   */
  public ResidueSolvablePolynomialRing(
      RingFactory<SolvableResidue<C>> cf,
      int n,
      TermOrder t,
   ...
   */
  public ResidueSolvablePolynomialRing(
      RingFactory<SolvableResidue<C>> cf, int n, TermOrder t, String[] v) {
    this(cf, n, t, v, null);
  }
   ...
   */
  public ResidueSolvablePolynomialRing(
      RingFactory<SolvableResidue<C>> cf, TermOrder t, String[] v) {
   ...
   */
  public ResidueSolvablePolynomialRing(
      RingFactory<SolvableResidue<C>> cf, ResidueSolvablePolynomialRing o) {
  ...
  public ResidueSolvablePolynomialRing<C> extend(int i, boolean top) {
    ...
    ResidueSolvablePolynomialRing<C> spfac =
        new ResidueSolvablePolynomialRing<C>(pfac.coFac, pfac.nvar, pfac.tord, pfac.getVars());
  ...
  /**
   * Solvable residue coefficients from integral polynomial coefficients. Represent as polynomial
   * with type SolvableResidue<C> coefficients.
   *
   ...
   */
  public ResidueSolvablePolynomial<C> fromPolyCoefficients(
  ...
  /**
   * Integral function from solvable residue coefficients. Represent as polynomial with type
