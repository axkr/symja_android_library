...
/**
 * This interface extends the MathMLElement interface for the MathML style element mstyle. While the
 * mstyle element may contain any attributes allowable on any MathML presentation element, only
 * attributes specific to the mstyle element are included in the interface below. Other attributes
 * should be accessed using the methods on the base Element class, particularly the
 * Element::getAttribute and Element::setAttribute methods, or even the Node::attributes attribute
 * to access all of them at once. Not only does this obviate a lengthy list below, but it seems
 * likely that most implementations will find this a considerably more useful interface to a
 * MathMLStyleElement.
 */
public interface MathMLStyleElement extends MathMLPresentationContainer {
  /**
   * A string of the form +/- unsigned integer; represents the scriptlevel attribute for the mstyle
   ...
   *
   * @param scriptlevel new value for scriptlevel.
   * @see #getScriptlevel()
   */
  void setScriptlevel(String scriptlevel);

  /**
   * Either true or false; a string representing the displaystyle attribute for the mstyle element,
   ...
   *
   * @param displaystyle new value for displaystyle.
   * @see #getDisplaystyle()
   */
  void setDisplaystyle(String displaystyle);

  /**
   * A string of the form number; represents the scriptsizemultiplier attribute for the mstyle
   * element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param scriptsizemultiplier new value for scriptsizemultiplier.
   * @see #getScriptsizemultiplier()
   */
  void setScriptsizemultiplier(String scriptsizemultiplier);

  /**
   * A string of the form number v-unit; represents the scriptminsize attribute for the mstyle
   * element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param scriptminsize new value for scriptminsize.
   * @see #getScriptminsize()
   */
  void setScriptminsize(String scriptminsize);

  /**
   * A string representation of a color or the string transparent; represents the background
   ...
   *
   * @param background new value for background.
   * @see #getBackground()
   */
  void setBackground(String background);

  /**
   * A string of the form number h-unit; represents the veryverythinmathspace attribute for the
   ...
   *
   * @param veryverythinmathspace new value for veryverythinmathspace.
   * @see #getVeryverythinmathspace()
   */
  void setVeryverythinmathspace(String veryverythinmathspace);

  /**
   * A string of the form number h-unit; represents the verythinmathspace attribute for the mstyle
   * element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param verythinmathspace new value for verythinmathspace.
   * @see #getVerythinmathspace()
   */
  void setVerythinmathspace(String verythinmathspace);

  /**
   * A string of the form number h-unit; represents the thinmathspace attribute for the mstyle
   * element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param thinmathspace new value for thinmathspace.
   * @see #getThinmathspace()
   */
  void setThinmathspace(String thinmathspace);

  /**
   * A string of the form number h-unit; represents the mediummathspace attribute for the mstyle
   * element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param mediummathspace new value for mediummathspace.
   * @see #getMediummathspace()
   */
  void setMediummathspace(String mediummathspace);

  /**
   * A string of the form number h-unit; represents the thickmathspace attribute for the mstyle
   * element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param thickmathspace new value for thickmathspace.
   * @see #getThickmathspace()
   */
  void setThickmathspace(String thickmathspace);

  /**
   * A string of the form number h-unit; represents the verythickmathspace attribute for the mstyle
   * element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param verythickmathspace new value for verythickmathspace.
   * @see #getVerythickmathspace()
   */
  void setVerythickmathspace(String verythickmathspace);

  /**
   * A string of the form number h-unit; represents the veryverythickmathspace attribute for the
   * mstyle element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param veryverythickmathspace new value for veryverythickmathspace.
   * @see #getVeryverythickmathspace()
   */
  void setVeryverythickmathspace(String veryverythickmathspace);

  /**
   * A string of the form number h-unit; represents the negativeveryverythinmathspace attribute for
   * the mstyle element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param negativeveryverythinmathspace new value for negativeveryverythinmathspace.
   * @see #getNegativeveryverythinmathspace()
   */
  void setNegativeveryverythinmathspace(String negativeveryverythinmathspace);

  /**
   * A string of the form number h-unit; represents the negativeverythinmathspace attribute for the
   * mstyle element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param negativeverythinmathspace new value for negativeverythinmathspace.
   * @see #getNegativeverythinmathspace()
   */
  void setNegativeverythinmathspace(String negativeverythinmathspace);

  /**
   * A string of the form number h-unit; represents the negativethinmathspace attribute for the
   * mstyle element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param negativethinmathspace new value for negativethinmathspace.
   * @see #getNegativethinmathspace()
   */
  void setNegativethinmathspace(String negativethinmathspace);

  /**
   * A string of the form number h-unit; represents the negativemediummathspace attribute for the
   * mstyle element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param negativemediummathspace new value for negativemediummathspace.
   * @see #getNegativemediummathspace()
   */
  void setNegativemediummathspace(String negativemediummathspace);

  /**
   * A string of the form number h-unit; represents the negativethickmathspace attribute for the
   * mstyle element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param negativethickmathspace new value for negativethickmathspace.
   * @see #getNegativethickmathspace()
   */
  void setNegativethickmathspace(String negativethickmathspace);

  /**
   * A string of the form number h-unit; represents the negativeverythickmathspace attribute for the
   * mstyle element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param negativeverythickmathspace new value for negativeverythickmathspace.
   * @see #getNegativeverythickmathspace()
   */
  void setNegativeverythickmathspace(String negativeverythickmathspace);

  /**
   * A string of the form number h-unit; represents the negativeveryverythickmathspace attribute for
   * the mstyle element, if specified. See also the discussion of this attribute.
   *
   ...
   *
   * @param negativeveryverythickmathspace new value for negativeveryverythickmathspace.
