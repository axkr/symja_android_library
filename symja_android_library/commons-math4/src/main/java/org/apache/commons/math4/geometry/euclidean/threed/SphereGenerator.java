...
public class SphereGenerator implements SupportBallGenerator<Euclidean3D, Vector3D> {
                ...
                if (support.size() < 3) {
                    ...
                    if (support.size() < 4) {
                        ...
                        final BigFraction[] c1 = new BigFraction[] {
                            c2[0].multiply(c2[0]).sum(c3[0].multiply(c3[0])).sum(c4[0].multiply(c4[0])),
                            c2[1].multiply(c2[1]).sum(c3[1].multiply(c3[1])).sum(c4[1].multiply(c4[1])),
                            c2[2].multiply(c2[2]).sum(c3[2].multiply(c3[2])).sum(c4[2].multiply(c4[2])),
                            c2[3].multiply(c2[3]).sum(c3[3].multiply(c3[3])).sum(c4[3].multiply(c4[3]))
                        };
                        ...
                        final BigFraction r2      = dx.multiply(dx).sum(dy.multiply(dy)).sum(dz.multiply(dz));
    ...
    private BigFraction minor(final BigFraction[] c1, final BigFraction[] c2, final BigFraction[] c3) {
        return      c2[0].multiply(c3[1]).multiply(c1[2].subtract(c1[3])).
                sum(c2[0].multiply(c3[2]).multiply(c1[3].subtract(c1[1]))).
                sum(c2[0].multiply(c3[3]).multiply(c1[1].subtract(c1[2]))).
                sum(c2[1].multiply(c3[0]).multiply(c1[3].subtract(c1[2]))).
                sum(c2[1].multiply(c3[2]).multiply(c1[0].subtract(c1[3]))).
                sum(c2[1].multiply(c3[3]).multiply(c1[2].subtract(c1[0]))).
                sum(c2[2].multiply(c3[0]).multiply(c1[1].subtract(c1[3]))).
                sum(c2[2].multiply(c3[1]).multiply(c1[3].subtract(c1[0]))).
                sum(c2[2].multiply(c3[3]).multiply(c1[0].subtract(c1[1]))).
                sum(c2[3].multiply(c3[0]).multiply(c1[2].subtract(c1[1]))).
                sum(c2[3].multiply(c3[1]).multiply(c1[0].subtract(c1[2]))).
                sum(c2[3].multiply(c3[2]).multiply(c1[1].subtract(c1[0])));
    }
