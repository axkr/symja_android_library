...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "KaryTree", "KelvinBei", "KelvinBer", "Key", "KeyDrop", "KeyExistsQ", "KeyFreeQ", "KeyMap",
      ...
      "KroneckerProduct", "KroneckerSymbol", "Kurtosis", "Labeled", "LaguerreL", "LambertW",
      "LaplaceTransform", "Laplacian", "LaplacianPDETerm", "Last", "LCM", "LeafCount",
