...
ISetDelayed(514,DeactivateTrig(Times(Power(Plus(a_DEFAULT,Times($($p("§trig"),Plus(e_DEFAULT,Times(f_DEFAULT,x_))),b_DEFAULT)),n_DEFAULT),Power(Plus(c_DEFAULT,Times(d_DEFAULT,x_)),m_DEFAULT)),x_),
...
ISetDelayed(519,FixInertTrigFunction(Times(Power($($s("§csc"),v_),m_DEFAULT),Power(Times($($s("§sin"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sin"),v),Negate(m)),Power(Times(c,$($s("§sin"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(520,FixInertTrigFunction(Times(Power($($s("§sec"),v_),m_DEFAULT),Power(Times($($s("§cos"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§cos"),v),Negate(m)),Power(Times(c,$($s("§cos"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(521,FixInertTrigFunction(Times(Power($($s("§cot"),v_),m_DEFAULT),Power(Times($($s("§tan"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§tan"),v),Negate(m)),Power(Times(c,$($s("§tan"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(522,FixInertTrigFunction(Times(Power($($s("§tan"),v_),m_DEFAULT),Power(Times($($s("§cot"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§cot"),v),Negate(m)),Power(Times(c,$($s("§cot"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(523,FixInertTrigFunction(Times(Power($($s("§cos"),v_),m_DEFAULT),Power(Times($($s("§sec"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sec"),v),Negate(m)),Power(Times(c,$($s("§sec"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(524,FixInertTrigFunction(Times(Power($($s("§sin"),v_),m_DEFAULT),Power(Times($($s("§csc"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§csc"),v),Negate(m)),Power(Times(c,$($s("§csc"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(525,FixInertTrigFunction(Times(Power($($s("§sec"),v_),m_DEFAULT),Power(Times($($s("§sin"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§cos"),v),Negate(m)),Power(Times(c,$($s("§sin"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(526,FixInertTrigFunction(Times(Power($($s("§csc"),v_),m_DEFAULT),Power(Times($($s("§cos"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sin"),v),Negate(m)),Power(Times(c,$($s("§cos"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(527,FixInertTrigFunction(Times(Power($($s("§cos"),v_),m_DEFAULT),Power(Times($($s("§tan"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sec"),v),Negate(m)),Power(Times(c,$($s("§tan"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(528,FixInertTrigFunction(Times(Power($($s("§sin"),v_),m_DEFAULT),Power(Times($($s("§cot"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§csc"),v),Negate(m)),Power(Times(c,$($s("§cot"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(529,FixInertTrigFunction(Times(Power($($s("§sin"),v_),m_DEFAULT),Power(Times($($s("§sec"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§csc"),v),Negate(m)),Power(Times(c,$($s("§sec"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(530,FixInertTrigFunction(Times(Power($($s("§cos"),v_),m_DEFAULT),Power(Times($($s("§csc"),w_),c_DEFAULT),n_DEFAULT)),x_),
    Condition(Times(Power($($s("§sec"),v),Negate(m)),Power(Times(c,$($s("§csc"),w)),n)),And(FreeQ(list(c,n),x),IntegerQ(m)))),
ISetDelayed(531,FixInertTrigFunction(Times(Power($($s("§cot"),v_),m_DEFAULT),Power(Times($($s("§sin"),w_),c_DEFAULT),n_DEFAULT)),x_),
