...
/**
 * Job-shop scheduling benchmark problem of FT06. The optimum makespan is 55.
 *
...
public class FT06 {
  private static void ft06(Network net) {
    ...
    IntVariable[][] jobs =
        {{v[1], v[2], v[3], v[4], v[5], v[6], v[0]}, {v[7], v[8], v[9], v[10], v[11], v[12], v[0]},
    ...
    int[][] jobs_pt = {{1, 3, 6, 7, 3, 6}, {8, 5, 10, 10, 10, 4}, {5, 4, 8, 9, 1, 7},
        {5, 5, 5, 3, 8, 9}, {9, 3, 5, 4, 3, 1}, {3, 3, 9, 10, 4, 1}};
    IntVariable[][] machines =
        {{v[2], v[11], v[16], v[20], v[29], v[34]}, {v[3], v[7], v[17], v[19], v[26], v[31]},
            {v[1], v[8], v[13], v[21], v[25], v[36]}, {v[4], v[12], v[14], v[22], v[30], v[32]},
            {v[6], v[9], v[18], v[23], v[27], v[35]}, {v[5], v[10], v[15], v[24], v[28], v[33]}};
    int[][] machines_pt = {{3, 10, 9, 5, 3, 10}, {6, 8, 1, 5, 3, 3}, {1, 5, 5, 5, 9, 1},
        {7, 4, 4, 3, 1, 3}, {6, 10, 7, 8, 5, 4}, {3, 10, 8, 9, 4, 9}};
  ...
  private static void solve(Network net, String solverName, long timeout) {
    ...
    System.out.println("Start " + solver + ", timeout = " + timeout + " msecs");
