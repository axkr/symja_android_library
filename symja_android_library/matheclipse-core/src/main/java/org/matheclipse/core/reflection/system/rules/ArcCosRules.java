...
public interface ArcCosRules {
  final public static IAST RULES = List(
    ...
    ISet(ArcCos(Times(C1D2,Sqrt(C2))),
      Times(C1D4,Pi)),
    ISet(ArcCos(Times(CN1D2,Sqrt(C2))),
      Times(QQ(3L,4L),Pi)),
    ISet(ArcCos(Times(C1D2,Sqrt(C3))),
      Times(QQ(1L,6L),Pi)),
    ISet(ArcCos(Times(CN1D2,Sqrt(C3))),
      Times(QQ(5L,6L),Pi)),
    ISet(ArcCos(Times(C1D2,Sqrt(Plus(C2,Sqrt(C2))))),
      Times(QQ(1L,8L),Pi)),
    ISet(ArcCos(Times(CN1D2,Sqrt(Plus(C2,Sqrt(C2))))),
      Times(QQ(7L,8L),Pi)),
    ISet(ArcCos(Times(C1D2,Plus(C1,Sqrt(C3)),Power(C2,CN1D2))),
      Times(QQ(1L,12L),Pi)),
    ISet(ArcCos(Times(C1D2,Plus(CN1,Times(CN1,Sqrt(C3))),Power(C2,CN1D2))),
      Times(QQ(11L,12L),Pi)),
    ISet(ArcCos(C1),
      C0),
    ISet(ArcCos(CN1),
    ...
    ISet(ArcCos(Times(CI,CInfinity)),
      Times(CNI,CInfinity)),
    ISet(ArcCos(Times(CNI,CInfinity)),
      Times(CI,CInfinity)),
