...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "ConvexHullMesh", "Convolve", "CoordinateBoundingBox", "CoordinateBounds", "CoplanarPoints",
      "CoprimeQ", "Correlation", "CorrelationDistance", "Cos", "Cosh", "CoshIntegral",
      "CosineDistance", "CosIntegral", "Cot", "Coth", "Count", "CountDistinct", "Counts",
      "CountsBy", "Covariance", "CreateDirectory", "CreateFile", "CreateUUID", "Cross",
      "CrossMatrix", "Csc", "Csch", "Cube", "CubeRoot", "Cuboid", "Cumulant", "Curl", "CycleGraph",
      "Cycles", "Cyclotomic", "Cylinder", "Darker", "Dashing", "Dataset", "DateObject",
      "DateString", "DateValue", "DawsonF", "DeBruijnSequence", "Decrement", "Decompose",
      "DedekindNumber", "Default", "DefaultButton", "DefaultValues", "Defer", "Definition",
      ...
      "DialogReturn", "DiamondMatrix", "DiceDissimilarity", "DifferenceDelta", "DifferenceQuotient",
      "DifferenceRoot", "Differences", "DigitCount", "DigitQ", "DigitSum", "Dimensions",
      "DiracDelta", "DirectedEdge", "DirectedGraphQ", "DirectedInfinity", "Direction",
      ...
      "DisjointQ", "Disk", "Dispatch", "DisplayForm", "Distribute", "Distributed", "Div", "Divide",
      "DivideBy", "DivideSides", "Divisible", "Divisors", "DivisorSigma", "DivisorSum", "Do",
      "Dodecahedron", "Dot", "DownValues", "Drop", "DSolve", "DSolveValue", "Dt", "DuplicateFreeQ",
      "Dynamic", "EasterSunday", "Echo", "EchoFunction", "EdgeAdd", "EdgeCount", "EdgeContract",
      "EdgeDelete", "EdgeForm", "EdgeList", "EdgeQ", "EdgeRules", "EdgeWeight", "EditDistance",
      "EffectiveInterest", "Eigensystem", "Eigenvalues", "EigenvectorCentrality", "Eigenvectors",
      "Element", "ElementData", "Eliminate", "Ellipsoid", "EllipticE", "EllipticF", "EllipticK",
      "EllipticPi", "EllipticTheta", "EmpiricalDistribution", "End", "EndPackage", "EndTestSection",
      "Entity", "EntityClass", "EntityList", "EntityProperty", "Entropy", "Equal", "EqualTo",
      "Equivalent", "Erf", "Erfc", "Erfi", "ErlangDistribution", "EuclideanDistance", "EulerE",
      "EulerianGraphQ", "EulerPhi", "Evaluate", "EvenQ", "ExactNumberQ", "Except", "Exists", "Exit",
      "Exp", "Expand", "ExpandAll", "ExpandDenominator", "ExpandNumerator", "Expectation",
      "ExpIntegralE", "ExpIntegralEi", "Exponent", "ExponentialDistribution",
      "ExponentialGeneratingFunction", "Export", "ExportString", "ExpToTrig", "ExtendedGCD",
      "Extract", "FaceForm", "Factor", "Factorial", "Factorial2", "FactorList", "FactorialMoment",
      "FactorialPower", "FactorInteger", "FactorSquareFree", "FactorSquareFreeList", "FactorTerms",
      "FactorTermsList", "Fibonacci", "FiniteGroupCount", "FiniteAbelianGroupCount", "File",
      "FileFormat", "FileHash", "FileNameDrop", "FileNameJoin", "FileNames", "FileNameTake",
      "FilePrint", "FilterRules", "FindClusters", "FindCycle", "FindEdgeCover", "FindEulerianCycle",
      ...
      "FromDigits", "FromLetterNumber", "FromPolarCoordinates",
      ...
      "GaussianWindow", "GCD", "GegenbauerC", "GeneratingFunction", "GeodesyData", "GeoDistance", "GeometricDistribution", "GeometricMean",
      "GeometricTransformation", "GeoPosition",  "Get",
      ...
      "JavaObjectQ", "JavaShow", "Join", "JoinForm", "JordanDecomposition", "JSForm", "JSFormData",
       "KaryTree", "KelvinBei", "KelvinBer", "Key", "KeyDrop", "KeyDropFrom",
      "KeyExistsQ", "KeyFreeQ", "KeyMap", "KeyMemberQ", "Keys", "KeySelect", "KeySort", "KeySortBy",
      "KeyTake", "KeyUnion", "KeyValueMap", "KeyValuePattern", "KirchhoffMatrix", "KleinInvariantJ",
      ...
      "ShortUpArrow", "Show",  "Sign", "Signature", "SignCmp",
      "SignedRegionDistance", "Simplex", "Simplify", "Sin", "Sinc", "SingularValueDecomposition",
      "SingularValueList", "Sinh", "SinhIntegral", "SinIntegral", "SixJSymbol", "Skeleton",
      "Skewness", "Slot", "SlotNumber", "SlotSequence", "SlotSequenceNumber", "SmallCircle",
      "SmithDecomposition", "SokalSneathDissimilarity", "Solve", "SolveAlways", "Sort", "SortBy",
      "Sow", "Span", "SparseArray", "SparseArrayQ", "SpearmanRho", "SpecialsFreeQ", "Specularity",
      ...
      "SucceedsTilde", "SuchThat", "SudokuSolve", "Sum", "Summary", "SuperDagger", "Superscript",
      "SuperscriptBox", "Superset", "SupersetEqual", "Surd", "SurfaceArea", "SurfaceGraphics",
      "SurvivalFunction", "Switch", "SymbolicDeltaProductArray", "SymbolicIdentityArray",
      ...
      "SyntaxQ", "SystemDialogInput", "Table", "TableForm", "TagSet", "TagSetDelayed", "TagUnset",
      ...
      "TensorProduct", "TensorRank", "TensorSymmetry", "TensorTranspose", "TensorWedge",
      "TestReport", "TestReportObject", "TestResultObject", "Tetrahedron", "TeXForm", "Text",
      "TextCell", "TextElement", "TextString", "TextStructure", "Therefore", "Thickness", "Thread",
      "ThreeJSymbol", "Through", "Throw", "Tilde", "TildeEqual", "TildeFullEqual", "TildeTilde",
      "TimeConstrained", "TimeObject", "TimeRemaining", "Times", "TimesBy", 
      ...
      "TopologicalSort", "ToRadicals", "TortoiseShellBracket", "ToSphericalCoordinates", "ToString",
      "Total", "ToUnicode", "ToUpperCase", "Tr", "Trace", "TraceForm", "TraditionalForm",
      "TransformationFunction", "TransitiveClosure", "TranslationTransform", "Transliterate",
      "Transpose", "TreeForm", "TreeGraph", "TreeGraphQ", "TreePlot", "Triangle", "TriangleCenter",
      "TrigExpand", "TrigFactor", "TrigReduce", "TrigSimplifyFu", "TrigToExp", "TrueQ", "TTest",
      ...
      "UnitaryMatrixQ", "UnitBox", "UnitConvert", "Unitize", "UnitStep", "UnitTriangle",
      ...
      "UpTeeArrow", "UpTo", "UpValues", "URLDecode", "URLEncode", "URLFetch", "ValueQ", "Values",
      "VandermondeMatrix", "Variables", "Variance", "VectorAngle", "VectorGreater",
      "VectorGreaterEqual", "VectorLess", "VectorLessEqual", "VectorPlot", "VectorQ",
