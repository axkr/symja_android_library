...
SetDelayed(SplitMonomialTerms(u_,x_Symbol),
...
SetDelayed(LinearQ(u_,x_Symbol),
    And(IntPolynomialQ(u,x),SameQ(Exponent(u,x),C1))),
SetDelayed(QuadraticQ(u_,x_Symbol),
    And(IntPolynomialQ(u,x),SameQ(Exponent(u,x),C2))),
SetDelayed(MonomialQ(u_,x_Symbol),
    MatchQ(u,Condition(Power(x,n_DEFAULT),FreeQ(n,x)))),
SetDelayed(BinomialQ(u_,x_Symbol),
    NotFalseQ(BinomialTest(u,x))),
SetDelayed(MonomialSumQ(u_,x_Symbol),
...
SetDelayed(PerfectPowerTest(u_,x_Symbol),
...
SetDelayed(RationalFunctionQ(u_,x_Symbol),
...
SetDelayed(RationalFunctionExponents(u_,x_Symbol),
...
SetDelayed(AlgebraicFunctionQ(u_,x_Symbol),
...
SetDelayed(ImproperRationalFunctionQ(u_,v_,x_Symbol),
...
SetDelayed(ExpandImproperFraction(u_,x_Symbol),
...
SetDelayed(ExpandImproperFraction(u_,v_,x_Symbol),
...
SetDelayed(PolynomialDivide(u_,v_,x_Symbol),
...
SetDelayed(PolynomialFunctionOf(u_,x_Symbol),
...
SetDelayed(NormalForm(Times(Power(u_,m_),Power(v_,n_)),x_Symbol),
...
SetDelayed(NormalForm(u_,x_Symbol),
    Condition(Plus(Coefficient(u,x,C0),Times(Coefficient(u,x,C1),x)),LinearQ(u,x))),
SetDelayed(NormalForm(Times(a_,u_),x_Symbol),
    Condition(NormalForm(Map(Function(Times(a,Slot1)),u),x),And(FreeQ(a,x),SumQ(u)))),
SetDelayed(NormalForm(Times(Plus(Times($p(d,true),x_),c_),b_DEFAULT,x_),x_Symbol),
    Condition(Plus(Times(b,c,x),Times(b,d,Power(x,C2))),FreeQ(List(b,c,d),x))),
SetDelayed(NormalForm(Plus(Times(Plus(Times(Power(x_,n_DEFAULT),$p(d,true)),c_),Power(x_,n_DEFAULT),b_DEFAULT),a_),x_Symbol),
    Condition(Plus(a,Times(b,c,Power(x,n)),Times(b,d,Power(x,Times(C2,n)))),FreeQ(List(a,b,c,d,n),x))),
SetDelayed(NormalForm(Plus(Times(Power(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_),C2),$p(d,true)),c_),x_Symbol),
...
SetDelayed(NormalForm(Plus(Times(Power(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_),C2),$p(d,true)),Times(Power(x_,n_DEFAULT),$p(e,true)),c_DEFAULT),x_Symbol),
...
SetDelayed(NormalForm(Plus(Times(Plus(Times(Power(f_,Plus(Times(g_DEFAULT,x_),$p(e,true))),$p(d,true)),c_),Power(f_,Plus(Times(g_DEFAULT,x_),$p(e,true))),b_DEFAULT),a_),x_Symbol),
...
SetDelayed(NormalForm(Times(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_),Power(x_,m_DEFAULT),c_DEFAULT),x_Symbol),
    Condition(Times(c,Plus(b,Times(a,Power(x,m)))),And(FreeQ(List(a,b,c,m,n),x),ZeroQ(Plus(m,n))))),
SetDelayed(NormalForm($(f_,Times(Power(Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_),p_),Power(x_,m_DEFAULT),c_DEFAULT)),x_Symbol),
...
SetDelayed(NormalForm(Power(Times(Plus(Times(b_DEFAULT,x_),a_),Plus(Times($p(d,true),x_),c_),$p(e,true)),n_),x_Symbol),
...
SetDelayed(NormalForm($(f_,u_),x_Symbol),
    Condition($(f,ExpandPolynomial(u,x)),And(FreeQ(f,x),QuadraticPolynomialQ(u,x)))),
SetDelayed(NormalForm(Power(f_,u_),x_Symbol),
    Condition(Power(f,ExpandPolynomial(u,x)),And(FreeQ(f,x),QuadraticPolynomialQ(u,x)))),
SetDelayed(NormalForm(Times(Power(f_,v_),Power(g_,w_),u_DEFAULT),x_Symbol),
...
SetDelayed(NormalForm(Times(Power(f_,Plus(Times(Power(x_,n_DEFAULT),b_DEFAULT),a_DEFAULT)),Power(g_,Plus(Times(Power(x_,n_DEFAULT),$p(d,true)),c_DEFAULT)),u_DEFAULT),x_Symbol),
...
SetDelayed(QuadraticPolynomialQ(u_,x_Symbol),
    And(And(IntPolynomialQ(u,x),LessEqual(Exponent(u,x),C2)),Not(MatchQ(u,Condition(Times(a_DEFAULT,Power(v_,C2)),FreeQ(a,x)))))),
SetDelayed(ExpandPolynomial(u_,x_Symbol),
    Module(List(k),Sum(Times(Coefficient(u,x,k),Power(x,k)),List(k,C0,Exponent(u,x))))),
SetDelayed(NormalForm(Power(Plus(Times(Power(x_,m_DEFAULT),a_DEFAULT),Times(Power(x_,n_DEFAULT),b_DEFAULT)),p_),x_Symbol),
...
SetDelayed(NormalForm(Plus(Times(a_DEFAULT,v_),Times(b_DEFAULT,v_),u_DEFAULT),x_Symbol),
    Condition(Plus(u,Times(Plus(a,b),v)),And(FreeQ(List(a,b),x),Not(FreeQ(v,x))))),
SetDelayed(NormalForm(Power(u_,n_),x_Symbol),
    Condition(Module(List(Set(v,Together(u))),Condition(Power(v,n),Not(SumQ(v)))),And(And(SumQ(u),FractionQ(n)),Not(MonomialSumQ(u,x))))),
SetDelayed(NormalForm(Times(Cos(Times(C2,u_)),Power(Sec(u_),C2)),x_Symbol),
    Condition(Plus(C1,Times(CN1,Power(Tan(u),C2))),Not(FreeQ(u,x)))),
SetDelayed(NormalForm(Times(Plus(c_,$p(d)),Power(Plus(a_,b_),CN2),u_DEFAULT),x_Symbol),
...
SetDelayed(SimplifyExpression(Times(Power(Plus(Times(Power(x_,n_),b_DEFAULT),a_),p_DEFAULT),Power(x_,m_)),x_Symbol),
...
SetDelayed(SimplifyExpression(Power(Plus(Times(Power(x_,m_),b_DEFAULT),Times(Power(x_,n_),c_DEFAULT),Times(a_DEFAULT,x_)),CN1),x_Symbol),
...
SetDelayed(SimplifyExpression(Times(Plus(Times(Power(x_,C2),b_DEFAULT),a_DEFAULT),Power(Plus(Times(Power(x_,C2),$p(d,true)),Times(Power(Plus(Times(Power(x_,C2),g_DEFAULT),f_),C1D2),$p(e,true)),c_),CN1)),x_Symbol),
...
SetDelayed(SimplifyExpression(Times(Power(Plus(Times(Power(x_,CN1),a_DEFAULT),Times(c_DEFAULT,x_),b_),CN1),Power(x_,CN1)),x_Symbol),
    Condition(Power(Plus(a,Times(b,x),Times(c,Power(x,C2))),CN1),FreeQ(List(a,b,c),x))),
SetDelayed(SimplifyExpression(Times(Power(Plus(Times(Power(x_,CN2),a_DEFAULT),Times(Power(x_,CN1),b_DEFAULT),c_),CN1),Power(x_,CN2)),x_Symbol),
    Condition(Power(Plus(a,Times(b,x),Times(c,Power(x,C2))),CN1),FreeQ(List(a,b,c),x))),
SetDelayed(SimplifyExpression(Times(Power(Plus(Times(Power(x_,m_DEFAULT),a_DEFAULT),Times(Power(x_,p_DEFAULT),b_DEFAULT),Times(Power(x_,q_DEFAULT),c_DEFAULT)),CN1),Power(x_,m_DEFAULT)),x_Symbol),
...
SetDelayed(SimplifyExpression(u_,x_Symbol),
...
SetDelayed(TrigSimplifyAux(Times(Power(Plus(Times(Power(v_,m_DEFAULT),a_DEFAULT),Times(Power(v_,n_DEFAULT),b_DEFAULT)),p_),u_DEFAULT)),
...
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Cos(z_),C2),u_DEFAULT),Times(Power(Sin(z_),C2),v_DEFAULT),w_DEFAULT)),
    Condition(Plus(u,w),SameQ(u,v))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Sec(z_),C2),u_DEFAULT),Times(Power(Tan(z_),C2),v_DEFAULT),w_DEFAULT)),
    Condition(Plus(u,w),SameQ(u,Times(CN1,v)))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Csc(z_),C2),u_DEFAULT),Times(Power(Cot(z_),C2),v_DEFAULT),w_DEFAULT)),
    Condition(Plus(u,w),SameQ(u,Times(CN1,v)))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Sin(z_),C2),v_DEFAULT),u_,w_DEFAULT)),
    Condition(Plus(Times(u,Power(Cos(z),C2)),w),SameQ(u,Times(CN1,v)))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Cos(z_),C2),v_DEFAULT),u_,w_DEFAULT)),
    Condition(Plus(Times(u,Power(Sin(z),C2)),w),SameQ(u,Times(CN1,v)))),
SetDelayed(TrigSimplifyAux(Plus(Times(Power(Tan(z_),C2),v_DEFAULT),u_,w_DEFAULT)),
