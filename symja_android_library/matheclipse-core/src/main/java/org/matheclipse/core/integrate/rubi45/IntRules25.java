...
ISetDelayed(Int(Power(Plus(Times(a_DEFAULT,Power(x_,q_DEFAULT)),Times(c_DEFAULT,Power(x_,r_DEFAULT)),Times(b_DEFAULT,Power(x_,pn_DEFAULT))),p_),x_Symbol),
...
ISetDelayed(Int(Sqrt(Plus(Times(a_DEFAULT,Power(x_,q_DEFAULT)),Times(c_DEFAULT,Power(x_,r_DEFAULT)),Times(b_DEFAULT,Power(x_,pn_DEFAULT)))),x_Symbol),
...
ISetDelayed(Int(Power(Plus(Times(a_DEFAULT,Power(x_,q_DEFAULT)),Times(c_DEFAULT,Power(x_,r_DEFAULT)),Times(b_DEFAULT,Power(x_,pn_DEFAULT))),CN1D2),x_Symbol),
...
ISetDelayed(Int(Power(Plus(Times(a_DEFAULT,Power(u_,q_DEFAULT)),Times(b_DEFAULT,Power(v_,pn_DEFAULT)),Times(c_DEFAULT,Power(w_,r_DEFAULT))),p_),x_Symbol),
