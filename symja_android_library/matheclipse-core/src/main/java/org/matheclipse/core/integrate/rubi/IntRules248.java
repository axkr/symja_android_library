  ...
  public static IAST RULES =
      List(
                  ...
                  Subtract(
                      Negate(
                          Simp(Times(Sqrt(Plus(d, Times(e, Sqr(x)))),
                              Power(Plus(a, Times(b, ArcCot(Times(c, x)))), p), Power(Times(d, x),
                                  CN1)),
                              x)),
                      Dist(Times(b, c, p),
                          Integrate(
              ...
              Integrate(
                  Times(
                      ...
                      Power(Times(f_DEFAULT, x_), m_), Power(Plus(d_, Times(e_DEFAULT, Sqr(x_))),
                          CN1D2)),
                  x_Symbol),
              Condition(Plus(Simp(Times(Power(Times(f, x), Plus(m, C1)), Sqrt(Plus(d, Times(e, Sqr(
                  x)))), Power(Plus(a, Times(b, ArcTan(Times(c, x)))), p), Power(Times(d, f, Plus(m,
                      C1)), CN1)),
                  x),
                  Negate(
                      Dist(
                          ...
                          x)),
                  Negate(Dist(Times(Sqr(c), Plus(m, C2), Power(Times(Sqr(f), Plus(m, C1)), CN1)),
                  ...
                  And(FreeQ(List(a, b, c, d, e, f), x), EqQ(e, Times(Sqr(c),
                      d)), GtQ(p, C0), LtQ(m, CN1), NeQ(m, CN2)))),
          IIntegrate(4963,
              Integrate(
                  Times(
                      Power(
              ...
              Condition(
                  Subtract(
                      ...
                      Dist(
                          ...
                          Integrate(
                              Times(
                                  Power(x, Subtract(m, C2)), Power(Plus(d,
                                      Times(e, Sqr(x))), q),
                                  Power(Plus(a, Times(b, ArcTan(Times(c, x)))), p)),
                              x),
                          x)),
                  ...
                  Subtract(
                      ...
                      Dist(Times(d, Power(e, CN1)),
                          Integrate(
                              ...
                              x),
                          x)),
                  And(FreeQ(List(a, b, c, d, e), x), EqQ(e, Times(Sqr(c), d)), IntegersQ(p,
                      Times(C2, q)), LtQ(q, CN1), IGtQ(m, C1), NeQ(p, CN1)))),
          IIntegrate(4966,
              Integrate(
                  Times(
                      Power(
              ...
              Condition(
                  Subtract(
                      ...
                      Dist(Times(e, Power(d, CN1)),
                          Integrate(
                              Times(
                                  Power(x, Plus(m, C2)), Power(Plus(d,
                                      Times(e, Sqr(x))), q),
                                  Power(Plus(a, Times(b, ArcCot(Times(c, x)))), p)),
                              x),
                          x)),
                  And(FreeQ(List(a, b, c, d, e), x), EqQ(e, Times(Sqr(c), d)), IntegersQ(p,
                      Times(C2, q)), LtQ(q, CN1), ILtQ(m, C0), NeQ(p, CN1)))),
          IIntegrate(4968,
              Integrate(
                  Times(
                      Power(Plus(a_DEFAULT, Times(ArcTan(Times(c_DEFAULT, x_)),
              ...
              Condition(
                  Plus(
                      Simp(
                          Times(
                              Power(x, m), Power(Plus(d, Times(e, Sqr(
                                  x))), Plus(q, C1)),
                          ...
                          Dist(
                              Times(c, Plus(m, Times(C2,
                                  q), C2), Power(Times(b, Plus(p, C1)),
                                      CN1)),
                              Integrate(
                                  Times(Power(x, Plus(m, C1)), Power(Plus(d, Times(e, Sqr(x))), q),
                      ...
                      Negate(Dist(Times(m, Power(Times(b, c, Plus(p, C1)), CN1)),
                          Integrate(
                              ...
                              x),
                          x))),
                  And(FreeQ(List(a, b, c, d, e, m), x), EqQ(e, Times(Sqr(c), d)), IntegerQ(m),
                      LtQ(q, CN1), LtQ(p, CN1), NeQ(Plus(m, Times(C2, q), C2), C0)))),
          IIntegrate(4969,
              Integrate(
                  Times(
                      Power(
              ...
              Condition(
                  Plus(
                      ...
                      Dist(
                          ...
                          Integrate(
                              Times(
                                  Power(x, Plus(m, C1)), Power(Plus(d, Times(e, Sqr(x))), q),
                                  Power(Plus(a, Times(b, ArcCot(Times(c, x)))), Plus(p, C1))),
                              x),
                          x),
                      Dist(Times(m, Power(Times(b, c, Plus(p, C1)), CN1)),
                          Integrate(
                              Times(Power(x, Subtract(m, C1)), Power(Plus(d, Times(e, Sqr(x))), q),
                                  Power(Plus(a, Times(b, ArcCot(Times(c, x)))), Plus(p, C1))),
                              x),
          ...
          IIntegrate(4970,
              ...
              Condition(
                  Dist(
                      Times(Power(d, q), Power(Power(c, Plus(m, C1)),
                          CN1)),
                      Subst(
                          Integrate(
                              Times(
                                  Power(Plus(a, Times(b, x)), p), Power(Sin(
                                      x), m),
                                  Power(Power(Cos(x), Plus(m, Times(C2, Plus(q, C1)))), CN1)),
                              x),
                          x, ArcTan(Times(c, x))),
                      x),
                  And(FreeQ(List(a, b, c, d, e, p), x), EqQ(e, Times(Sqr(c), d)), IGtQ(m, C0), ILtQ(
                      Plus(m, Times(C2, q), C1), C0), Or(IntegerQ(q), GtQ(d, C0))))),
          IIntegrate(4971,
              Integrate(
                  Times(
                      Power(
              ...
              Condition(
                  ...
                  And(FreeQ(List(a, b, c, d, e, p), x), EqQ(e, Times(Sqr(c),
                      d)), IGtQ(m, C0), ILtQ(Plus(m, Times(C2, q), C1),
                          C0),
                  ...
                  Negate(
                      Dist(
                          ...
                          Subst(
                              Integrate(
                                  Times(
                                      Power(Plus(a, Times(b, x)), p), Power(Cos(x), m), Power(Power(
                                          Sin(x), Plus(m, Times(C2, Plus(q, C1)))),
                                          CN1)),
                                  x),
                              x, ArcCot(Times(c, x))),
                          x)),
                  And(FreeQ(List(a, b, c, d, e, p), x), EqQ(e, Times(Sqr(c), d)), IGtQ(m, C0),
                      ILtQ(Plus(m, Times(C2, q), C1), C0), IntegerQ(q)))),
          IIntegrate(4973,
              Integrate(
                  Times(Power(Plus(a_DEFAULT, Times(ArcCot(Times(c_DEFAULT, x_)),
                      b_DEFAULT)), p_DEFAULT), Power(x_, m_DEFAULT), Power(
                          Plus(d_, Times(e_DEFAULT, Sqr(x_))), q_)),
                  x_Symbol),
              Condition(
                  Negate(
                      Dist(
                          ...
                          Subst(
                              Integrate(
                                  Times(Power(Plus(a, Times(b, x)), p), Power(Cos(x), m),
                                      Power(Power(Sin(x), Plus(m, Times(C2, Plus(q, C1)))), CN1)),
                                  x),
                              x, ArcCot(Times(c, x))),
                          x)),
                  And(FreeQ(List(a, b, c, d, e, p), x), EqQ(e, Times(Sqr(c),
          ...
          IIntegrate(4974,
              Integrate(
                  Times(Plus(a_DEFAULT, Times(ArcTan(Times(c_DEFAULT, x_)), b_DEFAULT)), x_, Power(
          ...
          IIntegrate(4975,
              Integrate(
                  Times(Plus(a_DEFAULT, Times(ArcCot(Times(c_DEFAULT, x_)), b_DEFAULT)), x_, Power(
                      Plus(d_DEFAULT, Times(e_DEFAULT, Sqr(x_))), q_DEFAULT)),
                  x_Symbol),
              Condition(
                  Plus(
          ...
          IIntegrate(4976,
              ...
              Condition(With(
                  ...
                  And(FreeQ(List(a, b, c, d, e, f, m, q), x),
                      Or(And(IGtQ(q, C0), Not(And(ILtQ(Times(C1D2, Subtract(m, C1)), C0),
                          GtQ(Plus(m, Times(C2, q), C3), C0)))), And(
                              IGtQ(Times(C1D2, Plus(m, C1)), C0), Not(
          ...
          IIntegrate(4977,
              ...
              Condition(With(
                  ...
                  And(FreeQ(List(a, b, c, d, e, f, m, q), x), Or(
                      ...
                      And(IGtQ(Times(C1D2, Plus(m, C1)),
                          C0), Not(And(ILtQ(q, C0), GtQ(Plus(m, Times(C2, q), C3), C0)))),
                      ...
                      Dist(
                          ...
                          Integrate(
                              Times(
                                  ...
                                  Power(
                                      Subtract(C1, Times(Rt(Times(CN1, e, Power(d, CN1)), C2), x)),
                                      CN2)),
                              x),
                          x),
                      Dist(
                          ...
                          Integrate(
                              Times(
                                  Power(Plus(a,
                                      Times(b, ArcCot(Times(c, x)))), p),
                                  Power(
                                      Plus(C1, Times(Rt(Times(CN1, e, Power(d, CN1)), C2),
                                          x)),
                                      CN2)),
                              x),
                          x)),
          ...
          IIntegrate(4980,
              ...
              Condition(
                  With(
                      List(Set(u, ExpandIntegrand(Power(Plus(a, Times(b, ArcTan(Times(c, x)))), p),
