...
SetDelayed(Int(Times(Times(Power(x_,$p("m",true)),u_),Power(Plus(a_,Times($p("b",true),Power(x_,C2))),n_)),$p("x",$s("Symbol"))),
    Condition(Dist(Times(CN1,Power(a,n)),Subst(Int(Regularize(Times(Times(Power(Cot(x),m),Power(Sin(x),Times(integer(-2L),Plus(n,C1)))),SubstFor(ArcCot(x),u,x)),x),x),x,ArcCot(x))),And(And(And(And(FreeQ(List(a,b),x),FunctionOfQ(ArcCot(x),u,x)),ZeroQ(Plus(a,Times(CN1,b)))),IntegerQ(List(m,n))),Less(n,C0)))),
SetDelayed(Int(Times(Times(Power(x_,$p("m",true)),u_),Power(Plus(a_,Times($p("b",true),Power(x_,C2))),n_)),$p("x",$s("Symbol"))),
    Condition(Dist(Times(CN1,Power(a,n)),Subst(Int(Regularize(Times(Times(Power(Cot(x),m),Power(Sin(x),Times(integer(-2L),Plus(n,C1)))),SubstFor(ArcCot(x),u,x)),x),x),x,ArcCot(x))),And(And(And(And(And(And(FreeQ(List(a,b),x),FunctionOfQ(ArcCot(x),u,x)),ZeroQ(Plus(a,Times(CN1,b)))),HalfIntegerQ(n)),Less(n,CN1)),PositiveQ(a)),IntegerQ(m)))),
SetDelayed(Int(ArcCot(u_),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcCot(u_)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(v_,ArcCot(u_)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(ArcSec(Times($p("a",true),Power(x_,$p("n",true)))),Power(x_,CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcSec(Plus(a_,Times($p("b",true),x_)))),$p("x",$s("Symbol"))),
    Condition(Dist(Times(C1,Power(b,CN1)),Subst(Int(Times(Power(Plus(Times(Times(CN1,a),Power(b,CN1)),Times(x,Power(b,CN1))),m),ArcSec(x)),x),x,Plus(a,Times(b,x)))),And(And(FreeQ(List(a,b),x),IntegerQ(m)),Greater(m,C0)))),
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcSec(Times($p("a",true),x_))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcSec(Plus($p("a",true),Times($p("b",true),x_)))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times($p("u",true),Power(ArcSec(Times($p("c",true),Power(Plus($p("a",true),Times($p("b",true),Power(x_,$p("n",true)))),CN1))),$p("m",true))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(ArcSec(u_),$p("x",$s("Symbol"))),
...
SetDelayed(Int(ArcCsc(Plus($p("a",true),Times($p("b",true),x_))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(ArcCsc(Times($p("a",true),Power(x_,$p("n",true)))),Power(x_,CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcCsc(Plus(a_,Times($p("b",true),x_)))),$p("x",$s("Symbol"))),
    Condition(Dist(Times(C1,Power(b,CN1)),Subst(Int(Times(Power(Plus(Times(Times(CN1,a),Power(b,CN1)),Times(x,Power(b,CN1))),m),ArcCsc(x)),x),x,Plus(a,Times(b,x)))),And(And(FreeQ(List(a,b),x),IntegerQ(m)),Greater(m,C0)))),
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcCsc(Times($p("a",true),x_))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcCsc(Plus($p("a",true),Times($p("b",true),x_)))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times($p("u",true),Power(ArcCsc(Times($p("c",true),Power(Plus($p("a",true),Times($p("b",true),Power(x_,$p("n",true)))),CN1))),$p("m",true))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(ArcCsc(u_),$p("x",$s("Symbol"))),
...
SetDelayed(Int(ArcSinh(Plus($p("a",true),Times($p("b",true),x_))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(C1,Power(ArcSinh(Plus($p("a",true),Times($p("b",true),x_))),CN1)),$p("x",$s("Symbol"))),
    Condition(Times(CoshIntegral(ArcSinh(Plus(a,Times(b,x)))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Times(C1,Power(Power(ArcSinh(Plus($p("a",true),Times($p("b",true),x_))),C2),CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(C1,Power(Sqrt(ArcSinh(Plus($p("a",true),Times($p("b",true),x_)))),CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Sqrt(ArcSinh(Plus($p("a",true),Times($p("b",true),x_)))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Power(ArcSinh(Plus($p("a",true),Times($p("b",true),x_))),n_),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(ArcSinh(Times($p("a",true),Power(x_,$p("n",true)))),Power(x_,CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcSinh(Plus($p("a",true),Times($p("b",true),x_)))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(C1,Power(Sqrt(Plus(a_,Times($p("b",true),ArcSinh(Plus($p("c",true),Times($p("d",true),x_)))))),CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(Plus(C1,Power(x_,C2)),$p("m",true)),Power(ArcSinh(x_),$p("n",true))),$p("x",$s("Symbol"))),
    Condition(Module(List(Set(u,Block(List(Set($s("ShowSteps"),False),Set($s("StepCounter"),Null)),Int(Power(Plus(C1,Power(x,C2)),m),x)))),Plus(Times(u,Power(ArcSinh(x),n)),Times(CN1,Dist(n,Int(Expand(Times(u,Times(Power(ArcSinh(x),Plus(n,Times(CN1,C1))),Power(Sqrt(Plus(C1,Power(x,C2))),CN1)))),x))))),And(And(And(HalfIntegerQ(m),Unequal(m,CN1D2)),IntegerQ(n)),Greater(n,C0)))),
SetDelayed(Int(Times(x_,Times(Power(ArcSinh(Plus($p("a",true),Times($p("b",true),x_))),n_),Power(Sqrt(u_),CN1))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times($p("u",true),Power(ArcSinh(Times($p("c",true),Power(Plus($p("a",true),Times($p("b",true),Power(x_,$p("n",true)))),CN1))),$p("m",true))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(ArcSinh(u_),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Power(f_,Times($p("c",true),ArcSinh(Plus($p("a",true),Times($p("b",true),x_))))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Power(E,Times($p("n",true),ArcSinh(v_))),$p("x",$s("Symbol"))),
    Condition(Int(Power(Plus(v,Sqrt(Plus(C1,Power(v,C2)))),n),x),And(IntegerQ(n),PolynomialQ(v,x)))),
SetDelayed(Int(Times(Power(x_,$p("m",true)),Power(E,Times($p("n",true),ArcSinh(v_)))),$p("x",$s("Symbol"))),
    Condition(Int(Times(Power(x,m),Power(Plus(v,Sqrt(Plus(C1,Power(v,C2)))),n)),x),And(And(RationalQ(m),IntegerQ(n)),PolynomialQ(v,x)))),
SetDelayed(Int(ArcCosh(Plus($p("a",true),Times($p("b",true),x_))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(C1,Power(ArcCosh(Plus($p("a",true),Times($p("b",true),x_))),CN1)),$p("x",$s("Symbol"))),
    Condition(Times(SinhIntegral(ArcCosh(Plus(a,Times(b,x)))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Times(C1,Power(Power(ArcCosh(Plus($p("a",true),Times($p("b",true),x_))),C2),CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(C1,Power(Sqrt(ArcCosh(Plus($p("a",true),Times($p("b",true),x_)))),CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Sqrt(ArcCosh(Plus($p("a",true),Times($p("b",true),x_)))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Power(ArcCosh(Plus($p("a",true),Times($p("b",true),x_))),n_),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(ArcCosh(Times($p("a",true),Power(x_,$p("n",true)))),Power(x_,CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcCosh(Plus($p("a",true),Times($p("b",true),x_)))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(C1,Power(Sqrt(Plus(a_,Times($p("b",true),ArcCosh(Plus($p("c",true),Times($p("d",true),x_)))))),CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Times(Power(Plus(C1,x_),$p("m",true)),Power(Plus(CN1,x_),$p("m",true))),Power(ArcCosh(x_),$p("n",true))),$p("x",$s("Symbol"))),
    Condition(Module(List(Set(u,Block(List(Set($s("ShowSteps"),False),Set($s("StepCounter"),Null)),Int(Times(Power(Plus(C1,x),m),Power(Plus(CN1,x),m)),x)))),Plus(Times(u,Power(ArcCosh(x),n)),Times(CN1,Dist(n,Int(Expand(Times(u,Times(Power(ArcCosh(x),Plus(n,Times(CN1,C1))),Power(Times(Sqrt(Plus(C1,x)),Sqrt(Plus(CN1,x))),CN1)))),x))))),And(And(And(HalfIntegerQ(m),Unequal(m,CN1D2)),IntegerQ(n)),Greater(n,C0)))),
SetDelayed(Int(Times($p("u",true),Power(ArcCosh(Times($p("c",true),Power(Plus($p("a",true),Times($p("b",true),Power(x_,$p("n",true)))),CN1))),$p("m",true))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(ArcCosh(u_),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Power(f_,Times($p("c",true),ArcCosh(Plus($p("a",true),Times($p("b",true),x_))))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Power(E,Times($p("n",true),ArcCosh(v_))),$p("x",$s("Symbol"))),
    Condition(Int(Power(Plus(v,Times(Sqrt(Plus(CN1,v)),Sqrt(Plus(C1,v)))),n),x),And(IntegerQ(n),PolynomialQ(v,x)))),
SetDelayed(Int(Times(Power(x_,$p("m",true)),Power(E,Times($p("n",true),ArcCosh(v_)))),$p("x",$s("Symbol"))),
    Condition(Int(Times(Power(x,m),Power(Plus(v,Times(Sqrt(Plus(CN1,v)),Sqrt(Plus(C1,v)))),n)),x),And(And(RationalQ(m),IntegerQ(n)),PolynomialQ(v,x)))),
SetDelayed(Int(ArcTanh(Plus($p("a",true),Times($p("b",true),x_))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(ArcTanh(Plus($p("a",true),Times($p("b",true),Power(x_,n_)))),$p("x",$s("Symbol"))),
    Condition(Plus(Times(x,ArcTanh(Plus(a,Times(b,Power(x,n))))),Times(CN1,Dist(Times(b,n),Int(Times(Power(x,n),Power(Plus(Plus(Plus(C1,Times(CN1,Power(a,C2))),Times(CN1,Times(Times(Times(C2,a),b),Power(x,n)))),Times(CN1,Times(Power(b,C2),Power(x,Times(C2,n))))),CN1)),x)))),And(FreeQ(List(a,b),x),IntegerQ(n)))),
SetDelayed(Int(Times(ArcTanh(Plus($p("a",true),Times($p("b",true),Power(x_,$p("n",true))))),Power(x_,CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcTanh(Plus($p("a",true),Times($p("b",true),Power(x_,$p("n",true)))))),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(x,Plus(m,C1)),Times(ArcTanh(Plus(a,Times(b,Power(x,n)))),Power(Plus(m,C1),CN1))),Times(CN1,Dist(Times(b,Times(n,Power(Plus(m,C1),CN1))),Int(Times(Power(x,Plus(m,n)),Power(Plus(Plus(Plus(C1,Times(CN1,Power(a,C2))),Times(CN1,Times(Times(Times(C2,a),b),Power(x,n)))),Times(CN1,Times(Power(b,C2),Power(x,Times(C2,n))))),CN1)),x)))),And(And(And(FreeQ(List(a,b,m),x),IntegerQ(n)),NonzeroQ(Plus(m,C1))),NonzeroQ(Plus(Plus(m,Times(CN1,n)),C1))))),
SetDelayed(Int(Times(Power(Plus(C1,Times(CN1,Power(x_,C2))),m_),Power(ArcTanh(x_),$p("n",true))),$p("x",$s("Symbol"))),
    Condition(Module(List(Set(u,Block(List(Set($s("ShowSteps"),False),Set($s("StepCounter"),Null)),Int(Power(Plus(C1,Times(CN1,Power(x,C2))),m),x)))),Plus(Times(u,Power(ArcTanh(x),n)),Times(CN1,Dist(n,Int(Expand(Times(u,Times(Power(ArcTanh(x),Plus(n,Times(CN1,C1))),Power(Plus(C1,Times(CN1,Power(x,C2))),CN1)))),x))))),And(And(IntegerQ(List(m,n)),Less(m,CN1)),Greater(n,C0)))),
SetDelayed(Int(Times(Power(Plus(CN1,Power(x_,C2)),m_),Power(ArcTanh(x_),$p("n",true))),$p("x",$s("Symbol"))),
    Condition(Dist(Power(CN1,m),Int(Times(Power(Plus(C1,Times(CN1,Power(x,C2))),m),Power(ArcTanh(x),n)),x)),And(And(IntegerQ(List(m,n)),Less(m,CN1)),Greater(n,C0)))),
SetDelayed(Int(Times(C1,Power(Times(Times(Plus(C1,Times(CN1,Power(x_,C2))),ArcCoth(x_)),ArcTanh(x_)),CN1)),$p("x",$s("Symbol"))),
    Times(Plus(Times(CN1,Log(ArcCoth(x))),Log(ArcTanh(x))),Power(Plus(ArcCoth(x),Times(CN1,ArcTanh(x))),CN1))),
SetDelayed(Int(Times(Power(ArcCoth(x_),$p("n",true)),Times(Power(ArcTanh(x_),$p("p",true)),Power(Plus(C1,Times(CN1,Power(x_,C2))),CN1))),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(ArcCoth(x),Plus(n,C1)),Times(Power(ArcTanh(x),p),Power(Plus(n,C1),CN1))),Times(CN1,Dist(Times(p,Power(Plus(n,C1),CN1)),Int(Times(Power(ArcCoth(x),Plus(n,C1)),Times(Power(ArcTanh(x),Plus(p,Times(CN1,C1))),Power(Plus(C1,Times(CN1,Power(x,C2))),CN1))),x)))),And(IntegerQ(List(n,p)),And(Less(C0,p),LessEqual(p,n))))),
SetDelayed(Int(Times(x_,Power(ArcTanh(Times($p("a",true),x_)),n_)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(x_,Power(ArcTanh(Plus($p("a",true),Times($p("b",true),x_))),n_)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times($p("u",true),Power(ArcTanh(Times($p("c",true),Power(Plus($p("a",true),Times($p("b",true),Power(x_,$p("n",true)))),CN1))),$p("m",true))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(u_,Power(v_,$p("n",true))),$p("x",$s("Symbol"))),
    Condition(Module(List(Set($s("tmp"),InverseFunctionOfLinear(u,x))),Condition(Dist(Times(Power(Times(Times(CN1,Discriminant(v,x)),Power(Times(C4,Coefficient(v,x,C2)),CN1)),n),Power(Coefficient(Part($s("tmp"),C1),x,C1),CN1)),Subst(Int(Regularize(Times(SubstForInverseFunction(u,$s("tmp"),x),Power(Sech(x),Times(C2,Plus(n,C1)))),x),x),x,$s("tmp"))),And(And(NotFalseQ($s("tmp")),SameQ(Head($s("tmp")),$s("ArcTanh"))),ZeroQ(Plus(Times(Discriminant(v,x),Power(Part($s("tmp"),C1),C2)),Times(CN1,Power(D(v,x),C2))))))),And(And(And(QuadraticQ(v,x),IntegerQ(n)),Less(n,C0)),PosQ(Discriminant(v,x))))),
SetDelayed(Int(Times($p("u",true),Power(E,Times($p("n",true),ArcTanh(v_)))),$p("x",$s("Symbol"))),
    Condition(Int(Times(u,Times(Power(Plus(C1,v),Times(n,C1D2)),Power(Power(Plus(C1,Times(CN1,v)),Times(n,C1D2)),CN1))),x),EvenQ(n))),
SetDelayed(Int(Power(E,Times($p("n",true),ArcTanh(v_))),$p("x",$s("Symbol"))),
    Condition(Int(Times(Power(Plus(C1,v),Times(n,C1D2)),Power(Power(Plus(C1,Times(CN1,v)),Times(n,C1D2)),CN1)),x),RationalQ(n))),
SetDelayed(Int(Times(Power(x_,$p("m",true)),Power(E,Times($p("n",true),ArcTanh(v_)))),$p("x",$s("Symbol"))),
    Condition(Int(Times(Power(x,m),Times(Power(Plus(C1,v),n),Power(Power(Plus(C1,Times(CN1,Power(v,C2))),Times(n,C1D2)),CN1))),x),And(And(RationalQ(m),OddQ(n)),PolynomialQ(v,x)))),
SetDelayed(Int(Times(Times($p("u",true),Power(E,Times($p("n",true),ArcTanh(v_)))),Power(Plus(C1,Times(CN1,Power(v_,C2))),$p("m",true))),$p("x",$s("Symbol"))),
    Condition(Int(Times(Times(u,Power(Plus(C1,Times(CN1,v)),Plus(m,Times(CN1,Times(n,C1D2))))),Power(Plus(C1,v),Plus(m,Times(n,C1D2)))),x),And(And(RationalQ(List(m,n)),IntegerQ(Plus(m,Times(CN1,Times(n,C1D2))))),IntegerQ(Plus(m,Times(n,C1D2)))))),
SetDelayed(Int(Times(Times($p("u",true),Power(E,Times($p("n",true),ArcTanh(v_)))),Power(Plus(a_,Times($p("b",true),Power(v_,C2))),$p("m",true))),$p("x",$s("Symbol"))),
    Condition(Times(Times(Power(Plus(a,Times(b,Power(v,C2))),m),Power(Power(Plus(C1,Times(CN1,Power(v,C2))),m),CN1)),Int(Times(Times(u,Power(Plus(C1,Times(CN1,v)),Plus(m,Times(CN1,Times(n,C1D2))))),Power(Plus(C1,v),Plus(m,Times(n,C1D2)))),x)),And(And(And(And(FreeQ(List(a,b),x),ZeroQ(Plus(a,b))),RationalQ(List(m,n))),IntegerQ(Plus(m,Times(CN1,Times(n,C1D2))))),IntegerQ(Plus(m,Times(n,C1D2)))))),
SetDelayed(Int(Times(Times($p("u",true),Power(E,Times($p("n",true),ArcTanh(v_)))),Power(Plus(C1,Times(CN1,Power(v_,C2))),$p("m",true))),$p("x",$s("Symbol"))),
    Condition(Int(Times(Times(u,Power(Plus(C1,v),n)),Power(Plus(C1,Times(CN1,Power(v,C2))),Plus(m,Times(CN1,Times(n,C1D2))))),x),And(And(RationalQ(n),IntegerQ(m)),Greater(m,C0)))),
SetDelayed(Int(Times(Times($p("u",true),Power(E,Times($p("n",true),ArcTanh(v_)))),Power(Plus(C1,v_),$p("m",true))),$p("x",$s("Symbol"))),
    Condition(Int(Times(u,Times(Power(Plus(C1,v),Plus(m,n)),Power(Power(Plus(C1,Times(CN1,Power(v,C2))),Times(n,C1D2)),CN1))),x),And(RationalQ(List(m,n)),IntegerQ(Plus(m,n))))),
SetDelayed(Int(Times(Times($p("u",true),Power(E,Times($p("n",true),ArcTanh(v_)))),Power(Plus(C1,v_),$p("m",true))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Times($p("u",true),Power(E,Times($p("n",true),ArcTanh(v_)))),Power(Plus(C1,Times(CN1,v_)),$p("m",true))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Times($p("u",true),Power(E,Times($p("n",true),ArcTanh(v_)))),Power(Plus(a_,Times($p("b",true),v_)),$p("m",true))),$p("x",$s("Symbol"))),
    Condition(Dist(Power(a,m),Int(Times(Times(u,Power(E,Times(n,ArcTanh(v)))),Power(Plus(C1,Times(Times(b,Power(a,CN1)),v)),m)),x)),And(And(And(And(FreeQ(List(a,b),x),IntegerQ(m)),RationalQ(n)),NonzeroQ(Plus(a,Times(CN1,C1)))),ZeroQ(Plus(Power(a,C2),Times(CN1,Power(b,C2))))))),
SetDelayed(Int(Times(Times($p("u",true),Power(E,ArcTanh(v_))),Power(Plus(a_,Times($p("b",true),Power(Power(v_,C2),CN1))),$p("m",true))),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(b,m),Int(Times(u,Times(Power(Plus(C1,Times(CN1,Power(v,C2))),Plus(m,Times(CN1,C1D2))),Power(Power(v,Times(C2,m)),CN1))),x)),Times(Power(b,m),Int(Times(u,Times(Power(Plus(C1,Times(CN1,Power(v,C2))),Plus(m,Times(CN1,C1D2))),Power(Power(v,Plus(Times(C2,m),Times(CN1,C1))),CN1))),x))),And(And(FreeQ(List(a,b),x),ZeroQ(Plus(a,b))),IntegerQ(m)))),
SetDelayed(Int(Times(u_,Power(Plus(a_,Times($p("b",true),Power(x_,C2))),n_)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Times(Power(x_,$p("m",true)),u_),Power(Plus(a_,Times($p("b",true),Power(x_,C2))),n_)),$p("x",$s("Symbol"))),
    Condition(Dist(Power(a,n),Subst(Int(Regularize(Times(Times(Power(Tanh(x),m),Power(Cosh(x),Times(integer(-2L),Plus(n,C1)))),SubstFor(ArcTanh(x),u,x)),x),x),x,ArcTanh(x))),And(And(And(And(And(And(FreeQ(List(a,b),x),FunctionOfQ(ArcTanh(x),u,x)),ZeroQ(Plus(a,b))),HalfIntegerQ(n)),Less(n,CN1)),PositiveQ(a)),IntegerQ(m)))),
SetDelayed(Int(ArcTanh(u_),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcTanh(u_)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(v_,ArcTanh(u_)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(ArcTanh(Times($p("b",true),x_)),Power(Plus(c_,Times($p("d",true),Power(x_,$p("n",true)))),CN1)),$p("x",$s("Symbol"))),
    Condition(Plus(Dist(C1D2,Int(Times(Log(Plus(C1,Times(b,x))),Power(Plus(c,Times(d,Power(x,n))),CN1)),x)),Times(CN1,Dist(C1D2,Int(Times(Log(Plus(C1,Times(CN1,Times(b,x)))),Power(Plus(c,Times(d,Power(x,n))),CN1)),x)))),And(And(FreeQ(List(b,c,d),x),IntegerQ(n)),Not(And(Equal(n,C2),ZeroQ(Plus(Times(Power(b,C2),c),d))))))),
SetDelayed(Int(Times(ArcTanh(Plus(a_,Times($p("b",true),x_))),Power(Plus(c_,Times($p("d",true),Power(x_,$p("n",true)))),CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(ArcCoth(Plus($p("a",true),Times($p("b",true),x_))),$p("x",$s("Symbol"))),
...
SetDelayed(Int(ArcCoth(Plus($p("a",true),Times($p("b",true),Power(x_,n_)))),$p("x",$s("Symbol"))),
    Condition(Plus(Times(x,ArcCoth(Plus(a,Times(b,Power(x,n))))),Times(CN1,Dist(Times(b,n),Int(Times(Power(x,n),Power(Plus(Plus(Plus(C1,Times(CN1,Power(a,C2))),Times(CN1,Times(Times(Times(C2,a),b),Power(x,n)))),Times(CN1,Times(Power(b,C2),Power(x,Times(C2,n))))),CN1)),x)))),And(FreeQ(List(a,b),x),IntegerQ(n)))),
SetDelayed(Int(Times(ArcCoth(Plus($p("a",true),Times($p("b",true),Power(x_,$p("n",true))))),Power(x_,CN1)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(Power(x_,$p("m",true)),ArcCoth(Plus($p("a",true),Times($p("b",true),Power(x_,$p("n",true)))))),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(x,Plus(m,C1)),Times(ArcCoth(Plus(a,Times(b,Power(x,n)))),Power(Plus(m,C1),CN1))),Times(CN1,Dist(Times(b,Times(n,Power(Plus(m,C1),CN1))),Int(Times(Power(x,Plus(m,n)),Power(Plus(Plus(Plus(C1,Times(CN1,Power(a,C2))),Times(CN1,Times(Times(Times(C2,a),b),Power(x,n)))),Times(CN1,Times(Power(b,C2),Power(x,Times(C2,n))))),CN1)),x)))),And(And(And(FreeQ(List(a,b,m),x),IntegerQ(n)),NonzeroQ(Plus(m,C1))),NonzeroQ(Plus(Plus(m,Times(CN1,n)),C1))))),
SetDelayed(Int(Times(Power(Plus(C1,Times(CN1,Power(x_,C2))),m_),Power(ArcCoth(x_),$p("n",true))),$p("x",$s("Symbol"))),
    Condition(Module(List(Set(u,Block(List(Set($s("ShowSteps"),False),Set($s("StepCounter"),Null)),Int(Power(Plus(C1,Times(CN1,Power(x,C2))),m),x)))),Plus(Times(u,Power(ArcCoth(x),n)),Times(CN1,Dist(n,Int(Expand(Times(u,Times(Power(ArcCoth(x),Plus(n,Times(CN1,C1))),Power(Plus(C1,Times(CN1,Power(x,C2))),CN1)))),x))))),And(And(IntegerQ(List(m,n)),Less(m,CN1)),Greater(n,C0)))),
SetDelayed(Int(Times(Power(Plus(CN1,Power(x_,C2)),m_),Power(ArcCoth(x_),$p("n",true))),$p("x",$s("Symbol"))),
    Condition(Dist(Power(CN1,m),Int(Times(Power(Plus(C1,Times(CN1,Power(x,C2))),m),Power(ArcCoth(x),n)),x)),And(And(IntegerQ(List(m,n)),Less(m,CN1)),Greater(n,C0)))),
SetDelayed(Int(Times(Power(ArcCoth(x_),$p("n",true)),Times(Power(ArcTanh(x_),p_),Power(Plus(C1,Times(CN1,Power(x_,C2))),CN1))),$p("x",$s("Symbol"))),
    Condition(Plus(Times(Power(ArcCoth(x),n),Times(Power(ArcTanh(x),Plus(p,C1)),Power(Plus(p,C1),CN1))),Times(CN1,Dist(Times(n,Power(Plus(p,C1),CN1)),Int(Times(Power(ArcCoth(x),Plus(n,Times(CN1,C1))),Times(Power(ArcTanh(x),Plus(p,C1)),Power(Plus(C1,Times(CN1,Power(x,C2))),CN1))),x)))),And(IntegerQ(List(n,p)),Less(Less(C0,n),p)))),
SetDelayed(Int(Times(Times(Power(Plus(C1,Times(CN1,Power(x_,C2))),$p("m",true)),Power(ArcCoth(x_),$p("n",true))),Power(ArcTanh(x_),$p("p",true))),$p("x",$s("Symbol"))),
    Condition(Module(List(Set(u,Block(List(Set($s("ShowSteps"),False),Set($s("StepCounter"),Null)),Int(Power(Plus(C1,Times(CN1,Power(x,C2))),m),x)))),Plus(Plus(Times(Times(u,Power(ArcCoth(x),n)),Power(ArcTanh(x),p)),Times(CN1,Dist(p,Int(Times(Times(u,Power(ArcCoth(x),n)),Times(Power(ArcTanh(x),Plus(p,Times(CN1,C1))),Power(Plus(C1,Times(CN1,Power(x,C2))),CN1))),x)))),Times(CN1,Dist(n,Int(Times(Times(u,Power(ArcCoth(x),Plus(n,Times(CN1,C1)))),Times(Power(ArcTanh(x),p),Power(Plus(C1,Times(CN1,Power(x,C2))),CN1))),x))))),And(And(And(IntegerQ(List(m,p,n)),Less(m,CN1)),Greater(p,C1)),Greater(n,C1)))),
SetDelayed(Int(Times(Times(Power(Plus(CN1,Power(x_,C2)),$p("m",true)),Power(ArcCoth(x_),$p("n",true))),Power(ArcTanh(x_),$p("p",true))),$p("x",$s("Symbol"))),
    Condition(Dist(Power(CN1,m),Int(Times(Times(Power(Plus(C1,Times(CN1,Power(x,C2))),m),Power(ArcCoth(x),n)),Power(ArcTanh(x),p)),x)),And(And(IntegerQ(List(m,n,p)),Less(m,CN1)),Greater(n,C0)))),
SetDelayed(Int(Times(x_,Power(ArcCoth(Times($p("a",true),x_)),n_)),$p("x",$s("Symbol"))),
...
SetDelayed(Int(Times(x_,Power(ArcCoth(Plus($p("a",true),Times($p("b",true),x_))),n_)),$p("x",$s("Symbol"))),
