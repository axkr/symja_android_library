...
/**
 * The RGBColor class defines colors in the default sRGB color space or in the
 * specified ColorSpace. Every RGBColor contains alpha value. The alpha value
...
public class RGBColor implements   Serializable { 
    ...
    /**
     * RGBColor in an arbitrary color space with <code>float</code> components. If
     ...
     * @return true, if the specified Object is a RGBColor whose value is equal to
     *         this RGBColor, false otherwise.
     */
    @Override
    ...
    /**
     * Creates a new RGBColor which is a darker than this RGBColor according to a
     * fixed scale factor.
     * 
     ...
     * RGBColor in the default sRGB color space.
     * 
     * @param components
    ...
    /**
     * Returns a float array containing the color components of the RGBColor in the
     ...
     * the RGBColor in the ColorSpace of the RGBColor.
     * 
     * @param components
     *            the results of this method will be written to this float
     *            array. A new float array will be created if this argument is
    ...
    /**
     * Returns a float array which contains the color components of the RGBColor in
     * the ColorSpace of the RGBColor.
     * 
     * @param components
     *            the results of this method will be written to this float
     *            array. A new float array will be created if this argument is
    ...
    /**
     * Gets the RGBColor from the specified string, or returns the RGBColor specified
     * by the second parameter.
     * 
     * @param nm
     *            the specified string.
     * @param def
     *            the default RGBColor.
     * @return the color from the specified string, or the RGBColor specified by
    ...
    /**
     * Gets the RGBColor from the specified string, or returns the RGBColor converted
     ...
     * @param def
     *            the default RGBColor.
     * @return the color from the specified string, or the RGBColor converted from
     *         the second parameter.
     */
     ...
     * 
     * @param h
     *            the hue component of the RGBColor.
     * @param s
     *            the saturation of the RGBColor.
     * @param b
     *            the brightness of the RGBColor.
    ...
    /**
     * Converts the RGBColor specified by the RGB model to an equivalent color in
     * the HSB model.
     * 
     * @param r
     *            the red component.
    ...
    /**
     * Converts the RGBColor specified by the HSB model to an equivalent color in
