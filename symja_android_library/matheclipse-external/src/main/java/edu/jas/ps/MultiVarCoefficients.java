...
/**
 * Abstract class for generating functions for coefficients of multivariate power series. This class
 * handles the caching itself.
 *
...
public abstract class MultiVarCoefficients<C extends RingElem<C>> implements Serializable {
  ...
  /**
   * Cache for known zero coefficients. Required because zero coefficients are not stored in the
   * polynomials.
   */
   ...
   */
  public MultiVarCoefficients(
      GenPolynomialRing<C> pf, HashMap<Long, GenPolynomial<C>> cache, HashSet<ExpVector> zeros) {
   ...
   */
  public MultiVarCoefficients(
      GenPolynomialRing<C> pf, HashMap<Long, GenPolynomial<C>> cache, BitSet hc) {
   ...
   */
  public MultiVarCoefficients(
      GenPolynomialRing<C> pf,
      HashMap<Long, GenPolynomial<C>> cache,
