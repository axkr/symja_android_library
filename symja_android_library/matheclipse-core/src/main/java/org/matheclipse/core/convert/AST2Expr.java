...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "FullForm", "FullDefinition", "FullSimplify", "Function", "FunctionDomain", "FunctionExpand",
      ...
      "GeometricTransformation", "GeoPosition", "Get", "GompertzMakehamDistribution", "Grad",
      "Graph", "GraphCenter", "GraphData", "GraphDiameter", "Graphics", "GraphicsJSON",
      "GraphicsComplex", "GraphicsGroup", "Graphics3D", "Graphics3DJSON", "GraphComplement",
      "GraphDifference", "GraphDisjointUnion", "GraphIntersection", "GraphPeriphery", "GraphQ",
      "GraphRadius", "GraphUnion", "GrayLevel", "Greater", "GreaterEqual", "GreaterEqualThan",
      "GreaterThan", "GridGraph", "GroebnerBasis", "GroupBy", "Gudermannian", "GumbelDistribution",
      "HamiltonianGraphQ", "HammingDistance", "HammingWindow", "HankelH1", "HankelH2",
      "HankelMatrix", "HannWindow", "Haversine", "HarmonicMean", "HarmonicNumber", "Head",
      ...
      "KelvinBei", "KelvinBer", "Key", "KeyExistsQ", "Keys", "KeySelect", "KeySort", "KeyTake",
      ...
      "MemoryAvailable", "MemoryInUse", "Merge", "MeshRange", "MessageName", "Message", "Messages",
