 ...
 *
 * <p>This implementation is long-based and uses the Montgomery reducer R=2^63.
 *
...
public class PollardRhoBrentMontgomery63 extends FactorAlgorithm {
  ...
  private static final long R_MASK =
      R - 1; // 0x7FFFFFFFFFFFFFFFL, helps to compute x mod R = x & (R - 1)
   ...
   *
   * <p>EEA63 would not work with R=2^63 because R overflows positive longs. But the algorithm from
   * http://coliru.stacked-crooked.com/a/f57f11426d06acd8 (which refers to "hackers delight") can
   * deal with R=2^63.
   */
  ...
  /**
   * Montgomery multiplication modulo N, using reducer R=2^63. Inputs and output are in Montgomery
   * form and in the range [0, N).
   *
   * @param a
   * @param b
   * @return
