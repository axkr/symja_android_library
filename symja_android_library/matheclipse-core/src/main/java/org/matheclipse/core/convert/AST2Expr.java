...
public class AST2Expr {
	...
	public final static String[] SYMBOL_STRINGS = { "All", "Algebraics", "Automatic", "Axes", "AxesOrigin", "AxesStyle",
			...
			"Degree", "DegreeLexicographic", "DegreeReverseLexicographic", "Disputed", "EliminationOrder", "EulerGamma",
			"Expression", "Extension", "False", "Flat", "Float", "Full", "GaussianIntegers", "General", "Glaisher",
			"GoldenAngle", "GoldenRatio", "Gray", "Green", "Heads", "HoldAll", "HoldComplete", "HoldAllComplete",
			"HoldFirst", "HoldRest", "Indeterminate", "Infinity", "Integer", "Integers", "Khinchin", "Left",
			"Lexicographic", "LightBlue", "LightBrown", "LightCyan", "LightGray", "LightGreen", "LightMagenta",
			"LightOrange", "LightPink", "LightPurple", "LightRed", "LightYellow", "Listable", "LongForm", "Magenta",
			...
			"NumericFunction", "OneIdentity", "Orange", "Orderless", "Pi", "Pink", "PrecisionGoal", "Primes",
			"Protected", "Purple", "Rationals", "ReadProtected", "Real", "Red", "Reals", "Right", "SameTest", "Second",
			"SequenceHold", "Slot", "SlotSequence", "Strict", "String", "Symbol", "Today", "TooLarge", "Top", "Trig",
			"True", "Unknown", "Variable", "ViewPoint", "White", "Whitespace", "Yellow" };
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AbsoluteCorrelation", "AbsoluteTime",
			...
			"Clip", "CMYColor", "Coefficient", "CoefficientList", "CoefficientRules", "Colon", "ColorData", "Column",
			"Collect", "Commonest", "CompatibleUnitQ", "Complement", "Compile", "CompiledFunction", "Complex",
			"ComplexExpand", "ComplexPlot3D", "ComposeList", "ComposeSeries", "Composition", "CompoundExpression",
			"Condition", "ConditionalExpression", "ConnectedGraphQ", "Conjugate", "ConjugateTranspose", "ConstantArray",
			...
			"Directive", "DirichletWindow", "Discriminant", "DisjointQ", "Distribute", "Distributed", "Div", "Divide",
			"DivideBy", "Divisible", "Divisors", "DivisorSum", "DivisorSigma", "Do", "Dot", "Drop", "Dynamic", "DSolve",
			...
			"Insert", "Information", "Interval", "IntegerDigits", "IntegerExponent", "IntegerLength", "IntegerName",
			...
			"JacobiCD", "JacobiCN", "JacobiDC", "JacobiDN", "JacobiNC", "JacobiND", "JacobiSC", "JacobiSD", "JacobiSN",
			"JacobiZeta", "JavaForm", "JSForm", "JSFormData", "Join", "Key", "KeyExistsQ", "Keys", "KeySort",
			"KleinInvariantJ", "KnownUnitQ", "KolmogorovSmirnovTest", "KOrderlessPartitions", "KPartitions",
			"KroneckerDelta", "Kurtosis", "Last", "LCM", "LeafCount", "LaguerreL", "LaplaceTransform", "LeastSquares",
			"LegendreP", "LegendreQ", "Length", "Less", "LessEqual", "LetterQ", "Level", "LevelQ", "Limit", "Line",
			"LinearModelFit", "LinearProgramming", "LinearRecurrence", "LinearSolve", "LiouvilleLambda", "List",
			"ListContourPlot", "ListConvolve", "ListCorrelate", "ListLinePlot", "ListPlot", "ListPlot3D", "ListQ",
			"Literal", "Log", "Log2", "Log10", "LogGamma", "LogNormalDistribution", "LogicalExpand", "LogisticSigmoid",
			"LogIntegral", "Lookup", "LowerCaseQ", "LowerTriangularize", "LucasL", "LUDecomposition", "MachineNumberQ",
			...
			"Return", "Reverse", "RGBColor", "Riffle", "RogersTanimotoDissimilarity", "RomanNumeral", "RootIntervals",
			...
			"Structure", "StruveH", "StruveL", "StudentTDistribution", "Style", "Subdivide", "Subfactorial", "Summary",
			...
			"SymmetricMatrixQ", "SyntaxQ", "SystemDialogInput", "Table", "TableForm", "TagSet", "TagSetDelayed", "Take",
			"TakeLargest", "TakeLargestBy", "Tally", "Tan", "Tanh", "TautologyQ", "Taylor", "TensorDimensions",
			"TensorProduct", "TensorRank", "TensorSymmetry", "TextCell", "TextString", "TeXForm", "Thread", "Through",
			"Throw", "TimeConstrained", "Times", "TimesBy", "TimeObject", "TimeValue", "Timing", "ToCharacterCode",
