...
/**
 * SolvableQuotient, that is a (left) rational function, based on GenSolvablePolynomial with
 * RingElem interface. Objects of this class are immutable.
 *
 * @author Heinz Kredel
 */
public class SolvableQuotient<C extends GcdRingElem<C>>
  ...
  /**
   * The constructor creates a SolvableQuotient object from a ring factory and a numerator
   * polynomial. The denominator is assumed to be 1.
   *
   * @param r ring factory.
  ...
  /**
   * The constructor creates a SolvableQuotient object from a ring factory and a numerator and
   * denominator solvable polynomial.
   *
   * @param r ring factory.
   * @param n numerator polynomial.
   * @param d denominator polynomial.
   */
  public SolvableQuotient(
      SolvableQuotientRing<C> r, GenSolvablePolynomial<C> n, GenSolvablePolynomial<C> d) {
    this(r, n, d, false);
  }
   ...
   */
  protected SolvableQuotient(
      SolvableQuotientRing<C> r,
  ...
  /**
   * SolvableQuotient right fraction. <b>Note:</b> It is not possible to distinguish right from left
   * fractions in the current implementation. So it is not possible to compute with right fractions.
   *
  ...
  /**
   * Test if SolvableQuotient right fraction. <b>Note:</b> It is not possible to distinguish right
   * from left fractions in the current implementation. So it is not possible to compute with right
   * fractions.
   *
