...
/**
 * Groebner Base parallel algorithm. Makes some effort to produce the same sequence of critical
 * pairs as in the sequential version. However already reduced pairs are not rereduced if new
 * polynomials appear. Implements a shared memory parallel version of Groebner bases. Slaves
 * maintain pairlist.
 *
