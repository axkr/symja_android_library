 ...
 * [Crandall/Pomerance 2005: "Prime numbers", algorithm 2.1.4] to let modInverse(x, y) work on
 * negative x, too.
 *
 * <p>Long version.
 *
...
public class EEA63 {
  ...
  /**
   * Slightly faster modular inverse initializing variables with first iteration and needing one
   * step less at the end.
   *
   * <p>Adapted from R.D.Silverman's single_modinv2(), see
   * http://www.mersenneforum.org/showthread.php?t=12963&page=2, post #16.
   *
   * @param a
   * @param modulus
   ...
   *
   * <p>Taken from Ben Buhrow's tinyecm.c and modified to work for a<0 and a>=p, too. Optimal
   * performance is achieved by 6 "if's" in Java, compared to 9 "if's" in C.
   *
   * <p>Significantly faster than the versions above.
   *
   * @param a
   * @param p modulus
   * @return (1/a) mod p
