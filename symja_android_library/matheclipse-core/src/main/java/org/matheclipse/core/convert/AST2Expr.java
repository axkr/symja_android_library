...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"AbsolutePointSize", "AbsoluteThickness",
      ...
      "CoefficientDomain", "Complexes", "ComplexityFunction", "Constant", "Contours",
      ...
      "Filling", "FillingStyle", "Frame", "FrameMargins", "FrameStyle", "FrameTicks", "Flat",
      "Float", "FourierParameters", "Full", "GaussianIntegers", "General", "GenerateConditions",
      "Glaisher", "GoldenAngle", "GoldenRatio", "GraphLayout", "Gray", "Green", "GridLines",
      "GridLinesStyle", "Heads", "HexidecimalCharacter", "HoldAll", "HoldComplete",
      "HoldAllComplete", "HoldFirst", "HoldRest", "IgnoreCase", "Indeterminate", "Inherited",
      "Infinity", "InsertionFunction", "Inset", "Integer", "Integers", "InterpolationOrder",
      "Joined", "KeyAbsent", "Khinchin", "LabelingFunction", "LabelingSize", "Large", "Left",
      "Legended", "LetterCharacter", "Lexicographic", "Lighting", "LightBlue", "LightBrown",
      "LightCyan", "LightGray", "LightGreen", "LightMagenta", "LightOrange", "LightPink",
      "LightPurple", "LightRed", "LightYellow", "Listable", "Locked", "LongForm", "Magenta",
      "Matrices", "MaxIterations", "MaxPlotPoints", "MaxPoints", "MaxRecursion", "MaxRoots", "Mesh",
      "Medium", "Method", "Modulus", "MonomialOrder", "NegativeDegreeLexicographic",
      ...
      "OneIdentity", "Orange", "Orderless", "Overlaps", "Pi", "Pink", "PlotLabel", "PlotLabels",
      "PlotLegends", "PlotPoints", "PlotRange", "PlotRangePadding", "PlotStyle", "PositiveIntegers",
      "PositiveRationals", "PositiveReals", "PrecisionGoal", "Primes", "Prolog", "Protected",
      "Purple", "RationalFunctions", "Rationals", "ReadProtected", "Real", "Record",
      "RecordSeparators", "Red", "Reals", "Right", "RoundingRadius", "SameTest", "ScalingFunctions",
      "Second", "SequenceHold", "SetSystemOptions", "Small", "SystemOptions", "SlotAbsent",
      ...
      "Thin", "Ticks", "Tiny", "TicksStyle", "Today", "TooLarge", "Top", "Transparent", "Trig",
      "True", "Unknown", "UseTypeChecking", "Variable", "Vectors", "VertexLabels",
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "Alphabet", "Alternatives", "AmbientLight", "And", "AngerJ", "AnglePath", "AngleVector",
      "Annotation", "Annuity", "AnnuityDue", "AntihermitianMatrixQ", "AntisymmetricMatrixQ",
      "AnyTrue", "Apart", "AppellF1", "Append", "AppendTo", "Apply", "ApplySides", "ArcCos",
      "ArcCosh", "ArcCot", "ArcCoth", "ArcCsc", "ArcCsch", "ArcLength", "ArcSec", "ArcSech",
      "ArcSin", "ArcSinh", "ArcTan", "ArcTanh", "Area", "Arg", "ArgMax", "ArgMin",
      "ArithmeticGeometricMean", "Array", "ArrayDepth", "ArrayFlatten", "ArrayPad", "ArrayPlot",
      "ArrayQ", "ArrayReduce", "ArrayReshape", "ArrayRules", "ArraySymbol", "Arrays", "Arrow",
      "Arrowheads", "ASATriangle", "AssociateTo", "Association", "AssociationMap", "AssociationQ",
      "AssociationThread", "Assuming", "Assumptions", "AtomQ", "Attributes", "Ball", "BarChart",
      ...
      "CenterDot", "CentralMoment", "CForm", "CharacteristicPolynomial", "CharacterRange",
      ...
      "DifferenceDelta", "DifferenceQuotient", "Differences", "DigitCount", "DigitQ", "Dimensions",
      ...
      "DSolve", "Dt", "DuplicateFreeQ", "Dynamic", "EasterSunday", "Echo", "EchoFunction",
      "EdgeCount", "EdgeForm", "EdgeList", "EdgeQ", "EdgeRules", "EdgeWeight", "EditDistance",
      ...
      "Entity", "Entropy", "Equal", "EqualTo", "Equivalent", "Erf", "Erfc", "Erfi",
      ...
      "Exponent", "ExponentialDistribution", "Export", "ExportString", "ExpToTrig", "ExtendedGCD",
      "Extract", "FaceForm", "Factor", "Factorial", "Factorial2", "FactorialMoment",
      ...
      "GeometricMean", "GeometricTransformation", "GeoPosition", "Get", "Glow", "GoldbachList",
      ...
      "GraphicsGrid", "Graphics3D", "Graphics3DJSON", "GraphicsComplex", "GraphicsGroup",
      ...
      "In", "Inactivate", "Inactive", "Increment", "Indexed", "IndexGraph", "Inequality",
      ...
      "MatrixSymbol", "Max", "MaxFilter", "Maximize", "MaxMemoryUsed", "Mean", "MeanDeviation",
      "MeanFilter", "Median", "MedianFilter", "MeijerG", "MemberQ", "MemoryAvailable",
      "MemoryInUse", "Merge", "MersennePrimeExponent", "MersennePrimeExponentQ", "MeshRange",
      "Message", "MessageName", "Messages", "Min", "MinFilter", "MinimalPolynomial", "Minimize",
      "MinMax", "Minor", "Minors", "Minus", "Missing", "MissingQ", "Mod", "ModularInverse",
      "Module", "MoebiusMu", "Moment", "MonomialList", "Most", "Mouseover", "MrvLimit",
      "Multinomial", "MultinormalDistribution", "MultiplicativeOrder", "MultiplySides",
      "MultivariatePoissonDistribution", "NakagamiDistribution", "NameQ", "Names", "Nand",
      "NArgMax", "NArgMin", "ND", "NDSolve", "Nearest", "NearestTo", "Needs", "Negative",
      "NegativeDefiniteMatrixQ", "NegativeSemidefiniteMatrixQ", "Nest", "NestList", "NestWhile",
      "NestWhileList", "NewLimit", "NExpectation", "NextPrime", "NFourierTransform", "NIntegrate",
      "NMaximize", "NMaxValue", "NMinimize", "NMinValue", "NonCommutativeMultiply", "NoneTrue",
      "NonNegative", "NonPositive", "Nor", "Norm", "Normal", "NormalDistribution", "Normalize",
      "NormalMatrixQ", "Not", "Notebook", "NotElement", "NotListQ", "NProbability", "NProduct",
      "NRoots", "NSolve", "NSum", "NullSpace", "NumberDigit", "NumberFieldRootsOfUnity",
      ...
      "SparseArrayQ", "SpecialsFreeQ", "Specularity", "SpectrogramArray", "Sphere",
      ...
      "Symmetric", "SymmetricMatrixQ", "SymmetricPolynomial", "SymmetricReduction", "SyntaxLength",
      ...
      "WhittakerM", "WhittakerW", "With", "WordBoundary", "Write", "WriteString", "Xnor", "Xor",
      "YuleDissimilarity", "ZernikeR", "Zeta", "ZTransform"};
