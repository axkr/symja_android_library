...
public interface CharacteristicSet<C extends GcdRingElem<C>> extends Serializable {
   ...
   * reduction of the leading coefficient depending on the implementing algorithm.
   *
   ...
   *     characteristicSetReductionCoeff(A,characteristicSetRemainder(A,P)) depending on the
   *     algorithm.
   */
