  ...
  final public static IAST RULES = List(IInit(Limit, SIZES),
      ...
      ISetDelayed(
          ...
          With(
              ...
              Condition(r, And(UnsameQ(r, Undefined), FreeQ(list(a, b, n), x))))),
      ...
      ISetDelayed(Limit(Power(x_, Times(a_DEFAULT, Power(x_, n_DEFAULT))), Rule(x_Symbol, oo)),
          With(list(Set(r, ConditionalExpression(C1, And(Element(a, Reals), Less(n, C0))))),
              Condition(r, And(UnsameQ(r, Undefined), FreeQ(list(a, n), x))))),
      ...
      ISet(Limit(Exp(x_), Rule(x_Symbol, oo)), oo),
      // Limit(E^x_,x_Symbol->-Infinity)=0
      ISet(Limit(Exp(x_), Rule(x_Symbol, Noo)), C0),
      ...
      ISetDelayed(Limit(Power(Plus(C1, Times(a_DEFAULT, Power(x_, CN1))), Times(b_DEFAULT, x_)),
      ...
      ISetDelayed(Limit(HarmonicNumber(y_Symbol, $p(s, Integer)), Rule(x_Symbol, oo)),
          Condition(
              With(list(Set(v, Times(C1D2, s))),
                  Times(Power(-1, Plus(v, C1)), Power(C2Pi, Times(C2, v)), BernoulliB(Times(C2, v)),
      ...
      ISetDelayed(Limit(Tan(x_), Rule(x_Symbol, oo)), Indeterminate),
      // Limit(Tan(x_),x_Symbol->-Infinity):=Indeterminate
      ISetDelayed(Limit(Tan(x_), Rule(x_Symbol, Noo)), Indeterminate),
      ...
      ISetDelayed(Limit(Cot(x_), Rule(x_Symbol, oo)), Indeterminate),
      // Limit(Cot(x_),x_Symbol->-Infinity):=Indeterminate
      ISetDelayed(Limit(Cot(x_), Rule(x_Symbol, Noo)), Indeterminate),
      ...
      ISet(Limit(AiryAi(x_), Rule(x_Symbol, oo)), C0),
      // Limit(AiryAi(x_),x_Symbol->-Infinity)=0
      ISet(Limit(AiryAi(x_), Rule(x_Symbol, Noo)), C0),
      // Limit(AiryAiPrime(x_),x_Symbol->Infinity)=0
      ISet(Limit(AiryAiPrime(x_), Rule(x_Symbol, oo)), C0),
      // Limit(AiryBi(x_),x_Symbol->Infinity)=Infinity
      ISet(Limit(AiryBi(x_), Rule(x_Symbol, oo)), oo),
      // Limit(AiryBi(x_),x_Symbol->-Infinity)=0
      ISet(Limit(AiryBi(x_), Rule(x_Symbol, Noo)), C0),
      // Limit(AiryBiPrime(x_),x_Symbol->Infinity)=Infinity
      ISet(Limit(AiryBiPrime(x_), Rule(x_Symbol, oo)), oo),
      // Limit(AiryBiPrime(x_),x_Symbol->-Infinity)=0
      ISet(Limit(AiryBiPrime(x_), Rule(x_Symbol, Noo)), C0),
      // Limit(BesselJ(n_,x_),x_Symbol->Infinity)=0/;FreeQ(n,x)
      ISet(Limit(BesselJ(n_, x_), Rule(x_Symbol, oo)), Condition(C0, FreeQ(n, x))),
      // Limit(BesselJ(n_,x_),x_Symbol->-Infinity)=0/;FreeQ(n,x)
      ISet(Limit(BesselJ(n_, x_), Rule(x_Symbol, Noo)), Condition(C0, FreeQ(n, x))),
      // Limit(BesselI(n_,x_),x_Symbol->Infinity)=Infinity/;FreeQ(n,x)
      ISet(Limit(BesselI(n_, x_), Rule(x_Symbol, oo)), Condition(oo, FreeQ(n, x))),
      // Limit(BesselY(n_,x_),x_Symbol->Infinity)=0/;FreeQ(n,x)
      ISet(Limit(BesselY(n_, x_), Rule(x_Symbol, oo)), Condition(C0, FreeQ(n, x))),
      // Limit(BesselY(n_,x_),x_Symbol->-Infinity)=0/;FreeQ(n,x)
      ISet(Limit(BesselY(n_, x_), Rule(x_Symbol, Noo)), Condition(C0, FreeQ(n, x))),
      // Limit(BesselK(n_,x_),x_Symbol->Infinity)=0/;FreeQ(n,x)
      ISet(Limit(BesselK(n_, x_), Rule(x_Symbol, oo)), Condition(C0, FreeQ(n, x))),
      // Limit(SphericalBesselJ(n_,x_),x_Symbol->Infinity)=0/;FreeQ(n,x)
      ISet(Limit(SphericalBesselJ(n_, x_), Rule(x_Symbol, oo)), Condition(C0, FreeQ(n, x))),
      // Limit(SphericalBesselJ(n_,x_),x_Symbol->-Infinity)=0/;FreeQ(n,x)
      ISet(Limit(SphericalBesselJ(n_, x_), Rule(x_Symbol, Noo)), Condition(C0, FreeQ(n, x))),
      // Limit(SphericalBesselY(n_,x_),x_Symbol->Infinity)=0/;FreeQ(n,x)
      ISet(Limit(SphericalBesselY(n_, x_), Rule(x_Symbol, oo)), Condition(C0, FreeQ(n, x))),
      // Limit(SphericalBesselY(n_,x_),x_Symbol->-Infinity)=0/;FreeQ(n,x)
      ISet(Limit(SphericalBesselY(n_, x_), Rule(x_Symbol, Noo)), Condition(C0, FreeQ(n, x))),
      // Limit(SphericalHankelH1(n_,x_),x_Symbol->Infinity)=0/;FreeQ(n,x)
      ISet(Limit(SphericalHankelH1(n_, x_), Rule(x_Symbol, oo)), Condition(C0, FreeQ(n, x))),
      // Limit(SphericalHankelH2(n_,x_),x_Symbol->Infinity)=0/;FreeQ(n,x)
      ISet(Limit(SphericalHankelH2(n_, x_), Rule(x_Symbol, oo)), Condition(C0, FreeQ(n, x))),
      ...
      ISetDelayed(Limit(StruveH(n_, x_), Rule(x_Symbol, Noo)),
          Condition(ConditionalExpression(C0, And(Element(n, Integers), Less(n, C1D2))),
              FreeQ(n, x))),
      ...
      ISet(Limit(Gamma(x_), Rule(x_Symbol, oo)), oo),
