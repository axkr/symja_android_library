...
/**
 * (Non-unique) factorization domain greatest common divisor common algorithms with primitive
...
public class GreatestCommonDivisorPrimitive<C extends GcdRingElem<C>>
  ...
  /**
   * Univariate GenSolvablePolynomial right greatest common divisor. Uses pseudoRemainder for
   * remainder.
   *
   * @param P univariate GenSolvablePolynomial.
   * @param S univariate GenSolvablePolynomial.
