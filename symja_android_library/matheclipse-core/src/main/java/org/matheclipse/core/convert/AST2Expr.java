...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "AiryBiPrime", "AllTrue", "Alphabet", "AmbientLight", "And", "AngerJ", "AngleVector",
      "AnyTrue", "AntihermitianMatrixQ", "AntiSymmetric", "AntisymmetricMatrixQ", "Annotation",
      "Annuity", "AnnuityDue", "AlgebraicNumber", "Alternatives", "Apart", "AppellF1", "Append",
      "AppendTo", "Apply", "ApplySides", "Area", "ArcCos", "ArcCosh", "ArcCot", "ArcCoth", "ArcCsc",
      "ArcCsch", "ArcLength", "ArcSec", "ArcSech", "ArithmeticGeometricMean", "ArcSin", "ArcSinh",
      "ArcTan", "ArcTanh", "Arg", "ArgMax", "ArgMin", "Array", "ArrayDepth", "ArrayFlatten",
      "ArrayPad", "ArrayPlot", "ArrayReshape", "Arrays", "ArrayQ", "ArrayRules", "Arrow",
      "Arrowheads", "ASATriangle", "AssociateTo", "Association", "AssociationQ", "AssociationMap",
      ...
      "ExpandDenominator", "ExpandNumerator", "Expectation", "ExponentialDistribution",
      ...
      "Flatten", "FlattenAt", "FlatTopWindow", "Fibonacci", "File", "FileFormat", "FileHash",
      ...
      "Fold", "FoldList", "For", "ForAll", "FormBox", "Fourier", "FourierCosTransform",
      "FourierDCT", "FourierDCTMatrix", "FourierDST", "FourierDSTMatrix", "FourierMatrix",
      "FourierSinTransform", "FRatioDistribution", "FractionBox", "FractionalPart",
      ...
      "FromPolarCoordinates", "FromRomanNumeral", "FromSphericalCoordinates", "FullForm",
      "FullDefinition", "FullSimplify", "Function", "FunctionDomain", "FunctionExpand",
      "FunctionPeriod", "FunctionRange", "FunctionURL", "Gamma", "GammaDistribution",
      "GammaRegularized", "Gather", "GatherBy", "GaussianMatrix", "GaussianWindow", "GCD",
      "GegenbauerC", "GeodesyData", "GeoDistance", "GeometricDistribution", "GeometricMean",
      "GeometricTransformation", "GeoPosition", "Get", "GoldbachList",
      ...
      "HammingWindow", "HankelH1", "HankelH2", "HankelMatrix", "HannWindow", "Haversine",
      "HarmonicMean", "HarmonicNumber", "Head", "HeavisideTheta", "HermiteH", "HermitianMatrixQ",
      ...
      "Names", "Nand", "NArgMax", "NArgMin", "ND", "NDSolve", "Nearest", "NearestTo", "Needs",
      "Negative", "Nest", "NestList", "NestWhile", "NestWhileList", "NewLimit", "NextPrime",
      ...
      "Normalize", "Norm", "NormalDistribution", "NormalMatrixQ", "Not", "NotElement", "NotListQ",
      "NRoots", "NSolve", "NullSpace", "NumberFieldRootsOfUnity", "NumberLinePlot", "NumberQ",
      ...
      "Ramp", "RamseyNumber", "RandomChoice", "RandomComplex", "RandomInteger", "RandomGraph",
      "RandomPermutation", "RandomPrime", "RandomReal", "RandomSample", "RandomVariate", "Range",
      "RankedMax", "RankedMin", "Rational", "Rationalize", "RawBoxes", "Re", "Read", "ReadList",
      "ReadString", "RealAbs", "RealDigits", "RealSign", "RealValuedNumericQ", "RealValuedNumberQ",
      ...
      "ScalingTransform", "Scan", "ScientificForm", "SchurDecomposition", "Sec", "Sech",
      ...
      "SixJSymbol", "Skewness", "SudokuSolve", "SokalSneathDissimilarity", "Solve", "Sort",
      "SortBy", "Sow", "Span", "SparseArray", "SparseArrayQ", "Specularity", "Sphere",
