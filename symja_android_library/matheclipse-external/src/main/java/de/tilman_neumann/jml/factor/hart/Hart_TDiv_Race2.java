 ...
 *
 * <p>This variant is slightly faster than Hart_TDiv_Race for N >= 45 bits, but will fail for some N
 * having small factors. Hart_Fast is faster for hard semiprimes.
 *
...
public class Hart_TDiv_Race2 extends FactorAlgorithm {
  ...
  public long findSingleFactor(long N) {
    ...
    try {
      ...
      // LOG.error("Hart_TDiv_Race_Unsafe: Failed to factor N=" + N + " because the arrays are too
      // small.");
      return 1;
    }
  }
