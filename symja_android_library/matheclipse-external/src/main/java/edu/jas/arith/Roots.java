...
public class Roots {
  ...
  /**
   * Square root. R is the square root approximation of A. Convert to BigDecimal and compute square
   * root.
   *
  ...
  /**
   * Square root. R is the square root approximation of A. Convert to BigDecimalComplex and compute
   * square root.
   *
