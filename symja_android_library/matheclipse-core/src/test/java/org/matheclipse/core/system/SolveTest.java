...
public class SolveTest extends ExprEvaluatorTestCase {
  ...
  public void testSystem805() {
    ...
    checkNumeric("Solve(x*(x^2+1)^2==7,x)",
        "{{x->-0.9784917834108957+I*(-1.0389327358561462)},{x->-0.9784917834108956+I*1.0389327358561462},{x->0.38213058392542093+I*1.6538990550344326},{x->0.38213058392542093+I*(-1.6538990550344328)},{x->1.1927223989709494}}");
