...
public class IndependentTestSuites extends AbstractRubiTestCase {
	...
	public void test0036() {
		check("Integrate[(b1*Cos[x] + a1*Sin[x])/(b*Cos[x] + a*Sin[x]), x]", "((a*a1 + b*b1)*x)/(a^2 + b^2) - ((a1*b - a*b1)*Log[b*Cos[x] + a*Sin[x]])/(a^2 + b^2)", //
				3133);
	}
	...
	public void test0039() {
		check("Integrate[1/Sqrt[1 + t^3], t]", "(2*Sqrt[2 + Sqrt[3]]*(1 + t)*Sqrt[(1 - t + t^2)/(1 + Sqrt[3] + t)^2]*EllipticF[ArcSin[(1 - Sqrt[3] + t)/(1 + Sqrt[3] + t)], -7 - 4*Sqrt[3]])/(3^(1/4)*Sqrt[(1 + t)/(1 + Sqrt[3] + t)^2]*Sqrt[1 + t^3])", //
				218);
	}
	...
	public void test0043() {
		check("Integrate[(6 - 3*x^2 + x^4)/(4 + 5*x^2 - 5*x^4 + x^6), x]", "-ArcTan[Sqrt[3] - 2*x] + ArcTan[Sqrt[3] + 2*x] + ArcTan[(x*(1 - 3*x^2 + x^4))/2]", //
				2095);
	}
	...
	public void test0062() {
		check("Integrate[Sin[x]^p, x]", "(Cos[x]*Hypergeometric2F1[1/2, (1 + p)/2, (3 + p)/2, Sin[x]^2]*Sin[x]^(1 + p))/((1 + p)*Sqrt[Cos[x]^2])", //
				2643);
	}
	...
	public void test0118() {
		check("Integrate[(x*(-Sqrt[-4 + x^2] + x^2*Sqrt[-4 + x^2] - 4*Sqrt[-1 + x^2] + x^2*Sqrt[-1 + x^2]))/((4 - 5*x^2 + x^4)*(1 + Sqrt[-4 + x^2] + Sqrt[-1 + x^2])), x]", "Log[1 + Sqrt[-4 + x^2] + Sqrt[-1 + x^2]]", //
				6684);
	}
	...
	public void test0231() {
		check("Integrate[1/(x^m*(a^3 + x^3)), x]", "(x^(1 - m)*Hypergeometric2F1[1, (1 - m)/3, (4 - m)/3, -(x^3/a^3)])/(a^3*(1 - m))", //
				364);
	}

	// {364}
	public void test0232() {
		check("Integrate[1/(x^m*(a^4 - x^4)), x]", "(x^(1 - m)*Hypergeometric2F1[1, (1 - m)/4, (5 - m)/4, x^4/a^4])/(a^4*(1 - m))", //
				364);
	}
	...
	public void test0234() {
		check("Integrate[1/(x^m*(a^5 + x^5)), x]", "(x^(1 - m)*Hypergeometric2F1[1, (1 - m)/5, (6 - m)/5, -(x^5/a^5)])/(a^5*(1 - m))", //
				364);
	}
	...
	public void test0243() {
		check("Integrate[(1 - x^2)/((1 + 2*a*x + x^2)*Sqrt[1 + 2*a*x + 2*b*x^2 + 2*a*x^3 + x^4]), x]", "ArcTan[(a + 2*(1 + a^2 - b)*x + a*x^2)/(Sqrt[2]*Sqrt[1 - b]*Sqrt[1 + 2*a*x + 2*b*x^2 + 2*a*x^3 + x^4])]/(Sqrt[2]*Sqrt[1 - b])", //
				2084);
	}

	// {2577}
	public void test0244() {
		check("Integrate[Cos[x]^(2*m)*Sin[x]^(2*m), x]", "(Cos[x]^(-1 + 2*m)*(Cos[x]^2)^(1/2 - m)*Hypergeometric2F1[(1 - 2*m)/2, (1 + 2*m)/2, (3 + 2*m)/2, Sin[x]^2]*Sin[x]^(1 + 2*m))/(1 + 2*m)", //
				2577);
	}
	...
	public void test0255() {
		check("Integrate[E^(m*x)*Csc[x]^2, x]", "(-4*E^((2*I + m)*x)*Hypergeometric2F1[2, 1 - (I/2)*m, 2 - (I/2)*m, E^((2*I)*x)])/(2*I + m)", //
				4453);
	}
	...
	public void test0269() {
		check("Integrate[(1 - x^3)^(-1/3), x]", "-(ArcTan[(1 - (2*x)/(1 - x^3)^(1/3))/Sqrt[3]]/Sqrt[3]) + Log[x + (1 - x^3)^(1/3)]/2", //
				239);
	}

	// {1587}
	public void test0270() {
		check("Integrate[(3 - 3*x + 30*x^2 + 160*x^3)/(9 + 24*x - 12*x^2 + 80*x^3 + 320*x^4), x]", "Log[9 + 24*x - 12*x^2 + 80*x^3 + 320*x^4]/8", //
				1587);
	}

	// {2090}
	public void test0271() {
		check("Integrate[(3 + 12*x + 20*x^2)/(9 + 24*x - 12*x^2 + 80*x^3 + 320*x^4), x]", "-ArcTan[(7 - 40*x)/(5*Sqrt[11])]/(2*Sqrt[11]) + ArcTan[(57 + 30*x - 40*x^2 + 800*x^3)/(6*Sqrt[11])]/(2*Sqrt[11])", //
				2090);
	}

	// {405}
	public void test0272() {
		check("Integrate[Sqrt[1 - x^4]/(1 + x^4), x]", "ArcTan[(x*(1 + x^2))/Sqrt[1 - x^4]]/2 + ArcTanh[(x*(1 - x^2))/Sqrt[1 - x^4]]/2", //
				405);
	}

	// {2072}
	public void test0273() {
		check("Integrate[Sqrt[1 + p*x^2 - x^4]/(1 + x^4), x]", "-(Sqrt[p + Sqrt[4 + p^2]]*ArcTan[(Sqrt[p + Sqrt[4 + p^2]]*x*(p - Sqrt[4 + p^2] - 2*x^2))/(2*Sqrt[2]*Sqrt[1 + p*x^2 - x^4])])/(2*Sqrt[2]) + (Sqrt[-p + Sqrt[4 + p^2]]*ArcTanh[(Sqrt[-p + Sqrt[4 + p^2]]*x*(p + Sqrt[4 + p^2] - 2*x^2))/(2*Sqrt[2]*Sqrt[1 + p*x^2 - x^4])])/(2*Sqrt[2])", //
				2072);
	}
	...
	public void test0275() {
		check("Integrate[x/((4 - d*x^3)*Sqrt[-1 + d*x^3]), x]", "-ArcTan[(1 + 2^(1/3)*d^(1/3)*x)/Sqrt[-1 + d*x^3]]/(3*2^(2/3)*d^(2/3)) - ArcTan[Sqrt[-1 + d*x^3]]/(9*2^(2/3)*d^(2/3)) - ArcTanh[(Sqrt[3]*(1 - 2^(1/3)*d^(1/3)*x))/Sqrt[-1 + d*x^3]]/(3*2^(2/3)*Sqrt[3]*d^(2/3)) - ArcTanh[Sqrt[-1 + d*x^3]/Sqrt[3]]/(3*2^(2/3)*Sqrt[3]*d^(2/3))", //
				485);
	}

	// {395}
	public void test0276() {
		check("Integrate[1/((1 - 3*x^2)^(1/3)*(3 - x^2)), x]", "ArcTan[(1 - (1 - 3*x^2)^(1/3))/x]/4 + ArcTanh[x/Sqrt[3]]/(4*Sqrt[3]) - ArcTanh[(1 - (1 - 3*x^2)^(1/3))^2/(3*Sqrt[3]*x)]/(4*Sqrt[3])", //
				395);
	}

	// {394}
	public void test0277() {
		check("Integrate[1/((3 + x^2)*(1 + 3*x^2)^(1/3)), x]", "ArcTan[x/Sqrt[3]]/(4*Sqrt[3]) + ArcTan[(1 - (1 + 3*x^2)^(1/3))^2/(3*Sqrt[3]*x)]/(4*Sqrt[3]) - ArcTanh[(1 - (1 + 3*x^2)^(1/3))/x]/4", //
				394);
	}
	...
	public void test0284() {
		check("Integrate[(-1 + x)/((1 + x)*(2 + x^3)^(1/3)), x]", "Sqrt[3]*ArcTan[(1 + (2*(2 + x))/(2 + x^3)^(1/3))/Sqrt[3]] + Log[1 + x] - (3*Log[2 + x - (2 + x^3)^(1/3)])/2", //
				2151);
	}
}
