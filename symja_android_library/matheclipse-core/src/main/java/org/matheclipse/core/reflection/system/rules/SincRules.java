...
public interface SincRules {
  final public static IAST RULES = List(
    ...
    ISet(Sinc(Times(C1D4,Pi)),
      Times(C2,Sqrt(C2),Power(Pi,CN1))),
    ISet(Sinc(Times(C1D3,Pi)),
      Times(QQ(3L,2L),Sqrt(C3),Power(Pi,CN1))),
    ISet(Sinc(Times(C1D2,Pi)),
      Times(C2,Power(Pi,CN1))),
    ISet(Sinc(Pi),
      C0),
    ISet(Sinc(Times(QQ(5L,12L),Pi)),
      Times(QQ(3L,5L),Plus(C1,Sqrt(C3)),Sqrt(C2),Power(Pi,CN1))),
    ISet(Sinc(Times(QQ(1L,5L),Pi)),
      Times(C5,Power(Pi,CN1),Sqrt(Plus(QQ(5L,8L),Times(QQ(-1L,8L),Sqrt(C5)))))),
    ISet(Sinc(Times(QQ(1L,12L),Pi)),
      Times(C3,Plus(CN1,Sqrt(C3)),Sqrt(C2),Power(Pi,CN1))),
    ISet(Sinc(Times(QQ(1L,10L),Pi)),
      Times(QQ(5L,2L),Plus(CN1,Sqrt(C5)),Power(Pi,CN1))),
    ISet(Sinc(Times(QQ(2L,5L),Pi)),
      Times(QQ(5L,2L),Power(Pi,CN1),Sqrt(Plus(QQ(5L,8L),Times(QQ(1L,8L),Sqrt(C5)))))),
    ISet(Sinc(Times(QQ(3L,10L),Pi)),
      Times(QQ(5L,6L),Plus(C1,Sqrt(C5)),Power(Pi,CN1))),
    ISet(Sinc(CI),
      Sinh(C1)),
    ...
    ISetDelayed(Sinc(ArcTan(x_)),
      Times(x,Power(Sqrt(Plus(C1,Sqr(x))),CN1),Power(ArcTan(x),CN1))),
