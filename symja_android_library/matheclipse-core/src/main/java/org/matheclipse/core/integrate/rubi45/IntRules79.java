...
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,Sqr($($s("§sec"),Plus(c_DEFAULT,Times(d_DEFAULT,x_)))))),CN1),x_Symbol),
...
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,Sqr($($s("§csc"),Plus(c_DEFAULT,Times(d_DEFAULT,x_)))))),CN1),x_Symbol),
