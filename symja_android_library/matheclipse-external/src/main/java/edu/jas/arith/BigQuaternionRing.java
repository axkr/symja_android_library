...
public final class BigQuaternionRing implements RingFactory<BigQuaternion> {
  ...
  public final BigQuaternion J =
      new BigQuaternion(this, BigRational.ZERO, BigRational.ZERO, BigRational.ONE);

  /** The constant k. */
  public final BigQuaternion K =
      new BigQuaternion(
          this, BigRational.ZERO, BigRational.ZERO, BigRational.ZERO, BigRational.ONE);
  ...
  /**
   * BigQuaternion units of the Hurwitzian integers. BigQuaternion units with all integer or all 1/2
   * times integer components.
   *
  ...
  /**
   * BigQuaternion random. Random rational numbers A, B, C and D are generated using random(n). Then
   * R is the quaternion number with real part A and imaginary parts B, C and D.
   *
  ...
  /**
   * BigQuaternion random. Random rational numbers A, B, C and D are generated using RNRAND(n). Then
   * R is the quaternion number with real part A and imaginary parts B, C and D.
   *
   * @param n such that 0 &le; A, B, C, D &le; (2<sup>n</sup>-1).
