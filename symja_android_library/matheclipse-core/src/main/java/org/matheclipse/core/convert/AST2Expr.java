...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abs", "AddTo", "And", "Alternatives", "Apart", "AppellF1",
			...
			"BooleanVariables", "Break", "Cancel", "CartesianProduct", "Cases", "CatalanNumber", "Catch", "Ceiling",
			"CharacteristicPolynomial", "CarmichaelLambda", "ChebyshevT", "ChebyshevU", "ChessboardDistance",
			"ChineseRemainder", "Chop", "Clear", "ClearAll", "Coefficient", "CoefficientList", "CoefficientRules",
			"Colon", "Collect", "Complement", "Compile", "Complex", "ComplexExpand", "ComplexInfinity", "ComposeList",
			"CompoundExpression", "Condition", "Conjugate", "ConjugateTranspose", "ConstantArray", "Continue",
			"ContinuedFraction", "CoprimeQ", "Cos", "Cosh", "CosIntegral", "CoshIntegral", "Cot", "Coth", "Count",
			"Cross", "Csc", "Csch", "Curl", "Decrement", "Default", "Defer", "Definition", "Delete", "DeleteCases",
			"DeleteDuplicates", "Denominator", "Depth", "Derivative", "Det", "DiagonalMatrix", "DigitQ", "Dimensions",
			...
			"SetAttributes", "SetDelayed", "Show", "Sign", "SignCmp", "Simplify", "Sin", "Sinc",
