...
public class Quotient<C extends RingElem<C>> implements RingElem<Quotient<C>>, QuotPair<C> {
  ...
  /**
   * The constructor creates a Quotient object from a ring factory and a numerator element. The
  ...
  /**
   * Greatest common divisor. <b>Note:</b> If not defined, throws UnsupportedOperationException.
   *
  ...
  public Quotient<C> gcd(Quotient<C> b) {
    ...
    if (num instanceof GcdRingElem
        && den instanceof GcdRingElem
        && b.num instanceof GcdRingElem
