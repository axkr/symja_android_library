...
public class JASJUnit {
  ...
  public void testSimplexFactor001() {
    ...
    GenPolynomialRing<Complex<BigRational>> cpfac = new GenPolynomialRing<Complex<BigRational>>(
  ...
  public void testGCD() {
    ...
    GenPolynomialRing<Complex<BigRational>> cpfac =
        new GenPolynomialRing<Complex<BigRational>>(cfac, new String[] {"a", "b", "c", "d", "e",
            "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p"}, TermOrderByName.INVLEX);
    GenPolynomial<Complex<BigRational>> p1 =
        cpfac.parse("-1/16777216*a^48*b+c^24*d-3/1048576*a^46*e*e^2+12*c^\r\n"
