...
/**
 * GenSolvablePolynomialRing generic solvable polynomial factory implementing RingFactory and
 * extending GenPolynomialRing factory. Factory for n-variate ordered solvable polynomials over C.
 * The non-commutative multiplication relations are maintained in a relation table. Almost immutable
...
public class GenSolvablePolynomialRing<C extends RingElem<C>> extends GenPolynomialRing<C> {
   ...
   * @param rt solvable multiplication relations.
   */
  public GenSolvablePolynomialRing(
  ...
  /**
   * Extend variables. Used e.g. in module embedding. Extend number of variables by i. New variables
   * commute with the exiting variables.
   *
  ...
  public GenSolvablePolynomialRing<C> extend(int i, boolean top) {
    ...
    GenSolvablePolynomialRing<C> spfac =
        new GenSolvablePolynomialRing<C>(pfac.coFac, pfac.nvar, pfac.tord, pfac.vars);
  ...
  public GenSolvablePolynomialRing<C> distribute() {
    ...
    // main relations
    List<GenPolynomial<GenPolynomial<C>>> rl =
        (List<GenPolynomial<GenPolynomial<C>>>)
            (List) PolynomialList.castToList(table.relationList());
