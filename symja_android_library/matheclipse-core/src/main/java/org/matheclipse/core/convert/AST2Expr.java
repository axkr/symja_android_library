...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"AbsolutePointSize", "AbsoluteThickness",
      ...
      "GaussianIntegers", "General", "GenerateConditions", "Glaisher", "GoldenAngle", "GoldenRatio",
      ...
      "MaxPlotPoints", "MaxPoints", "MaxRecursion", "MaxRoots", "Mesh", "Medium", "Method",
      "Modulus", "MonomialOrder", "NegativeDegreeLexicographic",
      ...
      "SpanFromAbove", "SpanFromBoth", "SpanFromLeft", "SplineClosed", "SplineDegree",
      ...
      "Today", "TooLarge", "Top", "Transparent", "Trig", "True", "Unknown", "UseTypeChecking",
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "Dashing", "Dataset", "DateObject", "DateString", "DateValue", "DawsonF", "Decrement",
      ...
      "Xnor", "Xor", "YuleDissimilarity", "ZernikeR", "Zeta", "ZTransform"};
