...
/**
 * SolvableLocalResidue, that is a (left) rational function, based on pairs of GenSolvablePolynomial
 * with GcdRingElem interface. Objects of this class are immutable.
 *
 * @author Heinz Kredel
 */
public class SolvableLocalResidue<C extends GcdRingElem<C>>
  ...
  /**
   * The constructor creates a SolvableLocalResidue object from a ring factory and a numerator
  ...
  /**
   * The constructor creates a SolvableLocalResidue object from a ring factory and a numerator and
   ...
   */
  public SolvableLocalResidue(
      SolvableLocalResidueRing<C> r, GenSolvablePolynomial<C> n, GenSolvablePolynomial<C> d) {
    this(r, n, d, false);
  }
   ...
   */
  protected SolvableLocalResidue(
      SolvableLocalResidueRing<C> r,
  ...
  public int compareTo(SolvableLocalResidue<C> b) {
    ...
    // //logger.info("p.signum() = " + p.signum());
    // if ( t == 0 ) {
    //     throw new RuntimeException("can not happen: denominator is zero: this " + this + ", b = "
    // + b);
    // }
    // return t * p.signum();
  }
