 ...
 * lexicographical orders. For the definitions see for example the articles <a
 * href="http://doi.acm.org/10.1145/43882.43887">Kredel "Admissible term orderings used in computer
 * algebra systems"</a> and <a href="http://doi.acm.org/10.1145/70936.70941">Sit, "Some comments on
 * term-ordering in Gr&ouml;bner basis computations"</a>. Not all algorithms may work with all term
 * orders since not all are well-founded, so watch your step.
 *
 * <p><b>Note:</b> Variables in printed JAS polynomial <b>(low, ..., medium, ..., high)</b>
 * Variables in other CAS polynomial <b>(high, ..., medium, ..., low)</b> with <b>low</b> &lt;
 * <b>medium</b> &lt; <b>high</b>. Example: for variables x<sub>1</sub>, ..., x<sub>r</sub> it is
 * assumed in JAS that x <sub>1</sub> &lt; ... &lt; x<sub>r</sub> in other CAS it means
...
public class TermOrderByName {
  ...
  /** Default TermOrder. */
  public static final TermOrder DEFAULT = new TermOrder(TermOrder.DEFAULT_EVORD);
  ...
  public static final TermOrder NegativeDegreeLexicographic = REVITDEG; // was REVTDEG;
  ...
  public static final TermOrder DegreeReverseLexicographic = ITDEGLEX; // was IGRLEX;
  ...
  public static final TermOrder lex = Lexicographic; // = REVILEX;

  /** TermOrder name degrevlex of Sage. */
  public static final TermOrder degrevlex = DegreeReverseLexicographic; // = IGRLEX;

  /** TermOrder name deglex of Sage. */
  public static final TermOrder deglex = DegreeLexicographic; // = REVITDG;

  /** TermOrder name invlex of Sage. */
  public static final TermOrder invlex = INVLEX; // ReverseLexicographic

  /** TermOrder name neglex of Sage. */
  public static final TermOrder neglex = NegativeLexicographic; // = REVLEX;

  /** TermOrder name negdegrevlex of Sage. */
  public static final TermOrder negdegrevlex = NegativeDegreeReverseLexicographic; // = GRLEX;

  /** TermOrder name negdeglex of Sage. */
  public static final TermOrder negdeglex = NegativeDegreeLexicographic; // = REVTDEG;

  /** TermOrder name negrevlex of Sage. */
  public static final TermOrder negrevlex = NegativeReverseLexicographic; // = LEX;

  // Singular term orders:

  /** TermOrder name lp of Singular. */
  public static final TermOrder lp = lex; // = REVILEX;

  /** TermOrder name dp of Singular. */
  public static final TermOrder dp = degrevlex; // = IGRLEX;

  /** TermOrder name Dp of Singular. */
  public static final TermOrder Dp = deglex; // = REVITDG;

  /** TermOrder name rp of Singular. */
  public static final TermOrder rp = invlex; // = INVLEX;

  /** TermOrder name ls of Singular. */
  public static final TermOrder ls = neglex; // = REVLEX;

  /** TermOrder name ds of Singular. */
  public static final TermOrder ds = negdegrevlex; // = GRLEX;

  /** TermOrder name Ds of Singular. */
  public static final TermOrder Ds = negdeglex; // = REVTDEG;

  // missing: public final static TermOrder negrevlex; // = LEX;

  /**
   * Construct elimination block TermOrder. Variables {x<sub>1</sub>, ..., x <sub>s-1</sub>} &lt;
    ...
    switch (to) {
      ...
      default:
        throw new UnsupportedOperationException(
            "case " + to + " not implemented for weightForOrder");
    }
    return w;
  }
   ...
   * @return weight matrix
   */
  /*public*/ static final long[][] weightForSplitOrder(int to, int to2, int n, int s) {
    int k = 0;
    switch (to) {
      case TermOrder.IGRLEX:
        k += 1;
    ...
    switch (to) {
      ...
      default:
        ...
        // throw new UnsupportedOperationException("case " + to + "/" + to2 + " not implemented for
        // weightForOrder");
        break;
    }
    switch (to2) {
