...
public interface MathMLEncloseElement extends MathMLPresentationContainer {
  /**
   * A string giving a name for the notation enclosing the element's contents. Represents the
   * notation attribute of the menclose. Any string is allowed as a value; predefined values include
   * longdiv, actuarial, radical, box, roundedbox, circle, left, right, top, bottom,
   * updiagonalstrike, downdiagonalstrike, verticalstrike, horizontalstrike, or combinations of
   * these strings separated by whitespace (see ).
   *
   ...
   *
   * @param notation new value for notation.
   * @see #getNotation()
   */
