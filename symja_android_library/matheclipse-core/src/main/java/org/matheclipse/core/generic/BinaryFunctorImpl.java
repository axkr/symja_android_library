...
/**
 * A function object that takes two arguments and returns a result. The two arguments are both of
 * type <code>T</code> and the result is also of type <code>T</code>
 *
 * @deprecated
 */
