...
class LutherFieldStepInterpolator<T extends RealFieldElement<T>>
    ...
    protected FieldODEStateAndDerivative<T> computeInterpolatedStateAndDerivatives(final FieldEquationsMapper<T> mapper,
        ...
        final T coeffDot5 =  theta.multiply(theta.multiply(theta.multiply(theta.multiply(c5a.divide(5)).sum(c5b.divide(15))).sum(c5c.divide(30))).sum(c5d.divide(150)));
        final T coeffDot6 =  theta.multiply(theta.multiply(theta.multiply(theta.multiply(c6a.divide(5)).sum(c6b.divide(15))).sum(c6c.divide(30))).sum(c6d.divide(150)));
        ...
        if (getGlobalPreviousState() != null && theta.getReal() <= 0.5) {
            ...
            final T coeff5    = s.multiply(theta.multiply(theta.multiply(theta.multiply(theta.multiply(c5a.divide(25)).sum(c5b.divide(60))).sum(c5c.divide(90))).sum(c5d.divide(300))));
            final T coeff6    = s.multiply(theta.multiply(theta.multiply(theta.multiply(theta.multiply(c6a.divide(25)).sum(c6b.divide(60))).sum(c6c.divide(90))).sum(c6d.divide(300))));
            ...
            final T coeff5    = s.multiply(theta.multiply(theta.multiply(theta.multiply(theta.multiply(d5a.divide(25)).sum(d5b.divide(300))).sum(d5c.divide(900))).add( -49 / 180.0)).add(-49 / 180.0));
            final T coeff6    = s.multiply(theta.multiply(theta.multiply(theta.multiply(theta.multiply(d6a.divide(25)).sum(d6b.divide(300))).sum(d6c.divide(900))).add( -49 / 180.0)).add(-49 / 180.0));
