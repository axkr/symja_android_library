...
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),Power(Coth(Plus(a_DEFAULT,Times(b_DEFAULT,Power(x_,n_DEFAULT)))),q_DEFAULT),Power(Csch(Plus(a_DEFAULT,Times(b_DEFAULT,Power(x_,n_DEFAULT)))),p_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Power($(F_,v_),p_DEFAULT),x_Symbol),
    Condition(Int(Power(F(ExpandToSum(v,x)),p),x),And(And(And(FreeQ(p,x),HyperbolicQ(FSymbol)),BinomialQ(v,x)),Not(BinomialMatchQ(v,x))))),
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),Power($(F_,v_),p_DEFAULT)),x_Symbol),
    Condition(Int(Times(Power(x,m),Power(F(ExpandToSum(v,x)),p)),x),And(And(And(FreeQ(List(m,p),x),HyperbolicQ(FSymbol)),BinomialQ(v,x)),Not(BinomialMatchQ(v,x))))),
...
ISetDelayed(Int(Power(Times(c_DEFAULT,Power($(F_,v_),p_DEFAULT)),q_),x_Symbol),
    Condition(Int(Power(Times(c,Power(F(ExpandToSum(v,x)),p)),q),x),And(And(And(FreeQ(List(c,p,q),x),HyperbolicQ(FSymbol)),BinomialQ(v,x)),Not(BinomialMatchQ(v,x))))),
ISetDelayed(Int(Times(Power(x_,m_DEFAULT),Power(Times(c_DEFAULT,Power($(F_,v_),p_DEFAULT)),q_)),x_Symbol),
    Condition(Int(Times(Power(x,m),Power(Times(c,Power(F(ExpandToSum(v,x)),p)),q)),x),And(And(And(FreeQ(List(c,m,p,q),x),HyperbolicQ(FSymbol)),BinomialQ(v,x)),Not(BinomialMatchQ(v,x)))))
  );
}
