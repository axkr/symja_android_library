...
public class ExpVectorIterable implements Iterable<ExpVector> {
   ...
   *
   * @param nv number of variables.
   * @param all true, if all elements between 0 and upper bound are enumerated, false, if only
   *     elements of exact upper bund are to be processed.
   * @param ub upper bound for the components.
   */
...
class ExpVectorIterator implements Iterator<ExpVector> {
   ...
   *
   * @param nv number of variables.
   * @param inf true, if all elements between 0 and upper bound are enumerated, false, if only
   *     elements of exact upper bund are to be processed.
