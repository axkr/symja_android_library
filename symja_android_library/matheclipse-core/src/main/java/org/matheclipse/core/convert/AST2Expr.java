...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "CoprimeQ", "Correlation", "CorrelationDistance", "Cos", "Cosh", "CosineDistance",
      "CosIntegral", "CoshIntegral", "Cot", "Coth", "Count", "CountDistinct", "Counts",
      "Covariance", "CreateFile", "CreateDirectory", "Cross", "Csc", "Csch", "CubeRoot", "Cuboid",
      "Curl", "Cyclotomic", "CycleGraph", "Cycles", "Cylinder", "Dataset", "DateObject",
      ...
      "FindIndependentVertexSet", "FindHamiltonianCycle", "FindInstance", "FindMaximum",
      ...
      "ForAll", "FormBox", "Fourier", "FourierMatrix", "FRatioDistribution", "FractionBox",
