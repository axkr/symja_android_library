...
ISetDelayed(Int(Times(Power(Plus(c_,Times(d_DEFAULT,Power(x_,n_))),-1),ArcTanh(Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition($(AbortRubi($s("Int")),Times(ArcTanh(Plus(a,Times(b,x))),Power(Plus(c,Times(d,Power(x,n))),-1)),x),And(FreeQ(List(a,b,c,d,n),x),Not(RationalQ(n))))),
ISetDelayed(Int(Times(Power(Plus(c_,Times(d_DEFAULT,Power(x_,n_))),-1),ArcCoth(Plus(a_,Times(b_DEFAULT,x_)))),x_Symbol),
    Condition($(AbortRubi($s("Int")),Times(ArcCoth(Plus(a,Times(b,x))),Power(Plus(c,Times(d,Power(x,n))),-1)),x),And(FreeQ(List(a,b,c,d,n),x),Not(RationalQ(n))))),
