...
ISetDelayed(Int(PolyLog(pn_,Times(Power(Times(Power(x_,p_DEFAULT),b_DEFAULT),q_DEFAULT),a_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(PolyLog(pn_,Times(Power(Plus(Times(b_DEFAULT,x_),a_DEFAULT),p_DEFAULT),c_DEFAULT)),Power(Plus(Times(x_,pe_DEFAULT),pd_DEFAULT),CN1)),x_Symbol),
...
ISetDelayed(Int(Times(PolyLog(pn_,Times(Power(Times(Power(x_,p_DEFAULT),b_DEFAULT),q_DEFAULT),a_DEFAULT)),Power(x_,CN1)),x_Symbol),
    Condition(Times(PolyLog(Plus(pn,C1),Times(a,Power(Times(b,Power(x,p)),q))),Power(Times(p,q),CN1)),FreeQ(List(a,b,pn,p,q),x))),
ISetDelayed(Int(Times(PolyLog(pn_,Times(Power(Times(Power(x_,p_DEFAULT),b_DEFAULT),q_DEFAULT),a_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(PolyLog(pn_,Times(Power(Times(Power(x_,p_DEFAULT),b_DEFAULT),q_DEFAULT),a_DEFAULT)),Power(Log(Times(Power(x_,m_DEFAULT),c_DEFAULT)),r_DEFAULT),Power(x_,CN1)),x_Symbol),
...
ISetDelayed(Int(PolyLog(pn_,Times(Power(Plus(Times(b_DEFAULT,x_),a_DEFAULT),p_DEFAULT),c_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(PolyLog(pn_,Times(Power(Plus(Times(b_DEFAULT,x_),a_DEFAULT),p_DEFAULT),c_DEFAULT)),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(PolyLog(pn_,Times(Power(Power(pf_,Times(Plus(Times(b_DEFAULT,x_),a_DEFAULT),c_DEFAULT)),p_DEFAULT),pd_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(PolyLog(pn_,Times(Power(Power(pf_,Times(Plus(Times(b_DEFAULT,x_),a_DEFAULT),c_DEFAULT)),p_DEFAULT),pd_DEFAULT)),Power(Plus(Times(f_DEFAULT,x_),pe_DEFAULT),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(PolyLog(pn_,v_),u_),x_Symbol),
...
ISetDelayed(Int(Times(Log(w_),PolyLog(pn_,v_),u_),x_Symbol),
