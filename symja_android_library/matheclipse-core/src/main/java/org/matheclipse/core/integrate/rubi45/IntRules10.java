...
ISetDelayed(Int(Power(Plus(Times(Power(x_,q_DEFAULT),a_DEFAULT),Times(Power(x_,pn_DEFAULT),b_DEFAULT)),p_),x_Symbol),
...
ISetDelayed(Int(Power(Plus(Times(Sqr(x_),a_DEFAULT),Times(b_DEFAULT,x_)),CN1D2),x_Symbol),
...
ISetDelayed(Int(Power(Plus(Times(Sqr(x_),a_DEFAULT),Times(Power(x_,pn_DEFAULT),b_DEFAULT)),CN1D2),x_Symbol),
...
ISetDelayed(Int(Power(Plus(Times(Power(x_,pn_),b_DEFAULT),Times(a_DEFAULT,x_)),CN1D2),x_Symbol),
...
ISetDelayed(Int(Power(Plus(Times(Power(u_,q_DEFAULT),a_DEFAULT),Times(Power(v_,pn_DEFAULT),b_DEFAULT)),p_),x_Symbol),
