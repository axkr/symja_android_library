...
/**
 * List of vectors of polynomials. Mainly for storage and printing / toString and conversions to
...
public class ModuleList<C extends RingElem<C>> implements Serializable {
   ...
   */
  public static <C extends RingElem<C>> List<List<GenPolynomial<C>>> padCols(
      GenPolynomialRing<C> ring, List<List<GenPolynomial<C>>> l) {
    if (l == null) {
      return l;
    }
    int mcols = 0;
  ...
  /**
   * Get list as List of GenSolvablePolynomials. Required because no List casts allowed. Equivalent
   * to cast (List&lt;List&lt;GenSolvablePolynomial&lt;C&gt;&gt;&gt;) list.
   *
  ...
  /**
   * Get a solvable polynomials list as List of GenPolynomials. Required because no List casts
   * allowed. Equivalent to cast (List&lt;List&lt;GenPolynomial&lt;C&gt;&gt;&gt;) list.
   *
