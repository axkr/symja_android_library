...
/**
 * Solvable Groebner Bases abstract class. Implements common left, right and twosided Groebner bases
...
public abstract class SolvableGroebnerBaseAbstract<C extends RingElem<C>>
   ...
   * @return a container for an extended left Groebner base G of F together with back-and-forth
   *     transformations.
   */
  public SolvableExtendedGB<C> extLeftGB(int modv, List<GenSolvablePolynomial<C>> F) {
    throw new UnsupportedOperationException(
        "extLeftGB not implemented in " + this.getClass().getSimpleName());
  }
  ...
  /**
   * Construct univariate solvable polynomial of minimal degree in variable i of a zero dimensional
   * ideal(G).
   *
  ...
  public GenSolvablePolynomial<C> constructUnivariate(int i, List<GenSolvablePolynomial<C>> G) {
    ...
    GenSolvablePolynomialRing<GenPolynomial<C>> rfac =
        new GenSolvablePolynomialRing<GenPolynomial<C>>(cpfac, pfac); // relations
    ...
    do {
      ...
      GenSolvablePolynomial<GenPolynomial<C>> XPs =
          (GenSolvablePolynomial<GenPolynomial<C>>) XPp.sum(P);
    ...
    GenSolvablePolynomialRing<C> ufac =
        new GenSolvablePolynomialRing<C>(
            cfac, 1, new TermOrder(TermOrder.INVLEX), new String[] {var});
  ...
  /**
   * Construct univariate solvable polynomials of minimal degree in all variables in zero
   * dimensional left ideal(G).
   *
   * @return list of univariate polynomial of minimal degree in each variable in ideal_left(G)
   */
