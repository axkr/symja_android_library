...
ISetDelayed(MergeMonomials(Times(u_DEFAULT,Power(Plus(a_DEFAULT,Times(b_DEFAULT,x_)),m_DEFAULT),Power(Plus(c_DEFAULT,Times($p(d,true),x_)),n_DEFAULT)),x_Symbol),
    Condition(Times(u,Power(b,m),Power(Power(d,m),CN1),Power(Plus(c,Times(d,x)),Plus(m,n))),And(And(FreeQ(List(a,b,c,d),x),IntegerQ(m)),ZeroQ(Plus(Times(b,c),Times(CN1,a,d)))))),
...
ISetDelayed(FixSimplify(Times(w_DEFAULT,Power(Plus(a_,b_),m_DEFAULT),Power(Plus(c_,$p(d)),n_))),
    Condition(Module(List(Set(q,Simplify(Times(b,Power(d,CN1))))),Condition(FixSimplify(Times(w,Power(q,m),Power(Plus(c,d),Plus(m,n)))),FreeQ(q,Plus))),And(And(IntegerQ(m),Not(IntegerQ(n))),ZeroQ(Plus(Times(b,c),Times(CN1,a,d)))))),
...
ISetDelayed(FixSimplify(Times(w_DEFAULT,Plus(u_DEFAULT,Times(b_DEFAULT,Sqrt(v_)),Times(c_DEFAULT,Sqrt(v_)),Times($p(d,true),Sqrt(v_)),Times(a_DEFAULT,Sqrt($p(v,Plus)))))),
...
ISetDelayed(FixSimplify(Times(u_DEFAULT,Power(a_,m_),Sqrt(Times(b_DEFAULT,Plus(c_,Times($p(d,true),Sqrt(a_))))))),
...
ISetDelayed(FixSimplify(Times(u_DEFAULT,Power(a_,m_),Power(Times(b_DEFAULT,Plus(c_,Times($p(d,true),Sqrt(a_)))),CN1D2))),
    Condition(Times(FixSimplify(u),Power(Together(Times(b,Plus(Times(c,Power(Power(a,Times(C2,m)),CN1)),Times(d,Power(Power(a,Plus(Times(C2,m),Times(CN1,C1D2))),CN1))))),CN1D2)),And(And(RationalQ(a,b,c,d,m),Greater(a,C0)),Equal(Denominator(m),C4)))),
...
ISetDelayed(FixSimplify(Times(u_DEFAULT,Power(Times(CN1,Power(v_,p_DEFAULT)),m_),Power(w_,n_DEFAULT))),
...
ISetDelayed(FixSimplify(Times(u_DEFAULT,Power(Plus(a,Times(CN1,b)),m_DEFAULT),Power(Plus(a,b),m_DEFAULT))),
    Condition(Times(u,Power(Plus(Sqr(a),Times(CN1,Sqr(b))),m)),IntegerQ(m))),
ISetDelayed(FixSimplify(Times(u_DEFAULT,Power(Plus(Times(CN1,e,Plus(Times(b,d),Times(CN1,a,e))),Times(c,Sqr(d))),m_DEFAULT))),
    Condition(Times(u,Power(Plus(Times(c,Sqr(d)),Times(CN1,b,d,e),Times(a,Sqr(e))),m)),RationalQ(m))),
ISetDelayed(FixSimplify(Times(u_DEFAULT,Power(Plus(Times(e,Plus(Times(CN1,b,d),Times(a,e))),Times(c,Sqr(d))),m_DEFAULT))),
    Condition(Times(u,Power(Plus(Times(c,Sqr(d)),Times(CN1,b,d,e),Times(a,Sqr(e))),m)),RationalQ(m))),
ISetDelayed(FixSimplify(u_),
    u),
ISetDelayed(SimpFixFactor(Power(Plus(Times(a_DEFAULT,Complex(C0,c_)),Times(b_DEFAULT,Complex(C0,$p(d)))),p_DEFAULT),x_),
    Condition(Times(Power(CI,p),SimpFixFactor(Power(Plus(Times(a,c),Times(b,d)),p),x)),IntegerQ(p))),
ISetDelayed(SimpFixFactor(Power(Plus(Times(a_DEFAULT,Complex(C0,$p(d))),Times(b_DEFAULT,Complex(C0,$p(e))),Times(c_DEFAULT,Complex(C0,f_))),p_DEFAULT),x_),
...
ISetDelayed(TrigSimplifyAux(Power(Plus(Times(a_DEFAULT,Sqr($($s("§cos"),u_))),Times(b_DEFAULT,Sqr($($s("§sin"),u_))),v_DEFAULT),n_)),
    Power(Plus(Times(Plus(b,Times(CN1,a)),Sqr(Sin(u))),a,v),n)),
...
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,$($s("§cos"),v_))),CN1),Sqr($($s("§sin"),v_)))),
    Condition(Times(u,Plus(Power(a,CN1),Times(CN1,Cos(v),Power(b,CN1)))),ZeroQ(Plus(Sqr(a),Times(CN1,Sqr(b)))))),
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,$($s("§sin"),v_))),CN1),Sqr($($s("§cos"),v_)))),
    Condition(Times(u,Plus(Power(a,CN1),Times(CN1,Sin(v),Power(b,CN1)))),ZeroQ(Plus(Sqr(a),Times(CN1,Sqr(b)))))),
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,Power($($s("§tan"),v_),n_DEFAULT))),CN1),Power($($s("§tan"),v_),n_DEFAULT))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Cot(v),n))),CN1)),And(PositiveIntegerQ(n),NonsumQ(a)))),
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,Power($($s("§cot"),v_),n_DEFAULT))),CN1),Power($($s("§cot"),v_),n_DEFAULT))),
    Condition(Times(u,Power(Plus(b,Times(a,Power(Tan(v),n))),CN1)),And(PositiveIntegerQ(n),NonsumQ(a)))),
ISetDelayed(TrigSimplifyAux(Times(u_DEFAULT,Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sec"),v_),n_DEFAULT))),CN1),Power($($s("§sec"),v_),n_DEFAULT))),
