      ...
      List(
          IIntegrate(4881,
              ...
              Condition(Plus(
                  ...
                  Dist(
                      Times(
                          Sqr(b), d, p, Subtract(p, C1), Power(Times(C2, q, Plus(Times(C2, q), C1)),
                              CN1)),
                      Integrate(Times(Power(Plus(d, Times(e, Sqr(x))), Subtract(q, C1)),
          ...
          IIntegrate(4882,
              Integrate(
                  Times(Power(Plus(a_DEFAULT,
                      Times(ArcTan(Times(c_DEFAULT, x_)), b_DEFAULT)), CN1), Power(
                          Plus(d_, Times(e_DEFAULT, Sqr(x_))), CN1)),
                  x_Symbol),
              Condition(
                  Simp(
                      Times(
                          Log(RemoveContent(Plus(a,
                              Times(b, ArcTan(Times(c, x)))), x)),
              ...
              Integrate(
                  Times(
                      Power(Plus(a_DEFAULT,
                          Times(ArcCot(Times(c_DEFAULT, x_)), b_DEFAULT)), CN1),
                      Power(Plus(d_, Times(e_DEFAULT, Sqr(x_))), CN1)),
                  x_Symbol),
              Condition(
                  Negate(
                      Simp(
                          Times(Log(RemoveContent(Plus(a, Times(b, ArcCot(Times(c, x)))), x)),
                              Power(Times(b, c, d), CN1)),
                          x)),
                  And(FreeQ(List(a, b, c, d, e), x), EqQ(e, Times(Sqr(c), d))))),
          IIntegrate(4884,
              ...
              Condition(
                  Simp(
                      ...
                      x),
                  And(FreeQ(List(a, b, c, d, e, p), x), EqQ(e, Times(Sqr(c), d)), NeQ(p, CN1)))),
          IIntegrate(4885,
              Integrate(
                  Times(
                      Power(
          ...
          IIntegrate(4886,
              ...
              Condition(
                  Plus(
                      Simp(
                          Times(CN2, CI, Plus(a, Times(b, ArcTan(Times(c, x)))),
                              ArcTan(Times(Sqrt(Plus(C1, Times(CI, c, x))),
                      ...
                      Simp(
                          Times(CI, b,
                              PolyLog(C2,
                                  Times(CN1, CI, Sqrt(Plus(C1, Times(CI, c, x))),
                                      Power(Subtract(C1, Times(CI, c, x)), CN1D2))),
                              Power(Times(c, Sqrt(d)), CN1)),
                          x),
                      Negate(Simp(Times(CI, b,
                          PolyLog(C2,
                              Times(CI, Sqrt(Plus(C1, Times(CI, c, x))),
                                  Power(Subtract(C1, Times(CI, c, x)), CN1D2))),
          ...
          IIntegrate(4887,
              ...
              Condition(
                  Plus(
                      Simp(Times(CN2, CI, Plus(a, Times(b, ArcCot(Times(c, x)))),
                          ArcTan(Times(Sqrt(Plus(C1, Times(CI, c, x))),
                              Power(Subtract(C1, Times(CI, c, x)), CN1D2))),
                          Power(Times(c, Sqrt(d)), CN1)), x),
                      Negate(
          ...
          IIntegrate(4888,
              Integrate(
                  ...
                  x_Symbol),
              Condition(
                  Dist(Power(Times(c, Sqrt(d)), CN1),
                      Subst(
                          Integrate(Times(Power(Plus(a, Times(b, x)), p), Sec(x)),
                              x),
                          x, ArcTan(Times(c, x))),
                      x),
              ...
              Condition(
                  Negate(
                      Dist(
                          ...
                          Subst(Integrate(Times(Power(Plus(a, Times(b, x)), p), Csc(x)), x), x,
                              ArcCot(Times(c, x))),
                          x)),
                  And(FreeQ(List(a, b, c, d, e), x), EqQ(e, Times(Sqr(c), d)), IGtQ(p, C0),
                      GtQ(d, C0)))),
          IIntegrate(4890,
              ...
              Condition(
                  Dist(
                      ...
                      x),
                  And(FreeQ(List(a, b, c, d, e), x), EqQ(e, Times(Sqr(c), d)), IGtQ(p,
                      C0), Not(GtQ(d, C0))))),
          IIntegrate(4891,
              Integrate(
                  Times(
          ...
          IIntegrate(4892,
              ...
              Condition(
                  Plus(
                      Simp(
                          Times(x, Power(Plus(a, Times(b, ArcTan(Times(c, x)))), p),
                      ...
                      Simp(
                          Times(
                              Power(Plus(a, Times(b, ArcTan(Times(c, x)))), Plus(p,
                                  C1)),
          ...
          IIntegrate(4894,
              Integrate(
                  Times(
                      Plus(a_DEFAULT, Times(ArcTan(Times(c_DEFAULT,
                          x_)), b_DEFAULT)),
              ...
              Condition(
                  Plus(
                      Simp(Times(b,
                          Power(Times(c, d, Sqrt(Plus(d, Times(e, Sqr(x))))), CN1)), x),
                      Simp(
                          Times(
                              x, Plus(a, Times(b,
                                  ArcTan(Times(c, x)))),
          ...
          IIntegrate(4895,
              ...
              Condition(
                  Plus(
                      Negate(
                          Simp(
                              Times(b, Power(Times(c, d, Sqrt(Plus(d, Times(e, Sqr(x))))),
                                  CN1)),
                              x)),
                      Simp(
                          Times(x, Plus(a, Times(b, ArcCot(Times(c, x)))),
                              Power(Times(d, Sqrt(Plus(d, Times(e, Sqr(x))))), CN1)),
                          x)),
                  And(FreeQ(List(a, b, c, d, e), x), EqQ(e, Times(Sqr(c), d))))),
          IIntegrate(4896,
              ...
              Condition(
                  Plus(Simp(Times(b, Power(Plus(d, Times(e, Sqr(x))), Plus(q, C1)),
                      Power(Times(C4, c, d, Sqr(Plus(q, C1))), CN1)), x), Dist(
                      ...
                      Negate(Simp(Times(x, Power(Plus(d, Times(e, Sqr(x))), Plus(q, C1)),
                          Plus(a, Times(b, ArcTan(Times(c, x)))), Power(Times(C2, d, Plus(q, C1)),
                              CN1)),
                          x))),
                  And(FreeQ(List(a, b, c, d, e), x), EqQ(e, Times(Sqr(c), d)), LtQ(q, CN1),
                      NeQ(q, QQ(-3L, 2L))))),
          IIntegrate(4897,
              Integrate(Times(Plus(a_DEFAULT, Times(ArcCot(Times(c_DEFAULT, x_)), b_DEFAULT)),
              ...
              Condition(
                  Plus(
                      Simp(
                          ...
                          x),
                      Negate(
                          Dist(Times(Sqr(b), p, Subtract(p, C1)),
                              Integrate(
                                  Times(
                                      Power(Plus(a, Times(b, ArcTan(Times(c, x)))),
                                          Subtract(p, C2)),
                      ...
                      Simp(
                          Times(
                              x, Power(Plus(a, Times(b, ArcTan(Times(c, x)))), p), Power(
                                  Times(d, Sqrt(Plus(d, Times(e, Sqr(x))))), CN1)),
                          x)),
                  And(FreeQ(List(a, b, c, d, e), x), EqQ(e, Times(Sqr(c), d)), GtQ(p, C1)))),
          IIntegrate(4899,
              Integrate(Times(
                  Power(Plus(a_DEFAULT, Times(ArcCot(Times(c_DEFAULT, x_)), b_DEFAULT)), p_), Power(
                  ...
                  Plus(
                      ...
                      Negate(Dist(
                          Times(Sqr(b), p, Subtract(p, C1),
                              Power(Times(C4, Sqr(Plus(q, C1))), CN1)),
                          Integrate(
