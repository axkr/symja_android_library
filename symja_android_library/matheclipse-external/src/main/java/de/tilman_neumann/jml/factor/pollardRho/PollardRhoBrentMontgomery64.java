 ...
 *
 * <p>The main reason why Montgomery multiplication is helpful for Pollard-Rho is that no
 * conversions to/from Montgomery form are required.
 *
 * <p>In this implementation I managed to use the Montgomery reducer R=2^64, which simplifies the
 * Montgomery multiplication a good deal.
 *
 * <p>Another small performance improvement stems from using the polynomial x*(x+1) instead of
 * x^2+c, which saves us the addition modulo N after each Montgomery multiplication.
 *
