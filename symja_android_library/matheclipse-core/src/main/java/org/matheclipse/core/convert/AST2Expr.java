...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abort", "Abs", "AbsArg", "AbsoluteCorrelation", "Accumulate",
			...
			"DataSet", "Decrement", "Default", "DefaultButton", "Defer", "Definition", "Delete", "DeleteCases", "DeleteDuplicates",
			...
			"SemanticImport", "Sequence", "Series", "SeriesCoefficient", "SeriesData", "Set", "SetAttributes",
			...
			"StandardForm", "Standardize", "StieltjesGamma", "StirlingS1", "StirlingS2", "StringDrop",
			"StringExpression", "StringJoin", "StringLength", "StringRiffle", "StringTake", "StringQ", "StringReplace",
