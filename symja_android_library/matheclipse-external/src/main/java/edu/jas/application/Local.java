...
/**
 * Local ring element based on GenPolynomial with RingElem interface. Objects of this class are
 * (nearly) immutable.
 *
 * @author Heinz Kredel
 */
...
public class Local<C extends GcdRingElem<C>>
  ...
  /**
   * The constructor creates a Local object from a ring factory and a numerator polynomial. The
  ...
  /**
   * The constructor creates a Local object from a ring factory and a numerator and denominator
   * polynomial.
   *
   * @param r ring factory.
   * @param n numerator polynomial.
