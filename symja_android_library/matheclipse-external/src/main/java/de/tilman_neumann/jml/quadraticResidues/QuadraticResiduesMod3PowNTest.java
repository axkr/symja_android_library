...
public class QuadraticResiduesMod3PowNTest {
  ...
  public static void main(String[] args) {
    ...
    for (int n = 0; n < 17; n++) {
      ...
      LOG.info(
          "v1: n = "
              + n
              + ": There are "
              + quadraticResiduesModPow.size()
              + " quadratic residues mod 3^"
              + n
              + (SHOW_ELEMENTS ? ": " + quadraticResiduesModPow : ""));
      counts.add(quadraticResiduesModPow.size());

      List<Long> quadraticResiduesModPow_v2 =
          QuadraticResiduesMod3PowN.getQuadraticResiduesMod3PowN(n);
      LOG.info(
          "v2: n = "
              + n
              + ": There are "
              + quadraticResiduesModPow_v2.size()
              + " quadratic residues mod 3^"
              + n
              + (SHOW_ELEMENTS ? ": " + quadraticResiduesModPow_v2 : ""));
      counts_v2.add(quadraticResiduesModPow_v2.size());

      List<Long> quadraticResiduesModPow_v3 =
          QuadraticResiduesMod3PowN.getQuadraticResiduesMod3PowN_testAll(n);
      LOG.info(
          "v3: n = "
              + n
              + ": There are "
              + quadraticResiduesModPow_v3.size()
              + " quadratic residues mod 3^"
              + n
              + (SHOW_ELEMENTS ? ": " + quadraticResiduesModPow_v3 : ""));
    ...
    // A039300(n) = 1, 2, 4, 11, 31, 92, 274, 821, 2461, 7382, 22144, 66431, 199291, 597872,
    // 1793614, 5380841, 16142521...
  }
}
