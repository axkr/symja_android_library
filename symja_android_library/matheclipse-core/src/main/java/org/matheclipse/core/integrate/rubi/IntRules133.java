...
IIntegrate(6668,Int(Times(u_,Plus(Times(a_DEFAULT,$(g_,x_),$($(Derivative(m_),f_),x_)),Times(b_DEFAULT,$($(Derivative(C1),g_),x_),$($(Derivative($p("m1")),f_),x_))),Power($($(Derivative($p("m1")),f_),x_),p_DEFAULT)),x_Symbol),
...
IIntegrate(6672,Int(Times(u_,Power($(g_,x_),q_DEFAULT),Plus(Times(a_DEFAULT,$(g_,x_),$($(Derivative(m_),f_),x_)),Times(b_DEFAULT,$($(Derivative(C1),g_),x_),$($(Derivative($p("m1")),f_),x_))),Power($($(Derivative($p("m1")),f_),x_),p_DEFAULT)),x_Symbol),
...
IIntegrate(6673,Int(Times(u_,Power($($(Derivative($p("m1")),f_),x_),p_DEFAULT),Plus(Times(b_DEFAULT,$($(Derivative($p("m1")),f_),x_),$($(Derivative(n_),g_),x_)),Times(a_DEFAULT,$($(Derivative(m_),f_),x_),$($(Derivative($p("n1")),g_),x_))),Power($($(Derivative($p("n1")),g_),x_),q_DEFAULT)),x_Symbol),
