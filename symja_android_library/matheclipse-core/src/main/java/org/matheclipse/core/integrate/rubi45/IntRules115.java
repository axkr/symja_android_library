...
ISetDelayed(Int(Times(ArcSec(Plus(a_,Times(b_DEFAULT,x_))),Power(x_,-1)),x_Symbol),
...
ISetDelayed(Int(Times(ArcCsc(Plus(a_,Times(b_DEFAULT,x_))),Power(x_,-1)),x_Symbol),
