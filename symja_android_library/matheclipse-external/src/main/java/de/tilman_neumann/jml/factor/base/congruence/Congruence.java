...
public interface Congruence {
  ...
  /**
   * @return set matrix elements. For a smooth congruence these are the small factors appearing with
   *     odd exponent, and for a partial congruence the large factors with odd exponent,
   */
