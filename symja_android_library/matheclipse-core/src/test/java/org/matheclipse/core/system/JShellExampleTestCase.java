  ...
  public void test002() {
    ...
    assertEquals(str, //
        "## Im\n" + "\n" + "Im(z)\n" + "\n"
            ...
            + "[Github master](https://github.com/axkr/symja_android_library/blob/master/symja_android_library/matheclipse-core/src/main/java/org/matheclipse/core/builtin/Arithmetic.java#L2293)\n"
            + "\n" + "");
  }
}
