...
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,Sqr($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_)))))),p_),x_Symbol),
...
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,Sqr($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_)))))),p_),x_Symbol),
...
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_))),n_))),p_),x_Symbol),
...
ISetDelayed(Int(Power(Plus(a_,Times(b_DEFAULT,Power($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_))),n_))),p_),x_Symbol),
...
ISetDelayed(Int(Times(u_,Power(Plus(a_,Times(b_DEFAULT,Sqr($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_)))))),p_)),x_Symbol),
...
ISetDelayed(Int(Times(u_,Power(Plus(a_,Times(b_DEFAULT,Sqr($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_)))))),p_)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_))),n_))),p_),Power($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_))),n_))),p_),Power($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_)),x_Symbol),
    Condition(Module(List(Set(f,FreeFactors(Tan(Plus(c,Times(d,x))),x))),Times(f,Power(d,CN1),Subst(Int(Times(Power(ExpandToSum(Plus(b,Times(a,Power(Plus(C1,Times(Sqr(f),Sqr(x))),Times(C1D2,n)))),x),p),Power(Power(Plus(C1,Times(Sqr(f),Sqr(x))),Plus(Times(C1D2,m),Times(n,C1D2,p),C1)),CN1)),x),x,Times(Tan(Plus(c,Times(d,x))),Power(f,CN1))))),And(And(And(FreeQ(List(a,b,c,d),x),EvenQ(n)),EvenQ(m)),IntegerQ(p)))),
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_))),n_))),p_),Power($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_))),n_))),p_),Power($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_))),n_))),p_),Power($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_))),n_))),p_),Power($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power(Times($p(e,true),$($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_)))),n_))),p_DEFAULT),Power($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power(Times($p(e,true),$($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_)))),n_))),p_DEFAULT),Power($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power(Times($p(e,true),$($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_)))),n_))),p_DEFAULT),Power($($s("§tan"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power(Times($p(e,true),$($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_)))),n_))),p_DEFAULT),Power($($s("§cot"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power($($s("§sin"),Plus(c_DEFAULT,Times($p(d,true),x_))),n_))),p_DEFAULT),Power($($s("§tan"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(a_,Times(b_DEFAULT,Power($($s("§cos"),Plus(c_DEFAULT,Times($p(d,true),x_))),n_))),p_DEFAULT),Power($($s("§cot"),Plus(c_DEFAULT,Times($p(d,true),x_))),m_)),x_Symbol),
