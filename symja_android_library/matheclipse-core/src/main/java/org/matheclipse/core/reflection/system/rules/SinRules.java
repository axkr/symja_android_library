...
public interface SinRules {
  final public static IAST RULES = List(
    ...
    ISet(Sin(Times(QQ(1L,12L),Pi)),
      Times(C1D2,Plus(CN1,Sqrt(C3)),Power(C2,CN1D2))),
    ...
    ISet(Sin(Times(QQ(1L,5L),Pi)),
      Times(C1D2,Sqrt(C1D2),Sqrt(Plus(C5,Times(CN1,Sqrt(C5)))))),
    ...
    ISet(Sin(Times(QQ(2L,5L),Pi)),
      Times(C1D2,Sqrt(C1D2),Sqrt(Plus(C5,Sqrt(C5))))),
    ISet(Sin(Times(QQ(5L,12L),Pi)),
      Times(C1D2,Plus(C1,Sqrt(C3)),Power(C2,CN1D2))),
    ...
    ISet(Sin(Times(QQ(13L,12L),Pi)),
      Times(CN1D2,Plus(CN1,Sqrt(C3)),Power(C2,CN1D2))),
    ISet(Sin(Times(QQ(11L,10L),Pi)),
      Times(CN1D4,Plus(CN1,Sqrt(C5)))),
    ISet(Sin(Times(QQ(9L,8L),Pi)),
      Times(CN1D2,Sqrt(Plus(C2,Times(CN1,Sqrt(C2)))))),
    ISet(Sin(Times(QQ(7L,6L),Pi)),
      CN1D2),
    ISet(Sin(Times(QQ(6L,5L),Pi)),
      Times(CN1D2,Sqrt(C1D2),Sqrt(Plus(C5,Times(CN1,Sqrt(C5)))))),
    ...
    ISet(Sin(Times(QQ(11L,8L),Pi)),
      Times(CN1D2,Sqrt(Plus(C2,Sqrt(C2))))),
    ISet(Sin(Times(QQ(7L,5L),Pi)),
      Times(CN1D2,Sqrt(C1D2),Sqrt(Plus(C5,Sqrt(C5))))),
    ISet(Sin(Times(QQ(17L,12L),Pi)),
      Times(CN1D2,Plus(C1,Sqrt(C3)),Power(C2,CN1D2))),
