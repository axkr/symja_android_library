...
public class SolveTest extends ExprEvaluatorTestCase {
  ...
  public void testNSolve() {
    ...
    check(
        ...
        // v1 is now a single reduced fraction; the previous nested form
        // (m1*u1+m2*u2+(m2*(-2.0*m1*u1+m1*u2-m2*u2))/(m1+m2))/m1 is the same value
        "{{v2->u2,v1->u1},{v2->(2.0*m1*u1-m1*u2+m2*u2)/(m1+m2),v1->(m1*u1-m2*u1+2.0*m2*u2)/(m1+m2)}}");
  ...
  public void testIssue1019() {
    ...
    check(evalString, //
        "{33659487.499802814,-1.544947365106681,22487008.039337061,-6.468845089540355,0.0000000002545837,20731337.636887173,0.00000000004876339}");
  ...
  public void testSolveLinearIntegers() {
    ...
    check("Solve(a+b+c==100,{a,b,c},Primes, MaxRoots->100)", //
        "{{a->2,b->19,c->79},{a->2,b->31,c->67},{a->2,b->37,c->61},{a->2,b->61,c->37},{a->\n" //
            + "2,b->67,c->31},{a->2,b->79,c->19},{a->19,b->2,c->79},{a->19,b->79,c->2},{a->31,b->\n" //
            + "2,c->67},{a->31,b->67,c->2},{a->37,b->2,c->61},{a->37,b->61,c->2},{a->61,b->2,c->\n" //
            + "37},{a->61,b->37,c->2},{a->67,b->2,c->31},{a->67,b->31,c->2},{a->79,b->2,c->19},{a->\n" //
            + "79,b->19,c->2}}");
  }
