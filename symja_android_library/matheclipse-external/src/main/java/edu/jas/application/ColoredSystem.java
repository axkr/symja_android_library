...
public class ColoredSystem<C extends GcdRingElem<C>> {
  ...
  /**
   * Add to list of colored systems. This is added to the list of colored systems, if a system with
   * the same condition is not already contained.
   *
  ...
  /**
   * Check invariants. Check if all polynomials are determined and if the color of all coefficients
   * is correct with respect to the condition.
   *
