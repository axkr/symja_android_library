...
public class ClusteringFunctions {
	...
	private final static class BinaryDistance extends AbstractDistance {
	 ...
	 * </pre>
	 */
	private final static class BrayCurtisDistance extends AbstractDistance {
	 ...
	 * </pre>
	 */
	private final static class CanberraDistance extends AbstractDistance {
		final static DistanceMeasure distance = new org.hipparchus.clustering.distance.CanberraDistance();
	 ...
	 * </pre>
	 */
	private final static class ChessboardDistance extends AbstractDistance {
	 ...
	 * </pre>
	 */
	private final static class CosineDistance extends AbstractDistance {
	 ...
	 * </pre>
	 */
	private final static class EuclideanDistance extends AbstractDistance {
		final static DistanceMeasure distance = new org.hipparchus.clustering.distance.EuclideanDistance();
				...
				if (ast.arg1().isList() && ast.arg1().size() > 1) {
					...
					if (k > 0) {
						...
						if ("KMeans".equals(method)) {
							...
							KMeansPlusPlusClusterer<DoublePoint> kMeansTransformer = new KMeansPlusPlusClusterer<DoublePoint>(
									k, 100, measure);
	 ...
	 * </pre>
	 */
	private final static class ManhattanDistance extends AbstractDistance {
		final static DistanceMeasure distance = new org.hipparchus.clustering.distance.ManhattanDistance();
	 ...
	 * </pre>
	 */
	final static class SquaredEuclideanDistance extends AbstractDistance {
