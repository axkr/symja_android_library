...
ISetDelayed(Int($($s("§sec"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
    Condition(Times(ArcTanh(Sin(Plus(a,Times(b,x)))),Power(b,CN1)),FreeQ(List(a,b),x))),
ISetDelayed(Int($($s("§csc"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),x_Symbol),
    Condition(Times(CN1,ArcTanh(Cos(Plus(a,Times(b,x)))),Power(b,CN1)),FreeQ(List(a,b),x))),
ISetDelayed(Int(Sqr($($s("§sec"),Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
    Condition(Times(Tan(Plus(a,Times(b,x))),Power(b,CN1)),FreeQ(List(a,b),x))),
ISetDelayed(Int(Sqr($($s("§csc"),Plus(Times(b_DEFAULT,x_),a_DEFAULT))),x_Symbol),
    Condition(Times(CN1,Cot(Plus(a,Times(b,x))),Power(b,CN1)),FreeQ(List(a,b),x))),
ISetDelayed(Int(Power($($s("§sec"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),pn_),x_Symbol),
...
ISetDelayed(Int(Power($($s("§csc"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),pn_),x_Symbol),
...
ISetDelayed(Int(Power(Times($($s("§sec"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),c_DEFAULT),pn_),x_Symbol),
...
ISetDelayed(Int(Power(Times($($s("§csc"),Plus(Times(b_DEFAULT,x_),a_DEFAULT)),c_DEFAULT),pn_),x_Symbol),
