...
public class ChocoConvert {
  ...
  //
  //  private static Model expr2IntegerSolver(
  //      final IAST list, final IAST variables, Map<ISymbol, IntVar> map)
  ...
  //  }
  //
  //  private static ReExpression relationalIntegerExpression(
  //      Model net, IAST temp, Map<ISymbol, IntVar> map) {
  //    ArExpression lhs;
  //    ArExpression rhs;
  //    if (temp.isAST2()) {
  ...
  //   * @param userDefinedVariables all variables which are defined by the user. May contain
  // additional
  ...
  //          listOfZZVariables =
  //              S.Apply.of(
  //                  engine, S.And, ((IAST) complement).mapThread(F.Element(F.Slot1, S.Integers),
  // 1));
  //        }
  //
  ...
  //  }
  //
  //  private static CReExpression relationalExpression(
  //      Model net, IAST temp, Map<ISymbol, RealVar> map) {
  //    CArExpression lhs;
  //    CArExpression rhs;
  //    if (temp.isAST2()) {
  ...
  //  }
  //
  //  private static Model expr2RealSolver(
  //      final IAST list, final IAST variables, Map<ISymbol, RealVar> map)
  //      throws ArgumentTypeException {
  //
  //    // Create a constraint network
  //    Model net = new Model();
  ...
  //        listOfRRVariables =
  //            S.Apply.of(
  //                engine, S.And, ((IAST) complement).mapThread(F.Element(F.Slot1, S.Reals), 1));
  //      }
  //
  ...
  //          temp.append(F.Rule(variable, F.ConditionalExpression(resultValue,
  // listOfRRVariables)));
  //        } else {
