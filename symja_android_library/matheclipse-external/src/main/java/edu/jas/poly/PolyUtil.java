...
/**
 * Polynomial utilities, for example conversion between different representations, evaluation and
 * interpolation.
 *
 * @author Heinz Kredel
 */
public class PolyUtil {
  ...
  /**
   * Recursive representation. Represent as polynomial in i variables with coefficients in n-i
   * variables. Works for arbitrary term orders.
   *
   ...
   */
  public static <C extends RingElem<C>> GenPolynomial<C> distribute(
      GenPolynomialRing<C> dfac, GenPolynomial<GenPolynomial<C>> B) {
  ...
  /**
   * Recursive representation. Represent as polynomials in i variables with coefficients in n-i
   * variables. Works for arbitrary term orders.
   *
   * @param <C> coefficient type.
   * @param rfac recursive polynomial ring factory.
  ...
  public static <C extends RingElem<C>> List<GenPolynomial<GenPolynomial<C>>> recursive(
    ...
    return ListUtil.<GenPolynomial<C>, GenPolynomial<GenPolynomial<C>>>map(
        L, new DistToRec<C>(rfac));
  }

  /**
   * Distribute a recursive polynomial list to a generic polynomial list. Works for arbitrary term
   * orders.
   *
   * @param <C> coefficient type.
   * @param dfac combined polynomial ring factory of coefficients and this.
   ...
   */
  public static <C extends RingElem<C>> List<GenPolynomial<C>> distribute(
      GenPolynomialRing<C> dfac, List<GenPolynomial<GenPolynomial<C>>> L) {
    return ListUtil.<GenPolynomial<GenPolynomial<C>>, GenPolynomial<C>>map(
        L, new RecToDist<C>(dfac));
  }

  /**
   * BigInteger from ModInteger coefficients, symmetric. Represent as polynomial with BigInteger
   * coefficients by removing the modules and making coefficients symmetric to 0.
   *
  ...
  public static <C extends RingElem<C> & Modular>
      GenPolynomial<BigInteger> integerFromModularCoefficients(
   ...
   */
  public static <C extends RingElem<C> & Modular>
      List<GenPolynomial<BigInteger>> integerFromModularCoefficients(
          final GenPolynomialRing<BigInteger> fac, List<GenPolynomial<C>> L) {
    return ListUtil.<GenPolynomial<C>, GenPolynomial<BigInteger>>map(
        L,
  ...
  /**
   * BigInteger from ModInteger coefficients, positive. Represent as polynomial with BigInteger
   * coefficients by removing the modules.
   *
   * @param fac result polynomial factory.
   * @param A polynomial with ModInteger coefficients to be converted.
   * @return polynomial with BigInteger coefficients.
   */
  public static <C extends RingElem<C> & Modular>
      GenPolynomial<BigInteger> integerFromModularCoefficientsPositive(
          GenPolynomialRing<BigInteger> fac, GenPolynomial<C> A) {
   ...
   *     coefficients.
   */
  public static Object[] integerFromRationalCoefficientsFactor(
      GenPolynomialRing<BigInteger> fac, GenPolynomial<BigRational> A) {
  ...
  public static GenPolynomial<BigInteger> integerFromRationalCoefficients(
    ...
    GenPolynomial<BigInteger> Ai =
        PolyUtil.<BigRational, BigInteger>map(fac, A, new RatToIntFactor(gcd, lcm));
    return Ai;
  }

  /**
   * BigInteger from BigRational coefficients. Represent as list of polynomials with BigInteger
   * coefficients by multiplication with the lcm of the numerators of the BigRational coefficients
   * of each polynomial.
   *
   * @param fac result polynomial factory.
  ...
  public static List<GenPolynomial<BigInteger>> integerFromRationalCoefficients(
    ...
    return ListUtil.<GenPolynomial<BigRational>, GenPolynomial<BigInteger>>map(
        L, new RatToIntPoly(fac));
  }

  /**
   * From BigInteger coefficients. Represent as polynomial with type C coefficients, e.g. ModInteger
   * or BigRational.
   *
   * @param <C> coefficient type.
   * @param fac result polynomial factory.
  ...
  public static <C extends RingElem<C>> GenPolynomial<C> fromIntegerCoefficients(
      GenPolynomialRing<C> fac, GenPolynomial<BigInteger> A) {
    return PolyUtil.<BigInteger, C>map(fac, A, new FromInteger<C>(fac.coFac));
  }

  /**
   * From BigInteger coefficients. Represent as list of polynomials with type C coefficients, e.g.
  ...
  public static <C extends RingElem<C>> List<GenPolynomial<C>> fromIntegerCoefficients(
    ...
    return ListUtil.<GenPolynomial<BigInteger>, GenPolynomial<C>>map(
        L, new FromIntegerPoly<C>(fac));
  }
  ...
  public static <C extends RingElem<C> & Rational>
      GenPolynomial<Complex<BigDecimal>> complexDecimalFromRational(
   ...
   */
  public static GenPolynomial<BigRational> realPart(
      GenPolynomialRing<BigRational> fac, GenPolynomial<BigComplex> A) {
   ...
   */
  public static GenPolynomial<BigRational> imaginaryPart(
      GenPolynomialRing<BigRational> fac, GenPolynomial<BigComplex> A) {
   ...
   * @return polynomial with real part of the coefficients.
   */
  public static <C extends RingElem<C>> GenPolynomial<C> realPartFromComplex(
      GenPolynomialRing<C> fac, GenPolynomial<Complex<C>> A) {
   ...
   * @return polynomial with imaginary part of coefficients.
   */
  public static <C extends RingElem<C>> GenPolynomial<C> imaginaryPartFromComplex(
      GenPolynomialRing<C> fac, GenPolynomial<Complex<C>> A) {
   ...
   */
  public static GenPolynomial<BigComplex> complexFromRational(
      GenPolynomialRing<BigComplex> fac, GenPolynomial<BigRational> A) {
  ...
  /**
   * From AlgebraicNumber coefficients. Represent as polynomial with type GenPolynomial&lt;C&gt;
  ...
  public static <C extends GcdRingElem<C>>
      GenPolynomial<GenPolynomial<C>> fromAlgebraicCoefficients(
   ...
   * coefficients, C is e.g. ModInteger or BigRational.
   *
   ...
   */
  public static <C extends GcdRingElem<C>>
      GenPolynomial<AlgebraicNumber<C>> convertToAlgebraicCoefficients(
  ...
  /**
   * Convert to recursive AlgebraicNumber coefficients. Represent as polynomial with recursive
   ...
   */
  public static <C extends GcdRingElem<C>>
      GenPolynomial<AlgebraicNumber<C>> convertToRecAlgebraicCoefficients(
   ...
   */
  public static <C extends GcdRingElem<C>>
      GenPolynomial<AlgebraicNumber<C>> convertRecursiveToAlgebraicCoefficients(
   ...
   *
   * @param fac GenPolynomial&lt;ModInteger&gt; result factory with A.coFac.modul*B.coFac.modul =
   *     C.coFac.modul.
   * @param A GenPolynomial&lt;ModInteger&gt;.
   * @param B other GenPolynomial&lt;ModInteger&gt;.
   * @param mi inverse of A.coFac.modul in ring B.coFac.
   * @return S = cra(A,B), with S mod A.coFac.modul == A and S mod B.coFac.modul == B.
   */
  ...
  /**
   * GenPolynomial monic, i.e. leadingBaseCoefficient == 1. If leadingBaseCoefficient is not
   * invertible returns this unmodified.
   *
   * @param <C> coefficient type.
  ...
  /**
   * GenSolvablePolynomial monic, i.e. leadingBaseCoefficient == 1. If leadingBaseCoefficient is not
   * invertible returns this unmodified.
   *
   * @param <C> coefficient type.
  ...
  public static <C extends RingElem<C>> List<GenPolynomial<C>> monic(List<GenPolynomial<C>> L) {
    return ListUtil.<GenPolynomial<C>, GenPolynomial<C>>map(
        L,
   ...
   */
  public static <C extends RingElem<C>> List<GenWordPolynomial<C>> wordMonic(
      List<GenWordPolynomial<C>> L) {
    return ListUtil.<GenWordPolynomial<C>, GenWordPolynomial<C>>map(
        L,
  ...
  public static <C extends RingElem<C>> List<GenPolynomial<GenPolynomial<C>>> monicRec(
    ...
    return ListUtil.<GenPolynomial<GenPolynomial<C>>, GenPolynomial<GenPolynomial<C>>>map(
        L,
  ...
  public static <C extends RingElem<C>> List<ExpVector> leadingExpVector(List<GenPolynomial<C>> L) {
    return ListUtil.<GenPolynomial<C>, ExpVector>map(
        L,
  ...
  /**
   * Extend coefficient variables. Extend all coefficient ExpVectors by i elements and multiply by
   * x_j^k.
   *
  ...
  /**
   * To recursive representation. Represent as polynomial in i+r variables with coefficients in i
   * variables. Works for arbitrary term orders.
   *
   * @param <C> coefficient type.
   * @param rfac recursive polynomial ring factory.
  ...
  /**
   * To recursive representation. Represent as solvable polynomial in i+r variables with
   * coefficients in i variables. Works for arbitrary term orders.
   *
   * @param <C> coefficient type.
   ...
   */
  public static <C extends RingElem<C>> GenPolynomial<C> baseRemainderPoly(
      GenPolynomial<C> P, C s) {
    if (s == null || s.isZERO()) {
   ...
   * @return remainder with ldcf(S)<sup>m'</sup> P = quotient * S + remainder. m' &le; deg(P)-deg(S)
   * @see edu.jas.poly.GenPolynomial#remainder(edu.jas.poly.GenPolynomial).
   * @deprecated Use {@link
   *     #baseSparsePseudoRemainder(edu.jas.poly.GenPolynomial,edu.jas.poly.GenPolynomial)} instead
   */
  @Deprecated
  public static <C extends RingElem<C>> GenPolynomial<C> basePseudoRemainder(
   ...
   * @param P GenPolynomial.
   * @param S nonzero GenPolynomial.
   * @return remainder with ldcf(S)<sup>m</sup> P = quotient * S + remainder. m == deg(P)-deg(S)
   * @see edu.jas.poly.GenPolynomial#remainder(edu.jas.poly.GenPolynomial).
   */
  public static <C extends RingElem<C>> GenPolynomial<C> baseDensePseudoRemainder(
      GenPolynomial<C> P, GenPolynomial<C> S) {
    if (S == null || S.isZERO()) {
      throw new ArithmeticException(P + " division by zero " + S);
    }
   ...
   * @param P GenPolynomial.
   * @param S nonzero GenPolynomial.
   * @return quotient with ldcf(S)<sup>m</sup> P = quotient * S + remainder. m == deg(P)-deg(S)
   * @see edu.jas.poly.GenPolynomial#remainder(edu.jas.poly.GenPolynomial).
   */
  public static <C extends RingElem<C>> GenPolynomial<C> baseDensePseudoQuotient(
      GenPolynomial<C> P, GenPolynomial<C> S) {
    if (S == null || S.isZERO()) {
      throw new ArithmeticException(P + " division by zero " + S);
    }
   ...
   * @param P GenPolynomial.
   * @param S nonzero GenPolynomial.
   * @return quotient with ldcf(S)<sup>m'</sup> P = quotient * S + remainder. m' &le; deg(P)-deg(S)
   * @see edu.jas.poly.GenPolynomial#divide(edu.jas.poly.GenPolynomial).
   */
  public static <C extends RingElem<C>> GenPolynomial<C> basePseudoDivide(
      GenPolynomial<C> P, GenPolynomial<C> S) {
    if (S == null || S.isZERO()) {
      throw new ArithmeticException(P.toString() + " division by zero " + S);
    }
  ...
  /**
   * GenPolynomial sparse pseudo quotient and remainder. For univariate polynomials or exact
   * division.
   *
   * @param <C> coefficient type.
   * @param P GenPolynomial.
   * @param S nonzero GenPolynomial.
   * @return [ quotient, remainder ] with ldcf(S)<sup>m'</sup> P = quotient * S + remainder. m' &le;
   *     deg(P)-deg(S)
   * @see edu.jas.poly.GenPolynomial#divide(edu.jas.poly.GenPolynomial).
   */
  ...
  public static <C extends RingElem<C>> boolean isBasePseudoQuotientRemainder(
      GenPolynomial<C> P, GenPolynomial<C> S, GenPolynomial<C> q, GenPolynomial<C> r) {
    GenPolynomial<C> rhs = q.multiply(S).sum(r);
  ...
  public static <C extends RingElem<C>>
      GenPolynomial<GenPolynomial<C>> recursiveSparsePseudoRemainder(
          GenPolynomial<GenPolynomial<C>> P, GenPolynomial<GenPolynomial<C>> S) {
    if (S == null || S.isZERO()) {
      throw new ArithmeticException(P + " division by zero " + S);
    }
   ...
   */
  public static <C extends RingElem<C>>
      GenPolynomial<GenPolynomial<C>> recursiveDensePseudoRemainder(
          GenPolynomial<GenPolynomial<C>> P, GenPolynomial<GenPolynomial<C>> S) {
    if (S == null || S.isZERO()) {
      throw new ArithmeticException(P + " division by zero " + S);
    }
   ...
   */
  public static <C extends RingElem<C>> GenPolynomial<C> baseDeriviative(
      GenPolynomial<C> P, int r) {
    if (P == null || P.isZERO()) {
      return P;
    }
    GenPolynomialRing<C> pfac = P.ring;
  ...
  /**
   * Factor coefficient bound. See SACIPOL.IPFCB: the product of all maxNorms of potential factors
   ...
   */
  public static <C extends RingElem<C>> GenPolynomial<C> evaluateMainRecursive(
      GenPolynomialRing<C> cfac, GenPolynomial<GenPolynomial<C>> A, C a) {
    if (A == null || A.isZERO()) {
      return cfac.getZERO();
    }
    if (A.ring.nvar != 1) {
  ...
  public static <C extends RingElem<C>> GenPolynomial<C> evaluateMain(
      GenPolynomialRing<C> cfac, GenPolynomial<C> A, C a) {
    if (A == null || A.isZERO()) {
      return cfac.getZERO();
    }
   ...
   */
  public static <C extends RingElem<C>> List<GenPolynomial<C>> evaluateMain(
      GenPolynomialRing<C> cfac, List<GenPolynomial<C>> L, C a) {
   ...
   * @return A( a ).
   */
  public static <C extends RingElem<C>> C evaluateMain(
      RingFactory<C> cfac, GenPolynomial<C> A, C a) {
    if (A == null || A.isZERO()) {
      return cfac.getZERO();
    }
    if (A.ring.nvar != 1) {
   ...
   */
  public static <C extends RingElem<C>> List<C> evaluateMain(
      RingFactory<C> cfac, List<GenPolynomial<C>> L, C a) {
   ...
   *
   * @param <C> coefficient type.
   * @param cfac coefficient polynomial ring in k variables C[x_1, ..., x_k] factory.
   * @param rfac coefficient polynomial ring C[x_1, ..., x_{k-1}] [x_k] factory, a recursive
   *     polynomial ring in 1 variable with coefficients in k-1 variables.
   * @param nfac polynomial ring in n-1 varaibles C[x_1, ..., x_{k-1}] [x_{k+1}, ..., x_n] factory,
   *     a recursive polynomial ring in n-k+1 variables with coefficients in k-1 variables.
   * @param dfac polynomial ring in n-1 variables. C[x_1, ..., x_{k-1}, x_{k+1}, ..., x_n] factory.
   * @param A polynomial to be evaluated.
   * @param a value to evaluate at.
   * @return A( x_1, ..., x_{k-1}, a, x_{k+1}, ..., x_n).
   */
  public static <C extends RingElem<C>> GenPolynomial<C> evaluate(
   ...
   * @return A( a, x_2, ..., x_n).
   */
  public static <C extends RingElem<C>> GenPolynomial<C> evaluateFirst(
      GenPolynomialRing<C> cfac, GenPolynomialRing<C> dfac, GenPolynomial<C> A, C a) {
    if (A == null || A.isZERO()) {
      return dfac.getZERO();
    }
    Map<ExpVector, GenPolynomial<C>> Ap = A.contract(cfac);
  ...
  /**
   * Evaluate at first (lowest) variable. Could also be called <code>evaluateFirst()</code>, but
   * type erasure of parameter <code>A</code> does not allow the same name.
   *
   * @param <C> coefficient type.
   * @param cfac coefficient polynomial ring in first variable C[x_1] factory.
   * @param dfac polynomial ring in n-1 variables. C[x_2, ..., x_n] factory.
   ...
   */
  public static <C extends RingElem<C>> C evaluateAll(
      RingFactory<C> cfac, GenPolynomial<C> A, List<C> a) {
    if (A == null || A.isZERO()) {
      return cfac.getZERO();
    }
   ...
   */
  public static <C extends RingElem<C>> GenPolynomial<C> substituteMain(
      GenPolynomial<C> A, GenPolynomial<C> s) {
   ...
   */
  public static <C extends RingElem<C>> GenPolynomial<C> substituteUnivariate(
      GenPolynomial<C> f, GenPolynomial<C> t) {
    if (f == null || t == null) {
      return null;
    }
   ...
   * @return polynomial f(x <- t).
   */
  public static <C extends RingElem<C>> GenPolynomial<C> substituteUnivariateMult(
      GenPolynomial<C> f, GenPolynomial<C> t) {
    if (f == null || t == null) {
      return null;
    }
   ...
   */
  public static <C extends RingElem<C>> GenPolynomial<C> interpolate(
      GenPolynomialRing<C> fac, GenPolynomial<C> A, GenPolynomial<C> M, C mi, C a, C am) {
    GenPolynomial<C> s;
   ...
   * @return Product represenation of A in the polynomial ring pfac.
   */
  public static GenPolynomial<Product<ModInteger>> toProduct(
      GenPolynomialRing<Product<ModInteger>> pfac, GenPolynomial<BigInteger> A) {
  ...
  public static List<GenPolynomial<Product<ModInteger>>> toProduct(
    ...
    List<GenPolynomial<Product<ModInteger>>> list =
        new ArrayList<GenPolynomial<Product<ModInteger>>>();
    if (L == null || L.size() == 0) {
      return list;
    }
  ...
  /**
   * Intersection. Intersection of a list of polynomials with a polynomial ring. The polynomial ring
   * must be a contraction of the polynomial ring of the list of polynomials and the TermOrder must
   * be an elimination order.
   *
   * @param R polynomial ring
   * @param F list of polynomials
   * @return R \cap F
   */
  public static <C extends RingElem<C>> List<GenPolynomial<C>> intersect(
      GenPolynomialRing<C> R, List<GenPolynomial<C>> F) {
    if (F == null || F.isEmpty()) {
      return F;
    }
  ...
  /**
   * Intersection. Intersection of a list of solvable polynomials with a solvable polynomial ring.
   * The solvable polynomial ring must be a contraction of the solvable polynomial ring of the list
   * of polynomials and the TermOrder must be an elimination order.
   *
  ...
  /**
   * Intersection. Intersection of a list of word polynomials with a word polynomial ring. The
   * polynomial ring must be a contraction of the polynomial ring of the list of polynomials,
   *
   * @param R word polynomial ring
   * @param F list of word polynomials
   * @return R \cap F
   */
  public static <C extends RingElem<C>> List<GenWordPolynomial<C>> intersect(
      GenWordPolynomialRing<C> R, List<GenWordPolynomial<C>> F) {
    if (F == null || F.isEmpty()) {
      return F;
    }
   ...
   * @return polynomial with removed variables
   */
  public static <C extends RingElem<C>> GenPolynomial<C> removeUnusedLowerVariables(
      GenPolynomial<C> p) {
    GenPolynomialRing<C> fac = p.ring;
    if (fac.nvar <= 1) { // univariate
      return p;
   ...
   */
  public static <C extends RingElem<C>> GenPolynomial<C> selectWithVariable(
      List<GenPolynomial<C>> P, int i) {
...
/** Evaluate main variable functor. */
class EvalMainPol<C extends RingElem<C>>
