...
/**
 * Ordered list of polynomials. Mainly for storage and printing / toString and conversions to other
 * representations. Polynomials in this list are sorted according to their head terms.
 *
 * @author Heinz Kredel
 */
public class OrderedPolynomialList<C extends RingElem<C>> extends PolynomialList<C> {
  ...
  public static <C extends RingElem<C>> List<GenPolynomial<C>> sort(
    ...
    Comparator<GenPolynomial<C>> cmp =
        new Comparator<GenPolynomial<C>>() {
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public static <C extends RingElem<C>> List<GenPolynomial<C>> sortDegree(
