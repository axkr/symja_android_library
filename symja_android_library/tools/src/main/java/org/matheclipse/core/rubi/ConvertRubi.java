...
public class ConvertRubi {
	...
	public static void addPredefinedSymbols() {
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("AbsurdNumberFactors", Context.RUBI_STR + "AbsurdNumberFactors");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("AbsurdNumberGCD", Context.RUBI_STR + "AbsurdNumberGCD");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("AbsurdNumberGCDList", Context.RUBI_STR + "AbsurdNumberGCDList");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("AlgebraicFunctionFactors",
				Context.RUBI_STR + "AlgebraicFunctionFactors");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("AlgebraicFunctionQ", Context.RUBI_STR + "AlgebraicFunctionQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("AlgebraicTrigFunctionQ", Context.RUBI_STR + "AlgebraicTrigFunctionQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("CancelCommonFactors", Context.RUBI_STR + "CancelCommonFactors");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("CannotIntegrate", Context.RUBI_STR + "CannotIntegrate");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("CollectReciprocals", Context.RUBI_STR + "CollectReciprocals");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("Coeff", Context.RUBI_STR + "Coeff");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("CombineExponents", Context.RUBI_STR + "CombineExponents");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("CommonFactors", Context.RUBI_STR + "CommonFactors");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("CommonNumericFactors", Context.RUBI_STR + "CommonNumericFactors");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("ContentFactorAux", Context.RUBI_STR + "ContentFactorAux");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("DeactivateTrigAux", Context.RUBI_STR + "DeactivateTrigAux");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("DerivativeDivides", Context.RUBI_STR + "DerivativeDivides");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("Distrib", Context.RUBI_STR + "Distrib");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("DistributeDegree", Context.RUBI_STR + "DistributeDegree");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("DivideDegreesOfFactors", Context.RUBI_STR + "DivideDegreesOfFactors");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("ExpandAlgebraicFunction", Context.RUBI_STR + "ExpandAlgebraicFunction");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("ExpandExpression", Context.RUBI_STR + "ExpandExpression");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("ExpandIntegrand", Context.RUBI_STR + "ExpandIntegrand");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("ExpandLinearProduct", Context.RUBI_STR + "ExpandLinearProduct");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("ExpandTrigExpand", Context.RUBI_STR + "ExpandTrigExpand");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("ExpandTrigReduce", Context.RUBI_STR + "ExpandTrigReduce");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("ExpandTrigReduceAux", Context.RUBI_STR + "ExpandTrigReduceAux");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FactorAbsurdNumber", Context.RUBI_STR + "FactorAbsurdNumber");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FactorNumericGcd", Context.RUBI_STR + "FactorNumericGcd");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FixInertTrigFunction", Context.RUBI_STR + "FixInertTrigFunction");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FractionOrNegativeQ", Context.RUBI_STR + "FractionOrNegativeQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FractionQ", Context.RUBI_STR + "FractionQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FractionalPowerFreeQ", Context.RUBI_STR + "FractionalPowerFreeQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FractionalPowerOfLinear", Context.RUBI_STR + "FractionalPowerOfLinear");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FractionalPowerOfSquareQ",
				Context.RUBI_STR + "FractionalPowerOfSquareQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FractionalPowerQ", Context.RUBI_STR + "FractionalPowerQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FractionalPowerSubexpressionQ",
				Context.RUBI_STR + "FractionalPowerSubexpressionQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfDensePolynomialsQ",
				Context.RUBI_STR + "FunctionOfDensePolynomialsQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfExpnQ", Context.RUBI_STR + "FunctionOfExpnQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfExponential", Context.RUBI_STR + "FunctionOfExponential");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfExponentialFunction",
				Context.RUBI_STR + "FunctionOfExponentialFunction");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfExponentialFunctionAux",
				Context.RUBI_STR + "FunctionOfExponentialFunctionAux");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfExponentialQ", Context.RUBI_STR + "FunctionOfExponentialQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfExponentialTest",
				Context.RUBI_STR + "FunctionOfExponentialTest");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfExponentialTestAux",
				Context.RUBI_STR + "FunctionOfExponentialTestAux");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfHyperbolic", Context.RUBI_STR + "FunctionOfHyperbolic");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfHyperbolicQ", Context.RUBI_STR + "FunctionOfHyperbolicQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfInverseLinear", Context.RUBI_STR + "FunctionOfInverseLinear");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfLinear", Context.RUBI_STR + "FunctionOfLinear");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfLinearSubst", Context.RUBI_STR + "FunctionOfLinearSubst");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfSquareRootOfQuadratic",
				Context.RUBI_STR + "FunctionOfSquareRootOfQuadratic");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfTanQ", Context.RUBI_STR + "FunctionOfTanQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfTanWeight", Context.RUBI_STR + "FunctionOfTanWeight");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfTanhQ", Context.RUBI_STR + "FunctionOfTanhQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfTanhWeight", Context.RUBI_STR + "FunctionOfTanhWeight");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfTrig", Context.RUBI_STR + "FunctionOfTrig");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("FunctionOfTrigOfLinearQ", Context.RUBI_STR + "FunctionOfTrigOfLinearQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("GeneralizedBinomialDegree",
				Context.RUBI_STR + "GeneralizedBinomialDegree");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("GeneralizedBinomialMatchQ",
				Context.RUBI_STR + "GeneralizedBinomialMatchQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("GeneralizedBinomialParts",
				Context.RUBI_STR + "GeneralizedBinomialParts");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("GeneralizedBinomialQ", Context.RUBI_STR + "GeneralizedBinomialQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("GeneralizedBinomialTest", Context.RUBI_STR + "GeneralizedBinomialTest");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("GeneralizedTrinomialDegree",
				Context.RUBI_STR + "GeneralizedTrinomialDegree");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("GeneralizedTrinomialMatchQ",
				Context.RUBI_STR + "GeneralizedTrinomialMatchQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("GeneralizedTrinomialParts",
				Context.RUBI_STR + "GeneralizedTrinomialParts");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("GeneralizedTrinomialQ", Context.RUBI_STR + "GeneralizedTrinomialQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("GeneralizedTrinomialTest",
				Context.RUBI_STR + "GeneralizedTrinomialTest");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("ImaginaryNumericQ", Context.RUBI_STR + "ImaginaryNumericQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("InertReciprocalQ", Context.RUBI_STR + "InertReciprocalQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("IntegerQuotientQ", Context.RUBI_STR + "IntegerQuotientQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("InverseFunctionFreeQ", Context.RUBI_STR + "InverseFunctionFreeQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("InverseFunctionOfLinear", Context.RUBI_STR + "InverseFunctionOfLinear");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("InverseFunctionQ", Context.RUBI_STR + "InverseFunctionQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("InverseHyperbolicQ", Context.RUBI_STR + "InverseHyperbolicQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("KnownCotangentIntegrandQ",
				Context.RUBI_STR + "KnownCotangentIntegrandQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("KnownSecantIntegrandQ", Context.RUBI_STR + "KnownSecantIntegrandQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("KnownSineIntegrandQ", Context.RUBI_STR + "KnownSineIntegrandQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("KnownTangentIntegrandQ", Context.RUBI_STR + "KnownTangentIntegrandQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("KnownTrigIntegrandQ", Context.RUBI_STR + "KnownTrigIntegrandQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("MergeableFactorQ", Context.RUBI_STR + "MergeableFactorQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("MinimumDegree", Context.RUBI_STR + "MinimumDegree");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("MinimumMonomialExponent", Context.RUBI_STR + "MinimumMonomialExponent");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("MonomialExponent", Context.RUBI_STR + "MonomialExponent");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("MostMainFactorPosition", Context.RUBI_STR + "MostMainFactorPosition");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NegQ", Context.RUBI_STR + "NegQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NegativeCoefficientQ", Context.RUBI_STR + "NegativeCoefficientQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NegativeIntegerQ", Context.RUBI_STR + "NegativeIntegerQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NonabsurdNumberFactors", Context.RUBI_STR + "NonabsurdNumberFactors");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NonalgebraicFunctionFactors",
				Context.RUBI_STR + "NonalgebraicFunctionFactors");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NonnumericFactors", Context.RUBI_STR + "NonnumericFactors");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NonpolynomialTerms", Context.RUBI_STR + "NonpolynomialTerms");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NonpositiveFactors", Context.RUBI_STR + "NonpositiveFactors");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NonrationalFunctionFactors",
				Context.RUBI_STR + "NonrationalFunctionFactors");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizeHyperbolic", Context.RUBI_STR + "NormalizeHyperbolic");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizeIntegrand", Context.RUBI_STR + "NormalizeIntegrand");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizeIntegrandAux", Context.RUBI_STR + "NormalizeIntegrandAux");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizeIntegrandFactor",
				Context.RUBI_STR + "NormalizeIntegrandFactor");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizeIntegrandFactorBase",
				Context.RUBI_STR + "NormalizeIntegrandFactorBase");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizeLeadTermSigns", Context.RUBI_STR + "NormalizeLeadTermSigns");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizePowerOfLinear", Context.RUBI_STR + "NormalizePowerOfLinear");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizePseudoBinomial", Context.RUBI_STR + "NormalizePseudoBinomial");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizeSumFactors", Context.RUBI_STR + "NormalizeSumFactors");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizeTogether", Context.RUBI_STR + "NormalizeTogether");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizeTrig", Context.RUBI_STR + "NormalizeTrig");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("NormalizeTrigReduce", Context.RUBI_STR + "NormalizeTrigReduce");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("OddHyperbolicPowerQ", Context.RUBI_STR + "OddHyperbolicPowerQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PerfectPowerTest", Context.RUBI_STR + "PerfectPowerTest");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PerfectSquareQ", Context.RUBI_STR + "PerfectSquareQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PiecewiseLinearQ", Context.RUBI_STR + "PiecewiseLinearQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PolynomialDivide", Context.RUBI_STR + "PolynomialDivide");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PolynomialInAuxQ", Context.RUBI_STR + "PolynomialInAuxQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PolynomialInQ", Context.RUBI_STR + "PolynomialInQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PolynomialInSubst", Context.RUBI_STR + "PolynomialInSubst");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PolynomialInSubstAux", Context.RUBI_STR + "PolynomialInSubstAux");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PositiveIntegerPowerQ", Context.RUBI_STR + "PositiveIntegerPowerQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PositiveIntegerQ", Context.RUBI_STR + "PositiveIntegerQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PowerOfInertTrigSumQ", Context.RUBI_STR + "PowerOfInertTrigSumQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PowerOfLinearMatchQ", Context.RUBI_STR + "PowerOfLinearMatchQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PowerVariableDegree", Context.RUBI_STR + "PowerVariableDegree");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PowerVariableExpn", Context.RUBI_STR + "PowerVariableExpn");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PowerVariableSubst", Context.RUBI_STR + "PowerVariableSubst");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("ProductOfLinearPowersQ", Context.RUBI_STR + "ProductOfLinearPowersQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PseudoBinomialPairQ", Context.RUBI_STR + "PseudoBinomialPairQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PseudoBinomialQ", Context.RUBI_STR + "PseudoBinomialQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PseudoBinomialParts", Context.RUBI_STR + "PseudoBinomialParts");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PureFunctionOfCosQ", Context.RUBI_STR + "PureFunctionOfCosQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PureFunctionOfCoshQ", Context.RUBI_STR + "PureFunctionOfCoshQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PureFunctionOfCotQ", Context.RUBI_STR + "PureFunctionOfCotQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PureFunctionOfCothQ", Context.RUBI_STR + "PureFunctionOfCothQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PureFunctionOfSinQ", Context.RUBI_STR + "PureFunctionOfSinQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PureFunctionOfSinhQ", Context.RUBI_STR + "PureFunctionOfSinhQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PureFunctionOfTanQ", Context.RUBI_STR + "PureFunctionOfTanQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("PureFunctionOfTanhQ", Context.RUBI_STR + "PureFunctionOfTanhQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("QuotientOfLinearsMatchQ", Context.RUBI_STR + "QuotientOfLinearsMatchQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("QuotientOfLinearsP", Context.RUBI_STR + "QuotientOfLinearsP");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("QuotientOfLinearsParts", Context.RUBI_STR + "QuotientOfLinearsParts");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("QuotientOfLinearsQ", Context.RUBI_STR + "QuotientOfLinearsQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("QuadraticProductQ", Context.RUBI_STR + "QuadraticProductQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("RationalFunctionExpand", Context.RUBI_STR + "RationalFunctionExpand");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("RationalFunctionExponents",
				Context.RUBI_STR + "RationalFunctionExponents");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("RationalFunctionFactors", Context.RUBI_STR + "RationalFunctionFactors");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("RationalFunctionQ", Context.RUBI_STR + "RationalFunctionQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("RectifyCotangent", Context.RUBI_STR + "RectifyCotangent");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("RemainingFactors", Context.RUBI_STR + "RemainingFactors");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("RemoveContentAux", Context.RUBI_STR + "RemoveContentAux");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SimplerIntegrandQ", Context.RUBI_STR + "SimplerIntegrandQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SimplifyAntiderivative", Context.RUBI_STR + "SimplifyAntiderivative");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SimplifyAntiderivativeSum",
				Context.RUBI_STR + "SimplifyAntiderivativeSum");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SimplifyIntegrand", Context.RUBI_STR + "SimplifyIntegrand");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SmartDenominator", Context.RUBI_STR + "SmartDenominator");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SplitFreeFactors", Context.RUBI_STR + "SplitFreeFactors");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SubstForFractionalPower", Context.RUBI_STR + "SubstForFractionalPower");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SubstForFractionalPowerAuxQ",
				Context.RUBI_STR + "SubstForFractionalPowerAuxQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SubstForFractionalPowerOfLinear",
				Context.RUBI_STR + "SubstForFractionalPowerOfLinear");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SubstForFractionalPowerQ",
				Context.RUBI_STR + "SubstForFractionalPowerQ");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SubstForHyperbolic", Context.RUBI_STR + "SubstForHyperbolic");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("SubstForInverseFunction", Context.RUBI_STR + "SubstForInverseFunction");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("TogetherSimplify", Context.RUBI_STR + "TogetherSimplify");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("TrigHyperbolicFreeQ", Context.RUBI_STR + "TrigHyperbolicFreeQ");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("TrigSimplifyRecur", Context.RUBI_STR + "TrigSimplifyRecur");
		...
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("TryPureTanhSubst", Context.RUBI_STR + "TryPureTanhSubst");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("TryTanhSubst", Context.RUBI_STR + "TryTanhSubst");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("UnifyInertTrigFunction", Context.RUBI_STR + "UnifyInertTrigFunction");
		F.PREDEFINED_INTERNAL_FORM_STRINGS.put("UnifyNegativeBaseFactors",
				Context.RUBI_STR + "UnifyNegativeBaseFactors");
