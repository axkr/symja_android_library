...
public final class MathUtils {
   ...
   * @throws MathException if the result can not be represented as an int
   * @since 1.1
   */
   ...
   * @throws MathException if the result can not be represented as an long
   * @since 1.2
   */
   ...
   * @throws MathException if the result is too large to be represented by a long integer.
   */
  ...
  /**
   * Returns the <a href="http://mathworld.wolfram.com/HyperbolicCosine.html">hyperbolic cosine</a>
   * of x.
   *
   ...
   * @throws MathException if the lcm is too large to store as an int
   * @since 1.1
   */
  ...
  /**
   * Returns the <a href="http://mathworld.wolfram.com/HyperbolicSine.html">hyperbolic sine</a> of
   * x.
   *
