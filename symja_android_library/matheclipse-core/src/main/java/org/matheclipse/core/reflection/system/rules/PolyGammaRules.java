...
public class PolyGammaRules {
  ...
  final public static IAST RULES = List(IInit(PolyGamma, SIZES),
      ...
      ISet(PolyGamma(C0, C1), Negate(EulerGamma), true),
      // PolyGamma(-1,1)=0
      ISet(PolyGamma(CN1, C1), C0, true),
      // PolyGamma(-1,0)=Infinity
      ISet(PolyGamma(CN1, C0), oo, true),
      // PolyGamma(1,1)=Pi^2/6
      ISet(PolyGamma(C1, C1), Times(QQ(1L, 6L), Sqr(Pi)), true),
      // PolyGamma(1,1/2)=Pi^2/2
      ISet(PolyGamma(C1, C1D2), Times(C1D2, Sqr(Pi)), true),
      // PolyGamma(3,1/2)=Pi^4
      ISet(PolyGamma(C3, C1D2), Power(Pi, C4), true),
