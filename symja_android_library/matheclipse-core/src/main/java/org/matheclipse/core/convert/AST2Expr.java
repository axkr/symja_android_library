...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "Flatten", "FlattenAt", "FlatTopWindow", "Fibonacci", "File", "FileFormat", "FileNameJoin",
      "FilePrint", "FileNameTake", "FileNames", "FilterRules", "FindClusters", "FindCycle",
      "FindEulerianCycle", "FindEdgeCover", "FindFit", "FindGraphCommunities",
      "FindGraphIsomorphism", "FindIndependentEdgeSet", "FindIndependentVertexSet",
      "FindHamiltonianCycle", "FindInstance", "FindLinearRecurrence", "FindMaximum", "FindMinimum",
      ...
      "FixedPoint", "FixedPointList", "Floor", "Fold", "FoldList", "For", "ForAll", "FormBox",
      "Fourier", "FourierMatrix", "FRatioDistribution", "FractionBox", "FractionalPart",
      ...
      "FromPolarCoordinates", "FullForm", "FullSimplify", "Function", "FunctionDomain",
      ...
      "HermitianMatrixQ", "HessenbergDecomposition", "HilbertMatrix", "Histogram", "HodgeDual",
      "Hold", "HoldForm", "HoldPattern", "Horner", "HornerForm", "Hue", "HurwitzLerchPhi",
      "HurwitzZeta", "HypercubeGraph", "Hyperfactorial", "HypergeometricDistribution",
      "HypergeometricPFQ", "HypergeometricU", "Hypergeometric0F1", "Hypergeometric1F1",
      "Hypergeometric1F1Regularized", "Hypergeometric2F1", "HypergeometricPFQRegularized",
      ...
      "ImageRotate", "ImageScaled", "ImageSize", "ImageType", "Implies", "Import", "ImportString",
      "In", "Increment", "IndexGraph", "Inequality", "InexactNumberQ", "Infix", "Information",
      ...
      "ListPlot3D", "ListPointPlot3D", "ListPolarPlot", "ListQ", "Literal", "LoadJavaClass", "Log",
      "Log2", "Log10", "LogGamma", "LogNormalDistribution", "LogPlot", "LogLinearPlot",
      "LogLogPlot", "LogicalExpand", "LogisticSigmoid", "LogIntegral", "Longest", "Lookup",
      ...
      "MantissaExponent", "Map", "MapAt", "MapAll", "MapIndexed", "MapThread",
      ...
      "Positive", "PossibleZeroQ", "Postfix", "Power", "PowerExpand", "PowerMod", "Precision",
      ...
      "RuleDelayed", "RussellRaoDissimilarity", "Surd", "SameObjectQ", "SameQ",
