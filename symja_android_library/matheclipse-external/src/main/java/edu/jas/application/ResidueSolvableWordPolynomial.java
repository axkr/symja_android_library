...
/**
 * ResidueSolvableWordPolynomial solvable polynomials with WordResidue coefficients implementing
 * RingElem. n-variate ordered solvable polynomials over non-commutative word residue coefficients.
...
public class ResidueSolvableWordPolynomial<C extends GcdRingElem<C>>
   ...
   */
  public ResidueSolvableWordPolynomial(
      ResidueSolvableWordPolynomialRing<C> r, GenSolvablePolynomial<WordResidue<C>> S) {
    this(r, S.getMap());
  }
   ...
   */
  protected ResidueSolvableWordPolynomial(
      ResidueSolvableWordPolynomialRing<C> r, SortedMap<ExpVector, WordResidue<C>> v) {
    this(r);
  ...
  /**
   * ResidueSolvableWordPolynomial left and right multiplication. Product with two polynomials.
   *
  ...
  /**
   * ResidueSolvableWordPolynomial multiplication. Product with ring element and exponent vector.
   *
   * @param b coefficient polynomial.
   * @param e exponent.
  ...
  /**
   * ResidueSolvableWordPolynomial multiplication. Left product with 'monomial'.
   *
   * @param m 'monomial'.
