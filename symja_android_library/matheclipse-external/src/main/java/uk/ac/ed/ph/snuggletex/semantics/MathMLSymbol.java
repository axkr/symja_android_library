...
public interface MathMLSymbol {
  ...
  public static final String HEARTSUIT =
      "\u2661"; /* (NB: This is not filled in, as per LaTeX. The MathML entity for heartsuit is mapped to U+2665) */
  public static final String DIAMONDSUIT =
      "\u2662"; /* (NB: This is not filled in, as per LaTeX. The MathML entity for diamondsuit is mapped to U+2666) */
