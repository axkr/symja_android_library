...
public class SVGGraphicsTestCase extends ExprEvaluatorTestCase {
  ...
  public void testPoint001() {
    ...
    // "<svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" viewBox=\"-1.666667 -1.666667
    // 353.333333 353.333333\" width=\"350px\" height=\"350px\">\n"
    // + "<circle cx=\"175.0\" cy=\"175.0\" r=\"2.16667\" \n"
    // + " style=\"stroke: none; stroke-width: 0.000000px; fill: rgb(0.0%, 0.0%, 100.0%);
    // fill-opacity: 1\" />\n"
    // + "\n"
    // + "</svg>");
  }
  ...
  public void testRectangle001() {
    ...
    // + " style=\"stroke: none; stroke-width: 0.000000px; fill: rgb(0.0%, 0.0%, 100.0%);
    // stroke-opacity: 1; stroke-width: 0.666667px; fill-opacity: 1\" />\n"
    // + "\n"
    // + "</svg>");
  }
  ...
  public void testRectangle002() {
    ...
    // + //
    // " style=\"stroke: none; stroke-width: 0.000000px; fill: rgb(100.0%, 0.0%, 0.0%);
    // stroke-opacity: 1; stroke-width: 0.666667px; fill-opacity: 1\" />\n"
    // + //
  ...
  public void testRectangle004() {
    ...
    // + " style=\"stroke: none; stroke-width: 0.000000px; fill: rgb(0.0%, 0.0%, 100.0%);
    // stroke-opacity: 1; stroke-width: 0.666667px; fill-opacity: 1\" />\n"
    // + "<polyline points=\"200.0,0.0 200.0,350.0\" style=\"stroke: rgb(0.000000%, 0.000000%,
    // 0.000000%); stroke-opacity: 1; stroke-width: 0.666667px; fill: none\"/>\n"
    // + "<polyline points=\"0.0,140.0 350.0,140.0\" style=\"stroke: rgb(0.000000%, 0.000000%,
    // 0.000000%); stroke-opacity: 1; stroke-width: 0.666667px; fill: none\"/>\n"
    // + "\n"
    // + "</svg>");
  }
