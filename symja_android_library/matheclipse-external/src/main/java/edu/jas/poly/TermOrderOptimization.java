...
public class TermOrderOptimization {
  ...
  public static <C extends RingElem<C>> List<GenPolynomial<BigInteger>> degreeMatrix(
    ...
    GenPolynomialRing<BigInteger> ufac =
        new GenPolynomialRing<BigInteger>(cfac, new String[] {"dm"});
   ...
   */
  public static List<GenPolynomial<BigInteger>> expVectorAdd(
      List<GenPolynomial<BigInteger>> dm, ExpVector e) {
   ...
   * @return P(A).
   */
  public static <C extends RingElem<C>> GenPolynomial<C> permutation(
      List<Integer> P, GenPolynomialRing<C> R, GenPolynomial<C> A) {
    if (A == null) {
      return A;
    }
   ...
   * @return P(L).
   */
  public static <C extends RingElem<C>> List<GenPolynomial<C>> permutation(
      List<Integer> P, GenPolynomialRing<C> R, List<GenPolynomial<C>> L) {
    if (L == null || L.size() == 0) {
      return L;
    }
   ...
   * @return P(L).
   */
  public static <C extends RingElem<C>> List<GenSolvablePolynomial<C>> permutation(
      List<Integer> P, GenSolvablePolynomialRing<C> R, List<GenSolvablePolynomial<C>> L) {
    if (L == null || L.size() == 0) {
      return L;
    }
   ...
   * @return P(R).
   */
  public static <C extends RingElem<C>> GenPolynomialRing<C> permutation(
      List<Integer> P, GenPolynomialRing<C> R) {
  ...
  public static <C extends RingElem<C>>
    ...
    if (ring instanceof GenSolvablePolynomialRing) { // look also on solvable relations
      GenSolvablePolynomialRing<GenPolynomial<C>> Rs =
          (GenSolvablePolynomialRing<GenPolynomial<C>>) ring;
      Lp.addAll(Rs.table.relationList());
    }
    ...
    if (ring instanceof GenSolvablePolynomialRing) { // permute also solvable relations
      ...
      List<GenPolynomial<GenPolynomial<C>>> ir =
          PolynomialList.<GenPolynomial<C>>castToList(sring.table.relationList());
  ...
  @SuppressWarnings("cast")
  public static <C extends RingElem<C>>
      OptimizedModuleList<GenPolynomial<C>> optimizeTermOrderOnCoefficients(
    ...
    OptimizedModuleList<GenPolynomial<C>> op =
        new OptimizedModuleList<GenPolynomial<C>>(perm, pring, mpolys);
    return op;
  }
}
