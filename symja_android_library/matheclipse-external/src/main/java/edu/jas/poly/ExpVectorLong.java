...
/*implements AbelianGroupElem<ExpVectorLong>*/ {
   ...
   * @param alloc true if internal representation array is newly allocated, else false.
   */
  ...
  /**
   * Constructor for ExpVector. Converts a String representation to an ExpVector. Accepted format =
   * (1,2,3,4,5,6,7).
   *
  ...
  /**
   * parser for ExpVector. Converts a String representation to an ExpVector. Accepted format =
   * (1,2,3,4,5,6,7).
   *
   * @param s String representation.
