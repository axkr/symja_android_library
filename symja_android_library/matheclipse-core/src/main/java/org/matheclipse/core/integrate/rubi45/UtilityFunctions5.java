...
ISetDelayed(SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times($p("A",true),Log(Plus(a_,Times(b_DEFAULT,Power(Tan(u_),n_DEFAULT))))),Times($p("B",true),Log(Cos(u_)))),x_Symbol),
    Condition(Plus(SimplifyAntiderivativeSum(v,x),Times($s("A"),Log(RemoveContent(Plus(Times(a,Power(Cos(u),n)),Times(b,Power(Sin(u),n))),x)))),And(And(FreeQ(List(a,b,$s("A"),$s("B")),x),IntegerQ(n)),ZeroQ(Plus(Times(n,$s("A")),Negate($s("B"))))))),
ISetDelayed(SimplifyAntiderivativeSum(Plus(v_DEFAULT,Times($p("A",true),Log(Plus(a_,Times(b_DEFAULT,Power(Cot(u_),n_DEFAULT))))),Times($p("B",true),Log(Sin(u_)))),x_Symbol),
    Condition(Plus(SimplifyAntiderivativeSum(v,x),Times($s("A"),Log(RemoveContent(Plus(Times(a,Power(Sin(u),n)),Times(b,Power(Cos(u),n))),x)))),And(And(FreeQ(List(a,b,$s("A"),$s("B")),x),IntegerQ(n)),ZeroQ(Plus(Times(n,$s("A")),Negate($s("B"))))))),
