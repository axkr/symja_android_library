...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "BioSequenceQ", "BioSequenceTranscribe", "BioSequenceTranslate", "BipartiteGraphQ",
      "BitLength", "BlackmanHarrisWindow", "BlackmanNuttallWindow", "BlackmanWindow", "Blank",
      "BlankSequence", "BlankNullSequence", "Block", "Boole", "BooleanQ", "BooleanConvert",
      "BooleanFunction", "BooleanMaxterms", "BooleanMinimize", "BooleanMinterms", "BooleanTable",
      "BooleanVariables", "BoxWhiskerChart", "BrayCurtisDistance", "Break", "BrownianBridgeProcess",
      "BSplineFunction", "Button", "ByteArray", "ByteArrayToString", "ByteArrayQ", "ByteCount",
      "CanberraDistance", "Cancel", "CancelButton", "CarmichaelLambda", "CarlsonRC", "CarlsonRD",
      "CarlsonRF", "CarlsonRG", "CarlsonRJ", "CartesianProduct", "Cases", "CatalanNumber", "Catch",
      "Catenate", "CauchyDistribution", "CDF", "Ceiling", "CenterDot", "CentralMoment", "CForm",
      ...
      "ContinuedFraction", "ContourPlot", "Convergents", "ConvexHullMesh", "CoordinateBoundingBox",
      "CoordinateBounds", "CoplanarPoints", "CoprimeQ", "Correlation", "CorrelationDistance", "Cos",
      "Cosh", "CosineDistance", "CosIntegral", "CoshIntegral", "Cot", "Coth", "Count",
      ...
      "DirectionalLight", "DirichletBeta", "DirichletEta", "DiscreteDelta", "DiscretePlot",
      ...
      "DuplicateFreeQ", "Dynamic", "DSolve", "Dt", "EasterSunday", "Echo", "EchoFunction",
      "EdgeCount", "EdgeForm", "EdgeList", "EdgeRules", "EdgeQ", "EdgeWeight", "EditDistance",
      ...
      "FourierDCT", "FourierDCTMatrix", "FourierDST", "FourierDSTMatrix", "FRatioDistribution",
      "FractionBox", "FractionalPart", "FrechetDistribution", "FreeQ", "FresnelC", "FresnelS",
      ...
      "FromSphericalCoordinates", "FullForm", "FullSimplify", "Function", "FunctionDomain",
      ...
      "Greater", "GreaterEqual", "GreaterEqualThan", "GreaterThan", "GridGraph", "GroebnerBasis",
      "GroupBy", "Gudermannian", "GumbelDistribution", "HamiltonianGraphQ", "HammingDistance",
      "HammingWindow", "HankelH1", "HankelH2", "HannWindow", "Haversine", "HarmonicMean",
      "HarmonicNumber", "Head", "HeavisideTheta", "HermiteH", "HermitianMatrixQ",
      "HessenbergDecomposition", "HessianMatrix", "HilbertMatrix", "Histogram", "HodgeDual", "Hold",
      "HoldForm", "HoldPattern", "Horner", "HornerForm", "Hue", "HurwitzLerchPhi", "HurwitzZeta",
      "HypercubeGraph", "Hyperfactorial", "HypergeometricDistribution", "HypergeometricPFQ",
      "HypergeometricU", "Hypergeometric0F1", "Hypergeometric0F1Regularized", "Hypergeometric1F1",
      ...
      "JacobiDN", "JacobiNC", "JacobiND", "JacobiP", "JacobiSC", "JacobiSD", "JacobiSN",
      ...
      "LevelQ", "LeviCivitaTensor", "Limit", "Line", "LinearModelFit", "LinearOptimization",
      ...
      "ListDensityPlot", "ListLinePlot", "ListLinePlot3D", "ListLogLogPlot", "ListLogPlot",
      "ListLogLinearPlot", "ListPlot", "ListStreamPlot", "ListVectorPlot", "ListPlot3D",
      "ListPointPlot3D", "ListPolarPlot", "ListQ", "Literal", "LoadJavaClass", "Log", "Log2",
      "Log10", "LogGamma", "LogNormalDistribution", "LogPlot", "LogLinearPlot", "LogLogPlot",
      ...
      "Multinomial", "MultiplicativeOrder", "MultiplySides", "NakagamiDistribution", "NameQ",
      "Names", "Nand", "ND", "NDSolve", "Nearest", "NearestTo", "Needs", "Negative", "Nest",
      "NestList", "NestWhile", "NestWhileList", "NewLimit", "NextPrime", "NFourierTransform",
      "NIntegrate", "NMaximize", "NMinimize", "NonCommutativeMultiply", "NonNegative",
      "NonPositive", "NoneTrue", "Nor", "Normal", "Normalize", "Norm", "NormalDistribution",
      "NormalMatrixQ", "Not", "NotElement", "NotListQ", "NRoots", "NSolve", "NullSpace",
      ...
      "OptionValue", "Or", "Order", "Ordering", "OrderedQ", "Orthogonalize", "OrthogonalMatrixQ",
      ...
      "PartitionsQ", "ParzenWindow", "PathGraph", "PathGraphQ", "PatternOrder", "PauliMatrix",
      "Pause", "PearsonChiSquareTest", "PerfectNumber", "PerfectNumberQ", "Pattern", "PatternTest",
      "PDF", "PearsonCorrelationTest", "Perimeter", "PermutationCycles", "PermutationCyclesQ",
      ...
      "PrimePi", "PrimePowerQ", "PrimeQ", "PrimitiveRoot", "PrimitiveRootList",
      ...
      "SinIntegral", "SinhIntegral", "SixJSymbol", "Skewness", "SokalSneathDissimilarity", "Solve",
      "Sort", "SortBy", "Sow", "Span", "SparseArray", "SparseArrayQ", "Specularity", "Sphere",
      "SphericalBesselJ", "SphericalBesselY", "SphericalHankelH1", "SphericalHankelH2",
      "SphericalHarmonicY", "Splice", "Split", "SplitBy", "SpotLight", "Sqrt", "SqrtBox",
      ...
      "StieltjesGamma", "StirlingS1", "StirlingS2", "StreamPlot", "StringCases", "StringCount",
      "StringContainsQ", "StringDrop", "StringExpression", "StringForm", "StringFormat",
      ...
      "Subsuperscript", "SubsuperscriptBox", "Subsets", "SubsetCases", "SubsetCount",
      "SubsetPosition", "SubsetQ", "SubsetReplace", "Subtract", "SubtractFrom", "SubtractSides",
      "Sum", "Superscript", "SuperscriptBox", "Surd", "SurfaceArea", "SurfaceGraphics",
      ...
      "Thickness", "Thread", "ThreeJSymbol", "Through", "Throw", "TimeConstrained", "TimeRemaining",
      "Times", "TimesBy", "TimeObject", "TimeValue", "Timing", "ToBoxes", "ToCharacterCode",
      "ToExpression", "ToeplitzMatrix", "Together", "ToPolarCoordinates", "ToRadicals",
      "ToSphericalCoordinates", "ToString", "Total", "ToIntervalData", "ToLowerCase", "ToUnicode",
