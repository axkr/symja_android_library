...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "Abs", "AddTo", "And", "AlgebraicNumber", "Alternatives", "Apart",
			...
			"DivideBy", "Divisible", "Divisors", "Do", "Dot", "Drop", "DSolve", "EasterSunday", "Eigenvalues",
			...
			"Riffle", "RogersTanimotoDissimilarity", "RootIntervals", "RootOf", "Roots", "RussellRaoDissimilarity",
			...
			"SinhIntegral", "Skewness", "SokalSneathDissimilarity", "Solve", "Sort", "Sow", "Span", "Sqrt",
			...
			"While", "Xor", "YuleDissimilarity", "Zeta" };
