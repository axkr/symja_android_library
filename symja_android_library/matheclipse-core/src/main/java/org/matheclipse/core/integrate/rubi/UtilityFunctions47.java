 ...
 *  
 */
class UtilityFunctions47 { 
  public static IAST RULES = List( 
ISetDelayed(686,Rt(u_,$p(n, Integer)),
    RtAux(TogetherSimplify(u),n)),
ISetDelayed(687,NthRoot(u_,n_),
    Power(u,Power(n,CN1))),
ISetDelayed(688,TrigSquare(u_),
