...
public interface ArcSinRules {
  final public static IAST RULES = List(
    ISet(ArcSin(C0),
      C0),
    ISet(ArcSin(Times(C1D2,Plus(CN1,Sqrt(C3)),Power(C2,CN1D2))),
      Times(QQ(1L,12L),Pi)),
    ISet(ArcSin(Times(C1D4,Plus(CN1,Sqrt(C5)))),
      Times(QQ(1L,10L),Pi)),
    ISet(ArcSin(Times(C1D2,Sqrt(Plus(C2,Times(CN1,Sqrt(C2)))))),
      Times(QQ(1L,8L),Pi)),
    ISet(ArcSin(C1D2),
      Times(QQ(1L,6L),Pi)),
    ISet(ArcSin(Times(C1D2,Sqrt(C1D2),Sqrt(Plus(C5,Times(CN1,Sqrt(C5)))))),
      Times(QQ(1L,5L),Pi)),
    ...
    ISet(ArcSin(Times(C1D2,Sqrt(Plus(C2,Sqrt(C2))))),
      Times(QQ(3L,8L),Pi)),
    ISet(ArcSin(Times(C1D2,Sqrt(C1D2),Sqrt(Plus(C5,Sqrt(C5))))),
      Times(QQ(2L,5L),Pi)),
    ISet(ArcSin(Times(C1D2,Plus(C1,Sqrt(C3)),Power(C2,CN1D2))),
      Times(QQ(5L,12L),Pi)),
    ISet(ArcSin(C1),
      Times(C1D2,Pi)),
    ISet(ArcSin(CI),
