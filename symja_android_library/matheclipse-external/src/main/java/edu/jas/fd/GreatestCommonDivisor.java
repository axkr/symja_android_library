...
public interface GreatestCommonDivisor<C extends GcdRingElem<C>> extends Serializable {
   ...
   * @return B with leftGcd(b,c) = 1 for all b != c in B and for all non-constant a in A there
   *     exists b in B with b|a. B does not contain zero or constant polynomials.
   */
