...
public class AST2Expr {
	...
	public final static String[] FUNCTION_STRINGS = { "DirectedInfinity", "Abs", "AddTo", "And", "Apart", "AppellF1", "Append",
			...
			"CharacteristicPolynomial", "ChebyshevT", "ChessboardDistance", "Chop", "Clear", "ClearAll", "Coefficient",
			...
			"CoprimeQ", "Cos", "Cosh", "CosIntegral", "CoshIntegral", "Cot", "Coth", "Count", "Cross", "Csc", "Csch", "Curl", "D",
			"Decrement", "Default", "Defer", "Definition", "Delete", "DeleteCases", "Denominator", "Depth", "Derivative", "Det",
			...
			"LinearProgramming", "LinearSolve", "List", "ListQ", "Log", "LogGamma", "LogIntegral", "LowerCaseQ", "LUDecomposition",
			...
			"NumericQ", "OddQ", "Options", "Or", "Order", "OrderedQ", "Out", "Outer", "Package", "PadLeft", "PadRight",
			...
			"ProductLog", "Quiet", "Quotient", "RandomInteger", "RandomReal", "Range", "Rational", "Rationalize", "Re", "Reap",
			"ReplaceAll", "ReplacePart", "ReplaceRepeated", "Rest", "Resultant", "Return", "Reverse", "Riffle", "RootIntervals",
			"RootOf", "Roots", "RotateLeft", "RotateRight", "Round", "RowReduce", "Rule", "RuleDelayed", "SameQ", "Scan", "Sec",
			...
			"Subsets", "SubtractFrom", "Sum", "Switch", "SyntaxLength", "SyntaxQ", "Table", "Take", "Tan", "Tanh", "Taylor",
