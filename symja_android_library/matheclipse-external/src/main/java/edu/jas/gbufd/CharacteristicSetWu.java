...
/**
 * Characteristic Set class acccording to Wu. Implements methods for Characteristic Sets and tests.
 *
...
public class CharacteristicSetWu<C extends GcdRingElem<C>> implements CharacteristicSet<C> {
  ...
  /**
   * Characteristic set. According to Wu's algorithm with rereduction of leading coefficients.
   *
  ...
  /**
   * Characteristic set reduction. Pseudo remainder wrt. the main variable with further pseudo
   * reduction of the leading coefficient.
   *
