...
public class ChocoConvert {
  ...
  // }
  // }
  // throw new ArgumentTypeException(expr.toString() + " is no int variable found for Solve(...,
  // Integers)");
  // }
  //
  ...
  // * all variables which are defined by the user. May contain additional variables which aren't
  // available
  // * in <code>equationVariables</code>
  // * @param engine
  // * @return a list of rules with the integer solutions
  // */
  // public IAST integerSolve(final IAST list, final IAST equationVariables, final IAST
  ...
  // F.ConditionalExpression(F.ZZ(solution.getIntVal(entry.getValue())),
  // listOfZZVariables)));
  // } else {
