...
ISetDelayed(Int(Times(ArcTanh(Plus(c_DEFAULT,Times(d_DEFAULT,Tanh(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))))),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(ArcCoth(Plus(c_DEFAULT,Times(d_DEFAULT,Tanh(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))))),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(ArcTanh(Plus(c_DEFAULT,Times(d_DEFAULT,Coth(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))))),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(ArcCoth(Plus(c_DEFAULT,Times(d_DEFAULT,Coth(Plus(a_DEFAULT,Times(b_DEFAULT,x_)))))),Power(x_,m_DEFAULT)),x_Symbol),
