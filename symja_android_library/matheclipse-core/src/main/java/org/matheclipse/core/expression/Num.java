...
public class Num implements INum {
  ...
  private static final double[] HARMONIC_NUMBERS =
      new double[] {1., 1.5, 1.83333333333333333333333333333333333333,
          2.08333333333333333333333333333333333333, 2.28333333333333333333333333333333333333, 2.45,
          2.59285714285714285714285714285714285714, 2.71785714285714285714285714285714285714,
          2.82896825396825396825396825396825396825, 2.92896825396825396825396825396825396825,
          3.01987734487734487734487734487734487734, 3.10321067821067821067821067821067821068,
          3.18013375513375513375513375513375513375, 3.25156232656232656232656232656232656233,
          3.31822899322899322899322899322899322899, 3.38072899322899322899322899322899322899,
          3.43955252264075793487558193440546381723, 3.49510807819631349043113748996101937278,
          3.54773965714368191148376906890838779384, 3.59773965714368191148376906890838779384,
  ...
  public IExpr harmonicNumber() {
    if (value >= 1.0 && value <= 24.0) {
      int intValue = toIntDefault();
      if (intValue > 0 && intValue <= 24) {
        return F.num(HARMONIC_NUMBERS[intValue - 1]);
      }
    }
