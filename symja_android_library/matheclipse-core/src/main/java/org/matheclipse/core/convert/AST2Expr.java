...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "Atom", "AtomList", "AtomQ", "Attributes", "Ball", "Band", "BarChart", "BarLegend", "BarnesG",
      "BartlettWindow", "BaseDecode", "BaseEncode", "BaseForm", "Beep", "Begin", "BeginPackage",
      ...
      "BinomialProcess", "BinormalDistribution", "BioSequence", "BioSequenceQ",
      ...
      "RandomReal", "RandomSample", "RandomVariate", "Range", "RangeSpace", "RankedMax",
