 ...
 * @author Heinz Kredel
 */
public class DReductionSeq<C extends RingElem<C>> extends ReductionAbstract<C>
   ...
   */
  public GenPolynomial<C> GPolynomial(
      List<GenPolynomial<C>> S, int i, GenPolynomial<C> Ap, int j, GenPolynomial<C> Bp) {
    throw new UnsupportedOperationException("not yet implemented");
  }

  /**
   * GB criterium 4. Use only for commutative polynomial rings. This version works also for
   * d-Groebner bases.
   *
   * @param A polynomial.
   * @param B polynomial.
