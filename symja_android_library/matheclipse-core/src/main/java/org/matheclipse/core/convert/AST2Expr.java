...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"Abort", "Abs", "AbsArg", "AbsoluteCorrelation",
      ...
      "ContourPlot", "Convergents", "ConvexHullMesh", "CoordinateBoundingBox", "CoplanarPoints",
      ...
      "SatisfiabilityInstances", "SatisfiableQ", "Scale", "Scaled", "Scan", "Sec", "Sech",
      ...
      "Short", "Shortest", "Show", "Sign", "Signature", "SignCmp", "Simplex", "Simplify", "Sin",
      "Sinc", "SingularValueDecomposition", "SingularValueList", "Sinh", "SinIntegral",
      "SinhIntegral", "Skewness", "SokalSneathDissimilarity", "Solve", "Sort", "SortBy", "Sow",
