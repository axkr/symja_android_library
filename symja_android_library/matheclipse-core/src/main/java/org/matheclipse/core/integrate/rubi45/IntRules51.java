...
ISetDelayed(Int(Power(Plus(Times(Sqr($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT))),b_DEFAULT),a_),p_),x_Symbol),
...
ISetDelayed(Int(Power(Plus(Times(Sqr($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT))),b_DEFAULT),a_),p_),x_Symbol),
...
ISetDelayed(Int(Power(Plus(Times(Power($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pn_),b_DEFAULT),a_),p_),x_Symbol),
...
ISetDelayed(Int(Power(Plus(Times(Power($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pn_),b_DEFAULT),a_),p_),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Sqr($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT))),b_DEFAULT),a_),p_),u_),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Sqr($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT))),b_DEFAULT),a_),p_),u_),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pn_),b_DEFAULT),a_),p_),Power($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pn_),b_DEFAULT),a_),p_),Power($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_)),x_Symbol),
    Condition(Module(List(Set(f,FreeFactors(Tan(Plus(c,Times(pd,x))),x))),Times(f,Power(pd,CN1),Subst(Int(Times(Power(ExpandToSum(Plus(b,Times(a,Power(Plus(C1,Times(Sqr(f),Sqr(x))),Times(C1D2,pn)))),x),p),Power(Power(Plus(C1,Times(Sqr(f),Sqr(x))),Plus(Times(C1D2,m),Times(pn,C1D2,p),C1)),CN1)),x),x,Times(Tan(Plus(c,Times(pd,x))),Power(f,CN1))))),And(And(And(FreeQ(List(a,b,c,pd),x),EvenQ(pn)),EvenQ(m)),IntegerQ(p)))),
ISetDelayed(Int(Times(Power(Plus(Times(Power($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pn_),b_DEFAULT),a_),p_),Power($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pn_),b_DEFAULT),a_),p_),Power($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pn_),b_DEFAULT),a_),p_),Power($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pn_),b_DEFAULT),a_),p_),Power($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power(Times($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pe_DEFAULT),pn_),b_DEFAULT),a_),p_DEFAULT),Power($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power(Times($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pe_DEFAULT),pn_),b_DEFAULT),a_),p_DEFAULT),Power($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power(Times($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pe_DEFAULT),pn_),b_DEFAULT),a_),p_DEFAULT),Power($($s("§tan"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power(Times($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pe_DEFAULT),pn_),b_DEFAULT),a_),p_DEFAULT),Power($($s("§cot"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power($($s("§sin"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pn_),b_DEFAULT),a_),p_DEFAULT),Power($($s("§tan"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Plus(Times(Power($($s("§cos"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),pn_),b_DEFAULT),a_),p_DEFAULT),Power($($s("§cot"),Plus(Times(x_,pd_DEFAULT),c_DEFAULT)),m_)),x_Symbol),
