...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"AbsolutePointSize", "AbsoluteThickness",
      "AccuracyGoal", "All", "AllowedHeads", "AllowShortContext", "Algebraics", "AspectRatio",
      "Automatic", "Axis", "Axes", "AxesLabel", "AxesOrigin", "AxesStyle", "Background",
      "BarOrigin", "BetweennessCentrality", "Black", "Blue", "Booleans", "Bottom", "Boxed",
      "BoxRatios", "Brown", "Byte", "Center", "Character", "CharacterEncoding", "ColorFunction",
      "ComplexInfinity", "Catalan", "CoefficientDomain", "Complexes", "ComplexityFunction",
      "Constant", "Cyan", "Dashed", "DataRange", "DefaultValue", "Degree", "DegreeLexicographic",
      ...
      "Red", "Reals", "Right", "SameTest", "ScalingFunctions", "Second", "SequenceHold",
      "SetSystemOptions", "Small", "SystemOptions", "SlotAbsent", "StaticsVisible", "StartOfLine",
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "Counts", "Covariance", "CreateDirectory", "CreateFile", "CreateUUID", "Cross", "Csc", "Csch",
      "Cube", "CubeRoot", "Cuboid", "Cumulant", "Curl", "CycleGraph", "Cycles", "Cyclotomic",
      "Cylinder", "Dashing", "Dataset", "DateObject", "DateString", "DateValue", "Decrement",
      ...
      "DiscreteDelta", "DiscretePlot", "DiscreteRatio", "DiscreteShift",
      ...
      "Extract", "Factor", "Factorial", "Factorial2", "FactorialMoment", "FactorialPower",
      ...
      "Indexed", "IndexGraph", "Inequality", "InexactNumberQ", "Infix", "Information", "Inner",
      "Input", "InputField", "InputForm", "InputStream", "InputString", "Insert", "InstallJava",
      ...
      "JavaShow", "Join", "JordanDecomposition", "JSForm", "JSFormData", "KelvinBei", "KelvinBer",
      "Key", "KeyDrop", "KeyExistsQ", "Keys", "KeySelect", "KeySort", "KeyTake", "KeyValuePattern",
      ...
      "LaguerreL", "LambertW", "LaplaceTransform", "Laplacian", "Last", "LCM", "LeafCount",
      ...
      "ModularInverse", "Module", "MoebiusMu", "Moment", "MonomialList", "Most", "MrvLimit",
      ...
      "Negative", "Nest", "NestList", "NestWhile", "NestWhileList", "NewLimit", "NExpectation",
      ...
      "Norm", "Normal", "NormalDistribution", "Normalize", "NormalMatrixQ", "Not", "NotElement",
      ...
      "RGBColor", "RiccatiSolve", "Riffle", "RightArrow", "RightArrowBar", "RightArrowLeftArrow",
      ...
      "Style", "StyleForm", "Subdivide", "Subfactorial", "Subscript", "SubscriptBox", "Subset",
      ...
      "Surd", "SurfaceArea", "SurfaceGraphics", "SurvivalFunction", "Switch", "SymbolName",
      ...
      "VectorQ", "Vee", "Verbatim", "VerificationTest", "VertexCount", "VertexEccentricity",
      "VertexList", "VertexQ", "VerticalBar", "VerticalSeparator", "VerticalTilde", "Volume",
      ...
      "YuleDissimilarity", "ZernikeR", "ZeroSymmetric", "Zeta", "ZTransform"};
