...
public class AST2Expr {
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "HarmonicNumber", "Hash", "Haversine", "Head", "HeavisideLambda", "HeavisidePi",
      ...
      "HypergeometricU", "Icosahedron", "Identity", "IdentityMatrix", "If", "Im", "Image",
      "ImageChannels", "ImageColorSpace", "ImageCrop", "ImageData", "ImageDimensions", "ImageQ",
      "ImageResize", "ImageRotate", "ImageScaled", "ImageSize", "ImageType", "ImplicitD", "Implies",
      "Import", "ImportString", "In", "Increment", "Indexed", "IndexGraph", "Inequality",
      ...
      "JavaObjectQ", "JavaShow", "Join", "JSForm", "JSFormData", "KelvinBei", "KelvinBer", "Key",
      "KeyDrop", "KeyExistsQ", "Keys", "KeySelect", "KeySort", "KeyTake", "KeyValuePattern",
