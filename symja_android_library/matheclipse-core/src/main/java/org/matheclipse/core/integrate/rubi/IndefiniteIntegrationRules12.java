...
SetDelayed(Int(Times(Times(Power(x_,$p(m,true)),u_),Power(Plus(a_,Times($p(b,true),Power(x_,C2))),n_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcCot(u_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(v_,ArcCot(u_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(ArcCot(Times($p(b,true),x_)),Power(Plus(c_,Times($p(d,true),Power(x_,$p(n,true)))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(ArcCot(Plus(a_,Times($p(b,true),x_))),Power(Plus(c_,Times($p(d,true),Power(x_,$p(n,true)))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(ArcSec(Plus($p(a,true),Times($p(b,true),x_))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(ArcSec(Times($p(a,true),Power(x_,$p(n,true)))),Power(x_,CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcSec(Plus(a_,Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcSec(Times($p(a,true),x_))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcSec(Plus($p(a,true),Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(ArcSec(Times($p(c,true),Power(Plus($p(a,true),Times($p(b,true),Power(x_,$p(n,true)))),CN1))),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(ArcCsc(Plus($p(a,true),Times($p(b,true),x_))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(ArcCsc(Times($p(a,true),Power(x_,$p(n,true)))),Power(x_,CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcCsc(Plus(a_,Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcCsc(Times($p(a,true),x_))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcCsc(Plus($p(a,true),Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(ArcCsc(Times($p(c,true),Power(Plus($p(a,true),Times($p(b,true),Power(x_,$p(n,true)))),CN1))),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(ArcSinh(Plus($p(a,true),Times($p(b,true),x_))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(C1,Power(ArcSinh(Plus($p(a,true),Times($p(b,true),x_))),CN1)),$p(x,SymbolHead)),
    Condition(Times(CoshIntegral(ArcSinh(Plus(a,Times(b,x)))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Times(C1,Power(Power(ArcSinh(Plus($p(a,true),Times($p(b,true),x_))),C2),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(C1,Power(Sqrt(ArcSinh(Plus($p(a,true),Times($p(b,true),x_)))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Sqrt(ArcSinh(Plus($p(a,true),Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Power(ArcSinh(Plus($p(a,true),Times($p(b,true),x_))),n_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(ArcSinh(Times($p(a,true),Power(x_,$p(n,true)))),Power(x_,CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcSinh(Plus($p(a,true),Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(C1,Power(Sqrt(Plus(a_,Times($p(b,true),ArcSinh(Plus($p(c,true),Times($p(d,true),x_)))))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(C1,Power(x_,C2)),$p(m,true)),Power(ArcSinh(x_),$p(n,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(x_,Times(Power(ArcSinh(Plus($p(a,true),Times($p(b,true),x_))),n_),Power(Sqrt(u_),CN1))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(ArcSinh(Times($p(c,true),Power(Plus($p(a,true),Times($p(b,true),Power(x_,$p(n,true)))),CN1))),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Power(f_,Times($p(c,true),ArcSinh(Plus($p(a,true),Times($p(b,true),x_))))),$p(x,SymbolHead)),
...
SetDelayed(Int(Power(E,Times($p(n,true),ArcSinh(v_))),$p(x,SymbolHead)),
    Condition(Int(Power(Plus(v,Sqrt(Plus(C1,Power(v,C2)))),n),x),And(IntIntegerQ(n),IntPolynomialQ(v,x)))),
SetDelayed(Int(Times(Power(x_,$p(m,true)),Power(E,Times($p(n,true),ArcSinh(v_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(ArcCosh(Plus($p(a,true),Times($p(b,true),x_))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(C1,Power(ArcCosh(Plus($p(a,true),Times($p(b,true),x_))),CN1)),$p(x,SymbolHead)),
    Condition(Times(SinhIntegral(ArcCosh(Plus(a,Times(b,x)))),Power(b,CN1)),FreeQ(List(a,b),x))),
SetDelayed(Int(Times(C1,Power(Power(ArcCosh(Plus($p(a,true),Times($p(b,true),x_))),C2),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(C1,Power(Sqrt(ArcCosh(Plus($p(a,true),Times($p(b,true),x_)))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Sqrt(ArcCosh(Plus($p(a,true),Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Power(ArcCosh(Plus($p(a,true),Times($p(b,true),x_))),n_),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(ArcCosh(Times($p(a,true),Power(x_,$p(n,true)))),Power(x_,CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcCosh(Plus($p(a,true),Times($p(b,true),x_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(C1,Power(Sqrt(Plus(a_,Times($p(b,true),ArcCosh(Plus($p(c,true),Times($p(d,true),x_)))))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times(Power(Plus(C1,x_),$p(m,true)),Power(Plus(CN1,x_),$p(m,true))),Power(ArcCosh(x_),$p(n,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(ArcCosh(Times($p(c,true),Power(Plus($p(a,true),Times($p(b,true),Power(x_,$p(n,true)))),CN1))),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Power(f_,Times($p(c,true),ArcCosh(Plus($p(a,true),Times($p(b,true),x_))))),$p(x,SymbolHead)),
...
SetDelayed(Int(Power(E,Times($p(n,true),ArcCosh(v_))),$p(x,SymbolHead)),
    Condition(Int(Power(Plus(v,Times(Sqrt(Plus(CN1,v)),Sqrt(Plus(C1,v)))),n),x),And(IntIntegerQ(n),IntPolynomialQ(v,x)))),
SetDelayed(Int(Times(Power(x_,$p(m,true)),Power(E,Times($p(n,true),ArcCosh(v_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(ArcTanh(Plus($p(a,true),Times($p(b,true),x_))),$p(x,SymbolHead)),
...
SetDelayed(Int(ArcTanh(Plus($p(a,true),Times($p(b,true),Power(x_,n_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(ArcTanh(Plus($p(a,true),Times($p(b,true),Power(x_,$p(n,true))))),Power(x_,CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcTanh(Plus($p(a,true),Times($p(b,true),Power(x_,$p(n,true)))))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(C1,Times(CN1,Power(x_,C2))),m_),Power(ArcTanh(x_),$p(n,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(CN1,Power(x_,C2)),m_),Power(ArcTanh(x_),$p(n,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(C1,Power(Times(Times(Plus(C1,Times(CN1,Power(x_,C2))),ArcCoth(x_)),ArcTanh(x_)),CN1)),$p(x,SymbolHead)),
    Times(Plus(Times(CN1,Log(ArcCoth(x))),Log(ArcTanh(x))),Power(Plus(ArcCoth(x),Times(CN1,ArcTanh(x))),CN1))),
SetDelayed(Int(Times(Power(ArcCoth(x_),$p(n,true)),Times(Power(ArcTanh(x_),$p(p,true)),Power(Plus(C1,Times(CN1,Power(x_,C2))),CN1))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(x_,Power(ArcTanh(Times($p(a,true),x_)),n_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(x_,Power(ArcTanh(Plus($p(a,true),Times($p(b,true),x_))),n_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(ArcTanh(Times($p(c,true),Power(Plus($p(a,true),Times($p(b,true),Power(x_,$p(n,true)))),CN1))),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(v_,$p(n,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times($p(u,true),Power(E,Times($p(n,true),ArcTanh(v_)))),$p(x,SymbolHead)),
    Condition(Int(Times(u,Times(Power(Plus(C1,v),Times(n,C1D2)),Power(Power(Plus(C1,Times(CN1,v)),Times(n,C1D2)),CN1))),x),EvenQ(n))),
SetDelayed(Int(Power(E,Times($p(n,true),ArcTanh(v_))),$p(x,SymbolHead)),
    Condition(Int(Times(Power(Plus(C1,v),Times(n,C1D2)),Power(Power(Plus(C1,Times(CN1,v)),Times(n,C1D2)),CN1)),x),RationalQ(n))),
SetDelayed(Int(Times(Power(x_,$p(m,true)),Power(E,Times($p(n,true),ArcTanh(v_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times($p(u,true),Power(E,Times($p(n,true),ArcTanh(v_)))),Power(Plus(C1,Times(CN1,Power(v_,C2))),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times($p(u,true),Power(E,Times($p(n,true),ArcTanh(v_)))),Power(Plus(a_,Times($p(b,true),Power(v_,C2))),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times($p(u,true),Power(E,Times($p(n,true),ArcTanh(v_)))),Power(Plus(C1,v_),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times($p(u,true),Power(E,Times($p(n,true),ArcTanh(v_)))),Power(Plus(C1,Times(CN1,v_)),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times($p(u,true),Power(E,Times($p(n,true),ArcTanh(v_)))),Power(Plus(a_,Times($p(b,true),v_)),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times($p(u,true),Power(E,ArcTanh(v_))),Power(Plus(a_,Times($p(b,true),Power(Power(v_,C2),CN1))),$p(m,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(u_,Power(Plus(a_,Times($p(b,true),Power(x_,C2))),n_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcTanh(u_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(v_,ArcTanh(u_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(ArcTanh(Times($p(b,true),x_)),Power(Plus(c_,Times($p(d,true),Power(x_,$p(n,true)))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(ArcTanh(Plus(a_,Times($p(b,true),x_))),Power(Plus(c_,Times($p(d,true),Power(x_,$p(n,true)))),CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(ArcCoth(Plus($p(a,true),Times($p(b,true),x_))),$p(x,SymbolHead)),
...
SetDelayed(Int(ArcCoth(Plus($p(a,true),Times($p(b,true),Power(x_,n_)))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(ArcCoth(Plus($p(a,true),Times($p(b,true),Power(x_,$p(n,true))))),Power(x_,CN1)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(x_,$p(m,true)),ArcCoth(Plus($p(a,true),Times($p(b,true),Power(x_,$p(n,true)))))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(C1,Times(CN1,Power(x_,C2))),m_),Power(ArcCoth(x_),$p(n,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(Plus(CN1,Power(x_,C2)),m_),Power(ArcCoth(x_),$p(n,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Power(ArcCoth(x_),$p(n,true)),Times(Power(ArcTanh(x_),p_),Power(Plus(C1,Times(CN1,Power(x_,C2))),CN1))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times(Power(Plus(C1,Times(CN1,Power(x_,C2))),$p(m,true)),Power(ArcCoth(x_),$p(n,true))),Power(ArcTanh(x_),$p(p,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(Times(Power(Plus(CN1,Power(x_,C2)),$p(m,true)),Power(ArcCoth(x_),$p(n,true))),Power(ArcTanh(x_),$p(p,true))),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(x_,Power(ArcCoth(Times($p(a,true),x_)),n_)),$p(x,SymbolHead)),
...
SetDelayed(Int(Times(x_,Power(ArcCoth(Plus($p(a,true),Times($p(b,true),x_))),n_)),$p(x,SymbolHead)),
