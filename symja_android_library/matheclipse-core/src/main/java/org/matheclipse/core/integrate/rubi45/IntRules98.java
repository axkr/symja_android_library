...
ISetDelayed(Int(Times(Power(Sech(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),p_),Power(x_,m_DEFAULT),Sinh(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT))),x_Symbol),
...
ISetDelayed(Int(Times(Cosh(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),Power(Csch(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),p_),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Sech(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),p_DEFAULT),Power(Tanh(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),q_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Coth(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),q_DEFAULT),Power(Csch(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),p_DEFAULT),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Power(Times(Power(Sinh(Plus(Times(Power(x_,pn_),b_DEFAULT),a_DEFAULT)),p_DEFAULT),c_DEFAULT),q_),x_Symbol),
...
ISetDelayed(Int(Power(Times(Power(Cosh(Plus(Times(Power(x_,pn_),b_DEFAULT),a_DEFAULT)),p_DEFAULT),c_DEFAULT),q_),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(Power(Sinh(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),p_DEFAULT),c_DEFAULT),q_),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(Power(Cosh(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),p_DEFAULT),c_DEFAULT),q_),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Power(Times(Power(Sech(Plus(Times(Power(x_,pn_),b_DEFAULT),a_DEFAULT)),p_DEFAULT),c_DEFAULT),q_),x_Symbol),
...
ISetDelayed(Int(Power(Times(Power(Csch(Plus(Times(Power(x_,pn_),b_DEFAULT),a_DEFAULT)),p_DEFAULT),c_DEFAULT),q_),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(Power(Sech(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),p_DEFAULT),c_DEFAULT),q_),Power(x_,m_DEFAULT)),x_Symbol),
...
ISetDelayed(Int(Times(Power(Times(Power(Csch(Plus(Times(Power(x_,pn_DEFAULT),b_DEFAULT),a_DEFAULT)),p_DEFAULT),c_DEFAULT),q_),Power(x_,m_DEFAULT)),x_Symbol),
