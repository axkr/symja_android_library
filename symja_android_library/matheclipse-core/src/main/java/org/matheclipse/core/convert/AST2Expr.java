...
public class AST2Expr {
  ...
  public static final String[] SYMBOL_STRINGS = {"AbsolutePointSize", "AbsoluteThickness",
      ...
      "Epilog", "EulerGamma", "Expression", "Extension", "False", "Filling", "FillingStyle",
      "Frame", "FrameStyle", "FrameTicks", "Flat", "Float", "FourierParameters", "Full",
      "GaussianIntegers", "General", "GenerateConditions", "Glaisher", "GoldenAngle", "GoldenRatio",
      "Gray", "Green", "GridLines", "GridLinesStyle", "Heads", "HexidecimalCharacter", "HoldAll",
      "HoldComplete", "HoldAllComplete", "HoldFirst", "HoldRest", "IgnoreCase", "Indeterminate",
      "Inherited", "Infinity", "InsertionFunction", "Inset", "Integer", "Integers",
      "InterpolationOrder", "Joined", "KeyAbsent", "Khinchin", "LabelingFunction", "LabelingSize",
      "Large", "Left", "Legended", "LetterCharacter", "Lexicographic", "Lighting", "LightBlue",
      "LightBrown", "LightCyan", "LightGray", "LightGreen", "LightMagenta", "LightOrange",
      "LightPink", "LightPurple", "LightRed", "LightYellow", "Listable", "Locked", "LongForm",
      "Magenta", "Matrices", "MaxIterations", "MaxPlotPoints", "MaxPoints", "MaxRecursion",
      "MaxRoots", "Mesh", "Medium", "Method", "Modulus", "MonomialOrder",
      "NegativeDegreeLexicographic", "NegativeDegreeReverseLexicographic", "NegativeLexicographic",
      "NegativeIntegers", "NegativeRationals", "NegativeReals", "NHoldAll", "NHoldFirst",
      "NHoldRest", "None", "NonNegativeIntegers", "NonNegativeRationals", "NonNegativeReals",
      "Nothing", "Nonexistent", "NotApplicable", "NotAvailable", "Now", "Null", "Number",
      "NumberString", "NumericFunction", "OneIdentity", "Orange", "Orderless", "Overlaps", "Pi",
      "Pink", "PlotLabel", "PlotLabels", "PlotLegends", "PlotPoints", "PlotRange", "PlotStyle",
      "PositiveIntegers", "PositiveRationals", "PositiveReals", "PrecisionGoal", "Primes", "Prolog",
      "Protected", "Purple", "RationalFunctions", "Rationals", "ReadProtected", "Real", "Record",
      "RecordSeparators", "Red", "Reals", "Right", "SameTest", "ScalingFunctions", "Second",
      "SequenceHold", "SetSystemOptions", "Small", "SystemOptions", "SlotAbsent", "StaticsVisible",
  ...
  public static final String[] FUNCTION_STRINGS = {"AASTriangle", "Abort", "Abs", "AbsArg",
      ...
      "DiscretePlot", "DiscreteRatio", "DiscreteShift", "DiscreteUniformDistribution",
      "Discriminant", "DisjointQ", "Disk", "Dispatch", "DisplayForm", "Distribute", "Distributed",
      "Div", "Divide", "DivideBy", "DivideSides", "Divisible", "Divisors", "DivisorSigma",
      "DivisorSum", "Do", "Dodecahedron", "Dot", "DownValues", "Drop", "DSolve", "Dt",
      "DuplicateFreeQ", "Dynamic", "EasterSunday", "Echo", "EchoFunction", "EdgeCount", "EdgeForm",
      ...
      "ExponentialDistribution", "Export", "ExportString", "ExpToTrig", "ExtendedGCD", "Extract",
      ...
      "Fibonacci", "File", "FileFormat", "FileHash", "FileNameDrop", "FileNameJoin", "FileNames",
      "FileNameTake", "FilePrint", "FilterRules", "FindClusters", "FindCycle", "FindEdgeCover",
      ...
      "MultinormalDistribution", "MultiplicativeOrder", "MultiplySides", "NakagamiDistribution",
      ...
      "NormalDistribution", "Normalize", "NormalMatrixQ", "Not", "Notebook", "NotElement",
      "NotListQ", "NProbability", "NProduct", "NRoots", "NSolve", "NSum", "NullSpace",
      ...
      "PathGraph", "PathGraphQ", "Pattern", "PatternOrder", "PatternTest", "PauliMatrix", "Pause",
      ...
      "PermutationListQ", "PermutationReplace", "Permutations", "Permute", "PetersenGraph", "Pick",
      "Piecewise", "PiecewiseExpand", "PieChart", "PlanarGraph", "PlanarGraphQ", "Plot", "Plot3D",
      "Plus", "PlusMinus", "Pochhammer", "Point", "PointLight", "PointSize", "PoissonDistribution",
